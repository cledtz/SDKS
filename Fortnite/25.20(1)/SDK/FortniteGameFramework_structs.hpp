...
{
public:
	uint8                                        Pad_3851[0x58];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3853[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3854[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3855[0x28];                                    // Fixing Size Of Struct..
};
