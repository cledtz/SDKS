...
public:
	...
	uint8                                        Pad_8FA7[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	struct FGameplayTag                          CallFunc_Array_Get_Item;                           // 0x24(0x4)(NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue;                  // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8FA8[0x3];                                     // Fixing Size After Last Property..
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                CallFunc_MakeGameplayCueParameters_ReturnValue;    // 0x30(0xD0)(ContainsInstancedReference)
};
...
public:
	...
	uint8                                        Pad_8FA9[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8FAA[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8FAC[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8FAD[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8FAE[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8FAF[0x3];                                     // Fixing Size After Last Property..
