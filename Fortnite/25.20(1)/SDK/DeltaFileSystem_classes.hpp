...
{
public:
	uint8                                        Pad_3EEA[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3EEB[0xA8];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3EEC[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3EED[0xC8];                                    // Fixing Size Of Struct..
