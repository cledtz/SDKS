...
{
public:
	uint8                                        Pad_7A25[0x18];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7A26[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A27[0x18];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7A29[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7A2E[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7A2F[0x74];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A30[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A31[0x8];                                     // Fixing Size Of Struct..
