...
public:
	...
	uint8                                        Pad_7E0C[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E0D[0x6];                                     // Fixing Size After Last Property..
	class UFortPlayerStateAthena*                SharedFromPlayer;                                  // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_7E0E[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	TWeakObjectPtr<class UFortPlayerStateAthena> SharedFromPlayer;                                  // 0x4(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_7E0F[0x1];                                     // Fixing Size Of Struct..
};
