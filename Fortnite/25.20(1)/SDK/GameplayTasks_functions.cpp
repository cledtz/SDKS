...
// Parameters:
// FInterfaceProperty_                TaskOwner                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// FInterfaceProperty_                InTaskOwner                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UGameplayTask_ClaimResource* UGameplayTask_ClaimResource::ClaimResources(FInterfaceProperty_ InTaskOwner, const TArray<TSubclassOf<class UGameplayTaskResource>>& ResourceClasses, uint8 Priority, class FName TaskInstanceName)
{
...
class UGameplayTask_ClaimResource* UGameplayTask_ClaimResource::ClaimResource(FInterfaceProperty_ InTaskOwner, TSubclassOf<class UGameplayTaskResource> ResourceClass, uint8 Priority, class FName TaskInstanceName)
{
...
// Parameters:
// FInterfaceProperty_                TaskOwner                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UGameplayTask_SpawnActor* UGameplayTask_SpawnActor::SpawnActor(FInterfaceProperty_ TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class UActor> Class, bool bSpawnOnlyOnAuthority)
{
...
class UGameplayTask_WaitDelay* UGameplayTask_WaitDelay::TaskWaitDelay(FInterfaceProperty_ TaskOwner, float Time, uint8 Priority)
{
