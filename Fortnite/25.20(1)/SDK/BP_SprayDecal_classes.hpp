...
public:
	...
	class UFortPlayerController*                 SpawningPlayerController;                          // 0xC50(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	TArray<class UActor*>                        NearbyBuildingActors;                              // 0xC58(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
