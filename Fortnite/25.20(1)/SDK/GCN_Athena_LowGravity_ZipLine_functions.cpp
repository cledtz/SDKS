...
void UGCN_Athena_LowGravity_ZipLine_C::ReceiveTick(float DeltaSeconds)
{
	static auto Func = Class->GetFunction("GCN_Athena_LowGravity_ZipLine_C", "ReceiveTick");

	Params::UGCN_Athena_LowGravity_ZipLine_C_ReceiveTick_Params Parms;
...
void UGCN_Athena_LowGravity_ZipLine_C::ExecuteUbergraph_GCN_Athena_LowGravity_ZipLine(int32 EntryPoint, float K2Node_Event_DeltaSeconds)
{
	static auto Func = Class->GetFunction("GCN_Athena_LowGravity_ZipLine_C", "ExecuteUbergraph_GCN_Athena_LowGravity_ZipLine");

	Params::UGCN_Athena_LowGravity_ZipLine_C_ExecuteUbergraph_GCN_Athena_LowGravity_ZipLine_Params Parms;
