...
void UFortCosmeticStatObject_AloeCroutonCharge::HandleChargeCountChanged(float OldChargeCount, float NewChargeCount, class UFortPlayerController* PlayerController)
{
