...
public:
	...
	uint8                                        Pad_80A7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_80A8[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_80A9[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_80AA[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	bool                                         ReturnValue;                                       // 0xD8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_80AB[0x7];                                     // Fixing Size After Last Property..
	class UFXSystemComponent*                    CallFunc_SpawnFXSystemAttached_ReturnValue;        // 0xE0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_80AC[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_80AD[0x4];                                     // Fixing Size After Last Property..
