...
void UB_CameraLens_Drown_Damage_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("B_CameraLens_Drown_Damage_C", "ReceiveBeginPlay");

	Params::UB_CameraLens_Drown_Damage_C_ReceiveBeginPlay_Params Parms;
...
void UB_CameraLens_Drown_Damage_C::ExecuteUbergraph_B_CameraLens_Drown_Damage(int32 EntryPoint)
{
	static auto Func = Class->GetFunction("B_CameraLens_Drown_Damage_C", "ExecuteUbergraph_B_CameraLens_Drown_Damage");

	Params::UB_CameraLens_Drown_Damage_C_ExecuteUbergraph_B_CameraLens_Drown_Damage_Params Parms;
