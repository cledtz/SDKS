...
{
public:
	uint8                                        Pad_3732[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3735[0xC0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3736[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3737[0x38];                                    // Fixing Size Of Struct..
};
