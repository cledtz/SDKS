...
{
public:
	uint8                                        Pad_3DFA[0x18];                                    // Fixing Size After Last Property..
	class UFortInventory*                        CachedFortInventory;                               // 0x78(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortPawn*                             CachedFortPawn;                                    // 0x80(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_3DFB[0x10];                                    // Fixing Size Of Struct..
