...
{
	static auto Func = Class->GetFunction("VoiceChannelHeaderButton_C", "OnListItemObjectSet_1");
...
{
	static auto Func = Class->GetFunction("VoiceChannelHeaderButton_C", "BP_OnItemExpansionChanged");
