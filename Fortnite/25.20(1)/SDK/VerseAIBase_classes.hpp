...
{
public:
	uint8                                        Pad_36D9[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_36DB[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	TArray<class UFortPawn*>                     SpawnedList;                                       // 0xBE8(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_36DE[0x20];                                    // Fixing Size Of Struct..
