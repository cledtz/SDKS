...
public:
	...
	uint8                                        Pad_9A2A[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A2B[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A2C[0x2];                                     // Fixing Size After Last Property..
	...
	void Set_Text(class FText ButtonText, bool CallFunc_TextIsEmpty_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, class UUserWidget* CallFunc_Create_Basic_Tooltip_Output);
