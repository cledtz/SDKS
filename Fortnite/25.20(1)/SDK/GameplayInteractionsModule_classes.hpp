...
public:
	...
	class UAITask_UseGameplayInteraction* UseClaimedGameplayInteractionSmartObject(class UAIController* Controller, const struct FSmartObjectClaimHandle& ClaimHandle, bool bLockAILogic);
	void RequestAbort();
};
...
public:
	...
	uint8                                        Pad_16DC[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_16DD[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_16DE[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_16DF[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_16E1[0x18];                                    // Fixing Size Of Struct..
