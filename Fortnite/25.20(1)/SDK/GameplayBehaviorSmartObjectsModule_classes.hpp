...
public:
	...
	uint8                                        Pad_471C[0x28];                                    // Fixing Size Of Struct..
	...
	class UAITask_UseGameplayBehaviorSmartObject* UseClaimedGameplayBehaviorSmartObject(class UAIController* Controller, const struct FSmartObjectClaimHandle& ClaimHandle, bool bLockAILogic);
};
...
public:
	...
	uint8                                        Pad_471D[0x14];                                    // Fixing Size Of Struct..
