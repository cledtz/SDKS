...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "Setup");
...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "Construct");
...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "OnSelectedStateChanged");
...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "OnSizeInfoReceived");
...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("QualityModeSelectTile_C", "ExecuteUbergraph_QualityModeSelectTile");
