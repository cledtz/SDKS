...
class UGCN_Loop_Snow_Whiteout_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	float                                        FadeinOut_Post_BDCA5FC943E3CD00D42B59A9A0D1C530;   // 0x978(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        FadeinOut_Fade_BDCA5FC943E3CD00D42B59A9A0D1C530;   // 0x97C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                FadeinOut__Direction_BDCA5FC943E3CD00D42B59A9A0D1C530; // 0x980(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9F21[0x7];                                     // Fixing Size After Last Property..
	class UTimelineComponent*                    FadeInOut;                                         // 0x988(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            SoundOnFadeIn;                                     // 0x990(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class USoundBase*                            SoundOnFadeOut;                                    // 0x998(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
