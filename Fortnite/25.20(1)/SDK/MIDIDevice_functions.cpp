...
{
	static auto Func = Class->GetFunction("MIDIDeviceManager", "ShutDownAllMIDIDevices");
...
{
	static auto Func = Class->GetFunction("MIDIDeviceManager", "GetDefaultMIDIOutputDeviceID");
...
{
	static auto Func = Class->GetFunction("MIDIDeviceManager", "GetDefaultMIDIInputDeviceID");
