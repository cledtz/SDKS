...
{
public:
	uint8                                        Pad_3AE6[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3AE7[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3AE8[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3AE9[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3AEA[0x1];                                     // Fixing Size Of Struct..
};
