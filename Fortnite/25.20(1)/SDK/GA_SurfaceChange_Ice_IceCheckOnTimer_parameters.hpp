...
public:
	...
	uint8                                        Pad_375D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_375F[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3761[0x7];                                     // Fixing Size After Last Property..
	class UActor*                                CallFunc_GetAvatarActorFromActorInfo_ReturnValue;  // 0x198(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortPlayerPawn*                       K2Node_DynamicCast_AsFort_Player_Pawn;             // 0x1A0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3762[0x6];                                     // Fixing Size After Last Property..
	TArray<class UActor*>                        Temp_object_Variable_1;                            // 0x1B0(0x10)(ConstParm, ReferenceParm)
