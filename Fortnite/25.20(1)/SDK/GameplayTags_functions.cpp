...
{
	static auto Func = Class->GetFunction("BlueprintGameplayTagLibrary", "MakeGameplayTagQuery_MatchNoTags");
...
{
	static auto Func = Class->GetFunction("BlueprintGameplayTagLibrary", "MakeGameplayTagQuery_MatchAnyTags");
...
{
	static auto Func = Class->GetFunction("BlueprintGameplayTagLibrary", "MakeGameplayTagQuery_MatchAllTags");
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// FInterfaceProperty_                TagContainerInterface                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FGameplayTagContainer       OtherContainer                                                   (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UBlueprintGameplayTagLibrary::HasAllMatchingGameplayTags(FInterfaceProperty_ TagContainerInterface, struct FGameplayTagContainer& OtherContainer)
{
...
void UBlueprintGameplayTagLibrary::GetAllActorsOfClassMatchingTagQuery(class UObject* WorldContextObject, TSubclassOf<class UActor> ActorClass, struct FGameplayTagQuery& GameplayTagQuery, TArray<class UActor*>* OutActors)
{
...
bool UBlueprintGameplayTagLibrary::DoesTagAssetInterfaceHaveTag(FInterfaceProperty_ TagContainerInterface, const struct FGameplayTag& Tag)
{
