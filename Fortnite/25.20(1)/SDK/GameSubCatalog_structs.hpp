...
public:
	...
	uint8                                        Pad_3DC3[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DC5[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DC7[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3DC8[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DCA[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DCC[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DCD[0x7];                                     // Fixing Size After Last Property..
	class FString                                CurrencySubType;                                   // 0x18(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        ExpectedTotalPrice;                                // 0x28(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_3DCF[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DD0[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3DD1[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DD2[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DD4[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3DD6[0x7];                                     // Fixing Size After Last Property..
...
public:
	enum class EAppStore                         AppStore;                                          // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3DD7[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3DD8[0x10];                                    // Fixing Size Of Struct..
};
