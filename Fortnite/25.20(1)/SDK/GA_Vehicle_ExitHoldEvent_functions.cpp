...
{
	static auto Func = Class->GetFunction("GA_Vehicle_ExitHoldEvent_C", "FailedToActivatePassiveAbility");
...
{
	static auto Func = Class->GetFunction("GA_Vehicle_ExitHoldEvent_C", "On Enter Vehicle Passenger");
...
{
	static auto Func = Class->GetFunction("GA_Vehicle_ExitHoldEvent_C", "On Enter Vehicle Driver");
...
{
	static auto Func = Class->GetFunction("GA_Vehicle_ExitHoldEvent_C", "On Fully Exit Vehicle");
