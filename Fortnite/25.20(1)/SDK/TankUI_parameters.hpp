...
{
public:
	class UActor*                                NewVehicle;                                        // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_14A8[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	bool                                         bNewlyDisabled;                                    // 0x8(0x1)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bNewlyEnabled;                                     // 0x9(0x1)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14A9[0x2];                                     // Fixing Size Of Struct..
};
...
{
public:
	class UFortWeaponRanged*                     EquippedMountedWeapon;                             // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_14AA[0x2];                                     // Fixing Size Of Struct..
};
