...
void UB_CameraLens_Splash_Water_Droplets_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("B_CameraLens_Splash_Water_Droplets_C", "ReceiveBeginPlay");

	Params::UB_CameraLens_Splash_Water_Droplets_C_ReceiveBeginPlay_Params Parms;
...
void UB_CameraLens_Splash_Water_Droplets_C::ExecuteUbergraph_B_CameraLens_Splash_Water_Droplets(int32 EntryPoint)
{
	...
	Params::UB_CameraLens_Splash_Water_Droplets_C_ExecuteUbergraph_B_CameraLens_Splash_Water_Droplets_Params Parms;
