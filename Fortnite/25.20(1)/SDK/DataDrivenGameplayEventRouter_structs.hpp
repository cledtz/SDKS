...
public:
	...
	uint8                                        Pad_3E79[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E7A[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3E7B[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E7C[0x8];                                     // Fixing Size After Last Property..
