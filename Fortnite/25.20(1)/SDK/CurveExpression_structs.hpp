...
public:
	...
	uint8                                        Pad_8097[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8099[0x58];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_809A[0x60];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_809B[0xBF];                                    // Fixing Size Of Struct..
};
