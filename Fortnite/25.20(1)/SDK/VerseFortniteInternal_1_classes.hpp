...
{
public:
	uint8                                        Pad_7AA5[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7AA7[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	class UFortAthenaMutator_BuildingSettings*   Mutator;                                           // 0x80(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_7AA9[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7AAA[0x10];                                    // Fixing Size Of Struct..
