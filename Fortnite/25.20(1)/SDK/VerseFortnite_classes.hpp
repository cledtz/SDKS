...
{
public:
	uint8                                        Pad_7A53[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A54[0x68];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A55[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A56[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A57[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A58[0x50];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A5A[0x60];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7A5B[0x50];                                    // Fixing Size Of Struct..
