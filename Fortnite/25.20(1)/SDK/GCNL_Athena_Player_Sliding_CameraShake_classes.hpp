...
class UGCNL_Athena_Player_Sliding_CameraShake_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	class UFortPlayerPawn*                       PlayerPawn;                                        // 0x988(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
