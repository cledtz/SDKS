...
struct UGCNL_PurpleStuff_C_OnRemove_Params
{
public:
...
struct UGCNL_PurpleStuff_C_OnActive_Params
{
public:
	class UActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	class UPlayerPawn_Athena_Generic_C*          K2Node_DynamicCast_AsPlayer_Pawn_Athena_Generic;   // 0xE0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UGCNL_PurpleStuff_C_ReceiveBeginPlay_Params
{
public:
};
...
struct UGCNL_PurpleStuff_C_ReceiveTick_Params
{
public:
...
struct UGCNL_PurpleStuff_C_ExecuteUbergraph_GCNL_PurpleStuff_Params
{
public:
	...
	uint8                                        Pad_9C9B[0x3];                                     // Fixing Size After Last Property..
