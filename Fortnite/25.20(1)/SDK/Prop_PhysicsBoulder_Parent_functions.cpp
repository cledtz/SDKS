...
void UProp_PhysicsBoulder_Parent_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Parent_C", "ReceiveBeginPlay");

	Params::UProp_PhysicsBoulder_Parent_C_ReceiveBeginPlay_Params Parms;
...
void UProp_PhysicsBoulder_Parent_C::ComponentHit(class UPrimitiveComponent* HitComponent, class UActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Parent_C", "ComponentHit");

	Params::UProp_PhysicsBoulder_Parent_C_ComponentHit_Params Parms;
