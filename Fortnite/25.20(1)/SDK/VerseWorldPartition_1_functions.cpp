...
FOptionProperty_ UVerseWorldPartition::_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_N_RGetDataLayerManager(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("VerseWorldPartition", "_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_N_RGetDataLayerManager");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition", "$InitCDO");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_asset", "$InitInstance");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_asset", "$Block");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_asset", "$InitCDO");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_manager", "_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RSetDataLayerRuntimeState_L_Ndata__layer__asset_M_Ndata__layer__runtime__state_M_Nlogic_R");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_manager", "_L_2fUnrealEngine_2ecom_2fWorldPartition_2fVerseWorldPartition_2fdata__layer__manager_N_RGetDataLayerEffectiveRuntimeState_L_Ndata__layer__asset_R");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_manager", "$InitInstance");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_manager", "$Block");
...
{
	static auto Func = Class->GetFunction("VerseWorldPartition_data_layer_manager", "$InitCDO");
