...
public:
	...
	uint8                                        Pad_95B3[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_95B4[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_95B5[0x3];                                     // Fixing Size After Last Property..
	...
	void ForceStopMontage(class UFortPawn* CallFunc_GetActivatingPawn_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, float CallFunc_GetDefaultBlendOutTime_ReturnValue, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3);
	void SetReticleVisibility(bool ShouldHide, bool CallFunc_IsServer_ReturnValue, class UController* CallFunc_GetInstigatorController_ReturnValue, class UFortPlayerControllerZone* K2Node_DynamicCast_AsFort_Player_Controller_Zone, bool K2Node_DynamicCast_bSuccess);
	...
	void GetBodyTypeAndGender(enum class EFortCustomBodyType* BodyType, enum class EFortCustomGender* Gender, class UFortPawn* CallFunc_GetActivatingPawn_ReturnValue, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, enum class EFortCustomBodyType CallFunc_GetCharacterBodyType_ReturnValue, enum class EFortCustomGender CallFunc_GetCharacterGender_ReturnValue);
	void K2_OnEndAbility(bool bWasCancelled, class UObject* CallFunc_GetCurrentSourceObject_ReturnValue, class UFortMontageItemDefinitionBase* K2Node_DynamicCast_AsFort_Montage_Item_Definition_Base, bool K2Node_DynamicCast_bSuccess, class UFortPawn* CallFunc_GetActivatingPawn_ReturnValue);
