...
{
public:
	uint8                                        Pad_7A14[0x58];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7A15[0x48];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7A17[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7A18[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7A1A[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7A1B[0x8];                                     // Fixing Size Of Struct..
};
