...
public:
	...
	uint8                                        Pad_7B71[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7B74[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7B75[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	class FName                                  PlaylistName;                                      // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7B76[0x4];                                     // Fixing Size After Last Property..
...
public:
	enum class ETireLocations                    TireIndex;                                         // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7B77[0x3];                                     // Fixing Size After Last Property..
	float                                        ReturnValue;                                       // 0x4(0x4)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_7B8F[0x4];                                     // Fixing Size Of Struct..
};
