...
{
public:
	uint8                                        Pad_45BD[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_45BE[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_45BF[0x8];                                     // Fixing Size After Last Property..
	TArray<class FName>                          PropertyBindingChain;                              // 0x30(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_45C1[0x8];                                     // Fixing Size After Last Property..
	TArray<class FName>                          PropertyBindingChain;                              // 0x30(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_45C3[0x8];                                     // Fixing Size After Last Property..
	TArray<class FName>                          PropertyBindingChain;                              // 0x30(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_45C6[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_45C7[0x20];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_45C8[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_45C9[0x18];                                    // Fixing Size Of Struct..
