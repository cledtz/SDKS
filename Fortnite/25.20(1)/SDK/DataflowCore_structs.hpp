...
{
public:
	uint8                                        Pad_18AC[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_18AD[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_18AE[0x28];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_18B1[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_18B2[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_18B3[0x20];                                    // Fixing Size Of Struct..
};
