...
void UGCNL_Athena_Player_Sliding_CameraShake_C::Timeline_0__FinishedFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_CameraShake_C", "Timeline_0__FinishedFunc");

	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_Timeline_0__FinishedFunc_Params Parms;
...
void UGCNL_Athena_Player_Sliding_CameraShake_C::Timeline_0__UpdateFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_CameraShake_C", "Timeline_0__UpdateFunc");

	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_Timeline_0__UpdateFunc_Params Parms;
...
void UGCNL_Athena_Player_Sliding_CameraShake_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_CameraShake_C", "OnLoopingStartGeneric");

	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_OnLoopingStartGeneric_Params Parms;
...
void UGCNL_Athena_Player_Sliding_CameraShake_C::CameraShakeTimer()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_CameraShake_C", "CameraShakeTimer");

	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_CameraShakeTimer_Params Parms;
...
void UGCNL_Athena_Player_Sliding_CameraShake_C::OnApplicationGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_CameraShake_C", "OnApplicationGeneric");

	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_OnApplicationGeneric_Params Parms;
...
void UGCNL_Athena_Player_Sliding_CameraShake_C::ExecuteUbergraph_GCNL_Athena_Player_Sliding_CameraShake(int32 EntryPoint, class UActor* K2Node_Event_MyTarget_2, const struct FGameplayCueParameters& K2Node_Event_Parameters_2, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_2, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_2, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance_1, class UDecalActor* K2Node_Event_BurstDecalInstance_1, class UActor* K2Node_Event_MyTarget_1, const struct FGameplayCueParameters& K2Node_Event_Parameters_1, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_1, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_1, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, const struct FVector& CallFunc_GetVelocity_ReturnValue, double CallFunc_VSize_ReturnValue, class UPlayerController* CallFunc_GetLocalViewingPlayerController_ReturnValue, int64 CallFunc_Conv_DoubleToInt64_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UCameraShakeBase* CallFunc_StartCameraShake_ReturnValue, class ULegacyCameraShake* CallFunc_Conv_LegacyCameraShake_ReturnValue, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance, class UDecalActor* K2Node_Event_BurstDecalInstance, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn_1, bool K2Node_DynamicCast_bSuccess_1, float CallFunc_GetValueAtLevel_ReturnValue, int64 CallFunc_Conv_DoubleToInt64_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, float CallFunc_Divide_Int64Int64UsingFloatingPoint_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_FClamp_ReturnValue, double CallFunc_Lerp_ReturnValue, double CallFunc_Lerp_ReturnValue_1, const struct FFOscillator& K2Node_MakeStruct_FOscillator, const struct FROscillator& K2Node_MakeStruct_ROscillator, bool CallFunc_IsLocallyViewed_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, bool CallFunc_Greater_DoubleDouble_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue, double CallFunc_Conv_DoubleToInt64_InDouble_ImplicitCast, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, double CallFunc_Multiply_DoubleDouble_B_ImplicitCast, double CallFunc_Multiply_DoubleDouble_B_ImplicitCast_1, float K2Node_MakeStruct_Frequency_ImplicitCast, float K2Node_MakeStruct_Amplitude_ImplicitCast)
{
	...
	Params::UGCNL_Athena_Player_Sliding_CameraShake_C_ExecuteUbergraph_GCNL_Athena_Player_Sliding_CameraShake_Params Parms;
