...
bool UModalDialogVariant::ShouldUseModalDialogTemplateWidgets()
{
	static auto Func = Class->GetFunction("ModalDialogVariant", "ShouldUseModalDialogTemplateWidgets");

	Params::UModalDialogVariant_ShouldUseModalDialogTemplateWidgets_Params Parms;
