...
{
public:
	uint8                                        Pad_3FB7[0xA0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FB8[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3FB9[0x50];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3FBA[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3FBC[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3FBD[0x5];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3FBE[0x6];                                     // Fixing Size Of Struct..
};
