...
public:
	...
	uint8                                        Pad_85C8[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_85C9[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	class FName                                  ClipName;                                          // 0x0(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        ClipId;                                            // 0x4(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_85CA[0x4];                                     // Fixing Size After Last Property..
	struct FVector2D                             DistanceRange;                                     // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_85CB[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_85CC[0x2];                                     // Fixing Size Of Struct..
};
