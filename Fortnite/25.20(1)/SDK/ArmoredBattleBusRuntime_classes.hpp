...
public:
	...
	uint8                                        Pad_7C2C[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C2D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C2E[0x3];                                     // Fixing Size After Last Property..
	...
	void UpdateYawDeltaSmoothed(class UFortAthenaVehicle* VehicleActor, class FName SocketName, struct FRotator& NewRotation, float* SmoothedYawValue);
	void UpdateSmoothedVehicleYawRate(class UFortAthenaVehicle* VehicleActor);
	...
	void GenerateCharacterPitchAndYawForSlopedTerrain(class UFortAthenaVehicle* VehicleActor, float* TurretYaw, float* TurretPitch, struct FRotator* PawnYawRotator);
};
...
public:
	...
	uint8                                        Pad_7C35[0xC];                                     // Fixing Size Of Struct..
	...
	float UpdateYawDeltaSmoothed(class UFortAthenaVehicle* VehicleActor, class FName SocketName, const struct FRotator& NewRotation, float SmoothedYawValue);
	void UpdateTurretAimPitchWeaponYaw(class UFortAthenaVehicle* OwnerVehicle, class UFortPlayerPawn* GunnerActor, class FName SocketName, float YawOffset, float* TurretAimPitch, float* YawDeltaSmoothed, struct FRotator* WeaponYaw);
	float UpdateSmoothedVehicleYawRate(class UFortAthenaVehicle* VehicleActor, const struct FRotator& PreviousRotator);
	void GetPitchAndYaw(class UFortAthenaVehicle* VehicleActor, class UFortPlayerPawn* GunnerActor, float* AdjustedPitch, float* AdjustedYaw, bool* bIsLocalPlayerControlled, struct FRotator* YawRotator);
};
