...
struct UGCN_NPC_Interaction_RezOut_Glitch_C_Spawn_Dissolve_VFX_Params
{
public:
};
...
struct UGCN_NPC_Interaction_RezOut_Glitch_C_ExecuteUbergraph_GCN_NPC_Interaction_RezOut_Glitch_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_471F[0x3];                                     // Fixing Size After Last Property..
