...
{
public:
	uint8                                        Pad_7C47[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C48[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7C49[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C4A[0x8];                                     // Fixing Size After Last Property..
