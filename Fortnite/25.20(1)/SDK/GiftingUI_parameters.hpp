...
public:
	...
	uint8                                        Pad_816B[0x7];                                     // Fixing Size After Last Property..
...
public:
	bool                                         bSuccess;                                          // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_816C[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8173[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8174[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_817C[0x7];                                     // Fixing Size Of Struct..
};
