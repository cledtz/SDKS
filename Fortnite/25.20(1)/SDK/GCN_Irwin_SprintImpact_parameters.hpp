...
struct UGCN_Irwin_SprintImpact_C_OnBurstGeneric_Params
{
public:
	...
	uint8                                        Pad_A1F3[0x7];                                     // Fixing Size After Last Property..
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0x1E0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x1F8(0xE0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
