...
public:
	...
	uint8                                        Pad_3740[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3741[0x7];                                     // Fixing Size After Last Property..
	class UActor*                                ActorContext;                                      // 0x20(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_3742[0x3];                                     // Fixing Size Of Struct..
};

// 0x18 (0x18 - 0x0)
// Function GameplayMessages.GameplayMessageReplicator.Multicast_ServerMessageTriggered
struct UGameplayMessageReplicator_Multicast_ServerMessageTriggered_Params
{
public:
...
public:
	...
	class UActor*                                ActorContext;                                      // 0x10(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	struct FEventMessageTag                      Channel;                                           // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3746[0x3];                                     // Fixing Size Of Struct..
};
