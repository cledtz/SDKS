...
{
public:
	class UActor*                                Avatar;                                            // 0x0(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_4560[0x28];                                    // Fixing Size Of Struct..
};
