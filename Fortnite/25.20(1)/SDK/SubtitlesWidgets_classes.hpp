...
public:
	...
	uint8                                        Pad_44DF[0x3];                                     // Fixing Size After Last Property..
	class FText                                  PreviewText;                                       // 0x190(0x18)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_44E0[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44E1[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44E2[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44E3[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44E4[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44E5[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44E6[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44E7[0x18];                                    // Fixing Size After Last Property..
	struct FSubtitleFormat                       SubtitleFormat;                                    // 0x48(0x4)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_44E8[0x4];                                     // Fixing Size Of Struct..
