...
{
public:
	uint8                                        Pad_36FA[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_36FB[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_36FD[0xA];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_36FE[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_36FF[0x10];                                    // Fixing Size Of Struct..
};
