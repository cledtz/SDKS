...
public:
	...
	uint8                                        Pad_20C1[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_20C2[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_20C3[0xF];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_20C4[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20C5[0x8];                                     // Fixing Size After Last Property..
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20C7[0x8];                                     // Fixing Size After Last Property..
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20C9[0x8];                                     // Fixing Size After Last Property..
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_20CA[0xF];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20CD[0xB];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_20CE[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20CF[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20D0[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_20D1[0x7];                                     // Fixing Size Of Struct..
};
