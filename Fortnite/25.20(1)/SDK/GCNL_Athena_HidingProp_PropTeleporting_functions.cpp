...
void UGCNL_Athena_HidingProp_PropTeleporting_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_PropTeleporting_C", "ReceiveBeginPlay");

	Params::UGCNL_Athena_HidingProp_PropTeleporting_C_ReceiveBeginPlay_Params Parms;
...
void UGCNL_Athena_HidingProp_PropTeleporting_C::ExecuteUbergraph_GCNL_Athena_HidingProp_PropTeleporting(int32 EntryPoint)
{
	...
	Params::UGCNL_Athena_HidingProp_PropTeleporting_C_ExecuteUbergraph_GCNL_Athena_HidingProp_PropTeleporting_Params Parms;
