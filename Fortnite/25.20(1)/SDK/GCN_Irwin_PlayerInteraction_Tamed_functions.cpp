...
{
	static auto Func = Class->GetFunction("GCN_Irwin_PlayerInteraction_Tamed_C", "OnBurstNiagara");

	Params::UGCN_Irwin_PlayerInteraction_Tamed_C_OnBurstNiagara_Params Parms;
