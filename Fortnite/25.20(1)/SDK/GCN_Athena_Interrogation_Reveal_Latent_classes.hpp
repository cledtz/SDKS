...
class UGCN_Athena_Interrogation_Reveal_Latent_C : public UFortGameplayCueNotify_BurstLatent
{
public:
	...
	struct FVector                               SourceObjectLocation;                              // 0x558(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               ParticleRelativeLocation;                          // 0x588(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USoundMix*                             RevealSoundMix;                                    // 0x5A0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                        StencilDuration;                                   // 0x5A8(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                         bShouldPlayParticleEffectOnHand;                   // 0x5D0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
