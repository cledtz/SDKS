...
{
public:
	uint8                                        Pad_7A4C[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7A4D[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A4E[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A52[0x8];                                     // Fixing Size After Last Property..
