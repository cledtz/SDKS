...
{
public:
	class UFortPlayerControllerAthena*           PlayerController;                                  // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1883[0x7];                                     // Fixing Size Of Struct..
};
