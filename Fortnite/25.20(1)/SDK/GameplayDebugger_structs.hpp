...
public:
	...
	uint8                                        Pad_3770[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	class FName                                  CategoryName;                                      // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3771[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3772[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3773[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3774[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3775[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        BitPad_228 : 7;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_3776[0x7];                                     // Fixing Size After Last Property..
