...
class UGC_Abilities_Death_FadeCapsule_StW_C : public UFortGameplayCueNotify_BurstLatent
{
public:
	...
	uint8                                        Pad_7D5D[0x3];                                     // Fixing Size After Last Property..
