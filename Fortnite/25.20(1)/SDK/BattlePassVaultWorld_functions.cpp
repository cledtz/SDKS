...
void UBattlePassVaultWorld_C::Background_Effects__FinishedFunc()
{
	static auto Func = Class->GetFunction("BattlePassVaultWorld_C", "Background-Effects__FinishedFunc");

	Params::UBattlePassVaultWorld_C_Background_Effects__FinishedFunc_Params Parms;
...
void UBattlePassVaultWorld_C::Background_Effects__UpdateFunc()
{
	static auto Func = Class->GetFunction("BattlePassVaultWorld_C", "Background-Effects__UpdateFunc");

	Params::UBattlePassVaultWorld_C_Background_Effects__UpdateFunc_Params Parms;
...
void UBattlePassVaultWorld_C::Floor_Visibility__FinishedFunc()
{
	static auto Func = Class->GetFunction("BattlePassVaultWorld_C", "Floor-Visibility__FinishedFunc");

	Params::UBattlePassVaultWorld_C_Floor_Visibility__FinishedFunc_Params Parms;
...
void UBattlePassVaultWorld_C::Floor_Visibility__UpdateFunc()
{
	static auto Func = Class->GetFunction("BattlePassVaultWorld_C", "Floor-Visibility__UpdateFunc");

	Params::UBattlePassVaultWorld_C_Floor_Visibility__UpdateFunc_Params Parms;
...
void UBattlePassVaultWorld_C::OnSetupBackground(class UTexture2D* LoadedBackgroundTexture, struct FVaultWorldBackgroundData& BackgroundInfo)
{
	static auto Func = Class->GetFunction("BattlePassVaultWorld_C", "OnSetupBackground");

	Params::UBattlePassVaultWorld_C_OnSetupBackground_Params Parms;
