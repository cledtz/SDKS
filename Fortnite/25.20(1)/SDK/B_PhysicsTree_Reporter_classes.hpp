...
class UB_PhysicsTree_Reporter_C : public UActor
{
public:
	...
	TArray<struct FPhysicsLogAnalyticsStruct>    PhysicsLogData;                                    // 0x2A0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
