...
public:
	class FName                                  TechniqueName;                                     // 0x0(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7DB3[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7DB4[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7DB5[0x6];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7DB8[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7DB9[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7DBA[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7DBE[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7DC0[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	class UCharacterMovementComponent*           CharMoveComp;                                      // 0x0(0x8)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        DeltaSeconds;                                      // 0x8(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7DC1[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7DC4[0x7];                                     // Fixing Size Of Struct..
};
