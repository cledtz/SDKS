...
public:
	...
	uint8                                        Pad_7DAC[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7DAD[0xE];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7DAE[0xD];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7DAF[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7DB0[0x5];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7DB1[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7DB2[0x6];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7DBB[0x5];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7DBC[0x28];                                    // Fixing Size Of Struct..
	...
	void ConfigureRootMotionWarping(class FName TechniqueName, bool* bOutAllowTranslationWarp, bool* bOutAllowRotationWarp, class UActor** OutTargetActor, bool* bOutSnapshotTargetActorLocation, bool* bOutWarpTranslationToLocation, struct FVector* OutTargetLocation);
...
public:
	...
	uint8                                        Pad_7DC2[0xC8];                                    // Fixing Size After Last Property..
	...
	class UFortWeapon*                           Weapon;                                            // 0x1D0(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7DC3[0x270];                                   // Fixing Size Of Struct..
	...
	void SetLockOnState(bool bEnabled, class UActor* TargetActor);
...
public:
	...
	uint8                                        Pad_7DC5[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7DC6[0xC];                                     // Fixing Size After Last Property..
	...
	void OnWeaponAbilitiesRemoved(class UFortWeapon* Weapon, enum class EFortWeaponAbilityRemovalReason RemovalReason);
	void OnUnEquip(class UFortWeapon* Weapon);
	void OnRep_ReplayAnimInstanceInfo();
	void OnReleaseTrigger(class UFortWeapon* Weapon);
	void OnReleaseSecondaryFire(class UFortWeapon* Weapon);
	void OnPressTrigger(class UFortWeapon* Weapon);
	void OnPressSecondaryFire(class UFortWeapon* Weapon);
