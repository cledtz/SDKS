...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_OnExecute_Params
{
public:
	...
	uint8                                        Pad_A0D6[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0D7[0x4];                                     // Fixing Size After Last Property..
	...
	class UActor*                                K2Node_DynamicCast_AsActor;                        // 0x1B0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_A0D9[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0DA[0x5];                                     // Fixing Size After Last Property..
	class UObject*                               K2Node_Select_Default;                             // 0x1E0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPlayerPawn_Athena_C*                  K2Node_DynamicCast_AsPlayer_Pawn_Athena;           // 0x1E8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_BeginSweepFX_Params
{
public:
};
...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_EndSweepFX_Params
{
public:
};
...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_ReceiveEndPlay_Params
{
public:
...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_PlayWorldSweep_Params
{
public:
};
...
struct UGCN_Athena_Interrogation_Reveal_Latent_C_ExecuteUbergraph_GCN_Athena_Interrogation_Reveal_Latent_Params
{
public:
	...
	uint8                                        Pad_A0DB[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0DC[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0DD[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0DE[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0DF[0x4];                                     // Fixing Size After Last Property..
