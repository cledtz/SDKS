...
public:
	...
	uint8                                        Pad_3E45[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E46[0x80];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E47[0xF0];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E48[0x40];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E49[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E4B[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E4C[0x1C8];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E4D[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E4F[0x60];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E50[0xC0];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E51[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E52[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E53[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E54[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E55[0x57];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E56[0x70];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E57[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E58[0x2C];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E59[0x10C];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E5A[0x48];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E5B[0x98];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E5C[0x60];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E5E[0x1A8];                                   // Fixing Size Of Struct..
