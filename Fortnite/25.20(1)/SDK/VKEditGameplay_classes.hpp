...
{
public:
	uint8                                        Pad_26EF[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_26F0[0x20];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_26F1[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_26F2[0x3];                                     // Fixing Size After Last Property..
