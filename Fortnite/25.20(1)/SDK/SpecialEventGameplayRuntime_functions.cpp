...
void UFortAthenaMutator_SpecialEvent::OnGamePhaseStepChanged(FInterfaceProperty_& SafeZoneInterface, enum class EAthenaGamePhaseStep GamePhaseStep)
{
...
void UFortAthenaMutator_SpecialEvent::OnGamePhaseChanged(enum class EAthenaGamePhase NewPhase)
{
	static auto Func = Class->GetFunction("FortAthenaMutator_SpecialEvent", "OnGamePhaseChanged");

	Params::UFortAthenaMutator_SpecialEvent_OnGamePhaseChanged_Params Parms;
