...
{
public:
	uint8                                        Pad_804A[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_804B[0x6];                                     // Fixing Size After Last Property..
	class UBodySetup*                            ProcMeshBodySetup;                                 // 0x5B0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FBoxSphereBounds                      LocalBounds;                                       // 0x5D8(0x38)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	TArray<class UBodySetup*>                    AsyncBodySetupQueue;                               // 0x610(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
