...
{
public:
	struct FPiPPartnerSource                     InSelectedSource;                                  // 0x0(0x128)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_3FA1[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FA2[0x7];                                     // Fixing Size Of Struct..
};
