...
public:
	...
	uint8                                        Pad_829E[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	int32                                        PartId;                                            // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_82A1[0x4];                                     // Fixing Size After Last Property..
...
public:
	int32                                        PartId;                                            // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_82A2[0x4];                                     // Fixing Size After Last Property..
...
public:
	int32                                        PartId;                                            // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_82A3[0x4];                                     // Fixing Size After Last Property..
...
public:
	int32                                        PartId;                                            // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_82A5[0x4];                                     // Fixing Size After Last Property..
	TArray<float>                                ReturnValue;                                       // 0x8(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
