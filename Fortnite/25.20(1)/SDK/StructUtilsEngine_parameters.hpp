...
public:
	...
	uint8                                        Pad_3701[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3703[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3704[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3705[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FInstancedStruct                      B;                                                 // 0x10(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3708[0x7];                                     // Fixing Size Of Struct..
};
