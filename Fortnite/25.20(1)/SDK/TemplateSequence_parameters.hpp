...
public:
	...
	uint8                                        Pad_416E[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4172[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4173[0xB];                                     // Fixing Size Of Struct..
};
...
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4174[0x8];                                     // Fixing Size After Last Property..
...
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4175[0x8];                                     // Fixing Size After Last Property..
	struct FMinimalViewInfo                      ReturnValue;                                       // 0x10(0x7C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
