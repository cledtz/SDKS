...
public:
	...
	uint8                                        Pad_41A4[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A5[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41A6[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41A8[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A9[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41AA[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41AB[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41AC[0x6];                                     // Fixing Size After Last Property..
	...
	bool                                         bQuicksilverEP;                                    // 0x278(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_41AD[0x17];                                    // Fixing Size Of Struct..
};
