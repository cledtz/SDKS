...
{
public:
	uint8                                        Pad_7C57[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C58[0x14];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7C59[0x30];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C5A[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7C5B[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C5D[0x10];                                    // Fixing Size Of Struct..
