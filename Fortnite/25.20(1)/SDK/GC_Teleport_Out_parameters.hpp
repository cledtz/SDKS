...
public:
	...
	uint8                                        Pad_9F0B[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9F0C[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9F0D[0x5];                                     // Fixing Size After Last Property..
	class UPlayerPawn_Generic_Parent_C*          K2Node_DynamicCast_AsPlayer_Pawn_Generic_Parent;   // 0x1B0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9F0F[0x8];                                     // Fixing Size After Last Property..
	struct FTransform                            CallFunc_GetTransform_ReturnValue;                 // 0x1D0(0x60)(ConstParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UActor*                                CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue; // 0x230(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UDuplicateResOutMesh_C*                CallFunc_FinishSpawningActor_ReturnValue;          // 0x238(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
