...
void UFortAthenaLivingWorldPointProvidersEnabler::OnCompletedEvaluation__DelegateSignature(TArray<FInterfaceProperty_>& EnabledPointProviders)
{
...
TArray<FInterfaceProperty_> UFortAthenaLivingWorldPointProvidersEnabler::GetEnabledLinkedPointProviders()
{
...
class UFortAthenaLivingWorldEncounterInstance* UFortAthenaLivingWorldManager::StartEncounter(TSoftObjectPtr<class UFortAthenaLivingWorldEncounter> EncounterType, TArray<FInterfaceProperty_>& EncounterPointProviders, class UActor* ActorDensityReservoir)
{
...
// FInterfaceProperty_                SourcePointProvider                                              (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortAthenaLivingWorldSpawnActionBlueprint::K2_OnAllActorSpawned(TArray<class UActor*>& SpawnedActor, FInterfaceProperty_& SourcePointProvider)
{
