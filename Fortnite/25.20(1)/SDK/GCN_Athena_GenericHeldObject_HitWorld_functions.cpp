...
{
	static auto Func = Class->GetFunction("GCN_Athena_GenericHeldObject_HitWorld_C", "OnBurst");

	Params::UGCN_Athena_GenericHeldObject_HitWorld_C_OnBurst_Params Parms;
