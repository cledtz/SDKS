...
public:
	...
	uint8                                        Pad_9A75[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A76[0x3];                                     // Fixing Size After Last Property..
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationForward_ReturnValue;         // 0xD0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPointerEvent                         K2Node_Event_MouseEvent;                           // 0xD8(0x78)(ConstParm)
	class FText                                  K2Node_Event_ActionText;                           // 0x150(0x18)(ConstParm)
	bool                                         K2Node_Event_bShowKeybindWidget;                   // 0x168(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
