...
{
public:
	uint8                                        Pad_4203[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4216[0x20];                                    // Fixing Size After Last Property..
	struct FRigVMByteCode                        ByteCodeStorage;                                   // 0x60(0x90)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4217[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4218[0x4];                                     // Fixing Size After Last Property..
	TArray<class FName>                          FunctionNamesStorage;                              // 0x218(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4219[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_421A[0xE8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_421B[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_421C[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_421D[0x28];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_421E[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4227[0x8];                                     // Fixing Size After Last Property..
	struct FRigVMRuntimeSettings                 VMRuntimeSettings;                                 // 0x30(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_4228[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4229[0x18];                                    // Fixing Size After Last Property..
	TArray<class FName>                          EventQueue;                                        // 0x90(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_422A[0x90];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_422B[0x40];                                    // Fixing Size Of Struct..
