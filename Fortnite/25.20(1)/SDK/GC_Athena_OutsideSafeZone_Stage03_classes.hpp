...
class UGC_Athena_OutsideSafeZone_Stage03_C : public UGC_Athena_OutsideSafeZone_C
{
public:
	uint8                                        Pad_A095[0x7];                                     // Fixing Size After Last Property..
