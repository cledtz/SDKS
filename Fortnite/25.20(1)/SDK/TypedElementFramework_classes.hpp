...
{
public:
	uint8                                        Pad_17FB[0x950];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_17FF[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1800[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1801[0x10];                                    // Fixing Size Of Struct..
