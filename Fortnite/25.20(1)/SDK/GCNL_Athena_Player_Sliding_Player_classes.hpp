...
class UGCNL_Athena_Player_Sliding_Player_C : public UFortGameplayCueNotifyLoop_Sliding
{
public:
	...
	uint8                                        Pad_15E7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_15E8[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_15E9[0x4];                                     // Fixing Size After Last Property..
	...
	void On_Target_Pawn_Actor_Hit(class UActor* SelfActor, class UActor* OtherActor, const struct FVector& NormalImpulse, struct FHitResult& Hit, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, bool CallFunc_OnCollision_OutResult, float CallFunc_OnCollision_OutMagnitude);
	void UpdateSoundComponentParameters(class UFortPlayerPawn* PlayerPawn, class UAudioComponent* AudioComponent, bool CallFunc_IsLocallyViewed_ReturnValue, enum class EFortTeamAffiliation CallFunc_GetTeamAffiliationForActorToLocalPlayer_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, FInterfaceProperty_ CallFunc_SetBoolParameter_self_CastInput, FInterfaceProperty_ CallFunc_SetBoolParameter_self_CastInput_1);
