...
public:
	...
	uint8                                        Pad_7F0F[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F10[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F11[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7F15[0x3];                                     // Fixing Size After Last Property..
	...
	void OnWakeUp(class UActor* GoalActor);
	void OnTeleport();
	void OnDamaged(class UActor* DamagedActor, float Damage, class UController* InstigatedBy, class UActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum);
};
