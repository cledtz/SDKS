...
public:
	...
	class UFortPlayerControllerAthena*           PlayerController;                                  // 0xB68(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UFortPlayerPawn*                       InterrogatedPlayer;                                // 0xB70(0x8)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8DB5[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8DB6[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8DB7[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8DB8[0x4];                                     // Fixing Size After Last Property..
	...
	void OnDied_Event_0(class UActor* DamagedActor, float Damage, class UController* InstigatedBy, class UActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum);
	void OnDied_Event_1(class UActor* DamagedActor, float Damage, class UController* InstigatedBy, class UActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum);
