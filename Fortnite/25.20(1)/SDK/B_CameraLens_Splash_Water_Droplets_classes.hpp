...
class UB_CameraLens_Splash_Water_Droplets_C : public UEmitterCameraLensEffectBase
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("B_CameraLens_Splash_Water_Droplets_C");
		return Clss;
	}
