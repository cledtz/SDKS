...
void UGCNL_RollingEffects_PhysicsTree_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_RollingEffects_PhysicsTree_C", "OnLoopingStartGeneric");

	Params::UGCNL_RollingEffects_PhysicsTree_C_OnLoopingStartGeneric_Params Parms;
