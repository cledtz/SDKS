...
void UBGA_PhysicsTreeLog_C::CalculateSplitOffset(bool bSmallSide, double SplitPercentage, double* LocalZOffset, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, double CallFunc_Subtract_DoubleDouble_ReturnValue_1, double CallFunc_Divide_DoubleDouble_ReturnValue_1, double CallFunc_Multiply_DoubleDouble_ReturnValue_2)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "CalculateSplitOffset");

	Params::UBGA_PhysicsTreeLog_C_CalculateSplitOffset_Params Parms;
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UB_PhysicsTree_Reporter_C*   ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash)
...
// class UB_PhysicsTree_Reporter_C*   CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UB_PhysicsTree_Reporter_C*   CallFunc_FinishSpawningActor_ReturnValue                         (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

class UB_PhysicsTree_Reporter_C* UBGA_PhysicsTreeLog_C::GetAnalyticsReporterActor(bool* Success, bool CallFunc_IsServer_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class UActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class UB_PhysicsTree_Reporter_C* CallFunc_GetActorOfClass_ReturnValue, class UB_PhysicsTree_Reporter_C* CallFunc_FinishSpawningActor_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "GetAnalyticsReporterActor");

	Params::UBGA_PhysicsTreeLog_C_GetAnalyticsReporterActor_Params Parms;
...
// Parameters:
// class UActor*                      FelledBy                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class FString                      Feller                                                           (Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
// class UB_PhysicsTree_Reporter_C*   CallFunc_GetAnalyticsReporterActor_ReturnValue                   (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UBGA_PhysicsTreeLog_C::ReportTreeFellingToAnalytics(class UActor* FelledBy, const class FString& Feller, class UB_PhysicsTree_Reporter_C* CallFunc_GetAnalyticsReporterActor_ReturnValue, bool CallFunc_GetAnalyticsReporterActor_Success, class UActor* CallFunc_GetOwner_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFortPlayerPawnAthena* K2Node_DynamicCast_AsFort_Player_Pawn_Athena, bool K2Node_DynamicCast_bSuccess, class UFortPlayerStateAthena* K2Node_DynamicCast_AsFort_Player_State_Athena, bool K2Node_DynamicCast_bSuccess_1, const class FString& CallFunc_GetObjectName_ReturnValue, const struct FUniqueNetIdRepl& CallFunc_GetPlayerUniqueNetID_ReturnValue, const class FString& CallFunc_GetDebugStringForUniqueId_ReturnValue, bool CallFunc_IsServer_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const class FString& CallFunc_GetObjectName_ReturnValue_1)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "ReportTreeFellingToAnalytics");

	Params::UBGA_PhysicsTreeLog_C_ReportTreeFellingToAnalytics_Params Parms;
...
void UBGA_PhysicsTreeLog_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "ReceiveBeginPlay");

	Params::UBGA_PhysicsTreeLog_C_ReceiveBeginPlay_Params Parms;
...
void UBGA_PhysicsTreeLog_C::OnComponentHit_Event_0(class UPrimitiveComponent* HitComponent, class UActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "OnComponentHit_Event_0");

	Params::UBGA_PhysicsTreeLog_C_OnComponentHit_Event_0_Params Parms;
...
void UBGA_PhysicsTreeLog_C::LogDamaged(class UActor* DamagedActor, float Damage, class UController* InstigatedBy, class UActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "LogDamaged");

	Params::UBGA_PhysicsTreeLog_C_LogDamaged_Params Parms;
...
void UBGA_PhysicsTreeLog_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class UFortPawn* InstigatedBy, class UActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "OnDeathPlayEffects");

	Params::UBGA_PhysicsTreeLog_C_OnDeathPlayEffects_Params Parms;
...
void UBGA_PhysicsTreeLog_C::RemoveSnow()
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "RemoveSnow");

	Params::UBGA_PhysicsTreeLog_C_RemoveSnow_Params Parms;
...
void UBGA_PhysicsTreeLog_C::CE_SplashInWater(const struct FVector& SplashLocation)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "CE_SplashInWater");

	Params::UBGA_PhysicsTreeLog_C_CE_SplashInWater_Params Parms;
...
void UBGA_PhysicsTreeLog_C::OnDeathServer(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class UController* InstigatedBy, class UActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "OnDeathServer");

	Params::UBGA_PhysicsTreeLog_C_OnDeathServer_Params Parms;
...
void UBGA_PhysicsTreeLog_C::AdjustWaterSettings()
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "AdjustWaterSettings");

	Params::UBGA_PhysicsTreeLog_C_AdjustWaterSettings_Params Parms;
...
void UBGA_PhysicsTreeLog_C::Update_Water_FX()
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "Update Water FX");

	Params::UBGA_PhysicsTreeLog_C_Update_Water_FX_Params Parms;
...
void UBGA_PhysicsTreeLog_C::AwakeStateChanged(class UPrimitiveComponent* SimulatingComponent, bool bIsAwake)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "AwakeStateChanged");

	Params::UBGA_PhysicsTreeLog_C_AwakeStateChanged_Params Parms;
...
void UBGA_PhysicsTreeLog_C::Control2dSimForces()
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "Control2dSimForces");

	Params::UBGA_PhysicsTreeLog_C_Control2dSimForces_Params Parms;
...
void UBGA_PhysicsTreeLog_C::OnPontoonEnteredWater(struct FSphericalPontoon& Pontoon)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "OnPontoonEnteredWater");

	Params::UBGA_PhysicsTreeLog_C_OnPontoonEnteredWater_Params Parms;
...
void UBGA_PhysicsTreeLog_C::OnPontoonExitedWater(struct FSphericalPontoon& Pontoon)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "OnPontoonExitedWater");

	Params::UBGA_PhysicsTreeLog_C_OnPontoonExitedWater_Params Parms;
...
void UBGA_PhysicsTreeLog_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("BGA_PhysicsTreeLog_C", "ReceiveEndPlay");

	Params::UBGA_PhysicsTreeLog_C_ReceiveEndPlay_Params Parms;
...
// int32                              Temp_int_Array_Index_Variable                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<class UBP_FluidSim_FN_C*>   CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class UBP_FluidSim_FN_C*           CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
