...
{
public:
	uint8                                        Pad_182E[0x8];                                     // Fixing Size After Last Property..
	...
	FInterfaceProperty_                          PurchaseChoiceOwner;                               // 0x578(0x10)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
