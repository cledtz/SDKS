...
{
public:
	uint8                                        Pad_160A[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_160B[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_160D[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_160F[0x50];                                    // Fixing Size Of Struct..
};
