...
{
	static auto Func = Class->GetFunction("Assets", "_L_2fVerse_2eorg_2fAssets_N_RMakeAsset_L_NAssetType_M_N_Kchar_20where_20AssetType_R");
...
{
	static auto Func = Class->GetFunction("Assets_mesh", "$InitInstance");
...
{
	static auto Func = Class->GetFunction("Assets_mesh", "$Block");
...
{
	static auto Func = Class->GetFunction("Assets_mesh", "$InitCDO");
...
{
	static auto Func = Class->GetFunction("Assets_texture_base", "$InitInstance");
...
{
	static auto Func = Class->GetFunction("Assets_texture_base", "$Block");
...
{
	static auto Func = Class->GetFunction("Assets_texture_base", "$InitCDO");
