...
{
public:
	uint8                                        Pad_7D78[0x1E0];                                   // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7D79[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7D7A[0x78];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7D7B[0x8];                                     // Fixing Size Of Struct..
};
