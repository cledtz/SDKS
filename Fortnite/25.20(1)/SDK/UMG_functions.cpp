...
{
	static auto Func = Class->GetFunction("Widget", "SetRenderTransformAngle");
...
{
	static auto Func = Class->GetFunction("Widget", "SetNavigationRuleExplicit");
...
{
	static auto Func = Class->GetFunction("Widget", "SetNavigationRuleCustomBoundary");
...
{
	static auto Func = Class->GetFunction("Widget", "SetNavigationRuleCustom");
...
{
	static auto Func = Class->GetFunction("Widget", "SetNavigationRuleBase");
...
{
	static auto Func = Class->GetFunction("Widget", "SetFocus");
...
{
	static auto Func = Class->GetFunction("Widget", "K2_RemoveFieldValueChangedDelegate");
...
{
	static auto Func = Class->GetFunction("Widget", "K2_BroadcastFieldValueChanged");
...
{
	static auto Func = Class->GetFunction("Widget", "K2_AddFieldValueChangedDelegate");
...
{
	static auto Func = Class->GetFunction("Widget", "IsRendered");
...
{
	static auto Func = Class->GetFunction("Widget", "IsInViewport");
...
{
	static auto Func = Class->GetFunction("Widget", "GetTickSpaceGeometry");
...
{
	static auto Func = Class->GetFunction("Widget", "GetRenderTransformAngle");
...
{
	static auto Func = Class->GetFunction("Widget", "GetPaintSpaceGeometry");
...
{
	static auto Func = Class->GetFunction("Widget", "GetAccessibleText");
...
{
	static auto Func = Class->GetFunction("Widget", "GetAccessibleSummaryText");
...
{
	static auto Func = Class->GetFunction("ListViewBase", "SetWheelScrollMultiplier");
...
{
	static auto Func = Class->GetFunction("ListViewBase", "SetScrollOffset");
...
{
	static auto Func = Class->GetFunction("ListViewBase", "SetScrollbarVisibility");
...
{
	static auto Func = Class->GetFunction("ListViewBase", "GetScrollOffset");
...
// Parameters:
// class UActor*                      ItemOuter                                                        (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UListView::OnListItemOuterEndPlayed(class UActor* ItemOuter, enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("ListView", "OnListItemOuterEndPlayed");
...
// (Final, Native, Protected)
// Parameters:
// class UActor*                      Item                                                             (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// enum class EEndPlayReason          EndPlayReason                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UListView::OnListItemEndPlayed(class UActor* Item, enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("ListView", "OnListItemEndPlayed");
...
{
	static auto Func = Class->GetFunction("ListView", "GetVerticalEntrySpacing");

	Params::UListView_GetVerticalEntrySpacing_Params Parms;
...
{
	static auto Func = Class->GetFunction("ListView", "GetHorizontalEntrySpacing");

	Params::UListView_GetHorizontalEntrySpacing_Params Parms;
...
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// class UPlayerController*           LocalPlayerController                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	static auto Func = Class->GetFunction("UserWidget", "SetAnimationCurrentTime");
...
{
	static auto Func = Class->GetFunction("UserWidget", "RemoveExtensions");
...
{
	static auto Func = Class->GetFunction("UserWidget", "RemoveExtension");
...
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class UPlayerCameraManager*        ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UPlayerCameraManager* UUserWidget::GetOwningPlayerCameraManager()
{
	static auto Func = Class->GetFunction("UserWidget", "GetOwningPlayerCameraManager");
...
{
	static auto Func = Class->GetFunction("UserWidget", "GetExtensions");
...
{
	static auto Func = Class->GetFunction("UserWidget", "GetExtension");
...
{
	static auto Func = Class->GetFunction("UserWidget", "FlushAnimations");
...
{
	static auto Func = Class->GetFunction("UserWidget", "AddExtension");
...
{
	static auto Func = Class->GetFunction("WidgetAnimationPlayCallbackProxy", "CreatePlayAnimationTimeRangeProxyObject");
...
{
	static auto Func = Class->GetFunction("WidgetAnimationPlayCallbackProxy", "CreatePlayAnimationProxyObject");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "SetWidgetSlotPosition");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "SetWidgetSlotDesiredSize");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "SetWidgetSlot");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "RemoveWidget");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "IsWidgetAdded");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "GetWidgetSlot");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "AddWidgetForPlayer");
...
{
	static auto Func = Class->GetFunction("GameViewportSubsystem", "AddWidget");
...
// Parameters:
// FInterfaceProperty_                UserListEntry                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UUserListEntryLibrary::IsListItemSelected(FInterfaceProperty_ UserListEntry)
{
	static auto Func = Class->GetFunction("UserListEntryLibrary", "IsListItemSelected");
...
bool UUserListEntryLibrary::IsListItemExpanded(FInterfaceProperty_ UserListEntry)
{
	static auto Func = Class->GetFunction("UserListEntryLibrary", "IsListItemExpanded");
...
class UListViewBase* UUserListEntryLibrary::GetOwningListView(FInterfaceProperty_ UserListEntry)
{
	static auto Func = Class->GetFunction("UserListEntryLibrary", "GetOwningListView");
...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// FInterfaceProperty_                UserObjectListEntry                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UObject*                     ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UObject* UUserObjectListEntryLibrary::GetListItemObject(FInterfaceProperty_ UserObjectListEntry)
{
	static auto Func = Class->GetFunction("UserObjectListEntryLibrary", "GetListItemObject");
...
{
	static auto Func = Class->GetFunction("BackgroundBlur", "SetCornerRadius");
...
{
	static auto Func = Class->GetFunction("Border", "SetShowEffectWhenDisabled");
...
{
	static auto Func = Class->GetFunction("CheckBox", "SetTouchMethod");
...
{
	static auto Func = Class->GetFunction("CheckBox", "SetPressMethod");
...
{
	static auto Func = Class->GetFunction("CheckBox", "SetClickMethod");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "SetSelectedOption");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "RemoveOption");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "OnSelectionChangedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "OnOpeningEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "IsOpen");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "GetSelectedOption");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "GenerateWidgetEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "ClearSelection");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "ClearOptions");
...
{
	static auto Func = Class->GetFunction("ComboBoxKey", "AddOption");
...
{
	static auto Func = Class->GetFunction("ComboBoxString", "IsOpen");
...
{
	static auto Func = Class->GetFunction("DynamicEntryBoxBase", "SetRadialSettings");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetTextOverflowPolicy");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetMinimumDesiredWidth");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetJustification");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetFontOutlineMaterial");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetFontMaterial");
...
{
	static auto Func = Class->GetFunction("EditableText", "SetFont");
...
{
	static auto Func = Class->GetFunction("EditableText", "GetJustification");
...
{
	static auto Func = Class->GetFunction("EditableText", "GetHintText");
...
{
	static auto Func = Class->GetFunction("EditableText", "GetFont");
...
{
	static auto Func = Class->GetFunction("EditableTextBox", "SetTextOverflowPolicy");
...
{
	static auto Func = Class->GetFunction("EditableTextBox", "SetJustification");
...
{
	static auto Func = Class->GetFunction("EditableTextBox", "SetForegroundColor");
...
{
	static auto Func = Class->GetFunction("GridSlot", "SetNudge");
...
{
	static auto Func = Class->GetFunction("Image", "SetDesiredSizeOverride");
...
// (Native, Public, BlueprintCallable)
// Parameters:
// FInterfaceProperty_                AtlasRegion                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bMatchSize                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UImage::SetBrushFromAtlasInterface(FInterfaceProperty_ AtlasRegion, bool bMatchSize)
{
...
{
	static auto Func = Class->GetFunction("MenuAnchor", "SetPlacement");
...
{
	static auto Func = Class->GetFunction("MenuAnchor", "GetUserWidget__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("MenuAnchor", "FitInWindow");
...
{
	static auto Func = Class->GetFunction("TextLayoutWidget", "SetJustification");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "SetWidgetStyle");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "SetHintText");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "SetFontOutlineMaterial");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "SetFontMaterial");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "SetFont");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "GetHintText");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableText", "GetFont");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableTextBox", "SetTextStyle");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableTextBox", "SetHintText");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableTextBox", "SetForegroundColor");
...
{
	static auto Func = Class->GetFunction("MultiLineEditableTextBox", "GetHintText");
...
{
	static auto Func = Class->GetFunction("Overlay", "ReplaceOverlayChildAt");
...
{
	static auto Func = Class->GetFunction("RetainerBox", "SetRetainRendering");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "SetTextTransformPolicy");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "SetTextOverflowPolicy");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "SetDefaultMaterial");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "SetDecorators");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "RefreshTextLayout");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "GetTextStyleSet");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "GetText");
...
{
	static auto Func = Class->GetFunction("RichTextBlock", "GetDefaultDynamicMaterial");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "SetWheelScrollMultiplier");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "SetScrollWhenFocusChanges");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "SetScrollbarPadding");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "SetNavigationDestination");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "SetAnimateWheelScrolling");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "GetViewFraction");
...
{
	static auto Func = Class->GetFunction("ScrollBox", "GetScrollOffsetOfEnd");
...
{
	static auto Func = Class->GetFunction("SizeBox", "SetMinAspectRatio");
...
{
	static auto Func = Class->GetFunction("SizeBox", "ClearMinAspectRatio");
...
{
	static auto Func = Class->GetFunction("Slider", "SetMinValue");
...
{
	static auto Func = Class->GetFunction("Slider", "SetMaxValue");
...
{
	static auto Func = Class->GetFunction("Slider", "GetNormalizedValue");
...
{
	static auto Func = Class->GetFunction("SpinBox", "SetMinFractionalDigits");
...
{
	static auto Func = Class->GetFunction("SpinBox", "SetMaxFractionalDigits");
...
{
	static auto Func = Class->GetFunction("SpinBox", "SetDelta");
...
{
	static auto Func = Class->GetFunction("SpinBox", "SetAlwaysUsesDeltaSnap");
...
{
	static auto Func = Class->GetFunction("SpinBox", "GetMinFractionalDigits");
...
{
	static auto Func = Class->GetFunction("SpinBox", "GetMaxFractionalDigits");
...
{
	static auto Func = Class->GetFunction("SpinBox", "GetDelta");
...
{
	static auto Func = Class->GetFunction("SpinBox", "GetAlwaysUsesDeltaSnap");
...
{
	static auto Func = Class->GetFunction("StackBox", "ReplaceStackBoxChildAt");
...
{
	static auto Func = Class->GetFunction("StackBox", "AddChildToStackBox");
...
{
	static auto Func = Class->GetFunction("TextBlock", "SetTextTransformPolicy");
...
{
	static auto Func = Class->GetFunction("TextBlock", "SetTextOverflowPolicy");
...
{
	static auto Func = Class->GetFunction("TextBlock", "SetFontOutlineMaterial");
...
{
	static auto Func = Class->GetFunction("TextBlock", "SetFontMaterial");
...
{
	static auto Func = Class->GetFunction("TileView", "IsAligned");

	Params::UTileView_IsAligned_Params Parms;
...
{
	static auto Func = Class->GetFunction("TileView", "GetEntryWidth");
...
{
	static auto Func = Class->GetFunction("TileView", "GetEntryHeight");
...
class UActor* UViewport::Spawn(TSubclassOf<class UActor> ActorClass)
{
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "SetWindowVisibility");
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "SetTickMode");
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "RequestRenderUpdate");
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "IsWidgetVisible");
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "GetWindowVisiblility");
...
{
	static auto Func = Class->GetFunction("WidgetComponent", "GetWidget");
...
{
	static auto Func = Class->GetFunction("WidgetInteractionComponent", "SetFocus");
...
{
	static auto Func = Class->GetFunction("WrapBox", "SetHorizontalAlignment");
...
{
	static auto Func = Class->GetFunction("WrapBoxSlot", "SetNewLine");
...
{
	static auto Func = Class->GetFunction("SlateBlueprintLibrary", "GetLocalTopLeft");
...
void UWidgetBlueprintLibrary::SetInputMode_UIOnlyEx(class UPlayerController* PlayerController, class UWidget* InWidgetToFocus, enum class EMouseLockMode InMouseLockMode, bool bFlushInput)
{
...
void UWidgetBlueprintLibrary::SetInputMode_GameOnly(class UPlayerController* PlayerController, bool bFlushInput)
{
...
void UWidgetBlueprintLibrary::SetInputMode_GameAndUIEx(class UPlayerController* PlayerController, class UWidget* InWidgetToFocus, enum class EMouseLockMode InMouseLockMode, bool bHideCursorDuringCapture, bool bFlushInput)
{
...
// TSubclassOf<class UInterface>      Interface                                                        (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	static auto Func = Class->GetFunction("WidgetBlueprintLibrary", "DrawSpline");
...
// class UPlayerController*           OwningPlayer                                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UUserWidget*                 ReturnValue                                                      (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UUserWidget* UWidgetBlueprintLibrary::Create(class UObject* WorldContextObject, TSubclassOf<class UUserWidget> WidgetType, class UPlayerController* OwningPlayer)
{
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsWrapBoxSlot");
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsWidgetSwitcherSlot");
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsSizeBoxSlot");
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsScrollBoxSlot");
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsScaleBoxSlot");
...
{
	static auto Func = Class->GetFunction("WidgetLayoutLibrary", "SlotAsSafeBoxSlot");
...
bool UWidgetLayoutLibrary::ProjectWorldLocationToWidgetPosition(class UPlayerController* PlayerController, const struct FVector& WorldLocation, struct FVector2D* ScreenPosition, bool bPlayerViewportRelative)
{
...
struct FGeometry UWidgetLayoutLibrary::GetPlayerScreenWidgetGeometry(class UPlayerController* PlayerController)
{
...
bool UWidgetLayoutLibrary::GetMousePositionScaledByDPI(class UPlayerController* Player, float* LocationX, float* LocationY)
{
