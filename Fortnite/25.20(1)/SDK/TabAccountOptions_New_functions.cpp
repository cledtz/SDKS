...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "OnComplete_DB10A9674F5CF800B883C79A4229D87C");
...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "OnComplete_1192BA0E41F4707FF3E3A4A4C72B2024");
...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "CenterOnTab");
...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "SettingValueChanged");
...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "BndEvt__Settings_Panel_K2Node_ComponentBoundEvent_1_OnExecuteNamedActionBP__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("TabAccountOptions_New_C", "ExecuteUbergraph_TabAccountOptions_New");
