...
public:
	...
	uint8                                        Pad_3FBF[0x90];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FC1[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FC2[0x68];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FC3[0x5];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FC4[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3FC5[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FC6[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FC7[0x8];                                     // Fixing Size Of Struct..
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x568(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3FC8[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FC9[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FCB[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FCC[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3FCF[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FD0[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FD2[0x3];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3FD4[0x8];                                     // Fixing Size After Last Property..
	class UWaterSplineComponent*                 SplineComp;                                        // 0x298(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_3FD5[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FD6[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FD7[0x98];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FD8[0xF];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3FD9[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FDA[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FDB[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FDD[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FDE[0x28];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FDF[0x30];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3FE2[0x28];                                    // Fixing Size Of Struct..
