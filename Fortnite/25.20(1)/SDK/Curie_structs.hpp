...
{
public:
	uint8                                        Pad_3DB7[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DB8[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DB9[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DBA[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DBB[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DBC[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3DBD[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DBE[0x4];                                     // Fixing Size Of Struct..
};
