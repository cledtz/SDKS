...
public:
	...
	uint8                                        Pad_3E60[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E61[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E62[0x10];                                    // Fixing Size After Last Property..
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_3E63[0x90];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E69[0x18];                                    // Fixing Size Of Struct..
};
