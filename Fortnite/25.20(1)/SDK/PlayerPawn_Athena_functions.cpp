...
void UPlayerPawn_Athena_C::GoToHUBIslandIfOutOfBounds(class UController* CallFunc_GetController_ReturnValue, class UFortPlayerControllerAthena* K2Node_DynamicCast_AsFort_Player_Controller_Athena, bool K2Node_DynamicCast_bSuccess, class UFortMinigame* CallFunc_GetMinigame_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_C", "GoToHUBIslandIfOutOfBounds");

	Params::UPlayerPawn_Athena_C_GoToHUBIslandIfOutOfBounds_Params Parms;
