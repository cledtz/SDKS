...
void UGCNL_Irwin_Player_Prey_Nug_Float_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("GCNL_Irwin_Player_Prey_Nug_Float_C", "ReceiveBeginPlay");

	Params::UGCNL_Irwin_Player_Prey_Nug_Float_C_ReceiveBeginPlay_Params Parms;
...
void UGCNL_Irwin_Player_Prey_Nug_Float_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Irwin_Player_Prey_Nug_Float_C", "OnLoopingStartGeneric");

	Params::UGCNL_Irwin_Player_Prey_Nug_Float_C_OnLoopingStartGeneric_Params Parms;
