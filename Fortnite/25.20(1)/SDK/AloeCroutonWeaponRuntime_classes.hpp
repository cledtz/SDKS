...
public:
	...
	uint8                                        Pad_7B53[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	void HandleChargeCountChanged(float OldChargeCount, float NewChargeCount, class UFortPlayerController* PlayerController);
};
