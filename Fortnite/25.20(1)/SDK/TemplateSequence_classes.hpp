...
public:
	...
	TSoftClassPtr<class UActor>                  BoundActorClass;                                   // 0x70(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4164[0xC];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4165[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4166[0x74];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4167[0x270];                                   // Fixing Size After Last Property..
	...
	uint8                                        Pad_4168[0x60];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4169[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_416A[0x3];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_416B[0x70];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_416C[0x58];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_416D[0x50];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_416F[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4170[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4171[0x8];                                     // Fixing Size Of Struct..
