...
public:
	...
	uint8                                        Pad_27F5[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_27F7[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_27F9[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_27FA[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_27FB[0x27];                                    // Fixing Size Of Struct..
};
...
{
public:
	class FName                                  MaskName;                                          // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EWeightMapTargetCommon            CurrentTarget;                                     // 0x4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_27FC[0x3];                                     // Fixing Size After Last Property..
	float                                        MaxValue;                                          // 0x8(0x4)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        MinValue;                                          // 0xC(0x4)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_27FD[0x7];                                     // Fixing Size Of Struct..
};
