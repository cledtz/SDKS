...
{
public:
	uint8                                        Pad_2168[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2169[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_216A[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_216B[0x8];                                     // Fixing Size After Last Property..
