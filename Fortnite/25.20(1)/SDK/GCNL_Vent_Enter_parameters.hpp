...
struct UGCNL_Vent_Enter_C_FadePPVol__FinishedFunc_Params
{
public:
};
...
struct UGCNL_Vent_Enter_C_FadePPVol__UpdateFunc_Params
{
public:
};
...
struct UGCNL_Vent_Enter_C_OnLoopingStart_Params
{
public:
...
struct UGCNL_Vent_Enter_C_OnRemoval_Params
{
public:
	class UActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct UGCNL_Vent_Enter_C_ExecuteUbergraph_GCNL_Vent_Enter_Params
{
public:
	...
	class UPlayerPawn_Athena_C*                  K2Node_DynamicCast_AsPlayer_Pawn_Athena;           // 0x2D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UController*                           CallFunc_GetController_ReturnValue;                // 0x2F8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPlayerController*                     K2Node_DynamicCast_AsPlayer_Controller;            // 0x300(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
