...
bool UGCNL_Creative_PossessProp_C::OnActive(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, bool CallFunc_OnActive_ReturnValue)
{
	static auto Func = Class->GetFunction("GCNL_Creative_PossessProp_C", "OnActive");

	Params::UGCNL_Creative_PossessProp_C_OnActive_Params Parms;
...
void UGCNL_Creative_PossessProp_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Creative_PossessProp_C", "OnLoopingStart");

	Params::UGCNL_Creative_PossessProp_C_OnLoopingStart_Params Parms;
...
void UGCNL_Creative_PossessProp_C::OnApplication(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Creative_PossessProp_C", "OnApplication");

	Params::UGCNL_Creative_PossessProp_C_OnApplication_Params Parms;
