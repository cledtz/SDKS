...
{
public:
	uint8                                        Pad_1F41[0x88];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1F42[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F43[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F44[0x20];                                    // Fixing Size Of Struct..
};
