...
public:
	...
	bool ReplicateMusicSequencerHit(class UObject* WorldContextObject, FInterfaceProperty_ HitInterface, class UController* Instigator);
	...
	bool AddSequenceHitEvent(FInterfaceProperty_ HitInterface, class UController* Instigator);
