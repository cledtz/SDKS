...
public:
	...
	uint8                                        Pad_1604[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1605[0x138];                                   // Fixing Size After Last Property..
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x160(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1606[0x88];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_1607[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_1608[0x4];                                     // Fixing Size Of Struct..
