...
public:
	...
	uint8                                        Pad_41B6[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41B7[0x3];                                     // Fixing Size After Last Property..
...
{
public:
	class UPlayerController*                     FortPC;                                            // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_41B9[0x7];                                     // Fixing Size Of Struct..
};
