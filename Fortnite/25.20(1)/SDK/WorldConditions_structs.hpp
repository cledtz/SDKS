...
{
public:
	uint8                                        Pad_3EF8[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3EF9[0xB];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3EFB[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	TSubclassOf<class UWorldConditionSchema>     SchemaClass;                                       // 0x10(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3EFC[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3EFD[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3EFE[0x28];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3EFF[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3F00[0x3];                                     // Fixing Size Of Struct..
};
