...
bool UMusicSequencerHitComponent::ReplicateMusicSequencerHit(class UObject* WorldContextObject, FInterfaceProperty_ HitInterface, class UController* Instigator)
{
...
bool UMusicSequencerHitComponent::AddSequenceHitEvent(FInterfaceProperty_ HitInterface, class UController* Instigator)
{
