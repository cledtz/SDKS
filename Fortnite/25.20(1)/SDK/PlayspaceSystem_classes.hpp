...
{
public:
	uint8                                        Pad_3F03[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F05[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3F07[0x48];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3F08[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F09[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	TSoftClassPtr<class UPlayspace>              PlayspaceClassTemplate;                            // 0x290(0x28)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_3F0A[0x7];                                     // Fixing Size After Last Property..
	TSubclassOf<class UPlayspace>                PlayspaceClass;                                    // 0x2C0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UPlayspace*                            Playspace;                                         // 0x2D0(0x8)(Net, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_3F0C[0x38];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F0D[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F0E[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F0F[0x30];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F10[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F11[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F13[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F14[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F16[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F17[0xF0];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F18[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F19[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3F1C[0x11F];                                   // Fixing Size After Last Property..
