...
void UStoreCamera_Blueprint_C::ChoicePackFOV_Out()
{
	static auto Func = Class->GetFunction("StoreCamera_Blueprint_C", "ChoicePackFOV-Out");

	Params::UStoreCamera_Blueprint_C_ChoicePackFOV_Out_Params Parms;
...
void UStoreCamera_Blueprint_C::ChoicePackFOV_In()
{
	static auto Func = Class->GetFunction("StoreCamera_Blueprint_C", "ChoicePackFOV-In");

	Params::UStoreCamera_Blueprint_C_ChoicePackFOV_In_Params Parms;
