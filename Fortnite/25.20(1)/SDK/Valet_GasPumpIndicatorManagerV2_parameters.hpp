...
public:
	...
	TArray<class UFuelIndicator_C*>              RemovalList;                                       // 0x10(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate)
	...
	uint8                                        Pad_9CB1[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CB2[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CB3[0x3];                                     // Fixing Size After Last Property..
	int32                                        Temp_int_Loop_Counter_Variable_1;                  // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9CB4[0x4];                                     // Fixing Size After Last Property..
	class UFuelIndicator_C*                      CallFunc_Array_Get_Item;                           // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9CB5[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CB6[0x3];                                     // Fixing Size After Last Property..
	...
	class UFuelIndicator_C*                      CallFunc_Array_Get_Item_2;                         // 0x70(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9CB7[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CB8[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CB9[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_9CBA[0x6];                                     // Fixing Size After Last Property..
	class UActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9CBB[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CBC[0x2];                                     // Fixing Size After Last Property..
	...
	class UActor*                                CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue; // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UActor*                                CallFunc_FinishSpawningActor_ReturnValue;          // 0xB0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFuelIndicator_C*                      K2Node_DynamicCast_AsFuel_Indicator;               // 0xB8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9CBF[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9CC0[0x3];                                     // Fixing Size After Last Property..
