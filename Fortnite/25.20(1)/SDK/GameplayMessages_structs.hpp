...
public:
	...
	uint8                                        Pad_3748[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3749[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_374A[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_374B[0xA0];                                    // Fixing Size Of Struct..
};
