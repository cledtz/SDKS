...
{
public:
	class UPictureInPictureFNEventsClient*       FNEventsClient;                                    // 0x558(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULiveEventHUDAd*                       HUDAdvertWidget;                                   // 0x560(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_82C0[0x20];                                    // Fixing Size Of Struct..
