...
{
public:
	uint8                                        Pad_3F49[0x8];                                     // Fixing Size After Last Property..
	TArray<class UDynamicUIScene*>               DefaultScenes;                                     // 0x298(0x10)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class ULocalPlayer>           OwningLocalPlayer;                                 // 0x2A8(0x8)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bAddEventRouter;                                   // 0x2B0(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bEnabledDuringReplay;                              // 0x2B1(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3F4A[0x6];                                     // Fixing Size After Last Property..
	class UGameplayEventRouterComponent*         EventRouter;                                       // 0x2B8(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_3F4B[0x30];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F4C[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F4D[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F4E[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F4F[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F50[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F51[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F52[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F53[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F54[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F55[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3F56[0x18];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3F57[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3F58[0x30];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F59[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F5A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F5B[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F5C[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F5D[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F5E[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F5F[0x6];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F60[0x17];                                    // Fixing Size Of Struct..
