...
public:
	...
	uint8                                        Pad_4505[0x7];                                     // Fixing Size After Last Property..
	TArray<class AFortPlayerController*>         CallFunc_GetLocalFortPlayerControllers_ReturnValue; // 0x20(0x10)(ReferenceParm)
	class AFortPlayerController*                 CallFunc_Array_Get_Item;                           // 0x30(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_Event_MyTarget_1;                           // 0x38(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ADecalActor*                           K2Node_Event_BurstDecalInstance;                   // 0x138(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                CallFunc_BreakGameplayCueParameters_Instigator;    // 0x2D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                CallFunc_BreakGameplayCueParameters_EffectCauser;  // 0x2E0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_4506[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4507[0x7];                                     // Fixing Size After Last Property..
	TArray<class AFortPlayerController*>         CallFunc_GetLocalFortPlayerControllers_ReturnValue_1; // 0x320(0x10)(ReferenceParm)
	class AFortPlayerController*                 CallFunc_Array_Get_Item_1;                         // 0x330(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
