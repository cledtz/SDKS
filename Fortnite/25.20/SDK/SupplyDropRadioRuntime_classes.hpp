...
public:
	...
	uint8                                        Pad_435F[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4360[0x7];                                     // Fixing Size After Last Property..
	...
	bool IsMoving();
	bool IsGrounded();
	void HandleMoveIgnoredActorEndPlay(class AActor* EndPlayActor, enum class EEndPlayReason Reason);
	class UBoxComponent* GetRootCollisionComponent();
	class AActor* GetHighestAttachParent(class AActor* InActor);
	float GetGravityZ();
...
public:
	...
	void StopCurrentConversation(class AFortPlayerControllerGameplay* PlayerController);
	void SetMoveShouldAbortConversation(class AFortPlayerControllerGameplay* PlayerController, bool bNewMoveAbortConversation);
};
