...
{
public:
	uint8                                        Pad_3EF4[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3EF6[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3EF8[0x48];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3EF9[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3EFA[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	TSoftClassPtr<class APlayspace>              PlayspaceClassTemplate;                            // 0x290(0x28)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	enum class EPlayspaceCreationType            PlayspaceCreationType;                             // 0x2B8(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3EFB[0x7];                                     // Fixing Size After Last Property..
	TSubclassOf<class APlayspace>                PlayspaceClass;                                    // 0x2C0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bDestroyPlayspaceOnEndPlay;                        // 0x2C8(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3EFC[0x7];                                     // Fixing Size After Last Property..
	class APlayspace*                            Playspace;                                         // 0x2D0(0x8)(Net, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                 VolumeTags;                                        // 0x2D8(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, Net, Protected, NativeAccessSpecifierProtected)
	class UOverlapComponent*                     BoundsComponent;                                   // 0x2F8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3EFD[0x38];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3EFE[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3EFF[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F00[0x30];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F01[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F02[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F03[0x4];                                     // Fixing Size After Last Property..
	TArray<TSubclassOf<class APlayspace>>        ChildPlayspaceClasses;                             // 0x398(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FPlayspaceUserList                    PlayspaceUsers;                                    // 0x3A8(0x178)(Net, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<class APlayspace*>                    ChildPlayspaces;                                   // 0x520(0x10)(Net, ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_3F04[0x6];                                     // Fixing Size After Last Property..
	...
	class AGameplayVolume*                       BoundGameplayVolume;                               // 0x550(0x8)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_3F06[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F07[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F08[0xF0];                                    // Fixing Size Of Struct..
...
{
public:
	class APlayspace*                            Playspace;                                         // 0x290(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_3F09[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F0A[0x1];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3F0C[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F0D[0x11F];                                   // Fixing Size After Last Property..
