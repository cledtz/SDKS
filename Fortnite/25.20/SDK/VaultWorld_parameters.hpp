...
{
public:
	class AVaultRotator_C*                       VaultRotator;                                      // 0x0(0x8)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AVaultRotator_C*                       K2Node_DynamicCast_AsVault_Rotator;                // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct AVaultWorld_C_OnTransitionItemDetails_Params
{
public:
...
public:
	...
	uint8                                        Pad_9DE9[0x6];                                     // Fixing Size After Last Property..
	class AFortStaticMeshActor*                  K2Node_DynamicCast_AsFort_Static_Mesh_Actor;       // 0x88(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
