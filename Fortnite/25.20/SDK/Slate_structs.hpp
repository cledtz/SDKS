...
public:
	...
	uint8                                        Pad_156D[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint16                                       First;                                             // 0x0(0x2)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                       Last;                                              // 0x2(0x2)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FCharRange>                    Ranges;                                            // 0x0(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class FName>                          SuppressExtenders;                                 // 0x108(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_156F[0xE8];                                    // Fixing Size Of Struct..
};
