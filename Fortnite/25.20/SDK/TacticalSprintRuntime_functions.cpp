...
void UFortMovementMode_ELTacSprint::HandleMovementModeChanged(class ACharacter* Character, enum class EMovementMode PreviousMovementMode, uint8 PreviousCustomMode)
{
...
void UFortPlayerControllerComponent_TacticalSprint::OnMovementModeChanged(class ACharacter* Character, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
