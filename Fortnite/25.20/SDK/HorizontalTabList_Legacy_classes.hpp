...
public:
	...
	uint8                                        Pad_9A9E[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A9F[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9AA0[0x4];                                     // Fixing Size After Last Property..
	...
	{
		static class UClass* Clss = UObject::FindClassFast("HorizontalTabList_Legacy_C");
		return Clss;
	}
