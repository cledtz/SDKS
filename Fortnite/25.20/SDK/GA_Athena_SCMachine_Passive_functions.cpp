...
void UGA_Athena_SCMachine_Passive_C::CheckPlayerChipSpawnEnabled(bool* IsChipSpawnEnabled, FInterfaceProperty_ CallFunc_HasMatchingGameplayTag_self_CastInput, bool CallFunc_HasMatchingGameplayTag_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	static auto Func = Class->GetFunction("GA_Athena_SCMachine_Passive_C", "CheckPlayerChipSpawnEnabled");
...
{
	static auto Func = Class->GetFunction("GA_Athena_SCMachine_Passive_C", "K2_ActivateAbilityFromEvent");
