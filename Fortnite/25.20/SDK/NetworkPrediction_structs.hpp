...
{
public:
	uint8                                        Pad_3FAD[0xA0];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3FAF[0x50];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3FB0[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3FB1[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FB2[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3FB3[0x5];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3FB4[0x6];                                     // Fixing Size Of Struct..
};
