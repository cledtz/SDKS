...
{
public:
	uint8                                        Pad_44E6[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_44E7[0x428];                                   // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_44E9[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44EA[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_44EB[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44EC[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44ED[0xDF];                                    // Fixing Size Of Struct..
};
