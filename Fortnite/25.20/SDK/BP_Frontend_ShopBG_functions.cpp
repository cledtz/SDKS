...
{
	static auto Func = Class->GetFunction("BP_Frontend_ShopBG_C", "DebugShopBG");

	Params::ABP_Frontend_ShopBG_C_DebugShopBG_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_ShopBG_C", "HandleRequestHide");

	Params::ABP_Frontend_ShopBG_C_HandleRequestHide_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_ShopBG_C", "HandleItemShopEntered");

	Params::ABP_Frontend_ShopBG_C_HandleItemShopEntered_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_ShopBG_C", "HandleStoreEntered");

	Params::ABP_Frontend_ShopBG_C_HandleStoreEntered_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Frontend_ShopBG_C", "ResetDonut");

	Params::ABP_Frontend_ShopBG_C_ResetDonut_Params Parms;
...
// TArray<class ACMSLobbyDirector_C*> CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class ACMSLobbyDirector_C*         CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
