...
{
public:
	uint8                                        Pad_27FF[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2800[0x50];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2801[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2803[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2804[0x4];                                     // Fixing Size After Last Property..
