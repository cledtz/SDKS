...
public:
	...
	uint8                                        Pad_82BF[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_82C0[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82C1[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82C2[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_82C3[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82C4[0x2];                                     // Fixing Size After Last Property..
	class FName                                  Name;                                              // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsDynamicArray;                                   // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_82C5[0x17];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82C6[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82C7[0x7];                                     // Fixing Size Of Struct..
};
