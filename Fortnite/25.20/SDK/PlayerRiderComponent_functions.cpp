...
void UPlayerRiderComponent_C::RiderUIStartClient(class FText Name, const struct FSlateBrush& Icon, class AActor* Ridable)
{
...
void UPlayerRiderComponent_C::MovementModeChanged(class ACharacter* Character, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
...
// FInterfaceProperty_                K2Node_DynamicCast_AsRiding_Generic_Interafce                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class AActor*                      K2Node_CustomEvent_Ridable_1                                     (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AActor*                      K2Node_CustomEvent_Ridable                                       (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UPlayerRiderComponent_C::RiderUIEnd__DelegateSignature(class AActor* RidableActor)
{
...
void UPlayerRiderComponent_C::RiderUINewStats__DelegateSignature(class FText Name, const struct FSlateBrush& Icon, class AActor* RidableActor)
{
