...
{
public:
	uint8                                        Pad_89A7[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_89A8[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	int32                                        Index;                                             // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_89A9[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89AA[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_89AB[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	int32                                        Index;                                             // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_89AC[0x4];                                     // Fixing Size After Last Property..
	struct FVector                               Location;                                          // 0x10(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               Velocity;                                          // 0x28(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               AngularVelocity;                                   // 0x40(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_89AD[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89AE[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_89AF[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89B0[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89B1[0xF5];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_89B2[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_89B3[0x8];                                     // Fixing Size After Last Property..
