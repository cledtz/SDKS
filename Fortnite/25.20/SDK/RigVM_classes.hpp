...
{
public:
	uint8                                        Pad_41CD[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41E0[0x20];                                    // Fixing Size After Last Property..
	struct FRigVMByteCode                        ByteCodeStorage;                                   // 0x60(0x90)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_41E1[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41E2[0x4];                                     // Fixing Size After Last Property..
	TArray<class FName>                          FunctionNamesStorage;                              // 0x218(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_41E3[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_41E4[0xE8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_41E5[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_41E6[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_41E7[0x28];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_41E8[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_41F1[0x8];                                     // Fixing Size After Last Property..
	struct FRigVMRuntimeSettings                 VMRuntimeSettings;                                 // 0x30(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_41F2[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_41F3[0x18];                                    // Fixing Size After Last Property..
	TArray<class FName>                          EventQueue;                                        // 0x90(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_41F4[0x90];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_41F5[0x40];                                    // Fixing Size Of Struct..
