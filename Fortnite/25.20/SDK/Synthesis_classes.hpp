...
public:
	...
	uint8                                        Pad_4057[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4060[0x6CC];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4061[0xE8];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4062[0x250];                                   // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4063[0x3E];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4064[0x50];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4066[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4067[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4068[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4069[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406A[0x30];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406B[0xA0];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406C[0x30];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406D[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406E[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_406F[0x40];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4070[0x4C];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4071[0x30];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4072[0x5E];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4073[0x34];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4074[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4075[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4076[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4077[0x60];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4078[0x4C];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4079[0x30];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4082[0x3D8];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4083[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4085[0x117];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_408B[0x728];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_408C[0x4C];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_408E[0x108];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_408F[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4090[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4092[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4093[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4095[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4096[0x18];                                    // Fixing Size Of Struct..
