...
public:
	...
	uint8                                        Pad_1EFA[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_1EE : 6;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_1EFB[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1EFC[0x88];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EFD[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1EFE[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1EFF[0x20];                                    // Fixing Size Of Struct..
};
