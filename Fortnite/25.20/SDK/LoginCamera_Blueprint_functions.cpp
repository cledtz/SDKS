...
{
	static auto Func = Class->GetFunction("LoginCamera_Blueprint_C", "BP_OnActivated");

	Params::ALoginCamera_Blueprint_C_BP_OnActivated_Params Parms;
