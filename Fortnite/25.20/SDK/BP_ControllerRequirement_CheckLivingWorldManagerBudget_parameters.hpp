...
public:
	...
	uint8                                        Pad_A2A6[0x6];                                     // Fixing Size After Last Property..
	class AFortGameStateAthena*                  CallFunc_GetGameStateAthenaFromContext_ReturnValue; // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue_1;                    // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A2A7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A2A8[0x3];                                     // Fixing Size After Last Property..
