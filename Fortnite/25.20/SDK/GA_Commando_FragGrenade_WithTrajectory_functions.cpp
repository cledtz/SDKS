...
// class AB_Prj_Commando_FragGrenade_C*FragGrenade                                                      (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
...
// class AFortProjectileBase*         CallFunc_SpawnProjectile_ReturnValue                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AB_Prj_Commando_FragGrenade_C*K2Node_DynamicCast_AsB_Prj_Commando_Frag_Grenade                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
