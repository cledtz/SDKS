...
// class AFortPlayerPawn*             CallFunc_GetHeroPlayerPawnByIndex_ReturnValue                    (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("FortnitePartyHeroSelect_Camera_C", "BP_OnActivated");

	Params::AFortnitePartyHeroSelect_Camera_C_BP_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("FortnitePartyHeroSelect_Camera_C", "BP_OnDeactivated");

	Params::AFortnitePartyHeroSelect_Camera_C_BP_OnDeactivated_Params Parms;
