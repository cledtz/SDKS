...
{
public:
	class AFortPawn*                             FortPawn;                                          // 0x0(0x8)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AFortPawn*                             LocalFortPawn;                                     // 0x8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	struct FGameplayAbilityActorInfo             CallFunc_GetActorInfo_ReturnValue;                 // 0x10(0x48)(ContainsInstancedReference)
	class AFortPawn*                             K2Node_DynamicCast_AsFort_Pawn;                    // 0x58(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_9594[0x4];                                     // Fixing Size After Last Property..
	struct FGameplayEventData                    K2Node_Event_EventData;                            // 0x8(0xB0)(ConstParm)
	class AFortPawn*                             CallFunc_SetupPawnActorAbility_FortPawn;           // 0xB8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
