...
public:
	...
	uint8                                        Pad_7BAC[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7BAD[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BAE[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7BAF[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7BB0[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BB1[0x48];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7BB2[0xB8];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BB3[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7BB4[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BB5[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BB6[0x4];                                     // Fixing Size After Last Property..
...
public:
	int32                                        Frame;                                             // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7BB7[0x4];                                     // Fixing Size After Last Property..
	struct FFortDagwoodCmd                       InputCmd;                                          // 0x8(0x30)(NoDestructor, NativeAccessSpecifierPublic)
	...
	class APlayerController*                     PC;                                                // 0x438(0x8)(ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7BB8[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7BB9[0x90];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BBA[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7BBB[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7BBC[0x18];                                    // Fixing Size Of Struct..
};
