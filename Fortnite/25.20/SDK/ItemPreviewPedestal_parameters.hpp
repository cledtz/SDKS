...
{
public:
	class AFortItemPreviewActor*                 Preview;                                           // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AWrapPreview_C*                        K2Node_DynamicCast_AsWrap_Preview;                 // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9E11[0x7];                                     // Fixing Size After Last Property..
	class AItemOnPawnPreview_C*                  K2Node_DynamicCast_AsItem_on_Pawn_Preview;         // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
