...
void ABGA_GrindRail_C::Is_Player_Exiting_This_Rail(class AFortPlayerPawn* Player, bool* bStillExiting, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, class UFortPawnComponent_GrindRail* CallFunc_GetComponentByClass_ReturnValue, const struct FVector& CallFunc_Normal_ReturnValue, class AActor* CallFunc_GetGrindBaseActor_ReturnValue, bool CallFunc_GetWantsToGrind_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, const struct FVector& CallFunc_FindUpVectorClosestToWorldLocation_ReturnValue, double CallFunc_Dot_VectorVector_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, double CallFunc_DegAcos_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, double CallFunc_LessEqual_DoubleDouble_B_ImplicitCast)
{
