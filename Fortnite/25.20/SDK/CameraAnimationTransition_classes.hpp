...
public:
	...
	uint8                                        Pad_9C95[0x3];                                     // Fixing Size After Last Property..
	...
	class AFortnitePartyBackdrop_Camera_C*       CameraBR;                                          // 0x2B0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9C96[0x8];                                     // Fixing Size After Last Property..
	...
	class AFortnitePartyBackdrop_Camera_C*       CameraBR16Player;                                  // 0x320(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class AFortnitePartyBackdrop_Camera_C*       CameraCreative;                                    // 0x328(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class AFortnitePartyBackdrop_Camera_C*       CameraCreative16Player;                            // 0x330(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9C97[0x8];                                     // Fixing Size After Last Property..
