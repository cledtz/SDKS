...
{
public:
	uint8                                        Pad_2734[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_2735[0x20];                                    // Fixing Size After Last Property..
	TSoftClassPtr<class AFortMinigameSettingsBuilding> EditorOnlyMinigameSettingsMachineClassToSpawn;     // 0x6B8(0x28)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftClassPtr<class AFortWorldManager>       EditorOnlyWorldManagerClassToSpawn;                // 0x6E0(0x28)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_2736[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_2737[0x3];                                     // Fixing Size After Last Property..
