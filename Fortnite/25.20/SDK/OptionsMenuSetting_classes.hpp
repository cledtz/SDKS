...
public:
	...
	void Hide_Tooltip();
	void Show_Tooltip();
	class UUserWidget* OnGetUserMenuContent(class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UTooltip_Basic_S_C* CallFunc_Create_ReturnValue);
