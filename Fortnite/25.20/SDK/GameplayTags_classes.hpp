...
public:
	...
	uint8                                        Pad_15E6[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_15E7[0x138];                                   // Fixing Size After Last Property..
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x160(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_15E8[0x88];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_15E9[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_15EA[0x4];                                     // Fixing Size Of Struct..
