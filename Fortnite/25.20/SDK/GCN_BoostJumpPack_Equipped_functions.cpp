...
void UGCN_BoostJumpPack_Equipped_C::GetFuelPercent(class APlayerPawn_Athena_C* PlayerPawn, double* Fuel_Percent, double CallFunc_GetFuel_ReturnValue, double CallFunc_GetMaxFuel_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue)
{
