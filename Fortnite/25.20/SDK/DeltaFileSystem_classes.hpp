...
{
public:
	uint8                                        Pad_3EDE[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3EDF[0xA8];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3EE0[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3EE1[0xC8];                                    // Fixing Size Of Struct..
