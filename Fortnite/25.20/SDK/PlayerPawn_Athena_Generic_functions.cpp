...
void APlayerPawn_Athena_Generic_C::OnRep_CapsuleEnlarged(bool CallFunc_HasAuthority_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue, float CallFunc_GetUnscaledCapsuleHalfHeight_ReturnValue, float CallFunc_SetCapsuleHalfHeight_HalfHeight_ImplicitCast, double K2Node_VariableSet_CachedCapsuleHalfHeight_ImplicitCast)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "OnRep_CapsuleEnlarged");
...
// class APawn*                       InstigatorLocal                                                  (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
...
void APlayerPawn_Athena_Generic_C::Are_the_wind_and_water_RTT_passes_enabled(bool* NewParam, float CallFunc_GetScalarParameterValue_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_Greater_DoubleDouble_A_ImplicitCast)
{
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "MeleeSwingRight_End");

	Params::APlayerPawn_Athena_Generic_C_MeleeSwingRight_End_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "MeleeSwingLeft_End");

	Params::APlayerPawn_Athena_Generic_C_MeleeSwingLeft_End_Params Parms;
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Abilities_SpookyMist_Loop(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_PotionConsumed(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Damage_Shielded(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_Destroyed(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Shield_Reapplied(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Athena_Generic_C::GameplayCue_Loop_Shadow_Bomb(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "ToggleLandFX");

	Params::APlayerPawn_Athena_Generic_C_ToggleLandFX_Params Parms;
...
void APlayerPawn_Athena_Generic_C::OnMovementStyleChanged(enum class EFortMovementStyle PreviousMovementStyle, enum class EFortMovementStyle NewMovementStyle)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "OnMovementStyleChanged");

	Params::APlayerPawn_Athena_Generic_C_OnMovementStyleChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "Hide VFX In Frontend Hologram");

	Params::APlayerPawn_Athena_Generic_C_Hide_VFX_In_Frontend_Hologram_Params Parms;
...
void APlayerPawn_Athena_Generic_C::OnPart(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "OnPart");

	Params::APlayerPawn_Athena_Generic_C_OnPart_Params Parms;
...
void APlayerPawn_Athena_Generic_C::OnPartApplied(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "OnPartApplied");

	Params::APlayerPawn_Athena_Generic_C_OnPartApplied_Params Parms;
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "OnCharacterPartsMIDInitialized__DelegateSignature");

	Params::APlayerPawn_Athena_Generic_C_OnCharacterPartsMIDInitialized__DelegateSignature_Params Parms;
...
// class AFortPawn*                   Instigated_By                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_C", "PlayDamageEffect__DelegateSignature");
