...
public:
	...
	uint8                                        Pad_A0E9[0xF];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0EA[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_A0EB[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0EC[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0ED[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0EE[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_A0EF[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0F0[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_A0F3[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0F4[0x4];                                     // Fixing Size After Last Property..
	struct FFortDialogDescription_NUI            CallFunc_GetConfirmationDescription_ReturnValue;   // 0x20(0x160)(ConstParm, ContainsInstancedReference)
	class UCommonButtonBase*                     K2Node_Event_Button;                               // 0x180(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UCommonButtonLegacy*                   K2Node_ComponentBoundEvent_Button;                 // 0x188(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsMobileGame_ReturnValue;                 // 0x190(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_IsDesignTime;                         // 0x191(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A0F5[0x2];                                     // Fixing Size After Last Property..
	int32                                        Temp_int_Loop_Counter_Variable;                    // 0x194(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       K2Node_Select_Default;                             // 0x198(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x1A0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A0F6[0x4];                                     // Fixing Size After Last Property..
	...
	TArray<class UUserWidget*>                   CallFunc_GetAllEntries_ReturnValue;                // 0x1B0(0x10)(ConstParm, ReferenceParm, ContainsInstancedReference)
	class UUserWidget*                           CallFunc_Array_Get_Item;                           // 0x1C0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_UIKit_ButtonCTA_Base_C*           K2Node_DynamicCast_AsWBP_UIKit_Button_CTA_Base;    // 0x1C8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x1D0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A0F7[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_A0F8[0x3];                                     // Fixing Size After Last Property..
	float                                        CallFunc_SetMinDesiredWidth_InMinDesiredWidth_ImplicitCast; // 0x1DC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
