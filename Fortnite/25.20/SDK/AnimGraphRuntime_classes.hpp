...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BlendSpaceLibrary");
		return Clss;
	}
	...
	void ConvertToBlendSpacePure(struct FAnimNodeReference& Node, struct FBlendSpaceReference* BlendSpace, bool* Result);
	struct FBlendSpaceReference ConvertToBlendSpace(struct FAnimNodeReference& Node, enum class EAnimNodeReferenceConversionResult* Result);
};
...
{
public:
	class FName                                  NotifyName;                                        // 0x38(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class FName                                  NotifyName;                                        // 0x30(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("BlendListBaseLibrary");
		return Clss;
	}

	void ResetNode(struct FBlendListBaseReference& BlendListBase);
	struct FBlendListBaseReference ConvertToBlendListBase(struct FAnimNodeReference& Node, enum class EAnimNodeReferenceConversionResult* Result);
};
...
public:
	...
	void SnapToPosition(struct FBlendSpacePlayerReference& BlendSpacePlayer, const struct FVector& NewPosition);
...
public:
	...
	uint8                                        Pad_1375[0x30];                                    // Fixing Size Of Struct..
