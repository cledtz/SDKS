...
public:
	...
	uint8                                        Pad_12A[0x1];                                      // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_12E[0x3];                                      // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_12F[0x1];                                      // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_130[0x1];                                      // Fixing Size Of Struct..
};
