...
{
	static auto Func = Class->GetFunction("FrontendCamera_Inspect_C", "BP_OnActivated");

	Params::AFrontendCamera_Inspect_C_BP_OnActivated_Params Parms;
...
{
	static auto Func = Class->GetFunction("FrontendCamera_Inspect_C", "BP_OnDeactivated");

	Params::AFrontendCamera_Inspect_C_BP_OnDeactivated_Params Parms;
