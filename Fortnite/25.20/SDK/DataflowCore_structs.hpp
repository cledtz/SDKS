...
{
public:
	uint8                                        Pad_17FB[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17FC[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17FD[0x28];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1801[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1802[0x20];                                    // Fixing Size Of Struct..
};
