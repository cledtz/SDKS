...
public:
	...
	class AFortPlayerPawnAthena*                 PlayerPawn;                                        // 0xB30(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9913[0x4];                                     // Fixing Size After Last Property..
	...
	void CheckPlayerChipSpawnEnabled(bool* IsChipSpawnEnabled, FInterfaceProperty_ CallFunc_HasMatchingGameplayTag_self_CastInput, bool CallFunc_HasMatchingGameplayTag_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue);
