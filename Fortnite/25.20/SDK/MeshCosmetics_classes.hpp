...
{
public:
	struct FCosmeticSlotSelector                 SlotValidWithin;                                   // 0x7E0(0x2)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_8284[0x6];                                     // Fixing Size After Last Property..
	struct FApparelCustomizableItemReference     Parameter;                                         // 0x7E8(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_8285[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8286[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	TMap<struct FCosmeticSlotSelector, struct FCosmeticsLayoutSlot> SlotDataConfig;                                    // 0x3B0(0x50)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	TMap<struct FCosmeticSlotSelector, TSoftObjectPtr<class UCustomizableObject>> SlottedCustomizableObjects;                        // 0x400(0x50)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
