...
{
public:
	TWeakObjectPtr<class AActor>                 Actor;                                             // 0x28(0x8)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_387E[0x1];                                     // Fixing Size After Last Property..
	...
	bool Play(class USoundBase* Sound, class AActor* Owner, struct FSoundLibraryPlayResult& OutResults);
	void OnRemovedFromActor(class AActor* InActor);
	void OnAddedToActor(class AActor* InActor);
	bool GatherActorTargets(TArray<class AActor*>& OutActors);
...
public:
	...
	uint8                                        Pad_3880[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3882[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3885[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_388F[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3891[0x50];                                    // Fixing Size After Last Property..
...
public:
	...
	void ConfigureContext(class AActor* OwningActor, struct FSoundLibrarySimpleContextSettings& InSettings);
};
...
public:
	...
	void RemoveLibrary(class AActor* Actor, class USoundLibrary* Library);
	void RemoveLibrariesFromCollections(class AActor* Actor, struct FGameplayTagContainer& CollectionTags);
	void RemoveLibraries(class AActor* Actor, const TArray<class USoundLibrary*>& Libraries);
	bool RemoveContext(class AActor* Actor, TSubclassOf<class USoundLibraryContext> ContextClass);
	struct FSoundLibraryPlayResult PlaySoundSimple(class AActor* OwningActor, struct FSoundLibrarySimpleContextSettings& InSettings);
	void PlaySound(class USoundLibraryContext* Context, struct FSoundLibraryPlayResult* OutResults);
	class USoundLibraryContext* GetContext(class AActor* Actor, TSubclassOf<class USoundLibraryContext> ContextClass);
	...
	void AddLibrariesFromCollections(class AActor* Actor, struct FGameplayTagContainer& CollectionTags);
	void AddLibraries(class AActor* Actor, const TArray<class USoundLibrary*>& Libraries);
	class USoundLibraryContext* AddContext(class AActor* Actor, TSubclassOf<class USoundLibraryContext> ContextClass);
};
