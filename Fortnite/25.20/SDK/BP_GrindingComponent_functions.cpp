...
void UBP_GrindingComponent_C::CalculateVelocity(float DeltaTime, bool bReplayingMovement, struct FVector* OutVelocity, double NewCurrentDistance, class ABGA_GrindRail_C* CurrentRailToUse, class AActor* CurrentBaseActor, const struct FVector& NewVelocity)
{
