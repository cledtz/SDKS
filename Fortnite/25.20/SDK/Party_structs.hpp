...
public:
	...
	uint8                                        Pad_3E8C[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E8D[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3E8E[0x10];                                    // Fixing Size After Last Property..
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_3E8F[0x90];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E95[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3E97[0x18];                                    // Fixing Size Of Struct..
};
