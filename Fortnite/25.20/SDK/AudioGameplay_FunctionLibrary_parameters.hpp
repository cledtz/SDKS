...
public:
	...
	class AActor*                                FinalActor;                                        // 0x18(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8F1B[0x3];                                     // Fixing Size After Last Property..
	class AFortAthenaVehicle*                    K2Node_DynamicCast_AsFort_Athena_Vehicle;          // 0x30(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8F1C[0x7];                                     // Fixing Size After Last Property..
	class AFortWeapon*                           K2Node_DynamicCast_AsFort_Weapon;                  // 0x40(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AFortPlayerPawn*>               CallFunc_BP_GetAllPassengers_ReturnValue;          // 0x60(0x10)(ReferenceParm)
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x70(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerPawn*                       CallFunc_Array_Get_Item;                           // 0x78(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8F1F[0x7];                                     // Fixing Size After Last Property..
	class AFortPlayerState*                      K2Node_DynamicCast_AsFort_Player_State;            // 0x90(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_2;                     // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8F20[0x7];                                     // Fixing Size After Last Property..
	class APawn*                                 CallFunc_GetPawn_ReturnValue;                      // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class AActor*                                Receiver;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
