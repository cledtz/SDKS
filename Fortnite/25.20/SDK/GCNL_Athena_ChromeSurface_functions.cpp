...
void AGCNL_Athena_ChromeSurface_C::OnApplicationGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_ChromeSurface_C", "OnApplicationGeneric");

	Params::AGCNL_Athena_ChromeSurface_C_OnApplicationGeneric_Params Parms;
...
void AGCNL_Athena_ChromeSurface_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_ChromeSurface_C", "OnRemovalGeneric");

	Params::AGCNL_Athena_ChromeSurface_C_OnRemovalGeneric_Params Parms;
