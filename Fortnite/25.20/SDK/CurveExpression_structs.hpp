...
public:
	...
	uint8                                        Pad_8135[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8137[0x58];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_8138[0x60];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8139[0xBF];                                    // Fixing Size Of Struct..
};
