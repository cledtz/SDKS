...
void APlayerPawn_Generic_C::On_Set_Material_Part(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType, bool K2Node_SwitchEnum_CmpSuccess)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "On Set Material Part");

	Params::APlayerPawn_Generic_C_On_Set_Material_Part_Params Parms;
...
void APlayerPawn_Generic_C::Set_Part_Material(TArray<class UMaterialInstanceDynamic*>& Array, class USkeletalMeshComponent* MeshPart, int32 Temp_int_Array_Index_Variable, bool CallFunc_IsValid_ReturnValue, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue_1, class UMaterialInstanceDynamic* CallFunc_GetMIDForSkeletalMeshComponent_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	...
	Params::APlayerPawn_Generic_C_Set_Part_Material_Params Parms;
...
void APlayerPawn_Generic_C::Setup_Duplicate_FX_Mesh(class UMaterialInterface*& Material_to_Apply, enum class EFortCustomPartType PartType, TArray<class UMaterialInstanceDynamic*>& Empty_MID_Array, class USkeletalMeshComponent*& Duplicated_Mesh, bool Transfer_Material_Parameters, int32 Translucent_Sort_Order, class USkeletalMeshComponent* MeshPart, bool* ObjectsValid, int32 Temp_int_Variable, class USkeletalMesh* CallFunc_GetSkeletalMesh_DEPRECATED_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue, class USkeletalMesh* CallFunc_GetSkeletalMesh_DEPRECATED_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, TArray<struct FSkeletalMaterial>& CallFunc_GetMaterials_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue, bool CallFunc_IsValid_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_4, bool CallFunc_Find_Stored_Char_Part_Materials_Found, int32 CallFunc_Find_Stored_Char_Part_Materials_Index, TArray<class UMaterialInstanceDynamic*>& CallFunc_Find_Stored_Char_Part_Materials_MIDs, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UMaterialInterface* CallFunc_Array_Get_Item, int32 CallFunc_Array_Add_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue_1, int32 CallFunc_Min_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue_1, bool Temp_bool_Variable, int32 CallFunc_Array_Add_ReturnValue_1, int32 K2Node_Select_Default, bool CallFunc_LessEqual_IntInt_ReturnValue)
{
	...
	Params::APlayerPawn_Generic_C_Setup_Duplicate_FX_Mesh_Params Parms;
...
void APlayerPawn_Generic_C::Restore_Previous_Materials_on_Character_Mesh(bool CallFunc_IsDedicatedServer_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FDelegateHandleController& CallFunc_WhenCosmeticPartApplied_DelegateHandleController_Out)
{
...
void APlayerPawn_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier1(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Generic_C::GameplayCue_Abilities_Activation_Generic_HarvestBuff_Tier2(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
// (Net, NetReliable, NetMulticast, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortWeapon*                 CurrentWeapon                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void APlayerPawn_Generic_C::GameplayCue_Shield_FullyCharged(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Generic_C::GameplayCue_Damage_Shielded(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Generic_C::GameplayCue_Shield_Destroyed(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Generic_C::GameplayCue_Damage(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
...
void APlayerPawn_Generic_C::ToggleLandFX(bool NewHidden)
{
	...
	Params::APlayerPawn_Generic_C_ToggleLandFX_Params Parms;
...
void APlayerPawn_Generic_C::OnPartApplied(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnPartApplied");

	Params::APlayerPawn_Generic_C_OnPartApplied_Params Parms;
...
void APlayerPawn_Generic_C::OnBackpack(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnBackpack");

	Params::APlayerPawn_Generic_C_OnBackpack_Params Parms;
...
void APlayerPawn_Generic_C::OnMeshPart(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnMeshPart");

	Params::APlayerPawn_Generic_C_OnMeshPart_Params Parms;
...
void APlayerPawn_Generic_C::GameplayCue_Athena_Equipping(enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "GameplayCue.Athena.Equipping");

	Params::APlayerPawn_Generic_C_GameplayCue_Athena_Equipping_Params Parms;
...
void APlayerPawn_Generic_C::OnMeshPart3(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnMeshPart3");

	Params::APlayerPawn_Generic_C_OnMeshPart3_Params Parms;
...
void APlayerPawn_Generic_C::OnMeshPartComplete(class AFortPlayerPawn* Pawn, class USkeletalMeshComponent* BaseMesh, TArray<class UCustomCharacterPart*>& PartsArray, TArray<class USkeletalMeshComponent*>& ValidSkeletalMeshComponentPartArray)
{
	...
	Params::APlayerPawn_Generic_C_OnMeshPartComplete_Params Parms;
...
void APlayerPawn_Generic_C::OnMeshPart2(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnMeshPart2");

	Params::APlayerPawn_Generic_C_OnMeshPart2_Params Parms;
...
void APlayerPawn_Generic_C::OnBackpackPart(class AFortPlayerPawn* Pawn, class UCustomCharacterPart* Part, class USkeletalMeshComponent* MeshPart, enum class EFortCustomPartType PartType)
{
	static auto Func = Class->GetFunction("PlayerPawn_Generic_C", "OnBackpackPart");

	Params::APlayerPawn_Generic_C_OnBackpackPart_Params Parms;
...
// class USkeletalMeshComponent*      CallFunc_AddComponent_ReturnValue                                (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// FInterfaceProperty_                K2Node_DynamicCast_AsFort_Initialize_from_Object_Interface       (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// FInterfaceProperty_                CallFunc_SpawnGenericCameraLensEffectDirectional_ReturnValue     (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
