...
{
public:
	uint8                                        Pad_3905[0x20];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_23A : 7;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_3908[0x6];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3909[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        BitPad_23B : 6;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_390C[0x1];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_390E[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_390F[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3910[0x4];                                     // Fixing Size After Last Property..
	class FText                                  DisplayName;                                       // 0x10(0x18)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        BitPad_23C : 7;                                    // Fixing Bit-Field Size..
...
public:
	...
	uint8                                        Pad_3913[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3914[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3915[0xB];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3916[0x20];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_391A[0x7];                                     // Fixing Size Of Struct..
};
