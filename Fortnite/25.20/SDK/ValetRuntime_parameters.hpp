...
public:
	...
	uint8                                        Pad_7B80[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7B83[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7B84[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	enum class ETireLocations                    TireIndex;                                         // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7B86[0x3];                                     // Fixing Size After Last Property..
	float                                        ReturnValue;                                       // 0x4(0x4)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_7B9E[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BA1[0x3];                                     // Fixing Size After Last Property..
