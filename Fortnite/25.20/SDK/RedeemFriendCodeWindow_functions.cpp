...
// TArray<struct FPurchasedItemInfo>  K2Node_MakeArray_Array                                           (ConstParm, ReferenceParm)
...
{
	static auto Func = Class->GetFunction("RedeemFriendCodeWindow_C", "BndEvt__Button_Cancel_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature");

	Params::URedeemFriendCodeWindow_C_BndEvt__Button_Cancel_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature_Params Parms;
