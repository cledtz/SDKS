...
{
public:
	uint8                                        Pad_3793[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3794[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3796[0xC0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3797[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3798[0x38];                                    // Fixing Size Of Struct..
};
