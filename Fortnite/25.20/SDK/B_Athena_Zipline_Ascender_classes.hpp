...
public:
	...
	TArray<class AFortPlayerPawn*>               PlayersOnAscender;                                 // 0x1128(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
	...
	class AFortPlayerPawn*                       PlayerPawn;                                        // 0x1150(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_A2CE[0x3];                                     // Fixing Size After Last Property..
	class APlayerState*                          PlayerStateUsingHandleComponent;                   // 0x1168(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
