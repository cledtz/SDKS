...
{
public:
	uint8                                        Pad_16CF[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D0[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D1[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D2[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D3[0xF];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D5[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D6[0xF];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D7[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D8[0xF];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16D9[0x5F];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16DA[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16DB[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16DC[0x3];                                     // Fixing Size Of Struct..
};
