...
void UCommonUserWidget_DamageNumbers::OnDamageDealt(double InDamage, class AActor* InActor, bool bInShield, bool bInCrit, const struct FVector& InWorldSpacePos)
{
