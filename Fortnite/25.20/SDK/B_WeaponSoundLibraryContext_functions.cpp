...
void UB_WeaponSoundLibraryContext_C::GetRootComponent(class AActor* Actor, const struct FGameplayTag& EventTag, class USceneComponent** RootComponent, const struct FGameplayTagContainer& EquipTags, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_HasTag_ReturnValue)
{
...
bool UB_WeaponSoundLibraryContext_C::Play(class USoundBase* Sound, class AActor* Owner, struct FSoundLibraryPlayResult& OutResults, class USceneComponent* CallFunc_GetRootComponent_RootComponent, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, int32 CallFunc_Array_Add_ReturnValue)
{
