...
struct AFortAthenaMutator_CR_CreativeAllowLootItem_SetItemGameplayTagsNotAllowed_Params
{
public:
...
struct AFortAthenaMutator_CR_LootChoice_GetLootTierDataTable_Params
{
public:
...
struct AFortAthenaMutator_CR_LootChoice_GetLootSelectionString_Params
{
public:
...
struct AFortAthenaMutator_CR_LootChoice_GetLootPackageTable_Params
{
public:
	class UDataTable*                            ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct AFortAthenaMutator_CR_LootChoice_GetContextTagsToRemove_Params
{
public:
...
struct AFortAthenaMutator_CR_LootChoice_GetContextTagsToAdd_Params
{
public:
	struct FGameplayTagContainer                 ReturnValue;                                       // 0x0(0x20)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2805[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2806[0xC];                                     // Fixing Size After Last Property..
