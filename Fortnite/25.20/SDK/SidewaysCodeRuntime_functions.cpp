...
void USidewaysStateComponent::SetSidewaysState(enum class ESidewaysState NewState, class ASidewaysPlayspace* NewSidewaysPlayspace)
{
...
void USidewaysStateComponent::HandleSidewaysStateChanged(class ASidewaysPlayspace* NewSidewaysPlayspace, enum class ESidewaysState OldState, enum class ESidewaysState NewState)
{
...
class USidewaysStateComponent* USidewaysLibrary::GetSidewaysStateComponent(class AActor* Owner)
{
...
void ASidewaysPlayspace::RefreshActorsInSideways()
{
	...
	Params::ASidewaysPlayspace_RefreshActorsInSideways_Params Parms;
...
void ASidewaysPlayspace::NotifySizeChanged()
{
	...
	Params::ASidewaysPlayspace_NotifySizeChanged_Params Parms;
