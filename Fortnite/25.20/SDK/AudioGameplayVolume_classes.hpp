...
public:
	...
	uint8                                        Pad_44F2[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44F5[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44F6[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44F7[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_44F8[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_44F9[0xD0];                                    // Fixing Size Of Struct..
