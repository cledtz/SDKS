...
public:
	...
	uint8                                        Pad_9C30[0x6];                                     // Fixing Size After Last Property..
	struct FGameplayTagContainer                 CallFunc_K2_CanActivateAbility_RelevantTags;       // 0x78(0x20)()
	...
	class AActor*                                CallFunc_GetAvatarActorFromActorInfo_ReturnValue;  // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9C32[0x3];                                     // Fixing Size After Last Property..
	float                                        CallFunc_GetFloatAttribute_ReturnValue;            // 0xB4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                CallFunc_GetAvatarActorFromActorInfo_ReturnValue_1; // 0xB8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerPawnAthena*                 K2Node_DynamicCast_AsFort_Player_Pawn_Athena;      // 0xC0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	FInterfaceProperty_                          CallFunc_HasAnyMatchingGameplayTags_self_CastInput; // 0xD8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_9C35[0x2];                                     // Fixing Size After Last Property..
