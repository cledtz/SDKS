...
void ATVPostProcessBPAthena_C::ExecuteUbergraph_TVPostProcessBPAthena(int32 EntryPoint, double CallFunc_GetUnpausedTimeSeconds_ReturnValue, float CallFunc_SetScalarParameterValue_ParameterValue_ImplicitCast)
{
