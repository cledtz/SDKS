...
public:
	...
	uint8                                        Pad_475C[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_475D[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_475E[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_475F[0x60];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4760[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4761[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4762[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4763[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4764[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4765[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4766[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4767[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_294 : 6;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_4768[0x6];                                     // Fixing Size After Last Property..
	class AActor*                                SourceActor;                                       // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class AActor*                                TargetActor;                                       // 0xA0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_4769[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_476A[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_476C[0x4];                                     // Fixing Size After Last Property..
	class AActor*                                TargetActor;                                       // 0x60(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_476D[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	enum class EClamberingType                   Type;                                              // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_476E[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_476F[0x4];                                     // Fixing Size After Last Property..
	struct FVector_NetQuantize100                TargetLocation;                                    // 0x8(0x18)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                TargetActor;                                       // 0x20(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4771[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4773[0x3];                                     // Fixing Size Of Struct..
};
