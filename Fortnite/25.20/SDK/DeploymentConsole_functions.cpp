...
class AFortAthenaAircraft* UDeploymentConsoleComponent::SpawnAircraft(int32 FlightIndex)
{
...
void UDeploymentConsoleComponent::SetPlayerIsWaiting(class AController* InController, bool bInPlayerIsWaiting)
{
...
void UDeploymentConsoleComponent::InitializeFlightPath(class AFortGameStateAthena* GSA, struct FAircraftFlightConstructionInfo& FlightPathConstructionInfo)
{
...
TArray<uint8> UDeploymentConsoleComponent::GetMinigameTeamsWithPlayers(class AFortMinigame* InMinigame)
{
...
class AFortAthenaMapInfo* UDeploymentConsoleComponent::GetMapInfo()
{
...
struct FAircraftFlightConstructionInfo UDeploymentConsoleComponent::GetDefaultFlightPathConstructionInfo(class AFortGameStateAthena* GameStateAthena, enum class EAirCraftBehavior AirCraftBehavior)
{
