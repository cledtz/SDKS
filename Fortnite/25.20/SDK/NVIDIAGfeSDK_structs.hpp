...
public:
	...
	uint8                                        Pad_8A7E[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8A7F[0x4];                                     // Fixing Size After Last Property..
	class FString                                NVIDIAGfeVersion;                                  // 0x8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<enum class EGfeSDKScope, enum class EGfeSDKPermission> ScopePermissions;                                  // 0x18(0x50)(NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_8A80[0x5];                                     // Fixing Size After Last Property..
	TMap<class FString, class FString>           NameTranslationTable;                              // 0x18(0x50)(NativeAccessSpecifierPublic)
};
...
public:
	...
	TMap<class FString, class FString>           GroupDescriptionTranslationTable;                  // 0x10(0x50)(NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_8A81[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8A82[0x6];                                     // Fixing Size Of Struct..
};
