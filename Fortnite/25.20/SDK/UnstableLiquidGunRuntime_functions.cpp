...
void AFortLiquidGunProjectile::SetDetachmentReason(enum class ELiquidRibbonDetachmentReason InDetachmentReason)
{
	static auto Func = Class->GetFunction("FortLiquidGunProjectile", "SetDetachmentReason");

	Params::AFortLiquidGunProjectile_SetDetachmentReason_Params Parms;
...
void AFortLiquidGunProjectile::HandleSplineHit(struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("FortLiquidGunProjectile", "HandleSplineHit");

	Params::AFortLiquidGunProjectile_HandleSplineHit_Params Parms;
...
enum class ELiquidRibbonDetachmentReason AFortLiquidGunProjectile::GetDetachmentReason()
{
	static auto Func = Class->GetFunction("FortLiquidGunProjectile", "GetDetachmentReason");

	Params::AFortLiquidGunProjectile_GetDetachmentReason_Params Parms;
...
void ALiquidRibbonManager::SetNiagaraData(class UNiagaraComponent* NiagaraComponent, TArray<struct FVector>& Positions, TArray<int32>& RibbonIDs, TArray<bool>& RibbonVisibilities, TArray<float>& FlashIntensities, TArray<int32>& RibbonSizes)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "SetNiagaraData");

	Params::ALiquidRibbonManager_SetNiagaraData_Params Parms;
...
void ALiquidRibbonManager::RunSplineCollisionTestOnProjectiles()
{
	...
	Params::ALiquidRibbonManager_RunSplineCollisionTestOnProjectiles_Params Parms;
...
struct FVector ALiquidRibbonManager::GetPointOnSegment(float T, struct FLiquidRibbonSplineSegment& Segment)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "GetPointOnSegment");

	Params::ALiquidRibbonManager_GetPointOnSegment_Params Parms;
...
struct FLiquidRibbonSplineDetachment ALiquidRibbonManager::GetOrAddDetachment(int32 RibbonID, struct FLiquidRibbonSplineSegment& Segment)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "GetOrAddDetachment");

	Params::ALiquidRibbonManager_GetOrAddDetachment_Params Parms;
...
int32 ALiquidRibbonManager::GetFirstVisiblePointIndex()
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "GetFirstVisiblePointIndex");

	Params::ALiquidRibbonManager_GetFirstVisiblePointIndex_Params Parms;
...
TArray<struct FLiquidRibbonSplineSegment> ALiquidRibbonManager::CalculateSegments(TArray<struct FVector>& Points, float Tension)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "CalculateSegments");

	Params::ALiquidRibbonManager_CalculateSegments_Params Parms;
...
float ALiquidRibbonManager::CalculatePointSize(int32 SegmentIndex, int32 PointIndex)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "CalculatePointSize");

	Params::ALiquidRibbonManager_CalculatePointSize_Params Parms;
...
float ALiquidRibbonManager::CalculatePointFlashIntensity(int32 PointSize)
{
	static auto Func = Class->GetFunction("LiquidRibbonManager", "CalculatePointFlashIntensity");

	Params::ALiquidRibbonManager_CalculatePointFlashIntensity_Params Parms;
