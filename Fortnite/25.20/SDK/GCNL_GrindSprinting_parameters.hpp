...
struct AGCNL_GrindSprinting_C_OnLoopingStartGeneric_Params
{
public:
...
struct AGCNL_GrindSprinting_C_OnRemovalGeneric_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_GrindSprinting_C_ExecuteUbergraph_GCNL_GrindSprinting_Params
{
public:
	...
	uint8                                        Pad_3DA4[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3DA5[0x6];                                     // Fixing Size After Last Property..
	...
	class AActor*                                K2Node_Event_MyTarget;                             // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ADecalActor*                           K2Node_Event_BurstDecalInstance;                   // 0x218(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue_3;                    // 0x220(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3DA6[0x7];                                     // Fixing Size After Last Property..
	class AFortPlayerPawn*                       K2Node_DynamicCast_AsFort_Player_Pawn_1;           // 0x228(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_1;                     // 0x230(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3DA7[0x7];                                     // Fixing Size After Last Property..
