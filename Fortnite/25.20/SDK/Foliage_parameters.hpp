...
public:
	...
	uint8                                        Pad_217D[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FHitResult                            OverlapInfo;                                       // 0x20(0xE0)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
