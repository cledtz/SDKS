...
void AEpicMediaServerTime::ServerRequestServerTime(double RequestUtcTime)
{
	...
	Params::AEpicMediaServerTime_ServerRequestServerTime_Params Parms;
...
bool AEpicMediaServerTime::GetTimeUtc(struct FDateTime& OutDateTime)
{
	static auto Func = Class->GetFunction("EpicMediaServerTime", "GetTimeUtc");

	Params::AEpicMediaServerTime_GetTimeUtc_Params Parms;
...
void AEpicMediaServerTime::ClientReportServerTime(double RequestUtcTime, double ServerUtcTime)
{
	...
	Params::AEpicMediaServerTime_ClientReportServerTime_Params Parms;
