...
void UFortGameplayAbility_Mantis::ConfigureRootMotionWarping(class FName TechniqueName, bool* bOutAllowTranslationWarp, bool* bOutAllowRotationWarp, class AActor** OutTargetActor, bool* bOutSnapshotTargetActorLocation, bool* bOutWarpTranslationToLocation, struct FVector* OutTargetLocation)
{
...
class AActor* UFortMantisPawnComponent::GetLockOnTarget()
{
...
void UFortMantisWeaponComponent::OnWeaponAbilitiesRemoved(class AFortWeapon* Weapon, enum class EFortWeaponAbilityRemovalReason RemovalReason)
{
