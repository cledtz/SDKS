...
public:
	...
	uint8                                        Pad_3E32[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3E33[0x10];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E35[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E36[0x6];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E37[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E38[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E39[0x3];                                     // Fixing Size Of Struct..
...
public:
	float                                        Weight;                                            // 0x40(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3E3A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E3B[0x6];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E3C[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E3D[0x1];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E3F[0x3];                                     // Fixing Size After Last Property..
	struct FLinearColor                          DebugColor;                                        // 0x58(0x10)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EInputQueryPose                   InputQueryPose;                                    // 0x68(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bUseCharacterSpaceVelocities;                      // 0x69(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_3E42[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E43[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E44[0x4];                                     // Fixing Size Of Struct..
...
public:
	float                                        CostAddend;                                        // 0x30(0x4)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3E45[0x4];                                     // Fixing Size Of Struct..
