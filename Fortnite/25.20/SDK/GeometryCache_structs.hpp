...
{
public:
	uint8                                        Pad_8367[0xC0];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_8368[0xC];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_8369[0x9];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_836A[0xC8];                                    // Fixing Size Of Struct..
};
