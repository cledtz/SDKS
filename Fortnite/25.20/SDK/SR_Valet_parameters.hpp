...
public:
	...
	struct FAthenaRadioStation                   AffectedSource;                                    // 0x8(0x58)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
public:
	...
	struct FAthenaRadioStation                   K2Node_CustomEvent_AffectedSource_1;               // 0x30(0x58)()
	class UStreamingRadioPlayerComponent*        K2Node_CustomEvent_Component;                      // 0x88(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FAthenaRadioStation                   K2Node_CustomEvent_AffectedSource;                 // 0x90(0x58)()
	...
	uint8                                        Pad_1317[0x7];                                     // Fixing Size After Last Property..
	class UMusicEventSubsystem*                  CallFunc_GetGameInstanceSubsystem_ReturnValue_1;   // 0x108(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UMusicEventSubsystem*                  CallFunc_GetGameInstanceSubsystem_ReturnValue_2;   // 0x110(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
