...
public:
	...
	uint8                                        Pad_3EA3[0x4];                                     // Fixing Size After Last Property..
	...
	class AActor*                                RouterContextActor;                                // 0x20(0x8)(Parm, ZeroConstructor, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x28(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3EA4[0x7];                                     // Fixing Size Of Struct..
};
