...
struct AEpicMediaServerTime_ServerRequestServerTime_Params
{
public:
...
struct AEpicMediaServerTime_GetTimeUtc_Params
{
public:
...
struct AEpicMediaServerTime_ClientReportServerTime_Params
{
public:
	double                                       RequestUtcTime;                                    // 0x0(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
