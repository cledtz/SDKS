...
{
public:
	uint8                                        Pad_7EE8[0x48];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7EEB[0x7];                                     // Fixing Size After Last Property..
	class ASidewaysPlayspace*                    SidewaysPlayspace;                                 // 0xA8(0x8)(Net, ZeroConstructor, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_7EEC[0x8];                                     // Fixing Size Of Struct..
