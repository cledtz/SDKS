...
public:
	...
	uint8                                        Pad_7BE6[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7BE8[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	class ACraftingObjectBGA*                    InCraftingObject;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
