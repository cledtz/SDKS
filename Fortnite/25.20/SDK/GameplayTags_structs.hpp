...
{
public:
	uint8                                        Pad_15EC[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_15ED[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_15EF[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_15F1[0x50];                                    // Fixing Size Of Struct..
};
