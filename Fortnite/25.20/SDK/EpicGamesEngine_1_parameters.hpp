...
public:
	...
	uint8                                        Pad_8B08[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8B0C[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	struct FTuple_L_Kchar_Minput__event_R        __verse_0xB2CDDD72_Argument;                       // 0x0(0x11)(Parm, HasGetValueTypeHash)
	uint8                                        Pad_8B0D[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8B0E[0x6];                                     // Fixing Size After Last Property..
