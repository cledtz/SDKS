...
{
public:
	uint8                                        Pad_7AA8[0x58];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7AA9[0x7];                                     // Fixing Size After Last Property..
	class APlayerController*                     CachedPC;                                          // 0x108(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_7AAA[0x8];                                     // Fixing Size Of Struct..
