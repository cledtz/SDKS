...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "RemoveLibraryCollection");

	Params::ANPC_Pawn_Parent_C_RemoveLibraryCollection_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Check Tag");

	Params::ANPC_Pawn_Parent_C_Check_Tag_Params Parms;
