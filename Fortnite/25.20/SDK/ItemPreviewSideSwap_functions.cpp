...
{
	static auto Func = Class->GetFunction("ItemPreviewSideSwap_C", "Timeline_1__FinishedFunc");

	Params::AItemPreviewSideSwap_C_Timeline_1__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("ItemPreviewSideSwap_C", "Timeline_1__UpdateFunc");

	Params::AItemPreviewSideSwap_C_Timeline_1__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("ItemPreviewSideSwap_C", "OnTargetZoomLevelSet");
...
void AItemPreviewSideSwap_C::OnTargetRotationOffsetSet(struct FRotator& TargetRotationOffset)
{
	static auto Func = Class->GetFunction("ItemPreviewSideSwap_C", "OnTargetRotationOffsetSet");

	Params::AItemPreviewSideSwap_C_OnTargetRotationOffsetSet_Params Parms;
