...
struct AGCNL_Ascender_Descent_C_OnLoopingStartGeneric_Params
{
public:
...
struct AGCNL_Ascender_Descent_C_VisualizeAudio_Params
{
public:
};
...
struct AGCNL_Ascender_Descent_C_OnRemovalGeneric_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Ascender_Descent_C_ExecuteUbergraph_GCNL_Ascender_Descent_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9A4A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A4B[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A4C[0x7];                                     // Fixing Size After Last Property..
	...
	class AActor*                                K2Node_Event_MyTarget;                             // 0x160(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ADecalActor*                           K2Node_Event_BurstDecalInstance;                   // 0x260(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
