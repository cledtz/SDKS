...
{
public:
	class AFortPlayerControllerAthena*           PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_4726[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4727[0x4];                                     // Fixing Size After Last Property..
	...
	class AActor*                                Owner;                                             // 0x18(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_4728[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4729[0x3];                                     // Fixing Size After Last Property..
	TSubclassOf<class AFortTimeOfDayManager>     SpawnClass;                                        // 0x8(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_472A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_472B[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_472C[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	TSoftClassPtr<class AActor>                  SoftActorClass;                                    // 0x20(0x28)(Edit, DisableEditOnInstance, RepSkip, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bStartEnabled;                                     // 0x48(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bDestroyActorOnServer;                             // 0x49(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bDestroyActorOnClient;                             // 0x4A(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bNetForceOnActorDestroy;                           // 0x4B(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bShouldModifyLevelOnActorDestroy;                  // 0x4C(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_472E[0x3];                                     // Fixing Size After Last Property..
	TArray<struct FDestroyActorsAndComponentsMutator_ComponentDefinition> ComponentDefinitions;                              // 0x50(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, RepSkip, NativeAccessSpecifierPublic)
	bool                                         bCurrentlyEnabled;                                 // 0x60(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bPermanentlyDisabled;                              // 0x61(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_472F[0x6];                                     // Fixing Size After Last Property..
	TArray<class AActor*>                        ActorsToProcess;                                   // 0x68(0x10)(ZeroConstructor, RepSkip, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	class AFortPlayerStateAthena*                PlayerState;                                       // 0x0(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4731[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4732[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4733[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4734[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4735[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4736[0x38];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4737[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4738[0x6];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4739[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_473A[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_473B[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_473C[0xF0];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_473D[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_473E[0xF];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_473F[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4741[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4742[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4743[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4744[0x2];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4745[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4746[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4747[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4748[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4749[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_474A[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	TSoftObjectPtr<class UWorld>                 LevelToLoad;                                       // 0x60(0x28)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                LevelName;                                         // 0x88(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bExcludeFromServerPreload;                         // 0x98(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_474B[0x7];                                     // Fixing Size After Last Property..
	struct FVector                               Location;                                          // 0xA0(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FRotator                              Rotation;                                          // 0xB8(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	class ULevelStreamingDynamic*                LevelInstance;                                     // 0xD0(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	uint8                                        Pad_474C[0x17];                                    // Fixing Size Of Struct..
};
...
{
public:
	TSubclassOf<class ASpecialEventPhase>        PhaseActorClass;                                   // 0x0(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_474D[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_474E[0x5];                                     // Fixing Size After Last Property..
	class ASpecialEventPhase*                    PhaseActor;                                        // 0x40(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
