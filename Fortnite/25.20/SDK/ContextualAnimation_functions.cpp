...
bool UContextualAnimManager::IsActorInAnyScene(class AActor* Actor)
{
...
class AActor* UContextualAnimSceneInstance::GetActorByRole(class FName Role)
{
...
struct FContextualAnimSceneBinding UContextualAnimUtilities::BP_SceneBindings_GetBindingByActor(struct FContextualAnimSceneBindings& Bindings, class AActor* Actor)
{
...
class AActor* UContextualAnimUtilities::BP_SceneBindingContext_GetActor(struct FContextualAnimSceneBindingContext& BindingContext)
{
...
class AActor* UContextualAnimUtilities::BP_SceneBinding_GetActor(struct FContextualAnimSceneBinding& Binding)
{
