...
{
public:
	uint8                                        Pad_374A[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_374B[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_374C[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_374D[0xA];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_374E[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_374F[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3750[0x10];                                    // Fixing Size Of Struct..
};
