...
public:
	...
	uint8                                        Pad_3F5F[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F60[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F61[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3F63[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	struct FUniqueNetIdRepl                      NetId;                                             // 0x0(0x30)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsLocalPlayer;                                    // 0x30(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3F64[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3F65[0x7];                                     // Fixing Size Of Struct..
};
