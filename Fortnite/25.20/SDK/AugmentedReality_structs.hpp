...
public:
	...
	uint8                                        Pad_20CB[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_20CC[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_20CD[0xF];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_20CE[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20CF[0x8];                                     // Fixing Size After Last Property..
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20D1[0x8];                                     // Fixing Size After Last Property..
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_20D2[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20D4[0xF];                                     // Fixing Size Of Struct..
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_20D5[0x8];                                     // Fixing Size After Last Property..
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_20D7[0xB];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_20D8[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20D9[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_20DB[0x7];                                     // Fixing Size Of Struct..
};
