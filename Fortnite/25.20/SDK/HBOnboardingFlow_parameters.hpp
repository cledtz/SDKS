...
public:
	...
	uint8                                        Pad_41C3[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41C4[0x7];                                     // Fixing Size After Last Property..
	class UFortGlobalUIContext*                  CallFunc_GetContext_ReturnValue;                   // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_41C5[0x5];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41C6[0x4];                                     // Fixing Size After Last Property..
	class UFortGlobalUIContext*                  CallFunc_GetContext_ReturnValue;                   // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_41C7[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41C9[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_41CA[0x2];                                     // Fixing Size After Last Property..
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_3;            // 0xB4(0xC)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class AFortPlayerController*>         K2Node_MakeArray_Array;                            // 0xC0(0x10)(ReferenceParm)
	...
	uint8                                        Pad_41CB[0x5];                                     // Fixing Size After Last Property..
	...
	class AFortClientAnnouncement*               CallFunc_FinishSpawningActor_ReturnValue;          // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
