...
public:
	...
	uint8                                        Pad_9C2E[0x4];                                     // Fixing Size After Last Property..
	class AFortDecoHelper*                       K2Node_Event_FortDecoHelper;                       // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
