...
public:
	...
	uint8                                        Pad_9A89[0x3];                                     // Fixing Size After Last Property..
	float                                        K2Node_Event_Value;                                // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9A8A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A8B[0x4];                                     // Fixing Size After Last Property..
