...
void UFortUIManagerComponent_VictoryCrowns::RebuildBearerIndicators(TArray<class AFortPlayerStateAthena*>& CrownBearerList)
{
...
// Parameters:
// class AFortPlayerStateAthena*      ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class AFortPlayerStateAthena* UVictoryCrownsIndicator::GetIndicatedPlayerStateAthena()
{
...
void UVictoryCrownsPlayerInfoWidget::HandleCrownBearerListChanged(TArray<class AFortPlayerStateAthena*>& CrownBearerList)
{
...
void UVictoryCrownsPreGameWidget::RebuildBearerList(TArray<class AFortPlayerStateAthena*>& CrownBearerList)
{
