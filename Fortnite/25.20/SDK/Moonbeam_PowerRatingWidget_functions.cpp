...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "SetBackgroundColor");

	Params::UMoonbeam_PowerRatingWidget_C_SetBackgroundColor_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "Construct");

	Params::UMoonbeam_PowerRatingWidget_C_Construct_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "OnBasePowerRatingUpdated");

	Params::UMoonbeam_PowerRatingWidget_C_OnBasePowerRatingUpdated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "OnTeamPowerRatingUpdated");

	Params::UMoonbeam_PowerRatingWidget_C_OnTeamPowerRatingUpdated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "OnPowerRatingProgressUpdated");

	Params::UMoonbeam_PowerRatingWidget_C_OnPowerRatingProgressUpdated_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "PreConstruct");

	Params::UMoonbeam_PowerRatingWidget_C_PreConstruct_Params Parms;
...
{
	static auto Func = Class->GetFunction("Moonbeam_PowerRatingWidget_C", "OnTeamMembershipChanged");

	Params::UMoonbeam_PowerRatingWidget_C_OnTeamMembershipChanged_Params Parms;
