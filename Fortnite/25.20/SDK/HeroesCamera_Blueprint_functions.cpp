...
void AHeroesCamera_Blueprint_C::BP_OnActivated(class AFortPlayerController* PlayerController)
{
	static auto Func = Class->GetFunction("HeroesCamera_Blueprint_C", "BP_OnActivated");

	Params::AHeroesCamera_Blueprint_C_BP_OnActivated_Params Parms;
...
void AHeroesCamera_Blueprint_C::BP_OnDeactivated(class AFortPlayerController* PlayerController)
{
	static auto Func = Class->GetFunction("HeroesCamera_Blueprint_C", "BP_OnDeactivated");

	Params::AHeroesCamera_Blueprint_C_BP_OnDeactivated_Params Parms;
