...
struct ADynamicUIDirectorBase_RemoveScene_Params
{
public:
...
struct ADynamicUIDirectorBase_GetOwningLocalPlayerController_Params
{
public:
...
struct ADynamicUIDirectorBase_GetOwningLocalPlayer_Params
{
public:
...
struct ADynamicUIDirectorBase_GetOwnedEventRouter_Params
{
public:
...
struct ADynamicUIDirectorBase_AddScene_Params
{
public:
	class UDynamicUIScene*                       Scene;                                             // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	class APlayerController*                     Player;                                            // 0x10(0x8)(Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	class UDynamicUIScene*                       Scene;                                             // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class APlayerController*                     Player;                                            // 0x8(0x8)(Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
