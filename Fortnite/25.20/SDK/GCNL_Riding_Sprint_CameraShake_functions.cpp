...
bool AGCNL_Riding_Sprint_CameraShake_C::OnRemove(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static auto Func = Class->GetFunction("GCNL_Riding_Sprint_CameraShake_C", "OnRemove");

	Params::AGCNL_Riding_Sprint_CameraShake_C_OnRemove_Params Parms;
...
void AGCNL_Riding_Sprint_CameraShake_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Riding_Sprint_CameraShake_C", "OnLoopingStartGeneric");

	Params::AGCNL_Riding_Sprint_CameraShake_C_OnLoopingStartGeneric_Params Parms;
