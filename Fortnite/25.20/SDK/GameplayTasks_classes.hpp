...
{
public:
	uint8                                        Pad_37EE[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_37EF[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_37F0[0x21];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_37F1[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_37F2[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_37F5[0x14];                                    // Fixing Size After Last Property..
	uint8                                        BitPad_228 : 1;                                    // Fixing Bit-Field Size..
	uint8                                        bIsNetDirty : 1;                                   // Mask: 0x2, PropSize: 0x10xB4(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_229 : 6;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_37F6[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_37F7[0x10];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_37FC[0x30];                                    // Fixing Size After Last Property..
	TSubclassOf<class AActor>                    ClassToSpawn;                                      // 0xB0(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UGameplayTask_SpawnActor* SpawnActor(FInterfaceProperty_ TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class, bool bSpawnOnlyOnAuthority);
...
public:
	...
	uint8                                        Pad_37FD[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_37FF[0x10];                                    // Fixing Size Of Struct..
