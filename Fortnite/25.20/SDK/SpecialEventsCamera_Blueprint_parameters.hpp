...
struct ASpecialEventsCamera_Blueprint_C_BP_OnActivated_Params
{
public:
...
struct ASpecialEventsCamera_Blueprint_C_BP_OnDeactivated_Params
{
public:
	class AFortPlayerController*                 PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_89C9[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89CA[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_89CC[0x3];                                     // Fixing Size After Last Property..
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors_2;          // 0x90(0x10)(ReferenceParm)
	class ABP_FortniteLobbyLightSwitcher_C*      CallFunc_Array_Get_Item_2;                         // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
