...
public:
	...
	uint8                                        Pad_7F38[0xC];                                     // Fixing Size Of Struct..
};
...
public:
	...
	class AFortScriptedObjectMovement_MovableObjectBase* PathTraveler;                                      // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_7F39[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7F3A[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7F3B[0x4];                                     // Fixing Size After Last Property..
