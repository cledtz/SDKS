...
public:
	...
	class AFortPlayerPawn*                       PlayerPawn;                                        // 0xB48(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_ZipLine_Athena_Harness_C*          ZiplineHarness;                                    // 0xB60(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class AFortAthenaZipline*                    Zipline;                                           // 0xB68(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9943[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9944[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9945[0x4];                                     // Fixing Size After Last Property..
	...
	void BreakNearbyStructures(class AFortPlayerPawn* PlayerPawn, TArray<class AActor*>& K2Node_MakeArray_Array, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, TArray<enum class EObjectTypeQuery>& K2Node_MakeArray_Array_1, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue);
