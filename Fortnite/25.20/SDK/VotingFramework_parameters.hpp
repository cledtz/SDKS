...
public:
	...
	uint8                                        Pad_1691[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1695[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FGameplayTag                          VoteId;                                            // 0x4(0x4)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EVoteState                        VoteState;                                         // 0x8(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1696[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1697[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1698[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_169A[0x4];                                     // Fixing Size Of Struct..
};
