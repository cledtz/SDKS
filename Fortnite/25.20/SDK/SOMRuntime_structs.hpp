...
{
public:
	uint8                                        Pad_7F18[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7F19[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7F1A[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F1B[0x60];                                    // Fixing Size Of Struct..
};
...
{
public:
	TArray<class AFortScriptedObjectMovement_Structure*> Structures;                                        // 0x0(0x10)(Edit, ZeroConstructor, DisableEditOnTemplate, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_7F1C[0x28];                                    // Fixing Size Of Struct..
};
...
public:
	...
	class AFortScriptedObjectMovement_MovableObjectBase* PathTraveler;                                      // 0xD0(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7F1E[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F1F[0xA];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7F20[0x30];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7F21[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	class AFortScriptedObjectMovement_MovableObjectBase* PathTraveler;                                      // 0x30(0x8)(Edit, ZeroConstructor, DisableEditOnTemplate, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_7F22[0x5];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F23[0x60];                                    // Fixing Size Of Struct..
};
