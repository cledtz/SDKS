...
{
public:
	TWeakObjectPtr<class AFortPlayerStateAthena> WeakPSA;                                           // 0x2D0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_85C3[0x28];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_85C4[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_85C6[0x18];                                    // Fixing Size Of Struct..
