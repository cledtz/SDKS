...
struct AB_WilliePete_WaterBodyChild_C_ReceiveBeginPlay_Params
{
public:
};
...
struct AB_WilliePete_WaterBodyChild_C_ExecuteUbergraph_B_WilliePete_WaterBodyChild_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_952C[0x4];                                     // Fixing Size After Last Property..
