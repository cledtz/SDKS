...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GA_Riding_Creature_IsBeingRidden_Passive_C");
		return Clss;
	}
	...
	void ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden_Passive(int32 EntryPoint, bool K2Node_Event_bWasCancelled, const struct FGameplayAbilityActorInfo& K2Node_Event_ActorInfo);
};
