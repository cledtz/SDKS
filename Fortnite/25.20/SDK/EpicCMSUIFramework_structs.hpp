...
public:
	...
	uint8                                        Pad_17F5[0x2];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17F6[0x70];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_17F7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_17F8[0x7];                                     // Fixing Size Of Struct..
};
