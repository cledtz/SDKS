...
{
	static auto Func = Class->GetFunction("GA_Athena_ZipLine_ReachedEnd_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_Athena_ZipLine_ReachedEnd_C", "K2_ActivateAbility");

	Params::UGA_Athena_ZipLine_ReachedEnd_C_K2_ActivateAbility_Params Parms;
