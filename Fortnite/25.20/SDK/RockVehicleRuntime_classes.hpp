...
public:
	...
	uint8                                        BitPad_443 : 5;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_83A7[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_83AA[0x78];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83AB[0xA0];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83AE[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83AF[0x1];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_83B0[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83B1[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_83B2[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83B3[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_83B4[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_83B5[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_83B7[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83B8[0x18];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_83B9[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83BA[0xF];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83BC[0x18];                                    // Fixing Size After Last Property..
	struct FRockScalableFloat                    JumpVelocity;                                      // 0x120(0x30)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_83BD[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_83BE[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_83BF[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_83C0[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83C7[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_83C8[0x128];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_83C9[0x4];                                     // Fixing Size After Last Property..
	...
	class ARockVehicle*                          CachedVehicle;                                     // 0x3A8(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_83CB[0x30];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_83CD[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_83CE[0x100];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83CF[0x10];                                    // Fixing Size After Last Property..
	TArray<class ARockVehicle*>                  RockVehicles;                                      // 0x2A0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
