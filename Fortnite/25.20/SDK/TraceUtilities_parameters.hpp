...
public:
	...
	uint8                                        Pad_86AC[0x6];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_86AD[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	TArray<class FString>                        Channels;                                          // 0x10(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_86AE[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_86AF[0x7];                                     // Fixing Size Of Struct..
};
