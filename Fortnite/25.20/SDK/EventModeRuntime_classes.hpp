...
{
public:
	uint8                                        Pad_81E3[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_81E4[0x8];                                     // Fixing Size After Last Property..
	...
	TSoftObjectPtr<class AActor>                 CurrentlyFocusedActor;                             // 0x1B8(0x28)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_81E5[0x40];                                    // Fixing Size Of Struct..
