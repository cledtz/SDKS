...
{
public:
	uint8                                        Pad_80FD[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_80FE[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_80FF[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_8100[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8101[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8102[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_8103[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_8105[0x18];                                    // Fixing Size Of Struct..
	...
	void ServerTextCommitted(class APlayerController* PlayerController, class FText& NewText);
...
public:
	...
	uint8                                        Pad_8108[0x28];                                    // Fixing Size Of Struct..
