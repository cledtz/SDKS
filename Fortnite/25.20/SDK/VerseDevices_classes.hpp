...
{
public:
	uint8                                        Pad_7A0C[0x78];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A0D[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7A0E[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7A0F[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7A10[0x8];                                     // Fixing Size Of Struct..
