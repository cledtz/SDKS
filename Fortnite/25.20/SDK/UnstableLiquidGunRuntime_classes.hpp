...
public:
	...
	class ALiquidRibbonManager*                  RibbonManager;                                     // 0xAD0(0x8)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2864[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2865[0x4D];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_286A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_286C[0x4];                                     // Fixing Size After Last Property..
	...
	TArray<class AFortLiquidGunProjectile*>      Projectiles_Native;                                // 0x438(0x10)(BlueprintVisible, ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
