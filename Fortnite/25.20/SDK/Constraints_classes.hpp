...
public:
	...
	uint8                                        Pad_222D[0xE];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_2234[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2237[0x6];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_2238[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2239[0x5];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_223A[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_223B[0xD];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_223C[0x8];                                     // Fixing Size After Last Property..
	...
	struct FFilterOptionPerAxis                  AxisFilter;                                        // 0xB0(0x3)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_223D[0x5];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_223E[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_223F[0x6];                                     // Fixing Size Of Struct..
