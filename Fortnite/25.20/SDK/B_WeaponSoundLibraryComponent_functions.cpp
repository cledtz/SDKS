...
{
	static auto Func = Class->GetFunction("B_WeaponSoundLibraryComponent_C", "OnSoundPlayed");
...
void UB_WeaponSoundLibraryComponent_C::OnSoundStopped(const struct FGameplayTag& InEventName, class UAudioComponent* InComponent, bool* bStopped, FInterfaceProperty_ CallFunc_SetTriggerParameter_self_CastInput, bool CallFunc_MatchesTag_ReturnValue)
{
	static auto Func = Class->GetFunction("B_WeaponSoundLibraryComponent_C", "OnSoundStopped");
...
void UB_WeaponSoundLibraryComponent_C::TryHandleFireEvent(const struct FGameplayTag& Event, class UAudioComponent* Component, class AActor* CallFunc_GetOwner_ReturnValue, class AFortWeapon* K2Node_DynamicCast_AsFort_Weapon, bool K2Node_DynamicCast_bSuccess, bool CallFunc_MatchesTag_ReturnValue, int32 CallFunc_GetMagazineAmmoCount_ReturnValue, FInterfaceProperty_ CallFunc_SetIntParameter_self_CastInput, float CallFunc_GetFiringRate_ReturnValue, double CallFunc_SafeDivide_ReturnValue, FInterfaceProperty_ CallFunc_SetFloatParameter_self_CastInput, double CallFunc_SafeDivide_B_ImplicitCast, float CallFunc_SetFloatParameter_InFloat_ImplicitCast)
{
	static auto Func = Class->GetFunction("B_WeaponSoundLibraryComponent_C", "TryHandleFireEvent");
