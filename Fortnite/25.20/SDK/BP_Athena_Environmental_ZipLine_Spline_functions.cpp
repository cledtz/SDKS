...
void ABP_Athena_Environmental_ZipLine_Spline_C::SetInteractionCollision(const struct FVector& CallFunc_GetLocationAtSplinePoint_ReturnValue, int32 CallFunc_GetNumberOfSplinePoints_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, int32 CallFunc_Subtract_IntInt_ReturnValue, const struct FVector& CallFunc_GetLocationAtSplinePoint_ReturnValue_1, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult_1)
{
	...
	Params::ABP_Athena_Environmental_ZipLine_Spline_C_SetInteractionCollision_Params Parms;
...
void ABP_Athena_Environmental_ZipLine_Spline_C::SetCableTilingBySplineLength(class UMeshComponent* Target, float CallFunc_GetSplineLength_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, int32 CallFunc_FTrunc_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_Divide_DoubleDouble_A_ImplicitCast, float CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast)
{
	...
	Params::ABP_Athena_Environmental_ZipLine_Spline_C_SetCableTilingBySplineLength_Params Parms;
...
void ABP_Athena_Environmental_ZipLine_Spline_C::ReceiveBeginPlay()
{
	...
	Params::ABP_Athena_Environmental_ZipLine_Spline_C_ReceiveBeginPlay_Params Parms;
...
void ABP_Athena_Environmental_ZipLine_Spline_C::HandlePoleDied(class AActor* DamagedActor, float Damage, class AController* InstigatedBy, class AActor* DamageCauser, const struct FVector& HitLocation, class UPrimitiveComponent* FHitComponent, class FName BoneName, const struct FVector& Momentum)
{
	...
	Params::ABP_Athena_Environmental_ZipLine_Spline_C_HandlePoleDied_Params Parms;
