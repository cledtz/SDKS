...
{
public:
	uint8                                        Pad_9ED7[0x6];                                     // Fixing Size After Last Property..
	...
	class AFortReplaySpectatorAthena*            ReplayController;                                  // 0x998(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
