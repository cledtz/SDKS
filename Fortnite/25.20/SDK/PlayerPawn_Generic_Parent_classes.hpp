...
public:
	...
	uint8                                        Pad_7BDC[0x4];                                     // Fixing Size After Last Property..
	class AActor*                                CurrentWaterMeshActor;                             // 0x46F8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                         IsInWater;                                         // 0x4700(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7BDD[0x7];                                     // Fixing Size After Last Property..
