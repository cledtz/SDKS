...
{
	static auto Func = Class->GetFunction("FortActivityTileDetailsDisplay", "IsActivityLocked");
...
{
	static auto Func = Class->GetFunction("FortActivityTileDetailsDisplay", "GetActivityCreatorDisplayText");
