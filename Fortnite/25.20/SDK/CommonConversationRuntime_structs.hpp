...
public:
	...
	uint8                                        Pad_419C[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	class AActor*                                Actor;                                             // 0x0(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                          ParticipantID;                                     // 0x8(0x4)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_419D[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A0[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A2[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_41A3[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_41A4[0x20];                                    // Fixing Size Of Struct..
};
