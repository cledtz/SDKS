...
{
	static auto Func = Class->GetFunction("VoiceChannelSettings_C", "OnComplete_CAAD0AF4467900CF5BC6B8B8CA0C330F");
...
{
	static auto Func = Class->GetFunction("VoiceChannelSettings_C", "ShowVoiceSettingsButton");
...
{
	static auto Func = Class->GetFunction("VoiceChannelSettings_C", "BndEvt__VoiceChannelSettings_Button_VoiceSettings_K2Node_ComponentBoundEvent_3_CommonButtonClicked__DelegateSignature");
