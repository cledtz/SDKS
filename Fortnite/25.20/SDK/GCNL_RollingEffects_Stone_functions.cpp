...
void AGCNL_RollingEffects_Stone_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_RollingEffects_Stone_C", "OnRemovalGeneric");

	Params::AGCNL_RollingEffects_Stone_C_OnRemovalGeneric_Params Parms;
...
void AGCNL_RollingEffects_Stone_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_RollingEffects_Stone_C", "OnLoopingStartGeneric");

	Params::AGCNL_RollingEffects_Stone_C_OnLoopingStartGeneric_Params Parms;
...
// class AProp_PhysicsBoulder_Parent_C*K2Node_DynamicCast_AsProp_Physics_Boulder_Parent                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AGCNL_RollingEffects_Stone_C::ExecuteUbergraph_GCNL_RollingEffects_Stone(int32 EntryPoint, class AActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, class AProp_PhysicsBoulder_Parent_C* K2Node_DynamicCast_AsProp_Physics_Boulder_Parent, bool K2Node_DynamicCast_bSuccess, class AActor* K2Node_Event_MyTarget_1, const struct FGameplayCueParameters& K2Node_Event_Parameters_1, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_1, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_1, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance, class ADecalActor* K2Node_Event_BurstDecalInstance, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, class AProp_PhysicsBoulder_Parent_C* K2Node_DynamicCast_AsProp_Physics_Boulder_Parent_1, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	Parms.K2Node_DynamicCast_AsProp_Physics_Boulder_Parent = K2Node_DynamicCast_AsProp_Physics_Boulder_Parent;
	...
	Parms.K2Node_DynamicCast_AsProp_Physics_Boulder_Parent_1 = K2Node_DynamicCast_AsProp_Physics_Boulder_Parent_1;
