...
{
	static auto Func = Class->GetFunction("ConstantQNRT", "GetNormalizedChannelConstantQAtTime");
...
{
	static auto Func = Class->GetFunction("ConstantQNRT", "GetChannelConstantQAtTime");
...
{
	static auto Func = Class->GetFunction("LoudnessNRT", "GetNormalizedLoudnessAtTime");
...
{
	static auto Func = Class->GetFunction("LoudnessNRT", "GetNormalizedChannelLoudnessAtTime");
...
{
	static auto Func = Class->GetFunction("LoudnessNRT", "GetLoudnessAtTime");
...
{
	static auto Func = Class->GetFunction("LoudnessNRT", "GetChannelLoudnessAtTime");
...
{
	static auto Func = Class->GetFunction("OnsetNRT", "GetNormalizedChannelOnsetsBetweenTimes");
...
{
	static auto Func = Class->GetFunction("OnsetNRT", "GetChannelOnsetsBetweenTimes");
...
{
	static auto Func = Class->GetFunction("SynesthesiaSpectrumAnalyzer", "GetNumCenterFrequencies");
...
{
	static auto Func = Class->GetFunction("SynesthesiaSpectrumAnalyzer", "GetCenterFrequencies");
