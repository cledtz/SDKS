...
public:
	...
	uint8                                        Pad_953A[0x4];                                     // Fixing Size After Last Property..
	class AFortPlayerController*                 PlayerController;                                  // 0xB40(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GA_Vehicle_ExitHoldEvent_C");
		return Clss;
	}
