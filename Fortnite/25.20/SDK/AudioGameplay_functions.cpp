...
// (Final, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// FInterfaceProperty_                NewExtension                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAudioComponentGroup::RemoveExtension(FInterfaceProperty_ NewExtension)
{
...
void UAudioComponentGroup::AddExtension(FInterfaceProperty_ NewExtension)
{
