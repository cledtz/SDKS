...
public:
	...
	uint8                                        Pad_3EA5[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3EA6[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3EA7[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3EA8[0x8];                                     // Fixing Size After Last Property..
