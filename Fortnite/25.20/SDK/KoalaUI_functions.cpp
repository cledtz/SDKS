...
void UKoalaHUDWidget::HandlePlayerPawnEmoteStopped(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
...
void UKoalaHUDWidget::HandleLocalPlayerKilledPlayer(class AFortPlayerStateAthena* Player)
{
