...
struct AFortnitePartyBackdrop_Camera_C_BP_OnActivated_Params
{
public:
...
struct AFortnitePartyBackdrop_Camera_C_BP_OnDeactivated_Params
{
public:
	class AFortPlayerController*                 PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
struct AFortnitePartyBackdrop_Camera_C_Reset_Location_Params
{
public:
};
...
struct AFortnitePartyBackdrop_Camera_C_ManualActivate_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_9CAF[0x4];                                     // Fixing Size After Last Property..
	...
	class AFortPlayerController*                 K2Node_Event_PlayerController_1;                   // 0x38(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors;            // 0x40(0x10)(ReferenceParm)
	int32                                        Temp_int_Array_Index_Variable_2;                   // 0x50(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9CB0[0x4];                                     // Fixing Size After Last Property..
	class ATVPostProcessBP_C*                    CallFunc_Array_Get_Item;                           // 0x58(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AFortPlayerController*                 K2Node_Event_PlayerController;                     // 0x68(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x70(0x10)(ReferenceParm)
	class ABP_FortniteLobbyLightSwitcher_C*      CallFunc_Array_Get_Item_1;                         // 0x80(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors_2;          // 0x98(0x10)(ReferenceParm)
	class ABP_FortniteLobbyLightSwitcher_C*      CallFunc_Array_Get_Item_2;                         // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9CB4[0x3];                                     // Fixing Size After Last Property..
