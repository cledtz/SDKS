...
{
public:
	uint8                                        Pad_3B15[0x38];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3B16[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3B17[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3B1A[0x58];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3B1B[0x1F];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3B1C[0x38];                                    // Fixing Size Of Struct..
