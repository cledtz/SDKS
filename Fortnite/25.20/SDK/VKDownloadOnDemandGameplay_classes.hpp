...
{
public:
	uint8                                        Pad_85C7[0x108];                                   // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_85C8[0x78];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_85C9[0x90];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_85CA[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_85CB[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_85CC[0x48];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_85CD[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_85CE[0x30];                                    // Fixing Size After Last Property..
