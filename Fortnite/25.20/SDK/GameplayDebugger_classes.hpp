...
{
public:
	class APlayerController*                     OwnerPC;                                           // 0x290(0x8)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_37DC[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_37DD[0x68];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_37DF[0xC0];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        BitPad_226 : 7;                                    // Fixing Bit-Field Size..
...
public:
	...
	uint8                                        Pad_37E1[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_37E2[0x8];                                     // Fixing Size After Last Property..
	...
	TArray<class AGameplayDebuggerCategoryReplicator*> PendingRegistrations;                              // 0x2A8(0x10)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_37E3[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_37E4[0x68];                                    // Fixing Size Of Struct..
