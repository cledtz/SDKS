...
void ATODM_Disabled_C::SetReflectionQualityMPC(class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, int32 CallFunc_GetReflectionQuality_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, float CallFunc_SetScalarParameterValue_ParameterValue_ImplicitCast)
{
	...
	Params::ATODM_Disabled_C_SetReflectionQualityMPC_Params Parms;
...
void ATODM_Disabled_C::SetGlobalIlluminationMPC(class UGameUserSettings* CallFunc_GetGameUserSettings_ReturnValue, int32 CallFunc_GetGlobalIlluminationQuality_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue_1, int32 CallFunc_Clamp_ReturnValue, int32 CallFunc_Clamp_ReturnValue_1, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue_1, float CallFunc_SetScalarParameterValue_ParameterValue_ImplicitCast, float CallFunc_SetScalarParameterValue_ParameterValue_ImplicitCast_1)
{
	...
	Params::ATODM_Disabled_C_SetGlobalIlluminationMPC_Params Parms;
...
void ATODM_Disabled_C::Update_Scalabilty_Settings()
{
	...
	Params::ATODM_Disabled_C_Update_Scalabilty_Settings_Params Parms;
