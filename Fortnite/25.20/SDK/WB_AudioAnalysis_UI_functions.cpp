...
{
	static auto Func = Class->GetFunction("WB_AudioAnalysis_UI_C", "AddScalarParameter");
...
{
	static auto Func = Class->GetFunction("WB_AudioAnalysis_UI_C", "AddVectorParameter");
...
{
	static auto Func = Class->GetFunction("WB_AudioAnalysis_UI_C", "ClearParameters");
...
{
	static auto Func = Class->GetFunction("WB_AudioAnalysis_UI_C", "ExecuteUbergraph_WB_AudioAnalysis_UI");
