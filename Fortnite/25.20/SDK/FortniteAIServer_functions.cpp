...
void UFortAthenaAIBotEvaluator_Harvest::HandleUnconverted(class AFortPawn* UnconvertedPawn, enum class EUnconvertReason UnconvertReason)
{
	static auto Func = Class->GetFunction("FortAthenaAIBotEvaluator_Harvest", "HandleUnconverted");
...
void UFortAthenaAIBotEvaluator_Harvest::HandleConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn)
{
	static auto Func = Class->GetFunction("FortAthenaAIBotEvaluator_Harvest", "HandleConverted");
...
{
	static auto Func = Class->GetFunction("FortAthenaAIBotEvaluator_SelectNextDynamicPOI", "OnGamePhaseLogicReady");
