...
public:
	...
	class AB_Athena_Zipline_Ascender_C*          K2Node_DynamicCast_AsB_Athena_Zipline_Ascender;    // 0x110(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x118(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A30C[0x7];                                     // Fixing Size After Last Property..
