...
void UAthenaFunctionLibrary_C::SpawnLootFromArray(TArray<struct FFortItemEntry>& Array, const struct FVector& Position, const struct FVector& Direction, int32 OverrideMaxStackCount, bool bToss, bool bRandomRotation, bool bBlockedFromAutoPickup, int32 PickupInstigatorHandle, enum class EFortPickupSourceTypeFlag SourceType, enum class EFortPickupSpawnSource Source, class AFortPlayerController* OptionalOwnerPC, bool bPickupOnlyRelevantToOwner, class UObject* __WorldContext, TArray<class AFortPickup*>* ItemPickupsSpawned, const TArray<class AFortPickup*>& PickupsSpawned, class FName LootTierData, int32 CallFunc_Array_Length_ReturnValue, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, const struct FFortItemEntry& CallFunc_Array_Get_Item, class UFortWorldItemDefinition* K2Node_DynamicCast_AsFort_World_Item_Definition, bool K2Node_DynamicCast_bSuccess, class AFortPickup* CallFunc_K2_SpawnPickupInWorld_ReturnValue, int32 CallFunc_Array_AddUnique_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "SpawnLootFromArray");
...
void UAthenaFunctionLibrary_C::SetPOITextWithContextTag(const struct FGameplayTag& POI_Tag, const struct FGameplayTagContainer& Context_Tags, class UObject* __WorldContext, int32 CallFunc_GetNumGameplayTagsInContainer_ReturnValue, bool CallFunc_IsServer_ReturnValue, bool CallFunc_GreaterEqual_IntInt_ReturnValue, class AFortGameStateAthena* CallFunc_GetGameStateAthena_ReturnValue, const struct FGameplayTagContainer& CallFunc_MakeGameplayTagContainerFromTag_ReturnValue, class UGSC_MiniMapDataOverride_C* CallFunc_GetComponentByClass_ReturnValue, int32 CallFunc_GetNumGameplayTagsInContainer_ReturnValue_1, bool CallFunc_GreaterEqual_IntInt_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "SetPOITextWithContextTag");
...
void UAthenaFunctionLibrary_C::GetPlayerGroundedZ(class AFortPlayerPawn* PlayerPawn, class UObject* __WorldContext, double* Ground_Z, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, double CallFunc_Subtract_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_B_ImplicitCast)
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "GetPlayerGroundedZ");
...
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "ShouldAllowDeathEffects");
...
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "GetActorMeshExtents");
...
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "UnclampedLerp");
...
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "MakeSimpleFortEffectContext");
...
{
	static auto Func = Class->GetFunction("AthenaFunctionLibrary_C", "SpawnLootFromTable");
...
// class AActor*                      _CurrentActorBeingLaunched                                       (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
