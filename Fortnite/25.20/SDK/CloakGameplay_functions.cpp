...
float AFortGameCueNotifyLoop_Cloak::TickVisibilityLevel(float DeltaSeconds)
{
	static auto Func = Class->GetFunction("FortGameCueNotifyLoop_Cloak", "TickVisibilityLevel");

	Params::AFortGameCueNotifyLoop_Cloak_TickVisibilityLevel_Params Parms;
...
bool AFortGameCueNotifyLoop_Cloak::SetModifierEnabled(class FName& ModifierName, bool bNewEnabled)
{
	static auto Func = Class->GetFunction("FortGameCueNotifyLoop_Cloak", "SetModifierEnabled");

	Params::AFortGameCueNotifyLoop_Cloak_SetModifierEnabled_Params Parms;
...
bool AFortGameCueNotifyLoop_Cloak::SetModifierCanBeEnabled(class FName& ModifierName, bool bNewCanBeEnabled)
{
	static auto Func = Class->GetFunction("FortGameCueNotifyLoop_Cloak", "SetModifierCanBeEnabled");

	Params::AFortGameCueNotifyLoop_Cloak_SetModifierCanBeEnabled_Params Parms;
...
bool AFortGameCueNotifyLoop_Cloak::GetCurrentModifierValues(float* OutVisibilityMultiplier, float* OutVisibilityAddition, class FName& ModifierName)
{
	static auto Func = Class->GetFunction("FortGameCueNotifyLoop_Cloak", "GetCurrentModifierValues");

	Params::AFortGameCueNotifyLoop_Cloak_GetCurrentModifierValues_Params Parms;
