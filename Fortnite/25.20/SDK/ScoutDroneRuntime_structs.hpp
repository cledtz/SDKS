...
{
public:
	TWeakObjectPtr<class AFortScoutDrone>        DeployedDrone;                                     // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_8047[0x4];                                     // Fixing Size After Last Property..
	TArray<class AActor*>                        MarkedActors;                                      // 0x8(0x10)(BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_8048[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	TArray<class AActor*>                        Items;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	class AFortPawn*                             DBNOPawn;                                          // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_8049[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_804A[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_804B[0x4];                                     // Fixing Size Of Struct..
};
