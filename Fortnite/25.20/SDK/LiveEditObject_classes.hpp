...
{
public:
	uint8                                        Pad_437B[0x48];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_437C[0xF8];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_437D[0x378];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_437E[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_437F[0x230];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4380[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4381[0x128];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4382[0x4];                                     // Fixing Size After Last Property..
