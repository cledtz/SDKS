...
class UGameplayTask_SpawnActor* UGameplayTask_SpawnActor::SpawnActor(FInterfaceProperty_ TaskOwner, const struct FVector& SpawnLocation, const struct FRotator& SpawnRotation, TSubclassOf<class AActor> Class, bool bSpawnOnlyOnAuthority)
{
