...
{
public:
	uint8                                        Pad_3DDE[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DDF[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DE1[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DE2[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DE3[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3DE4[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DE5[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3DE6[0x4];                                     // Fixing Size Of Struct..
};
