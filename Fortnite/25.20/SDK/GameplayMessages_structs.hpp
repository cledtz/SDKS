...
public:
	...
	uint8                                        Pad_37AC[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_37AD[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_37AE[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_37AF[0xA0];                                    // Fixing Size Of Struct..
};
