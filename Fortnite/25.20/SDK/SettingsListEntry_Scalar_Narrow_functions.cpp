...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "GetPrimaryGamepadFocusWidget");
...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "OnValueChanged");
...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "OnDefaultValueChanged");
...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("SettingsListEntry_Scalar_Narrow_C", "ExecuteUbergraph_SettingsListEntry_Scalar_Narrow");
