...
public:
	...
	class UPostProcessComponent*                 FullScreenTVPP_OnlyMaterialModified;               // 0x2B8(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
