...
void USmartObjectComponent::ReceiveOnEvent(struct FSmartObjectEventData& EventData, class AActor* Interactor)
{
...
bool USmartObjectSubsystem::FindSmartObjects_BP(struct FSmartObjectRequest& Request, TArray<struct FSmartObjectRequestResult>* OutResults, class AActor* UserActor)
{
...
bool USmartObjectSubsystem::FindSmartObjects(struct FSmartObjectRequest& Request, TArray<struct FSmartObjectRequestResult>* OutResults, class AActor* UserActor)
{
...
struct FSmartObjectRequestResult USmartObjectSubsystem::FindSmartObject(struct FSmartObjectRequest& Request, class AActor* UserActor)
{
...
struct FSmartObjectClaimHandle USmartObjectSubsystem::Claim(struct FSmartObjectRequestResult& RequestResult, class AActor* UserActor)
{
...
void ASmartObjectTestingActor::RunTests()
{
	...
	Params::ASmartObjectTestingActor_RunTests_Params Parms;
...
void ASmartObjectTestingActor::ResetTests()
{
	...
	Params::ASmartObjectTestingActor_ResetTests_Params Parms;
