...
void AGCN_RezOut_C::Set_Timeline_Playrates(float CallFunc_SetPlayRate_NewRate_ImplicitCast, float CallFunc_SetPlayRate_NewRate_ImplicitCast_1)
{
	static auto Func = Class->GetFunction("GCN_RezOut_C", "Set Timeline Playrates");

	Params::AGCN_RezOut_C_Set_Timeline_Playrates_Params Parms;
...
void AGCN_RezOut_C::Clean_Up_Teleportation_Light(bool CallFunc_IsValid_ReturnValue)
{
	static auto Func = Class->GetFunction("GCN_RezOut_C", "Clean-Up Teleportation Light");

	Params::AGCN_RezOut_C_Clean_Up_Teleportation_Light_Params Parms;
...
void AGCN_RezOut_C::TFX_GlowCharacterMesh__FinishedFunc()
{
	...
	Params::AGCN_RezOut_C_TFX_GlowCharacterMesh__FinishedFunc_Params Parms;
...
void AGCN_RezOut_C::TFX_GlowCharacterMesh__UpdateFunc()
{
	...
	Params::AGCN_RezOut_C_TFX_GlowCharacterMesh__UpdateFunc_Params Parms;
...
void AGCN_RezOut_C::TFX_ResOutCharacterMesh__FinishedFunc()
{
	...
	Params::AGCN_RezOut_C_TFX_ResOutCharacterMesh__FinishedFunc_Params Parms;
...
void AGCN_RezOut_C::TFX_ResOutCharacterMesh__UpdateFunc()
{
	...
	Params::AGCN_RezOut_C_TFX_ResOutCharacterMesh__UpdateFunc_Params Parms;
...
void AGCN_RezOut_C::EndVFX()
{
	...
	Params::AGCN_RezOut_C_EndVFX_Params Parms;
...
void AGCN_RezOut_C::OnBurstGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCN_RezOut_C::Pre_Sequence_Change()
{
	...
	Params::AGCN_RezOut_C_Pre_Sequence_Change_Params Parms;
...
void AGCN_RezOut_C::TriggerVFX()
{
	...
	Params::AGCN_RezOut_C_TriggerVFX_Params Parms;
