...
{
public:
	uint8                                        Pad_7E2A[0x1E0];                                   // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7E2B[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7E2C[0x78];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E2D[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E2E[0x4];                                     // Fixing Size After Last Property..
	...
	class AFortPawn*                             InstigatedBy;                                      // 0x120(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                DamageCauser;                                      // 0x128(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
