...
struct AGCNL_Athena_Player_Sliding_Speedlines_C_RefreshDustStateTimer_Params
{
public:
...
struct AGCNL_Athena_Player_Sliding_Speedlines_C_OnLoopingStartGeneric_Params
{
public:
...
struct AGCNL_Athena_Player_Sliding_Speedlines_C_OnRemovalGeneric_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Athena_Player_Sliding_Speedlines_C_On_View_Target_Changed_Params
{
public:
	...
	class AActor*                                OldViewTarget;                                     // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                NewViewTarget;                                     // 0x10(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};

// 0x0 (0x0 - 0x0)
// Function GCNL_Athena_Player_Sliding_Speedlines.GCNL_Athena_Player_Sliding_Speedlines_C.UpdateDustState
struct AGCNL_Athena_Player_Sliding_Speedlines_C_UpdateDustState_Params
{
public:
};
...
struct AGCNL_Athena_Player_Sliding_Speedlines_C_ExecuteUbergraph_GCNL_Athena_Player_Sliding_Speedlines_Params
{
public:
	...
	uint8                                        Pad_80BF[0x7];                                     // Fixing Size After Last Property..
	class APawn*                                 K2Node_DynamicCast_AsPawn;                         // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x120(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_80C0[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_80C1[0x5];                                     // Fixing Size After Last Property..
	...
	class AFortPlayerController*                 K2Node_CustomEvent_PlayerController;               // 0x240(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_CustomEvent_OldViewTarget;                  // 0x248(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_CustomEvent_NewViewTarget;                  // 0x250(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_80C2[0x6];                                     // Fixing Size After Last Property..
	struct FTimerHandle                          CallFunc_K2_SetTimer_ReturnValue;                  // 0x260(0x8)(NoDestructor, HasGetValueTypeHash)
	class APlayerController*                     CallFunc_GetLocalViewingPlayerController_ReturnValue; // 0x268(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
