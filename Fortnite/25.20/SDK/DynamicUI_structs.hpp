...
public:
	...
	uint8                                        Pad_3F55[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3F56[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3F57[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3F59[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3F5A[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3F5B[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3F5C[0x40];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3F5D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F5E[0x3B];                                    // Fixing Size Of Struct..
};
