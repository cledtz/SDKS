...
{
public:
	uint8                                        Pad_7F2D[0x68];                                    // Fixing Size Of Struct..
...
{
public:
	float                                        GenerationZTraceHeight;                            // 0x4E8(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                        CubeSpacingFactor;                                 // 0x4EC(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                        CubeAngleLimitDegrees;                             // 0x4F0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7F2E[0x4];                                     // Fixing Size After Last Property..
	class UFortCorruptionSequenceData*           CorruptionSequence;                                // 0x4F8(0x8)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7F2F[0x8];                                     // Fixing Size After Last Property..
	TArray<struct FTravelerStepCorruptionOverrideData> TravelerCorruptionStepPercentOverrides;            // 0x508(0x10)(Edit, ZeroConstructor, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7F30[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7F34[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7F35[0x1F];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7F36[0x50];                                    // Fixing Size Of Struct..
