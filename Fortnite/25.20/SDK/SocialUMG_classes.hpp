...
{
public:
	uint8                                        Pad_438C[0x68];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_438E[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_438F[0x18];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4390[0xE8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4391[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4392[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4393[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4394[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4395[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4396[0x80];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4397[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4398[0x30];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4399[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_439A[0xC];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_439B[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	class UMenuAnchor*                           MenuAnchor_Actions;                                // 0x14E0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_439C[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_439D[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_439E[0x108];                                   // Fixing Size After Last Property..
	...
	uint8                                        Pad_439F[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_43A0[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_43A1[0x70];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_43A2[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_43A3[0x28];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_43A4[0x40];                                    // Fixing Size Of Struct..
