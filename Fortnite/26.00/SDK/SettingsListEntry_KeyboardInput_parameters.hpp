...
public:
	...
	uint8                                        Pad_8AD7[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8ADC[0x3];                                     // Fixing Size After Last Property 
	struct FGeometry                             K2Node_Event_MyGeometry;                           // 0x54(0x38)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_8ADD[0x4];                                     // Fixing Size After Last Property 
