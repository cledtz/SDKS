...
// TScriptInterface<class UFortInventoryOwnerInterface>InventoryOwner                                                   (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
