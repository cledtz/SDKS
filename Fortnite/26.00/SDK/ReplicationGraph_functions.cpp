...
class UClass* UReplicationGraphDebugActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UReplicationGraphDebugActor* UReplicationGraphDebugActor::GetDefaultObj()
{
	static class UReplicationGraphDebugActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UReplicationGraphDebugActor*>(UReplicationGraphDebugActor::StaticClass()->DefaultObject);
