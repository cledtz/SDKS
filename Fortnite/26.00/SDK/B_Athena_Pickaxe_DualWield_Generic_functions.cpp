...
class UClass* UB_Athena_Pickaxe_DualWield_Generic_C::StaticClass()
{
...
class UB_Athena_Pickaxe_DualWield_Generic_C* UB_Athena_Pickaxe_DualWield_Generic_C::GetDefaultObj()
{
	static class UB_Athena_Pickaxe_DualWield_Generic_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_Athena_Pickaxe_DualWield_Generic_C*>(UB_Athena_Pickaxe_DualWield_Generic_C::StaticClass()->DefaultObject);
