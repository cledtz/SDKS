...
public:
	...
	uint8                                        Pad_32E6[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_32EE[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_32FB[0x68];                                    // Fixing Size After Last Property 
	...
	static class UClass* StaticClass();
	static class UFortAscenderZipline* GetDefaultObj();
