...
struct UFortGameplayCueNotify_CrownWear_RemoveCrownWear_Params
{
public:
};
...
struct UFortGameplayCueNotify_CrownWear_OnIntroFXTimelineTick_Params
{
public:
	struct FVector                               CurveValue;                                        // 0x0(0x18)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x10 (0x10 - 0x0)
// Function VictoryCrownsRuntime.FortGameplayCueNotify_CrownWear.ApplyCrownWear
struct UFortGameplayCueNotify_CrownWear_ApplyCrownWear_Params
{
public:
	TArray<class UFXSystemComponent*>            ParticleComponents;                                // 0x0(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_4A08[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4A13[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UFortItem*                             CrownItem;                                         // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4A19[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UFortItem*                             CrownItem;                                         // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4A1D[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UFortItem*                             CrownItem;                                         // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4A28[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4A47[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4A78[0x7];                                     // Fixing Size Of Struct
};
