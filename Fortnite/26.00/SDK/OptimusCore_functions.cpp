...
class UClass* UOptimusDeprecatedExecutionDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptimusDeprecatedExecutionDataInterface");

	return Clss;
}


// OptimusDeprecatedExecutionDataInterface OptimusCore.Default__OptimusDeprecatedExecutionDataInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class UOptimusDeprecatedExecutionDataInterface* UOptimusDeprecatedExecutionDataInterface::GetDefaultObj()
{
	static class UOptimusDeprecatedExecutionDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptimusDeprecatedExecutionDataInterface*>(UOptimusDeprecatedExecutionDataInterface::StaticClass()->DefaultObject);
...
class UClass* UOptimusSkinnedMeshVertexAttributeDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptimusSkinnedMeshVertexAttributeDataInterface");

	return Clss;
}


// OptimusSkinnedMeshVertexAttributeDataInterface OptimusCore.Default__OptimusSkinnedMeshVertexAttributeDataInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class UOptimusSkinnedMeshVertexAttributeDataInterface* UOptimusSkinnedMeshVertexAttributeDataInterface::GetDefaultObj()
{
	static class UOptimusSkinnedMeshVertexAttributeDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptimusSkinnedMeshVertexAttributeDataInterface*>(UOptimusSkinnedMeshVertexAttributeDataInterface::StaticClass()->DefaultObject);
...
class UClass* UOptimusSkinnedMeshVertexAttributeDataProvider::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptimusSkinnedMeshVertexAttributeDataProvider");

	return Clss;
}


// OptimusSkinnedMeshVertexAttributeDataProvider OptimusCore.Default__OptimusSkinnedMeshVertexAttributeDataProvider
// (Public, ClassDefaultObject, ArchetypeObject)

class UOptimusSkinnedMeshVertexAttributeDataProvider* UOptimusSkinnedMeshVertexAttributeDataProvider::GetDefaultObj()
{
	static class UOptimusSkinnedMeshVertexAttributeDataProvider* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptimusSkinnedMeshVertexAttributeDataProvider*>(UOptimusSkinnedMeshVertexAttributeDataProvider::StaticClass()->DefaultObject);
...
class UClass* UOptimusCustomComputeKernelDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptimusCustomComputeKernelDataInterface");

	return Clss;
}


// OptimusCustomComputeKernelDataInterface OptimusCore.Default__OptimusCustomComputeKernelDataInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class UOptimusCustomComputeKernelDataInterface* UOptimusCustomComputeKernelDataInterface::GetDefaultObj()
{
	static class UOptimusCustomComputeKernelDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptimusCustomComputeKernelDataInterface*>(UOptimusCustomComputeKernelDataInterface::StaticClass()->DefaultObject);
...
class UClass* UOptimusCustomComputeKernelDataProvider::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptimusCustomComputeKernelDataProvider");

	return Clss;
}


// OptimusCustomComputeKernelDataProvider OptimusCore.Default__OptimusCustomComputeKernelDataProvider
// (Public, ClassDefaultObject, ArchetypeObject)

class UOptimusCustomComputeKernelDataProvider* UOptimusCustomComputeKernelDataProvider::GetDefaultObj()
{
	static class UOptimusCustomComputeKernelDataProvider* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptimusCustomComputeKernelDataProvider*>(UOptimusCustomComputeKernelDataProvider::StaticClass()->DefaultObject);
