...
class UClass* UB_EmotePreviewDisplay_C::StaticClass()
{
...
class UB_EmotePreviewDisplay_C* UB_EmotePreviewDisplay_C::GetDefaultObj()
{
	static class UB_EmotePreviewDisplay_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_EmotePreviewDisplay_C*>(UB_EmotePreviewDisplay_C::StaticClass()->DefaultObject);
