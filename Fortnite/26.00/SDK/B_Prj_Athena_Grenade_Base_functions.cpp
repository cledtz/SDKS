...
class UClass* UB_Prj_Athena_Grenade_Base_C::StaticClass()
{
...
class UB_Prj_Athena_Grenade_Base_C* UB_Prj_Athena_Grenade_Base_C::GetDefaultObj()
{
	static class UB_Prj_Athena_Grenade_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_Prj_Athena_Grenade_Base_C*>(UB_Prj_Athena_Grenade_Base_C::StaticClass()->DefaultObject);
