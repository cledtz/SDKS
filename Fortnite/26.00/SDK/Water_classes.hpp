...
public:
	...
	uint8                                        Pad_1C9B[0x90];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1CA7[0x50];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1CA9[0x68];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UBuoyancyManager* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1CAE[0x5];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1CC3[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1CC5[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1CC7[0x18];                                    // Fixing Size Of Struct
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x568(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1CD9[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1CF7[0x8];                                     // Fixing Size After Last Property 
	...
	static class UClass* StaticClass();
	static class UWaterBody* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1D43[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1D45[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1D46[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1D47[0x3];                                     // Fixing Size After Last Property 
	...
	TSoftObjectPtr<class UWaterZone>             OwningWaterZone;                                   // 0xDD0(0x20)(Edit, DisableEditOnTemplate, EditConst, AdvancedDisplay, Protected, TextExportTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UWaterZone>             WaterZoneOverride;                                 // 0xDF0(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FPostProcessSettings                  CurrentPostProcessSettings;                        // 0xE10(0x6E0)(Transient, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UNavAreaBase>              WaterNavAreaClass;                                 // 0x14F0(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	double                                       FixedWaterDepth;                                   // 0x14F8(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

	static class UClass* StaticClass();
	static class UWaterBodyComponent* GetDefaultObj();

	void SetWaterZoneOverride(TSoftObjectPtr<class UWaterZone>& InWaterZoneOverride);
...
public:
	...
	static class UClass* StaticClass();
	static class UWaterBodyCustom* GetDefaultObj();
...
{
public:
	class UStaticMeshComponent*                  MeshComp;                                          // 0x1500(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_1D53[0x7];                                     // Fixing Size After Last Property 
	...
	static class UClass* StaticClass();
	static class UWaterBodyExclusionVolume* GetDefaultObj();
...
{
public:
	uint8                                        Pad_1D70[0x8];                                     // Fixing Size After Last Property 
	class UWaterSplineComponent*                 SplineComp;                                        // 0x298(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)

	static class UClass* StaticClass();
	static class UWaterBodyIsland* GetDefaultObj();
...
public:
	...
	static class UClass* StaticClass();
	static class UWaterBodyLake* GetDefaultObj();
...
{
public:
	class UStaticMeshComponent*                  LakeMeshComp;                                      // 0x1500(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULakeCollisionComponent*               LakeCollision;                                     // 0x1508(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UClass* StaticClass();
	static class UWaterBodyOcean* GetDefaultObj();
...
{
public:
	TArray<class UOceanBoxCollisionComponent*>   CollisionBoxes;                                    // 0x1500(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UOceanCollisionComponent*>      CollisionHullSets;                                 // 0x1510(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	struct FVector                               CollisionExtents;                                  // 0x1520(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                             OceanExtents;                                      // 0x1538(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                             SavedZoneLocation;                                 // 0x1548(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_1DCE[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UWaterBodyRiver* GetDefaultObj();
...
{
public:
	TArray<class USplineMeshComponent*>          SplineMeshComponents;                              // 0x1500(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
	class UMaterialInterface*                    LakeTransitionMaterial;                            // 0x1510(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*              LakeTransitionMID;                                 // 0x1518(0x8)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                    OceanTransitionMaterial;                           // 0x1520(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*              OceanTransitionMID;                                // 0x1528(0x8)(Edit, ZeroConstructor, DisableEditOnTemplate, Transient, EditConst, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	static class UClass* StaticClass();
	static class UWaterBrushActorInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1E4A[0x98];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E4B[0xF];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1E53[0x7];                                     // Fixing Size After Last Property 
	TSoftObjectPtr<class UMaterialParameterCollection> MaterialParameterCollection;                       // 0x38(0x20)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        WaterBodyIconWorldZOffset;                         // 0x58(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  DefaultWaterCollisionProfileName;                  // 0x5C(0x4)(Edit, ZeroConstructor, Config, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMaterialInterface>     DefaultWaterInfoMaterial;                          // 0x60(0x20)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UWaterBodyRiverComponent>  WaterBodyRiverComponentClass;                      // 0x80(0x8)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UWaterBodyLakeComponent>   WaterBodyLakeComponentClass;                       // 0x88(0x8)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UWaterBodyOceanComponent>  WaterBodyOceanComponentClass;                      // 0x90(0x8)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UWaterBodyCustomComponent> WaterBodyCustomComponentClass;                     // 0x98(0x8)(Edit, ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bWarnOnMismatchOceanExtent;                        // 0xA0(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1E5B[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1E64[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1E93[0x38];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E95[0x28];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E96[0x30];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1EA7[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1EAA[0x28];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UWaterZone* GetDefaultObj();
