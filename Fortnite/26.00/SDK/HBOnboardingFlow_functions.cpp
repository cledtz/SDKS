...
class UClass* UHBOnboardingFlow_C::StaticClass()
{
...
class UHBOnboardingFlow_C* UHBOnboardingFlow_C::GetDefaultObj()
{
	static class UHBOnboardingFlow_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHBOnboardingFlow_C*>(UHBOnboardingFlow_C::StaticClass()->DefaultObject);
