...
public:
	...
	uint8                                        Pad_EF5[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EF6[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EF7[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EF9[0x4];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_EFE[0x10];                                     // Fixing Size Of Struct
};
