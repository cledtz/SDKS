...
struct UPhysicalRimlight_C_Set_Rimlight_Color_and_Intensity_Params
{
public:
	...
	uint8                                        Pad_7D80[0x6];                                     // Fixing Size After Last Property 
...
struct UPhysicalRimlight_C_RimlightAttemptValidation_Params
{
public:
...
struct UPhysicalRimlight_C_PhysicalRimlight_AutoGenFunc_Params
{
public:
...
struct UPhysicalRimlight_C_Update_Rimlight_Params
{
public:
};
...
struct UPhysicalRimlight_C_ValidateRimlight_Params
{
public:
	...
	class UPawn*                                 CallFunc_GetPlayerPawn_ReturnValue;                // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPlayerCameraManager*                  CallFunc_GetPlayerCameraManager_ReturnValue;       // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7D99[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7D9B[0x3];                                     // Fixing Size After Last Property 
...
struct UPhysicalRimlight_C_ReceiveBeginPlay_Params
{
public:
};
...
struct UPhysicalRimlight_C_InitRim_Params
{
public:
};
...
struct UPhysicalRimlight_C_Day_Phase__Params
{
public:
...
struct UPhysicalRimlight_C_ExecuteUbergraph_PhysicalRimlight_Params
{
public:
	...
	uint8                                        Pad_7DAC[0x4];                                     // Fixing Size After Last Property 
	struct FTimerHandle                          CallFunc_K2_SetTimer_ReturnValue;                  // 0x28(0x8)(NoDestructor, HasGetValueTypeHash)
	class UPawn*                                 CallFunc_GetPlayerPawn_ReturnValue;                // 0x30(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class UFortTimeOfDayManagerInterface> CallFunc_GetContextualTimeOfDayManager_ReturnValue; // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
