...
class UClass* UWBP_Augments_InteractionIndicator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_Augments_InteractionIndicator_C");

	return Clss;
}


// WBP_Augments_InteractionIndicator_C WBP_Augments_InteractionIndicator.Default__WBP_Augments_InteractionIndicator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_Augments_InteractionIndicator_C* UWBP_Augments_InteractionIndicator_C::GetDefaultObj()
{
	static class UWBP_Augments_InteractionIndicator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_Augments_InteractionIndicator_C*>(UWBP_Augments_InteractionIndicator_C::StaticClass()->DefaultObject);
