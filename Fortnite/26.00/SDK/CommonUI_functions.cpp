...
class UClass* UCommonBoundActionButtonInterface::StaticClass()
{
...
class UCommonBoundActionButtonInterface* UCommonBoundActionButtonInterface::GetDefaultObj()
{
	static class UCommonBoundActionButtonInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonBoundActionButtonInterface*>(UCommonBoundActionButtonInterface::StaticClass()->DefaultObject);
...
class UClass* UCommonActionHandlerInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UCommonActionHandlerInterface* UCommonActionHandlerInterface::GetDefaultObj()
{
	static class UCommonActionHandlerInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonActionHandlerInterface*>(UCommonActionHandlerInterface::StaticClass()->DefaultObject);
...
class UClass* UWidgetLockedStateRegistration::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WidgetLockedStateRegistration");

	return Clss;
}


// WidgetLockedStateRegistration CommonUI.Default__WidgetLockedStateRegistration
// (Public, ClassDefaultObject, ArchetypeObject)

class UWidgetLockedStateRegistration* UWidgetLockedStateRegistration::GetDefaultObj()
{
	static class UWidgetLockedStateRegistration* Default = nullptr;

	if (!Default)
		Default = static_cast<UWidgetLockedStateRegistration*>(UWidgetLockedStateRegistration::StaticClass()->DefaultObject);
...
class UClass* UCommonPoolableWidgetInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UCommonPoolableWidgetInterface* UCommonPoolableWidgetInterface::GetDefaultObj()
{
	static class UCommonPoolableWidgetInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonPoolableWidgetInterface*>(UCommonPoolableWidgetInterface::StaticClass()->DefaultObject);
...
class UClass* UCommonMappingContextMetadataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UCommonMappingContextMetadataInterface* UCommonMappingContextMetadataInterface::GetDefaultObj()
{
	static class UCommonMappingContextMetadataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonMappingContextMetadataInterface*>(UCommonMappingContextMetadataInterface::StaticClass()->DefaultObject);
