...
{
public:
	uint8                                        Pad_2361[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2362[0x48];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2367[0x99];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2368[0x6C];                                    // Fixing Size After Last Property 
	class URigHierarchyController*               HierarchyController;                               // 0x1A8(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2369[0x58];                                    // Fixing Size After Last Property 
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x208(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_236B[0x80];                                    // Fixing Size After Last Property 
	class URigHierarchy*                         HierarchyForCacheValidation;                       // 0x2D8(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_236C[0xA0];                                    // Fixing Size Of Struct
...
{
public:
	TSoftObjectPtr<class UControlRig>            ControlRig;                                        // 0x58(0x20)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  ControlName;                                       // 0x78(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_238A[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_23A7[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_23AA[0x90];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_23AC[0xD0];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_23AD[0x1F];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_23B4[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2453[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2456[0xC0];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_245F[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2461[0x7];                                     // Fixing Size After Last Property 
	...
	TSoftObjectPtr<class UControlRig>            ControlRig;                                        // 0x2D0(0x20)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	static class UClass* StaticClass();
	static class UControlRigControlActor* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_247E[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_247F[0x7];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UControlRigShapeActor* GetDefaultObj();
...
{
public:
	uint8                                        Pad_2482[0x8];                                     // Fixing Size After Last Property 
	struct FControlRigShapeDefinition            DefaultShape;                                      // 0x30(0xA0)(Edit, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UMaterial>              DefaultMaterial;                                   // 0xD0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UMaterial>              XRayMaterial;                                      // 0xF0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  MaterialColorParameter;                            // 0x110(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2484[0x4];                                     // Fixing Size After Last Property 
	TArray<struct FControlRigShapeDefinition>    Shapes;                                            // 0x118(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_2485[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_249D[0x40];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_24A1[0x30];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_24A4[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_24A7[0x2F];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2577[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2578[0x6C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_257F[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2587[0x48];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_258B[0x68];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_258E[0x40];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_25A8[0x6];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_25B0[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_25B4[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_25B5[0x4];                                     // Fixing Size After Last Property 
