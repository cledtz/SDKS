...
class UClass* UGA_Riding_Creature_IsBeingRidden_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Riding_Creature_IsBeingRidden_C");

	return Clss;
}


// GA_Riding_Creature_IsBeingRidden_C GA_Riding_Creature_IsBeingRidden.Default__GA_Riding_Creature_IsBeingRidden_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Riding_Creature_IsBeingRidden_C* UGA_Riding_Creature_IsBeingRidden_C::GetDefaultObj()
{
	static class UGA_Riding_Creature_IsBeingRidden_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Riding_Creature_IsBeingRidden_C*>(UGA_Riding_Creature_IsBeingRidden_C::StaticClass()->DefaultObject);
