...
class UClass* UVictoryCrownFrontEndPawnComponent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VictoryCrownFrontEndPawnComponent_C");

	return Clss;
}


// VictoryCrownFrontEndPawnComponent_C VictoryCrownFrontEndPawnComponent.Default__VictoryCrownFrontEndPawnComponent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UVictoryCrownFrontEndPawnComponent_C* UVictoryCrownFrontEndPawnComponent_C::GetDefaultObj()
{
	static class UVictoryCrownFrontEndPawnComponent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVictoryCrownFrontEndPawnComponent_C*>(UVictoryCrownFrontEndPawnComponent_C::StaticClass()->DefaultObject);
...
// class UFortTeamMemberPedestal*     K2Node_DynamicCast_AsFort_Team_Member_Pedestal                   (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UVictoryCrownFrontEndPawnComponent_C::ExecuteUbergraph_VictoryCrownFrontEndPawnComponent(int32 EntryPoint, class FName K2Node_CustomEvent_StatName, int32 K2Node_CustomEvent_StatValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 Temp_int_Variable, class FName Temp_name_Variable, bool CallFunc_Greater_IntInt_ReturnValue, class UActor* CallFunc_GetOwner_ReturnValue, class UActor* CallFunc_GetOwner_ReturnValue_1, class UFortTeamMemberPedestal* K2Node_DynamicCast_AsFort_Team_Member_Pedestal, bool K2Node_DynamicCast_bSuccess, class UPlayerPawn_Athena_C* K2Node_DynamicCast_AsPlayer_Pawn_Athena, bool K2Node_DynamicCast_bSuccess_1, class UFortAsyncAction_CosmeticAdaptiveStatWatcher* CallFunc_WatchCosmeticStat_ReturnValue, bool CallFunc_IsValid_ReturnValue, enum class EEndPlayReason K2Node_Event_EndPlayReason)
{
	static class UFunction* Func = nullptr;
