...
class UClass* UHorizontalTabList_Legacy_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HorizontalTabList_Legacy_C");

	return Clss;
}


// HorizontalTabList_Legacy_C HorizontalTabList_Legacy.Default__HorizontalTabList_Legacy_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHorizontalTabList_Legacy_C* UHorizontalTabList_Legacy_C::GetDefaultObj()
{
	static class UHorizontalTabList_Legacy_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHorizontalTabList_Legacy_C*>(UHorizontalTabList_Legacy_C::StaticClass()->DefaultObject);
