...
class UClass* UMediaSourceRendererInterface::StaticClass()
{
...
class UMediaSourceRendererInterface* UMediaSourceRendererInterface::GetDefaultObj()
{
	static class UMediaSourceRendererInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UMediaSourceRendererInterface*>(UMediaSourceRendererInterface::StaticClass()->DefaultObject);
...
class UMediaTimeStampInfo* UMediaPlayer::GetDisplayTimeStamp()
{
	...
	Params::UMediaPlayer_GetDisplayTimeStamp_Params Parms{};
...
struct FTimespan UMediaPlayer::GetDisplayTime()
{
	...
	Params::UMediaPlayer_GetDisplayTime_Params Parms{};
...
class UClass* UMediaPlayerProxyInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UMediaPlayerProxyInterface* UMediaPlayerProxyInterface::GetDefaultObj()
{
	static class UMediaPlayerProxyInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UMediaPlayerProxyInterface*>(UMediaPlayerProxyInterface::StaticClass()->DefaultObject);
