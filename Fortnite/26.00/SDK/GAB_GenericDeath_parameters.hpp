...
public:
	...
	uint8                                        Pad_856B[0x7];                                     // Fixing Size After Last Property 
	class UFortPawn*                             CallFunc_GetActivatingPawn_ReturnValue_1;          // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_HasAuthority_ReturnValue;                 // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_856C[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_856D[0x5];                                     // Fixing Size After Last Property 
	struct FTransform                            CallFunc_K2_GetComponentToWorld_ReturnValue;       // 0x40(0x60)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UActor*                                CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue; // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class UGameplayTagAssetInterface> CallFunc_HasAnyMatchingGameplayTags_self_CastInput; // 0xA8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_856E[0x7];                                     // Fixing Size After Last Property 
	class UBP_VictoryDrone_C*                    CallFunc_FinishSpawningActor_ReturnValue;          // 0xC0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_856F[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8570[0x3];                                     // Fixing Size After Last Property 
	...
	class UFortAIPawn*                           K2Node_DynamicCast_AsFort_AIPawn;                  // 0x120(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8572[0x5];                                     // Fixing Size After Last Property 
