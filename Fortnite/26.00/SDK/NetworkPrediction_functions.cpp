...
class UClass* UNetworkPredictionReplicatedManager::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UNetworkPredictionReplicatedManager* UNetworkPredictionReplicatedManager::GetDefaultObj()
{
	static class UNetworkPredictionReplicatedManager* Default = nullptr;

	if (!Default)
		Default = static_cast<UNetworkPredictionReplicatedManager*>(UNetworkPredictionReplicatedManager::StaticClass()->DefaultObject);
