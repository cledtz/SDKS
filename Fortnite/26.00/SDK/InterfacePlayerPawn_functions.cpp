...
class UClass* UInterfacePlayerPawn_C::StaticClass()
{
...
class UInterfacePlayerPawn_C* UInterfacePlayerPawn_C::GetDefaultObj()
{
	static class UInterfacePlayerPawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInterfacePlayerPawn_C*>(UInterfacePlayerPawn_C::StaticClass()->DefaultObject);
