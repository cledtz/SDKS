...
class UClass* UGA_NPC_Parent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_NPC_Parent_C");

	return Clss;
}


// GA_NPC_Parent_C GA_NPC_Parent.Default__GA_NPC_Parent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_NPC_Parent_C* UGA_NPC_Parent_C::GetDefaultObj()
{
	static class UGA_NPC_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_NPC_Parent_C*>(UGA_NPC_Parent_C::StaticClass()->DefaultObject);
