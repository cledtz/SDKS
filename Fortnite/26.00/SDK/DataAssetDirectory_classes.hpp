...
public:
	...
	static class UDataAssetDirectoryPatchableAsset* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_192E[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1939[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_193B[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_193D[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_194F[0x178];                                   // Fixing Size After Last Property 
	...
	uint8                                        Pad_1953[0x11];                                    // Fixing Size Of Struct
