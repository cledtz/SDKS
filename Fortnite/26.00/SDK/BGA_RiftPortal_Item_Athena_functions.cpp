...
class UClass* UBGA_RiftPortal_Item_Athena_C::StaticClass()
{
...
class UBGA_RiftPortal_Item_Athena_C* UBGA_RiftPortal_Item_Athena_C::GetDefaultObj()
{
	static class UBGA_RiftPortal_Item_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBGA_RiftPortal_Item_Athena_C*>(UBGA_RiftPortal_Item_Athena_C::StaticClass()->DefaultObject);
...
void UBGA_RiftPortal_Item_Athena_C::EjectFromTurret(class UFortPlayerPawn* PlayerPawn, TScriptInterface<class UFortVehicleInterface> CallFunc_GetVehicleUInterface_ReturnValue, class UAbilitySystemComponent* CallFunc_GetAbilitySystemComponent_ReturnValue, bool CallFunc_CanTeleport_ReturnValue, int32 CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue, class UObject* CallFunc_Conv_InterfaceToObject_ReturnValue, bool CallFunc_IsInVehicle_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
