...
class UClass* UPlayerRiderComponent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerRiderComponent_C");

	return Clss;
}


// PlayerRiderComponent_C PlayerRiderComponent.Default__PlayerRiderComponent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerRiderComponent_C* UPlayerRiderComponent_C::GetDefaultObj()
{
	static class UPlayerRiderComponent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerRiderComponent_C*>(UPlayerRiderComponent_C::StaticClass()->DefaultObject);
...
void UPlayerRiderComponent_C::RiderUIUpdateHealth__DelegateSignature(double Health)
{
	...
	if (!Func)
		Func = Class->GetFunction("PlayerRiderComponent_C", "RiderUIUpdateHealth__DelegateSignature");
...
void UPlayerRiderComponent_C::RiderUIUpdateEnergy__DelegateSignature(double Energy)
{
	...
	if (!Func)
		Func = Class->GetFunction("PlayerRiderComponent_C", "RiderUIUpdateEnergy__DelegateSignature");
...
void UPlayerRiderComponent_C::RiderUIEnd__DelegateSignature(class UActor* RidableActor)
{
	...
	if (!Func)
		Func = Class->GetFunction("PlayerRiderComponent_C", "RiderUIEnd__DelegateSignature");
...
void UPlayerRiderComponent_C::RiderUINewStats__DelegateSignature(class FText Name, const struct FSlateBrush& Icon, class UActor* RidableActor)
{
	...
	if (!Func)
		Func = Class->GetFunction("PlayerRiderComponent_C", "RiderUINewStats__DelegateSignature");
