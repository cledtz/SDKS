...
class UClass* UVariantScript_Glider_BistroAstronaut_Style_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VariantScript_Glider_BistroAstronaut_Style_C");

	return Clss;
}


// VariantScript_Glider_BistroAstronaut_Style_C VariantScript_Glider_BistroAstronaut_Style.Default__VariantScript_Glider_BistroAstronaut_Style_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UVariantScript_Glider_BistroAstronaut_Style_C* UVariantScript_Glider_BistroAstronaut_Style_C::GetDefaultObj()
{
	static class UVariantScript_Glider_BistroAstronaut_Style_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVariantScript_Glider_BistroAstronaut_Style_C*>(UVariantScript_Glider_BistroAstronaut_Style_C::StaticClass()->DefaultObject);
...
struct FGameplayTag UVariantScript_Glider_BistroAstronaut_Style_C::DetermineVariantSelection(struct FFortAthenaLoadout& Loadout, bool CallFunc_IsItemInLoadout_ReturnValue, const struct FGameplayTag& CallFunc_GetActiveVariantForSoftItemAndChannel_ReturnValue, const struct FGameplayTag& CallFunc_GetActiveVariantForSoftItemAndChannel_ReturnValue_1)
{
	...
	Params::UVariantScript_Glider_BistroAstronaut_Style_C_DetermineVariantSelection_Params Parms{};
