...
class UClass* UBP_TeleportationDrone_C::StaticClass()
{
...
class UBP_TeleportationDrone_C* UBP_TeleportationDrone_C::GetDefaultObj()
{
	static class UBP_TeleportationDrone_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_TeleportationDrone_C*>(UBP_TeleportationDrone_C::StaticClass()->DefaultObject);
