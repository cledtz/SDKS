...
class UClass* UPlayerPawn_Athena_Generic_Parent_C::StaticClass()
{
...
class UPlayerPawn_Athena_Generic_Parent_C* UPlayerPawn_Athena_Generic_Parent_C::GetDefaultObj()
{
	static class UPlayerPawn_Athena_Generic_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerPawn_Athena_Generic_Parent_C*>(UPlayerPawn_Athena_Generic_Parent_C::StaticClass()->DefaultObject);
