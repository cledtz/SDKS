...
public:
	...
	uint8                                        Pad_12AD[0x68];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UGameplayDebuggerCategoryReplicator* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_12B7[0xC0];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        BitPad_B1 : 7;                                     // Fixing Bit-Field Size 
...
public:
	...
	uint8                                        Pad_12C9[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_12CC[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_12CD[0x8];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UGameplayDebuggerPlayerManager* GetDefaultObj();
...
{
public:
	uint8                                        Pad_12D1[0x68];                                    // Fixing Size Of Struct
