...
class UClass* UFortArmoredBattleBusPassengerAnimInstance::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortArmoredBattleBusPassengerAnimInstance");

	return Clss;
}


// FortArmoredBattleBusPassengerAnimInstance ArmoredBattleBusRuntime.Default__FortArmoredBattleBusPassengerAnimInstance
// (Public, ClassDefaultObject, ArchetypeObject)

class UFortArmoredBattleBusPassengerAnimInstance* UFortArmoredBattleBusPassengerAnimInstance::GetDefaultObj()
{
	static class UFortArmoredBattleBusPassengerAnimInstance* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortArmoredBattleBusPassengerAnimInstance*>(UFortArmoredBattleBusPassengerAnimInstance::StaticClass()->DefaultObject);
...
// Parameters:
// class UFortAthenaVehicle*          VehicleActor                                                     (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UFortArmoredBattleBusPassengerAnimInstance::UpdateYawDeltaSmoothed(class UFortAthenaVehicle* VehicleActor, class FName SocketName, struct FRotator& NewRotation, float* SmoothedYawValue)
{
...
void UFortArmoredBattleBusPassengerAnimInstance::UpdateSmoothedVehicleYawRate(class UFortAthenaVehicle* VehicleActor)
{
	static class UFunction* Func = nullptr;
...
void UFortArmoredBattleBusPassengerAnimInstance::GenerateCharacterPitchAndYawForSlopedTerrain(class UFortAthenaVehicle* VehicleActor, float* TurretYaw, float* TurretPitch, struct FRotator* PawnYawRotator)
{
	static class UFunction* Func = nullptr;
...
class UClass* UFortArmoredBattleBusVehicleAnimInstance::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortArmoredBattleBusVehicleAnimInstance");

	return Clss;
}


// FortArmoredBattleBusVehicleAnimInstance ArmoredBattleBusRuntime.Default__FortArmoredBattleBusVehicleAnimInstance
// (Public, ClassDefaultObject, ArchetypeObject)

class UFortArmoredBattleBusVehicleAnimInstance* UFortArmoredBattleBusVehicleAnimInstance::GetDefaultObj()
{
	static class UFortArmoredBattleBusVehicleAnimInstance* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortArmoredBattleBusVehicleAnimInstance*>(UFortArmoredBattleBusVehicleAnimInstance::StaticClass()->DefaultObject);
...
float UFortArmoredBattleBusVehicleAnimInstance::UpdateYawDeltaSmoothed(class UFortAthenaVehicle* VehicleActor, class FName SocketName, const struct FRotator& NewRotation, float SmoothedYawValue)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, HasOutParams, HasDefaults, BlueprintCallable)
// Parameters:
// class UFortAthenaVehicle*          OwnerVehicle                                                     (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UFortPlayerPawn*             GunnerActor                                                      (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FName                        SocketName                                                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UFortArmoredBattleBusVehicleAnimInstance::UpdateTurretAimPitchWeaponYaw(class UFortAthenaVehicle* OwnerVehicle, class UFortPlayerPawn* GunnerActor, class FName SocketName, float YawOffset, float* TurretAimPitch, float* YawDeltaSmoothed, struct FRotator* WeaponYaw)
{
	static class UFunction* Func = nullptr;
...
float UFortArmoredBattleBusVehicleAnimInstance::UpdateSmoothedVehicleYawRate(class UFortAthenaVehicle* VehicleActor, const struct FRotator& PreviousRotator)
{
	static class UFunction* Func = nullptr;
...
void UFortArmoredBattleBusVehicleAnimInstance::GetPitchAndYaw(class UFortAthenaVehicle* VehicleActor, class UFortPlayerPawn* GunnerActor, float* AdjustedPitch, float* AdjustedYaw, bool* bIsLocalPlayerControlled, struct FRotator* YawRotator)
{
	static class UFunction* Func = nullptr;
