...
public:
	...
	uint8                                        Pad_4F22[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4F25[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4F29[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4F2B[0x4];                                     // Fixing Size After Last Property 
...
public:
	class FName                                  ParameterName;                                     // 0x0(0x4)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4F2C[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4F2E[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4F30[0x4];                                     // Fixing Size After Last Property 
