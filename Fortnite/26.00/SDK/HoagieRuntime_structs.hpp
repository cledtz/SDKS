...
{
public:
	uint8                                        Pad_356D[0x1E0];                                   // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_356E[0x3];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_356F[0x78];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3570[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3573[0x4];                                     // Fixing Size After Last Property 
