...
class UClass* USpecialEventVaultWorld_C::StaticClass()
{
...
class USpecialEventVaultWorld_C* USpecialEventVaultWorld_C::GetDefaultObj()
{
	static class USpecialEventVaultWorld_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USpecialEventVaultWorld_C*>(USpecialEventVaultWorld_C::StaticClass()->DefaultObject);
...
void USpecialEventVaultWorld_C::BackgroundMinusEffects__FinishedFunc()
{
	static class UFunction* Func = nullptr;
	...
	Params::USpecialEventVaultWorld_C_BackgroundMinusEffects__FinishedFunc_Params Parms{};
...
void USpecialEventVaultWorld_C::BackgroundMinusEffects__UpdateFunc()
{
	static class UFunction* Func = nullptr;
	...
	Params::USpecialEventVaultWorld_C_BackgroundMinusEffects__UpdateFunc_Params Parms{};
...
void USpecialEventVaultWorld_C::FloorMinusVisibility__FinishedFunc()
{
	static class UFunction* Func = nullptr;
	...
	Params::USpecialEventVaultWorld_C_FloorMinusVisibility__FinishedFunc_Params Parms{};
...
void USpecialEventVaultWorld_C::FloorMinusVisibility__UpdateFunc()
{
	static class UFunction* Func = nullptr;
	...
	Params::USpecialEventVaultWorld_C_FloorMinusVisibility__UpdateFunc_Params Parms{};
