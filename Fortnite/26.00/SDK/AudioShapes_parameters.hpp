...
{
public:
	TArray<class UPlayerController*>             InLocalControllers;                                // 0x0(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1D76[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1D78[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1D7A[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1D81[0x4];                                     // Fixing Size Of Struct
};
