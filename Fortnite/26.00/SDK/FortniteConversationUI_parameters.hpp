...
public:
	...
	uint8                                        Pad_34E7[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_34F2[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	class UActor*                                NewIndicatorActor;                                 // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UActor*                                OverActor;                                         // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UFortConversationOption_IsLocked_Params
{
public:
...
struct UFortConversationOption_GetUnlockLevel_Params
{
public:
...
public:
	...
	uint8                                        Pad_3595[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_35B8[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	TScriptInterface<class UFortInventoryOwnerInterface> InventoryOwner;                                    // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_35E4[0x4];                                     // Fixing Size Of Struct
};
