...
class UClass* UGA_Athena_ZipLine_SmashParent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_ZipLine_SmashParent_C");

	return Clss;
}


// GA_Athena_ZipLine_SmashParent_C GA_Athena_ZipLine_SmashParent.Default__GA_Athena_ZipLine_SmashParent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_ZipLine_SmashParent_C* UGA_Athena_ZipLine_SmashParent_C::GetDefaultObj()
{
	static class UGA_Athena_ZipLine_SmashParent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_ZipLine_SmashParent_C*>(UGA_Athena_ZipLine_SmashParent_C::StaticClass()->DefaultObject);
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVerbMessage_Custom         CallFunc_MakeCustomVerbMessage_ReturnValue                       (None)
// class UFortQuestManager*           CallFunc_GetQuestManager_ReturnValue                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FVerbMessage_Custom         CallFunc_AddTagsForSubject_Result                                (None)
...
void UGA_Athena_ZipLine_SmashParent_C::Added_5A9C02A9480D39B213A8AC81767C7A76()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Athena_ZipLine_SmashParent_C", "Added_5A9C02A9480D39B213A8AC81767C7A76");
