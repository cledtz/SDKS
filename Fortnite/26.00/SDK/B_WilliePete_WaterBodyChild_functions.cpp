...
class UClass* UB_WilliePete_WaterBodyChild_C::StaticClass()
{
...
class UB_WilliePete_WaterBodyChild_C* UB_WilliePete_WaterBodyChild_C::GetDefaultObj()
{
	static class UB_WilliePete_WaterBodyChild_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_WilliePete_WaterBodyChild_C*>(UB_WilliePete_WaterBodyChild_C::StaticClass()->DefaultObject);
