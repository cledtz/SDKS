...
class UClass* UPlayerPawn_Generic_Parent_C::StaticClass()
{
...
class UPlayerPawn_Generic_Parent_C* UPlayerPawn_Generic_Parent_C::GetDefaultObj()
{
	static class UPlayerPawn_Generic_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerPawn_Generic_Parent_C*>(UPlayerPawn_Generic_Parent_C::StaticClass()->DefaultObject);
