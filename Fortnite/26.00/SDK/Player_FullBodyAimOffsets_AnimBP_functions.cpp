...
class UClass* UPlayer_FullBodyAimOffsets_AnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Player_FullBodyAimOffsets_AnimBP_C");

	return Clss;
}


// Player_FullBodyAimOffsets_AnimBP_C Player_FullBodyAimOffsets_AnimBP.Default__Player_FullBodyAimOffsets_AnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayer_FullBodyAimOffsets_AnimBP_C* UPlayer_FullBodyAimOffsets_AnimBP_C::GetDefaultObj()
{
	static class UPlayer_FullBodyAimOffsets_AnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayer_FullBodyAimOffsets_AnimBP_C*>(UPlayer_FullBodyAimOffsets_AnimBP_C::StaticClass()->DefaultObject);
