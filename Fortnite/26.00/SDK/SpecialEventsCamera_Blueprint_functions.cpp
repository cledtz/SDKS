...
class UClass* USpecialEventsCamera_Blueprint_C::StaticClass()
{
...
class USpecialEventsCamera_Blueprint_C* USpecialEventsCamera_Blueprint_C::GetDefaultObj()
{
	static class USpecialEventsCamera_Blueprint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USpecialEventsCamera_Blueprint_C*>(USpecialEventsCamera_Blueprint_C::StaticClass()->DefaultObject);
