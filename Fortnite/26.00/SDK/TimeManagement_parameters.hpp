...
public:
	...
	uint8                                        Pad_F93[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_F9B[0x3];                                      // Fixing Size Of Struct
};
...
struct UTimeManagementBlueprintLibrary_Conv_FrameRateToInterval_Params
{
public:
	struct FFrameRate                            InFrameRate;                                       // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        ReturnValue;                                       // 0x8(0x4)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
