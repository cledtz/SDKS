...
public:
	...
	uint8                                        Pad_1C50[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1C54[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	TSoftClassPtr<class UPlayspaceComponent>     PlayspaceComponentClass;                           // 0x0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EPlayspaceComponentCreationType   CreationType;                                      // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C58[0x7];                                     // Fixing Size After Last Property 
	struct FGameplayTagQuery                     TagQuery;                                          // 0x28(0x48)(Edit, NativeAccessSpecifierPublic)
	struct FVector                               Location;                                          // 0x70(0x18)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TSoftClassPtr<class UPlayspace>              PlayspaceClass;                                    // 0x0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EPlayspaceCreationType            CreationType;                                      // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C5B[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1C5D[0x8];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1C68[0x54];                                    // Fixing Size After Last Property 
