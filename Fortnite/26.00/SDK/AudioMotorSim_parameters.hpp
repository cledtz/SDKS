...
{
public:
	TScriptInterface<class UAudioMotorSim>       InComponent;                                       // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TScriptInterface<class UAudioMotorSimOutput> InComponent;                                       // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_613[0x3];                                      // Fixing Size Of Struct
};
