...
class UClass* UVaultCharacterLightingBP_C::StaticClass()
{
...
class UVaultCharacterLightingBP_C* UVaultCharacterLightingBP_C::GetDefaultObj()
{
	static class UVaultCharacterLightingBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVaultCharacterLightingBP_C*>(UVaultCharacterLightingBP_C::StaticClass()->DefaultObject);
