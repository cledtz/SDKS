...
struct UMovieSceneBoundObjectProxy_BP_GetBoundObjectForSequencer_Params
{
public:
	class UObject*                               ResolvedObject;                                    // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct UBuiltInDynamicBindingResolverLibrary_ResolveToPlayerPawn_Params
{
public:
	...
	uint8                                        Pad_104F[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1098[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	int32                                        NewSerialNumber;                                   // 0x8(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_10A8[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_10AB[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_10B7[0x7];                                     // Fixing Size After Last Property 
