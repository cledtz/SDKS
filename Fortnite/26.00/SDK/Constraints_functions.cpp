...
class UClass* UConstraintsActor::StaticClass()
{
...
class UConstraintsActor* UConstraintsActor::GetDefaultObj()
{
	static class UConstraintsActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UConstraintsActor*>(UConstraintsActor::StaticClass()->DefaultObject);
