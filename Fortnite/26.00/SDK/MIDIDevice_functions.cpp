...
class UClass* UMIDIDeviceControllerBase::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MIDIDeviceControllerBase");

	return Clss;
}


// MIDIDeviceControllerBase MIDIDevice.Default__MIDIDeviceControllerBase
// (Public, ClassDefaultObject, ArchetypeObject)

class UMIDIDeviceControllerBase* UMIDIDeviceControllerBase::GetDefaultObj()
{
	static class UMIDIDeviceControllerBase* Default = nullptr;

	if (!Default)
		Default = static_cast<UMIDIDeviceControllerBase*>(UMIDIDeviceControllerBase::StaticClass()->DefaultObject);
...
void UMIDIDeviceManager::ShutDownAllMIDIDevices()
{
	...
	if (!Func)
		Func = Class->GetFunction("MIDIDeviceManager", "ShutDownAllMIDIDevices");

	Params::UMIDIDeviceManager_ShutDownAllMIDIDevices_Params Parms{};
...
void UMIDIDeviceManager::GetDefaultMIDIOutputDeviceID(int32* DeviceID)
{
	...
	if (!Func)
		Func = Class->GetFunction("MIDIDeviceManager", "GetDefaultMIDIOutputDeviceID");

	Params::UMIDIDeviceManager_GetDefaultMIDIOutputDeviceID_Params Parms{};
...
void UMIDIDeviceManager::GetDefaultMIDIInputDeviceID(int32* DeviceID)
{
	...
	if (!Func)
		Func = Class->GetFunction("MIDIDeviceManager", "GetDefaultMIDIInputDeviceID");

	Params::UMIDIDeviceManager_GetDefaultMIDIInputDeviceID_Params Parms{};
