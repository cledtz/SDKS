...
public:
	...
	uint8                                        Pad_93E2[0xF];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_93E4[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_93E8[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_93E9[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_93EA[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_93EB[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_93EE[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_93EF[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	bool                                         K2Node_Event_IsDesignTime;                         // 0x190(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationForward_ReturnValue;         // 0x198(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x1A0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsMobileGame_ReturnValue;                 // 0x1A4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9402[0x3];                                     // Fixing Size After Last Property 
	TArray<class UUserWidget*>                   CallFunc_GetAllEntries_ReturnValue;                // 0x1A8(0x10)(ConstParm, ReferenceParm, ContainsInstancedReference)
	class UUserWidget*                           CallFunc_Array_Get_Item;                           // 0x1B8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9403[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_9404[0x3];                                     // Fixing Size After Last Property 
