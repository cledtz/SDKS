...
class UClass* UGA_Action_ADS_GrindRail_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Action_ADS_GrindRail_C");

	return Clss;
}


// GA_Action_ADS_GrindRail_C GA_Action_ADS_GrindRail.Default__GA_Action_ADS_GrindRail_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Action_ADS_GrindRail_C* UGA_Action_ADS_GrindRail_C::GetDefaultObj()
{
	static class UGA_Action_ADS_GrindRail_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Action_ADS_GrindRail_C*>(UGA_Action_ADS_GrindRail_C::StaticClass()->DefaultObject);
