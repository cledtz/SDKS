...
class UClass* UBP_FluidSim_FN_C::StaticClass()
{
...
class UBP_FluidSim_FN_C* UBP_FluidSim_FN_C::GetDefaultObj()
{
	static class UBP_FluidSim_FN_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FluidSim_FN_C*>(UBP_FluidSim_FN_C::StaticClass()->DefaultObject);
