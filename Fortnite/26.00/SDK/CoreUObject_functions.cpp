...
class UClass* UObjectReachabilityStressData::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ObjectReachabilityStressData");

	return Clss;
}


// ObjectReachabilityStressData CoreUObject.Default__ObjectReachabilityStressData
// (Public, ClassDefaultObject, ArchetypeObject)

class UObjectReachabilityStressData* UObjectReachabilityStressData::GetDefaultObj()
{
	static class UObjectReachabilityStressData* Default = nullptr;

	if (!Default)
		Default = static_cast<UObjectReachabilityStressData*>(UObjectReachabilityStressData::StaticClass()->DefaultObject);
...
class UInterface* UInterface::GetDefaultObj()
{
	static class UInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UInterface*>(UInterface::StaticClass()->DefaultObject);
