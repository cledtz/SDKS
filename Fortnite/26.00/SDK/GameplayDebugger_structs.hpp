...
public:
	...
	uint8                                        Pad_12D9[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_12DC[0x3];                                     // Fixing Size Of Struct
};
...
public:
	class FName                                  CategoryName;                                      // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_12DF[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_12E1[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_12E5[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_12ED[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_12EE[0x7];                                     // Fixing Size After Last Property 
