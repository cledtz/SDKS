...
class UClass* UBP_PlayerPawn_Athena_Phoebe_C::StaticClass()
{
...
class UBP_PlayerPawn_Athena_Phoebe_C* UBP_PlayerPawn_Athena_Phoebe_C::GetDefaultObj()
{
	static class UBP_PlayerPawn_Athena_Phoebe_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_PlayerPawn_Athena_Phoebe_C*>(UBP_PlayerPawn_Athena_Phoebe_C::StaticClass()->DefaultObject);
