...
public:
	...
	class UImage*                                RatingMinusGlowMinusLarge;                         // 0x340(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UCommonNumericTextBlock*               TeamRatingValueMinusLarge;                         // 0x360(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                        Pad_8A5E[0x3];                                     // Fixing Size After Last Property 
