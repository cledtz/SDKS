...
class UClass* UProceduralGenerationBlockingVolume::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UProceduralGenerationBlockingVolume* UProceduralGenerationBlockingVolume::GetDefaultObj()
{
	static class UProceduralGenerationBlockingVolume* Default = nullptr;

	if (!Default)
		Default = static_cast<UProceduralGenerationBlockingVolume*>(UProceduralGenerationBlockingVolume::StaticClass()->DefaultObject);
...
class UClass* UProceduralGenerationVolume::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UProceduralGenerationVolume* UProceduralGenerationVolume::GetDefaultObj()
{
	static class UProceduralGenerationVolume* Default = nullptr;

	if (!Default)
		Default = static_cast<UProceduralGenerationVolume*>(UProceduralGenerationVolume::StaticClass()->DefaultObject);
