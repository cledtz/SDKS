...
public:
	...
	uint8                                        Pad_8964[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_896A[0x2];                                     // Fixing Size After Last Property 
	struct FSlateColor                           K2Node_Select_Default;                             // 0x30(0x14)(None)
};
...
public:
	...
	uint8                                        Pad_896D[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_8977[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8979[0xD];                                     // Fixing Size After Last Property 
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x120(0xC0)(None)
	class UCommonInputSubsystem*                 CallFunc_GetContext_ReturnValue;                   // 0x1E0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_897A[0x8];                                     // Fixing Size After Last Property 
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush_1;                    // 0x1F0(0xC0)(None)
