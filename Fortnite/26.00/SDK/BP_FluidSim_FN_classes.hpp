...
class UBP_FluidSim_FN_C : public UBP_FluidSim_01_C
{
public:
	...
	TArray<class UFortPawn*>                     RelevantFortPawns;                                 // 0x6C8(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
