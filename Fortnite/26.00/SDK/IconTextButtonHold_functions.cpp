...
class UClass* UIconTextButtonHold_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("IconTextButtonHold_C");

	return Clss;
}


// IconTextButtonHold_C IconTextButtonHold.Default__IconTextButtonHold_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UIconTextButtonHold_C* UIconTextButtonHold_C::GetDefaultObj()
{
	static class UIconTextButtonHold_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UIconTextButtonHold_C*>(UIconTextButtonHold_C::StaticClass()->DefaultObject);
