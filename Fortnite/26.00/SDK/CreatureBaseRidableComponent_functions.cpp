...
class UClass* UCreatureBaseRidableComponent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CreatureBaseRidableComponent_C");

	return Clss;
}


// CreatureBaseRidableComponent_C CreatureBaseRidableComponent.Default__CreatureBaseRidableComponent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCreatureBaseRidableComponent_C* UCreatureBaseRidableComponent_C::GetDefaultObj()
{
	static class UCreatureBaseRidableComponent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCreatureBaseRidableComponent_C*>(UCreatureBaseRidableComponent_C::StaticClass()->DefaultObject);
...
// Parameters:
// class UActor*                      PlayerPawn                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UActor*                      CreaturePawn                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UCreatureBaseRidableComponent_C::ForceTaming(class UActor* PlayerPawn, class UActor* CreaturePawn, bool* IsTamingEnabled, const struct FGameplayTagContainer& CreativeAllowTamingTags, bool Temp_bool_Variable, class UFortPawn* K2Node_DynamicCast_AsFort_Pawn, bool K2Node_DynamicCast_bSuccess, class UFortPawn* K2Node_DynamicCast_AsFort_Pawn_1, bool K2Node_DynamicCast_bSuccess_1, TScriptInterface<class UGameplayTagAssetInterface> K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_HasAnyMatchingGameplayTags_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UCreatureBaseRidableComponent_C_ForceTaming_Params Parms{};

	Parms.PlayerPawn = PlayerPawn;
	Parms.CreaturePawn = CreaturePawn;
	Parms.CreativeAllowTamingTags = CreativeAllowTamingTags;
	Parms.Temp_bool_Variable = Temp_bool_Variable;
	Parms.K2Node_DynamicCast_AsFort_Pawn = K2Node_DynamicCast_AsFort_Pawn;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
...
// struct FScalableFloat              K2Node_MakeStruct_ScalableFloat_1                                (None)
// float                              CallFunc_GetValueAtLevel_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_GetValueAtLevel_ReturnValue_1                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UCreatureBaseRidableComponent_C::ExecuteUbergraph_CreatureBaseRidableComponent(int32 EntryPoint, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsServer_ReturnValue, bool CallFunc_Vector_IsZero_ReturnValue, class UActor* CallFunc_GetOwner_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue, const struct FVector& CallFunc_GetRiderLocation_Location, bool CallFunc_IsValid_ReturnValue_2, class UActor* CallFunc_GetOwner_ReturnValue_1, class UActor* CallFunc_GetOwner_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_4, bool CallFunc_HasAuthority_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue_2, class UActor* CallFunc_GetOwner_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_5, bool CallFunc_IsValid_ReturnValue_6, bool CallFunc_HasAuthority_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_7, class UActor* CallFunc_GetOwner_ReturnValue_4, const struct FVector2D& CallFunc_Conv_VectorToVector2D_ReturnValue, bool CallFunc_IsValid_ReturnValue_8, double CallFunc_VSize2D_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, bool CallFunc_HasAuthority_ReturnValue_4, bool CallFunc_IsValidClass_ReturnValue, TArray<enum class ECollisionChannel>& K2Node_MakeArray_Array, class UActor* CallFunc_GetOwner_ReturnValue_5, class UFortPawn* K2Node_DynamicCast_AsFort_Pawn, bool K2Node_DynamicCast_bSuccess, class UFortPawn* K2Node_DynamicCast_AsFort_Pawn_1, bool K2Node_DynamicCast_bSuccess_1, double K2Node_CustomEvent_JumpPitchInterpSpeed, class UActor* CallFunc_GetOwner_ReturnValue_6, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortAIPawn* K2Node_DynamicCast_AsFort_AIPawn, bool K2Node_DynamicCast_bSuccess_2, class UActor* CallFunc_GetOwner_ReturnValue_7, bool CallFunc_IsDedicatedServer_ReturnValue, class UFortAIPawn* K2Node_DynamicCast_AsFort_AIPawn_1, bool K2Node_DynamicCast_bSuccess_3, class UActor* K2Node_CustomEvent_AIPawn, class UFortPlayerPawn* K2Node_CustomEvent_InteractingPlayerPawn, class UActor* CallFunc_GetOwner_ReturnValue_8, bool CallFunc_ToggleRiding_bChangedRiding, class UNPC_Pawn_Wildlife_Parent_C* K2Node_DynamicCast_AsNPC_Pawn_Wildlife_Parent, bool K2Node_DynamicCast_bSuccess_4, bool CallFunc_ForceTaming_IsTamingEnabled, class UNPC_Pawn_Parent_C* K2Node_DynamicCast_AsNPC_Pawn_Parent, bool K2Node_DynamicCast_bSuccess_5, bool CallFunc_NPC_UpdateInteract_EnabledInteract, class UFortAIPawn* K2Node_DynamicCast_AsFort_AIPawn_2, bool K2Node_DynamicCast_bSuccess_6, bool CallFunc_IsDedicatedServer_ReturnValue_1, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool K2Node_CustomEvent_Converted, class UFortPawn* K2Node_CustomEvent_InstigatorPawn, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, double CallFunc_GetTimeSeconds_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, bool CallFunc_IsBeingRidden_ReturnValue, bool CallFunc_IsValid_ReturnValue_9, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_IsBeingRidden_ReturnValue_1, bool CallFunc_TestThreshold_crossedThreshold, bool CallFunc_IsBeingRidden_ReturnValue_2, bool CallFunc_IsBeingRidden_ReturnValue_3, bool CallFunc_TestThreshold_crossedThreshold_1, bool CallFunc_IsBeingRidden_ReturnValue_4, double CallFunc_GetTimeSeconds_ReturnValue_1, double K2Node_CustomEvent_EnergyCost_1, double CallFunc_Subtract_DoubleDouble_ReturnValue_1, bool CallFunc_NotEqual_NameName_ReturnValue, bool CallFunc_Less_DoubleDouble_ReturnValue, double CallFunc_DetermineRateOfChange_RateOfChange, bool CallFunc_NotEqual_DoubleDouble_ReturnValue, bool CallFunc_IsValid_ReturnValue_10, double CallFunc_UpdateValue_updatedValue, bool CallFunc_UpdateValue_energyDepleted, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsValid_ReturnValue_11, class UActor* CallFunc_GetOwner_ReturnValue_9, class UFortAIPawn* K2Node_DynamicCast_AsFort_AIPawn_3, bool K2Node_DynamicCast_bSuccess_7, bool CallFunc_BooleanAND_ReturnValue_1, bool CallFunc_ApplyGEToSelf_isValidClass, bool CallFunc_ApplyGEToSelf_isValidClass_1, bool CallFunc_ApplyGEToSelf_isValidClass_2, bool CallFunc_IsValid_ReturnValue_12, class UActor* CallFunc_GetOwner_ReturnValue_10, bool CallFunc_IsValid_ReturnValue_13, class UFortPawn* K2Node_DynamicCast_AsFort_Pawn_2, bool K2Node_DynamicCast_bSuccess_8, class UActor* CallFunc_GetOwner_ReturnValue_11, bool K2Node_Event_bAbilityInputHeld, bool K2Node_Event_bForceCancel, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsValid_ReturnValue_14, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_IsValid_ReturnValue_15, bool CallFunc_IsSwimming_IsSwimming, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, enum class EEvaluateCurveTableResult CallFunc_EvaluateCurveTableRow_OutResult, float CallFunc_EvaluateCurveTableRow_OutXY, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_IsBeingRidden_ReturnValue_5, bool CallFunc_NotEqual_DoubleDouble_ReturnValue_1, class UPlayerRiderComponent_C* K2Node_DynamicCast_AsPlayer_Rider_Component, bool K2Node_DynamicCast_bSuccess_9, class UActor* CallFunc_GetOwner_ReturnValue_12, class UAbilityAsync_WaitGameplayTagRemoved* CallFunc_WaitGameplayTagRemoveFromActor_ReturnValue, bool CallFunc_IsValid_ReturnValue_16, bool CallFunc_IsSprintToggleable_ReturnValue, bool CallFunc_IsSprintToggleable_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_17, bool CallFunc_IsSprintToggleable_ReturnValue_2, bool CallFunc_Not_PreBool_ReturnValue_2, TScriptInterface<class UGameplayTagAssetInterface> CallFunc_HasAnyMatchingGameplayTags_self_CastInput, bool CallFunc_HasAnyMatchingGameplayTags_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_2, bool CallFunc_IsSprintToggleable_ReturnValue_3, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, float K2Node_Event_StaminaPercent, bool Temp_bool_IsClosed_Variable, class URiderComponent* K2Node_Event_Rider, double K2Node_CustomEvent_Energy, bool K2Node_CustomEvent_bWarningActive, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, class URiderComponent* K2Node_Event_Rider_1, bool CallFunc_Greater_DoubleDouble_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_18, class UActor* CallFunc_GetOwner_ReturnValue_13, bool CallFunc_IsValid_ReturnValue_19, class UFortPlayerPawnAthena* K2Node_DynamicCast_AsFort_Player_Pawn_Athena, bool K2Node_DynamicCast_bSuccess_10, double K2Node_CustomEvent_EnergyCost, class UActor* CallFunc_GetOwner_ReturnValue_14, class UNPC_Pawn_Parent_C* K2Node_DynamicCast_AsNPC_Pawn_Parent_1, bool K2Node_DynamicCast_bSuccess_11, class UNPC_Pawn_Parent_C* K2Node_DynamicCast_AsNPC_Pawn_Parent_2, bool K2Node_DynamicCast_bSuccess_12, bool CallFunc_NPC_UpdateInteract_EnabledInteract_1, bool CallFunc_NPC_CanBeInteractedWith_CanInteract, class UFortAbilitySystemComponent* CallFunc_GetFortAbilitySystemComponent_ReturnValue, bool CallFunc_NPC_UpdateInteract_EnabledInteract_2, const struct FActiveGameplayEffectHandle& CallFunc_BP_FortApplyGameplayEffectToSelf_ReturnValue, int32 CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue, int32 CallFunc_RemoveActiveEffectsWithGrantedTags_ReturnValue_1, class UActor* CallFunc_GetOwner_ReturnValue_15, class UActor* CallFunc_GetOwner_ReturnValue_16, bool CallFunc_IsValid_ReturnValue_20, bool CallFunc_IsValid_ReturnValue_21, bool CallFunc_HasAuthority_ReturnValue_5, bool CallFunc_HasAuthority_ReturnValue_6, class UActor* CallFunc_GetOwner_ReturnValue_17, bool CallFunc_IsValid_ReturnValue_22, bool CallFunc_HasAuthority_ReturnValue_7, bool CallFunc_IsValid_ReturnValue_23, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5, bool CallFunc_CanJumpExit_CanJumpExit, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_6, bool CallFunc_IsValid_ReturnValue_24, bool CallFunc_IsValid_ReturnValue_25, bool CallFunc_IsFalling_ReturnValue, bool CallFunc_CanStartSprinting_ReturnValue, bool CallFunc_CanStartSprinting_ReturnValue_1, bool CallFunc_ApplyGEToSelf_isValidClass_3, bool CallFunc_LessEqual_DoubleDouble_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_7, float CallFunc_EvaluateCurveTableRow_OutXY_1, bool CallFunc_EvaluateCurveTableRow_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_3, bool CallFunc_GreaterEqual_DoubleDouble_ReturnValue, class UActor* CallFunc_GetOwner_ReturnValue_18, bool CallFunc_BooleanAND_ReturnValue_4, class UAbilityAsync_WaitGameplayTagAdded* CallFunc_WaitGameplayTagAddToActor_ReturnValue, bool CallFunc_IsValid_ReturnValue_26, class UAbilityAsync_WaitGameplayTagRemoved* CallFunc_WaitGameplayTagRemoveFromActor_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_27, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_8, enum class EEvaluateCurveTableResult CallFunc_EvaluateCurveTableRow_OutResult_1, float CallFunc_EvaluateCurveTableRow_OutXY_2, bool CallFunc_EqualEqual_DoubleDouble_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess_1, class UActor* CallFunc_GetOwner_ReturnValue_19, bool CallFunc_ShouldBufferJumpExitToRetryJump_Output, class UFortAIPawn* K2Node_DynamicCast_AsFort_AIPawn_4, bool K2Node_DynamicCast_bSuccess_13, const struct FHitResult& K2Node_CustomEvent_Hit_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_9, bool CallFunc_Should_Convert_Jump_Exit_to_Jump_Out, bool Temp_bool_Variable, TSubclassOf<class UGameplayEffect> K2Node_Select_Default, const struct FActiveGameplayEffectHandle& CallFunc_BP_FortApplyGameplayEffectToSelf_ReturnValue_1, const struct FHitResult& K2Node_CustomEvent_Hit, class UFortAbilitySystemComponent* CallFunc_GetFortAbilitySystemComponent_ReturnValue_1, bool CallFunc_ShouldBufferJumpExitToRetryJump_Output_1, bool CallFunc_GetValueAsBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_10, bool CallFunc_GetValueAsBool_ReturnValue_1, bool CallFunc_GetValueAsBool_ReturnValue_2, const struct FRidingPettingData& CallFunc_GetPettingData_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_3, const struct FCurveTableRowHandle& K2Node_MakeStruct_CurveTableRowHandle, const struct FCurveTableRowHandle& K2Node_MakeStruct_CurveTableRowHandle_1, const struct FScalableFloat& K2Node_MakeStruct_ScalableFloat, const struct FScalableFloat& K2Node_MakeStruct_ScalableFloat_1, float CallFunc_GetValueAtLevel_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue_1, double K2Node_VariableSet_currentEnergyValue_ImplicitCast, double K2Node_VariableSet_CurrentEnergyRateOfRecharge_ImplicitCast, double CallFunc_EqualEqual_DoubleDouble_A_ImplicitCast, double CallFunc_UpdateLootAnimalGlow_Scale_ImplicitCast, double CallFunc_UpdateLootAnimalGlow_Scale_ImplicitCast_1)
{
	static class UFunction* Func = nullptr;
