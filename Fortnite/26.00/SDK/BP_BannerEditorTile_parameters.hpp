...
public:
	...
	uint8                                        Pad_8A64[0x4];                                     // Fixing Size After Last Property 
	class UObject*                               CallFunc_GetListItemObject_ReturnValue;            // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TSoftObjectPtr<class UTexture2D>             CallFunc_GetBannerSmallIconAsset_ReturnValue;      // 0x48(0x20)(UObjectWrapper, HasGetValueTypeHash)
	class UObject*                               K2Node_CustomEvent_Object;                         // 0x68(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x70(0xC)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8A6B[0x4];                                     // Fixing Size After Last Property 
	class UTexture2D*                            K2Node_DynamicCast_AsTexture_2D;                   // 0x80(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                               CallFunc_GetListItemObject_ReturnValue_2;          // 0x90(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortHomebaseBannerColorItem*          K2Node_DynamicCast_AsFort_Homebase_Banner_Color_Item_1; // 0x98(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_4;                     // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8A6E[0x3];                                     // Fixing Size After Last Property 
	struct FLinearColor                          CallFunc_GetBannerColorSecondaryColor_ReturnValue; // 0xA4(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          CallFunc_GetBannerColorPrimaryColor_ReturnValue;   // 0xB4(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                               K2Node_Event_ListItemObject;                       // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
