...
{
public:
	uint8                                        Pad_33E9[0x58];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_33EA[0x48];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_33ED[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_33F7[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_33F8[0x8];                                     // Fixing Size Of Struct
};
