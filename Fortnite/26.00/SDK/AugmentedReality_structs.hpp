...
public:
	...
	uint8                                        Pad_4594[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_4599[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_459B[0xF];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_459C[0x1];                                     // Fixing Size Of Struct
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_45A0[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_45A2[0x8];                                     // Fixing Size Of Struct
};
...
public:
	struct FARSessionPayload                     SessionPayload;                                    // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_45A3[0x8];                                     // Fixing Size After Last Property 
	struct FTransform                            WorldTransform;                                    // 0x20(0x60)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_45A5[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_45C1[0xF];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_45CB[0xB];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_45CD[0x18];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_45CF[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_45D1[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_45D4[0x7];                                     // Fixing Size Of Struct
};
