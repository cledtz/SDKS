...
class UClass* UB_Prj_Athena_FragGrenade_C::StaticClass()
{
...
class UB_Prj_Athena_FragGrenade_C* UB_Prj_Athena_FragGrenade_C::GetDefaultObj()
{
	static class UB_Prj_Athena_FragGrenade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_Prj_Athena_FragGrenade_C*>(UB_Prj_Athena_FragGrenade_C::StaticClass()->DefaultObject);
