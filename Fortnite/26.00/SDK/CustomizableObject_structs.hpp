...
{
public:
	uint8                                        Pad_16EE[0x10];                                    // Fixing Size After Last Property 
	class FString                                Name;                                              // 0x10(0x10)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTexture*                              Texture;                                           // 0x20(0x8)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_16F0[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_16F2[0x10];                                    // Fixing Size After Last Property 
...
{
public:
	class USkeleton*                             Skeleton;                                          // 0x0(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_16F6[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_16F9[0x20];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_16FA[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1700[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1701[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1702[0x4];                                     // Fixing Size Of Struct
};
...
public:
	class FString                                ParameterName;                                     // 0x0(0x10)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  ParameterValue;                                    // 0x10(0x4)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1709[0x4];                                     // Fixing Size After Last Property 
	class FString                                UID;                                               // 0x18(0x10)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                          ParameterRangeValues;                              // 0x28(0x10)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
...
public:
	...
	TSoftObjectPtr<class UTexture2D>             UIThumbnail;                                       // 0x28(0x20)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FString, class FString>           ExtraInformation;                                  // 0x48(0x50)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	TMap<class FString, TSoftObjectPtr<class UObject>> ExtraAssets;                                       // 0x98(0x50)(Edit, BlueprintVisible, UObjectWrapper, NativeAccessSpecifierPublic)
	float                                        MinimumValue;                                      // 0xE8(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        MaximumValue;                                      // 0xEC(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FMutableParamUIMetadata               ParamUIMetadata;                                   // 0x10(0xF0)(BlueprintVisible, NativeAccessSpecifierPublic)
};
...
public:
	class FString                                Name;                                              // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMutableParamUIMetadata               ParamUIMetadata;                                   // 0x10(0xF0)(BlueprintVisible, NativeAccessSpecifierPublic)
	enum class EMutableParameterType             Type;                                              // 0x100(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1710[0x7];                                     // Fixing Size After Last Property 
	TArray<struct FIntegerParameterUIData>       ArrayIntegerParameterOption;                       // 0x108(0x10)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	enum class ECustomizableObjectGroupType      IntegerParameterGroupType;                         // 0x118(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class ETextureCompressionStrategy       TextureCompressionStrategy;                        // 0x119(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bLiveUpdateMode;                                   // 0x11A(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bReuseInstanceTextures;                            // 0x11B(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1711[0x4];                                     // Fixing Size After Last Property 
	TMap<class FString, class FString>           ForcedParameterValues;                             // 0x120(0x50)(BlueprintVisible, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1717[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1718[0x27];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_171A[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_171B[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_171D[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_171F[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1720[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1721[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	TSoftClassPtr<class UAnimInstance>           AnimInstanceClass;                                 // 0x0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPhysicsAsset>          SourceAsset;                                       // 0x20(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        PropertyIndex;                                     // 0x40(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1724[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1727[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_172A[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_172B[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_172C[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1730[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1734[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	TSoftObjectPtr<class USkeleton>              Skeleton;                                          // 0x80(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPhysicsAsset>          PhysicsAsset;                                      // 0xA0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UAnimInstance>           PostProcessAnimInst;                               // 0xC0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UPhysicsAsset>          ShadowPhysicsAsset;                                // 0xE0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FMutableRefAssetUserData>      AssetUserData;                                     // 0x100(0x10)(ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_1745[0x80];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1747[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1748[0x70];                                    // Fixing Size After Last Property 
...
{
public:
	TSoftObjectPtr<class UCustomizableObjectExtensionDataContainer> ContainerPath;                                     // 0x0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCustomizableObjectExtensionDataContainer* Container;                                         // 0x20(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
{
public:
	uint8                                        Pad_174B[0x8];                                     // Fixing Size Of Struct
};
