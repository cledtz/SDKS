...
class UClass* UBoarRidingPlayerLayerAnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BoarRidingPlayerLayerAnimBP_C");

	return Clss;
}


// BoarRidingPlayerLayerAnimBP_C BoarRidingPlayerLayerAnimBP.Default__BoarRidingPlayerLayerAnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBoarRidingPlayerLayerAnimBP_C* UBoarRidingPlayerLayerAnimBP_C::GetDefaultObj()
{
	static class UBoarRidingPlayerLayerAnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBoarRidingPlayerLayerAnimBP_C*>(UBoarRidingPlayerLayerAnimBP_C::StaticClass()->DefaultObject);
