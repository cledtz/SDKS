...
class UUserWidget* UOptionsMenuSetting_C::OnGetUserMenuContent(class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UTooltipMinusBasicMinusS_C* CallFunc_Create_ReturnValue)
{
	static class UFunction* Func = nullptr;
