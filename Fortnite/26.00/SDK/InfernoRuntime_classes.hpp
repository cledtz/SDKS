...
public:
	...
	uint8                                        Pad_1BCB[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1BD1[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UFortCurieVoxelFireDebugParticleDataInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1BD8[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_1BE2[0x30];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1BE5[0x50];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1BEF[0x60];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1BFB[0x50];                                    // Fixing Size After Last Property 
...
public:
	...
	static class UClass* StaticClass();
	static class UFortCurieVoxelFireParticleDataInterface* GetDefaultObj();
...
public:
	...
	static class UClass* StaticClass();
	static class UInfernoCurieVoxelFireAudioParticleDataInterface* GetDefaultObj();
