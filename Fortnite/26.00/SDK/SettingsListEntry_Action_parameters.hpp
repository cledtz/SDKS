...
public:
	...
	uint8                                        Pad_100A[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_100C[0x3];                                     // Fixing Size After Last Property 
	struct FGeometry                             K2Node_Event_MyGeometry;                           // 0x14(0x38)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_100D[0x4];                                     // Fixing Size After Last Property 
