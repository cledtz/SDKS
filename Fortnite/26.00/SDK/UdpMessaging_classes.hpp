...
public:
	...
	uint8                                        Pad_4EE5[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4EE8[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4EEA[0x6];                                     // Fixing Size After Last Property 
	...
	bool                                         bShareKnownNodesWithActiveConnections;             // 0x80(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         EnableTunnel;                                      // 0x81(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4EEF[0x6];                                     // Fixing Size After Last Property 
