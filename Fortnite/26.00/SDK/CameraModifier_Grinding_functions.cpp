...
class UClass* UCameraModifier_Grinding_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CameraModifier_Grinding_C");

	return Clss;
}


// CameraModifier_Grinding_C CameraModifier_Grinding.Default__CameraModifier_Grinding_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCameraModifier_Grinding_C* UCameraModifier_Grinding_C::GetDefaultObj()
{
	static class UCameraModifier_Grinding_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCameraModifier_Grinding_C*>(UCameraModifier_Grinding_C::StaticClass()->DefaultObject);
