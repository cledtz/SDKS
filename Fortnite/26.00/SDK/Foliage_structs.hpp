...
public:
	...
	uint8                                        BitPad_94 : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_FC7[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FC8[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_FC9[0x7];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_FCB[0x7];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_FCC[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FCE[0x18];                                     // Fixing Size Of Struct
};
