...
public:
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_RMakeTagContainer_L_Ntag__selector__container_R(const struct FVerseGameplayTagContainer& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_RMakeGameplayTagFromSubClass_L_NType_20where_20Type_R(class UClass* __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_RMakeGameplayTag_L_Ntag__selector_R(const struct FVerseGameplayTag& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_RFindObjectWithTag_L_Ntag_R(class UTags_tag* __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_REquals_L_Ntag__container_M_Ntag__container_R(const struct FTuple_Ltag__container_Mtag__container_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_N_REquals_L_Ntag_M_Ntag_R(const struct FTuple_Ltag_Mtag_R& __verse_0xB2CDDD72_Argument);
	void _InitCDO();
};
...
public:
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__container_N_RRemove_L_Ntag_R(class UTags_tag* __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__view_N_RHasAny_L_N_Ktag_R(const TArray<class UTags_tag*>& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__view_N_RHasAll_L_N_Ktag_R(const TArray<class UTags_tag*>& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__view_N_RHas_L_Ntag_R(class UTags_tag* __verse_0xB2CDDD72_Argument);
...
{
public:
	FVerseFunctionProperty_                      __verse_0xCE39A097__L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__container__component_N_RGetTags; // 0x70(0x10)(InstancedReference, HasGetValueTypeHash)
	FVerseFunctionProperty_                      __verse_0x4182B069__L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__container__component_N_RSetTags_L_Ntag__container_R; // 0x80(0x10)(InstancedReference, HasGetValueTypeHash)
	FVerseFunctionProperty_                      __verse_0x78A18B3B__L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__container__component_N_RAddTag_L_Ntag_R; // 0x90(0x10)(InstancedReference, HasGetValueTypeHash)
	FVerseFunctionProperty_                      __verse_0x60A0B16A__L_2fVerse_2eorg_2fSimulation_2fTags_2ftag__container__component_N_RRemoveTag_L_Ntag_R; // 0xA0(0x10)(InstancedReference, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_5EBC[0x7];                                     // Fixing Size Of Struct
