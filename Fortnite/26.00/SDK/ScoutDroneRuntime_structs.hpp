...
public:
	...
	uint8                                        Pad_29BF[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_29C0[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_29C6[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_29CB[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_29CC[0x4];                                     // Fixing Size Of Struct
};
