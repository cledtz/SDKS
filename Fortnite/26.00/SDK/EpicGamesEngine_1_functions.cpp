...
// $SolarisSignatureFunctionOuter EpicGamesEngine.Default__$SolarisSignatureFunctionOuter
...
class UClass* UEpicGames_Input_verse_ue_input_component::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EpicGames_Input_verse_ue_input_component");

	return Clss;
}


// EpicGames_Input_verse_ue_input_component EpicGamesEngine.Default__EpicGames_Input_verse_ue_input_component
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEpicGames_Input_verse_ue_input_component* UEpicGames_Input_verse_ue_input_component::GetDefaultObj()
{
	static class UEpicGames_Input_verse_ue_input_component* Default = nullptr;

	if (!Default)
		Default = static_cast<UEpicGames_Input_verse_ue_input_component*>(UEpicGames_Input_verse_ue_input_component::StaticClass()->DefaultObject);
...
// struct FTuple_L_Kchar_Minput__event_R_ExprResult_9                                                    (HasGetValueTypeHash)
...
// enum class EVerseTrue              _InvokeSureResultDummy_15                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
class UClass* UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("task_EpicGames_Input_verse_ue_input_component$WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R");

	return Clss;
}


// task_EpicGames_Input_verse_ue_input_component$WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R EpicGamesEngine.Default__task_EpicGames_Input_verse_ue_input_component$WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R* UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R::GetDefaultObj()
{
	static class UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R*>(UTask_EpicGames_Input_verse_ue_input_component_WaitForAction_L_Nverse__ue__input__component_M_N_Kchar_M_Ninput__event_R::StaticClass()->DefaultObject);
