...
{
public:
	class UVerseEngine_subscribable_event*       _Self;                                             // 0x140(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FTuple_L_R                            __verse_0xB2CDDD72_Argument;                       // 0x148(0x1)(Parm, HasGetValueTypeHash)
	uint8                                        Pad_5E00[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	class UClass* _L_2fVerse_2eorg_2fVerseEngine_N_Rsubscribable__event(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument, FVerseFunctionProperty_ _Callee_0, FVerseFunctionProperty_ _Callee_1);
	...
	class UClass* _L_2fVerse_2eorg_2fVerseEngine_N_Rmulticast__delegate(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument, FVerseFunctionProperty_ _Callee_0, FVerseFunctionProperty_ _Callee_1);
	void _InitCDO();
};
...
public:
	...
	uint8                                        Pad_5E4E[0x8];                                     // Fixing Size Of Struct
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fVerseEngine_2fEntity_2fentity_N_RHasComponents_L_N_Ksubtype_Lcomponent_R_R(const TArray<class UClass*>& __verse_0xB2CDDD72_Argument, uint8 _ExprResult_0, int64 _ForIndex_1, int64 _ForLength_2, class UClass* __verse_0xF655308E_ComponentClass_4, FOptionalProperty_ _ExprResultStack_3, FOptionalProperty_ _ExprResultStack_4, FVerseFunctionProperty_ _Callee_5, FOptionalProperty_ _ExprResultStack_6, uint8 _ExprResult_7, int64 _ForIndex_8, int64 _ForLength_9, class UClass* __verse_0xF655308E_ComponentClass_12, FOptionalProperty_ _ExprResultStack_10, FOptionalProperty_ _ExprResultStack_11, FVerseFunctionProperty_ _Callee_12, FOptionalProperty_ _ExprResultStack_13);
	FOptionalProperty_ _L_2fVerse_2eorg_2fVerseEngine_2fEntity_2fentity_N_RGetOrCreateComponentOfType_L_NComponentType_20where_20ComponentType_R(class UClass* __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fVerseEngine_2fEntity_2fentity_N_RGetComponentOfType_L_NComponentType_20where_20ComponentType_R(class UClass* __verse_0xB2CDDD72_Argument);
...
public:
	...
	FOptionalProperty_ _L_2fVerse_2eorg_2fVerseEngine_2fEntity_2fEntityHelpers_N_RGetEntityFromComponent_L_Ncomponent_R(class UEntityComponent* __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fVerse_2eorg_2fVerseEngine_2fEntity_2fEntityHelpers_N_RGetComponentOfTypeC_L_Ncomponent_M_NType_20where_20Type_R(const struct FTuple_Lcomponent_Many_R& __verse_0xB2CDDD72_Argument);
...
{
public:
	uint8                                        Pad_5E67[0x40];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_5E69[0x8];                                     // Fixing Size After Last Property 
	FOptionalProperty_                           __verse_0xC5BA7E5B_InternalDelegate;               // 0x40(0x8)(ZeroConstructor, InstancedReference, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_5E6A[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_5E79[0x28];                                    // Fixing Size Of Struct
