...
public:
	...
	uint8                                        Pad_11AD[0x7];                                     // Fixing Size After Last Property 
	class UActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x50(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_VictoryDrone_C*                    K2Node_DynamicCast_AsBP_Victory_Drone;             // 0x58(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
