...
public:
	...
	uint8                                        Pad_4D2D[0x8];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_4D2F[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        BitPad_2AD : 7;                                    // Fixing Bit-Field Size 
	uint8                                        Pad_4D31[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        BitPad_2AE : 7;                                    // Fixing Bit-Field Size 
...
public:
	struct FSpatialMath_vector3                  __verse_0x18E3F084_Elem0;                          // 0x0(0x18)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4D37[0x8];                                     // Fixing Size After Last Property 
