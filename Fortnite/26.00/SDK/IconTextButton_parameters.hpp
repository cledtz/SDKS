...
public:
	...
	uint8                                        Pad_89E4[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_89E7[0x5];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_89EE[0xA];                                     // Fixing Size After Last Property 
	...
	class FText                                  CallFunc_GetEmptyText_ReturnValue;                 // 0x148(0x18)(None)
