...
class UClass* UB_MusicEventDebugWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_MusicEventDebugWidget_C");

	return Clss;
}


// B_MusicEventDebugWidget_C B_MusicEventDebugWidget.Default__B_MusicEventDebugWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UB_MusicEventDebugWidget_C* UB_MusicEventDebugWidget_C::GetDefaultObj()
{
	static class UB_MusicEventDebugWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_MusicEventDebugWidget_C*>(UB_MusicEventDebugWidget_C::StaticClass()->DefaultObject);
