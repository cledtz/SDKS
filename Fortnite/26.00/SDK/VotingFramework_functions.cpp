...
class UClass* UVoteInitiationActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UVoteInitiationActor* UVoteInitiationActor::GetDefaultObj()
{
	static class UVoteInitiationActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UVoteInitiationActor*>(UVoteInitiationActor::StaticClass()->DefaultObject);
