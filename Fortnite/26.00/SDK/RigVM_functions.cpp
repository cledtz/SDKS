...
// Parameters:
// struct FRigVMExtendedExecuteContextContext                                                          (Parm, OutParm, NativeAccessSpecifierPublic)
...
class UClass* UNameSpacedUserData::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NameSpacedUserData");

	return Clss;
}


// NameSpacedUserData RigVM.Default__NameSpacedUserData
// (Public, ClassDefaultObject, ArchetypeObject)

class UNameSpacedUserData* UNameSpacedUserData::GetDefaultObj()
{
	static class UNameSpacedUserData* Default = nullptr;

	if (!Default)
		Default = static_cast<UNameSpacedUserData*>(UNameSpacedUserData::StaticClass()->DefaultObject);
...
class UClass* UDataAssetLink::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DataAssetLink");

	return Clss;
}


// DataAssetLink RigVM.Default__DataAssetLink
// (Public, ClassDefaultObject, ArchetypeObject)

class UDataAssetLink* UDataAssetLink::GetDefaultObj()
{
	static class UDataAssetLink* Default = nullptr;

	if (!Default)
		Default = static_cast<UDataAssetLink*>(UDataAssetLink::StaticClass()->DefaultObject);
...
// (Native, Public, BlueprintCallable)
// Parameters:
// struct FRigVMExtendedExecuteContextReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
...
struct FRigVMExtendedExecuteContext URigVMHost::GetExtendedExecuteContext()
{
	...
	Params::URigVMHost_GetExtendedExecuteContext_Params Parms{};
...
class UClass* URigVMEditorSettings::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RigVMEditorSettings");

	return Clss;
}


// RigVMEditorSettings RigVM.Default__RigVMEditorSettings
// (Public, ClassDefaultObject, ArchetypeObject)

class URigVMEditorSettings* URigVMEditorSettings::GetDefaultObj()
{
	static class URigVMEditorSettings* Default = nullptr;

	if (!Default)
		Default = static_cast<URigVMEditorSettings*>(URigVMEditorSettings::StaticClass()->DefaultObject);
