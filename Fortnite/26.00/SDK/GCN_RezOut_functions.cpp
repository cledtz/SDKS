...
class UClass* UGCN_RezOut_C::StaticClass()
{
...
class UGCN_RezOut_C* UGCN_RezOut_C::GetDefaultObj()
{
	static class UGCN_RezOut_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_RezOut_C*>(UGCN_RezOut_C::StaticClass()->DefaultObject);
...
void UGCN_RezOut_C::CleanMinusUp_Teleportation_Light(bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGCN_RezOut_C_CleanMinusUp_Teleportation_Light_Params Parms{};
...
void UGCN_RezOut_C::PreMinusSequence_Change()
{
	static class UFunction* Func = nullptr;
	...
	Params::UGCN_RezOut_C_PreMinusSequence_Change_Params Parms{};
