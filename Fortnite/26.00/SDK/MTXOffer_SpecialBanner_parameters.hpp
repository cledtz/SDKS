...
public:
	...
	uint8                                        Pad_34BB[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_34BC[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_34BE[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_34BF[0x7];                                     // Fixing Size After Last Property 
	class FText                                  K2Node_CustomEvent_SaleText;                       // 0xF0(0x18)(None)
	...
	class FText                                  CallFunc_Map_Find_Value;                           // 0x158(0x18)(None)
	...
	uint8                                        Pad_34C7[0x6];                                     // Fixing Size After Last Property 
	class FText                                  K2Node_Select_Default_4;                           // 0x178(0x18)(None)
	class FText                                  K2Node_Select_Default_5;                           // 0x190(0x18)(None)
	...
	uint8                                        Pad_34CA[0x3];                                     // Fixing Size After Last Property 
