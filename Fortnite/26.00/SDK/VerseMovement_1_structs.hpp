...
public:
	...
	uint8                                        BitPad_3FD : 7;                                    // Fixing Bit-Field Size 
	uint8                                        Pad_62EE[0x7];                                     // Fixing Size After Last Property 
	FVerseStringProperty_                        __verse_0x38D9A616_Name;                           // 0x8(0x10)(InstancedReference, HasGetValueTypeHash)
	FOptionalProperty_                           __verse_0x2A186A5F_AxisToMagnitudeCurve;           // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
	...
	uint8                                        BitPad_400 : 7;                                    // Fixing Bit-Field Size 
	uint8                                        Pad_62F2[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	FOptionalProperty_                           __verse_0x0C3D14E7_HitDistanceToMagnitudeCurve;    // 0x30(0x8)(ZeroConstructor, InstancedReference, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_62FA[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	FOptionalProperty_                           __verse_0x9D526629_MagnitudeCurve;                 // 0x20(0x8)(ZeroConstructor, InstancedReference, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
	...
	uint8                                        Pad_6301[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_6304[0x7];                                     // Fixing Size Of Struct
};
