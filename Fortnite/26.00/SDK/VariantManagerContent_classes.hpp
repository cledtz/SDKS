...
public:
	...
	uint8                                        Pad_51B9[0x50];                                    // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class ULevelVariantSetsActor* GetDefaultObj();
...
{
public:
	uint8                                        Pad_51CF[0x18];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_51D6[0x60];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_51D7[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_51D8[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_51D9[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_51DA[0x67];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_51F5[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_51F6[0x4];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class USwitchActor* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_5252[0x18];                                    // Fixing Size After Last Property 
...
public:
	...
	TLazyObjectPtr<class UObject>                LazyObjectPtr;                                     // 0x50(0x18)(IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UPropertyValue*>                CapturedProperties;                                // 0x68(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<struct FFunctionCaller>               FunctionCallers;                                   // 0x78(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
