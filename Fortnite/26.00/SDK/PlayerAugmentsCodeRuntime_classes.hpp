...
public:
	...
	uint8                                        Pad_366D[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_366F[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3673[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_36AF[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_36B1[0xF];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_372F[0x20];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_3736[0x28];                                    // Fixing Size After Last Property 
	...
	struct FFortItemEntry                        SelectorItemEntry;                                 // 0x240(0x198)(Net, Transient, RepNotify, NativeAccessSpecifierPrivate)
	struct FFortItemEntry                        LocalCachedPreviousWeapon;                         // 0x3D8(0x198)(Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3738[0x58];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_376C[0x20];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_376F[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_3770[0xC];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_37AD[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_37C7[0x50];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_37D4[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_381E[0x18];                                    // Fixing Size After Last Property 
