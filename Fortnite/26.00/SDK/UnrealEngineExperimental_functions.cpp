...
class UClass* UControllerComponentDebugDraw::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ControllerComponentDebugDraw");

	return Clss;
}


// ControllerComponentDebugDraw UnrealEngineExperimental.Default__ControllerComponentDebugDraw
// (Public, ClassDefaultObject, ArchetypeObject)

class UControllerComponentDebugDraw* UControllerComponentDebugDraw::GetDefaultObj()
{
	static class UControllerComponentDebugDraw* Default = nullptr;

	if (!Default)
		Default = static_cast<UControllerComponentDebugDraw*>(UControllerComponentDebugDraw::StaticClass()->DefaultObject);
