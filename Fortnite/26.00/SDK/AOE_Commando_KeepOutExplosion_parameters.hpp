...
{
public:
	struct FSoundAttenuationSettings             CallFunc_BP_GetAttenuationSettingsToApply_OutAttenuationSettings; // 0x0(0x3D0)(None)
	...
	uint8                                        Pad_5282[0x7];                                     // Fixing Size After Last Property 
	...
	struct FSoundAttenuationSettings             K2Node_MakeStruct_SoundAttenuationSettings;        // 0x3F0(0x3D0)(None)
...
public:
	...
	uint8                                        Pad_528F[0x4];                                     // Fixing Size After Last Property 
