...
public:
	...
	uint8                                        Pad_8CBE[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8CBF[0x4];                                     // Fixing Size After Last Property 
...
struct UGCN_RezIn_C_CleanMinusUp_Teleportation_Light_Params
{
public:
...
public:
	...
	uint8                                        Pad_8CC4[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8CC5[0x7];                                     // Fixing Size After Last Property 
...
struct UGCN_RezIn_C_PreMinusSequence_Change_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_8CD6[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8CD7[0x7];                                     // Fixing Size After Last Property 
	...
	TSoftObjectPtr<class UMaterialInterface>     CallFunc_Conv_ObjectToSoftObjectReference_ReturnValue; // 0x150(0x20)(UObjectWrapper, HasGetValueTypeHash)
	struct FGuid                                 CallFunc_BP_ApplyMaterialOverrideLocalWithFlags_ReturnValue; // 0x170(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_RemoveMaterialOverrideLocal_ReturnValue;  // 0x180(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8CD8[0x7];                                     // Fixing Size After Last Property 
	TArray<class UMaterialInstanceDynamic*>      K2Node_MakeArray_Array;                            // 0x188(0x10)(ConstParm, ReferenceParm)
	class UFortPlayerPawn*                       K2Node_CustomEvent_Pawn;                           // 0x198(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UCustomCharacterPart*                  K2Node_CustomEvent_Part;                           // 0x1A0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                K2Node_CustomEvent_MeshPart;                       // 0x1A8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	enum class EFortCustomPartType               K2Node_CustomEvent_PartType;                       // 0x1B0(0x1)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8CDA[0x3];                                     // Fixing Size After Last Property 
	float                                        CallFunc_UpdateDissolveFx_MaxLightIntensity_ImplicitCast; // 0x1B4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
