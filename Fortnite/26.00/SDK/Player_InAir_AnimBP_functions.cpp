...
class UClass* UPlayer_InAir_AnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Player_InAir_AnimBP_C");

	return Clss;
}


// Player_InAir_AnimBP_C Player_InAir_AnimBP.Default__Player_InAir_AnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayer_InAir_AnimBP_C* UPlayer_InAir_AnimBP_C::GetDefaultObj()
{
	static class UPlayer_InAir_AnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayer_InAir_AnimBP_C*>(UPlayer_InAir_AnimBP_C::StaticClass()->DefaultObject);
