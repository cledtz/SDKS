...
public:
	...
	uint8                                        Pad_9027[0x5];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_902D[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_902E[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_902F[0x4];                                     // Fixing Size After Last Property 
	...
	struct FSlateFontInfo                        CallFunc_GetFont_ReturnValue;                      // 0x60(0x58)(ConstParm, HasGetValueTypeHash)
	struct FSlateFontInfo                        K2Node_MakeStruct_SlateFontInfo;                   // 0xB8(0x58)(HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_9034[0x8];                                     // Fixing Size After Last Property 
	struct FEditableTextStyle                    K2Node_MakeStruct_EditableTextStyle;               // 0x30(0x2C0)(None)
...
public:
	...
	uint8                                        Pad_903A[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	struct FPointerEvent                         K2Node_Event_MouseEvent_1;                         // 0x70(0x78)(ConstParm)
	struct FPointerEvent                         K2Node_Event_MouseEvent;                           // 0xE8(0x78)(ConstParm)
	class FText                                  K2Node_Event_EditableText;                         // 0x160(0x18)(ConstParm)
	class FText                                  K2Node_Event_ErrorText;                            // 0x178(0x18)(ConstParm)
	class FText                                  K2Node_Event_HintText;                             // 0x190(0x18)(ConstParm)
	bool                                         CallFunc_TextIsEmpty_ReturnValue;                  // 0x1A8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x1A9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_BoolBool_ReturnValue;            // 0x1AA(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9043[0x5];                                     // Fixing Size After Last Property 
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationReverse_ReturnValue;         // 0x1B0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	enum class ECommonInputType                  K2Node_CustomEvent_bNewInputType;                  // 0x1C0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_IsDesignTime;                         // 0x1C1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
