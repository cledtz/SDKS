...
{
public:
	TSoftObjectPtr<class UActor>                 ActorToTrack;                                      // 0x0(0x20)(Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               RelativeOffset;                                    // 0x20(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bDrawDebugTrackingFocusPoint : 1;                  // Mask: 0x1, PropSize: 0x10x38(0x1)(Edit, BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_A2F[0x3];                                      // Fixing Size After Last Property 
	...
	struct FCameraTrackingFocusSettings          TrackingFocusSettings;                             // 0x8(0x40)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                        BitPad_44 : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_A32[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A34[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A3D[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A3E[0x18];                                     // Fixing Size After Last Property 
	TSoftObjectPtr<class UActor>                 ActorToTrack;                                      // 0x20(0x20)(Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               RelativeOffset;                                    // 0x40(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bAllowRoll : 1;                                    // Mask: 0x1, PropSize: 0x10x58(0x1)(Edit, BlueprintVisible, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_A3F[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A41[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A42[0x4];                                      // Fixing Size Of Struct
};
