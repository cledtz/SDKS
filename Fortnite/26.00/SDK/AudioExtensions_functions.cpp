...
class UClass* UAudioParameterControllerInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UAudioParameterControllerInterface* UAudioParameterControllerInterface::GetDefaultObj()
{
	static class UAudioParameterControllerInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UAudioParameterControllerInterface*>(UAudioParameterControllerInterface::StaticClass()->DefaultObject);
