...
class UClass* UB_Athena_Zipline_Ascender_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Athena_Zipline_Ascender_C");

	return Clss;
}


// B_Athena_Zipline_Ascender_C B_Athena_Zipline_Ascender.Default__B_Athena_Zipline_Ascender_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UB_Athena_Zipline_Ascender_C* UB_Athena_Zipline_Ascender_C::GetDefaultObj()
{
	static class UB_Athena_Zipline_Ascender_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_Athena_Zipline_Ascender_C*>(UB_Athena_Zipline_Ascender_C::StaticClass()->DefaultObject);
