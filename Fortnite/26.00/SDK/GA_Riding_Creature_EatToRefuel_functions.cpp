...
class UClass* UGA_Riding_Creature_EatToRefuel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Riding_Creature_EatToRefuel_C");

	return Clss;
}


// GA_Riding_Creature_EatToRefuel_C GA_Riding_Creature_EatToRefuel.Default__GA_Riding_Creature_EatToRefuel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Riding_Creature_EatToRefuel_C* UGA_Riding_Creature_EatToRefuel_C::GetDefaultObj()
{
	static class UGA_Riding_Creature_EatToRefuel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Riding_Creature_EatToRefuel_C*>(UGA_Riding_Creature_EatToRefuel_C::StaticClass()->DefaultObject);
