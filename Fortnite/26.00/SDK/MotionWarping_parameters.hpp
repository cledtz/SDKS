...
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4B2[0xC];                                      // Fixing Size After Last Property 
...
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4BC[0x4];                                      // Fixing Size After Last Property 
	struct FVector                               TargetLocation;                                    // 0x8(0x18)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                  WarpTargetName;                                    // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4C3[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_4C4[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_521[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_526[0x3];                                      // Fixing Size After Last Property 
