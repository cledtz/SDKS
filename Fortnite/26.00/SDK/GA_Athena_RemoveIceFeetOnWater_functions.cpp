...
void UGA_Athena_RemoveIceFeetOnWater_C::On_Movement_Mode_Changed(class UCharacter* Character, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
	static class UFunction* Func = nullptr;
