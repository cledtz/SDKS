...
class UClass* UNPCStatusWidget_AIBoss_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NPCStatusWidget_AIBoss_C");

	return Clss;
}


// NPCStatusWidget_AIBoss_C NPCStatusWidget_AIBoss.Default__NPCStatusWidget_AIBoss_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UNPCStatusWidget_AIBoss_C* UNPCStatusWidget_AIBoss_C::GetDefaultObj()
{
	static class UNPCStatusWidget_AIBoss_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UNPCStatusWidget_AIBoss_C*>(UNPCStatusWidget_AIBoss_C::StaticClass()->DefaultObject);
