...
public:
	...
	uint8                                        Pad_8B00[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B01[0x3];                                     // Fixing Size After Last Property 
	struct FSlateChildSize                       K2Node_MakeStruct_SlateChildSize;                  // 0x5C(0x8)(NoDestructor)
	uint8                                        Pad_8B02[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B04[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B05[0x3];                                     // Fixing Size After Last Property 
