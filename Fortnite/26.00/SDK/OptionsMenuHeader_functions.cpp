...
void UOptionsMenuHeader_C::SetFontSize(class UCommonTextBlock* Text, int32 DefaultSize, int32 MobileSize, const struct FSlateFontInfo& TempFont, bool Temp_bool_Variable, bool CallFunc_IsMobileGame_ReturnValue, int32 K2Node_Select_Default, double CallFunc_Conv_IntToDouble_ReturnValue, float K2Node_SetFieldsInStruct_Size_ImplicitCast)
{
...
void UOptionsMenuHeader_C::CenterOnWidget_1()
{
	...
	Params::UOptionsMenuHeader_C_CenterOnWidget_1_Params Parms{};
