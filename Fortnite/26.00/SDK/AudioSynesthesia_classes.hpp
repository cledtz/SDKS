...
public:
	...
	uint8                                        Pad_2FA7[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	float                                        NoiseFloorDb;                                      // 0x38(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2FAB[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2FD1[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2FD2[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2FD3[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2FD4[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2FD9[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2FDB[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3010[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_3011[0x18];                                    // Fixing Size Of Struct
