...
class UClass* UAOE_Commando_KeepOutExplosion_C::StaticClass()
{
...
class UAOE_Commando_KeepOutExplosion_C* UAOE_Commando_KeepOutExplosion_C::GetDefaultObj()
{
	static class UAOE_Commando_KeepOutExplosion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAOE_Commando_KeepOutExplosion_C*>(UAOE_Commando_KeepOutExplosion_C::StaticClass()->DefaultObject);
