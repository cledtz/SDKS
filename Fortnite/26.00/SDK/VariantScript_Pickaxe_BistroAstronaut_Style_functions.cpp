...
class UClass* UVariantScript_Pickaxe_BistroAstronaut_Style_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VariantScript_Pickaxe_BistroAstronaut_Style_C");

	return Clss;
}


// VariantScript_Pickaxe_BistroAstronaut_Style_C VariantScript_Pickaxe_BistroAstronaut_Style.Default__VariantScript_Pickaxe_BistroAstronaut_Style_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UVariantScript_Pickaxe_BistroAstronaut_Style_C* UVariantScript_Pickaxe_BistroAstronaut_Style_C::GetDefaultObj()
{
	static class UVariantScript_Pickaxe_BistroAstronaut_Style_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVariantScript_Pickaxe_BistroAstronaut_Style_C*>(UVariantScript_Pickaxe_BistroAstronaut_Style_C::StaticClass()->DefaultObject);
...
struct FGameplayTag UVariantScript_Pickaxe_BistroAstronaut_Style_C::DetermineVariantSelection(struct FFortAthenaLoadout& Loadout, bool CallFunc_IsItemInLoadout_ReturnValue, const struct FGameplayTag& CallFunc_GetActiveVariantForSoftItemAndChannel_ReturnValue, const struct FGameplayTag& CallFunc_GetActiveVariantForSoftItemAndChannel_ReturnValue_1)
{
	...
	Params::UVariantScript_Pickaxe_BistroAstronaut_Style_C_DetermineVariantSelection_Params Parms{};
