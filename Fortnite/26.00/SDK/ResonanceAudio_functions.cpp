...
class UClass* UResonanceAudioDirectivityVisualizer::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UResonanceAudioDirectivityVisualizer* UResonanceAudioDirectivityVisualizer::GetDefaultObj()
{
	static class UResonanceAudioDirectivityVisualizer* Default = nullptr;

	if (!Default)
		Default = static_cast<UResonanceAudioDirectivityVisualizer*>(UResonanceAudioDirectivityVisualizer::StaticClass()->DefaultObject);
