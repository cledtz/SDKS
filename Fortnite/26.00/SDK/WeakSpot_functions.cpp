...
class UClass* UWeakSpot_C::StaticClass()
{
...
class UWeakSpot_C* UWeakSpot_C::GetDefaultObj()
{
	static class UWeakSpot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWeakSpot_C*>(UWeakSpot_C::StaticClass()->DefaultObject);
