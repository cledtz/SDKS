...
class UClass* UWindManager_C::StaticClass()
{
...
class UWindManager_C* UWindManager_C::GetDefaultObj()
{
	static class UWindManager_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWindManager_C*>(UWindManager_C::StaticClass()->DefaultObject);
