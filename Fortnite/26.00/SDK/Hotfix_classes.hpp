...
{
public:
	uint8                                        Pad_1ADC[0x200];                                   // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_1AE0[0x60];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AE5[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AE9[0x23];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AEA[0x26];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AEB[0x58];                                    // Fixing Size Of Struct
