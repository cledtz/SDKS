...
class UClass* UWolfRidingPlayerLayerAnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WolfRidingPlayerLayerAnimBP_C");

	return Clss;
}


// WolfRidingPlayerLayerAnimBP_C WolfRidingPlayerLayerAnimBP.Default__WolfRidingPlayerLayerAnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWolfRidingPlayerLayerAnimBP_C* UWolfRidingPlayerLayerAnimBP_C::GetDefaultObj()
{
	static class UWolfRidingPlayerLayerAnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWolfRidingPlayerLayerAnimBP_C*>(UWolfRidingPlayerLayerAnimBP_C::StaticClass()->DefaultObject);
