...
public:
	...
	uint8                                        Pad_1AAE[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1AC0[0xF];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1AC9[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	TSoftObjectPtr<class UObject>                ResourceObject;                                    // 0x20(0x20)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                             ImageSize;                                         // 0x40(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1ACC[0xC];                                     // Fixing Size After Last Property 
	struct FSlateBrush                           OverrideBrush;                                     // 0x30(0xC0)(Edit, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FUIActionTag                          ActionTag;                                         // 0x0(0x4)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1AD0[0x4];                                     // Fixing Size After Last Property 
