...
class UClass* UBP_ZipLine_Athena_Harness_C::StaticClass()
{
...
class UBP_ZipLine_Athena_Harness_C* UBP_ZipLine_Athena_Harness_C::GetDefaultObj()
{
	static class UBP_ZipLine_Athena_Harness_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_ZipLine_Athena_Harness_C*>(UBP_ZipLine_Athena_Harness_C::StaticClass()->DefaultObject);
