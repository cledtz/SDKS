...
struct UVaultCamera_Blueprint_C_BP_OnActivated_Params
{
public:
...
struct UVaultCamera_Blueprint_C_BP_OnDeactivated_Params
{
public:
	class UFortPlayerController*                 PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
struct UVaultCamera_Blueprint_C_ExecuteUbergraph_VaultCamera_Blueprint_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_760E[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_760F[0x4];                                     // Fixing Size After Last Property 
	class UFortPlayerController*                 K2Node_Event_PlayerController_1;                   // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortPlayerController*                 K2Node_Event_PlayerController;                     // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
