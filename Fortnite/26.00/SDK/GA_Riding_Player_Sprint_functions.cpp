...
class UClass* UGA_Riding_Player_Sprint_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Riding_Player_Sprint_C");

	return Clss;
}


// GA_Riding_Player_Sprint_C GA_Riding_Player_Sprint.Default__GA_Riding_Player_Sprint_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Riding_Player_Sprint_C* UGA_Riding_Player_Sprint_C::GetDefaultObj()
{
	static class UGA_Riding_Player_Sprint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Riding_Player_Sprint_C*>(UGA_Riding_Player_Sprint_C::StaticClass()->DefaultObject);
