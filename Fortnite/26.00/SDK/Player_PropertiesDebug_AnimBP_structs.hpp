...
{
public:
	uint8                                        Pad_68F9[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_68FA[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_68FB[0x7];                                     // Fixing Size After Last Property 
	struct FAnimSubsystem_PropertyAccess         AnimBlueprintExtension_PropertyAccess;             // 0x30(0x80)(None)
	struct FAnimSubsystem_Base                   AnimBlueprintExtension_Base;                       // 0xB0(0x18)(None)
};
