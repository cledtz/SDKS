...
class UBP_FortniteLobbyLightSwitcher_C : public UActor
{
public:
	...
	class UDirectionalLight*                     DirectionLight;                                    // 0x2A0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class USkyLight*                             SkyLight;                                          // 0x2A8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	TArray<class UPointLight*>                   Pointlights;                                       // 0x2B0(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate)
	class UExponentialHeightFog*                 ExponentialHeightFog;                              // 0x2C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class UDirectionalLight*                     DirectionalLight_LowDetailMode;                    // 0x2C8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	TArray<class UEmitter*>                      ParticleSystems;                                   // 0x2D0(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate)
	...
	uint8                                        Pad_877B[0x6];                                     // Fixing Size After Last Property 
	class USkyLight*                             SkyLight_LowDetailMode;                            // 0x2E8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	class UExponentialHeightFog*                 ExponentialHeightfog_LowDetailMode;                // 0x2F0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_877C[0x2];                                     // Fixing Size After Last Property 
	struct FLinearColor                          MPCMinusManualSunlightVector;                      // 0x2FC(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          MPCMinusManualSunlightColor;                       // 0x30C(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UBP_FortniteLobbyLightSwitcher_C* GetDefaultObj();
