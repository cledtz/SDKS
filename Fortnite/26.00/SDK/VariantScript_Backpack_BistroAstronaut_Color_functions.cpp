...
class UClass* UVariantScript_Backpack_BistroAstronaut_Color_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VariantScript_Backpack_BistroAstronaut_Color_C");

	return Clss;
}


// VariantScript_Backpack_BistroAstronaut_Color_C VariantScript_Backpack_BistroAstronaut_Color.Default__VariantScript_Backpack_BistroAstronaut_Color_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UVariantScript_Backpack_BistroAstronaut_Color_C* UVariantScript_Backpack_BistroAstronaut_Color_C::GetDefaultObj()
{
	static class UVariantScript_Backpack_BistroAstronaut_Color_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVariantScript_Backpack_BistroAstronaut_Color_C*>(UVariantScript_Backpack_BistroAstronaut_Color_C::StaticClass()->DefaultObject);
