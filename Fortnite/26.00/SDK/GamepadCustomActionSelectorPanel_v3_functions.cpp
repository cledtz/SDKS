...
// class UGamepadKeyTextButton_C*     ReturnItem_Local                                                 (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UGamepadKeyTextButton_C*     CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// TArray<class UFortOptionsMenuInputData*>InputData                                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// TArray<class UFortOptionsMenuInputData*>K2Node_CustomEvent_InputData                                     (ConstParm, ReferenceParm)
...
// class UGamepadKeyTextButton_C*     CallFunc_CreateCustomListItem_ReturnItem                         (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
