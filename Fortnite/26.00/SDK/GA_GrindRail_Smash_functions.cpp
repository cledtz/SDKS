...
class UClass* UGA_GrindRail_Smash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_GrindRail_Smash_C");

	return Clss;
}


// GA_GrindRail_Smash_C GA_GrindRail_Smash.Default__GA_GrindRail_Smash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_GrindRail_Smash_C* UGA_GrindRail_Smash_C::GetDefaultObj()
{
	static class UGA_GrindRail_Smash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_GrindRail_Smash_C*>(UGA_GrindRail_Smash_C::StaticClass()->DefaultObject);
