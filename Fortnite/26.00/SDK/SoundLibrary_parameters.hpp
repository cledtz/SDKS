...
{
public:
	struct FSoundLibraryContextEventInput        InEventData;                                       // 0x0(0x38)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<class UAudioComponent*>               OutComponents;                                     // 0x38(0x10)(Parm, OutParm, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_14A3[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14A9[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14AC[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14B1[0x4];                                     // Fixing Size Of Struct
};
...
public:
	struct FGameplayTag                          InTag;                                             // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14CF[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14E6[0x3];                                     // Fixing Size Of Struct
};
...
public:
	struct FGameplayTag                          InEventName;                                       // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14FE[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1500[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1509[0x7];                                     // Fixing Size Of Struct
};
...
public:
	struct FGameplayTag                          InEventName;                                       // 0x0(0x4)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1514[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x10(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_153A[0x7];                                     // Fixing Size Of Struct
};
