...
class UClass* UCableActor::StaticClass()
{
...
class UCableActor* UCableActor::GetDefaultObj()
{
	static class UCableActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UCableActor*>(UCableActor::StaticClass()->DefaultObject);
...
void UCableComponent::SetAttachEndTo(class UActor* Actor, class FName ComponentProperty, class FName SocketName)
{
	static class UFunction* Func = nullptr;
...
class UActor* UCableComponent::GetAttachedActor()
{
	static class UFunction* Func = nullptr;
