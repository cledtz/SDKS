...
public:
	...
	uint8                                        Pad_F41[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_F4C[0x4];                                      // Fixing Size Of Struct
};
...
{
public:
	TScriptInterface<class UAudioComponentGroupExtension> NewExtension;                                      // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	class FName                                  ParamName;                                         // 0x0(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_F70[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_F7B[0x3];                                      // Fixing Size Of Struct
};
