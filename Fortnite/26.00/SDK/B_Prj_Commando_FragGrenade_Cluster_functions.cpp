...
class UClass* UB_Prj_Commando_FragGrenade_Cluster_C::StaticClass()
{
...
class UB_Prj_Commando_FragGrenade_Cluster_C* UB_Prj_Commando_FragGrenade_Cluster_C::GetDefaultObj()
{
	static class UB_Prj_Commando_FragGrenade_Cluster_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_Prj_Commando_FragGrenade_Cluster_C*>(UB_Prj_Commando_FragGrenade_Cluster_C::StaticClass()->DefaultObject);
