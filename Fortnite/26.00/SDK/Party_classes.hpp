...
public:
	...
	uint8                                        Pad_7B6[0x18];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7B8[0x80];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7B9[0xF0];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7BE[0x40];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7C1[0x50];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7C3[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_7C4[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_7C5[0x1C8];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7C7[0x50];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7C9[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_7CA[0x60];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7CD[0xC0];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_7D1[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7D7[0x38];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7D8[0x10];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7D9[0x57];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7DA[0x70];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7DC[0x2C];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7DD[0x10C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7DE[0x48];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_7DF[0x98];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7E0[0x60];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_7E2[0x4];                                      // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_7E3[0x1A8];                                    // Fixing Size Of Struct
