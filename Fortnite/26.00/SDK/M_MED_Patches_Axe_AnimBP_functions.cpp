...
class UClass* UM_MED_Patches_Axe_AnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("M_MED_Patches_Axe_AnimBP_C");

	return Clss;
}


// M_MED_Patches_Axe_AnimBP_C M_MED_Patches_Axe_AnimBP.Default__M_MED_Patches_Axe_AnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UM_MED_Patches_Axe_AnimBP_C* UM_MED_Patches_Axe_AnimBP_C::GetDefaultObj()
{
	static class UM_MED_Patches_Axe_AnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UM_MED_Patches_Axe_AnimBP_C*>(UM_MED_Patches_Axe_AnimBP_C::StaticClass()->DefaultObject);
