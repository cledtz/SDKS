...
public:
	...
	uint8                                        Pad_41CD[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_41CF[0x6];                                     // Fixing Size Of Struct
...
{
public:
	struct FDataTableRowHandle                   MainMenuInputRowHandle;                            // 0x3E8(0x10)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
