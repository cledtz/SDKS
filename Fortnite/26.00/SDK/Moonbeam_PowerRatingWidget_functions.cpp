...
class UClass* UMoonbeam_PowerRatingWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Moonbeam_PowerRatingWidget_C");

	return Clss;
}


// Moonbeam_PowerRatingWidget_C Moonbeam_PowerRatingWidget.Default__Moonbeam_PowerRatingWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMoonbeam_PowerRatingWidget_C* UMoonbeam_PowerRatingWidget_C::GetDefaultObj()
{
	static class UMoonbeam_PowerRatingWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMoonbeam_PowerRatingWidget_C*>(UMoonbeam_PowerRatingWidget_C::StaticClass()->DefaultObject);
