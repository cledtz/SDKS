...
public:
	...
	uint8                                        Pad_52D6[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_52E4[0x5];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_52F0[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_52F1[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_531B[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_5321[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_5323[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_5327[0x7];                                     // Fixing Size After Last Property 
	double                                       CallFunc_FTrunc_A_ImplicitCast;                    // 0x160(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
