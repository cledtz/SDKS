...
public:
	...
	uint8                                        Pad_6B94[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_6B95[0x4];                                     // Fixing Size After Last Property 
	class UFortPlayerControllerZone*             CallFunc_GetPlayerController_AsFort_Player_Controller_Zone; // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	class UFortPlayerPawn*                       Pawn;                                              // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortPlayerControllerZone*             AsFort_Player_Controller_Zone;                     // 0x8(0x8)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6B96[0x7];                                     // Fixing Size After Last Property 
	class UController*                           CallFunc_GetController_ReturnValue;                // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortPlayerControllerZone*             K2Node_DynamicCast_AsFort_Player_Controller_Zone;  // 0x20(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_6BAA[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_6BAB[0x7];                                     // Fixing Size After Last Property 
	class UFortPlayerPawn*                       LocalPlayerPawn;                                   // 0x78(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
