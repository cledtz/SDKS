...
class UClass* UBoarRidableComponent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BoarRidableComponent_C");

	return Clss;
}


// BoarRidableComponent_C BoarRidableComponent.Default__BoarRidableComponent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBoarRidableComponent_C* UBoarRidableComponent_C::GetDefaultObj()
{
	static class UBoarRidableComponent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBoarRidableComponent_C*>(UBoarRidableComponent_C::StaticClass()->DefaultObject);
...
// Parameters:
// class UActor*                      HitActor                                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UBoarRidableComponent_C::OnReactionEvent(class UActor* HitActor, bool bFromAsyncSweepBox, enum class EFCollisionReactionType CollisionReactionType, bool bIsFirstContinuousReactionOnDelayableActor, struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;
...
// class UActor*                      CallFunc_GetOwner_ReturnValue_3                                  (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UActor*                      K2Node_CustomEvent_HitActor                                      (ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
