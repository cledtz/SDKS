...
class UClass* UNPC_Pawn_Wildlife_Parent_C::StaticClass()
{
...
class UNPC_Pawn_Wildlife_Parent_C* UNPC_Pawn_Wildlife_Parent_C::GetDefaultObj()
{
	static class UNPC_Pawn_Wildlife_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UNPC_Pawn_Wildlife_Parent_C*>(UNPC_Pawn_Wildlife_Parent_C::StaticClass()->DefaultObject);
...
void UNPC_Pawn_Wildlife_Parent_C::OnModifiedDamageReceived__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("NPC_Pawn_Wildlife_Parent_C", "OnModifiedDamageReceived__DelegateSignature");
...
void UNPC_Pawn_Wildlife_Parent_C::ConvertedDispatcher__DelegateSignature(bool Converted, class UFortPawn* InstigatorPawn)
{
	...
	if (!Func)
		Func = Class->GetFunction("NPC_Pawn_Wildlife_Parent_C", "ConvertedDispatcher__DelegateSignature");
