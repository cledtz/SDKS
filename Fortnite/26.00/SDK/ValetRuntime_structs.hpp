...
public:
	...
	uint8                                        Pad_3182[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3183[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3189[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_3192[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3194[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3195[0x48];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3196[0xB8];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3198[0x6];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3199[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_31A1[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_31AA[0x8];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_31B2[0x90];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_31C8[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_31CB[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_31E1[0x18];                                    // Fixing Size Of Struct
};
...
{
public:
	TSoftObjectPtr<class UFortVehicleItemDefinition> FortVehicleItemDefinition;                         // 0x0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               TransOffset;                                       // 0x20(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                              RotOffset;                                         // 0x38(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
