...
struct UCommonInputSettings_IsEnhancedInputSupportEnabled_Params
{
public:
...
{
public:
	class FName                                  InGamepadInputType;                                // 0x0(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UCommonInputSubsystem_BroadcastInputMethodChanged_Params
{
public:
};
