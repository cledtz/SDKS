...
{
public:
	uint8                                        Pad_1D54[0x8];                                     // Fixing Size After Last Property 
	...
	TArray<class UPlayerController*>             LocalControllers;                                  // 0x120(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_1D57[0x10];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UAudioShapeComponent* GetDefaultObj();

	void UpdateAudioShape(TArray<class UPlayerController*>& InLocalControllers);
	void Enable();
	void Disable();
};
...
public:
	...
	uint8                                        Pad_1D63[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1D64[0x48];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1D69[0x8];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1D84[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1D88[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1D89[0x28];                                    // Fixing Size After Last Property 
	...
	TArray<class UPlayerController*>             LocalControllers;                                  // 0x68(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1D8A[0x10];                                    // Fixing Size Of Struct
