...
class UClass* UVirtualHeightfieldMesh::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UVirtualHeightfieldMesh* UVirtualHeightfieldMesh::GetDefaultObj()
{
	static class UVirtualHeightfieldMesh* Default = nullptr;

	if (!Default)
		Default = static_cast<UVirtualHeightfieldMesh*>(UVirtualHeightfieldMesh::StaticClass()->DefaultObject);
