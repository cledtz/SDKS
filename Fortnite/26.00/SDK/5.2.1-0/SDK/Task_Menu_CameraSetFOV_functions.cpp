...
class UClass* UTask_Menu_CameraSetFOV_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_Menu_CameraSetFOV_C");

	return Clss;
}


// Task_Menu_CameraSetFOV_C Task_Menu_CameraSetFOV.Default__Task_Menu_CameraSetFOV_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_Menu_CameraSetFOV_C* UTask_Menu_CameraSetFOV_C::GetDefaultObj()
{
	static class UTask_Menu_CameraSetFOV_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_Menu_CameraSetFOV_C*>(UTask_Menu_CameraSetFOV_C::StaticClass()->DefaultObject);
