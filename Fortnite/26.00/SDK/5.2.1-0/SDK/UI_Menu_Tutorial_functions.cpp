...
class UClass* UUI_Menu_Tutorial_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Tutorial_C");

	return Clss;
}


// UI_Menu_Tutorial_C UI_Menu_Tutorial.Default__UI_Menu_Tutorial_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Tutorial_C* UUI_Menu_Tutorial_C::GetDefaultObj()
{
	static class UUI_Menu_Tutorial_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Tutorial_C*>(UUI_Menu_Tutorial_C::StaticClass()->DefaultObject);
