...
class UClass* UTask_Menu_GeneralMenuScreen_SetActivePage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_Menu_GeneralMenuScreen_SetActivePage_C");

	return Clss;
}


// Task_Menu_GeneralMenuScreen_SetActivePage_C Task_Menu_GeneralMenuScreen_SetActivePage.Default__Task_Menu_GeneralMenuScreen_SetActivePage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_Menu_GeneralMenuScreen_SetActivePage_C* UTask_Menu_GeneralMenuScreen_SetActivePage_C::GetDefaultObj()
{
	static class UTask_Menu_GeneralMenuScreen_SetActivePage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_Menu_GeneralMenuScreen_SetActivePage_C*>(UTask_Menu_GeneralMenuScreen_SetActivePage_C::StaticClass()->DefaultObject);
