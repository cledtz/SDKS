...
class UClass* UBP_Item_Accessory_Flashlight_01_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Item_Accessory_Flashlight_01_C");

	return Clss;
}


// BP_Item_Accessory_Flashlight_01_C BP_Item_Accessory_Flashlight_01.Default__BP_Item_Accessory_Flashlight_01_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Item_Accessory_Flashlight_01_C* UBP_Item_Accessory_Flashlight_01_C::GetDefaultObj()
{
	static class UBP_Item_Accessory_Flashlight_01_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Item_Accessory_Flashlight_01_C*>(UBP_Item_Accessory_Flashlight_01_C::StaticClass()->DefaultObject);
