...
class UClass* UUI_Button_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Button_C");

	return Clss;
}


// UI_Button_C UI_Button.Default__UI_Button_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Button_C* UUI_Button_C::GetDefaultObj()
{
	static class UUI_Button_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Button_C*>(UUI_Button_C::StaticClass()->DefaultObject);
