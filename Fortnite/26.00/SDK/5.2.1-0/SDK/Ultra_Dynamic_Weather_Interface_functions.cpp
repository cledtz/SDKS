...
class UClass* UUltra_Dynamic_Weather_Interface_C::StaticClass()
{
...
class UUltra_Dynamic_Weather_Interface_C* UUltra_Dynamic_Weather_Interface_C::GetDefaultObj()
{
	static class UUltra_Dynamic_Weather_Interface_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUltra_Dynamic_Weather_Interface_C*>(UUltra_Dynamic_Weather_Interface_C::StaticClass()->DefaultObject);
