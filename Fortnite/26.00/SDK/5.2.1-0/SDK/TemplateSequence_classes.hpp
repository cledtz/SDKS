...
public:
	...
	uint8                                        BitPad_9A : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_17BC[0x3];                                     // Fixing Size After Last Property 
	float                                        AspectRatio;                                       // 0x30(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17BD[0xC];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_17C1[0x7C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17C3[0x270];                                   // Fixing Size After Last Property 
	...
	uint8                                        Pad_17C4[0x60];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_17CD[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17D7[0x70];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17DB[0x58];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17E0[0x50];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17FB[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1801[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_180A[0x8];                                     // Fixing Size Of Struct
