...
class UClass* UTask_Multiplayer_RequestServer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_Multiplayer_RequestServer_C");

	return Clss;
}


// Task_Multiplayer_RequestServer_C Task_Multiplayer_RequestServer.Default__Task_Multiplayer_RequestServer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_Multiplayer_RequestServer_C* UTask_Multiplayer_RequestServer_C::GetDefaultObj()
{
	static class UTask_Multiplayer_RequestServer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_Multiplayer_RequestServer_C*>(UTask_Multiplayer_RequestServer_C::StaticClass()->DefaultObject);
...
// struct FPingQoSInfo                CallFunc_Array_Get_Item                                          (None)
