...
class UClass* UBP_Item_Rifle_ScarH_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Item_Rifle_ScarH_C");

	return Clss;
}


// BP_Item_Rifle_ScarH_C BP_Item_Rifle_ScarH.Default__BP_Item_Rifle_ScarH_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Item_Rifle_ScarH_C* UBP_Item_Rifle_ScarH_C::GetDefaultObj()
{
	static class UBP_Item_Rifle_ScarH_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Item_Rifle_ScarH_C*>(UBP_Item_Rifle_ScarH_C::StaticClass()->DefaultObject);
...
void UBP_Item_Rifle_ScarH_C::SetSight(bool Temp_bool_True_if_break_was_hit_Variable, int32 Temp_int_Array_Index_Variable, bool CallFunc_Not_PreBool_ReturnValue, class UItem_Module_General* CallFunc_Array_Get_Item, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult_1, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult_2, const struct FHitResult& CallFunc_K2_SetRelativeRotation_SweepHitResult_3, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	Params::UBP_Item_Rifle_ScarH_C_SetSight_Params Parms{};
...
void UBP_Item_Rifle_ScarH_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Item_Rifle_ScarH_C_ReceiveBeginPlay_Params Parms{};
...
void UBP_Item_Rifle_ScarH_C::OnSetGunModules_Event()
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Item_Rifle_ScarH_C_OnSetGunModules_Event_Params Parms{};
...
void UBP_Item_Rifle_ScarH_C::ExecuteUbergraph_BP_Item_Rifle_ScarH(int32 EntryPoint, bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_Item_Rifle_ScarH_C_ExecuteUbergraph_BP_Item_Rifle_ScarH_Params Parms{};
