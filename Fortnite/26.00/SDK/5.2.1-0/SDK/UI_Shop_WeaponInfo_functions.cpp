...
class UClass* UUI_Shop_WeaponInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Shop_WeaponInfo_C");

	return Clss;
}


// UI_Shop_WeaponInfo_C UI_Shop_WeaponInfo.Default__UI_Shop_WeaponInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Shop_WeaponInfo_C* UUI_Shop_WeaponInfo_C::GetDefaultObj()
{
	static class UUI_Shop_WeaponInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Shop_WeaponInfo_C*>(UUI_Shop_WeaponInfo_C::StaticClass()->DefaultObject);
