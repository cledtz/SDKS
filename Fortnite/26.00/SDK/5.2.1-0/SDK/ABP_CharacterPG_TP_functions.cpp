...
class UClass* UABP_CharacterPG_TP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ABP_CharacterPG_TP_C");

	return Clss;
}


// ABP_CharacterPG_TP_C ABP_CharacterPG_TP.Default__ABP_CharacterPG_TP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UABP_CharacterPG_TP_C* UABP_CharacterPG_TP_C::GetDefaultObj()
{
	static class UABP_CharacterPG_TP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UABP_CharacterPG_TP_C*>(UABP_CharacterPG_TP_C::StaticClass()->DefaultObject);
