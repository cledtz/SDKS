...
class UClass* UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C");

	return Clss;
}


// Task_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C Task_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle.Default__Task_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C* UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C::GetDefaultObj()
{
	static class UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C*>(UTask_MainMenu_Shop_Premium_Offers_GenerateBoosterBundle_C::StaticClass()->DefaultObject);
...
// struct FClientGetTimeResult        K2Node_CustomEvent_result_1                                      (None)
