...
class UClass* UUI_Menu_Solder_Gear_Watch_Slot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Solder_Gear_Watch_Slot_C");

	return Clss;
}


// UI_Menu_Solder_Gear_Watch_Slot_C UI_Menu_Solder_Gear_Watch_Slot.Default__UI_Menu_Solder_Gear_Watch_Slot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Solder_Gear_Watch_Slot_C* UUI_Menu_Solder_Gear_Watch_Slot_C::GetDefaultObj()
{
	static class UUI_Menu_Solder_Gear_Watch_Slot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Solder_Gear_Watch_Slot_C*>(UUI_Menu_Solder_Gear_Watch_Slot_C::StaticClass()->DefaultObject);
