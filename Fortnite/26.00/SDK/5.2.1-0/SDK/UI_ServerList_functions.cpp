...
class UClass* UUI_ServerList_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_ServerList_C");

	return Clss;
}


// UI_ServerList_C UI_ServerList.Default__UI_ServerList_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_ServerList_C* UUI_ServerList_C::GetDefaultObj()
{
	static class UUI_ServerList_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_ServerList_C*>(UUI_ServerList_C::StaticClass()->DefaultObject);
...
// struct FClientGetUserDataRequest   K2Node_MakeStruct_ClientGetUserDataRequest                       (None)
