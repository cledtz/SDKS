...
public:
	...
	uint8                                        Pad_13E8[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_13EA[0xC];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_13EC[0x8];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_13ED[0x8];                                     // Fixing Size After Last Property 
	struct FTransform                            Transform;                                         // 0x10(0x60)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKShapeElem                           Element;                                           // 0x70(0x30)(Edit, EditConst, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_13EF[0x8];                                     // Fixing Size Of Struct
};
