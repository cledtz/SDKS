...
class UClass* UMovieSceneCaptureInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UMovieSceneCaptureInterface* UMovieSceneCaptureInterface::GetDefaultObj()
{
	static class UMovieSceneCaptureInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneCaptureInterface*>(UMovieSceneCaptureInterface::StaticClass()->DefaultObject);
