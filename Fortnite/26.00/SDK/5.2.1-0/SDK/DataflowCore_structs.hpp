...
{
public:
	uint8                                        Pad_2300[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2302[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2304[0x28];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2305[0x20];                                    // Fixing Size Of Struct
};
