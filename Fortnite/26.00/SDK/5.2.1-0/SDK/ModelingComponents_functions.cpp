...
class UClass* UDynamicMeshCommitter::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UDynamicMeshCommitter* UDynamicMeshCommitter::GetDefaultObj()
{
	static class UDynamicMeshCommitter* Default = nullptr;

	if (!Default)
		Default = static_cast<UDynamicMeshCommitter*>(UDynamicMeshCommitter::StaticClass()->DefaultObject);
...
class UClass* UDynamicMeshProvider::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UDynamicMeshProvider* UDynamicMeshProvider::GetDefaultObj()
{
	static class UDynamicMeshProvider* Default = nullptr;

	if (!Default)
		Default = static_cast<UDynamicMeshProvider*>(UDynamicMeshProvider::StaticClass()->DefaultObject);
...
class UClass* UPersistentDynamicMeshSource::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UPersistentDynamicMeshSource* UPersistentDynamicMeshSource::GetDefaultObj()
{
	static class UPersistentDynamicMeshSource* Default = nullptr;

	if (!Default)
		Default = static_cast<UPersistentDynamicMeshSource*>(UPersistentDynamicMeshSource::StaticClass()->DefaultObject);
...
class UClass* UToolActivityHost::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UToolActivityHost* UToolActivityHost::GetDefaultObj()
{
	static class UToolActivityHost* Default = nullptr;

	if (!Default)
		Default = static_cast<UToolActivityHost*>(UToolActivityHost::StaticClass()->DefaultObject);
...
class UClass* UPreviewGeometryActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UPreviewGeometryActor* UPreviewGeometryActor::GetDefaultObj()
{
	static class UPreviewGeometryActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UPreviewGeometryActor*>(UPreviewGeometryActor::StaticClass()->DefaultObject);
...
class UClass* UPreviewMeshActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UPreviewMeshActor* UPreviewMeshActor::GetDefaultObj()
{
	static class UPreviewMeshActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UPreviewMeshActor*>(UPreviewMeshActor::StaticClass()->DefaultObject);
