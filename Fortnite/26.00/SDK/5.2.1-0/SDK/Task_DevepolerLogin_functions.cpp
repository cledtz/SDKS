...
class UClass* UTask_DevepolerLogin_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_DevepolerLogin_C");

	return Clss;
}


// Task_DevepolerLogin_C Task_DevepolerLogin.Default__Task_DevepolerLogin_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_DevepolerLogin_C* UTask_DevepolerLogin_C::GetDefaultObj()
{
	static class UTask_DevepolerLogin_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_DevepolerLogin_C*>(UTask_DevepolerLogin_C::StaticClass()->DefaultObject);
...
// struct FClientLoginWithCustomIDRequestK2Node_MakeStruct_ClientLoginWithCustomIDRequest                 (None)
...
// struct FClientLoginResult          K2Node_CustomEvent_result_1                                      (None)
...
// struct FClientGetPlayerCombinedInfoResultK2Node_CustomEvent_result                                        (None)
