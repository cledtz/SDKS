...
class UClass* UUI_ControlPointMarker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_ControlPointMarker_C");

	return Clss;
}


// UI_ControlPointMarker_C UI_ControlPointMarker.Default__UI_ControlPointMarker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_ControlPointMarker_C* UUI_ControlPointMarker_C::GetDefaultObj()
{
	static class UUI_ControlPointMarker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_ControlPointMarker_C*>(UUI_ControlPointMarker_C::StaticClass()->DefaultObject);
