...
class UClass* UUI_Shop_WeaponModules_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Shop_WeaponModules_C");

	return Clss;
}


// UI_Shop_WeaponModules_C UI_Shop_WeaponModules.Default__UI_Shop_WeaponModules_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Shop_WeaponModules_C* UUI_Shop_WeaponModules_C::GetDefaultObj()
{
	static class UUI_Shop_WeaponModules_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Shop_WeaponModules_C*>(UUI_Shop_WeaponModules_C::StaticClass()->DefaultObject);
