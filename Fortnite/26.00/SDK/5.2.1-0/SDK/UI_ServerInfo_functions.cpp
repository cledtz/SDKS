...
class UClass* UUI_ServerInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_ServerInfo_C");

	return Clss;
}


// UI_ServerInfo_C UI_ServerInfo.Default__UI_ServerInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_ServerInfo_C* UUI_ServerInfo_C::GetDefaultObj()
{
	static class UUI_ServerInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_ServerInfo_C*>(UUI_ServerInfo_C::StaticClass()->DefaultObject);
