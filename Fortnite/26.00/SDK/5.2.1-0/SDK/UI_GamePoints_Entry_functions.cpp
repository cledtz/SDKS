...
class UClass* UUI_GamePoints_Entry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_GamePoints_Entry_C");

	return Clss;
}


// UI_GamePoints_Entry_C UI_GamePoints_Entry.Default__UI_GamePoints_Entry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_GamePoints_Entry_C* UUI_GamePoints_Entry_C::GetDefaultObj()
{
	static class UUI_GamePoints_Entry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_GamePoints_Entry_C*>(UUI_GamePoints_Entry_C::StaticClass()->DefaultObject);
