...
class UClass* UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C");

	return Clss;
}


// UI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C UI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary.Default__UI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C* UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C::GetDefaultObj()
{
	static class UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C*>(UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_C::StaticClass()->DefaultObject);
