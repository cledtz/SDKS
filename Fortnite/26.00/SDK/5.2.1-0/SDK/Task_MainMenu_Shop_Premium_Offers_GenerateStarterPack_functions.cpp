...
class UClass* UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C");

	return Clss;
}


// Task_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C Task_MainMenu_Shop_Premium_Offers_GenerateStarterPack.Default__Task_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C* UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C::GetDefaultObj()
{
	static class UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C*>(UTask_MainMenu_Shop_Premium_Offers_GenerateStarterPack_C::StaticClass()->DefaultObject);
