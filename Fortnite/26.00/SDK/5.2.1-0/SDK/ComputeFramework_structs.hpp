...
{
public:
	uint8                                        Pad_D2E[0x8];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D2F[0x8];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D34[0x7];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_D3B[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D3D[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_D3E[0x13];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D40[0x4];                                      // Fixing Size Of Struct
};
