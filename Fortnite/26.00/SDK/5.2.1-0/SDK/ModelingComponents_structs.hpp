...
public:
	...
	uint8                                        Pad_4C1[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4D0[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_4D2[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_4D5[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_4D7[0x4];                                      // Fixing Size After Last Property 
	struct FMeshNaniteSettings                   NaniteSettings;                                    // 0xD0(0x38)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_4D8[0x4F8];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4DC[0x7];                                      // Fixing Size After Last Property 
