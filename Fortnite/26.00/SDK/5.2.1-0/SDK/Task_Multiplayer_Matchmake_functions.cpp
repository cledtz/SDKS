...
class UClass* UTask_Multiplayer_Matchmake_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Task_Multiplayer_Matchmake_C");

	return Clss;
}


// Task_Multiplayer_Matchmake_C Task_Multiplayer_Matchmake.Default__Task_Multiplayer_Matchmake_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTask_Multiplayer_Matchmake_C* UTask_Multiplayer_Matchmake_C::GetDefaultObj()
{
	static class UTask_Multiplayer_Matchmake_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTask_Multiplayer_Matchmake_C*>(UTask_Multiplayer_Matchmake_C::StaticClass()->DefaultObject);
