...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x50(0xD0)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush_1;                    // 0x120(0xD0)(None)
};
...
public:
	...
	uint8                                        Pad_2DCF[0x2];                                     // Fixing Size After Last Property 
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x3C(0x14)(None)
};
...
public:
	...
	uint8                                        Pad_2DD6[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2DD7[0x3];                                     // Fixing Size After Last Property 
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x9C(0x14)(None)
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor_3;                    // 0x100(0x14)(None)
