...
public:
	...
	uint8                                        Pad_AEA[0x7];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_AEC[0x18];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_AEE[0x8];                                      // Fixing Size After Last Property 
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x20(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_AF0[0x90];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_AF6[0x35];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_AF7[0x18];                                     // Fixing Size Of Struct
};
