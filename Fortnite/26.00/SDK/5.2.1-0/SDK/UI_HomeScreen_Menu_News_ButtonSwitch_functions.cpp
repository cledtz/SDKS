...
class UClass* UUI_HomeScreen_Menu_News_ButtonSwitch_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_HomeScreen_Menu_News_ButtonSwitch_C");

	return Clss;
}


// UI_HomeScreen_Menu_News_ButtonSwitch_C UI_HomeScreen_Menu_News_ButtonSwitch.Default__UI_HomeScreen_Menu_News_ButtonSwitch_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_HomeScreen_Menu_News_ButtonSwitch_C* UUI_HomeScreen_Menu_News_ButtonSwitch_C::GetDefaultObj()
{
	static class UUI_HomeScreen_Menu_News_ButtonSwitch_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_HomeScreen_Menu_News_ButtonSwitch_C*>(UUI_HomeScreen_Menu_News_ButtonSwitch_C::StaticClass()->DefaultObject);
...
void UUI_HomeScreen_Menu_News_ButtonSwitch_C::BndEvt__UI_HomeScreen_Offer_News_ButtonSwitch_Button_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("UI_HomeScreen_Menu_News_ButtonSwitch_C", "BndEvt__UI_HomeScreen_Offer_News_ButtonSwitch_Button_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature");
...
void UUI_HomeScreen_Menu_News_ButtonSwitch_C::SetIsActive(bool IsActive)
{
	...
	if (!Func)
		Func = Class->GetFunction("UI_HomeScreen_Menu_News_ButtonSwitch_C", "SetIsActive");
...
void UUI_HomeScreen_Menu_News_ButtonSwitch_C::ExecuteUbergraph_UI_HomeScreen_Menu_News_ButtonSwitch(int32 EntryPoint, class UPlayerController* CallFunc_GetPlayerController_ReturnValue, class UBP_PG_PlayerController_Menu_C* K2Node_DynamicCast_AsBP_PG_Player_Controller_Menu, bool K2Node_DynamicCast_bSuccess, bool K2Node_CustomEvent_isActive, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("UI_HomeScreen_Menu_News_ButtonSwitch_C", "ExecuteUbergraph_UI_HomeScreen_Menu_News_ButtonSwitch");
