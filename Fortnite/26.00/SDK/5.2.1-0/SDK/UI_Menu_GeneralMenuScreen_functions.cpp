...
class UClass* UUI_Menu_GeneralMenuScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_GeneralMenuScreen_C");

	return Clss;
}


// UI_Menu_GeneralMenuScreen_C UI_Menu_GeneralMenuScreen.Default__UI_Menu_GeneralMenuScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_GeneralMenuScreen_C* UUI_Menu_GeneralMenuScreen_C::GetDefaultObj()
{
	static class UUI_Menu_GeneralMenuScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_GeneralMenuScreen_C*>(UUI_Menu_GeneralMenuScreen_C::StaticClass()->DefaultObject);
...
// struct FMultiplayerListQosServersForTitleResponseK2Node_CustomEvent_result_1                                      (None)
...
// struct FClientGetTimeResult        K2Node_CustomEvent_result                                        (None)
...
// struct FPingQoSInfo                K2Node_MakeStruct_PingQoSInfo                                    (None)
