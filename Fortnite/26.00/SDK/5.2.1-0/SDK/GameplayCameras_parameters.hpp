...
public:
	...
	uint8                                        Pad_176A[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_17B9[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_17C5[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_17C8[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_17DA[0x4];                                     // Fixing Size After Last Property 
	class UCameraAnimationCameraModifier*        ReturnValue;                                       // 0x10(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1808[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_180C[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bImmediate;                                        // 0x8(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_180F[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1816[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_181F[0x3];                                     // Fixing Size Of Struct
};
