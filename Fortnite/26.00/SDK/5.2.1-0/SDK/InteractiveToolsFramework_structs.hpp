...
public:
	...
	uint8                                        Pad_25D[0x2];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_25E[0x3];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_25F[0x128];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_260[0x18];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_261[0x7];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_265[0x28];                                     // Fixing Size Of Struct
};
