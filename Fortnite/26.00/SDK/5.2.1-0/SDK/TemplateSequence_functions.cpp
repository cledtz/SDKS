...
class UClass* UTemplateSequenceActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UTemplateSequenceActor* UTemplateSequenceActor::GetDefaultObj()
{
	static class UTemplateSequenceActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UTemplateSequenceActor*>(UTemplateSequenceActor::StaticClass()->DefaultObject);
