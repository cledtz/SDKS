...
class UClass* UBP_UserEntry_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_UserEntry_C");

	return Clss;
}


// BP_UserEntry_C BP_UserEntry.Default__BP_UserEntry_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_UserEntry_C* UBP_UserEntry_C::GetDefaultObj()
{
	static class UBP_UserEntry_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_UserEntry_C*>(UBP_UserEntry_C::StaticClass()->DefaultObject);
