...
{
public:
	uint8                                        Pad_21EF[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_21F0[0x110];                                   // Fixing Size After Last Property 
	...
	uint8                                        Pad_21F1[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UChaosNotifyHandlerInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_21FE[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_21FF[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2202[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2203[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2204[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_2205[0x8];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UChaosSolverActor* GetDefaultObj();
...
{
public:
	uint8                                        Pad_2206[0x8];                                     // Fixing Size After Last Property 
