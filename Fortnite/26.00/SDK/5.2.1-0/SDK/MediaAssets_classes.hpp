...
{
public:
	uint8                                        Pad_C8E[0x58];                                     // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UMediaSourceRendererInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_CB7[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_CC2[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_CC4[0xC0];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_CCD[0x17];                                     // Fixing Size Of Struct
...
public:
	...
	FMulticastInlineDelegateProperty_            OnMetadataChanged;                                 // 0xA8(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FTimespan                             CacheAhead;                                        // 0xB8(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTimespan                             CacheBehind;                                       // 0xC0(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTimespan                             CacheBehindGame;                                   // 0xC8(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         NativeAudioOut;                                    // 0xD0(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         PlayOnOpen;                                        // 0xD1(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_E5A[0x2];                                      // Fixing Size After Last Property 
	uint8                                        Shuffle : 1;                                       // Mask: 0x1, PropSize: 0x10xD4(0x1)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Loop : 1;                                          // Mask: 0x2, PropSize: 0x10xD4(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        BitPad_61 : 6;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_E5B[0x3];                                      // Fixing Size After Last Property 
	class UMediaPlaylist*                        Playlist;                                          // 0xD8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FTimespan                             TimeDelay;                                         // 0xE8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                        HorizontalFieldOfView;                             // 0xF0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                        VerticalFieldOfView;                               // 0xF4(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FRotator                              ViewRotation;                                      // 0xF8(0x18)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_E64[0x28];                                     // Fixing Size After Last Property 
	struct FGuid                                 PlayerGuid;                                        // 0x138(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_E65[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UMediaPlayerProxyInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_EE6[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EE8[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EE9[0xB8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_EEF[0x7];                                      // Fixing Size Of Struct
