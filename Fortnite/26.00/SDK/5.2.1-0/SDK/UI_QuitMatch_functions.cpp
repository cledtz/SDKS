...
class UClass* UUI_QuitMatch_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_QuitMatch_C");

	return Clss;
}


// UI_QuitMatch_C UI_QuitMatch.Default__UI_QuitMatch_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_QuitMatch_C* UUI_QuitMatch_C::GetDefaultObj()
{
	static class UUI_QuitMatch_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_QuitMatch_C*>(UUI_QuitMatch_C::StaticClass()->DefaultObject);
