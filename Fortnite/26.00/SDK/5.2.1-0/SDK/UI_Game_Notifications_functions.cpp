...
class UClass* UUI_Game_Notifications_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Game_Notifications_C");

	return Clss;
}


// UI_Game_Notifications_C UI_Game_Notifications.Default__UI_Game_Notifications_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Game_Notifications_C* UUI_Game_Notifications_C::GetDefaultObj()
{
	static class UUI_Game_Notifications_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Game_Notifications_C*>(UUI_Game_Notifications_C::StaticClass()->DefaultObject);
