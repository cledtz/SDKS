...
class UClass* UUI_Menu_Soldier_Weapon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Soldier_Weapon_C");

	return Clss;
}


// UI_Menu_Soldier_Weapon_C UI_Menu_Soldier_Weapon.Default__UI_Menu_Soldier_Weapon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Soldier_Weapon_C* UUI_Menu_Soldier_Weapon_C::GetDefaultObj()
{
	static class UUI_Menu_Soldier_Weapon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Soldier_Weapon_C*>(UUI_Menu_Soldier_Weapon_C::StaticClass()->DefaultObject);
