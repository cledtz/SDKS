...
struct UUI_Menu_Solder_Weapon_Gun_Gunsmith_ModuleSummary_Entry_C_ParseCharacteristic_Params
{
public:
	...
	class UDataContainerValue_Base*              CallFunc_Map_Find_Value;                           // 0x90(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Map_Find_ReturnValue;                     // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D80[0x7];                                     // Fixing Size After Last Property 
	class UDataContainerValue_Base*              K2Node_LowEntry_LocalVariable_Value__Object;       // 0xA0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0xA8(0x14)(None)
	uint8                                        Pad_1D82[0x4];                                     // Fixing Size After Last Property 
	class UDataContainerValue_Bool*              K2Node_DynamicCast_AsBool;                         // 0xC0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_1D84[0x1];                                     // Fixing Size After Last Property 
	class FName                                  Temp_name_Variable_1;                              // 0xCC(0x8)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D85[0x4];                                     // Fixing Size After Last Property 
	class UDataContainerValue_Base*              CallFunc_Map_Find_Value_1;                         // 0xD8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UDataContainerValue_Base*              K2Node_LowEntry_LocalVariable_Value__1_Object;     // 0xE8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UDataContainerValue_FText*             K2Node_DynamicCast_AsFText;                        // 0xF8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
