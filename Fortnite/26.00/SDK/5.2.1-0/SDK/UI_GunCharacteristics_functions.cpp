...
class UClass* UUI_GunCharacteristics_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_GunCharacteristics_C");

	return Clss;
}


// UI_GunCharacteristics_C UI_GunCharacteristics.Default__UI_GunCharacteristics_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_GunCharacteristics_C* UUI_GunCharacteristics_C::GetDefaultObj()
{
	static class UUI_GunCharacteristics_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_GunCharacteristics_C*>(UUI_GunCharacteristics_C::StaticClass()->DefaultObject);
