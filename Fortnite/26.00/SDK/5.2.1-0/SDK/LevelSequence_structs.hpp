...
{
public:
	uint8                                        Pad_14CA[0x20];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_14CB[0x50];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_14CC[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14D5[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_14D7[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	class FString                                MasterName;                                        // 0xB0(0x10)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FQualifiedFrameTime                   MasterTime;                                        // 0xC0(0x10)(Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
