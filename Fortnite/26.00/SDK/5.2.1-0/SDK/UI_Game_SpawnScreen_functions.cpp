...
class UClass* UUI_Game_SpawnScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Game_SpawnScreen_C");

	return Clss;
}


// UI_Game_SpawnScreen_C UI_Game_SpawnScreen.Default__UI_Game_SpawnScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Game_SpawnScreen_C* UUI_Game_SpawnScreen_C::GetDefaultObj()
{
	static class UUI_Game_SpawnScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Game_SpawnScreen_C*>(UUI_Game_SpawnScreen_C::StaticClass()->DefaultObject);
