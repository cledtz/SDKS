...
class UClass* UUI_BattlePass_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_BattlePass_C");

	return Clss;
}


// UI_BattlePass_C UI_BattlePass.Default__UI_BattlePass_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_BattlePass_C* UUI_BattlePass_C::GetDefaultObj()
{
	static class UUI_BattlePass_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_BattlePass_C*>(UUI_BattlePass_C::StaticClass()->DefaultObject);
...
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FBattlePassReward           CallFunc_GetDataTableRowFromName_OutRow                          (None)
...
// bool                               CallFunc_Less_IntInt_ReturnValue_1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_BooleanAND_ReturnValue_1                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FBattlePassReward           CallFunc_GetBattlePassLevelInfoByProgress_LevelInfo              (None)
...
// struct FBattlePassReward           CallFunc_GetDataTableRowFromName_OutRow_1                        (None)
