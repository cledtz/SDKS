...
class UClass* UUI_BattlePass_Reward_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_BattlePass_Reward_C");

	return Clss;
}


// UI_BattlePass_Reward_C UI_BattlePass_Reward.Default__UI_BattlePass_Reward_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_BattlePass_Reward_C* UUI_BattlePass_Reward_C::GetDefaultObj()
{
	static class UUI_BattlePass_Reward_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_BattlePass_Reward_C*>(UUI_BattlePass_Reward_C::StaticClass()->DefaultObject);
