...
{
public:
	uint8                                        Pad_2A0[0x38];                                     // Fixing Size Of Struct
...
{
public:
	TArray<struct FDefaultContextSetting>        DefaultMappingContexts;                            // 0x38(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<struct FDefaultContextSetting>        DefaultWorldSubsystemMappingContexts;              // 0x48(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UEnhancedPlayerInput>    DefaultWorldInputClass;                            // 0x58(0x30)(Edit, Config, NoClear, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPerPlatformSettings                  PlatformSettings;                                  // 0x88(0x10)(Edit, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                        bEnableDefaultMappingContexts : 1;                 // Mask: 0x1, PropSize: 0x10x98(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bShouldOnlyTriggerLastActionInChord : 1;           // Mask: 0x2, PropSize: 0x10x98(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bEnableWorldSubsystem : 1;                         // Mask: 0x4, PropSize: 0x10x98(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bShouldLogAllWorldSubsystemInputs : 1;             // Mask: 0x8, PropSize: 0x10x98(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2A4[0x7];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_313[0x7];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_398[0x1A0];                                    // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_3A0[0x1A0];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_3A1[0x10];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_3A8[0x50];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3A9[0xA0];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3AB[0x18];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3B0[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_3F2[0x7];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3FA[0x5];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_3FC[0x30];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_404[0x3];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_40C[0x7];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_420[0x3];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_424[0x3];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_42C[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_433[0x4];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_437[0x4];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_439[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_43B[0x3];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_474[0x7];                                      // Fixing Size After Last Property 
