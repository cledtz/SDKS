...
class UClass* UABP_CharacterPG_FP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ABP_CharacterPG_FP_C");

	return Clss;
}


// ABP_CharacterPG_FP_C ABP_CharacterPG_FP.Default__ABP_CharacterPG_FP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UABP_CharacterPG_FP_C* UABP_CharacterPG_FP_C::GetDefaultObj()
{
	static class UABP_CharacterPG_FP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UABP_CharacterPG_FP_C*>(UABP_CharacterPG_FP_C::StaticClass()->DefaultObject);
