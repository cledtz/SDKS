...
class UClass* UUI_Options_Spinner_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Options_Spinner_C");

	return Clss;
}


// UI_Options_Spinner_C UI_Options_Spinner.Default__UI_Options_Spinner_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Options_Spinner_C* UUI_Options_Spinner_C::GetDefaultObj()
{
	static class UUI_Options_Spinner_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Options_Spinner_C*>(UUI_Options_Spinner_C::StaticClass()->DefaultObject);
