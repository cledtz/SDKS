...
public:
	...
	uint8                                        Pad_3E3C[0x4];                                     // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E3D[0x8];                                     // Fixing Size After Last (Predefined) Property 
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_3E3E[0x4];                                     // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E3F[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E40[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E41[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E42[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E43[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E44[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E45[0x28];                                    // Fixing Size After Last (Predefined) Property 
...
{
public:
	uint8                                        Pad_3E46[0x28];                                    // Fixing Size After Last (Predefined) Property 
