...
public:
	...
	uint8                                        Pad_176B[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_176E[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1778[0x8];                                     // Fixing Size Of Struct
};
...
public:
	struct FRetargetProfile                      RetargetProfile;                                   // 0x0(0x108)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FTargetChainSettings                  ChainSettings;                                     // 0x108(0xA8)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	struct FRetargetProfile                      RetargetProfile;                                   // 0x0(0x108)(Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FTargetChainIKSettings                IKSettings;                                        // 0x108(0x78)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct FTargetChainSettings                  ReturnValue;                                       // 0x110(0xA8)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FTargetChainSettings                  ReturnValue;                                       // 0x18(0xA8)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
