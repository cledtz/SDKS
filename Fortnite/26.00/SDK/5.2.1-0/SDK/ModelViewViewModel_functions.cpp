...
class UClass* UMVVMViewWorldSubsystem::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MVVMViewWorldSubsystem");

	return Clss;
}


// MVVMViewWorldSubsystem ModelViewViewModel.Default__MVVMViewWorldSubsystem
// (Public, ClassDefaultObject, ArchetypeObject)

class UMVVMViewWorldSubsystem* UMVVMViewWorldSubsystem::GetDefaultObj()
{
	static class UMVVMViewWorldSubsystem* Default = nullptr;

	if (!Default)
		Default = static_cast<UMVVMViewWorldSubsystem*>(UMVVMViewWorldSubsystem::StaticClass()->DefaultObject);
