...
class UClass* USteamCoreGameMode::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class USteamCoreGameMode* USteamCoreGameMode::GetDefaultObj()
{
	static class USteamCoreGameMode* Default = nullptr;

	if (!Default)
		Default = static_cast<USteamCoreGameMode*>(USteamCoreGameMode::StaticClass()->DefaultObject);
