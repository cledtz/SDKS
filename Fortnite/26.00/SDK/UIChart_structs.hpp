...
enum class EWidgetStateComponentUnloadDefaultBehavior : int32
{
	WaitForAnimations              = 0,
...
enum class EUIStateChartContextConditionType : int32
{
	IsEmpty                        = 0,
	IsNotEmpty                     = 1,
	IsEqualTo                      = 2,
...
enum class EStateComponentStatus : int32
{
	Inactive                       = 0,
	PreparingForLoad               = 1,
	Loading                        = 2,
...
enum class EStateChartResourceScope : int32
{
	StateChart                     = 0,
	Player                         = 1,
	Global                         = 2,
...
public:
	...
	uint8                                        Pad_274F[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_275B[0x88];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_275C[0x10];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_275F[0x8];                                     // Fixing Size Of Struct
};
