...
enum class EObjectChooserResultType : int32
{
	ObjectResult                   = 0,
	ClassResult                    = 1,
...
enum class EContextObjectDirection : int32
{
	Read                           = 0,
	Write                          = 1,
	ReadWrite                      = 2,
...
enum class EObjectColumnCellValueComparison : int32
{
	MatchEqual                     = 0,
	MatchNotEqual                  = 1,
	MatchAny                       = 2,
...
{
public:
	uint8                                        Pad_25D8[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_25DE[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	struct FInstancedStruct                      InputValue;                                        // 0x8(0x10)(Edit, NoClear, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_25F0[0x4];                                     // Fixing Size After Last Property 
...
public:
	TArray<class FName>                          PropertyBindingChain;                              // 0x8(0x10)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	struct FChooserPropertyBinding               Binding;                                           // 0x18(0x18)(Edit, NoClear, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_25FC[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_25FF[0x50];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2602[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2603[0x50];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2604[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	TSoftObjectPtr<class UObject>                Value;                                             // 0x8(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2614[0x4];                                     // Fixing Size After Last Property 
