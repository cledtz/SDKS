...
public:
	...
	uint8                                        Pad_87A6[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_87A7[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_87A8[0x3];                                     // Fixing Size After Last Property 
	int32                                        K2Node_Select_Default;                             // 0x20(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_87A9[0x4];                                     // Fixing Size After Last Property 
