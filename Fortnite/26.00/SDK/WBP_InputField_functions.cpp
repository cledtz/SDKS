...
class UClass* UWBP_InputField_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_InputField_C");

	return Clss;
}


// WBP_InputField_C WBP_InputField.Default__WBP_InputField_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_InputField_C* UWBP_InputField_C::GetDefaultObj()
{
	static class UWBP_InputField_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_InputField_C*>(UWBP_InputField_C::StaticClass()->DefaultObject);
