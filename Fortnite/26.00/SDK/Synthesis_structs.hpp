...
public:
	...
	uint8                                        Pad_995[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_99C[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_99D[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_99F[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9A0[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9A3[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9A7[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9AA[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_3E : 6;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_9AD[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_3F : 6;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_9B6[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9BC[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9C1[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9C2[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9C5[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9C8[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9CE[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9D3[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9D6[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9D8[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9D9[0x2];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9DA[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9DC[0x3];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9DD[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9DF[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9E2[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9E3[0x2];                                      // Fixing Size After Last Property 
	float                                        CutoffFrequency;                                   // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        FilterQ;                                           // 0x8(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_9E5[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_9E7[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9EA[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9EF[0x2];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9F0[0x3];                                      // Fixing Size After Last Property 
	float                                        Frequency;                                         // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_9F3[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9F5[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9F9[0x2];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_A00[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A04[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A07[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A0E[0x2];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_A18[0x1];                                      // Fixing Size After Last Property 
	float                                        LookAheadMsec;                                     // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_A1D[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A1F[0x3];                                      // Fixing Size After Last Property 
...
public:
	...
	bool                                         bFilterEnabled;                                    // 0x18(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EStereoDelayFiltertype            FilterType;                                        // 0x19(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_A26[0x2];                                      // Fixing Size After Last Property 
	float                                        FilterFrequency;                                   // 0x1C(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        FilterQ;                                           // 0x20(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_A2A[0x3];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_A2B[0x3];                                      // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_A2E[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A33[0xC];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_A35[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_A37[0x7];                                      // Fixing Size Of Struct
};
