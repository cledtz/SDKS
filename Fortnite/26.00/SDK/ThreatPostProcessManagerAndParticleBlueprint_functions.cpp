...
class UClass* UThreatPostProcessManagerAndParticleBlueprint_C::StaticClass()
{
...
class UThreatPostProcessManagerAndParticleBlueprint_C* UThreatPostProcessManagerAndParticleBlueprint_C::GetDefaultObj()
{
	static class UThreatPostProcessManagerAndParticleBlueprint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UThreatPostProcessManagerAndParticleBlueprint_C*>(UThreatPostProcessManagerAndParticleBlueprint_C::StaticClass()->DefaultObject);
