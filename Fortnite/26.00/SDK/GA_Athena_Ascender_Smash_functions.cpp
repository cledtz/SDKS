...
class UClass* UGA_Athena_Ascender_Smash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_Ascender_Smash_C");

	return Clss;
}


// GA_Athena_Ascender_Smash_C GA_Athena_Ascender_Smash.Default__GA_Athena_Ascender_Smash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_Ascender_Smash_C* UGA_Athena_Ascender_Smash_C::GetDefaultObj()
{
	static class UGA_Athena_Ascender_Smash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_Ascender_Smash_C*>(UGA_Athena_Ascender_Smash_C::StaticClass()->DefaultObject);
