...
public:
	...
	uint8                                        Pad_6004[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_6005[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_6009[0x7];                                     // Fixing Size After Last Property 
...
public:
	struct FVerseRotation                        __verse_0x18E3F084_Elem0;                          // 0x0(0x20)(InstancedReference, NoDestructor)
	struct FTuple_L_R                            __verse_0x7D844C3C_Elem1;                          // 0x20(0x1)(InstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_600A[0xF];                                     // Fixing Size After Last Property 
...
public:
	struct FVerseRotation                        __verse_0x18E3F084_Elem0;                          // 0x0(0x20)(InstancedReference, NoDestructor)
	struct FTuple_L_R                            __verse_0x7D844C3C_Elem1;                          // 0x20(0x1)(InstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_600C[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_6010[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_6014[0x7];                                     // Fixing Size After Last Property 
	double                                       __verse_0x932BF92E_Elem2;                          // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
