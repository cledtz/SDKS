...
public:
	...
	uint8                                        Pad_7E9[0x7];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_7EA[0x18];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_7EB[0x10];                                     // Fixing Size After Last Property 
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_7EC[0x90];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_7F4[0x18];                                     // Fixing Size Of Struct
};
