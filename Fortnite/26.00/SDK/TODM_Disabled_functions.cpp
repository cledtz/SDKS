...
class UClass* UTODM_Disabled_C::StaticClass()
{
...
class UTODM_Disabled_C* UTODM_Disabled_C::GetDefaultObj()
{
	static class UTODM_Disabled_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTODM_Disabled_C*>(UTODM_Disabled_C::StaticClass()->DefaultObject);
