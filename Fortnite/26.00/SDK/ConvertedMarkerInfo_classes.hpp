...
public:
	...
	uint8                                        Pad_7B4D[0x5];                                     // Fixing Size After Last Property 
	TSoftObjectPtr<class UTexture2D>             Icon_Move;                                         // 0x328(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>             Icon_Hold;                                         // 0x348(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>             Icon_BackToMe;                                     // 0x368(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>             Icon_Revive;                                       // 0x388(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>             Icon_Attack;                                       // 0x3A8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	...
	void InitPlayerIconState(class UFortPlayerStateAthena* PSA);
