...
void UGAB_AthenaDBNO_C::Get_Max_Health_Tenacity(double* Tenacity, class UActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue, bool CallFunc_GetFloatAttribute_bSuccessfullyFoundAttribute, float CallFunc_GetFloatAttribute_ReturnValue, double K2Node_FunctionResult_Tenacity_ImplicitCast)
{
	static class UFunction* Func = nullptr;
