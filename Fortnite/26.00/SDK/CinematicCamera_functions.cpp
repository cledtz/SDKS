...
class UClass* UCameraRig_Crane::StaticClass()
{
...
class UCameraRig_Crane* UCameraRig_Crane::GetDefaultObj()
{
	static class UCameraRig_Crane* Default = nullptr;

	if (!Default)
		Default = static_cast<UCameraRig_Crane*>(UCameraRig_Crane::StaticClass()->DefaultObject);
...
class UClass* UCameraRig_Rail::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UCameraRig_Rail* UCameraRig_Rail::GetDefaultObj()
{
	static class UCameraRig_Rail* Default = nullptr;

	if (!Default)
		Default = static_cast<UCameraRig_Rail*>(UCameraRig_Rail::StaticClass()->DefaultObject);
...
class UClass* UCineCameraActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UCineCameraActor* UCineCameraActor::GetDefaultObj()
{
	static class UCineCameraActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UCineCameraActor*>(UCineCameraActor::StaticClass()->DefaultObject);
