...
class UClass* UWBP_Augment_SelectionTimer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_Augment_SelectionTimer_C");

	return Clss;
}


// WBP_Augment_SelectionTimer_C WBP_Augment_SelectionTimer.Default__WBP_Augment_SelectionTimer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_Augment_SelectionTimer_C* UWBP_Augment_SelectionTimer_C::GetDefaultObj()
{
	static class UWBP_Augment_SelectionTimer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_Augment_SelectionTimer_C*>(UWBP_Augment_SelectionTimer_C::StaticClass()->DefaultObject);
...
void UWBP_Augment_SelectionTimer_C::StartHideTimerEvent(bool CallFunc_IsUsingTouch_ReturnValue, int32 CallFunc_GetValueAsInteger_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_Not_PreBool_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// struct FVector2D                   K2Node_Select_Default_8                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// enum class EVerticalAlignment      K2Node_Select_Default_10                                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_Augment_SelectionTimer_C::SetMobileVisuals(float Temp_real_Variable, bool Temp_bool_Variable, const struct FVector2D& Temp_struct_Variable, const struct FVector2D& Temp_struct_Variable_1, bool Temp_bool_Variable_1, const struct FVector2D& Temp_struct_Variable_2, const struct FVector2D& Temp_struct_Variable_3, bool Temp_bool_Variable_2, const struct FVector2D& Temp_struct_Variable_4, const struct FVector2D& Temp_struct_Variable_5, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_IsUsingTouch_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FVector2D& K2Node_Select_Default, const struct FVector2D& K2Node_Select_Default_1, const struct FVector2D& K2Node_Select_Default_2, float Temp_real_Variable_1, bool Temp_bool_Variable_3, enum class ESlateVisibility Temp_byte_Variable, float K2Node_Select_Default_3, const struct FMargin& K2Node_MakeStruct_Margin, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_1, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue_1, bool Temp_bool_Variable_4, enum class ESlateVisibility Temp_byte_Variable_2, enum class ESlateVisibility K2Node_Select_Default_4, enum class ESlateVisibility Temp_byte_Variable_3, bool Temp_bool_Variable_5, enum class ESlateVisibility K2Node_Select_Default_5, class UOverlaySlot* CallFunc_SlotAsOverlaySlot_ReturnValue_2, class UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_4, bool CallFunc_HasChild_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_5, class UOverlaySlot* CallFunc_AddChildToOverlay_ReturnValue, bool Temp_bool_Variable_6, enum class ESlateVisibility K2Node_Select_Default_6, enum class ESlateVisibility Temp_byte_Variable_6, enum class ESlateVisibility Temp_byte_Variable_7, bool Temp_bool_Variable_7, const struct FVector2D& Temp_struct_Variable_6, enum class ESlateVisibility K2Node_Select_Default_7, bool CallFunc_HasChild_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_1, class UHorizontalBoxSlot* CallFunc_AddChildToHorizontalBox_ReturnValue_1, const struct FVector2D& Temp_struct_Variable_7, bool Temp_bool_Variable_8, enum class ESlateVisibility Temp_byte_Variable_8, const struct FVector2D& K2Node_Select_Default_8, enum class ESlateVisibility Temp_byte_Variable_9, bool Temp_bool_Variable_9, enum class ESlateVisibility K2Node_Select_Default_9, enum class EVerticalAlignment Temp_byte_Variable_10, enum class EVerticalAlignment Temp_byte_Variable_11, bool Temp_bool_Variable_10, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, enum class EVerticalAlignment K2Node_Select_Default_10, float Temp_real_Variable_2, class UOverlaySlot* CallFunc_AddChildToOverlay_ReturnValue_1, float Temp_real_Variable_3, bool Temp_bool_Variable_11, float K2Node_Select_Default_11, const struct FMargin& K2Node_MakeStruct_Margin_1)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Augment_SelectionTimer_C::UpdateVisibility(bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_IsUsingTouch_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsCountdownVisible_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Augment_SelectionTimer_C::SetAugmentReadyState(bool AugmentSelectionAvailable, bool CallFunc_NotEqual_BoolBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_IsUsingTouch_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// TScriptInterface<class USlateTextureAtlasInterface>CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput        (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// bool                               CallFunc_IsUsingTouchControls_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Augment_SelectionTimer_C::ExecuteUbergraph_WBP_Augment_SelectionTimer(int32 EntryPoint, bool CallFunc_IsMobileGame_ReturnValue, class UObject* Temp_object_Variable, class UPaperSprite* K2Node_DynamicCast_AsPaper_Sprite, bool K2Node_DynamicCast_bSuccess, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsAugmentSelectionAvailable_IsEnabled, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, bool K2Node_Event_IsDesignTime, bool CallFunc_CanSelectAugment_ReturnValue, const struct FGameplayTagContainer& K2Node_Event_HiddenElementTagContainer, bool CallFunc_HasTag_ReturnValue, bool CallFunc_HasTag_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue, class UObject* K2Node_CustomEvent_Loaded, class UPawn* CallFunc_GetOwningPlayerPawn_ReturnValue, bool Temp_bool_Variable, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_IsSkydiving_ReturnValue, bool CallFunc_IsDBNO_ReturnValue, bool K2Node_CustomEvent_bEnteredBuildMode, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue_1, class UWidget* K2Node_Select_Default, class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess_2, TScriptInterface<class USlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput, bool K2Node_Event_bCanSelectAugment, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, class UFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller_1, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_IsUsingTouchControls_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_IsUsingTouchControls_ReturnValue = CallFunc_IsUsingTouchControls_ReturnValue;
