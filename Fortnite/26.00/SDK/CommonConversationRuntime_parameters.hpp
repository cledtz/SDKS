...
public:
	...
	uint8                                        Pad_FA0[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_FA9[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_FDB[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FDD[0x4];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_FE1[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_FE4[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1001[0x4];                                     // Fixing Size After Last Property 
...
public:
	struct FConversationContext                  Context;                                           // 0x0(0x38)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	enum class EConversationRequirementResult    ReturnValue;                                       // 0x38(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_101F[0x7];                                     // Fixing Size Of Struct
};
