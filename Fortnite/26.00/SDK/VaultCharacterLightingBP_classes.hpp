...
public:
	...
	uint8                                        Pad_90A3[0x3];                                     // Fixing Size After Last Property 
	struct FLinearColor                          MPCMinusManualSunlightVector;                      // 0x340(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          MPCMinusManualSunlightColor;                       // 0x350(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UVaultCharacterLightingBP_C* GetDefaultObj();
