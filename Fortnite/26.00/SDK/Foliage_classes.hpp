...
public:
	...
	uint8                                        Pad_F53[0x4];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_F57[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F58[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F5B[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_83 : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F5C[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_84 : 5;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F5E[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F60[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F62[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_86 : 7;                                     // Fixing Bit-Field Size 
	...
	uint8                                        Pad_F66[0x4];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F68[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_87 : 2;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F69[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_88 : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F6A[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_89 : 5;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F6B[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_8A : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F6E[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_8B : 6;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F6F[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F73[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_8C : 7;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_F74[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F77[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F7D[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_F80[0x3];                                      // Fixing Size Of Struct
...
{
public:
	TSubclassOf<class UActor>                    ActorClass;                                        // 0x4B8(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_F85[0x6];                                      // Fixing Size After Last Property 
...
class UInstancedFoliageActor : public UISMPartitionActor
{
public:
	uint8                                        Pad_F89[0x50];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UInstancedFoliageActor* GetDefaultObj();
...
{
public:
	uint8                                        Pad_F8A[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_FAA[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_FB7[0x4];                                      // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UInteractiveFoliageActor* GetDefaultObj();

	void CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class UActor* Other, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& OverlapInfo);
};
...
{
public:
	class UProceduralFoliageVolume*              ProceduralFoliageVolume;                           // 0x2C8(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFoliageDensityFalloff                DensityFalloff;                                    // 0x2D0(0x90)(Edit, NativeAccessSpecifierPublic)

	static class UClass* StaticClass();
	static class UProceduralFoliageBlockingVolume* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_FBA[0x4];                                      // Fixing Size After Last Property 
	class UVolume*                               SpawningVolume;                                    // 0xB0(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_FBD[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FBE[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FBF[0x18];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_FC4[0x8];                                      // Fixing Size After Last Property 
	...
	static class UClass* StaticClass();
	static class UProceduralFoliageVolume* GetDefaultObj();
