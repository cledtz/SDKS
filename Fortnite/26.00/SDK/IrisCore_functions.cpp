...
class UClass* UNetObjectConnectionFilterConfig::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NetObjectConnectionFilterConfig");

	return Clss;
}


// NetObjectConnectionFilterConfig IrisCore.Default__NetObjectConnectionFilterConfig
// (Public, ClassDefaultObject, ArchetypeObject)

class UNetObjectConnectionFilterConfig* UNetObjectConnectionFilterConfig::GetDefaultObj()
{
	static class UNetObjectConnectionFilterConfig* Default = nullptr;

	if (!Default)
		Default = static_cast<UNetObjectConnectionFilterConfig*>(UNetObjectConnectionFilterConfig::StaticClass()->DefaultObject);
...
class UClass* UNetObjectConnectionFilter::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NetObjectConnectionFilter");

	return Clss;
}


// NetObjectConnectionFilter IrisCore.Default__NetObjectConnectionFilter
// (Public, ClassDefaultObject, ArchetypeObject)

class UNetObjectConnectionFilter* UNetObjectConnectionFilter::GetDefaultObj()
{
	static class UNetObjectConnectionFilter* Default = nullptr;

	if (!Default)
		Default = static_cast<UNetObjectConnectionFilter*>(UNetObjectConnectionFilter::StaticClass()->DefaultObject);
...
class UClass* UNetObjectGridWorldLocFilter::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NetObjectGridWorldLocFilter");

	return Clss;
}


// NetObjectGridWorldLocFilter IrisCore.Default__NetObjectGridWorldLocFilter
// (Public, ClassDefaultObject, ArchetypeObject)

class UNetObjectGridWorldLocFilter* UNetObjectGridWorldLocFilter::GetDefaultObj()
{
	static class UNetObjectGridWorldLocFilter* Default = nullptr;

	if (!Default)
		Default = static_cast<UNetObjectGridWorldLocFilter*>(UNetObjectGridWorldLocFilter::StaticClass()->DefaultObject);
...
class UClass* UNetObjectGridFragmentLocFilter::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NetObjectGridFragmentLocFilter");

	return Clss;
}


// NetObjectGridFragmentLocFilter IrisCore.Default__NetObjectGridFragmentLocFilter
// (Public, ClassDefaultObject, ArchetypeObject)

class UNetObjectGridFragmentLocFilter* UNetObjectGridFragmentLocFilter::GetDefaultObj()
{
	static class UNetObjectGridFragmentLocFilter* Default = nullptr;

	if (!Default)
		Default = static_cast<UNetObjectGridFragmentLocFilter*>(UNetObjectGridFragmentLocFilter::StaticClass()->DefaultObject);
