...
public:
	...
	TSoftObjectPtr<class UAnimMontage>           DefaultSprayMontage_M;                             // 0xBA8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TSoftObjectPtr<class UAnimMontage>           DefaultSprayMontage_F;                             // 0xBC8(0x20)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
