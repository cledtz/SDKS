...
{
public:
	uint8                                        Pad_155D[0x58];                                    // Fixing Size Of Struct
};
...
{
public:
	TSoftObjectPtr<class UStateTree>             StateTreeAsset;                                    // 0x0(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bShouldReplicate;                                  // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_155E[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1560[0x10];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1568[0x28];                                    // Fixing Size Of Struct
};
