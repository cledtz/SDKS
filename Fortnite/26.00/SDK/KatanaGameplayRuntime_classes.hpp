...
public:
	...
	uint8                                        Pad_3873[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_387E[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3886[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3889[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	bool                                         IsBMeleeKatana;                                    // 0x15E8(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3895[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3899[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_389C[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_389F[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_38A3[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_38AA[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_38AE[0xC];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_38B9[0x3];                                     // Fixing Size After Last Property 
	...
	struct FGameplayTagContainer                 DashBlockIgnoreTags;                               // 0x298(0x20)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<enum class EFortKatanaPrimaryAttackVariation, struct FFortKatanaPrimaryAttackVariationInfo> PrimaryAttackVariationInfos;                       // 0x2B8(0x50)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	float                                        PrimaryAttackMinForwardMovement;                   // 0x308(0x4)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	enum class ECollisionChannel                 PrimaryAttackObstructionTraceChannel;              // 0x30C(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_38BD[0x3];                                     // Fixing Size Of Struct
