...
class UClass* UFortNevadaVehicleReticle::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortNevadaVehicleReticle");

	return Clss;
}


// FortNevadaVehicleReticle NevadaUI.Default__FortNevadaVehicleReticle
// (Public, ClassDefaultObject, ArchetypeObject)

class UFortNevadaVehicleReticle* UFortNevadaVehicleReticle::GetDefaultObj()
{
	static class UFortNevadaVehicleReticle* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortNevadaVehicleReticle*>(UFortNevadaVehicleReticle::StaticClass()->DefaultObject);
...
class UClass* UNevadaTargetIndicator::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NevadaTargetIndicator");

	return Clss;
}


// NevadaTargetIndicator NevadaUI.Default__NevadaTargetIndicator
// (Public, ClassDefaultObject, ArchetypeObject)

class UNevadaTargetIndicator* UNevadaTargetIndicator::GetDefaultObj()
{
	static class UNevadaTargetIndicator* Default = nullptr;

	if (!Default)
		Default = static_cast<UNevadaTargetIndicator*>(UNevadaTargetIndicator::StaticClass()->DefaultObject);
