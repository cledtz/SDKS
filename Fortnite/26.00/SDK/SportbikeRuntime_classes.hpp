...
public:
	...
	uint8                                        Pad_3F6C[0x9];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3F72[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3F73[0xF];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_3F75[0x10];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UFortSportbikeVehicle* GetDefaultObj();
