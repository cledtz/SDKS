...
{
public:
	uint8                                        Pad_E32[0x8];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_E46[0x7];                                      // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_E8B[0x18];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_E8F[0x6];                                      // Fixing Size After Last Property 
	...
	uint8                                        BitPad_76 : 5;                                     // Fixing Bit-Field Size 
	uint8                                        Pad_E93[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_E94[0x7];                                      // Fixing Size After Last Property 
...
{
public:
	struct FLevelSequencePlayerSnapshot          FrameInformation;                                  // 0x2A8(0xC0)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ULevelSequenceActor*                   LevelSequenceActor;                                // 0x368(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_EC2[0x120];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_EC8[0x7];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_EC9[0x7];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_ED5[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_ED7[0xC];                                      // Fixing Size Of Struct
