...
{
public:
	uint8                                        Pad_FF4[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_FF5[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_FF6[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_FF7[0x8];                                      // Fixing Size After Last Property 
