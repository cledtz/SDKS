...
public:
	...
	uint8                                        Pad_8A49[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8A4A[0x3];                                     // Fixing Size After Last Property 
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x20(0xC0)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush_1;                    // 0xE0(0xC0)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush_2;                    // 0x1A0(0xC0)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush_3;                    // 0x260(0xC0)(None)
};
...
public:
	...
	uint8                                        Pad_8A56[0x1];                                     // Fixing Size After Last Property 
