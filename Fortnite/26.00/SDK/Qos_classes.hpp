...
{
public:
	uint8                                        Pad_1A97[0x38];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UQosBeaconClient* GetDefaultObj();
...
{
public:
	uint8                                        Pad_1A98[0x8];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UQosBeaconHost* GetDefaultObj();
...
{
public:
	uint8                                        Pad_1A9A[0x20];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1AA5[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AA7[0x7];                                     // Fixing Size After Last Property 
