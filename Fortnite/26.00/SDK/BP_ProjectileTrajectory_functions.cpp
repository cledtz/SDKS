...
class UClass* UBP_ProjectileTrajectory_C::StaticClass()
{
...
class UBP_ProjectileTrajectory_C* UBP_ProjectileTrajectory_C::GetDefaultObj()
{
	static class UBP_ProjectileTrajectory_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_ProjectileTrajectory_C*>(UBP_ProjectileTrajectory_C::StaticClass()->DefaultObject);
...
void UBP_ProjectileTrajectory_C::SetShouldUpdateFromOwner(bool ShouldUpdate, class UObject* Owner)
{
	...
	Params::UBP_ProjectileTrajectory_C_SetShouldUpdateFromOwner_Params Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TScriptInterface<class UFortTrajectoryAbilityInterface>K2Node_DynamicCast_AsFort_Trajectory_Ability_Interface           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_ProjectileTrajectory_C::UpdateFromTrajectoryOwner(TScriptInterface<class UFortTrajectoryAbilityInterface> K2Node_DynamicCast_AsFort_Trajectory_Ability_Interface, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_UpdateFromTrajectoryOwner_Params Parms{};
...
void UBP_ProjectileTrajectory_C::UserConstructionScript(class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_UserConstructionScript_Params Parms{};
...
void UBP_ProjectileTrajectory_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_ReceiveBeginPlay_Params Parms{};
...
void UBP_ProjectileTrajectory_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_ReceiveTick_Params Parms{};
...
void UBP_ProjectileTrajectory_C::SetTrajectorySpline(TArray<struct FVector>& SplinePoints, TArray<struct FVector>& SplineTangents)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_SetTrajectorySpline_Params Parms{};
...
void UBP_ProjectileTrajectory_C::SetTrajectoryValid(bool bIsTrajectoryValid)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_SetTrajectoryValid_Params Parms{};
...
void UBP_ProjectileTrajectory_C::UpdateTargetMeshVisibility()
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_ProjectileTrajectory_C_UpdateTargetMeshVisibility_Params Parms{};
...
void UBP_ProjectileTrajectory_C::ExecuteUbergraph_BP_ProjectileTrajectory(int32 EntryPoint, float K2Node_Event_DeltaSeconds, TArray<struct FVector>& K2Node_Event_SplinePoints, TArray<struct FVector>& K2Node_Event_SplineTangents, int32 CallFunc_Array_LastIndex_ReturnValue, const struct FLinearColor& CallFunc_Conv_VectorToLinearColor_ReturnValue, const struct FLinearColor& CallFunc_Conv_VectorToLinearColor_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, bool K2Node_CustomEvent_bIsTrajectoryValid, int32 CallFunc_Array_Length_ReturnValue_1, int32 Temp_int_Array_Index_Variable, class USplineMeshComponent* CallFunc_Array_Get_Item, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_EqualEqual_BoolBool_ReturnValue, class UMaterialInstance* CallFunc_SelectMaterialInstance_ReturnValue, float CallFunc_SetScalarParameterValue_Value_ImplicitCast, float CallFunc_SetScalarParameterValue_Value_ImplicitCast_1)
{
	...
	Params::UBP_ProjectileTrajectory_C_ExecuteUbergraph_BP_ProjectileTrajectory_Params Parms{};
