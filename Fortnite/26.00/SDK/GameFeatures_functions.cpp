...
class UClass* UGameFeatureStateChangeObserver::StaticClass()
{
...
class UGameFeatureStateChangeObserver* UGameFeatureStateChangeObserver::GetDefaultObj()
{
	static class UGameFeatureStateChangeObserver* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameFeatureStateChangeObserver*>(UGameFeatureStateChangeObserver::StaticClass()->DefaultObject);
...
class UClass* UGameFeatureVersePathMapperCommandlet::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameFeatureVersePathMapperCommandlet");

	return Clss;
}


// GameFeatureVersePathMapperCommandlet GameFeatures.Default__GameFeatureVersePathMapperCommandlet
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameFeatureVersePathMapperCommandlet* UGameFeatureVersePathMapperCommandlet::GetDefaultObj()
{
	static class UGameFeatureVersePathMapperCommandlet* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameFeatureVersePathMapperCommandlet*>(UGameFeatureVersePathMapperCommandlet::StaticClass()->DefaultObject);
...
class UClass* UGameFeatureAction_AddChunkOverride::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameFeatureAction_AddChunkOverride");

	return Clss;
}


// GameFeatureAction_AddChunkOverride GameFeatures.Default__GameFeatureAction_AddChunkOverride
// (Public, ClassDefaultObject, ArchetypeObject)

class UGameFeatureAction_AddChunkOverride* UGameFeatureAction_AddChunkOverride::GetDefaultObj()
{
	static class UGameFeatureAction_AddChunkOverride* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameFeatureAction_AddChunkOverride*>(UGameFeatureAction_AddChunkOverride::StaticClass()->DefaultObject);
...
void UGameFeatureData::GetPluginName(class UGameFeatureData* GFD, class FString* PluginName)
{
	...
	if (!Func)
		Func = Class->GetFunction("GameFeatureData", "GetPluginName");
