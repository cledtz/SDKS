...
class UClass* UEmberRae_Axe_R_AnimBP_Post_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EmberRae_Axe_R_AnimBP_Post_C");

	return Clss;
}


// EmberRae_Axe_R_AnimBP_Post_C EmberRae_Axe_R_AnimBP_Post.Default__EmberRae_Axe_R_AnimBP_Post_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UEmberRae_Axe_R_AnimBP_Post_C* UEmberRae_Axe_R_AnimBP_Post_C::GetDefaultObj()
{
	static class UEmberRae_Axe_R_AnimBP_Post_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UEmberRae_Axe_R_AnimBP_Post_C*>(UEmberRae_Axe_R_AnimBP_Post_C::StaticClass()->DefaultObject);
