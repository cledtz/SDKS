...
{
public:
	uint8                                        Pad_42E9[0x20];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_42EB[0x10];                                    // Fixing Size Of Struct
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x50(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailed;                                          // 0x60(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_42F4[0x40];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4303[0x30];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_4304[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_430B[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_431F[0xF];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4330[0x5];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4331[0x28];                                    // Fixing Size Of Struct
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x50(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailed;                                          // 0x60(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_43D1[0x30];                                    // Fixing Size Of Struct
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x50(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailed;                                          // 0x60(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_43DD[0x38];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_43F3[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_441D[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_441F[0x1F];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_4420[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4487[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4488[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_448A[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_448B[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_448D[0x6];                                     // Fixing Size After Last Property 
	...
	void RemoveCandidateImageAtIndex(int32 Index);
...
public:
	...
	uint8                                        Pad_44A1[0x64];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_44A9[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_44C8[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_44D5[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_44D8[0x3];                                     // Fixing Size After Last Property 
	...
	struct FVector2f                             Size;                                              // 0x150(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	enum class EARDepthQuality                   DepthQuality;                                      // 0x158(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EARDepthAccuracy                  DepthAccuracy;                                     // 0x159(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsTemporallySmoothed;                             // 0x15A(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_44DF[0x5];                                     // Fixing Size Of Struct
...
public:
	...
	struct FVector2f                             Size;                                              // 0x158(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_44F9[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_44FD[0xF];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_44FE[0x16];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_4504[0xC];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4505[0x14];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4516[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4518[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_451E[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4523[0xC];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_452C[0x7];                                     // Fixing Size After Last Property 
	TMap<enum class EARFaceBlendShape, float>    BlendShapes;                                       // 0x178(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_452D[0x38];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_4532[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4534[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_4537[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_4541[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_455A[0x7];                                     // Fixing Size Of Struct
