...
{
public:
	uint8                                        Pad_1AE2[0x8];                                     // Fixing Size Of Struct
...
{
public:
	int32                                        JitterLatencyFrames;                               // 0x900(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1B07[0xBC];                                    // Fixing Size Of Struct
