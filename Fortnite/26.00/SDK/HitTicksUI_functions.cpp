...
class UClass* UFortUserWidget_HitTicks::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortUserWidget_HitTicks");

	return Clss;
}


// FortUserWidget_HitTicks HitTicksUI.Default__FortUserWidget_HitTicks
// (Public, ClassDefaultObject, ArchetypeObject)

class UFortUserWidget_HitTicks* UFortUserWidget_HitTicks::GetDefaultObj()
{
	static class UFortUserWidget_HitTicks* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortUserWidget_HitTicks*>(UFortUserWidget_HitTicks::StaticClass()->DefaultObject);
