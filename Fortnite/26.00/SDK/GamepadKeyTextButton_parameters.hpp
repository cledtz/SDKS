...
public:
	...
	uint8                                        Pad_73E[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_742[0x7];                                      // Fixing Size After Last Property 
	struct FKey                                  K2Node_CustomEvent_Key_1;                          // 0x20(0x18)(HasGetValueTypeHash)
	class FText                                  K2Node_CustomEvent_DescText_1;                     // 0x38(0x18)(None)
	...
	uint8                                        Pad_743[0x3];                                      // Fixing Size After Last Property 
	struct FKey                                  K2Node_CustomEvent_Key;                            // 0x58(0x18)(HasGetValueTypeHash)
	class FText                                  K2Node_CustomEvent_DescText;                       // 0x70(0x18)(None)
	...
	uint8                                        Pad_748[0x6];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_75D[0x4];                                      // Fixing Size After Last Property 
