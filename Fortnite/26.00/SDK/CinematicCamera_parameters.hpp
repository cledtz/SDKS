...
{
public:
	struct FCameraFocusSettings                  NewFocusSettings;                                  // 0x0(0x58)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_9F7[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A09[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A17[0x3];                                      // Fixing Size Of Struct
};
