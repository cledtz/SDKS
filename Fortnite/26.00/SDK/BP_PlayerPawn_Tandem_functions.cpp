...
class UClass* UBP_PlayerPawn_Tandem_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_PlayerPawn_Tandem_C");

	return Clss;
}


// BP_PlayerPawn_Tandem_C BP_PlayerPawn_Tandem.Default__BP_PlayerPawn_Tandem_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_PlayerPawn_Tandem_C* UBP_PlayerPawn_Tandem_C::GetDefaultObj()
{
	static class UBP_PlayerPawn_Tandem_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_PlayerPawn_Tandem_C*>(UBP_PlayerPawn_Tandem_C::StaticClass()->DefaultObject);
