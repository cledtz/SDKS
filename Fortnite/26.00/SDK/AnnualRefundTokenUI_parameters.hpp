...
struct UFortPurchaseHistoryEntryBase_UpdateItemList_Params
{
public:
...
public:
	...
	uint8                                        Pad_2DAA[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	bool                                         IsPartOfABundle;                                   // 0x4(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         IsNextRefundable;                                  // 0x5(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2DD0[0x2];                                     // Fixing Size After Last Property 
	int32                                        IndexInBundle;                                     // 0x8(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        NumPurchasesInBundle;                              // 0xC(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x4 (0x4 - 0x0)
// Function AnnualRefundTokenUI.FortPurchaseHistoryBundleEntry.SetExpandButtonText
struct UFortPurchaseHistoryBundleEntry_SetExpandButtonText_Params
{
public:
	int32                                        NumPurchases;                                      // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	bool                                         bBundledRefund;                                    // 0x1(0x1)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2E4C[0x4];                                     // Fixing Size Of Struct
};
