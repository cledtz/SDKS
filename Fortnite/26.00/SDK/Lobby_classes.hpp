...
public:
	...
	uint8                                        Pad_1B8F[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1B90[0x76];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1B94[0x8];                                     // Fixing Size After Last Property 
	TSoftClassPtr<class ULobbyBeaconState>       LobbyStateClass;                                   // 0x2C0(0x20)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULobbyBeaconState*                     LobbyState;                                        // 0x2E0(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_1B99[0x48];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1B9C[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1B9D[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1B9E[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1B9F[0x68];                                    // Fixing Size Of Struct
