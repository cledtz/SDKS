...
{
public:
	uint8                                        Pad_FDE[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_FE0[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_FE2[0xC0];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_FE3[0x10];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_FE7[0x2];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FEA[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FEB[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_FEC[0x18];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_FED[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_FF1[0x8];                                      // Fixing Size After Last Property 
