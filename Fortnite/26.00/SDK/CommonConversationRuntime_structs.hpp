...
public:
	...
	uint8                                        Pad_102A[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_102D[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1033[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1037[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	bool                                         bServer_PRIVATE;                                   // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bClient_PRIVATE;                                   // 0x31(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_103B[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_103E[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_1043[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1045[0x20];                                    // Fixing Size Of Struct
};
