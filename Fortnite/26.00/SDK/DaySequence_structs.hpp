...
public:
	...
	uint8                                        Pad_2849[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_284C[0x3];                                     // Fixing Size Of Struct
};
...
{
public:
	TSoftObjectPtr<class UObject>                ExternalObjectPath;                                // 0x0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                ObjectPath;                                        // 0x20(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
