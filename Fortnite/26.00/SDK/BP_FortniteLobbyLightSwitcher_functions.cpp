...
class UClass* UBP_FortniteLobbyLightSwitcher_C::StaticClass()
{
...
class UBP_FortniteLobbyLightSwitcher_C* UBP_FortniteLobbyLightSwitcher_C::GetDefaultObj()
{
	static class UBP_FortniteLobbyLightSwitcher_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_FortniteLobbyLightSwitcher_C*>(UBP_FortniteLobbyLightSwitcher_C::StaticClass()->DefaultObject);
