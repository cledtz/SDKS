...
class UClass* UGCN_RezIn_C::StaticClass()
{
...
class UGCN_RezIn_C* UGCN_RezIn_C::GetDefaultObj()
{
	static class UGCN_RezIn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_RezIn_C*>(UGCN_RezIn_C::StaticClass()->DefaultObject);
...
void UGCN_RezIn_C::CleanMinusUp_Teleportation_Light(bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UGCN_RezIn_C_CleanMinusUp_Teleportation_Light_Params Parms{};
...
void UGCN_RezIn_C::PreMinusSequence_Change()
{
	static class UFunction* Func = nullptr;
	...
	Params::UGCN_RezIn_C_PreMinusSequence_Change_Params Parms{};
