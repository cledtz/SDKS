...
{
public:
	TSoftObjectPtr<class UEnum>                  AnimationStateEnum;                                // 0x28(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_2471[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2477[0x3];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2479[0x3];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_247A[0x50];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_247B[0x38];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_247C[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_247D[0x28];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_248D[0x40];                                    // Fixing Size Of Struct
