...
struct UFortPowerupReticleExtensionWidget_GetOverheatingMaxValue_Params
{
public:
...
struct UFortPowerupReticleExtensionWidget_GetCurrentOverheatValue_Params
{
public:
	float                                        ReturnValue;                                       // 0x0(0x4)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct UFortPowerupReticleExtensionWidget_GetCurrentOverheatPercent_Params
{
public:
	float                                        ReturnValue;                                       // 0x0(0x4)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
