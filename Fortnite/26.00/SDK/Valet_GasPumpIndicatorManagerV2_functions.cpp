...
class UClass* UValet_GasPumpIndicatorManagerV2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Valet_GasPumpIndicatorManagerV2_C");

	return Clss;
}


// Valet_GasPumpIndicatorManagerV2_C Valet_GasPumpIndicatorManagerV2.Default__Valet_GasPumpIndicatorManagerV2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UValet_GasPumpIndicatorManagerV2_C* UValet_GasPumpIndicatorManagerV2_C::GetDefaultObj()
{
	static class UValet_GasPumpIndicatorManagerV2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UValet_GasPumpIndicatorManagerV2_C*>(UValet_GasPumpIndicatorManagerV2_C::StaticClass()->DefaultObject);
