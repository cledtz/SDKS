...
public:
	...
	uint8                                        Pad_3286[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3290[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3298[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UPrimitiveComponent*                   InComponent;                                       // 0x0(0x8)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_329C[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UAttachableWheel*                      AttachedWheel;                                     // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_32A4[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UAttachableWheel*                      AttachedWheel;                                     // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_32AB[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_32B4[0x4];                                     // Fixing Size After Last Property 
