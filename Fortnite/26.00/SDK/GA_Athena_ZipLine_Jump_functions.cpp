...
class UClass* UGA_Athena_ZipLine_Jump_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_ZipLine_Jump_C");

	return Clss;
}


// GA_Athena_ZipLine_Jump_C GA_Athena_ZipLine_Jump.Default__GA_Athena_ZipLine_Jump_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_ZipLine_Jump_C* UGA_Athena_ZipLine_Jump_C::GetDefaultObj()
{
	static class UGA_Athena_ZipLine_Jump_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_ZipLine_Jump_C*>(UGA_Athena_ZipLine_Jump_C::StaticClass()->DefaultObject);
