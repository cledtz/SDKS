...
class UClass* UInfoFlag_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("InfoFlag_C");

	return Clss;
}


// InfoFlag_C InfoFlag.Default__InfoFlag_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInfoFlag_C* UInfoFlag_C::GetDefaultObj()
{
	static class UInfoFlag_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInfoFlag_C*>(UInfoFlag_C::StaticClass()->DefaultObject);
