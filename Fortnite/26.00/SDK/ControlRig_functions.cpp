...
class UClass* UControlRigShapeLibraryLink::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ControlRigShapeLibraryLink");

	return Clss;
}


// ControlRigShapeLibraryLink ControlRig.Default__ControlRigShapeLibraryLink
// (Public, ClassDefaultObject, ArchetypeObject)

class UControlRigShapeLibraryLink* UControlRigShapeLibraryLink::GetDefaultObj()
{
	static class UControlRigShapeLibraryLink* Default = nullptr;

	if (!Default)
		Default = static_cast<UControlRigShapeLibraryLink*>(UControlRigShapeLibraryLink::StaticClass()->DefaultObject);
...
class UClass* UControlRigControlActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UControlRigControlActor* UControlRigControlActor::GetDefaultObj()
{
	static class UControlRigControlActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UControlRigControlActor*>(UControlRigControlActor::StaticClass()->DefaultObject);
...
class UClass* UControlRigShapeActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UControlRigShapeActor* UControlRigShapeActor::GetDefaultObj()
{
	static class UControlRigShapeActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UControlRigShapeActor*>(UControlRigShapeActor::StaticClass()->DefaultObject);
