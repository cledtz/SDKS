...
public:
	...
	uint8                                        Pad_4498[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	TSoftObjectPtr<class UObject>                ChannelSlotIcon;                                   // 0x0(0x20)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
