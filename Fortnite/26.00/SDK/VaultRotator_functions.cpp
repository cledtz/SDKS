...
class UClass* UVaultRotator_C::StaticClass()
{
...
class UVaultRotator_C* UVaultRotator_C::GetDefaultObj()
{
	static class UVaultRotator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UVaultRotator_C*>(UVaultRotator_C::StaticClass()->DefaultObject);
