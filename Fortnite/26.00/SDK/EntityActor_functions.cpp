...
class UClass* UEntityAbilityInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EntityAbilityInterface");

	return Clss;
}


// EntityAbilityInterface EntityActor.Default__EntityAbilityInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class UEntityAbilityInterface* UEntityAbilityInterface::GetDefaultObj()
{
	static class UEntityAbilityInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UEntityAbilityInterface*>(UEntityAbilityInterface::StaticClass()->DefaultObject);
...
class UClass* USimObject::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class USimObject* USimObject::GetDefaultObj()
{
	static class USimObject* Default = nullptr;

	if (!Default)
		Default = static_cast<USimObject*>(USimObject::StaticClass()->DefaultObject);
...
class UClass* UEntityActorComponent::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EntityActorComponent");

	return Clss;
}


// EntityActorComponent EntityActor.Default__EntityActorComponent
// (Public, ClassDefaultObject, ArchetypeObject)

class UEntityActorComponent* UEntityActorComponent::GetDefaultObj()
{
	static class UEntityActorComponent* Default = nullptr;

	if (!Default)
		Default = static_cast<UEntityActorComponent*>(UEntityActorComponent::StaticClass()->DefaultObject);
