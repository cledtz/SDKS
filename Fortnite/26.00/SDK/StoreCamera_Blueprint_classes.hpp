...
class UStoreCamera_Blueprint_C : public UFortCameraBase
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0xA00(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                  MeshMinusDarkenBG;                                 // 0xA08(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8DBC[0x7];                                     // Fixing Size After Last Property 
	class UStorePinataMaster_Parent_C*           PinataInLevel;                                     // 0xAA0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	class UStoreCardReveal_Parent_C*             CardRevealInLevel;                                 // 0xAA8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UStoreCamera_Blueprint_C* GetDefaultObj();
