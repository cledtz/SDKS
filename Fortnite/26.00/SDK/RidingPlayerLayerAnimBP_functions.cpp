...
class UClass* URidingPlayerLayerAnimBP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RidingPlayerLayerAnimBP_C");

	return Clss;
}


// RidingPlayerLayerAnimBP_C RidingPlayerLayerAnimBP.Default__RidingPlayerLayerAnimBP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URidingPlayerLayerAnimBP_C* URidingPlayerLayerAnimBP_C::GetDefaultObj()
{
	static class URidingPlayerLayerAnimBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URidingPlayerLayerAnimBP_C*>(URidingPlayerLayerAnimBP_C::StaticClass()->DefaultObject);
