...
class UClass* UMcpItemAware::StaticClass()
{
...
class UMcpItemAware* UMcpItemAware::GetDefaultObj()
{
	static class UMcpItemAware* Default = nullptr;

	if (!Default)
		Default = static_cast<UMcpItemAware*>(UMcpItemAware::StaticClass()->DefaultObject);
