...
public:
	...
	bool HasAllMatchingGameplayTags(TScriptInterface<class UGameplayTagAssetInterface> TagContainerInterface, struct FGameplayTagContainer& OtherContainer);
	...
	void GetAllActorsOfClassMatchingTagQuery(class UObject* WorldContextObject, TSubclassOf<class UActor> ActorClass, struct FGameplayTagQuery& GameplayTagQuery, TArray<class UActor*>* OutActors);
	...
	bool DoesTagAssetInterfaceHaveTag(TScriptInterface<class UGameplayTagAssetInterface> TagContainerInterface, const struct FGameplayTag& Tag);
...
public:
	...
	static class UClass* StaticClass();
	static class UGameplayTagAssetInterface* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1162[0x10];                                    // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_117B[0x160];                                   // Fixing Size After Last Property 
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_117C[0xB0];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1186[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1192[0x4];                                     // Fixing Size Of Struct
