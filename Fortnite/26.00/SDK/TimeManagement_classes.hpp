...
public:
	...
	uint8                                        Pad_F63[0x16];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_F67[0x27];                                     // Fixing Size Of Struct
...
public:
	...
	float Conv_FrameRateToInterval(const struct FFrameRate& InFrameRate);
...
public:
	...
	uint8                                        Pad_FC5[0x3];                                      // Fixing Size After Last Property 
