...
class UClass* UB_MusicEventInstanceWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_MusicEventInstanceWidget_C");

	return Clss;
}


// B_MusicEventInstanceWidget_C B_MusicEventInstanceWidget.Default__B_MusicEventInstanceWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UB_MusicEventInstanceWidget_C* UB_MusicEventInstanceWidget_C::GetDefaultObj()
{
	static class UB_MusicEventInstanceWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_MusicEventInstanceWidget_C*>(UB_MusicEventInstanceWidget_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetFormatText_Result                                    (None)
