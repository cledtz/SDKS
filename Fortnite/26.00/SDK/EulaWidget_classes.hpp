...
{
public:
	FMulticastInlineDelegateProperty_            OnEulaResponse;                                    // 0x580(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
