...
class UClass* UFortWaterBodyBP_C::StaticClass()
{
...
class UFortWaterBodyBP_C* UFortWaterBodyBP_C::GetDefaultObj()
{
	static class UFortWaterBodyBP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortWaterBodyBP_C*>(UFortWaterBodyBP_C::StaticClass()->DefaultObject);
...
void UFortWaterBodyBP_C::ReceiveBeginPlay()
{
	...
	Params::UFortWaterBodyBP_C_ReceiveBeginPlay_Params Parms{};
...
void UFortWaterBodyBP_C::OnReceivedBulletImpact(struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;
	...
	Params::UFortWaterBodyBP_C_OnReceivedBulletImpact_Params Parms{};
...
void UFortWaterBodyBP_C::ExecuteUbergraph_FortWaterBodyBP(int32 EntryPoint, const struct FFluidForceImpulseTimedEffects& K2Node_MakeStruct_FluidForceImpulseTimedEffects, bool CallFunc_IsDedicatedServer_ReturnValue, const struct FHitResult& K2Node_Event_Hit, TArray<class UBP_FluidSim_FN_C*>& CallFunc_GetAllActorsOfClass_OutActors, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class UActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, class FName CallFunc_BreakHitResult_BoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, class UBP_FluidSim_FN_C* CallFunc_Array_Get_Item, const struct FFluidForceImpulse& K2Node_MakeStruct_FluidForceImpulse, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue)
{
	...
	Params::UFortWaterBodyBP_C_ExecuteUbergraph_FortWaterBodyBP_Params Parms{};
