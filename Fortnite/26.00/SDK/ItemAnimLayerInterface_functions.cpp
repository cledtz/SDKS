...
class UClass* UItemAnimLayerInterface_C::StaticClass()
{
...
class UItemAnimLayerInterface_C* UItemAnimLayerInterface_C::GetDefaultObj()
{
	static class UItemAnimLayerInterface_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemAnimLayerInterface_C*>(UItemAnimLayerInterface_C::StaticClass()->DefaultObject);
