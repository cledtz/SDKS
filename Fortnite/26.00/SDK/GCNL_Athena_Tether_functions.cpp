...
class UClass* UGCNL_Athena_Tether_C::StaticClass()
{
...
class UGCNL_Athena_Tether_C* UGCNL_Athena_Tether_C::GetDefaultObj()
{
	static class UGCNL_Athena_Tether_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCNL_Athena_Tether_C*>(UGCNL_Athena_Tether_C::StaticClass()->DefaultObject);
