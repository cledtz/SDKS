...
public:
	...
	TSoftObjectPtr<class UTexture2D>             AccoladeLargePreviewImageOverride;                 // 0x28(0x20)(ConstParm, Parm, OutParm, ReferenceParm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                  SimulatedName;                                     // 0x48(0x18)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	class FText                                  SimulatedText;                                     // 0x60(0x18)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	enum class EFortSimulatedXPSize              SimulatedXpSize;                                   // 0x78(0x1)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3D38[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3D5D[0x7];                                     // Fixing Size Of Struct
};
