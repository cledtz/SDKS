...
{
public:
	class USoundBase*                            Sound;                                             // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UActor*                                Owner;                                             // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                          EventTag;                                          // 0x10(0x4)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1572[0x4];                                     // Fixing Size After Last Property 
	struct FGameplayTagContainer                 LibraryTags;                                       // 0x18(0x20)(BlueprintVisible, BlueprintReadOnly, Transient, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1578[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_157D[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_157F[0x20];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1580[0x8];                                     // Fixing Size Of Struct
};
