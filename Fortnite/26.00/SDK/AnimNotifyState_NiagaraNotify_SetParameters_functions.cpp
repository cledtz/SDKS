...
class UClass* UAnimNotifyState_NiagaraNotify_SetParameters_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AnimNotifyState_NiagaraNotify_SetParameters_C");

	return Clss;
}


// AnimNotifyState_NiagaraNotify_SetParameters_C AnimNotifyState_NiagaraNotify_SetParameters.Default__AnimNotifyState_NiagaraNotify_SetParameters_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnimNotifyState_NiagaraNotify_SetParameters_C* UAnimNotifyState_NiagaraNotify_SetParameters_C::GetDefaultObj()
{
	static class UAnimNotifyState_NiagaraNotify_SetParameters_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnimNotifyState_NiagaraNotify_SetParameters_C*>(UAnimNotifyState_NiagaraNotify_SetParameters_C::StaticClass()->DefaultObject);
