...
class UBP_ProjectileTrajectory_C : public UFortProjectileTrajectory
{
public:
	...
	uint8                                        Pad_20C3[0x7];                                     // Fixing Size After Last Property 
	...
	static class UBP_ProjectileTrajectory_C* GetDefaultObj();

	void SetShouldUpdateFromOwner(bool ShouldUpdate, class UObject* Owner);
	void UpdateFromTrajectoryOwner(TScriptInterface<class UFortTrajectoryAbilityInterface> K2Node_DynamicCast_AsFort_Trajectory_Ability_Interface, bool K2Node_DynamicCast_bSuccess);
