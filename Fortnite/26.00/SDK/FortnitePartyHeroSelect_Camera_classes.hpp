...
public:
	...
	uint8                                        Pad_8E50[0x7];                                     // Fixing Size After Last Property 
	...
	static class UFortnitePartyHeroSelect_Camera_C* GetDefaultObj();
