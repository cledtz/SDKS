...
class UClass* UWBP_UIKit_Button_Quiet_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_UIKit_Button_Quiet_C");

	return Clss;
}


// WBP_UIKit_Button_Quiet_C WBP_UIKit_Button_Quiet.Default__WBP_UIKit_Button_Quiet_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_UIKit_Button_Quiet_C* UWBP_UIKit_Button_Quiet_C::GetDefaultObj()
{
	static class UWBP_UIKit_Button_Quiet_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_UIKit_Button_Quiet_C*>(UWBP_UIKit_Button_Quiet_C::StaticClass()->DefaultObject);
