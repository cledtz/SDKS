...
class UClass* UHeroesCamera_Blueprint_C::StaticClass()
{
...
class UHeroesCamera_Blueprint_C* UHeroesCamera_Blueprint_C::GetDefaultObj()
{
	static class UHeroesCamera_Blueprint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHeroesCamera_Blueprint_C*>(UHeroesCamera_Blueprint_C::StaticClass()->DefaultObject);
