...
public:
	...
	uint8                                        Pad_8B34[0x4];                                     // Fixing Size After Last Property 
	class UPlayerController*                     CallFunc_GetOwningPlayer_ReturnValue;              // 0x268(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UCinematicMinusTeamMics_C*             CallFunc_Create_ReturnValue;                       // 0x270(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_Add_ReturnValue;                    // 0x278(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8B35[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_8B37[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B38[0x3];                                     // Fixing Size After Last Property 
	class UCinematicMinusTeamMics_C*             CallFunc_Array_Get_Item;                           // 0x268(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_8B39[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B3A[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B3B[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8B3C[0x3];                                     // Fixing Size After Last Property 
