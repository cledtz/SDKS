...
{
public:
	TSubclassOf<class UFortGameplayEffectDeliveryActor> LightningBoltClass;                                // 0xA0(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_4906[0xD0];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4925[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_4928[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_492A[0x118];                                   // Fixing Size After Last Property 
	struct FTargetingRequestHandle               AsyncTargetingHandle;                              // 0x430(0x4)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_492D[0x4];                                     // Fixing Size After Last Property 
	TSet<class UFortPlayerPawn*>                 PreviouslyNearPlayers;                             // 0x438(0x50)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_492E[0xA8];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UTempestTornadoForcesComponent* GetDefaultObj();

	void OnVehicleInTornadoPlayerExit(class UFortPlayerControllerAthena* PlayerController, class UFortAthenaVehicle* Vehicle);
	bool IsActorInTornado(class UActor* Actor);
};

// 0x38 (0x2D0 - 0x298)
// Class SuperstormRuntime.TornadoRadialForce
class UTornadoRadialForce : public UFieldSystemActor
{
public:
	float                                        Radius;                                            // 0x298(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Strength;                                          // 0x29C(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        StartTime;                                         // 0x2A0(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        StopTime;                                          // 0x2A4(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        IncomingDuration;                                  // 0x2A8(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        OutgoingDuration;                                  // 0x2AC(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_493B[0x8];                                     // Fixing Size After Last Property 
	class URadialVector*                         RadialVector;                                      // 0x2B8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class URadialFalloff*                        RadialFalloff;                                     // 0x2C0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOperatorField*                        OperatorField;                                     // 0x2C8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

	static class UClass* StaticClass();
	static class UTornadoRadialForce* GetDefaultObj();
