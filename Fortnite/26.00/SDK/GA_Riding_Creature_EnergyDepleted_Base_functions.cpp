...
class UClass* UGA_Riding_Creature_EnergyDepleted_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Riding_Creature_EnergyDepleted_Base_C");

	return Clss;
}


// GA_Riding_Creature_EnergyDepleted_Base_C GA_Riding_Creature_EnergyDepleted_Base.Default__GA_Riding_Creature_EnergyDepleted_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Riding_Creature_EnergyDepleted_Base_C* UGA_Riding_Creature_EnergyDepleted_Base_C::GetDefaultObj()
{
	static class UGA_Riding_Creature_EnergyDepleted_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Riding_Creature_EnergyDepleted_Base_C*>(UGA_Riding_Creature_EnergyDepleted_Base_C::StaticClass()->DefaultObject);
...
void UGA_Riding_Creature_EnergyDepleted_Base_C::K2_ActivateAbility()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Riding_Creature_EnergyDepleted_Base_C", "K2_ActivateAbility");
...
void UGA_Riding_Creature_EnergyDepleted_Base_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Riding_Creature_EnergyDepleted_Base_C", "K2_OnEndAbility");
...
void UGA_Riding_Creature_EnergyDepleted_Base_C::FailedToActivatePassiveAbility(const struct FGameplayAbilityActorInfo& ActorInfo)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Riding_Creature_EnergyDepleted_Base_C", "FailedToActivatePassiveAbility");
...
void UGA_Riding_Creature_EnergyDepleted_Base_C::ExecuteUbergraph_GA_Riding_Creature_EnergyDepleted_Base(int32 EntryPoint, enum class EEvaluateCurveTableResult CallFunc_EvaluateCurveTableRow_OutResult, float CallFunc_EvaluateCurveTableRow_OutXY, bool K2Node_SwitchEnum_CmpSuccess, bool K2Node_Event_bWasCancelled, const struct FGameplayAbilityActorInfo& K2Node_Event_ActorInfo, class UActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue, class UCreatureBaseRidableComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Riding_Creature_EnergyDepleted_Base_C", "ExecuteUbergraph_GA_Riding_Creature_EnergyDepleted_Base");
