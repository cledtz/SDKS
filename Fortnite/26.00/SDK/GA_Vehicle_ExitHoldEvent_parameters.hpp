...
public:
	...
	uint8                                        Pad_8118[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_8119[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_811A[0x4];                                     // Fixing Size After Last Property 
	struct FGameplayEventData                    Temp_struct_Variable_1;                            // 0x258(0xB0)(None)
	...
	uint8                                        Pad_811D[0x6];                                     // Fixing Size After Last Property 
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x398(0x28)(None)
	TArray<struct FActiveGameplayEffectHandle>   CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue; // 0x3C0(0x10)(ReferenceParm)
	struct FGameplayEventData                    K2Node_CustomEvent_Payload_1;                      // 0x3D0(0xB0)(None)
	...
	uint8                                        Pad_811E[0x3];                                     // Fixing Size After Last Property 
