...
public:
	int32                                        OutPayload;                                        // 0x0(0x4)(Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x4(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_118E[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_11A4[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_11A6[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x10(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_11BE[0x7];                                     // Fixing Size Of Struct
};
