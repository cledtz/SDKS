...
public:
	...
	uint8                                        Pad_58F6[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_58F8[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	class FName                                  PropertyName;                                      // 0xF0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_58F9[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_58FB[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_58FD[0xC];                                     // Fixing Size After Last Property 
...
public:
	...
	class FName                                  PropertyName;                                      // 0xF0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5900[0x4];                                     // Fixing Size Of Struct
};
