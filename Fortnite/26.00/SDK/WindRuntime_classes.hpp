...
public:
	...
	uint8                                        Pad_3EBC[0x7];                                     // Fixing Size Of Struct
...
class UWindField : public UFieldSystemActor
{
public:
	...
	uint8                                        Pad_3ED7[0xF3];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UWindField* GetDefaultObj();

	void SetActive(bool bInIsActive);
	void RemoveIgnoredActor(class UActor* Actor);
	void RemoveCollider(class UShapeComponent* ShapeComponent);
	void OnEndOverlap(class UPrimitiveComponent* OverlappedComponent, class UActor* Other, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex);
	void OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class UActor* Other, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult);
	void AddIgnoredActor(class UActor* Actor);
	void AddCollider(class UShapeComponent* ShapeComponent);
};

// 0x90 (0x430 - 0x3A0)
// Class WindRuntime.LinearWindField
class ULinearWindField : public UWindField
{
public:
	...
	uint8                                        Pad_3EDD[0x50];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class ULinearWindField* GetDefaultObj();

};

// 0x150 (0x4F0 - 0x3A0)
// Class WindRuntime.RadialWindField
class URadialWindField : public UWindField
{
public:
	...
	uint8                                        Pad_3EE0[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3EE3[0x50];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class URadialWindField* GetDefaultObj();
...
{
public:
	uint8                                        Pad_3EEC[0x20];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_3EF4[0x388];                                   // Fixing Size Of Struct
