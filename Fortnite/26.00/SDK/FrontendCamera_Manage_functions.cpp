...
class UClass* UFrontendCamera_Manage_C::StaticClass()
{
...
class UFrontendCamera_Manage_C* UFrontendCamera_Manage_C::GetDefaultObj()
{
	static class UFrontendCamera_Manage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFrontendCamera_Manage_C*>(UFrontendCamera_Manage_C::StaticClass()->DefaultObject);
