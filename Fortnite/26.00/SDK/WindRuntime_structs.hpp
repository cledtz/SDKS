...
public:
	...
	uint8                                        Pad_3EFC[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3EFD[0x1F0];                                   // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3F00[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	TWeakObjectPtr<class UActor>                 Target;                                            // 0xC(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3F01[0x14];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3F02[0xA0];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3F05[0x8];                                     // Fixing Size After Last Property 
