...
struct UFortAthenaAISpawnerDataComponent_Verse_SetAIBehaviorScript_Params
{
public:
	class UAIBehaviorScript*                     InAIBehaviorScript;                                // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2DBA[0x4];                                     // Fixing Size Of Struct
};
