...
class UClass* UWBP_UIKit_ButtonBackground_CTA_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_UIKit_ButtonBackground_CTA_C");

	return Clss;
}


// WBP_UIKit_ButtonBackground_CTA_C WBP_UIKit_ButtonBackground_CTA.Default__WBP_UIKit_ButtonBackground_CTA_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_UIKit_ButtonBackground_CTA_C* UWBP_UIKit_ButtonBackground_CTA_C::GetDefaultObj()
{
	static class UWBP_UIKit_ButtonBackground_CTA_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_UIKit_ButtonBackground_CTA_C*>(UWBP_UIKit_ButtonBackground_CTA_C::StaticClass()->DefaultObject);
...
void UWBP_UIKit_ButtonBackground_CTA_C::TransitionUnhovered(class UWidgetAnimation* AnimTransition)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_UIKit_ButtonBackground_CTA_C", "TransitionUnhovered");
...
void UWBP_UIKit_ButtonBackground_CTA_C::TransitionHovered(class UWidgetAnimation* AnimTransition)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_UIKit_ButtonBackground_CTA_C", "TransitionHovered");
