...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fAI_N_Roperator_U_2eGetNavigatable_U_L_Nfort__character_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fAI_N_Roperator_U_2eGetFortThreatPerception_U_L_Nfort__character_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fAI_N_Roperator_U_2eGetFortLeashable_U_L_Nfort__character_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fAI_N_Roperator_U_2eGetFocusInterface_U_L_Nfort__character_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	...
	void _L_2fFortnite_2ecom_2fAI_N_RMakeNavigationTarget_L_Nfort__threat__info_R(const struct FAI_fort_threat_info& __verse_0xB2CDDD72_Argument, uint64 InstancingGraph, class UAI_navigation_target* __verse_0xB482F2DD_CurrentlyInstantiatedObject);
	...
	struct FSpatialMath_vector3 _L_2fFortnite_2ecom_2fAI_N_RGetThreatLocation_L_Nfort__threat__info_R(const struct FAI_fort_threat_info& __verse_0xB2CDDD72_Argument);
	struct FAI_fort_threat_info AI_fort_threat_info_OverrideFactory(TMap<FVerseStringProperty_, uint8> __verse_0xFB48ED96__InitOverrideMap);
	struct FAI_fort_threat_info AI_fort_threat_info_Factory();
	void _InitCDO();
};
...
public:
	...
	FVerseFunctionProperty_                      __verse_0x1F792AAA_OnBegin;                        // 0xA0(0x10)(InstancedReference, HasGetValueTypeHash)
	FVerseFunctionProperty_                      __verse_0xBBA05E4C__L_2fFortnite_2ecom_2fAI_2fai__behavior_N_ROnEnd; // 0xB0(0x10)(InstancedReference, HasGetValueTypeHash)
	FVerseFunctionProperty_                      __verse_0x5CF23422__L_2fFortnite_2ecom_2fAI_2fai__behavior_N_RGetAgent; // 0xC0(0x10)(InstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_394E[0x10];                                    // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UAI_ai_behavior* GetDefaultObj();

	void _L_2fFortnite_2ecom_2fAI_2fai__behavior_N_ROnEnd(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fAI_2fai__behavior_N_RGetAgent(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	void _InitInstance();
	void _Block();
	void _InitCDO();
};
...
public:
	...
	static class UClass* StaticClass();
	static class UAI_fort_threat_perception_interface* GetDefaultObj();
...
{
public:
	uint8                                        Pad_39A6[0x20];                                    // Fixing Size Of Struct
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_N_Roperator_U_2eGetInstigatorAgent_U_L_Ngame__action__instigator_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lgame__action__instigator_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_N_Roperator_U_2eGetFortCharacter_U_L_Nagent_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lagent_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RTeleportTo_L_Nvector3_M_Nrotation_R(const struct FTuple_Lvector3_Mrotation_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsVulnerable(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsOnGround(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsInWater(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsInAir(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsGliding(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsFlying(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsFalling(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsDownButNotOut(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsCrouching(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RIsActive(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fCharacters_2ffort__character_N_RGetAgent(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
...
public:
	...
	uint8                                        Pad_3AE5[0x70];                                    // Fixing Size Of Struct
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fFortPlayerUtilities_N_Roperator_U_2eSpectatePlayer_U_L_Nplayer_M_Ntuple_L_R_M_Nplayer_R(const struct FTuple_Lplayer_Mtuple_L_R_Mplayer_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fFortPlayerUtilities_N_Roperator_U_2eSpectateEliminator_U_L_Nplayer_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lplayer_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fFortPlayerUtilities_N_Roperator_U_2eSetSpectator_U_L_Nplayer_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lplayer_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fFortPlayerUtilities_N_Roperator_U_2eIsSpectator_U_L_Nplayer_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lplayer_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
...
public:
	...
	struct FGame_damage_result Game_damage_result_Factory(FOptionalProperty_ _ExprResult_0, FOptionalProperty_ __verse_0x00000000__1, uint8 _ExprResult_1, FOptionalProperty_ _ExprResultStack_2, FOptionalProperty_ _ExprResult_3, FOptionalProperty_ __verse_0x00000000__3, uint8 _ExprResult_4, FOptionalProperty_ _ExprResultStack_5, FOptionalProperty_ _ExprResult_6, FOptionalProperty_ __verse_0x00000000__5, uint8 _ExprResult_7, FOptionalProperty_ _ExprResultStack_8, FOptionalProperty_ _ExprResult_9, FOptionalProperty_ __verse_0x00000000__7, uint8 _ExprResult_10, FOptionalProperty_ _ExprResultStack_11);
	struct FGame_damage_args Game_damage_args_OverrideFactory(TMap<FVerseStringProperty_, uint8> __verse_0xFB48ED96__InitOverrideMap, FVerseStringProperty_ _ExprResultStack_0, FOptionalProperty_ _ExprResult_1, FOptionalProperty_ _ExprResult_2, FOptionalProperty_ __verse_0x00000000__1, uint8 _ExprResult_3, FOptionalProperty_ _ExprResultStack_4, FVerseStringProperty_ _ExprResultStack_5, FOptionalProperty_ _ExprResult_6, FOptionalProperty_ _ExprResult_7, FOptionalProperty_ __verse_0x00000000__3, uint8 _ExprResult_8, FOptionalProperty_ _ExprResultStack_9, FVerseStringProperty_ _ExprResultStack_10, FOptionalProperty_ _ExprResult_11, FOptionalProperty_ _ExprResult_12, FOptionalProperty_ __verse_0x00000000__5, uint8 _ExprResult_13, FOptionalProperty_ _ExprResultStack_14, FVerseStringProperty_ _ExprResultStack_15, FOptionalProperty_ _ExprResult_16, FOptionalProperty_ _ExprResult_17, FOptionalProperty_ __verse_0x00000000__7, uint8 _ExprResult_18, FOptionalProperty_ _ExprResultStack_19);
	struct FGame_damage_args Game_damage_args_Factory(FOptionalProperty_ _ExprResult_0, FOptionalProperty_ __verse_0x00000000__1, uint8 _ExprResult_1, FOptionalProperty_ _ExprResultStack_2, FOptionalProperty_ _ExprResult_3, FOptionalProperty_ __verse_0x00000000__3, uint8 _ExprResult_4, FOptionalProperty_ _ExprResultStack_5, FOptionalProperty_ _ExprResult_6, FOptionalProperty_ __verse_0x00000000__5, uint8 _ExprResult_7, FOptionalProperty_ _ExprResultStack_8, FOptionalProperty_ _ExprResult_9, FOptionalProperty_ __verse_0x00000000__7, uint8 _ExprResult_10, FOptionalProperty_ _ExprResultStack_11);
...
{
public:
	class UAI_ai_behavior*                       _Self;                                             // 0x140(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class UAI_focus_interface*                   _Self;                                             // 0x140(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
public:
	class UAI_navigatable*                       _Self;                                             // 0x140(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3C85[0x6];                                     // Fixing Size After Last Property 
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RIsOnTeam_L_Nagent_M_Nteam_R(const struct FTuple_Lagent_Mteam_R& __verse_0xB2CDDD72_Argument);
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RGetTeamAttitude_L_Nteam_M_Nteam_R(const struct FTuple_Lteam_Mteam_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RGetTeamAttitude_L_Nagent_M_Nagent_R(const struct FTuple_Lagent_Magent_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RGetTeam_L_Nagent_R(class USimulation_agent* __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RGetAgents_L_Nteam_R(class USimulation_team* __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fTeams_2ffort__team__collection_N_RAddToTeam_L_Nagent_M_Nteam_R(const struct FTuple_Lagent_Mteam_R& __verse_0xB2CDDD72_Argument);
	void _InitInstance();
	void _Block();
	void _InitCDO();
};
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fVehicles_N_Roperator_U_2eGetVehicle_U_L_Nfort__character_M_Ntuple_L_R_M_Ntuple_L_R_R(const struct FTuple_Lfort__character_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	void _InitCDO();
};
...
public:
	...
	FOptionalProperty_ _L_2fFortnite_2ecom_2fVehicles_2ffort__vehicle_N_RIsOnGround(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fVehicles_2ffort__vehicle_N_RIsInWater(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
	FOptionalProperty_ _L_2fFortnite_2ecom_2fVehicles_2ffort__vehicle_N_RIsInAir(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument);
