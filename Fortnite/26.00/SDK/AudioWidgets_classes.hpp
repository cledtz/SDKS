...
public:
	...
	uint8                                        Pad_3663[0xC];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3671[0x1C];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_36E2[0x160];                                   // Fixing Size Of Struct
...
public:
	float                                        Value;                                             // 0x178(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_373E[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3748[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3749[0x6E8];                                   // Fixing Size Of Struct
