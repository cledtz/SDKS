...
{
public:
	FMulticastInlineDelegateProperty_            OnTargetReady;                                     // 0x78(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	class UAbilityTask_PerformTargeting* PerformFilteringRequest(class UGameplayAbility* OwningAbility, class UTargetingPreset* TargetingPreset, const TArray<class UActor*>& InTargets, bool bAllowAsync);
};
...
public:
	...
	TWeakObjectPtr<class UActor>                 WeakSourceActor;                                   // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UActor*>                        InitialTargets;                                    // 0x50(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_1C3D[0x3];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UAsyncAction_PerformTargeting* GetDefaultObj();

	class UAsyncAction_PerformTargeting* PerformTargetingRequest(class UActor* SourceActor, class UTargetingPreset* TargetingPreset, bool bUseAsyncTargeting);
	class UAsyncAction_PerformTargeting* PerformFilteringRequest(class UActor* SourceActor, class UTargetingPreset* TargetingPreset, bool bUseAsyncTargeting, const TArray<class UActor*>& InTargets);
...
public:
	...
	uint8                                        Pad_1C52[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        BitPad_131 : 5;                                    // Fixing Bit-Field Size 
	uint8                                        Pad_1C55[0x7];                                     // Fixing Size After Last Property 
	...
	struct FQuat GetSourceRotation(struct FTargetingRequestHandle& TargetingHandle);
...
public:
	...
	uint8                                        Pad_1C7A[0x2];                                     // Fixing Size After Last Property 
	struct FCollisionProfileName                 CollisionProfileName;                              // 0x2C(0x4)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	struct FVector GetSourceOffset(struct FTargetingRequestHandle& TargetingHandle);
	struct FVector GetSourceLocation(struct FTargetingRequestHandle& TargetingHandle);
	void GetAdditionalActorsToIgnore(struct FTargetingRequestHandle& TargetingHandle, TArray<class UActor*>* OutAdditionalActorsToIgnore);
};
...
public:
	...
	uint8                                        Pad_1C84[0x7];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1CA0[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1CA2[0x28];                                    // Fixing Size Of Struct
	...
	void GetTargetingResultsActors(const struct FTargetingRequestHandle& TargetingHandle, TArray<class UActor*>* Targets);
