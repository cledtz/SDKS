...
class UClass* UFN_TimedNiagaraNotify_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FN_TimedNiagaraNotify_C");

	return Clss;
}


// FN_TimedNiagaraNotify_C FN_TimedNiagaraNotify.Default__FN_TimedNiagaraNotify_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFN_TimedNiagaraNotify_C* UFN_TimedNiagaraNotify_C::GetDefaultObj()
{
	static class UFN_TimedNiagaraNotify_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFN_TimedNiagaraNotify_C*>(UFN_TimedNiagaraNotify_C::StaticClass()->DefaultObject);
