...
{
public:
	uint8                                        Pad_1D2F[0x8];                                     // Fixing Size After Last Property 
	FMulticastInlineDelegateProperty_            OnWidgetActivated;                                 // 0x3F0(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnWidgetDeactivated;                               // 0x400(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                         bConsumeAllActions;                                // 0x410(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bExposeActionsExternally;                          // 0x411(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bShouldBypassStack;                                // 0x412(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1D30[0x10D];                                   // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1D48[0x48];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1D5C[0x80];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1D67[0x8];                                     // Fixing Size Of Struct
...
{
public:
	bool                                         bUseInputStack;                                    // 0x520(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1D6A[0x3];                                     // Fixing Size After Last Property 
	TWeakObjectPtr<class UMenuAnchor>            OwningMenuAnchor;                                  // 0x524(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UObject>                ContextProvidingObject;                            // 0x52C(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1D6B[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1D8C[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1D91[0x2];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1DC2[0x6];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1E20[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E23[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E24[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1E25[0x18];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1E2A[0x8];                                     // Fixing Size Of Struct
