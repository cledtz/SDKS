...
public:
	...
	uint8                                        Pad_2DB0[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2DB3[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2DB5[0x6];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2DB7[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_2DBB[0x30];                                    // Fixing Size After Last Property 
	TArray<struct FUIFrameworkWidgetTreeEntry>   Entries;                                           // 0x138(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class UActor*                                ReplicatedOwner;                                   // 0x148(0x8)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2DBC[0xA8];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2DBE[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2DC2[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	TSoftObjectPtr<class UObject>                ResourceObject;                                    // 0x10(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2f                             DesiredSize;                                       // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class ESlateBrushTileType               Tiling;                                            // 0x38(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bUseTextureSize;                                   // 0x39(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2DC8[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2DC9[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2DCC[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2DCE[0x4];                                     // Fixing Size Of Struct
};
