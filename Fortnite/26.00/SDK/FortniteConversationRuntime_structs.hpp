...
{
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_346E[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_346F[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_3470[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	TSoftClassPtr<class UUserWidget>             DialogMarkerSoftClass;                             // 0x0(0x20)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
