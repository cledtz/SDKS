...
void USoloButton_C::HandleSize(bool Temp_bool_Variable, bool Temp_bool_Variable_1, int32 Temp_int_Variable, const struct FMargin& K2Node_MakeStruct_Margin, const struct FMargin& K2Node_Select_Default, int32 K2Node_Select_Default_1, double CallFunc_Conv_IntToDouble_ReturnValue, const struct FSlateFontInfo& K2Node_MakeStruct_SlateFontInfo, float K2Node_MakeStruct_Size_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
void USoloButton_C::BP_OnDisabled()
{
	...
	Params::USoloButton_C_BP_OnDisabled_Params Parms{};
...
void USoloButton_C::BP_OnEnabled()
{
	...
	Params::USoloButton_C_BP_OnEnabled_Params Parms{};
