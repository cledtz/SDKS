...
{
public:
	TSoftObjectPtr<class UMaterialInterface>     SoftMaterial;                                      // 0x0(0x20)(BlueprintVisible, BlueprintReadOnly, Parm, UObjectWrapper, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_67CC[0x1];                                     // Fixing Size After Last Property 
	TSoftObjectPtr<class UMaterialInterface>     K2Node_CustomEvent_SoftMaterial;                   // 0x8(0x20)(UObjectWrapper, HasGetValueTypeHash)
	bool                                         K2Node_Event_IsDesignTime;                         // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_67CD[0x3];                                     // Fixing Size After Last Property 
	struct FLinearColor                          K2Node_CustomEvent_Color;                          // 0x2C(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
