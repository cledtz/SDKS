...
class UClass* UGCL_BoostJumpPack_Hovering_C::StaticClass()
{
...
class UGCL_BoostJumpPack_Hovering_C* UGCL_BoostJumpPack_Hovering_C::GetDefaultObj()
{
	static class UGCL_BoostJumpPack_Hovering_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCL_BoostJumpPack_Hovering_C*>(UGCL_BoostJumpPack_Hovering_C::StaticClass()->DefaultObject);
