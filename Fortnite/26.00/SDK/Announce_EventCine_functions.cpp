...
class UClass* UAnnounce_EventCine_C::StaticClass()
{
...
class UAnnounce_EventCine_C* UAnnounce_EventCine_C::GetDefaultObj()
{
	static class UAnnounce_EventCine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnnounce_EventCine_C*>(UAnnounce_EventCine_C::StaticClass()->DefaultObject);
