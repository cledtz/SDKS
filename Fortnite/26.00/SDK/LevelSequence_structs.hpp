...
{
public:
	uint8                                        Pad_EDA[0x20];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_EDC[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	TSoftObjectPtr<class UCameraComponent>       CameraComponent;                                   // 0x70(0x20)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, EditConst, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULevelSequence*                        ActiveShot;                                        // 0x90(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneSequenceID                 ShotID;                                            // 0x98(0x4)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_EE9[0x4];                                      // Fixing Size After Last Property 
	class FString                                MasterName;                                        // 0xA0(0x10)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FQualifiedFrameTime                   MasterTime;                                        // 0xB0(0x10)(Deprecated, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
