...
{
public:
	class ULandscapePatchManager*                NewPatchManager;                                   // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class ULandscape*                            NewLandscape;                                      // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class ULandscapePatchManager*                ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_508F[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_5093[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5095[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5099[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_50A5[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_50B5[0x3];                                     // Fixing Size Of Struct
};
...
public:
	class FName                                  InWeightmapLayerName;                              // 0x0(0x4)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_50BA[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_50C2[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_50C9[0x7];                                     // Fixing Size After Last Property 
	class UTextureRenderTarget2D*                ReturnValue;                                       // 0x8(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_50E2[0x2];                                     // Fixing Size Of Struct
};
