...
class UClass* UARActor::StaticClass()
{
...
class UARActor* UARActor::GetDefaultObj()
{
	static class UARActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UARActor*>(UARActor::StaticClass()->DefaultObject);
...
class UClass* UAROriginActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UAROriginActor* UAROriginActor::GetDefaultObj()
{
	static class UAROriginActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UAROriginActor*>(UAROriginActor::StaticClass()->DefaultObject);
...
void UARSessionConfig::RemoveCandidateImageAtIndex(int32 Index)
{
	static class UFunction* Func = nullptr;
	...
	Params::UARSessionConfig_RemoveCandidateImageAtIndex_Params Parms{};
...
void UARSessionConfig::RemoveCandidateImage(class UARCandidateImage* CandidateImage)
{
	...
	Params::UARSessionConfig_RemoveCandidateImage_Params Parms{};
...
void UARSessionConfig::ClearCandidateImages()
{
	...
	Params::UARSessionConfig_ClearCandidateImages_Params Parms{};
...
class UClass* UARSharedWorldGameMode::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UARSharedWorldGameMode* UARSharedWorldGameMode::GetDefaultObj()
{
	static class UARSharedWorldGameMode* Default = nullptr;

	if (!Default)
		Default = static_cast<UARSharedWorldGameMode*>(UARSharedWorldGameMode::StaticClass()->DefaultObject);
...
class UClass* UARSharedWorldGameState::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UARSharedWorldGameState* UARSharedWorldGameState::GetDefaultObj()
{
	static class UARSharedWorldGameState* Default = nullptr;

	if (!Default)
		Default = static_cast<UARSharedWorldGameState*>(UARSharedWorldGameState::StaticClass()->DefaultObject);
...
class UClass* UARSharedWorldPlayerController::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UARSharedWorldPlayerController* UARSharedWorldPlayerController::GetDefaultObj()
{
	static class UARSharedWorldPlayerController* Default = nullptr;

	if (!Default)
		Default = static_cast<UARSharedWorldPlayerController*>(UARSharedWorldPlayerController::StaticClass()->DefaultObject);
...
class UClass* UARSkyLight::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UARSkyLight* UARSkyLight::GetDefaultObj()
{
	static class UARSkyLight* Default = nullptr;

	if (!Default)
		Default = static_cast<UARSkyLight*>(UARSkyLight::StaticClass()->DefaultObject);
