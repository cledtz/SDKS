...
public:
	...
	uint8                                        Pad_5DC9[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_5E01[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_5E0D[0x7];                                     // Fixing Size Of Struct

	static class UClass* StaticClass();
	static class UDiagnostics_log* GetDefaultObj();

	void _L_2fUnrealEngine_2ecom_2fTemporary_2fDiagnostics_2flog_N_RPrintCallStack_L_N_QLevel_Nlog__level_20_3d_20_2e_2e_2e_R(FOptionalProperty_ __verse_0xB2CDDD72_Argument);
