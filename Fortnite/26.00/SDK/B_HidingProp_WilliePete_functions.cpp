...
class UClass* UB_HidingProp_WilliePete_C::StaticClass()
{
...
class UB_HidingProp_WilliePete_C* UB_HidingProp_WilliePete_C::GetDefaultObj()
{
	static class UB_HidingProp_WilliePete_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UB_HidingProp_WilliePete_C*>(UB_HidingProp_WilliePete_C::StaticClass()->DefaultObject);
