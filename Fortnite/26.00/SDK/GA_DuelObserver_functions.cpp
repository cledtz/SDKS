...
class UClass* UGA_DuelObserver_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_DuelObserver_C");

	return Clss;
}


// GA_DuelObserver_C GA_DuelObserver.Default__GA_DuelObserver_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_DuelObserver_C* UGA_DuelObserver_C::GetDefaultObj()
{
	static class UGA_DuelObserver_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_DuelObserver_C*>(UGA_DuelObserver_C::StaticClass()->DefaultObject);
