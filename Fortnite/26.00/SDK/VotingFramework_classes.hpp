...
{
public:
	uint8                                        Pad_4701[0x90];                                    // Fixing Size After Last Property 
...
class UVoteInitiationActor : public UInfo
{
public:
	uint8                                        Pad_4708[0x8];                                     // Fixing Size After Last Property 
	...
	static class UClass* StaticClass();
	static class UVoteInitiationActor* GetDefaultObj();
...
public:
	...
	void CastManualVoteSelectionAtIndex(class UPlayerState* InPlayerState, int32 SelectionIndex);
	void CastManualVoteSelection(class UPlayerState* InPlayerState, struct FGameplayTag& VoteSelection);
	void CastDefaultVoteSelection(class UPlayerState* InPlayerState);
};
