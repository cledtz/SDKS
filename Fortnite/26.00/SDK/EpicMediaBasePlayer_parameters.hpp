...
public:
	...
	uint8                                        Pad_B6A[0x4];                                      // Fixing Size Of Struct
};
...
struct UEpicBaseStreamingVideo_SetCreateAudioComponent_Params
{
public:
	bool                                         bInCreateAudioComponent;                           // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_BA7[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_BCB[0x6];                                      // Fixing Size Of Struct
};
...
struct UEpicBaseStreamingVideo_GetLicensedAudio_Params
{
public:
