...
class UClass* UPlayerPawn_Generic_C::StaticClass()
{
...
class UPlayerPawn_Generic_C* UPlayerPawn_Generic_C::GetDefaultObj()
{
	static class UPlayerPawn_Generic_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerPawn_Generic_C*>(UPlayerPawn_Generic_C::StaticClass()->DefaultObject);
...
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FDelegateHandleController   CallFunc_WhenCosmeticSpecificPartApplied_DelegateHandleController_Out(None)
...
// struct FDelegateHandleController   CallFunc_WhenCosmeticsApplied_DelegateHandleController_Out       (None)
...
// struct FDelegateHandleController   CallFunc_WhenCosmeticPartApplied_DelegateHandleController_Out_2  (None)
...
// struct FDelegateHandleController   CallFunc_WhenCosmeticSpecificPartApplied_DelegateHandleController_Out_1(None)
...
// struct FDelegateHandleController   CallFunc_WhenCosmeticPartApplied_DelegateHandleController_Out_3  (None)
