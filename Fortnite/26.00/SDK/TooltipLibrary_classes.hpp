...
public:
	...
	void Create_Custom_Tooltip(class UPlayerController* Owning_Player, class FText Header_Text, class USlateBrushAsset* Icon_Brush, class UUserWidget* Widget, class UObject* __WorldContext, class UUserWidget** Output, class UTooltipMinusCustomMinusS_C* CallFunc_Create_ReturnValue);
	void Create_Basic_Tooltip(class UPlayerController* Owning_Player, class FText Body_Text, class FText Header_Text, class USlateBrushAsset* Icon_Brush, class UClass* Header_Style, class UClass* Body_Style, class UObject* __WorldContext, class UUserWidget** Output, class UTooltipMinusBasicMinusS_C* CallFunc_Create_ReturnValue);
};
