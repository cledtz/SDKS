...
class UClass* UPhysicalRimlight_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PhysicalRimlight_C");

	return Clss;
}


// PhysicalRimlight_C PhysicalRimlight.Default__PhysicalRimlight_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPhysicalRimlight_C* UPhysicalRimlight_C::GetDefaultObj()
{
	static class UPhysicalRimlight_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPhysicalRimlight_C*>(UPhysicalRimlight_C::StaticClass()->DefaultObject);
...
void UPhysicalRimlight_C::Set_Rimlight_Color_and_Intensity(enum class EFortDayPhase Temp_byte_Variable, TScriptInterface<class UFortTimeOfDayManagerInterface> CallFunc_GetContextualTimeOfDayManager_ReturnValue, class UDirectionalLightComponent* CallFunc_GetDirectionalLightComponent_ReturnValue, class UObject* CallFunc_Conv_InterfaceToObject_ReturnValue, const struct FLinearColor& CallFunc_GetLightColor_ReturnValue, bool CallFunc_IsValid_ReturnValue, enum class EFortDayPhase CallFunc_GetCurrentDayPhase_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, double CallFunc_Multiply_DoubleDouble_ReturnValue_2, double K2Node_Select_Default, double CallFunc_Multiply_DoubleDouble_ReturnValue_3, float CallFunc_SetIntensity_NewIntensity_ImplicitCast, float CallFunc_SetIntensity_NewIntensity_ImplicitCast_1)
{
	...
	Params::UPhysicalRimlight_C_Set_Rimlight_Color_and_Intensity_Params Parms{};
...
void UPhysicalRimlight_C::RimlightAttemptValidation(bool CallFunc_Array_IsValidIndex_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_RimlightAttemptValidation_Params Parms{};
...
void UPhysicalRimlight_C::PhysicalRimlight_AutoGenFunc(const class FString& CVarName, float CallFunc_GetConsoleVariableFloatValue_ReturnValue, double K2Node_VariableSet_Rimlight_CVARBoost_ImplicitCast)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_PhysicalRimlight_AutoGenFunc_Params Parms{};
...
void UPhysicalRimlight_C::Update_Rimlight()
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_Update_Rimlight_Params Parms{};
...
void UPhysicalRimlight_C::ValidateRimlight(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable_1, class UPawn* CallFunc_GetPlayerPawn_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue, class UPlayerCameraManager* CallFunc_GetPlayerCameraManager_ReturnValue, const struct FRotator& CallFunc_GetCameraRotation_ReturnValue, const struct FVector& CallFunc_GetCameraLocation_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, const struct FVector& CallFunc_TransformLocation_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, const struct FRotator& CallFunc_FindLookAtRotation_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldRotation_SweepHitResult, bool CallFunc_IsLocallyControlled_ReturnValue, float CallFunc_GetConsoleVariableFloatValue_ReturnValue, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item_1, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable_1, bool CallFunc_Less_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_1)
{
	...
	Params::UPhysicalRimlight_C_ValidateRimlight_Params Parms{};
...
void UPhysicalRimlight_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_ReceiveBeginPlay_Params Parms{};
...
void UPhysicalRimlight_C::InitRim()
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_InitRim_Params Parms{};
...
void UPhysicalRimlight_C::Day_Phase_(enum class EFortDayPhase CurrentDayPhase, enum class EFortDayPhase PreviousDayPhase, bool bAtCreation)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_Day_Phase__Params Parms{};
...
void UPhysicalRimlight_C::ExecuteUbergraph_PhysicalRimlight(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UDataDrivenCVarEngineSubsystem* CallFunc_GetEngineSubsystem_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, class UPawn* CallFunc_GetPlayerPawn_ReturnValue, TScriptInterface<class UFortTimeOfDayManagerInterface> CallFunc_GetContextualTimeOfDayManager_ReturnValue, class UPlayerPawn_Athena_C* K2Node_DynamicCast_AsPlayer_Pawn_Athena, bool K2Node_DynamicCast_bSuccess, enum class EFortDayPhase K2Node_CustomEvent_CurrentDayPhase, enum class EFortDayPhase K2Node_CustomEvent_PreviousDayPhase, bool K2Node_CustomEvent_bAtCreation)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPhysicalRimlight_C_ExecuteUbergraph_PhysicalRimlight_Params Parms{};
