...
public:
	...
	uint8                                        Pad_1DC0[0xF];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1DC3[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1DC8[0x50];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DCF[0x88];                                    // Fixing Size Of Struct
...
{
public:
	class FString                                TileSetFieldName;                                  // 0x520(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UDataTable>             TileTypeToTileClassDataTable;                      // 0x530(0x20)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftClassPtr<class UUserWidget>             LayoutErrorClass;                                  // 0x550(0x20)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UDataTable>             LayoutTypeToLayoutClassDataTable;                  // 0x570(0x20)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1DD2[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DDC[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1DE0[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1DE1[0x18];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1DE4[0x88];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1E08[0x5];                                     // Fixing Size Of Struct
