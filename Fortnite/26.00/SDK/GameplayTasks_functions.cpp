...
class UClass* UGameplayTaskOwnerInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UGameplayTaskOwnerInterface* UGameplayTaskOwnerInterface::GetDefaultObj()
{
	static class UGameplayTaskOwnerInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayTaskOwnerInterface*>(UGameplayTaskOwnerInterface::StaticClass()->DefaultObject);
