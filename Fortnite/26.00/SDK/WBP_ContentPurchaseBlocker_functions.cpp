...
class UClass* UWBP_ContentPurchaseBlocker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_ContentPurchaseBlocker_C");

	return Clss;
}


// WBP_ContentPurchaseBlocker_C WBP_ContentPurchaseBlocker.Default__WBP_ContentPurchaseBlocker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_ContentPurchaseBlocker_C* UWBP_ContentPurchaseBlocker_C::GetDefaultObj()
{
	static class UWBP_ContentPurchaseBlocker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_ContentPurchaseBlocker_C*>(UWBP_ContentPurchaseBlocker_C::StaticClass()->DefaultObject);
...
void UWBP_ContentPurchaseBlocker_C::OnComplete_EDE27478404080C54EDC0D863BB58408(class UUserWidget* UserWidget)
{
	...
	if (!Func)
		Func = Class->GetFunction("WBP_ContentPurchaseBlocker_C", "OnComplete_EDE27478404080C54EDC0D863BB58408");
