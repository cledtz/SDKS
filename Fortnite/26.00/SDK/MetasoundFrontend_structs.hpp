...
{
public:
	uint8                                        Pad_20FB[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20FC[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_210C[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_210D[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_210F[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_2110[0x4];                                     // Fixing Size After Last Property 
	struct FMetasoundFrontendLiteral             DefaultLiteral;                                    // 0x30(0x58)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2112[0x3];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2113[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2119[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_211B[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	class FName                                  Namespace;                                         // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FName                                  Variant;                                           // 0x8(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FMetasoundFrontendClassName           ClassName;                                         // 0x0(0xC)(Edit, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_211D[0x1];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_211F[0x8];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2122[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_2124[0x10];                                    // Fixing Size After Last Property 
...
{
public:
	TScriptInterface<class UMetaSoundDocumentInterface> DocumentInterface;                                 // 0x0(0x10)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2129[0x20];                                    // Fixing Size Of Struct
};
