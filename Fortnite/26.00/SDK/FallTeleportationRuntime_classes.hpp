...
{
public:
	TSoftClassPtr<class UActor>                  PlayerPawnReceiverClass;                           // 0xA0(0x20)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UFortFallTeleportComponentBase> ComponentToAddClass;                               // 0xC0(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                        TeleportEnabled;                                   // 0xC8(0x28)(Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                        RemoveComponentRequestTimeOffset;                  // 0xF0(0x28)(Edit, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_4338[0x50];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_435C[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_435F[0x20];                                    // Fixing Size Of Struct
