...
class UClass* UAnimNotifyState_HightBeam_HandFX_HologramHide_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AnimNotifyState_HightBeam_HandFX_HologramHide_C");

	return Clss;
}


// AnimNotifyState_HightBeam_HandFX_HologramHide_C AnimNotifyState_HightBeam_HandFX_HologramHide.Default__AnimNotifyState_HightBeam_HandFX_HologramHide_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnimNotifyState_HightBeam_HandFX_HologramHide_C* UAnimNotifyState_HightBeam_HandFX_HologramHide_C::GetDefaultObj()
{
	static class UAnimNotifyState_HightBeam_HandFX_HologramHide_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnimNotifyState_HightBeam_HandFX_HologramHide_C*>(UAnimNotifyState_HightBeam_HandFX_HologramHide_C::StaticClass()->DefaultObject);
...
bool UAnimNotifyState_HightBeam_HandFX_HologramHide_C::Received_NotifyTick(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float FrameDeltaTime, struct FAnimNotifyEventReference& EventReference, class UActor* CallFunc_GetOwner_ReturnValue, bool CallFunc_Received_NotifyTick_ReturnValue, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsInFrontEndHologram_ReturnValue, class UFXSystemComponent* CallFunc_GetSpawnedEffect_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UAnimNotifyState_HightBeam_HandFX_HologramHide_C_Received_NotifyTick_Params Parms{};
