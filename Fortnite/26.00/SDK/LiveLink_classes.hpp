...
public:
	...
	uint8                                        Pad_960[0x17];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_972[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_976[0x1];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_977[0x6];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_AEE[0x10];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_AF3[0x6];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_B03[0x58];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B22[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	TSoftObjectPtr<class ULiveLinkPreset>        DefaultLiveLinkPreset;                             // 0x40(0x20)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        ClockOffsetCorrectionStep;                         // 0x60(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class ELiveLinkSourceMode               DefaultMessageBusSourceMode;                       // 0x64(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B2B[0x3];                                      // Fixing Size After Last Property 
	double                                       MessageBusPingRequestFrequency;                    // 0x68(0x8)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                       MessageBusHeartbeatFrequency;                      // 0x70(0x8)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                       MessageBusHeartbeatTimeout;                        // 0x78(0x8)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                       MessageBusTimeBeforeRemovingInactiveSource;        // 0x80(0x8)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                       TimeWithoutFrameToBeConsiderAsInvalid;             // 0x88(0x8)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          ValidColor;                                        // 0x90(0x10)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                          InvalidColor;                                      // 0xA0(0x10)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        TextSizeSource;                                    // 0xB0(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        TextSizeSubject;                                   // 0xB1(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B2E[0x6];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B31[0x3];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_B33[0x68];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B37[0x4C];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B3C[0x4];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B46[0x10];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_B4D[0x14];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_B63[0x28];                                     // Fixing Size Of Struct
