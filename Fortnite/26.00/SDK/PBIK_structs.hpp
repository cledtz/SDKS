...
public:
	...
	uint8                                        Pad_1F8F[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1F90[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1F91[0x3];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1F95[0x2];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_1F9A[0x68];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1F9B[0x3];                                     // Fixing Size Of Struct
};
...
public:
	class FName                                  bone;                                              // 0x0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1F9C[0xC];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1F9D[0xC];                                     // Fixing Size Of Struct
};
...
public:
	...
	struct FPBIKSolver                           Solver;                                            // 0x28(0x68)(Transient, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1FA1[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1FA2[0x4];                                     // Fixing Size After Last Property 
	struct FPBIKWorkData                         WorkData;                                          // 0x1F0(0x90)(Transient, NativeAccessSpecifierPublic)
};
