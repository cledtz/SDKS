...
class UClass* UGA_Athena_Consumable_Throw_Parent_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_Consumable_Throw_Parent_C");

	return Clss;
}


// GA_Athena_Consumable_Throw_Parent_C GA_Athena_Consumable_Throw_Parent.Default__GA_Athena_Consumable_Throw_Parent_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_Consumable_Throw_Parent_C* UGA_Athena_Consumable_Throw_Parent_C::GetDefaultObj()
{
	static class UGA_Athena_Consumable_Throw_Parent_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_Consumable_Throw_Parent_C*>(UGA_Athena_Consumable_Throw_Parent_C::StaticClass()->DefaultObject);
...
// struct FGameplayTagContainer       CallFunc_K2_OverrideFailedReason_OverridenFailedReason           (None)
...
void UGA_Athena_Consumable_Throw_Parent_C::OnProjectileSpawn__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Athena_Consumable_Throw_Parent_C", "OnProjectileSpawn__DelegateSignature");
