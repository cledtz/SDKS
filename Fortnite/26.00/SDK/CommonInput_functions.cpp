...
class UClass* UCommonUIHoldData::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CommonUIHoldData");

	return Clss;
}


// CommonUIHoldData CommonInput.Default__CommonUIHoldData
// (Public, ClassDefaultObject, ArchetypeObject)

class UCommonUIHoldData* UCommonUIHoldData::GetDefaultObj()
{
	static class UCommonUIHoldData* Default = nullptr;

	if (!Default)
		Default = static_cast<UCommonUIHoldData*>(UCommonUIHoldData::StaticClass()->DefaultObject);
