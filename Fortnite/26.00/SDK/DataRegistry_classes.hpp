...
public:
	...
	uint8                                        Pad_109E[0x48];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_10A2[0x28];                                    // Fixing Size Of Struct
...
{
public:
	TSoftObjectPtr<class UCurveTable>            SourceTable;                                       // 0x38(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDataRegistrySource_DataTableRules    TableRules;                                        // 0x58(0x8)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	class UCurveTable*                           CachedTable;                                       // 0x60(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCurveTable*                           PreloadTable;                                      // 0x68(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_10A3[0x28];                                    // Fixing Size Of Struct
...
{
public:
	TSoftObjectPtr<class UDataTable>             SourceTable;                                       // 0x38(0x20)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDataRegistrySource_DataTableRules    TableRules;                                        // 0x58(0x8)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	class UDataTable*                            CachedTable;                                       // 0x60(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UDataTable*                            PreloadTable;                                      // 0x68(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_10A4[0x28];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_10E4[0x98];                                    // Fixing Size Of Struct
