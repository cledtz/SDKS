...
void UQuartzClockHandle::NotifyOnQuantizationBoundary(class UObject* WorldContextObject, const struct FQuartzQuantizationBoundary& InQuantizationBoundary, FDelegateProperty_& InDelegate, float InMsOffset)
{
	static class UFunction* Func = nullptr;
	...
	Params::UQuartzClockHandle_NotifyOnQuantizationBoundary_Params Parms{};
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// enum class EQuartzCommandQuantizationQuantizationBoundary                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
float UQuartzClockHandle::GetBeatProgressPercent(enum class EQuartzCommandQuantization QuantizationBoundary, float PhaseOffset, float MsOffset)
{
	static class UFunction* Func = nullptr;
	...
	Params::UQuartzClockHandle_GetBeatProgressPercent_Params Parms{};
