...
public:
	...
	uint8                                        Pad_905D[0x6];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9063[0x3];                                     // Fixing Size After Last Property 
	class UFortPlayerPawn*                       CallFunc_GetInstigator_ReturnValue;                // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	uint8                                        Pad_9069[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_906E[0x2];                                     // Fixing Size After Last Property 
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x4(0xC)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_9076[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_9077[0xF];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_907B[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_907C[0x7];                                     // Fixing Size After Last Property 
	...
	TMap<enum class ELinkToDirection, struct FVector> K2Node_MakeMap_Map;                                // 0x110(0x50)(None)
};
...
public:
	...
	uint8                                        Pad_9082[0x1];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9085[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_908D[0x4];                                     // Fixing Size After Last Property 
...
public:
	float                                        Damage;                                            // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9092[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_9095[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_90BC[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90BE[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90C3[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90CB[0x5];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90CD[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90D1[0x6];                                     // Fixing Size After Last Property 
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x6B0(0x18)(None)
	...
	uint8                                        Pad_90D6[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90E0[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90E2[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90E6[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90EB[0x5];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90EE[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90F0[0x7];                                     // Fixing Size After Last Property 
	class UFortPlaylist*                         Temp_object_Variable_1;                            // 0xBE0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                 Temp_struct_Variable;                              // 0xBE8(0x20)(None)
	...
	uint8                                        Pad_90F1[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90F2[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90F5[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90F6[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90F9[0x5];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_90FA[0x1];                                     // Fixing Size After Last Property 
