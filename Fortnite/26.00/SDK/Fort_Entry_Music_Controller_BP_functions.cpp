...
class UClass* UFort_Entry_Music_Controller_BP_C::StaticClass()
{
...
class UFort_Entry_Music_Controller_BP_C* UFort_Entry_Music_Controller_BP_C::GetDefaultObj()
{
	static class UFort_Entry_Music_Controller_BP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFort_Entry_Music_Controller_BP_C*>(UFort_Entry_Music_Controller_BP_C::StaticClass()->DefaultObject);
