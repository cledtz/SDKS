...
public:
	...
	uint8                                        Pad_32A6[0x7];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_32AF[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_32B3[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_32F0[0x5];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_32F8[0x4];                                     // Fixing Size Of Struct
...
{
public:
	struct FScalableFloat                        AugmentsEnabledViaHotfix;                          // 0x630(0x28)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	TMap<struct FGameplayTag, TSoftObjectPtr<class UObject>> TagToImageMap;                                     // 0x658(0x50)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UCommonTextBlock*                      Text_CategoryTitle;                                // 0x6A8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	class FName                                  ParamName_Progress;                                // 0x4B0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_330B[0x4];                                     // Fixing Size After Last Property 
	class UCommonTextBlock*                      Text_ItemCategory;                                 // 0x4B8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortItemCategoryIndicator*            ItemCategoryIndicator;                             // 0x4C0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UOverlay*                              Overlay_UndiscoveredText;                          // 0x4C8(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_3382[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_3383[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_33D7[0x8];                                     // Fixing Size After Last Property 
	...
	class UFortSocialAvatarIcon*                 Icon_LenderAvatarIcon;                             // 0x430(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortLazyImage*                        Image_LenderSquadColor;                            // 0x438(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonTextBlock*                      Text_BorrowingText;                                // 0x440(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_33E4[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_340A[0x8];                                     // Fixing Size After Last Property 
	struct FScalableFloat                        AugmentsEnabledViaHotfix;                          // 0x3F0(0x28)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FGameplayTagContainer                 HiddenAugmentGameplayTags;                         // 0x418(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	class FName                                  TabNameID;                                         // 0x438(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_340B[0x4];                                     // Fixing Size After Last Property 
	struct FFortTabButtonLabelInfo               TabButtonLabelInfo;                                // 0x440(0xF0)(Edit, NativeAccessSpecifierPrivate)
	class UFortPlayerAugmentInventoryInfoWidget* AugmentInfo;                                       // 0x530(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UCommonListView*                       ListView_Augments;                                 // 0x538(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_3443[0x60];                                    // Fixing Size After Last Property 
