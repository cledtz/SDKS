...
{
public:
	uint8                                        Pad_2379[0xC];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_237D[0x20];                                    // Fixing Size Of Struct
};
...
public:
	...
	bool                                         bForceUniqueClassName;                             // 0x4(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bAddToRegistry;                                    // 0x5(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2383[0x2];                                     // Fixing Size After Last Property 
	TScriptInterface<class UMetaSoundDocumentInterface> ExistingMetaSound;                                 // 0x8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
