...
void AGCNL_GrindSprinting_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_GrindSprinting_C", "OnLoopingStartGeneric");

	Params::AGCNL_GrindSprinting_C_OnLoopingStartGeneric_Params Parms;
...
void AGCNL_GrindSprinting_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_GrindSprinting_C", "OnRemovalGeneric");

	Params::AGCNL_GrindSprinting_C_OnRemovalGeneric_Params Parms;
