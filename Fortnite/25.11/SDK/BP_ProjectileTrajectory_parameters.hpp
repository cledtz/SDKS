...
{
public:
	FInterfaceProperty_                          K2Node_DynamicCast_AsFort_Trajectory_Ability_Interface; // 0x0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_ProjectileTrajectory_C_SetTrajectoryValid_Params
{
public:
...
struct ABP_ProjectileTrajectory_C_UpdateTargetMeshVisibility_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_93B4[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_93B5[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_93B7[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_93B8[0x2];                                     // Fixing Size After Last Property..
