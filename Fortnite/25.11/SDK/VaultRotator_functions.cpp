...
void AVaultRotator_C::Timeline_YawRotation__FinishedFunc()
{
	...
	Params::AVaultRotator_C_Timeline_YawRotation__FinishedFunc_Params Parms;
...
void AVaultRotator_C::Timeline_YawRotation__UpdateFunc()
{
	...
	Params::AVaultRotator_C_Timeline_YawRotation__UpdateFunc_Params Parms;
...
void AVaultRotator_C::OnTargetZoomLevelSet(float TargetZoomLevel)
{
	...
	Params::AVaultRotator_C_OnTargetZoomLevelSet_Params Parms;
...
void AVaultRotator_C::OnSetBackgroundMessageText(class FText& BackgroundMessageText)
{
	...
	Params::AVaultRotator_C_OnSetBackgroundMessageText_Params Parms;
...
void AVaultRotator_C::OnUpdateBackgroundColor(bool bEnableAutotestBackground)
{
	...
	Params::AVaultRotator_C_OnUpdateBackgroundColor_Params Parms;
...
void AVaultRotator_C::OnTargetRotationOffsetSet(struct FRotator& TargetRotationOffset)
{
	static auto Func = Class->GetFunction("VaultRotator_C", "OnTargetRotationOffsetSet");

	Params::AVaultRotator_C_OnTargetRotationOffsetSet_Params Parms;
...
void AVaultRotator_C::OnTargetRotationOffsetCanceled()
{
	...
	Params::AVaultRotator_C_OnTargetRotationOffsetCanceled_Params Parms;
...
void AVaultRotator_C::OnTargetZoomLevelCanceled()
{
	...
	Params::AVaultRotator_C_OnTargetZoomLevelCanceled_Params Parms;
