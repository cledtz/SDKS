...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("AIDebuggerCheatManager");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_12E6[0x98];                                    // Fixing Size After Last Property..
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("AIDebuggerRendererComponent");
		return Clss;
	}
...
{
public:
	class APlayerController*                     OwnerPC;                                           // 0xA8(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_12E8[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_12E9[0x1E];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("FortControllerComponent_AIDebugger");
		return Clss;
	}
