...
{
public:
	uint8                                        Pad_2227[0x20];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2228[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_1EE : 7;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_222A[0x6];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_222B[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_222C[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	class FName                                  MappingName;                                       // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_222D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_222E[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_222F[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_2230[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2231[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2232[0x4];                                     // Fixing Size After Last Property..
	class FText                                  DisplayName;                                       // 0x10(0x18)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_2233[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_2236[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2237[0xB];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2238[0x20];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_223C[0x7];                                     // Fixing Size Of Struct..
};
