...
void AGCNL_Ascender_Ascent_C::OnApplicationGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Ascender_Ascent_C", "OnApplicationGeneric");

	Params::AGCNL_Ascender_Ascent_C_OnApplicationGeneric_Params Parms;
...
void AGCNL_Ascender_Ascent_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Ascender_Ascent_C", "OnRemovalGeneric");

	Params::AGCNL_Ascender_Ascent_C_OnRemovalGeneric_Params Parms;
...
void AGCNL_Ascender_Ascent_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Ascender_Ascent_C", "OnLoopingStartGeneric");

	Params::AGCNL_Ascender_Ascent_C_OnLoopingStartGeneric_Params Parms;
...
void AGCNL_Ascender_Ascent_C::CameraShakeTimer()
{
	...
	Params::AGCNL_Ascender_Ascent_C_CameraShakeTimer_Params Parms;
