...
public:
	...
	uint8                                        Pad_368F[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FGameplayTag                          CursorModeTag;                                     // 0x8(0x4)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bShouldBeVisible;                                  // 0xC(0x1)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3690[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	class AFortPlayerStateAthena*                ReturnValue;                                       // 0x0(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_3696[0x7];                                     // Fixing Size Of Struct..
};
