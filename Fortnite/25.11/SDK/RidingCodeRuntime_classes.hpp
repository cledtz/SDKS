...
public:
	...
	uint8                                        Pad_7D4D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D4E[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D50[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D54[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D55[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D57[0x38];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7D5D[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D5E[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D61[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D62[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D63[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D64[0x17];                                    // Fixing Size Of Struct..
	...
	void HandleRiderEndPlay(class AActor* Actor, enum class EEndPlayReason EndPlayReason);
...
public:
	...
	uint8                                        Pad_7D67[0x5];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D68[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D69[0x1E];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D6A[0x28];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7D77[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D79[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        BitPad_41C : 7;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_7D7A[0x3];                                     // Fixing Size After Last Property..
	TWeakObjectPtr<class AFortPlayerController>  ClampedController;                                 // 0x524(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_7D7B[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D7C[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D7D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7D7E[0x90];                                    // Fixing Size Of Struct..
	...
	void HandleActorEndPlayWhileRiding(class AActor* Actor, enum class EEndPlayReason EndPlayReason);
...
{
public:
	class UFortInputMappingContext*              ControllingRidingInputContext;                     // 0x678(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UInputAction*                          RidingAbility;                                     // 0x680(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UInputAction*                          GamepadRidingAbility;                              // 0x688(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bCanControlRidable;                                // 0x690(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bIsControllingRidable;                             // 0x691(0x1)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	enum class ERidingControlInputStyle          ControlInputStyle;                                 // 0x692(0x1)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7D80[0xD];                                     // Fixing Size After Last Property..
	struct FRidingControlInputState              ReplicatedControlInputState;                       // 0x6A0(0xC)(Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FRidingControlInputStateReliable      ReplicatedControlInputStateReliable;               // 0x6AC(0x1)(Net, Transient, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FRidingControlInputStateUnreliable    ReplicatedControlInputStateUnreliable;             // 0x6AD(0x2)(Net, Transient, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7D81[0x1];                                     // Fixing Size After Last Property..
	class UFortInputComponent*                   ControllingRiderInputComponent;                    // 0x6B0(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7D82[0x10];                                    // Fixing Size After Last Property..
	float                                        AutoRunDoubleTapTimestamp;                         // 0x6C8(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bCanBePet;                                         // 0x6CC(0x1)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7D83[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7D84[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_7D85[0x4];                                     // Fixing Size Of Struct..
