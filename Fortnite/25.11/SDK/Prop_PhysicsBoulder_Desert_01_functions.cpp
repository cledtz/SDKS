...
void AProp_PhysicsBoulder_Desert_01_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Desert_01_C", "OnDeathPlayEffects");

	Params::AProp_PhysicsBoulder_Desert_01_C_OnDeathPlayEffects_Params Parms;
...
void AProp_PhysicsBoulder_Desert_01_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Desert_01_C", "ReceiveHit");

	Params::AProp_PhysicsBoulder_Desert_01_C_ReceiveHit_Params Parms;
...
void AProp_PhysicsBoulder_Desert_01_C::ReceiveBeginPlay()
{
	...
	Params::AProp_PhysicsBoulder_Desert_01_C_ReceiveBeginPlay_Params Parms;
