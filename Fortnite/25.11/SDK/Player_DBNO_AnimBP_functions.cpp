...
{
	static auto Func = Class->GetFunction("Player_DBNO_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("Player_DBNO_AnimBP_C", "ExecuteUbergraph_Player_DBNO_AnimBP");
