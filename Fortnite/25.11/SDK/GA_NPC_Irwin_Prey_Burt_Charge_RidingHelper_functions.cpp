...
{
	static auto Func = Class->GetFunction("GA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C", "K2_ActivateAbilityFromEvent");
...
// Parameters:
// class AActor*                      PlayerTarget                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UGA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C::FireBoostEffectsOnPlayerMulti(class AActor* PlayerTarget)
{
	static auto Func = Class->GetFunction("GA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C", "FireBoostEffectsOnPlayerMulti");
...
// class AActor*                      K2Node_CustomEvent_PlayerTarget                                  (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
