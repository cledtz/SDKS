...
{
public:
	uint8                                        Pad_17DD[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_17DE[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17E0[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17E1[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_17E2[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_17E3[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_17E5[0x4];                                     // Fixing Size Of Struct..
};
