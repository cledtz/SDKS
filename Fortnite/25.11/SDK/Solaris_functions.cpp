...
void USolarisMapLibrary::RefCall(TMap<struct FGenericKeyType, struct FGenericValueType>& Map, const struct FGenericKeyType& Key)
{
	static auto Func = Class->GetFunction("SolarisMapLibrary", "RefCall");

	Params::USolarisMapLibrary_RefCall_Params Parms;
...
void USolarisMapLibrary::CompletelyAssignedRefCall(TMap<struct FGenericKeyType, struct FGenericValueType>& Map, const struct FGenericKeyType& Key)
{
	static auto Func = Class->GetFunction("SolarisMapLibrary", "CompletelyAssignedRefCall");

	Params::USolarisMapLibrary_CompletelyAssignedRefCall_Params Parms;
...
void USolarisMapLibrary::Call(TMap<struct FGenericKeyType, struct FGenericValueType>& Map, const struct FGenericKeyType& Key)
{
	static auto Func = Class->GetFunction("SolarisMapLibrary", "Call");

	Params::USolarisMapLibrary_Call_Params Parms;
