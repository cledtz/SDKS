...
public:
	...
	uint8                                        Pad_8156[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8157[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8158[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8159[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	class ACreativePlayerReplicationProxy*       ProxyData;                                         // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class AFortPlayerState*                      PlayerState;                                       // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_815A[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	struct FUniqueNetIdRepl                      NetId;                                             // 0x0(0x30)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsLocalPlayer;                                    // 0x30(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_815B[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_815C[0x7];                                     // Fixing Size Of Struct..
};
