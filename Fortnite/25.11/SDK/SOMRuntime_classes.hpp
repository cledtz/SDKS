...
{
public:
	uint8                                        Pad_7EBE[0x8];                                     // Fixing Size After Last Property..
	TArray<struct FFortScriptedObjectMovementPhaseData> Phases;                                            // 0x290(0x10)(Edit, ZeroConstructor, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                        NumSimulatenousMovingObjects;                      // 0x2A0(0x28)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                        PhaseIntervalSeconds;                              // 0x2C8(0x28)(Edit, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7EBF[0x20];                                    // Fixing Size After Last Property..
	struct FScriptedObjectMovement_Grid          BaseGrid;                                          // 0x310(0xC8)(Transient, NativeAccessSpecifierPrivate)
	struct FScriptedObjectMovement_DynamicPathContext InProgressPath;                                    // 0x3D8(0x38)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TArray<class UFortScriptedObjectMovement_Slot*> LeavingSlotStack;                                  // 0x410(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UFortScriptedObjectMovement_Slot*> DestinationSlotStack;                              // 0x420(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UFortScriptedObjectMovement_Slot*> OverflowSlotStack;                                 // 0x430(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class AFortScriptedObjectMovement_MovableObjectBase*> CurrentlyMovingObjects;                            // 0x440(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_7EC0[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	TArray<class UFortScriptedObjectMovement_Slot*> CachedObjectSlots;                                 // 0x288(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UFortScriptedObjectMovement_SlotDefinition*> CachedSlotDefinitions;                             // 0x298(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_7EC3[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EC4[0x98];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7EC8[0x78];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EC9[0x24];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ECA[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ECB[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ECC[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ECD[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7ED1[0x18];                                    // Fixing Size After Last Property..
	class USplineComponent*                      MasterSplinePath;                                  // 0x2A0(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FScriptedObjectMovement_StaticPathTravelerData> PathTravelers;                                     // 0x2A8(0x10)(Edit, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FScriptedObjectMovement_StaticPathSplineInputKeyData> SplineData;                                        // 0x2B8(0x10)(Edit, ZeroConstructor, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
	float                                        StepSpacingDistance;                               // 0x2C8(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7ED2[0x4];                                     // Fixing Size After Last Property..
	TSoftObjectPtr<class UScriptedObjectMovement_CalendarCheatDefinition> CheatCalendarEventDefinition;                      // 0x2D0(0x28)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_7ED3[0x7C];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ED4[0x128];                                   // Fixing Size After Last Property..
