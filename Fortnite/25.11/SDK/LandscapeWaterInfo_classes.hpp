...
public:
	...
	double                                       Flood_Water_Level;                                 // 0x298(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                            Game_Texture__Water_Velocity_and_Height;           // 0x2A0(0x8)(Edit, BlueprintVisible, ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9C4B[0x8];                                     // Fixing Size After Last Property..
