...
{
public:
	class APlayerController*                     OwnerPC;                                           // 0x288(0x8)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bIsEnabled;                                        // 0x290(0x1)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1EFC[0x7];                                     // Fixing Size After Last Property..
	struct FGameplayDebuggerNetPack              ReplicatedData;                                    // 0x298(0x18)(Net, RepNotify, Protected, NativeAccessSpecifierProtected)
	struct FGameplayDebuggerDebugActor           DebugActor;                                        // 0x2B0(0x10)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayDebuggerVisLogSync           VisLogSync;                                        // 0x2C0(0x10)(Net, Protected, NativeAccessSpecifierProtected)
	class UGameplayDebuggerRenderingComponent*   RenderingComp;                                     // 0x2D0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1EFD[0x68];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1EFF[0xC0];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1F01[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1F02[0x8];                                     // Fixing Size After Last Property..
	TArray<struct FGameplayDebuggerPlayerData>   PlayerData;                                        // 0x290(0x10)(ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class AGameplayDebuggerCategoryReplicator*> PendingRegistrations;                              // 0x2A0(0x10)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_1F03[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1F04[0x68];                                    // Fixing Size Of Struct..
