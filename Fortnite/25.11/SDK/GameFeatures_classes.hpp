...
public:
	...
	uint8                                        Pad_1DBC[0xF];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_1DBD[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1DBE[0x50];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1DBF[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1DC0[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1DC4[0xA0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1DC5[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	TArray<class FString>                        DisabledPlugins;                                   // 0x48(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<class FString>                        AdditionalPluginMetadataKeys;                      // 0x58(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	uint8                                        Pad_1DC6[0x20];                                    // Fixing Size Of Struct..
