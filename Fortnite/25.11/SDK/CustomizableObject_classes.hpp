...
public:
	...
	uint8                                        Pad_1E76[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1E77[0x88];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1E78[0xA0];                                    // Fixing Size After Last Property..
	TArray<class UPhysicsAsset*>                 ClothingPhysicsAssets;                             // 0x240(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UAnimInstance>>     GatheredAnimBPs;                                   // 0x250(0x10)(Edit, EditFixedSize, ZeroConstructor, Transient, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                 AnimBPGameplayTags;                                // 0x260(0x20)(Edit, EditFixedSize, Transient, EditConst, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class UAnimInstance>, struct FAnimBpGeneratedPhysicsAssets> AnimBpPhysicsAssets;                               // 0x280(0x50)(Edit, EditFixedSize, Transient, EditConst, NativeAccessSpecifierPublic)
	uint8                                        Pad_1E79[0x38];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableInstancePrivateData");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObjectExtension");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableInstanceLODManagementBase");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_1E7A[0x58];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableInstanceLODManagement");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("MutableMaskOutCache");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObjectBulk");
		return Clss;
	}
...
public:
	...
	TArray<TSoftObjectPtr<class UTexture2D>>     ReferencedPassThroughTextures;                     // 0x68(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1E8A[0x14];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1E8B[0x50];                                    // Fixing Size After Last Property..
	...
	TSoftObjectPtr<class UMutableMaskOutCache>   MaskOutCache;                                      // 0x300(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<uint64, struct FMutableStreamableBlock> HashToStreamableBlock;                             // 0x328(0x50)(NativeAccessSpecifierPublic)
	TArray<class FString>                        CustomizableObjectClassTags;                       // 0x378(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                        PopulationClassTags;                               // 0x388(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FString, struct FParameterTags>   CustomizableObjectParametersTags;                  // 0x398(0x50)(NativeAccessSpecifierPublic)
	class UMutableMaskOutCache*                  MaskOutCache_HardRef;                              // 0x3E8(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                 Identifier;                                        // 0x3F0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                 CompilationGuid;                                   // 0x400(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1E8C[0x10];                                    // Fixing Size After Last Property..
	class UCustomizableObjectBulk*               BulkData;                                          // 0x420(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1E8D[0x10];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObject");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("DGGUI");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_1EB2[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EB3[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EB4[0x68];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EB5[0x48];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EB6[0x48];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1EB7[0x8];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObjectInstance");
		return Clss;
	}
	...
	class FString GetTextureParameterSelectedOption(const class FString& TextureParamName, int32 RangeIndex);
...
public:
	...
	uint8                                        Pad_1EB8[0x20];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("MutableTextureMipDataProviderFactory");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObjectExtensionDataContainer");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableSystemImageProvider");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_1EB9[0xF8];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableObjectSystem");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_1EBC[0x2C];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableSkeletalComponent");
		return Clss;
	}
...
{
public:
	TArray<class UCustomizableSkeletalComponent*> CustomizableSkeletalComponents;                    // 0x308(0x10)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class USkeletalMeshComponent*>        SkeletalMeshComponents;                            // 0x318(0x10)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	class UCustomizableSkeletalComponent*        CustomizableSkeletalComponent;                     // 0x328(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CustomizableSkeletalMeshActor");
		return Clss;
	}
...
{
public:
	TMap<class FString, class UTexture2D*>       Textures;                                          // 0x28(0x50)(UObjectWrapper, NativeAccessSpecifierPrivate)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("DefaultImageProvider");
		return Clss;
	}
