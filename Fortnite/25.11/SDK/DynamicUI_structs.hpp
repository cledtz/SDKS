...
{
public:
	uint8                                        Pad_14A1[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_14A2[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_14A3[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_14A4[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_14A5[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	TWeakObjectPtr<class AActor>                 Instance;                                          // 0x28(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_14A6[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_14A7[0x40];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_14A9[0x3B];                                    // Fixing Size Of Struct..
};
