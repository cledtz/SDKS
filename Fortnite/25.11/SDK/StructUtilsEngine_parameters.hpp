...
public:
	...
	uint8                                        Pad_78B2[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78B3[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78B4[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_78B5[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78B6[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78B7[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_78B8[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FInstancedStruct                      B;                                                 // 0x10(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_78B9[0x7];                                     // Fixing Size Of Struct..
};
