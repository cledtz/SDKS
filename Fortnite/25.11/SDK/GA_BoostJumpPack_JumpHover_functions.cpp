...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "K2_CommitExecute");
...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "K2_CanActivateAbility");
...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "OnAbilityInputReleased");
...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "K2_ActivateAbility");
...
{
	static auto Func = Class->GetFunction("GA_BoostJumpPack_JumpHover_C", "ExecuteUbergraph_GA_BoostJumpPack_JumpHover");
