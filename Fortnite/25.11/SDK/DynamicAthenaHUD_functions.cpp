...
void ADynamicAthenaHUDDirector::HandleExitingVehicle()
{
	...
	Params::ADynamicAthenaHUDDirector_HandleExitingVehicle_Params Parms;
...
void ADynamicAthenaHUDDirector::HandleEnteringVehicle()
{
	...
	Params::ADynamicAthenaHUDDirector_HandleEnteringVehicle_Params Parms;
...
void ADynamicAthenaHUDDirector::HandleCreativeQuickbarEquippedChanged(bool bIsQuickbarEquipped)
{
	...
	Params::ADynamicAthenaHUDDirector_HandleCreativeQuickbarEquippedChanged_Params Parms;
