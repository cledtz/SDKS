...
{
public:
	uint8                                        Pad_17E9[0x8];                                     // Fixing Size After Last Property..
	float                                        MaxHealth;                                         // 0x318(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17EA[0x4];                                     // Fixing Size After Last Property..
	class UFortAbilitySystemComponent*           AbilitySystemComponent;                            // 0x320(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
