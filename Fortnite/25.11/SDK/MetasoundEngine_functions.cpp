...
// (Final, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// FInterfaceProperty_                NodeClass                                                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// enum class EMetaSoundBuilderResult OutResult                                                        (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FMetaSoundNodeHandle        ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct FMetaSoundNodeHandle UMetaSoundBuilderBase::AddNode(FInterfaceProperty_& NodeClass, enum class EMetaSoundBuilderResult* OutResult)
{
...
FInterfaceProperty_ UMetaSoundPatchBuilder::Build(class UObject* Parent, struct FMetaSoundBuilderOptions& Options)
{
...
FInterfaceProperty_ UMetaSoundSourceBuilder::Build(class UObject* Parent, struct FMetaSoundBuilderOptions& Options)
{
