...
void AGCN_Loop_GhostMode_C::FadeMaterialsTL__FinishedFunc()
{
	...
	Params::AGCN_Loop_GhostMode_C_FadeMaterialsTL__FinishedFunc_Params Parms;
...
void AGCN_Loop_GhostMode_C::FadeMaterialsTL__UpdateFunc()
{
	...
	Params::AGCN_Loop_GhostMode_C_FadeMaterialsTL__UpdateFunc_Params Parms;
...
void AGCN_Loop_GhostMode_C::OnRemoval(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCN_Loop_GhostMode_C::FadeMaterialsIn()
{
	...
	Params::AGCN_Loop_GhostMode_C_FadeMaterialsIn_Params Parms;
...
void AGCN_Loop_GhostMode_C::FadeMaterialsOut()
{
	...
	Params::AGCN_Loop_GhostMode_C_FadeMaterialsOut_Params Parms;
...
// FInterfaceProperty_                K2Node_DynamicCast_AsPawn_Highlight_Interface                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
