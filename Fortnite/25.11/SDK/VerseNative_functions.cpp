...
class UClass* UConcurrency::_L_2fVerse_2eorg_2fConcurrency_N_Rtask_L_Ntype_R(class UClass* __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Concurrency", "_L_2fVerse_2eorg_2fConcurrency_N_Rtask_L_Ntype_R");

	Params::UConcurrency__L_2fVerse_2eorg_2fConcurrency_N_Rtask_L_Ntype_R_Params Parms;
...
class UClass* UConcurrency::_L_2fVerse_2eorg_2fConcurrency_N_Rawaitable_L_Ntype_R(class UClass* __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Concurrency", "_L_2fVerse_2eorg_2fConcurrency_N_Rawaitable_L_Ntype_R");

	Params::UConcurrency__L_2fVerse_2eorg_2fConcurrency_N_Rawaitable_L_Ntype_R_Params Parms;
