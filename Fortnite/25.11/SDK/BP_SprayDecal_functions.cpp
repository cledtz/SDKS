...
// class AFortPlayerController*       InSpawningPlayerController                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_HasAuthority_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue_1                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_BooleanAND_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_SprayDecal_C::Initialize_Spray_Spawned_from_Gameplay(double InDecalSize, class UAthenaSprayItemDefinition* InSprayAsset, class AFortPlayerController* InSpawningPlayerController, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue)
{
	static auto Func = Class->GetFunction("BP_SprayDecal_C", "Initialize Spray Spawned from Gameplay");

	Params::ABP_SprayDecal_C_Initialize_Spray_Spawned_from_Gameplay_Params Parms;
...
void ABP_SprayDecal_C::OnRep_DecalFadeoutTime(bool CallFunc_Greater_DoubleDouble_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_SetFadeOut_Duration_ImplicitCast)
{
...
// class AFortPlayerController*       TestController                                                   (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
...
void ABP_SprayDecal_C::CreateDecalComponents(const struct FVector& CallFunc_MakeVector_ReturnValue, double CallFunc_GetRealTimeSeconds_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FTransform& Temp_struct_Variable, class UDecalComponent* CallFunc_AddComponent_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, bool CallFunc_ShouldUseBannerAsTexture_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, float CallFunc_SetScalarParameterValue_Value_ImplicitCast, float CallFunc_SetScalarParameterValue_Value_ImplicitCast_1)
{
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class ABuildingTrap*               Trap                                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class ABuildingTrap*               K2Node_CustomEvent_Trap                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
