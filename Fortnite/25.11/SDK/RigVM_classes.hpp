...
{
public:
	struct FRigVMGraphFunctionStore              GraphFunctionStore;                                // 0x380(0x20)(NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_38D8[0x20];                                    // Fixing Size After Last Property..
	struct FRigVMByteCode                        ByteCodeStorage;                                   // 0x60(0x90)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_38D9[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_38DB[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_38DC[0xE8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_38DD[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38DE[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38DF[0x28];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_38E0[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38E9[0x8];                                     // Fixing Size After Last Property..
	struct FRigVMRuntimeSettings                 VMRuntimeSettings;                                 // 0x30(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_38EA[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_38EB[0x18];                                    // Fixing Size After Last Property..
	TArray<class FName>                          EventQueue;                                        // 0x90(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_38EC[0x90];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_38ED[0x40];                                    // Fixing Size Of Struct..
