...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("VerseStruct");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VerseDigest");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_223F[0x4];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VerseEnum");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisCoroutineLibrary");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_2241[0x18];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GameFeature_SolarisObserver");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisMapLibrary");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisMathLibrary_Rational");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisMathLibrary_Float");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisMathLibrary_String");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisMathLibrary_Option");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("SolarisUtilLibrary");
		return Clss;
	}
...
{
public:
	uint32                                       SolClassFlags;                                     // 0x210(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_225D[0x4];                                     // Fixing Size After Last Property..
	TArray<TSubclassOf<class UObject>>           TaskClasses;                                       // 0x218(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TSet<TSubclassOf<class UObject>>             InterfaceClasses;                                  // 0x228(0x50)(UObjectWrapper, NativeAccessSpecifierPublic)
	TMap<class FName, FFieldPathProperty_>       InterfaceMethodFunctionProperties;                 // 0x278(0x50)(NativeAccessSpecifierPublic)
	class UFunction*                             InitInstanceFunction;                              // 0x2C8(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_225E[0x10];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VerseClass");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_225F[0x10];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VerseDebugData");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VerseDynamicallyTypedValueLibrary");
		return Clss;
	}
