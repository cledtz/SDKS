...
{
public:
	FMulticastInlineDelegateProperty_            OnSettingsChanged;                                 // 0x28(0x10)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnSettingsApplied;                                 // 0x38(0x10)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_21EF[0x20];                                    // Fixing Size After Last Property..
	struct FGameplayTag                          CurrentProfileIdentifier;                          // 0x68(0x4)(SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_21F0[0x4];                                     // Fixing Size After Last Property..
	TMap<struct FGameplayTag, class UEnhancedPlayerMappableKeyProfile*> SavedKeyProfiles;                                  // 0x70(0x50)(SaveGame, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class ULocalPlayer>           OwningLocalPlayer;                                 // 0xC0(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSet<class UInputMappingContext*>            RegisteredMappingContexts;                         // 0xC8(0x50)(Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_21F1[0x38];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        bEnableUserSettings : 1;                           // Mask: 0x1, PropSize: 0x10xD8(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bEnableDefaultMappingContexts : 1;                 // Mask: 0x2, PropSize: 0x10xD8(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bShouldOnlyTriggerLastActionInChord : 1;           // Mask: 0x4, PropSize: 0x10xD8(0x1)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bLogOnDeprecatedConfigUsed : 1;                    // Mask: 0x8, PropSize: 0x10xD8(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bEnableWorldSubsystem : 1;                         // Mask: 0x10, PropSize: 0x10xD8(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bShouldLogAllWorldSubsystemInputs : 1;             // Mask: 0x20, PropSize: 0x10xD8(0x1)(Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_21F2[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_21F9[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_220B[0x1F0];                                   // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_220D[0x1F0];                                   // Fixing Size After Last Property..
	...
	uint8                                        Pad_220E[0x10];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_220F[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_2210[0xA0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_2211[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2215[0x5];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_2216[0x30];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2217[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2218[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_221C[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_221E[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2220[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2225[0x7];                                     // Fixing Size After Last Property..
