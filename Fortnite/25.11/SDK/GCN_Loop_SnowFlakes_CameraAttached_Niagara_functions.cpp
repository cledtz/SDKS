...
void AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCN_Loop_SnowFlakes_CameraAttached_Niagara_C", "OnLoopingStartGeneric");

	Params::AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C_OnLoopingStartGeneric_Params Parms;
