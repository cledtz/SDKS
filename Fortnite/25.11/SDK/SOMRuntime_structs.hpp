...
{
public:
	uint8                                        Pad_7ED5[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7ED6[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7ED7[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7ED8[0x60];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7ED9[0x28];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7EDA[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EDB[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EDC[0xA];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7EDD[0x30];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7EDF[0x5];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EE0[0x60];                                    // Fixing Size Of Struct..
};
