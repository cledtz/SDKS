...
struct AGCNL_RollingEffects_Stone_C_OnRemovalGeneric_Params
{
public:
...
struct AGCNL_RollingEffects_Stone_C_OnLoopingStartGeneric_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_RollingEffects_Stone_C_ExecuteUbergraph_GCNL_RollingEffects_Stone_Params
{
public:
	...
	class AProp_PhysicsBoulder_Parent_C*         K2Node_DynamicCast_AsProp_Physics_Boulder_Parent;  // 0x100(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1CD4[0x7];                                     // Fixing Size After Last Property..
	...
	class AProp_PhysicsBoulder_Parent_C*         K2Node_DynamicCast_AsProp_Physics_Boulder_Parent_1; // 0x230(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
