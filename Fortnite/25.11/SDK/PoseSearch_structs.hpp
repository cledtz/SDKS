...
{
public:
	uint8                                        Pad_418C[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_418D[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_418E[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_418F[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	bool                                         bEnabled;                                          // 0x10(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4190[0x3];                                     // Fixing Size After Last Property..
	struct FFloatInterval                        SamplingRange;                                     // 0x14(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EPoseSearchMirrorOption           MirrorOption;                                      // 0x1C(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	bool                                         bEnabled;                                          // 0x10(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4191[0x3];                                     // Fixing Size After Last Property..
	struct FFloatInterval                        SamplingRange;                                     // 0x14(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EPoseSearchMirrorOption           MirrorOption;                                      // 0x1C(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_4192[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4194[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4195[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4196[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4197[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_4198[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_4199[0x228];                                   // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_419A[0x20];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_419B[0x2];                                     // Fixing Size After Last Property..
	...
	float                                        MaxAnimationDeltaTime;                             // 0x70(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        MaxActiveBlends;                                   // 0x74(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UBlendProfile*                         BlendProfile;                                      // 0x78(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EAlphaBlendOption                 BlendOption;                                       // 0x80(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_419C[0x7];                                     // Fixing Size After Last Property..
	struct FVector                               BlendParameters;                                   // 0x88(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMirrorDataTable*                      MirrorDataTable;                                   // 0xA0(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_419D[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_419E[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_419F[0xEE];                                    // Fixing Size After Last Property..
	TArray<class UPoseSearchDatabase*>           DatabasesToSearch;                                 // 0x180(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_41A0[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41A1[0x78];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_41A2[0x24];                                    // Fixing Size After Last Property..
	float                                        ElapsedPoseSearchTime;                             // 0x24(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        WantedPlayRate;                                    // 0x28(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bJumpedToPose;                                     // 0x2C(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_41A3[0x53];                                    // Fixing Size Of Struct..
};
