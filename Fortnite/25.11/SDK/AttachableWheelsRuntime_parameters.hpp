...
public:
	...
	uint8                                        Pad_8087[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8088[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8089[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_808A[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	class UPrimitiveComponent*                   InComponent;                                       // 0x0(0x8)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_808B[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	class AAttachableWheel*                      AttachedWheel;                                     // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_808E[0x7];                                     // Fixing Size Of Struct..
};
