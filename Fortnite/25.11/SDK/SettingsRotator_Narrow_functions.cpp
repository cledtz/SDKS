...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "BP_OnOptionsPopulated");
...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "BP_OnOptionSelected");
...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "BP_OnDefaultOptionSpecified");
...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "OnHover Animation");

	Params::USettingsRotator_Narrow_C_OnHover_Animation_Params Parms;
...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "OnUnHover Animation");

	Params::USettingsRotator_Narrow_C_OnUnHover_Animation_Params Parms;
...
{
	static auto Func = Class->GetFunction("SettingsRotator_Narrow_C", "ExecuteUbergraph_SettingsRotator_Narrow");
