...
{
public:
	uint8                                        Pad_3F71[0xC0];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3F7D[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F7E[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F7F[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3F80[0x70];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3F81[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3F82[0x198];                                   // Fixing Size Of Struct..
...
{
public:
	struct FMetaSoundFrontendDocumentBuilder     Builder;                                           // 0x28(0x20)(Protected, NativeAccessSpecifierProtected)
	...
	struct FMetaSoundNodeHandle AddNode(FInterfaceProperty_& NodeClass, enum class EMetaSoundBuilderResult* OutResult);
...
public:
	...
	FInterfaceProperty_ Build(class UObject* Parent, struct FMetaSoundBuilderOptions& Options);
};
...
{
public:
	uint8                                        Pad_3FAE[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3FBF[0x70];                                    // Fixing Size After Last Property..
	struct FMetasoundFrontendDocument            RootMetaSoundDocument;                             // 0x510(0x1B8)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                          ReferencedAssetClassKeys;                          // 0x6C8(0x50)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                         ReferencedAssetClassObjects;                       // 0x718(0x50)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                 ReferenceAssetClassCache;                          // 0x768(0x50)(Protected, NativeAccessSpecifierProtected)
	enum class EMetaSoundOutputAudioFormat       OutputFormat;                                      // 0x7B8(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3FC0[0x3];                                     // Fixing Size After Last Property..
	struct FGuid                                 AssetClassID;                                      // 0x7BC(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3FC1[0xC4];                                    // Fixing Size Of Struct..
