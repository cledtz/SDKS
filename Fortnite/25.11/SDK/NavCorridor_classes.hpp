...
public:
	...
	uint8                                        Pad_4152[0x2];                                     // Fixing Size After Last Property..
	...
	class AActor*                                GoalActor;                                         // 0x5F8(0x8)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ANavigationData*                       NavData;                                           // 0x600(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_4153[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4154[0xA0];                                    // Fixing Size Of Struct..
...
{
public:
	class UNavCorridorTestingComponent*          DebugComp;                                         // 0x288(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
