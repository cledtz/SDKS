...
public:
	...
	class APlayerPawn_Athena_C*                  PlayerPawnAthena;                                  // 0x968(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
