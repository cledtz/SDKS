...
public:
	...
	class AFortAIPawn*                           FortAIPawnCached;                                  // 0xB38(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_41AC[0x4];                                     // Fixing Size After Last Property..
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GA_NPC_Irwin_Prey_Burt_Charge_RidingHelper_C");
		return Clss;
	}
