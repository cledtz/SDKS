...
{
	static auto Func = Class->GetFunction("AnimNotifyState_SyncPettingCreature_C", "Received_NotifyEnd");
...
{
	static auto Func = Class->GetFunction("AnimNotifyState_SyncPettingCreature_C", "Received_NotifyBegin");
