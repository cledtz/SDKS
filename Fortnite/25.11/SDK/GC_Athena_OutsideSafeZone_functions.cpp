...
void AGC_Athena_OutsideSafeZone_C::OnStormEffectsEnabled(bool bEnabled)
{
	...
	Params::AGC_Athena_OutsideSafeZone_C_OnStormEffectsEnabled_Params Parms;
...
void AGC_Athena_OutsideSafeZone_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GC_Athena_OutsideSafeZone_C", "OnLoopingStartGeneric");

	Params::AGC_Athena_OutsideSafeZone_C_OnLoopingStartGeneric_Params Parms;
...
void AGC_Athena_OutsideSafeZone_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GC_Athena_OutsideSafeZone_C", "OnRemovalGeneric");

	Params::AGC_Athena_OutsideSafeZone_C_OnRemovalGeneric_Params Parms;
