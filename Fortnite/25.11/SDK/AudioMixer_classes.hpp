...
{
public:
	uint8                                        Pad_1C0E[0x60];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("AudioBusSubsystem");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_1C10[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1C11[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1C12[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1C13[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1C14[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1C15[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_1C2D[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        BitPad_1C2 : 4;                                    // Fixing Bit-Field Size..
	...
	uint8                                        BitPad_1C3 : 5;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_1C39[0x3];                                     // Fixing Size After Last Property..
	...
	struct FSoundModulationDefaultRoutingSettings ModulationRouting;                                 // 0x6D8(0x188)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class USoundClass*                           SoundClass;                                        // 0x860(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundEffectSourcePresetChain*         SourceEffectChain;                                 // 0x868(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class USoundSubmixBase*                      SoundSubmix;                                       // 0x870(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSoundSubmixSendInfo>          SoundSubmixSends;                                  // 0x878(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FSoundSourceBusSendInfo>       BusSends;                                          // 0x888(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FSoundSourceBusSendInfo>       PreEffectBusSends;                                 // 0x898(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        bIsUISound : 1;                                    // Mask: 0x1, PropSize: 0x10x8A8(0x1)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bIsPreviewSound : 1;                               // Mask: 0x2, PropSize: 0x10x8A8(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_1C4 : 6;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_1C3A[0x3];                                     // Fixing Size After Last Property..
	int32                                        EnvelopeFollowerAttackTime;                        // 0x8AC(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        EnvelopeFollowerReleaseTime;                       // 0x8B0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C3B[0x4];                                     // Fixing Size After Last Property..
	FMulticastInlineDelegateProperty_            OnAudioEnvelopeValue;                              // 0x8B8(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C3C[0x20];                                    // Fixing Size After Last Property..
	class USynthSound*                           Synth;                                             // 0x8E8(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAudioComponent*                       AudioComponent;                                    // 0x8F0(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1C3D[0x28];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1C3E[0x88];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1C3F[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1C40[0x68];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1C41[0x80];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1C5D[0x1C0];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_1C6C[0x20];                                    // Fixing Size Of Struct..
