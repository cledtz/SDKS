...
{
public:
	uint8                                        Pad_16B5[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16B6[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16B7[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_16BA[0x20];                                    // Fixing Size Of Struct..
};
