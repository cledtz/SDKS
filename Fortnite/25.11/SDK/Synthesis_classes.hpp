...
public:
	...
	uint8                                        Pad_371B[0x3];                                     // Fixing Size After Last Property..
...
{
public:
	int32                                        VoiceCount;                                        // 0x920(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3724[0x6CC];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3725[0xF8];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3726[0x280];                                   // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3727[0x3E];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3728[0x50];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3729[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_372A[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_372B[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_372C[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_372D[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_372E[0x30];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_372F[0xA0];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3730[0x30];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3731[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3732[0x48];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3733[0x40];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3734[0x4C];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_3735[0x30];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3736[0x5E];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3737[0x34];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3738[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3739[0x34];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_373A[0x38];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_373B[0x60];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_373C[0x4C];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_373D[0x30];                                    // Fixing Size After Last Property..
...
{
public:
	class USoundWave*                            GranulatedSoundWave;                               // 0x920(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3746[0x3D8];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        BitPad_22A : 7;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_3748[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3749[0x117];                                   // Fixing Size Of Struct..
...
{
public:
	FMulticastInlineDelegateProperty_            OnTableAltered;                                    // 0x920(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnNumTablesChanged;                                // 0x930(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UMonoWaveTableSynthPreset*             CurrentPreset;                                     // 0x940(0x8)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_374F[0x728];                                   // Fixing Size Of Struct..
...
{
public:
	float                                        Frequency;                                         // 0x920(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Volume;                                            // 0x924(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                    DistanceAttenuationCurve;                          // 0x928(0x88)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector2D                             DistanceRange;                                     // 0x9B0(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        AttenuationDbAtMaxRange;                           // 0x9C0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3750[0x4C];                                    // Fixing Size Of Struct..
...
{
public:
	class USoundWave*                            SoundWave;                                         // 0x920(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnSampleLoaded;                                    // 0x928(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnSamplePlaybackProgress;                          // 0x938(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_3752[0x108];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3753[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3754[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3756[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        BitPad_22B : 7;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_3758[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3759[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_375A[0x18];                                    // Fixing Size Of Struct..
