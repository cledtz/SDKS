...
public:
	...
	uint8                                        Pad_26FC[0x3];                                     // Fixing Size After Last Property..
	class UTimelineComponent*                    Floor_Visibility;                                  // 0x370(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UTimelineComponent*                    Background_Effects;                                // 0x380(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
