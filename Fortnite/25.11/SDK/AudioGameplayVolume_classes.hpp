...
public:
	...
	uint8                                        Pad_14B8[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	class UAudioGameplayVolumeComponent*         AGVComponent;                                      // 0x2C0(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bEnabled;                                          // 0x2C8(0x1)(Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_14B9[0x7];                                     // Fixing Size After Last Property..
	FMulticastInlineDelegateProperty_            OnListenerEnterEvent;                              // 0x2D0(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnListenerExitEvent;                               // 0x2E0(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_14BA[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_14BB[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_14BD[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_14BE[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_14BF[0xD0];                                    // Fixing Size Of Struct..
