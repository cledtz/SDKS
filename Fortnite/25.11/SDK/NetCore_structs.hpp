...
{
public:
	uint8                                        Pad_16A2[0x54];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_16A3[0xA8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_16A4[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	class FName                                  DataName;                                          // 0x0(0x4)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bEnabled;                                          // 0x4(0x1)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_16A5[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_16A7[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_16A8[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_16AA[0x6];                                     // Fixing Size Of Struct..
};
