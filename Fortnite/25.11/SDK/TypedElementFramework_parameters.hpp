...
public:
	...
	uint8                                        Pad_159C[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	struct FScriptTypedElementHandle             RHS;                                               // 0x8(0x8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x10(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_159D[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_159F[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x18(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_15A3[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_15AA[0x6];                                     // Fixing Size Of Struct..
};
...
public:
	struct FScriptTypedElementHandle             InElementHandle;                                   // 0x0(0x8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_15AB[0x7];                                     // Fixing Size Of Struct..
};
