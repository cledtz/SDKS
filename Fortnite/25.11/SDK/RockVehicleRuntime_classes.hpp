...
public:
	...
	uint8                                        BitPad_442 : 5;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_8385[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8388[0x78];                                    // Fixing Size After Last Property..
	...
	class AFortVehicleAudioController*           CachedVehicleAudioController;                      // 0x1BB0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_8389[0xA0];                                    // Fixing Size Of Struct..
...
{
public:
	class ARockVehicle*                          Vehicle;                                           // 0xA0(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_838C[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_838D[0x1];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_838E[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_838F[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_8390[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_8391[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_8392[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8393[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_8394[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_8395[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_8396[0x18];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8398[0xF];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_8399[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_839A[0x18];                                    // Fixing Size After Last Property..
	struct FRockScalableFloat                    JumpVelocity;                                      // 0x120(0x30)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_839B[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_839C[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_839D[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_839E[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83A5[0x8];                                     // Fixing Size After Last Property..
	struct FRockVehicleAnalyticsSession          CurrentSession;                                    // 0xA8(0x28)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
	class ARockVehicle*                          Vehicle;                                           // 0xD0(0x8)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	void OnPawnExitedSeat(FInterfaceProperty_& InVehicle, class AFortPawn* InPlayerPawn, int32 InSeatIndex);
	void OnPawnEnteredSeat(FInterfaceProperty_& InVehicle, class AFortPawn* InPlayerPawn, int32 InSeatIndex);
...
public:
	...
	uint8                                        Pad_83A6[0x128];                                   // Fixing Size Of Struct..
...
{
public:
	struct FRuntimeFloatCurve                    SideSpeedToSkidVolume;                             // 0x2E8(0x88)(Edit, NativeAccessSpecifierPublic)
	float                                        SurfaceTypeInterpSpeed;                            // 0x370(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_83A7[0x4];                                     // Fixing Size After Last Property..
	class UAudioComponent*                       TireSurfaceComponent;                              // 0x378(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAudioComponent*                       AirLoopComponent;                                  // 0x380(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAudioComponent*                       SuperSonicComponent;                               // 0x388(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bInWater;                                          // 0x390(0x1)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_83A8[0x7];                                     // Fixing Size After Last Property..
	class UAudioMotorModelComponent*             MotorModel;                                        // 0x398(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ARockVehicle*                          CachedVehicle;                                     // 0x3A0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_83A9[0x30];                                    // Fixing Size Of Struct..
...
public:
	...
	class ARockVehicle*                          VehicleTarget;                                     // 0x1C30(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_83AC[0x100];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_83AD[0x10];                                    // Fixing Size After Last Property..
	TArray<class ARockVehicle*>                  RockVehicles;                                      // 0x298(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
{
public:
	class ARockVehicleManager*                   VehicleManager;                                    // 0x30(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
