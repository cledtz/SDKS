...
public:
	...
	uint8                                        Pad_1433[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1434[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_1435[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1437[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1438[0x14];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_194 : 7;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_1439[0x7];                                     // Fixing Size After Last Property..
	struct FSoundModulationTransform             Transform;                                         // 0x8(0xA8)(Edit, NativeAccessSpecifierPublic)
	class USoundControlBus*                      Bus;                                               // 0xB0(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	bool                                         bBypass;                                           // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_143A[0x7];                                     // Fixing Size After Last Property..
