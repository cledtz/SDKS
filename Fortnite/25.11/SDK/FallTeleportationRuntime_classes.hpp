...
{
public:
	TSoftClassPtr<class AActor>                  PlayerPawnReceiverClass;                           // 0xA0(0x28)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_8240[0x30];                                    // Fixing Size Of Struct..
...
public:
	...
	TArray<TSubclassOf<class AActor>>            TeleportOnBlocklist;                               // 0x150(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_8244[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8245[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8246[0x4];                                     // Fixing Size After Last Property..
	class AFortPlayerPawnAthena*                 OwningPawn;                                        // 0x1C8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_8247[0x20];                                    // Fixing Size Of Struct..
	...
	void UpdateLastGroundLocation(class ACharacter* Character, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode);
	bool IsValidActorToTeleportOn(class AActor* ActorToTeleportOn);
