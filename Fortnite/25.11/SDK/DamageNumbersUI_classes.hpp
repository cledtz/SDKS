...
{
public:
	uint8                                        Pad_1656[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1657[0x4];                                     // Fixing Size After Last Property..
	...
	class AActor*                                HitActor;                                          // 0x340(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_1658[0x1];                                     // Fixing Size After Last Property..
	...
	void Reset();
	void OnDamageDealt(double InDamage, class AActor* InActor, bool bInShield, bool bInCrit, const struct FVector& InWorldSpacePos);
};
...
public:
	...
	uint8                                        Pad_165B[0x4];                                     // Fixing Size After Last Property..
	...
	class AFortPlayerPawn*                       BoundPawn;                                         // 0x300(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
