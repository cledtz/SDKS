...
{
public:
	class UMusicSequencerHitComponent*           MusicSequencerHitComponent;                        // 0x288(0x8)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
