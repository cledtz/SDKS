...
public:
	...
	uint8                                        Pad_2261[0x6];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_2262[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2263[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2264[0x1];                                     // Fixing Size Of Struct..
};
