...
void UCreatureBaseRidableComponent_C::IsSwimming(bool* IsSwimming, class AActor* CallFunc_GetOwner_ReturnValue, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsSurfaceSwimming_ReturnValue)
{
...
void UCreatureBaseRidableComponent_C::ApplyCollisionResponse(TArray<enum class ECollisionChannel>& Channels, enum class ECollisionResponse Response, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, enum class ECollisionChannel CallFunc_Array_Get_Item, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UCapsuleComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, enum class ECollisionResponse CallFunc_GetCollisionResponseToChannel_ReturnValue)
{
...
void UCreatureBaseRidableComponent_C::UpdateAnimInputBool(class AFortPawn* FortPawn, bool IsBeingRidden, class UFortAnimInputEvent_Bool* CallFunc_CreateAnimInputEvent_Bool_ReturnValue)
{
