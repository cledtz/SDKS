...
{
public:
	uint8                                        Pad_15E1[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_15E2[0x10];                                    // Fixing Size After Last Property..
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_15E3[0x90];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_15E9[0x18];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_15EB[0x18];                                    // Fixing Size Of Struct..
};
