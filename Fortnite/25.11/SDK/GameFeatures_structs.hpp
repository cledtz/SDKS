...
{
public:
	uint8                                        Pad_1DC9[0x88];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_1DCA[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1DCB[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1DCC[0x20];                                    // Fixing Size Of Struct..
};
