...
public:
	...
	struct FGameplayTag                          TacticalSprintTag;                                 // 0x968(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9A9A[0x4];                                     // Fixing Size After Last Property..
	class UFXSystemComponent*                    MainNS;                                            // 0x970(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
