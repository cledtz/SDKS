...
{
	static auto Func = Class->GetFunction("GA_Riding_Creature_IsBeingRidden_Passive_C", "K2_ActivateAbility");
...
{
	static auto Func = Class->GetFunction("GA_Riding_Creature_IsBeingRidden_Passive_C", "K2_OnEndAbility");
...
{
	static auto Func = Class->GetFunction("GA_Riding_Creature_IsBeingRidden_Passive_C", "FailedToActivatePassiveAbility");
...
{
	static auto Func = Class->GetFunction("GA_Riding_Creature_IsBeingRidden_Passive_C", "ExecuteUbergraph_GA_Riding_Creature_IsBeingRidden_Passive");
