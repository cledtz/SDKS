...
public:
	...
	void ZapFX(int32 ZapCount, class APlayerPawn_Athena_C* PlayerPawnAthena, double CallFunc_Conv_IntToDouble_ReturnValue, bool CallFunc_IsActive_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_SetFloatParameter_Param_ImplicitCast);
