...
public:
	...
	uint8                                        Pad_7B07[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7B08[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	class AFortSphericalVehicle*                 AsFortSphericalVehicle;                            // 0x438(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_7B0A[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7B0B[0xFC];                                    // Fixing Size Of Struct..
...
{
public:
	class FName                                  SpeedParamName;                                    // 0x960(0x4)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                  IsFallingParamName;                                // 0x964(0x4)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGoopAudioMapRangeClamped             SpeedMapRangeClamped;                              // 0x968(0x20)(Edit, DisableEditOnInstance, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                        InterpSpeed;                                       // 0x988(0x4)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7B0C[0x4];                                     // Fixing Size After Last Property..
	class UAudioComponent*                       LoopingAudioComponent;                             // 0x990(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7B0D[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	void UpdatePropIndexEventState(class AActor* ContextActor, struct FPaddleGingerPropData& Payload);
	void UpdatePropActivatedEventState(class AActor* ContextActor, struct FPaddleGingerPropActivatedData& Payload);
	void ClearPropIndexEventState(class AActor* ContextActor);
	void ClearPropActivatedEventState(class AActor* ContextActor);
};
...
{
public:
	class AFortPawn*                             Pawn;                                              // 0x960(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortWeaponFxComponent_ChargeAimLocation* CachedAimLocationComponent;                        // 0x968(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                               FoundEndPoint;                                     // 0x970(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                        MinHitDistance;                                    // 0x988(0x28)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                        HitObjectsLimit;                                   // 0x9B0(0x28)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7B12[0x4];                                     // Fixing Size After Last Property..
	enum class ECollisionChannel                 TraceChannel;                                      // 0x9DC(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7B13[0xB];                                     // Fixing Size Of Struct..
