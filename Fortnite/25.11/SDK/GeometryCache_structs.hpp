...
{
public:
	uint8                                        Pad_2756[0xC0];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2757[0xC];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2758[0x9];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_2759[0xC8];                                    // Fixing Size Of Struct..
};
