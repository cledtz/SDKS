...
struct ABP_VendAISpawner_Base_C_ReceiveBeginPlay_Params
{
public:
};
...
public:
	...
	uint8                                        Pad_3E1F[0x2];                                     // Fixing Size After Last Property..
	FDelegateProperty_                           Temp_delegate_Variable;                            // 0x8(0xC)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3E20[0xC];                                     // Fixing Size After Last Property..
	struct FTransform                            CallFunc_GetTransform_ReturnValue;                 // 0x20(0x60)(ConstParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AFortGameStateAthena*                  CallFunc_GetGameStateAthenaFromContext_ReturnValue; // 0x80(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3E21[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3E22[0x3];                                     // Fixing Size After Last Property..
