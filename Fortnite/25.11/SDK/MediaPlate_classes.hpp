...
{
public:
	class UMediaPlateComponent*                  MediaPlateComponent;                               // 0x288(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("MediaPlate");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_8771[0x10];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("MediaPlateAssetUserData");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_8774[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8775[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8776[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8777[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8778[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8779[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_877A[0x38];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("MediaPlateComponent");
		return Clss;
	}
