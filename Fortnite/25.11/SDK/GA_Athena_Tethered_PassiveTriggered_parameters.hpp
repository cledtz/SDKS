...
public:
	...
	uint8                                        Pad_92D2[0x4];                                     // Fixing Size After Last Property..
	...
	class AActor*                                CallFunc_GetOwningActorFromActorInfo_ReturnValue;  // 0x240(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
