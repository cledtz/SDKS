...
void UPropManipulationNativeComponent::SetControlledObjectsVisibilityAndCollision(const TArray<class ABuildingSMActor*>& InObjectsOfControl, bool InNewVisibility)
{
