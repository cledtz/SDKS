...
public:
	...
	uint8                                        Pad_7B6B[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7B6D[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	class UMotoSynthPreset*                      MotoSynthPreset;                                   // 0x920(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        RPM;                                               // 0x928(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7B6E[0x194];                                   // Fixing Size Of Struct..
