...
{
public:
	uint8                                        Pad_21DC[0x28];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_21DD[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_21DE[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_21DF[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_21E0[0x8];                                     // Fixing Size Of Struct..
