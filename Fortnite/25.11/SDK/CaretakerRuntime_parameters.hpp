...
{
public:
	class ACharacter*                            CharacterOwner;                                    // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2116[0x6];                                     // Fixing Size Of Struct..
};
