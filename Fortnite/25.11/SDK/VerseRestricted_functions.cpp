...
class UClass* URestricted::_L_2fVerse_2eorg_2fRestricted_N_Rsticky__event_L_Ntype_R(class UClass* __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Restricted", "_L_2fVerse_2eorg_2fRestricted_N_Rsticky__event_L_Ntype_R");

	Params::URestricted__L_2fVerse_2eorg_2fRestricted_N_Rsticky__event_L_Ntype_R_Params Parms;
