...
public:
	...
	uint8                                        Pad_7FA6[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7FA8[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	FOptionProperty_                             __verse_0x459049A1_Target;                         // 0x0(0x8)(ZeroConstructor, InstancedReference, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
	struct FSpatialMath_vector3                  __verse_0x4A328DE2_LastKnownPosition;              // 0x8(0x18)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor)
	uint8                                        __verse_0xAC2B8860_HasLineOfSight : 1;             // Mask: 0x1, PropSize: 0x10x20(0x1)(InstancedReference, NoDestructor, HasGetValueTypeHash)
	uint8                                        BitPad_425 : 7;                                    // Fixing Bit-Field Size..
	uint8                                        __verse_0xABBA0802_IsThreatening : 1;              // Mask: 0x1, PropSize: 0x10x21(0x1)(InstancedReference, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7FA9[0xE];                                     // Fixing Size Of Struct..
};
