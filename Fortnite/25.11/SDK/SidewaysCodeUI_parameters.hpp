...
public:
	...
	class ASidewaysPlayspace*                    NewPlayspace;                                      // 0x8(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_7F0A[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	class ASidewaysPlayspace*                    Playspace;                                         // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_7F0B[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	class AFortPawn*                             PossessedPawn;                                     // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
