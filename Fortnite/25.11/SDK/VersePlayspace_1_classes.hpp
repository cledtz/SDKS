...
public:
	...
	FVerseFunctionProperty_                      __verse_0x771372C6__L_2fUnrealEngine_2ecom_2fPlayspace_2fplayspace__component_N_RSetPlayerComponentClass_L_Ntype_R; // 0xE0(0x10)(InstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_8A49[0x50];                                    // Fixing Size Of Struct..
