...
public:
	...
	uint8                                        Pad_235F[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_2360[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_2362[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_2363[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint32                                       ChannelId;                                         // 0x50(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                       InstanceID;                                        // 0x54(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2365[0x8];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_2366[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2367[0x8];                                     // Fixing Size Of Struct..
};
