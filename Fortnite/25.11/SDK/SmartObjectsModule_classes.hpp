...
public:
	...
	uint8                                        Pad_40EA[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_40EB[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	class USmartObjectComponent*                 SOComponent;                                       // 0x288(0x8)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoClear, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	struct FBox                                  Bounds;                                            // 0x288(0x38)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FSmartObjectCollectionEntry>   CollectionEntries;                                 // 0x2C0(0x10)(Edit, ZeroConstructor, EditConst, Protected, NativeAccessSpecifierProtected)
	TMap<struct FSmartObjectHandle, struct FSoftObjectPath> RegisteredIdToObjectMap;                           // 0x2D0(0x50)(Protected, NativeAccessSpecifierProtected)
	TArray<class USmartObjectDefinition*>        Definitions;                                       // 0x320(0x10)(Edit, ZeroConstructor, EditConst, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_40F8[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_40F9[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_40FA[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_40FB[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_40FC[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_40FD[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_40FE[0x6];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_40FF[0xA8];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4100[0xC8];                                    // Fixing Size Of Struct..
...
{
public:
	struct FSmartObjectContainer                 SmartObjectContainer;                              // 0x288(0xB0)(Edit, EditConst, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_4101[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4102[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	class ASmartObjectSubsystemRenderingActor*   RenderingActor;                                    // 0x58(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_4111[0x20];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4112[0x10];                                    // Fixing Size After Last Property..
	TArray<class USmartObjectComponent*>         RegisteredSOComponents;                            // 0x1E0(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class USmartObjectComponent*>         PendingSmartObjectRegistration;                    // 0x1F0(0x10)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_4113[0x8];                                     // Fixing Size Of Struct..
	...
	bool FindSmartObjects_BP(struct FSmartObjectRequest& Request, TArray<struct FSmartObjectRequestResult>* OutResults, class AActor* UserActor);
	bool FindSmartObjects(struct FSmartObjectRequest& Request, TArray<struct FSmartObjectRequestResult>* OutResults, class AActor* UserActor);
	struct FSmartObjectRequestResult FindSmartObject(struct FSmartObjectRequest& Request, class AActor* UserActor);
	struct FSmartObjectClaimHandle Claim(struct FSmartObjectRequestResult& RequestResult, class AActor* UserActor);
...
{
public:
	class USmartObjectSubsystemRenderingComponent* RenderingComponent;                                // 0x288(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	TArray<class USmartObjectTest*>              Tests;                                             // 0x288(0x10)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class USmartObjectTestRenderingComponent*    RenderingComponent;                                // 0x298(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USmartObjectSubsystem*                 SmartObjectSubsystem;                              // 0x2A0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bRunTestsEachFrame;                                // 0x2A8(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_4114[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4115[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_4116[0x28];                                    // Fixing Size Of Struct..
