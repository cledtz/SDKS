...
public:
	...
	struct FFluidForceDynamic                    BoatForceSettings;                                 // 0x570(0x70)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash)
	struct FFluidForceDynamic                    PlayerForceSettings;                               // 0x5E0(0x70)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash)
	struct FFluidForceDynamic                    MechForceSettings;                                 // 0x650(0x70)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash)
	TArray<class AFortPawn*>                     RelevantFortPawns;                                 // 0x6C0(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance)
	bool                                         Use_FN_Pawn_Forces;                                // 0x6D0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9D84[0x7];                                     // Fixing Size After Last Property..
	TMap<struct FGameplayTag, struct FFluidForceDynamic> VehicleTypeMap;                                    // 0x6D8(0x50)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
