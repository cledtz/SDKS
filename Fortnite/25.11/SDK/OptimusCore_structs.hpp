...
public:
	...
	uint8                                        Pad_1F76[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1F77[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F78[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F79[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F7A[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F7C[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F7D[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F7E[0x30];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F7F[0x30];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F80[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F81[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F82[0x90];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F83[0x38];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F84[0x98];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F85[0x30];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F86[0x78];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F87[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F88[0x18];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F89[0x88];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8A[0x88];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8B[0x48];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8C[0x28];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8D[0x90];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8E[0x48];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F8F[0x50];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F90[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F91[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F92[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F93[0x88];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F94[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F95[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F96[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1F97[0x20];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F98[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F9C[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_1F9D[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_1F9E[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F9F[0x4];                                     // Fixing Size After Last Property..
