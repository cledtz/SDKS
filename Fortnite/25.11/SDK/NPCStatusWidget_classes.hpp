...
public:
	...
	uint8                                        Pad_8FA4[0x7];                                     // Fixing Size After Last Property..
	class AFortPawn*                             FortPawn;                                          // 0x3E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
