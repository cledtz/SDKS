...
void AFrontendCamera_Main_C::BP_OnActivated(class AFortPlayerController* PlayerController)
{
	...
	Params::AFrontendCamera_Main_C_BP_OnActivated_Params Parms;
