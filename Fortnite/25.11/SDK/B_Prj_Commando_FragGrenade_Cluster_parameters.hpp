...
public:
	...
	uint8                                        Pad_9452[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_9454[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9455[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9457[0x4];                                     // Fixing Size After Last Property..
	class UDamageType*                           K2Node_Event_DamageType;                           // 0x1C8(0x8)(ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AController*                           K2Node_Event_InstigatedBy;                         // 0x1D0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AActor*                                K2Node_Event_DamageCauser;                         // 0x1D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_IsClosed_Variable_1;                     // 0x1E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9458[0x7];                                     // Fixing Size After Last Property..
	TArray<class AActor*>                        K2Node_Event_HitActors;                            // 0x1E8(0x10)(ConstParm, ReferenceParm)
