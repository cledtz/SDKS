...
{
public:
	uint8                                        Pad_38A5[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_38A6[0x88];                                    // Fixing Size After Last Property..
	class USoundSubmixBase*                      DefaultSubmix;                                     // 0x130(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class USoundSubmixBase*                      LicensedSubmix;                                    // 0x138(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMediaSoundComponent*                  MediaSoundComponent;                               // 0x140(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
