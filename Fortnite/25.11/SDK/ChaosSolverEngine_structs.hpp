...
public:
	...
	uint8                                        Pad_1A0D[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1A0F[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1A10[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1A11[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1A12[0x40];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1A13[0x8];                                     // Fixing Size After Last Property..
