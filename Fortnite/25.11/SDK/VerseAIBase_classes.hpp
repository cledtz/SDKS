...
{
public:
	uint8                                        Pad_3DCF[0x40];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3DD0[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3DD1[0x20];                                    // Fixing Size Of Struct..
...
public:
	...
	TArray<class AFortPawn*>                     SpawnedList;                                       // 0xBE0(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	TSoftObjectPtr<class UEnvQuery>              SpawnEQSQuery;                                     // 0xC08(0x28)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3DD4[0x20];                                    // Fixing Size Of Struct..
