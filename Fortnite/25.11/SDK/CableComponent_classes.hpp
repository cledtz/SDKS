...
{
public:
	class UCableComponent*                       CableComponent;                                    // 0x288(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_3FC7[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FC8[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3FCB[0x18];                                    // Fixing Size Of Struct..
