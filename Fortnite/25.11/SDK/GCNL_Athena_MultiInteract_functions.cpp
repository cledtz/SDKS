...
void AGCNL_Athena_MultiInteract_C::OnApplicationGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCNL_Athena_MultiInteract_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCNL_Athena_MultiInteract_C::CheckTargetProgress()
{
	...
	Params::AGCNL_Athena_MultiInteract_C_CheckTargetProgress_Params Parms;
...
void AGCNL_Athena_MultiInteract_C::OnActorCountChanged(int32 InteractingActorCount, float MultiInteractMultiplier, float InteractingDuration)
{
	...
	Params::AGCNL_Athena_MultiInteract_C_OnActorCountChanged_Params Parms;
