...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Orphaned");

	Params::ANPC_Pawn_Parent_C_Orphaned_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TryShowHealthBar");

	Params::ANPC_Pawn_Parent_C_TryShowHealthBar_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnRep_NPC Death Time");

	Params::ANPC_Pawn_Parent_C_OnRep_NPC_Death_Time_Params Parms;
...
void ANPC_Pawn_Parent_C::PlayStateChangeAudio(enum class Enum_NPC_AlertLevel Index)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "PlayStateChangeAudio");

	Params::ANPC_Pawn_Parent_C_PlayStateChangeAudio_Params Parms;
...
void ANPC_Pawn_Parent_C::IsConverted(bool* IsConverted, class UFortPawnComponent_Convert* CallFunc_GetComponentByClass_ReturnValue, class AFortPlayerPawn* CallFunc_GetConverterPawn_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "IsConverted");

	Params::ANPC_Pawn_Parent_C_IsConverted_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC GhostCollisionSettings");

	Params::ANPC_Pawn_Parent_C_NPC_GhostCollisionSettings_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "CanUpdateSoundLib");

	Params::ANPC_Pawn_Parent_C_CanUpdateSoundLib_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "PlayAdditiveHitReacts");

	Params::ANPC_Pawn_Parent_C_PlayAdditiveHitReacts_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC DamageRemovesIdlePhaseTagGE");

	Params::ANPC_Pawn_Parent_C_NPC_DamageRemovesIdlePhaseTagGE_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "GetSoundFoleyLibrary");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC CanBeInteractedWith");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC CheckForDespawnIfStaleToPlayers");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC SetCanDropLoot");
...
void ANPC_Pawn_Parent_C::NPC_GetSafeZonePhase(int32* SafeZonePhase, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class AAthena_GameState_C* K2Node_DynamicCast_AsAthena_Game_State, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_GetSafeZonePhase_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC GetSafeZonePhase");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnRep_NPC Leader");
...
void ANPC_Pawn_Parent_C::Play_Water_Splash_at_Water_Surface(class AFortWaterBodyActor* Water_Body, bool Enter_Water, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, bool Temp_bool_Variable, const struct FWaterSurfaceInfo& CallFunc_GetWaterSurfaceInfoStruct_OutWaterSurfaceInfo, double CallFunc_Conv_IntToDouble_ReturnValue, const struct FGameplayCueParameters& CallFunc_MakeGameplayCueParameters_ReturnValue, const struct FGameplayTag& K2Node_Select_Default, float CallFunc_MakeGameplayCueParameters_NormalizedMagnitude_ImplicitCast)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Play Water Splash at Water Surface");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ResetMaterialFromDeath");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnRep_SelectedPrimitiveDataFloat");

	Params::ANPC_Pawn_Parent_C_OnRep_SelectedPrimitiveDataFloat_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "CheckSoundLibraryRemoved");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "CheckSoundLibraryAdded");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "UpdateSoundLibrary");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ClearOutTargetSlots");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC UpdateInteract");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC HasLeader?");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC SetLeader");
...
void ANPC_Pawn_Parent_C::NPC_AttemptToSetLeader(class AActor* PossibleLeader, enum class EUnconvertReason UnconvertReason, bool CallFunc_NPC_SetLeader_Success_, class AActor* CallFunc_NPC_SetLeader_LeaderSet)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC AttemptToSetLeader");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "SetPrimitiveDataFloat");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "SelectPrimitiveDataFloat");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "StoreOriginalGravityAndRotation");

	Params::ANPC_Pawn_Parent_C_StoreOriginalGravityAndRotation_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC DisableIntroPhaseBehavior");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC DamageAttemptDisableIntroPhaseBehavior");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC TargetSlotIsUsingOverride");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC TargetSlotInfo");
...
// class AAthena_GameState_C*         K2Node_DynamicCast_AsAthena_Game_State                           (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortSafeZoneIndicator*      CallFunc_GetSafeZoneIndicator_ReturnValue                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC CheckIsInSafeZone");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC HandleAlertLevelVoice");
...
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// FInterfaceProperty_                CallFunc_GiveItemEntryToInventoryOwner_InventoryOwner_CastInput  (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ApplyGameplayEffectWithMMRScaling");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC SetLootCollectionPhaseCompleteToBlackboard");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ResetOriginalRotationRate");

	Params::ANPC_Pawn_Parent_C_NPC_ResetOriginalRotationRate_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ResetOriginalGravityScale");

	Params::ANPC_Pawn_Parent_C_NPC_ResetOriginalGravityScale_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC SetReturnGatheredLootToBlackboard");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC GetScalableFloatHotfixValue");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ScalableFloatIsValid");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC PickupDropped");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC PickupGrabbed_Destroyed");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC PickupGrabbed");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnRep_NPC BestLootRarityInInventory");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC SendGameplayCuePickupGrabbed");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC PawnDebugMessage");
...
// FInterfaceProperty_                CallFunc_GetItemsFromInventoryOwner_InventoryOwner_CastInput     (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnRep_NPC_AlertLevel");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC GetAlertLevelInfo");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ApplyRecentlyDamagedTagGE");

	Params::ANPC_Pawn_Parent_C_NPC_ApplyRecentlyDamagedTagGE_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ShouldUpdateSkeletalMesh");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "UserConstructionScript");

	Params::ANPC_Pawn_Parent_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Timeline_ScaleMeshInOrOut__FinishedFunc");

	Params::ANPC_Pawn_Parent_C_Timeline_ScaleMeshInOrOut__FinishedFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Timeline_ScaleMeshInOrOut__UpdateFunc");

	Params::ANPC_Pawn_Parent_C_Timeline_ScaleMeshInOrOut__UpdateFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ReceiveEndPlay");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "WidgetVisibilityChanged");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC ParentLaunchVehicle");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TestLoot");

	Params::ANPC_Pawn_Parent_C_TestLoot_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnDeathPlayEffects");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC UpdateHealthBarComponentVisibility");

	Params::ANPC_Pawn_Parent_C_NPC_UpdateHealthBarComponentVisibility_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ReceivePossessed");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "RequestUpdateNPCAlertLevel");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCAlertLevelChangedClient");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC InitializeIdleVO");

	Params::ANPC_Pawn_Parent_C_NPC_InitializeIdleVO_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TriggerIdleVO");

	Params::ANPC_Pawn_Parent_C_TriggerIdleVO_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnDeathServer");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCEnableHealthBars");

	Params::ANPC_Pawn_Parent_C_NPCEnableHealthBars_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCDisableHealthBars");

	Params::ANPC_Pawn_Parent_C_NPCDisableHealthBars_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_AlertLevel_ForceLevel");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_AlertLevel_ClearDebug");

	Params::ANPC_Pawn_Parent_C_Debug_AlertLevel_ClearDebug_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "GrantStartingItems");

	Params::ANPC_Pawn_Parent_C_GrantStartingItems_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_ForceAlertLevel_Invalid");

	Params::ANPC_Pawn_Parent_C_Debug_ForceAlertLevel_Invalid_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_ForceAlertLevel_Unaware");

	Params::ANPC_Pawn_Parent_C_Debug_ForceAlertLevel_Unaware_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_ForceAlertLevel_NA");

	Params::ANPC_Pawn_Parent_C_Debug_ForceAlertLevel_NA_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_ForceAlertLevel_Alerted");

	Params::ANPC_Pawn_Parent_C_Debug_ForceAlertLevel_Alerted_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "Debug_ForceAlertLevel_Aggressive");

	Params::ANPC_Pawn_Parent_C_Debug_ForceAlertLevel_Aggressive_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "HandleInteracts");

	Params::ANPC_Pawn_Parent_C_HandleInteracts_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC Pawn Interact");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "On NPC PawnInteractedWith");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnBeginDeepWaterInteraction");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ReceiveBeginPlay");

	Params::ANPC_Pawn_Parent_C_ReceiveBeginPlay_Params Parms;
...
void ANPC_Pawn_Parent_C::NPC_LeaderSet(bool Success_, class AActor* Leader, enum class EUnconvertReason UnconvertReason)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC LeaderSet");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnDamageServer");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TriggerDeathFX");

	Params::ANPC_Pawn_Parent_C_TriggerDeathFX_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TestIsInSafeZone");

	Params::ANPC_Pawn_Parent_C_TestIsInSafeZone_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnEndDance");

	Params::ANPC_Pawn_Parent_C_OnEndDance_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnBeginDance");

	Params::ANPC_Pawn_Parent_C_OnBeginDance_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TryToDespawnDueToStorm");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "InitializeTestInSafeZone");

	Params::ANPC_Pawn_Parent_C_InitializeTestInSafeZone_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "DespawnDueToStorm");

	Params::ANPC_Pawn_Parent_C_DespawnDueToStorm_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "End Music Tracker");

	Params::ANPC_Pawn_Parent_C_End_Music_Tracker_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "BeginMusicTracker");

	Params::ANPC_Pawn_Parent_C_BeginMusicTracker_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "StopUpdatingHealthBarWidget");

	Params::ANPC_Pawn_Parent_C_StopUpdatingHealthBarWidget_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "RemoveSoundSystemLibraries");

	Params::ANPC_Pawn_Parent_C_RemoveSoundSystemLibraries_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "AddSoundSystemLibraries");

	Params::ANPC_Pawn_Parent_C_AddSoundSystemLibraries_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "InitializeInventory");

	Params::ANPC_Pawn_Parent_C_InitializeInventory_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "StartUpdatingHleathBarWidget");

	Params::ANPC_Pawn_Parent_C_StartUpdatingHleathBarWidget_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC AlertLevelChangedServer");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnPawnHealthChanged_Event_0");

	Params::ANPC_Pawn_Parent_C_OnPawnHealthChanged_Event_0_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnEnteredWaterBody");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnExitedWaterBody");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "LuredOnServer");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "LuredInterest");

	Params::ANPC_Pawn_Parent_C_LuredInterest_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "PlayEnterWaterSplash");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "PlayExitWaterSplash");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TryWaterInteractionDrown");

	Params::ANPC_Pawn_Parent_C_TryWaterInteractionDrown_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "StopTestingIsInSafeZone");

	Params::ANPC_Pawn_Parent_C_StopTestingIsInSafeZone_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCScaleMeshIn");

	Params::ANPC_Pawn_Parent_C_NPCScaleMeshIn_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCScaleMeshOut");

	Params::ANPC_Pawn_Parent_C_NPCScaleMeshOut_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "TriggerDespawnAbility");

	Params::ANPC_Pawn_Parent_C_TriggerDespawnAbility_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPC MulticastGameplayCueDeath");

	Params::ANPC_Pawn_Parent_C_NPC_MulticastGameplayCueDeath_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "UpdateSoundLibFoley");

	Params::ANPC_Pawn_Parent_C_UpdateSoundLibFoley_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "OnDamagePlayEffects");
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "AdditiveHitReactDelay");

	Params::ANPC_Pawn_Parent_C_AdditiveHitReactDelay_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "UpdateCustomDepth");

	Params::ANPC_Pawn_Parent_C_UpdateCustomDepth_Params Parms;
...
// FInterfaceProperty_                CallFunc_SetIntParameter_self_CastInput                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ANPC_Pawn_Parent_C::ExecuteUbergraph_NPC_Pawn_Parent(int32 EntryPoint, class AActor* K2Node_CustomEvent_Vehicle, const struct FVector& K2Node_CustomEvent_Velocity, enum class EFortRarity CallFunc_NPC_SetBestLootRarityInInventory_NPC_BestLootRarityInInventory, float K2Node_Event_Damage_3, const struct FGameplayTagContainer& K2Node_Event_DamageTags_3, const struct FVector& K2Node_Event_Momentum_3, const struct FHitResult& K2Node_Event_HitInfo_3, class AFortPawn* K2Node_Event_InstigatedBy_3, class AActor* K2Node_Event_DamageCauser_3, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext_3, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_HasTag_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue, class AController* K2Node_Event_NewController, class UNPCStatusWidget_C* K2Node_DynamicCast_AsNPCStatus_Widget, bool K2Node_DynamicCast_bSuccess, const struct FGameplayTagContainer& CallFunc_MakeLiteralGameplayTagContainer_ReturnValue, bool CallFunc_NotEqual_GameplayTagContainer_ReturnValue, enum class Enum_NPC_AlertLevel K2Node_CustomEvent_NPC_AlertLevel_1, enum class Enum_NPC_AlertLevel K2Node_CustomEvent_NPC_AlertLevel, bool CallFunc_NotEqual_ByteByte_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue_1, double CallFunc_RandomFloatInRange_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, float K2Node_Event_Damage_2, const struct FGameplayTagContainer& K2Node_Event_DamageTags_2, const struct FVector& K2Node_Event_Momentum_2, const struct FHitResult& K2Node_Event_HitInfo_2, class AController* K2Node_Event_InstigatedBy_2, class AActor* K2Node_Event_DamageCauser_2, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext_2, bool CallFunc_NPC_TryToDropLootOnDeath_CanDropLoot, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat, enum class Enum_NPC_AlertLevel K2Node_CustomEvent_NewNPC_AlertLevel, bool CallFunc_Greater_DoubleDouble_ReturnValue, bool CallFunc_HasAuthority_ReturnValue, class AFortAIPawn* K2Node_CustomEvent_AI, class AFortPlayerController* K2Node_CustomEvent_InteractingPlayerController, enum class EInteractionBeingAttempted K2Node_CustomEvent_InteractionBeingAttempted, class AActor* K2Node_CustomEvent_AIPawn, class AFortPlayerPawn* K2Node_CustomEvent_InteractingPlayerPawn, class AFortPlayerPawn* CallFunc_GetPlayerPawn_ReturnValue, bool K2Node_CustomEvent_bVisible, const struct FVector& K2Node_Event_WaterSurfaceLocation, float K2Node_Event_WaterDepth, bool K2Node_CustomEvent_Success_, class AActor* K2Node_CustomEvent_Leader, enum class EUnconvertReason K2Node_CustomEvent_UnconvertReason, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_NPC_UpdateInteract_EnabledInteract, bool CallFunc_NPC_UpdateInteract_EnabledInteract_1, float K2Node_Event_Damage_1, const struct FGameplayTagContainer& K2Node_Event_DamageTags_1, const struct FVector& K2Node_Event_Momentum_1, const struct FHitResult& K2Node_Event_HitInfo_1, class AController* K2Node_Event_InstigatedBy_1, class AActor* K2Node_Event_DamageCauser_1, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FGameplayCueParameters& CallFunc_MakeGameplayCueParameters_ReturnValue, bool Temp_bool_Variable, const struct FGameplayTag& K2Node_Select_Default, bool CallFunc_NPC_CheckIsInSafeZone_TestSucceeded, bool CallFunc_NPC_CheckIsInSafeZone_isInSafeZone, bool CallFunc_PlayVoiceLine_Success, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_1, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_1, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, double CallFunc_RandomFloatInRange_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue_1, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool K2Node_CustomEvent_Reset_Timer, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue_1, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_2, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_2, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_2, bool CallFunc_K2_IsValidTimerHandle_ReturnValue, bool CallFunc_HasAuthority_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_2, bool CallFunc_Not_PreBool_ReturnValue_2, bool CallFunc_HasAuthority_ReturnValue_3, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_HasAuthority_ReturnValue_4, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue_2, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_3, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_3, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_3, bool CallFunc_IsValid_ReturnValue_3, bool CallFunc_BooleanAND_ReturnValue_3, bool CallFunc_TryActivateAbilitiesByTag_ReturnValue, enum class Enum_NPC_AlertLevel CallFunc_NPC_GetAlertLevelInfo_AlertLevel, const struct FGameplayTag& CallFunc_NPC_GetAlertLevelInfo_AlertLevelTag, bool CallFunc_NPC_GetAlertLevelInfo_ValidDataFound, bool Temp_bool_Has_Been_Initd_Variable, bool Temp_bool_IsClosed_Variable, enum class Enum_NPC_AlertLevel K2Node_CustomEvent_NPCAlertLevel, bool K2Node_SwitchEnum_CmpSuccess_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, const struct FGameplayEventData& K2Node_MakeStruct_GameplayEventData, const struct FGameplayEventData& K2Node_MakeStruct_GameplayEventData_1, class UFortGameplayDataTrackerComponentManager* CallFunc_GetCurrent_ReturnValue, bool CallFunc_IsValid_ReturnValue_4, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, class AFortWaterBodyActor* K2Node_Event_WaterBody_1, bool K2Node_Event_bIsFirstBody, class AFortWaterBodyActor* K2Node_Event_WaterBody, bool K2Node_Event_bIsLastBody, bool CallFunc_IsDedicatedServer_ReturnValue, class UBlackboardComponent* CallFunc_GetBlackboard_ReturnValue, class UFortGameplayDataTrackerComponentManager* CallFunc_GetCurrent_ReturnValue_1, enum class Enum_NPC_AlertLevel K2Node_CustomEvent_AlertLevel, bool K2Node_SwitchEnum_CmpSuccess_2, bool CallFunc_IsValid_ReturnValue_5, class UObject* CallFunc_GetValueAsObject_ReturnValue, class AFortProjectileBase* K2Node_DynamicCast_AsFort_Projectile_Base, bool K2Node_DynamicCast_bSuccess_1, const struct FGameplayCueParameters& CallFunc_MakeGameplayCueParameters_ReturnValue_1, class AFortPickup* K2Node_DynamicCast_AsFort_Pickup, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_IsValid_ReturnValue_6, bool CallFunc_IsGameplayTagValid_ReturnValue, bool CallFunc_IsDedicatedServer_ReturnValue_1, bool CallFunc_NotEqual_ObjectObject_ReturnValue, enum class EEndPlayReason K2Node_Event_EndPlayReason, bool CallFunc_IsValidClass_ReturnValue, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue, bool CallFunc_IsValidClass_ReturnValue_1, bool CallFunc_RemoveActiveGameplayEffect_ReturnValue, class AFortWaterBodyActor* K2Node_CustomEvent_Water_Body_1, class AFortWaterBodyActor* K2Node_CustomEvent_Water_Body, bool CallFunc_IsValid_ReturnValue_7, const struct FGameplayTagContainer& CallFunc_MakeLiteralGameplayTagContainer_ReturnValue_1, bool CallFunc_K2_IsValidTimerHandle_ReturnValue_1, bool CallFunc_K2_IsValidTimerHandle_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_8, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_4, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_4, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_4, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_5, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_5, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_5, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_6, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_6, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_6, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_7, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_7, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_7, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_8, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_8, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_8, bool CallFunc_IsGameplayTagValid_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_4, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_1, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_2, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_3, int32 CallFunc_NPC_GetSafeZonePhase_SafeZonePhase, bool CallFunc_IsValid_ReturnValue_9, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue_1, class UNPCStatusWidget_C* K2Node_DynamicCast_AsNPCStatus_Widget_1, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_IsValid_ReturnValue_10, bool CallFunc_TryActivateAbilitiesByTag_ReturnValue_1, const struct FGameplayTagContainer& CallFunc_MakeLiteralGameplayTagContainer_ReturnValue_2, const struct FGameplayTagContainer& CallFunc_MakeLiteralGameplayTagContainer_ReturnValue_3, bool CallFunc_NotEqual_GameplayTagContainer_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_11, bool CallFunc_NPC_CanBeInteractedWith_CanInteract, bool CallFunc_NPC_CanBeInteractedWith_CanInteract_1, bool CallFunc_NPC_UpdateInteract_EnabledInteract_2, bool CallFunc_NPC_UpdateInteract_EnabledInteract_3, bool CallFunc_BooleanOR_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_5, bool CallFunc_IsValid_ReturnValue_12, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue_2, class UNPCStatusWidget_C* K2Node_DynamicCast_AsNPCStatus_Widget_2, bool K2Node_DynamicCast_bSuccess_4, const struct FGameplayCueParameters& CallFunc_MakeGameplayCueParameters_ReturnValue_2, const struct FGameplayTag& CallFunc_MakeLiteralGameplayTag_ReturnValue, bool CallFunc_NotEqual_GameplayTag_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_3, bool CallFunc_BooleanAND_ReturnValue_6, enum class Enum_NPC_AlertLevel CallFunc_NPC_GetAlertLevelInfo_AlertLevel_1, const struct FGameplayTag& CallFunc_NPC_GetAlertLevelInfo_AlertLevelTag_1, bool CallFunc_NPC_GetAlertLevelInfo_ValidDataFound_1, class UFortGameplayDataTrackerComponentManager* CallFunc_GetCurrent_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_13, bool CallFunc_IsValidClass_ReturnValue_2, const struct FActiveGameplayEffectHandle& CallFunc_BP_ApplyGameplayEffectToSelf_ReturnValue_4, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, int32 CallFunc_Conv_BoolToInt_ReturnValue, FInterfaceProperty_ CallFunc_SetIntParameter_self_CastInput, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_4, bool CallFunc_Not_PreBool_ReturnValue_5, bool CallFunc_BooleanAND_ReturnValue_7, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_6, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, bool CallFunc_IsValid_ReturnValue_14, float K2Node_Event_Damage, const struct FGameplayTagContainer& K2Node_Event_DamageTags, const struct FVector& K2Node_Event_Momentum, const struct FHitResult& K2Node_Event_HitInfo, class AFortPawn* K2Node_Event_InstigatedBy, class AActor* K2Node_Event_DamageCauser, const struct FGameplayEffectContextHandle& K2Node_Event_EffectContext, class AFortProjectileBase* K2Node_DynamicCast_AsFort_Projectile_Base_1, bool K2Node_DynamicCast_bSuccess_5, class AFortWeapon* K2Node_DynamicCast_AsFort_Weapon, bool K2Node_DynamicCast_bSuccess_6, enum class EFortDamageZone CallFunc_GetDamageZone_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess_3, bool CallFunc_WeaponDataHasAnyMatchingGameplayTags_ReturnValue, bool CallFunc_IsValid_ReturnValue_15, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, bool CallFunc_IsValid_ReturnValue_16, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue_1, const struct FRotator& CallFunc_K2_GetComponentRotation_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue, bool CallFunc_IsValid_ReturnValue_17, bool CallFunc_Greater_DoubleDouble_ReturnValue_1, class UUserWidget* CallFunc_GetUserWidgetObject_ReturnValue_3, class UNPCStatusWidget_C* K2Node_DynamicCast_AsNPCStatus_Widget_3, bool K2Node_DynamicCast_bSuccess_7, bool CallFunc_IsValid_ReturnValue_18, bool CallFunc_IsVisible_ReturnValue, bool CallFunc_IsValid_ReturnValue_19, bool CallFunc_Array_IsValidIndex_ReturnValue, bool CallFunc_Array_IsValidIndex_ReturnValue_1, bool CallFunc_IsConverted_IsConverted, bool CallFunc_IsRenderCustomDepthEnabled_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue_3, bool CallFunc_IsGameplayTagValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_20, bool CallFunc_CanActivateAbilityWithMatchingTag_ReturnValue, bool CallFunc_TryActivateAbilitiesByTag_ReturnValue_2, bool K2Node_SwitchEnum_CmpSuccess_4, const struct FVector& CallFunc_VLerp_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess_5, bool CallFunc_RemoveActiveGameplayEffect_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_21, bool CallFunc_TryActivateAbilitiesByTag_ReturnValue_3, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_9, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_9, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_9, bool CallFunc_Not_PreBool_ReturnValue_6, bool CallFunc_Greater_DoubleDouble_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_8, bool CallFunc_NPC_GetScalableFloatHotfixValue_AsBool_10, int32 CallFunc_NPC_GetScalableFloatHotfixValue_AsIntRounded_10, double CallFunc_NPC_GetScalableFloatHotfixValue_AsFloat_10, double CallFunc_GetGameTimeInSeconds_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, bool CallFunc_IsValid_ReturnValue_22, double CallFunc_Subtract_DoubleDouble_ReturnValue_1, bool CallFunc_Greater_DoubleDouble_ReturnValue_3, double CallFunc_GetGameTimeInSeconds_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_7, bool CallFunc_Greater_DoubleDouble_ReturnValue_4, bool CallFunc_WasRecentlyRendered_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_7, bool CallFunc_BooleanAND_ReturnValue_9, bool CallFunc_HasAnyMatchingGameplayTags_ReturnValue, class USoundLibrarySubsystem* CallFunc_GetWorldSubsystem_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue_8, bool CallFunc_BooleanAND_ReturnValue_10, bool CallFunc_IsValid_ReturnValue_23, bool CallFunc_IsValid_ReturnValue_24, float CallFunc_Delay_Duration_ImplicitCast, double CallFunc_RandomFloatInRange_Min_ImplicitCast, double CallFunc_RandomFloatInRange_Max_ImplicitCast, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast, float CallFunc_Delay_Duration_ImplicitCast_1, float CallFunc_MakeGameplayCueParameters_RawMagnitude_ImplicitCast, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_1, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_2, float CallFunc_MakeGameplayCueParameters_RawMagnitude_ImplicitCast_1, float CallFunc_K2_SetTimer_Time_ImplicitCast, float CallFunc_K2_SetTimerDelegate_Time_ImplicitCast_3, float CallFunc_Update_DeltaTime_ImplicitCast, float CallFunc_Delay_Duration_ImplicitCast_2)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "ExecuteUbergraph_NPC_Pawn_Parent");
...
void ANPC_Pawn_Parent_C::NPCAlertLevelUpdated__DelegateSignature(enum class Enum_NPC_AlertLevel NPC_Alert_Level)
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCAlertLevelUpdated__DelegateSignature");

	Params::ANPC_Pawn_Parent_C_NPCAlertLevelUpdated__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCPawnInteractWithDispatcher__DelegateSignature");

	Params::ANPC_Pawn_Parent_C_NPCPawnInteractWithDispatcher__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCScaleMeshOutCompleted__DelegateSignature");

	Params::ANPC_Pawn_Parent_C_NPCScaleMeshOutCompleted__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("NPC_Pawn_Parent_C", "NPCScaleMeshInCompleted__DelegateSignature");

	Params::ANPC_Pawn_Parent_C_NPCScaleMeshInCompleted__DelegateSignature_Params Parms;
