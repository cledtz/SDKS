...
public:
	...
	uint8                                        Pad_8261[0x6];                                     // Fixing Size After Last Property..
	class AActor*                                PrevHitPawn;                                       // 0x310(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("FortUserWidget_HitTicks");
		return Clss;
	}
