...
struct UAnimNotify_GrindRailLand_C_Received_Notify_Params
{
public:
	...
	uint8                                        Pad_829C[0x7];                                     // Fixing Size After Last Property..
	class UBP_GrindingComponent_C*               GrindingComponent;                                 // 0x40(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x48(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_GrindingComponent_C*               CallFunc_GetComponentByClass_ReturnValue;          // 0x50(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
