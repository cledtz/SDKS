...
public:
	...
	uint8                                        Pad_3DF3[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3DF5[0x6];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3DFD[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E01[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3E04[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3E09[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3E0A[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3E0C[0x4];                                     // Fixing Size After Last Property..
...
public:
	enum class EAugmentExecResult                OutExec;                                           // 0x0(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3E0E[0x7];                                     // Fixing Size After Last Property..
