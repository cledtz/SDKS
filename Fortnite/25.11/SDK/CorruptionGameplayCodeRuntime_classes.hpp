...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("WarEffortFundingLibrary");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_7EEA[0x68];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CorruptionCoverageMap");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("FortCorruptionSequenceData");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_7EEC[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7EED[0x8];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("CubeMovementStaticPath");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_7EF1[0x8];                                     // Fixing Size After Last Property..
	struct FWarEffortMutatorMetadata             MeshNetworkMetadata;                               // 0x458(0x20)(BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	TArray<struct FWarEffortMutatorChoiceData>   WeaponChoices;                                     // 0x478(0x10)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPrimaryAssetId>               PreloadedItemList;                                 // 0x488(0x10)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	bool                                         bCanPreloadItems;                                  // 0x498(0x1)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_7EF2[0x1F];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("FortAthenaMutator_WarEffort");
		return Clss;
	}
...
{
public:
	class UMeshNetworkComponent*                 MeshNetworkComponent;                              // 0x288(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTag>                  ActiveFundedItems;                                 // 0x290(0x10)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<struct FGameplayTag>                  ActiveTryBeforeYouBuyItems;                        // 0x2A0(0x10)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<struct FWarEffortFundingData>         CurrentFundingData;                                // 0x2B0(0x10)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7EF3[0x50];                                    // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("WarEffortMeshActor");
		return Clss;
	}
