...
public:
	...
	class UImage*                                Rating_Glow_Large;                                 // 0x348(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UCommonNumericTextBlock*               TeamRatingValue_Large;                             // 0x368(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Moonbeam_PowerRatingWidget_C");
		return Clss;
	}
