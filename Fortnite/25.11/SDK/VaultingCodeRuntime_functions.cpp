...
void UHurdleComponent::HandleOwnerMovementModeChanged(class ACharacter* Character, enum class EMovementMode PreviousMovementMode, uint8 PreviousCustomMode)
{
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// enum class EHurdleType             HurdleType                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UHurdleComponent::BP_HandleHurdleStarted(enum class EHurdleType HurdleType, struct FSynchedActionInfo& SynchedActionInfo)
{
...
bool UHurdleLibrary::PerformHurdleTargeting(class ACharacter* Character, struct FHurdleInputConfigCache* HurdleInputConfig, struct FHurdleTargetingData* OutTargetingData, bool bIsAutoHurdle)
{
