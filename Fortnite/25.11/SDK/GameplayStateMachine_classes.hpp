...
public:
	...
	uint8                                        Pad_7984[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7985[0x4];                                     // Fixing Size After Last Property..
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GameplayState");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_7986[0x18];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7988[0x4];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GameplayStateMachine");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GameplayStateMachineManager");
		return Clss;
	}
