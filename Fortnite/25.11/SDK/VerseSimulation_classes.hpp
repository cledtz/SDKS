...
public:
	...
	FOptionProperty_ _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R(const struct FTuple_Lplayer__component_Many_R& __verse_0xB2CDDD72_Argument);
	FOptionProperty_ _L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_Ntype_R(const struct FTuple_Lint_Many_R& __verse_0xB2CDDD72_Argument);
	FOptionProperty_ _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_Ntype_R(const struct FTuple_Lplayer__component_Many_R& __verse_0xB2CDDD72_Argument);
	FOptionProperty_ _L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_Ntype_R(const struct FTuple_Lint_Many_R& __verse_0xB2CDDD72_Argument);
	void _InitCDO();
};
