...
public:
	...
	uint8                                        Pad_1897[0x7];                                     // Fixing Size After Last Property..
	struct FRotator                              CallFunc_MakeRotFromX_ReturnValue;                 // 0x1E0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x1F8(0xE0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
