...
struct AMidMatchRiftPoiManagerActor_SetDynamicLandBrush_Params
{
public:
...
struct AMidmatchRiftPoiSpawnIndicator_TeleportVehicleActor_Params
{
public:
	class AActor*                                VehicleActor;                                      // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct AMidmatchRiftPoiSpawnIndicator_IsActorInDataLayerInstance_Params
{
public:
	...
	uint8                                        Pad_82B0[0x7];                                     // Fixing Size Of Struct..
};
