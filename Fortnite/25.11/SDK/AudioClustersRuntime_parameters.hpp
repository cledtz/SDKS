...
public:
	...
	uint8                                        Pad_78A9[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78AA[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_78AB[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78AC[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_78AD[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	struct FAudioClusterActorInfo                ActorInfo;                                         // 0x0(0xC)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0xC(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_78AE[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	class UAudioClusterConfigMap*                Map;                                               // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_78AF[0x7];                                     // Fixing Size Of Struct..
};
