...
public:
	...
	uint8                                        Pad_3E7C[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3E7D[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3E7F[0x8];                                     // Fixing Size After Last Property..
	...
	class AAmbientAudioParameterActor*           ParameterActor;                                    // 0x68(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3E80[0x1E8];                                   // Fixing Size Of Struct..
...
{
public:
	class UAudioParameterComponent*              Parameters;                                        // 0x288(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
