...
public:
	...
	float                                        Intro_Ambient_FX_Timeline_Ambient_FX_Volume_EE4EF3FC4169AF85C3E076ADB15A9FAB; // 0x968(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                Intro_Ambient_FX_Timeline__Direction_EE4EF3FC4169AF85C3E076ADB15A9FAB; // 0x96C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A0A9[0x3];                                     // Fixing Size After Last Property..
	class UTimelineComponent*                    Intro_Ambient_FX_Timeline;                         // 0x970(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	float                                        Intro_Flare_Timeline_Flare_FX_Volume_DC12FFA64C913C89F456A7BA1F0987D7; // 0x978(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                Intro_Flare_Timeline__Direction_DC12FFA64C913C89F456A7BA1F0987D7; // 0x97C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A0AA[0x3];                                     // Fixing Size After Last Property..
	class UTimelineComponent*                    Intro_Flare_Timeline;                              // 0x980(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FScalableFloat                        Audio_Vizualizer_Shown_On_Wearer_;                 // 0x988(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Audio_Vizualizer_Range;                            // 0x9B0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Audio_Vizualizer_Ping_Frequency;                   // 0x9D8(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Intro_AmbientFX_Timeline_Rate;                     // 0xA00(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Intro_Flare_Timline_Rate;                          // 0xA28(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Intro_FX_Visual_Volume;                            // 0xA50(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        _1st_Person_FX_Visual_Volume;                      // 0xA78(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        _3rd_Perosn_FX_Visual_Volume;                      // 0xAA0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FTimerHandle                          Timer_handle;                                      // 0xAC8(0x8)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	TArray<class UFXSystemComponent*>            Particle_Components;                               // 0xAD0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
