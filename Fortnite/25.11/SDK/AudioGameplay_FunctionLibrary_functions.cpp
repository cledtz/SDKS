...
void UAudioGameplay_FunctionLibrary_C::GetAudioForPlayerEvent(class AActor* Target, class USoundBase* _1P_Sound, class USoundBase* _3P_Sound, class UObject* __WorldContext, class USoundBase** AudioAsset, bool CallFunc_IsActorLocal_ReturnValue)
{
