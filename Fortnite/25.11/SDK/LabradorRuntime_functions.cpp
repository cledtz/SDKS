...
{
	static auto Func = Class->GetFunction("FortLabradorComponent_Telemetry", "OnWakeUp");
...
{
	static auto Func = Class->GetFunction("FortLabradorComponent_Telemetry", "OnTeleport");
...
{
	static auto Func = Class->GetFunction("FortLabradorComponent_Telemetry", "OnDamaged");
