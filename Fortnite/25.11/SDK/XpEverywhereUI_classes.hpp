...
{
public:
	uint8                                        Pad_381D[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_381E[0xE];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_3820[0xD0];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3821[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3824[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3825[0x48];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3826[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_3827[0x6];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_3828[0x90];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_3829[0x10];                                    // Fixing Size Of Struct..
