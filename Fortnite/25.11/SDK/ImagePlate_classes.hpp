...
{
public:
	class UImagePlateComponent*                  ImagePlate;                                        // 0x288(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_868D[0x118];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_868E[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_868F[0x8];                                     // Fixing Size Of Struct..
