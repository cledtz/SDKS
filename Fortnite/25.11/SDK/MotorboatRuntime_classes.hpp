...
{
public:
	class AFortMeatballVehicle*                  Meatball;                                          // 0x5F8(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_814B[0x5];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_814D[0x4];                                     // Fixing Size After Last Property..
	...
	class APlayerController*                     DrivingPlayerController;                           // 0x1BE0(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_814E[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_814F[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8150[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8151[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_8152[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_8153[0x3F];                                    // Fixing Size Of Struct..
	...
	void SmashedThroughBuildingPiece(struct FVector& ImpactPoint, struct FVector& ImpactNormal, class ABuildingActor* BuildingHitActor);
