...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "StopLocalForceFeedback");

	Params::AB_Ranged_Generic_C_StopLocalForceFeedback_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "PlayLocalForceFeedback");

	Params::AB_Ranged_Generic_C_PlayLocalForceFeedback_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "getScopeComp");

	Params::AB_Ranged_Generic_C_GetScopeComp_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "initScope");

	Params::AB_Ranged_Generic_C_InitScope_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "IsNewFeedbackEnabled");

	Params::AB_Ranged_Generic_C_IsNewFeedbackEnabled_Params Parms;
...
void AB_Ranged_Generic_C::LocalReloadStarted(float ReloadTime, enum class EFortWeaponReloadType ReloadType)
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "LocalReloadStarted");

	Params::AB_Ranged_Generic_C_LocalReloadStarted_Params Parms;
...
void AB_Ranged_Generic_C::GetCorrectMuzzleNiagaraSystem(TSoftObjectPtr<class UNiagaraSystem>* OutNiagaraSystem, bool Temp_bool_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsQuartzGunfireEnabled_ReturnValue, TSoftObjectPtr<class UNiagaraSystem> K2Node_Select_Default)
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "GetCorrectMuzzleNiagaraSystem");

	Params::AB_Ranged_Generic_C_GetCorrectMuzzleNiagaraSystem_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "PlayScopeOutAudio");

	Params::AB_Ranged_Generic_C_PlayScopeOutAudio_Params Parms;
...
void AB_Ranged_Generic_C::DeactivateMuzzleFX(int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_GetValueAsBool_ReturnValue, TArray<class UFXSystemComponent*>& CallFunc_GetActiveMuzzleComponents_NewParam, class UFXSystemComponent* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue)
{
...
void AB_Ranged_Generic_C::Muzzle_Flash_FX(bool Persistent_Fire, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class UFXSystemComponent*>& CallFunc_GetActiveMuzzleComponents_NewParam, bool CallFunc_IsUsingScope_ReturnValue, class UFXSystemComponent* CallFunc_Array_Get_Item, bool CallFunc_Not_PreBool_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_GetValueAsBool_ReturnValue, double CallFunc_GetGameTimeInSeconds_ReturnValue, TSoftObjectPtr<class UNiagaraSystem> CallFunc_GetCorrectMuzzleNiagaraSystem_OutNiagaraSystem, float CallFunc_ActivateMuzzleFlashFXNative_MuzzleFlashSmallMaxScale_ImplicitCast, float CallFunc_ActivateMuzzleFlashFXNative_MuzzleFlashSmallMinScale_ImplicitCast, float CallFunc_ActivateMuzzleFlashFXNative_MuzzleFlashLargeMaxScale_ImplicitCast, float CallFunc_ActivateMuzzleFlashFXNative_MuzzleFlashLargeMinScale_ImplicitCast, float CallFunc_ActivateMuzzleFlashFXNative_MuzzleChanceOfLargeFlash_ImplicitCast)
{
...
void AB_Ranged_Generic_C::UserConstructionScript(int32 ValidMuzzleSocketCount, int32 Temp_int_Array_Index_Variable, bool CallFunc_GreaterEqual_IntInt_ReturnValue, float CallFunc_GetScalarParameterValue_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, TSoftObjectPtr<class UNiagaraSystem> CallFunc_GetCorrectMuzzleNiagaraSystem_OutNiagaraSystem, const struct FTransform& Temp_struct_Variable, bool CallFunc_IsNiagaraEffectEnabledSoftPtr_ReturnValue, class UParticleSystemComponent* CallFunc_AddComponent_ReturnValue, int32 Temp_int_Array_Index_Variable_1, TArray<class FName>& CallFunc_GetUniqueMuzzleSocketNames_Names, TArray<class FName>& CallFunc_GetUniqueMuzzleSocketNames_Names_1, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_IsDedicatedServer_ReturnValue, class UParticleSystemComponent* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue_2, bool CallFunc_Array_IsValidIndex_ReturnValue, class FName CallFunc_GetMuzzleSocketName_ReturnValue, bool CallFunc_Array_IsValidIndex_ReturnValue_1, int32 Temp_int_Loop_Counter_Variable, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Loop_Counter_Variable_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_1, const struct FTransform& Temp_struct_Variable_1, class UParticleSystemComponent* CallFunc_AddComponent_ReturnValue_1, double CallFunc_Greater_DoubleDouble_A_ImplicitCast)
{
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "AnimateScopePostProcess__Toggle Scope__EventFunc");

	Params::AB_Ranged_Generic_C_AnimateScopePostProcess__Toggle_Scope__EventFunc_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "OnLoaded_4D1409A247BFDB4C074B628406FC7A72");
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "LoadNiagaraMuzzleSoftObject");

	Params::AB_Ranged_Generic_C_LoadNiagaraMuzzleSoftObject_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "OnApplyFireModeData");
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "ScopeEffectDelay2");

	Params::AB_Ranged_Generic_C_ScopeEffectDelay2_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "ScopeEffectDelay1");

	Params::AB_Ranged_Generic_C_ScopeEffectDelay1_Params Parms;
...
// class UObject*                     K2Node_CustomEvent_Loaded_4                                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                              Temp_int_Array_Index_Variable                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_ShouldPlayPersistentFireFX_ReturnValue                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortAIPawn*                 CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Less_IntInt_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               CallFunc_GetNumericCVar_ReturnValue_3                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UParticleSystem*             K2Node_DynamicCast_AsParticle_System_3                           (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AB_Ranged_Generic_C::ExecuteUbergraph_B_Ranged_Generic(int32 EntryPoint, double CallFunc_GetPI_ReturnValue, double CallFunc_MultiplyMultiply_FloatFloat_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsDedicatedServer_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_IsDedicatedServer_ReturnValue_1, class APawn* CallFunc_GetInstigator_ReturnValue_1, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, bool CallFunc_IsInVehicle_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_1, bool K2Node_Event_bPersistentFire, bool K2Node_Event_bSecondaryFire, enum class EFortReloadFXState K2Node_Event_ReloadStage, bool Temp_bool_IsClosed_Variable, double CallFunc_GetGameTimeInSeconds_ReturnValue, double K2Node_MathExpression_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, bool K2Node_MathExpression_ReturnValue_1, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue_2, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn_1, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_IsValid_ReturnValue_3, class APlayerController* CallFunc_GetLocalViewingPlayerController_ReturnValue, bool CallFunc_IsValid_ReturnValue_4, bool K2Node_Event_bNewIsTargeting, bool CallFunc_SetHiddenInGameControllerOnly_ReturnValue, TArray<class AFortAIPawn*>& CallFunc_GetAllActorsOfClass_OutActors, bool K2Node_CustomEvent_Enable_Or_Disable, int32 K2Node_CustomEvent_StencilBufferValue, class APawn* CallFunc_GetInstigator_ReturnValue_3, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn_2, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_IsValid_ReturnValue_5, bool Temp_bool_Has_Been_Initd_Variable, class UFortAlterationItemDefinition* K2Node_Event_NewAlteration, const struct FFortCosmeticModification& K2Node_Event_CosmeticMod, TSoftObjectPtr<class UFXSystemAsset> CallFunc_SelectAltSystemAsset_ReturnValue, bool CallFunc_IsAssetNull_ReturnValue, bool CallFunc_IsAssetNull_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue, TSoftObjectPtr<class UFXSystemAsset> CallFunc_SelectAltSystemAsset_ReturnValue_1, bool CallFunc_IsAssetNull_ReturnValue_2, bool CallFunc_IsAssetNull_ReturnValue_3, bool CallFunc_UseScopeTargeting_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue_4, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn_3, bool K2Node_DynamicCast_bSuccess_4, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue, class APlayerController* CallFunc_GetLocalViewingPlayerController_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_6, bool CallFunc_IsValid_ReturnValue_7, class UStaticMeshComponent* CallFunc_getScopeComp_scopeComponent, bool CallFunc_SetHiddenInGameOtherLocalControllersOnly_ReturnValue, bool CallFunc_IsValid_ReturnValue_8, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue_1, bool K2Node_CustomEvent_Enable_1, int32 K2Node_CustomEvent_TargetLimit_1, class UStaticMeshComponent* CallFunc_getScopeComp_scopeComponent_1, int32 CallFunc_SelectInt_ReturnValue, const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue_1, const struct FVector& CallFunc_GetSocketLocation_ReturnValue_2, const struct FVector& CallFunc_InverseTransformLocation_ReturnValue, const struct FVector& CallFunc_InverseTransformLocation_ReturnValue_1, const struct FLinearColor& CallFunc_Conv_VectorToLinearColor_ReturnValue, const struct FLinearColor& CallFunc_Conv_VectorToLinearColor_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_9, bool K2Node_CustomEvent_Enable, int32 K2Node_CustomEvent_TargetLimit, class UObject* K2Node_CustomEvent_Loaded_3, int32 CallFunc_SelectInt_ReturnValue_1, bool CallFunc_IsUsingFirstPersonCamera_ReturnValue, class AController* CallFunc_GetInstigatorController_ReturnValue, class AFortPlayerControllerZone* K2Node_DynamicCast_AsFort_Player_Controller_Zone, bool K2Node_DynamicCast_bSuccess_5, class AFortWindManager* CallFunc_GetWindManager_ReturnValue, bool CallFunc_UseScopeTargeting_ReturnValue_1, bool CallFunc_UseScopeTargeting_ReturnValue_2, bool K2Node_Event_bVisible, bool K2Node_Event_bSetForLocalControllerOnly, class UStaticMeshComponent* CallFunc_getScopeComp_scopeComponent_2, bool CallFunc_IsValid_ReturnValue_10, class UObject* Temp_object_Variable, int32 CallFunc_GetRenderingDetailMode_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsValid_ReturnValue_11, bool CallFunc_SetHiddenInGameControllerOnly_ReturnValue_1, class APawn* CallFunc_GetInstigator_ReturnValue_5, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn_4, bool K2Node_DynamicCast_bSuccess_6, bool CallFunc_IsValid_ReturnValue_12, class APlayerController* CallFunc_GetLocalViewingPlayerController_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_13, int32 K2Node_CustomEvent_Which_Call, float K2Node_CustomEvent_NewRateOfFire, float CallFunc_GetWeaponRateOfFireModifier_ReturnValue, float CallFunc_GetFloatValue_ReturnValue, bool CallFunc_IsInAthena_ReturnValue, class UObject* K2Node_CustomEvent_Loaded_4, int32 Temp_int_Array_Index_Variable, class APawn* CallFunc_GetInstigator_ReturnValue_6, class AFortPawn* K2Node_DynamicCast_AsFort_Pawn_5, bool K2Node_DynamicCast_bSuccess_7, bool CallFunc_IsValid_ReturnValue_14, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UFortGameUserSettings* CallFunc_GetFortGameUserSettings_ReturnValue, class UObject* Temp_object_Variable_1, class UParticleSystem* K2Node_DynamicCast_AsParticle_System, bool K2Node_DynamicCast_bSuccess_8, bool CallFunc_IsDedicatedServer_ReturnValue_2, const struct FHitResult& K2Node_Event_HitResult, enum class EPhysicalSurface K2Node_Event_ImpactPhysicalSurface, class UFXSystemComponent* K2Node_Event_SpawnedPSC, int32 CallFunc_Conv_ByteToInt_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_HasAuthority_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_GetIsTargeting_ReturnValue, bool CallFunc_GetIsTargeting_ReturnValue_1, bool CallFunc_GetIsTargeting_ReturnValue_2, const struct FSlateBrush& CallFunc_GetWeaponDataSmallPreviewImageBrush_ReturnValue, enum class EFortWeaponTriggerType CallFunc_GetWeaponDataTriggerType_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, class UTexture2D* K2Node_DynamicCast_AsTexture_2D, bool K2Node_DynamicCast_bSuccess_9, bool CallFunc_ShouldPlayPersistentFireFX_ReturnValue, class AFortAIPawn* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_15, class UObject* K2Node_CustomEvent_Loaded_2, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_ShouldPlayShellFX_ReturnValue, int32 Temp_int_Array_Index_Variable_1, class UFortWeaponFireModeData* K2Node_Event_FireModeData, bool CallFunc_IsValid_ReturnValue_16, bool CallFunc_IsValid_ReturnValue_17, class UParticleSystemComponent* CallFunc_Array_Get_Item_1, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_18, bool CallFunc_IsValid_ReturnValue_19, bool CallFunc_GetValueAsBool_ReturnValue, TSoftObjectPtr<class UNiagaraSystem> CallFunc_GetCorrectMuzzleNiagaraSystem_OutNiagaraSystem, class UObject* CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue, bool CallFunc_IsAssetNull_ReturnValue_4, class UNiagaraSystem* K2Node_DynamicCast_AsNiagara_System, bool K2Node_DynamicCast_bSuccess_10, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_20, bool CallFunc_Not_PreBool_ReturnValue_2, bool CallFunc_BooleanAND_ReturnValue_1, int32 Temp_int_Loop_Counter_Variable_1, bool CallFunc_Less_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_2, class APawn* CallFunc_GetInstigator_ReturnValue_7, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, class AFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn_1, bool K2Node_DynamicCast_bSuccess_11, bool CallFunc_IsInVehicle_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_21, enum class EFortWeaponCoreAnimation CallFunc_GetCoreAnimation_ReturnValue, bool CallFunc_IsValid_ReturnValue_22, int32 CallFunc_Conv_ByteToInt_ReturnValue_1, bool CallFunc_IsDedicatedServer_ReturnValue_3, TArray<class UFXSystemComponent*>& CallFunc_GetActiveMuzzleComponents_NewParam, class UFXSystemComponent* CallFunc_Array_Get_Item_2, int32 CallFunc_Array_Length_ReturnValue_2, bool CallFunc_Less_IntInt_ReturnValue_2, class UParticleSystemComponent* CallFunc_GetBeamPSC_ReturnValue, bool CallFunc_GetUseBeamParticles_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_2, class APawn* CallFunc_GetInstigator_ReturnValue_8, class APlayerPawn_Generic_Parent_C* K2Node_DynamicCast_AsPlayer_Pawn_Generic_Parent, bool K2Node_DynamicCast_bSuccess_12, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5, float CallFunc_GetNumericCVar_OutValue, bool CallFunc_GetNumericCVar_ReturnValue, double CallFunc_FMax_ReturnValue, float CallFunc_GetNumericCVar_OutValue_1, bool CallFunc_GetNumericCVar_ReturnValue_1, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_FMax_ReturnValue_1, float CallFunc_GetNumericCVar_OutValue_2, bool CallFunc_GetNumericCVar_ReturnValue_2, double CallFunc_Divide_DoubleDouble_ReturnValue_1, double CallFunc_FMax_ReturnValue_2, double CallFunc_Divide_DoubleDouble_ReturnValue_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_6, float CallFunc_GetNumericCVar_OutValue_3, bool CallFunc_GetNumericCVar_ReturnValue_3, double CallFunc_FMax_ReturnValue_3, double CallFunc_Divide_DoubleDouble_ReturnValue_3, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, class UObject* Temp_object_Variable_2, class UParticleSystem* K2Node_DynamicCast_AsParticle_System_1, bool K2Node_DynamicCast_bSuccess_13, double CallFunc_Multiply_DoubleDouble_ReturnValue_2, double CallFunc_Multiply_DoubleDouble_ReturnValue_3, double CallFunc_Multiply_DoubleDouble_ReturnValue_4, class UObject* K2Node_CustomEvent_Loaded, class UObject* Temp_object_Variable_3, class UNiagaraSystem* K2Node_DynamicCast_AsNiagara_System_1, bool K2Node_DynamicCast_bSuccess_14, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_7, class UParticleSystem* K2Node_DynamicCast_AsParticle_System_2, bool K2Node_DynamicCast_bSuccess_15, class UObject* K2Node_CustomEvent_Loaded_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_8, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_9, const struct FTransform& CallFunc_GetSocketTransform_ReturnValue, const struct FTransform& CallFunc_GetSocketTransform_ReturnValue_1, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FVector& CallFunc_BreakTransform_Location_1, const struct FRotator& CallFunc_BreakTransform_Rotation_1, const struct FVector& CallFunc_BreakTransform_Scale_1, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, double CallFunc_BreakVector_X_1, double CallFunc_BreakVector_Y_1, double CallFunc_BreakVector_Z_1, double CallFunc_Add_DoubleDouble_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue_3, double CallFunc_Divide_DoubleDouble_ReturnValue_4, const struct FVector& CallFunc_GetSocketLocation_ReturnValue_4, double CallFunc_Multiply_DoubleDouble_ReturnValue_5, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAttached_ReturnValue_1, const struct FRotator& CallFunc_Conv_VectorToRotator_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldRotation_SweepHitResult, double CallFunc_VSize_ReturnValue, bool CallFunc_DoesSocketExist_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_6, double CallFunc_Divide_DoubleDouble_ReturnValue_5, double CallFunc_Divide_DoubleDouble_ReturnValue_6, const struct FVector& CallFunc_MakeVector_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue_7, double CallFunc_Divide_DoubleDouble_ReturnValue_8, const struct FVector& CallFunc_MakeVector_ReturnValue_1, const struct FVector& CallFunc_MakeVector_ReturnValue_2, bool CallFunc_DoesSocketExist_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_3, class UObject* Temp_object_Variable_4, class APawn* CallFunc_GetInstigator_ReturnValue_9, class UNiagaraSystem* K2Node_DynamicCast_AsNiagara_System_2, bool K2Node_DynamicCast_bSuccess_16, class UNiagaraSystem* CallFunc_SetBeamNiagaraSystem_ReturnValue, bool CallFunc_IsValid_ReturnValue_23, class UParticleSystem* K2Node_DynamicCast_AsParticle_System_3, bool K2Node_DynamicCast_bSuccess_17, class UParticleSystem* CallFunc_SetBeamParticleSystem_ReturnValue, float CallFunc_RetriggerableDelay_Duration_ImplicitCast, double CallFunc_SetPostProcessParams_InputPin_ImplicitCast, double CallFunc_FMax_A_ImplicitCast, double CallFunc_FMax_A_ImplicitCast_1, double CallFunc_FMax_A_ImplicitCast_2, double CallFunc_FMax_A_ImplicitCast_3, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast_1, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast_2, float CallFunc_SetCullDistance_NewCullDistance_ImplicitCast_3, float CallFunc_SetFloatParameter_Param_ImplicitCast, float CallFunc_SetFloatParameter_Param_ImplicitCast_1, float CallFunc_SetFloatParameter_Param_ImplicitCast_2)
{
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "OnPersistentFireStopped__DelegateSignature");

	Params::AB_Ranged_Generic_C_OnPersistentFireStopped__DelegateSignature_Params Parms;
...
{
	static auto Func = Class->GetFunction("B_Ranged_Generic_C", "OnStartFiring__DelegateSignature");

	Params::AB_Ranged_Generic_C_OnStartFiring__DelegateSignature_Params Parms;
