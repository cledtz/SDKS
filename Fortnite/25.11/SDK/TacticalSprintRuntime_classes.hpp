...
{
public:
	uint8                                        Pad_7E8D[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E8E[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E8F[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E90[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E91[0xC];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E92[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E93[0x4];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("FortMovementMode_ELTacSprint");
		return Clss;
	}
	...
	void HandleMovementModeChanged(class ACharacter* Character, enum class EMovementMode PreviousMovementMode, uint8 PreviousCustomMode);
...
{
public:
	uint8                                        Pad_7E96[0x18];                                    // Fixing Size After Last Property..
	...
	class AFortPlayerPawn*                       CurrentBoundPlayerPawn;                            // 0xD0(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        BitPad_422 : 2;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_7E98[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E99[0x68];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E9A[0x8];                                     // Fixing Size Of Struct..

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("FortPlayerControllerComponent_TacticalSprint");
		return Clss;
	}
