...
void AFortAthenaMutator_ScoutDrone::OnViewTargetChanged(class AFortPlayerController* PlayerController, class AActor* OldViewTarget, class AActor* NewViewTarget)
{
	...
	Params::AFortAthenaMutator_ScoutDrone_OnViewTargetChanged_Params Parms;
...
void AFortScoutDrone::SetupGameplayAudioParameters()
{
	...
	Params::AFortScoutDrone_SetupGameplayAudioParameters_Params Parms;
...
void AFortScoutDrone::SetTeamMatesIndicator(bool bState)
{
	...
	Params::AFortScoutDrone_SetTeamMatesIndicator_Params Parms;
...
void AFortScoutDrone::SetAffiliationAudio()
{
	...
	Params::AFortScoutDrone_SetAffiliationAudio_Params Parms;
...
void AFortScoutDrone::OnRep_ControllingPlayerPawn()
{
	...
	Params::AFortScoutDrone_OnRep_ControllingPlayerPawn_Params Parms;
...
void AFortScoutDrone::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("FortScoutDrone", "OnDeathPlayEffects");

	Params::AFortScoutDrone_OnDeathPlayEffects_Params Parms;
...
void AFortScoutDrone::OnDamagePlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("FortScoutDrone", "OnDamagePlayEffects");

	Params::AFortScoutDrone_OnDamagePlayEffects_Params Parms;
...
float AFortScoutDrone::GetHealthPercentage()
{
	static auto Func = Class->GetFunction("FortScoutDrone", "GetHealthPercentage");

	Params::AFortScoutDrone_GetHealthPercentage_Params Parms;
...
void AFortScoutDrone::GetForwardAndRightDotProducts_Native(float* OutForwardDot, float* OutRightDot)
{
	...
	Params::AFortScoutDrone_GetForwardAndRightDotProducts_Native_Params Parms;
...
struct FRotator AFortScoutDrone::GetDeltaRotator()
{
	static auto Func = Class->GetFunction("FortScoutDrone", "GetDeltaRotator");

	Params::AFortScoutDrone_GetDeltaRotator_Params Parms;
...
class AFortPawn* AFortScoutDrone::GetControllingPlayerPawn()
{
	static auto Func = Class->GetFunction("FortScoutDrone", "GetControllingPlayerPawn");

	Params::AFortScoutDrone_GetControllingPlayerPawn_Params Parms;
...
void AFortScoutDrone::GameplayCue_Damage(enum class EGameplayCueEvent EventType, const struct FGameplayCueParameters& Parameters)
{
	static auto Func = Class->GetFunction("FortScoutDrone", "GameplayCue_Damage");

	Params::AFortScoutDrone_GameplayCue_Damage_Params Parms;
...
class AFortScoutDrone* UFortScoutDroneControllingComponent::GetControlledDrone()
{
