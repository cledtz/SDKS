...
{
public:
	class USoundBase*                            Pick_Up_Sound;                                     // 0x210(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("GCN_Athena_GenericHeldObject_PickUp_C");
		return Clss;
	}
