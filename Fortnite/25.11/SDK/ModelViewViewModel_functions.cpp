...
{
	static auto Func = Class->GetFunction("MVVMConversionLibrary", "Conv_BoolToSlateVisibility");
...
// FInterfaceProperty_                ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

FInterfaceProperty_ UMVVMViewModelContextResolver::K2_CreateInstance(class UClass* ExpectedType, class UUserWidget* UserWidget)
{
	static auto Func = Class->GetFunction("MVVMViewModelContextResolver", "K2_CreateInstance");
...
{
	static auto Func = Class->GetFunction("MVVMGameSubsystem", "GetViewModelCollection");
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// FInterfaceProperty_                NewValue                                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMVVMView::SetViewModelByClass(FInterfaceProperty_ NewValue)
{
	static auto Func = Class->GetFunction("MVVMView", "SetViewModelByClass");
...
// FInterfaceProperty_                ViewModel                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMVVMView::SetViewModel(class FName ViewModelName, FInterfaceProperty_ ViewModel)
{
...
FInterfaceProperty_ UMVVMView::GetViewModel(class FName ViewModelName)
{
	static auto Func = Class->GetFunction("MVVMView", "GetViewModel");
