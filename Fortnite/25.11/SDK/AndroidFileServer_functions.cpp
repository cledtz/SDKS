...
{
	static auto Func = Class->GetFunction("AndroidFileServerBPLibrary", "StopFileServer");
...
{
	static auto Func = Class->GetFunction("AndroidFileServerBPLibrary", "StartFileServer");
...
{
	static auto Func = Class->GetFunction("AndroidFileServerBPLibrary", "IsFileServerRunning");
