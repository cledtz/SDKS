...
public:
	...
	uint8                                        Pad_9E9E[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9E9F[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_9EA0[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9EA1[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_9EA2[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_9EA3[0x3];                                     // Fixing Size After Last Property..
	...
	class UCommonButtonLegacy*                   K2Node_ComponentBoundEvent_Button_1;               // 0x150(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue;                // 0x158(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_bCursorModeEnabled;                   // 0x160(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9EA6[0x7];                                     // Fixing Size After Last Property..
	class UCommonButtonLegacy*                   K2Node_ComponentBoundEvent_Button;                 // 0x168(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsUsingTouch_ReturnValue;                 // 0x170(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ECommonInputType                  K2Node_Event_NewInputType;                         // 0x171(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanOR_ReturnValue;                    // 0x172(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9EA7[0x1];                                     // Fixing Size After Last Property..
	...
	class UIconTextButton_C*                     K2Node_Select_Default;                             // 0x178(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UFortUINotification*                   K2Node_Event_Notification_1;                       // 0x180(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortUINotification*                   K2Node_Event_Notification;                         // 0x188(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
