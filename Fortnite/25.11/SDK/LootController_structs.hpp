...
{
public:
	class ABuildingContainer*                    BuildingContainer;                                 // 0x0(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7E62[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7E65[0x4];                                     // Fixing Size After Last Property..
