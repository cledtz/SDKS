...
public:
	...
	uint8                                        Pad_82A5[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	class AFortPlayerControllerZone*             PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class AFortPlayerControllerAthena*           PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_82A7[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_82A8[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_82AB[0x7];                                     // Fixing Size After Last Property..
