...
public:
	...
	uint8                                        Pad_38AC[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38AD[0x28];                                    // Fixing Size After Last Property..
	struct FConversationParticipants             Participants;                                      // 0x50(0x10)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_38AE[0x148];                                   // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_38B5[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38B7[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_38B8[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_38B9[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_38BA[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_38BB[0x160];                                   // Fixing Size Of Struct..
