...
void ABP_PlayerPawn_Athena_Phoebe_C::ComputeCosmeticVariantID(bool CallFunc_Less_IntInt_ReturnValue, class UAthenaAIServicePlayerBots* CallFunc_GetAIServicePlayerBots_ReturnValue, int32 CallFunc_FetchNextCustomBotCosmeticVariantID_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::ABP_PlayerPawn_Athena_Phoebe_C_ComputeCosmeticVariantID_Params Parms;
...
void ABP_PlayerPawn_Athena_Phoebe_C::AssignCosmeticVariant(bool CallFunc_GreaterEqual_IntInt_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, class USkeletalMeshComponent* CallFunc_GetSkeletalMeshForPartType_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_SetCustomPrimitiveDataFloat_Value_ImplicitCast)
{
	...
	Params::ABP_PlayerPawn_Athena_Phoebe_C_AssignCosmeticVariant_Params Parms;
...
void ABP_PlayerPawn_Athena_Phoebe_C::OnCharacterCustomizationCompleted(class AFortPlayerPawn* Pawn)
{
	...
	Params::ABP_PlayerPawn_Athena_Phoebe_C_OnCharacterCustomizationCompleted_Params Parms;
