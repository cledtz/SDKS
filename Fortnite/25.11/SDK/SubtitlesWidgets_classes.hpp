...
public:
	...
	uint8                                        Pad_13DF[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_13E0[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_13E1[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_13E2[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_13E3[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_13E4[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_13E5[0x18];                                    // Fixing Size After Last Property..
	struct FSubtitleFormat                       SubtitleFormat;                                    // 0x48(0x4)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_13E6[0x4];                                     // Fixing Size Of Struct..
