...
public:
	...
	struct FVector                               LocalPlayerLocation;                               // 0x550(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FScalableFloat                        StencilDuration;                                   // 0x580(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
