...
public:
	...
	uint8                                        Pad_80F7[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_80F8[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_80F9[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x18(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_80FA[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_80FB[0x7];                                     // Fixing Size Of Struct..
};
