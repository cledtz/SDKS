...
{
public:
	uint8                                        Pad_7970[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7971[0x68];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7972[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7973[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7974[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_7977[0x20];                                    // Fixing Size After Last Property..
	TArray<class UVerseFortnitePlayspaceExtensionBase*> Extensions;                                        // 0x68(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_7978[0x50];                                    // Fixing Size Of Struct..
