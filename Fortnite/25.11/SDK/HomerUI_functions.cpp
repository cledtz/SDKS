...
void UFortHomerComponent::HandlePawnEmoteStopped(class UFortItemDefinition* MontageItemDef, class AFortPawn* PawnEmoting)
{
...
void UFortHomerComponent::HandleLocalPlayerEliminatedPlayer(class AFortPlayerStateAthena* Player)
{
