...
public:
	...
	uint8                                        Pad_7E15[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E17[0x4];                                     // Fixing Size Of Struct..
};
...
public:
	enum class EInteractionRange                 TargetInteractionRange;                            // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7E19[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7E2D[0x4];                                     // Fixing Size Of Struct..
};
