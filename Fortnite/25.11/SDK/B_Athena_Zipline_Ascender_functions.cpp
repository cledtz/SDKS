...
TArray<enum class EFortTeamAffiliation> AB_Athena_Zipline_Ascender_C::GetAffiliationsToShowFor(TArray<enum class EFortTeamAffiliation>& K2Node_MakeArray_Array)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetAffiliationsToShowFor");

	Params::AB_Athena_Zipline_Ascender_C_GetAffiliationsToShowFor_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::ShouldShowSoundIndicator(class AFortPlayerController* PlayerController, bool CallFunc_IsValid_ReturnValue, enum class EFortTeamAffiliation CallFunc_GetTeamAffiliation_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "ShouldShowSoundIndicator");

	Params::AB_Athena_Zipline_Ascender_C_ShouldShowSoundIndicator_Params Parms;
...
enum class EDynamicDestructionResourceType AB_Athena_Zipline_Ascender_C::GetDynamicDestructionResourceType()
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetDynamicDestructionResourceType");

	Params::AB_Athena_Zipline_Ascender_C_GetDynamicDestructionResourceType_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::ShouldUseDynamicDestructionNiagaraSystem()
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "ShouldUseDynamicDestructionNiagaraSystem");

	Params::AB_Athena_Zipline_Ascender_C_ShouldUseDynamicDestructionNiagaraSystem_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::ShouldUseDynamicDestructionMaterial()
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "ShouldUseDynamicDestructionMaterial");

	Params::AB_Athena_Zipline_Ascender_C_ShouldUseDynamicDestructionMaterial_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::OnRep_BeDestroy()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_OnRep_BeDestroy_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::CanBeginZiplining(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent, bool CallFunc_CanBeginZiplining_ReturnValue, bool CallFunc_IsDBNO_ReturnValue, class AFortPlayerPawn* CallFunc_GetDBNOHoistee_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "CanBeginZiplining");

	Params::AB_Athena_Zipline_Ascender_C_CanBeginZiplining_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::LocalOnFailedInteract(class AFortPlayerPawn* InteractingPawn)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "LocalOnFailedInteract");

	Params::AB_Athena_Zipline_Ascender_C_LocalOnFailedInteract_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::GetBoundsComponents(class AActor* SelfActor, TArray<class USceneComponent*>* OutComponents)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetBoundsComponents");

	Params::AB_Athena_Zipline_Ascender_C_GetBoundsComponents_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::ApplyStructureDamage(class ABuildingSMActor* BuildingActor, class AActor* DamageSource, class UAbilitySystemComponent* CallFunc_GetAbilitySystemComponent_ReturnValue, TArray<TSubclassOf<class UGameplayEffect>>& K2Node_MakeArray_Array, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "ApplyStructureDamage");

	Params::AB_Athena_Zipline_Ascender_C_ApplyStructureDamage_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::AttemptOverrideZiplineSocketOffset(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent, struct FVector& BaseSocketOffset, struct FVector* OutSocketOffset, bool Temp_bool_Variable, class UPrimitiveComponent* CallFunc_GetHandleComponent_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, const struct FVector& K2Node_Select_Default, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "AttemptOverrideZiplineSocketOffset");

	Params::AB_Athena_Zipline_Ascender_C_AttemptOverrideZiplineSocketOffset_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::CalculateLaunchVelocity(class AActor* PlayerPawn, struct FVector* LaunchVelocity, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue_1, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_MakeVector_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, double CallFunc_MakeVector_Z_ImplicitCast)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "CalculateLaunchVelocity");

	Params::AB_Athena_Zipline_Ascender_C_CalculateLaunchVelocity_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::SetCableTilingBySplineLength(float CallFunc_GetSplineLength_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, int32 CallFunc_FTrunc_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_Divide_DoubleDouble_A_ImplicitCast, float CallFunc_SetScalarParameterValueOnMaterials_ParameterValue_ImplicitCast)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "SetCableTilingBySplineLength");

	Params::AB_Athena_Zipline_Ascender_C_SetCableTilingBySplineLength_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::HotfixEnabled(bool CallFunc_GetValueAsBool_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "HotfixEnabled");

	Params::AB_Athena_Zipline_Ascender_C_HotfixEnabled_Params Parms;
...
class UPrimitiveComponent* AB_Athena_Zipline_Ascender_C::GetTopComponent()
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetTopComponent");

	Params::AB_Athena_Zipline_Ascender_C_GetTopComponent_Params Parms;
...
class UPrimitiveComponent* AB_Athena_Zipline_Ascender_C::GetHandleComponent()
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetHandleComponent");

	Params::AB_Athena_Zipline_Ascender_C_GetHandleComponent_Params Parms;
...
bool AB_Athena_Zipline_Ascender_C::PawnIsInHandleRange(class AFortPawn* Pawn, TArray<class AActor*>& CallFunc_GetOverlappingActors_OverlappingActors, bool CallFunc_Array_Contains_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "PawnIsInHandleRange");

	Params::AB_Athena_Zipline_Ascender_C_PawnIsInHandleRange_Params Parms;
...
class FText AB_Athena_Zipline_Ascender_C::BlueprintGetInteractionString(class AFortPawn* InteractingPawn, enum class EInteractionBeingAttempted InteractionBeingAttempted, bool Temp_bool_Variable, class FText Temp_text_Variable, class FText Temp_text_Variable_1, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, class FText K2Node_Select_Default)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "BlueprintGetInteractionString");

	Params::AB_Athena_Zipline_Ascender_C_BlueprintGetInteractionString_Params Parms;
...
int32 AB_Athena_Zipline_Ascender_C::GetLastSplinePointIndex(int32 CallFunc_GetNumberOfSplinePoints_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "GetLastSplinePointIndex");

	Params::AB_Athena_Zipline_Ascender_C_GetLastSplinePointIndex_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::UserConstructionScript(bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "UserConstructionScript");

	Params::AB_Athena_Zipline_Ascender_C_UserConstructionScript_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::OnReady_93837FC44A18F6AE57D3478CC43A98AB(class AFortGameStateAthena* GameState, class UFortPlaylist* Playlist, struct FGameplayTagContainer& PlaylistContextTags)
{
	static auto Func = Class->GetFunction("B_Athena_Zipline_Ascender_C", "OnReady_93837FC44A18F6AE57D3478CC43A98AB");

	Params::AB_Athena_Zipline_Ascender_C_OnReady_93837FC44A18F6AE57D3478CC43A98AB_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandlePlayerStartedUsingHandle(class AFortPlayerPawn* Player)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandlePlayerStartedUsingHandle_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandlePlayerStoppedUsingHandle(class AFortPlayerPawn* Player)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandlePlayerStoppedUsingHandle_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandleStartedLoweringCable()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandleStartedLoweringCable_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandleStartedLoweringHandle()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandleStartedLoweringHandle_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandleStoppedLoweringCable()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandleStoppedLoweringCable_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandleStoppedLoweringHandle()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandleStoppedLoweringHandle_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::OnZipliningStarted(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_OnZipliningStarted_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::PlayerDescendingStarted(class AFortPlayerPawn* Sliding_Player)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_PlayerDescendingStarted_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::ReceiveBeginPlay()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_ReceiveBeginPlay_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::BP_HandleUpdatedLoweringCable()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_BP_HandleUpdatedLoweringCable_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::OnZipliningStopped(class AFortPlayerPawn* InteractingPawn, class UPrimitiveComponent* InteractComponent, float ZiplineUsageDuration)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_OnZipliningStopped_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::ShouldPlayWhooshTimer()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_ShouldPlayWhooshTimer_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::OnAscenderSetupComplete_Event()
{
	...
	Params::AB_Athena_Zipline_Ascender_C_OnAscenderSetupComplete_Event_Params Parms;
...
void AB_Athena_Zipline_Ascender_C::HandleLinkedActorDestroyed(class AActor* DamageCauser)
{
	...
	Params::AB_Athena_Zipline_Ascender_C_HandleLinkedActorDestroyed_Params Parms;
...
// class AFortPlayerPawn*             K2Node_Event_Player                                              (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct FVector                     CallFunc_K2_GetComponentLocation_ReturnValue                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortPlayerPawn*             CallFunc_GetPawnUsingHandle_ReturnValue                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortPlayerPawn*             K2Node_Event_Player_1                                            (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class AFortPlayerPawn*             CallFunc_GetPawnUsingHandle_ReturnValue_1                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_NotEqual_ObjectObject_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AFortPlayerPawn*             K2Node_CustomEvent_Sliding_Player                                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue_1                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue_2                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class AFortPlayerPawn*             CallFunc_GetPawnUsingHandle_ReturnValue_2                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class AFortPlayerPawn*             CallFunc_GetPawnUsingHandle_ReturnValue_3                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
