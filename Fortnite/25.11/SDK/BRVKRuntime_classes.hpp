...
{
public:
	uint8                                        Pad_15BE[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_15C0[0x7];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_15C1[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_15C2[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_15C3[0x8];                                     // Fixing Size Of Struct..
...
class AFortBRVKPlayspace : public AFortPlayspace
{
public:
	class UFortLevelStreamComponent*             LevelStreamComponent;                              // 0x690(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortProjectPlayComponent*             ProjectPlayComponent;                              // 0x698(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
class AFortBRVKTheBlockMutator : public AFortAthenaMutator_GameModeBase
{
public:
	bool                                         bContentIsReadyOrFailed;                           // 0x450(0x1)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_15C4[0x27];                                    // Fixing Size After Last Property..
	class AFortGameModeAthena*                   CachedGameModeAthena;                              // 0x478(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
