...
public:
	...
	struct FScalableFloat                        Row_TickInterval;                                  // 0x968(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScalableFloat                        Row_MaxHeals;                                      // 0x990(0x28)(Edit, BlueprintVisible, DisableEditOnInstance)
