...
{
	static auto Func = Class->GetFunction("VerseFortniteCharacter", "HandlePosessedPawnChanged");

	Params::UVerseFortniteCharacter_HandlePosessedPawnChanged_Params Parms;
