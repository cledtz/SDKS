...
void URidableComponent::HandleRiderEndPlay(class AActor* Actor, enum class EEndPlayReason EndPlayReason)
{
...
void UControllableRidableComponent::OnCapsuleBeginOverlap(class UPrimitiveComponent* OverlappedComp, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
...
void URiderComponent::OnMovementModeChanged(class ACharacter* InCharacter, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode)
{
...
void URiderComponent::HandleActorEndPlayWhileRiding(class AActor* Actor, enum class EEndPlayReason EndPlayReason)
{
