...
{
	static auto Func = Class->GetFunction("AssetRegistryHelpers", "GetBlueprintAssets");
...
FInterfaceProperty_ UAssetRegistryHelpers::GetAssetRegistry()
{
...
{
	static auto Func = Class->GetFunction("AssetRegistryHelpers", "FindAssetNativeClass");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "WaitForPackage");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "WaitForCompletion");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "K2_GetAssetByObjectPath");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "IsSearchAsync");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "IsSearchAllAssets");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "GetDerivedClassNames");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "GetAssetsByPaths");
...
{
	static auto Func = Class->GetFunction("AssetRegistry", "GetAncestorClassNames");
