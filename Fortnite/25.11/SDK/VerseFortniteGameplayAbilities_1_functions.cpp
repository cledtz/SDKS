...
// Function VerseFortniteGameplayAbilities.Game_Abilities_ability_component.ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R
...
class UConcurrency_task* UGame_Abilities_ability_component::ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R(class UConcurrency_task* __verse_0xC1E81372_CallingTask, int64 __verse_0xA3A00DDB_CallerResumeState, int64 __verse_0x2AC0E4D8_CallerCancelState, const struct FTuple_Lgameplay__ability__asset_M_QTarget_N_Qagent_20_3d_20_2e_2e_2e_R& __verse_0xB2CDDD72_Argument, FOptionProperty_ _ExprResult_0, FOptionProperty_ __verse_0x00000000__1, uint8 _ExprResult_1, FOptionProperty_ _ExprResultStack_2)
{
	static auto Func = Class->GetFunction("Game_Abilities_ability_component", "ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R");

	Params::UGame_Abilities_ability_component_ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R_Params Parms;
...
// Function VerseFortniteGameplayAbilities.task_Game_Abilities_ability_component$ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R.Update
// (Native, Public, HasOutParams)
// Parameters:
// int64                              RetVal                                                           (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

int64 UTask_Game_Abilities_ability_component_ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R::Update()
{
	static auto Func = Class->GetFunction("task_Game_Abilities_ability_component$ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R", "Update");

	Params::UTask_Game_Abilities_ability_component_ActivateAbility_L_Ngameplay__ability__asset_M_N_Qagent_R_Update_Params Parms;
