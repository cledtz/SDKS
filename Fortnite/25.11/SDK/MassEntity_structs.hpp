...
{
public:
	uint8                                        Pad_40CD[0x1E8];                                   // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40CE[0xB8];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40CF[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40D0[0x1];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40D1[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40D2[0x80];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_40D3[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40D5[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_40D8[0x17];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_40DA[0x48];                                    // Fixing Size Of Struct..
};
