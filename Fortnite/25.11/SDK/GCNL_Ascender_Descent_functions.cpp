...
void AGCNL_Ascender_Descent_C::OnLoopingStartGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Ascender_Descent_C", "OnLoopingStartGeneric");

	Params::AGCNL_Ascender_Descent_C_OnLoopingStartGeneric_Params Parms;
...
void AGCNL_Ascender_Descent_C::VisualizeAudio()
{
	...
	Params::AGCNL_Ascender_Descent_C_VisualizeAudio_Params Parms;
...
void AGCNL_Ascender_Descent_C::OnRemovalGeneric(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Ascender_Descent_C", "OnRemovalGeneric");

	Params::AGCNL_Ascender_Descent_C_OnRemovalGeneric_Params Parms;
