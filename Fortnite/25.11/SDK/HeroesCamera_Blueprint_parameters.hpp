...
struct AHeroesCamera_Blueprint_C_BP_OnActivated_Params
{
public:
...
struct AHeroesCamera_Blueprint_C_BP_OnDeactivated_Params
{
public:
	class AFortPlayerController*                 PlayerController;                                  // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_9A73[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A74[0x4];                                     // Fixing Size After Last Property..
	struct FKey                                  K2Node_InputKeyEvent_Key_2;                        // 0x80(0x18)(HasGetValueTypeHash)
	class AFortPlayerController*                 K2Node_Event_PlayerController_1;                   // 0x98(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AFortPlayerController*                 K2Node_Event_PlayerController;                     // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9A75[0x4];                                     // Fixing Size After Last Property..
	...
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors;            // 0xE8(0x10)(ReferenceParm)
	...
	class ATVPostProcessBP_C*                    CallFunc_Array_Get_Item;                           // 0x100(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_Length_ReturnValue;                 // 0x108(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9A77[0x4];                                     // Fixing Size After Last Property..
	struct FRotator                              CallFunc_K2_GetActorRotation_ReturnValue;          // 0x110(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue_2;        // 0x128(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9A78[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A79[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_9A7A[0x2];                                     // Fixing Size After Last Property..
