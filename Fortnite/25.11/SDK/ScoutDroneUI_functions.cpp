...
class AFortScoutDrone* UScoutDroneHUD::GetControlledDrone()
{
...
class AFortScoutDrone* UScoutDroneTetherIndicator::GetControlledDrone()
{
...
void AScoutDroneUIDirector::BP_OnScoutDroneDismissed()
{
	...
	Params::AScoutDroneUIDirector_BP_OnScoutDroneDismissed_Params Parms;
...
void AScoutDroneUIDirector::BP_OnScoutDroneDeployed()
{
	...
	Params::AScoutDroneUIDirector_BP_OnScoutDroneDeployed_Params Parms;
