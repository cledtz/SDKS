...
{
public:
	uint8                                        Pad_7D03[0x90];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7D04[0x8];                                     // Fixing Size After Last Property..
	class UVoteBroadcasterComponent*             VoteBroadcasterComponent;                          // 0x290(0x8)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_7D0D[0x7];                                     // Fixing Size After Last Property..
