...
public:
	...
	uint8                                        Pad_82EC[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_82ED[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_82EE[0x10];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_82EF[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_82F0[0x7];                                     // Fixing Size After Last Property..
	struct FPiPPartnerSource                     CurrentSource;                                     // 0x1D0(0x128)(ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPiPPartnerSource>             Sources;                                           // 0x2F8(0x10)(ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPiPPartnerSource>             ValidSources;                                      // 0x308(0x10)(ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FMediaPlayerOptions                   LocalOptions;                                      // 0x318(0x30)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_            BaseErrorEvent;                                    // 0x348(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_            BaseEnabledEvent;                                  // 0x358(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_            SourcesChangedEvent;                               // 0x368(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_            SourceSelectedEvent;                               // 0x378(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_82F1[0x8];                                     // Fixing Size After Last Property..
	TArray<struct FPictureInPictureActionConfig> InstanceActionData;                                // 0x390(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class UPictureInPictureAnalyticsManager*     AnalyticsManager;                                  // 0x3A0(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDateTime                             ActiveStartTime;                                   // 0x3A8(0x8)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDateTime                             PausedStartTime;                                   // 0x3B0(0x8)(ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_82F2[0x8];                                     // Fixing Size After Last Property..
	struct FPiPSuspendInfo                       SuspendedInfo;                                     // 0x3C0(0x130)(ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_82F3[0x68];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_82F4[0x10];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_82F6[0xE0];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_82F7[0x50];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_82F8[0x38];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_82F9[0x7];                                     // Fixing Size After Last Property..
