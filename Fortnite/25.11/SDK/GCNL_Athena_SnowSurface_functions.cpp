...
void AGCNL_Athena_SnowSurface_C::OnRemoval(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class ADecalActor* BurstDecalInstance)
{
...
void AGCNL_Athena_SnowSurface_C::K2_HandleGameplayCue(class AActor* MyTarget, enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
	static auto Func = Class->GetFunction("GCNL_Athena_SnowSurface_C", "K2_HandleGameplayCue");

	Params::AGCNL_Athena_SnowSurface_C_K2_HandleGameplayCue_Params Parms;
...
// class AActor*                      K2Node_Event_MyTarget_3                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class AFortReplaySpectatorAthena*  K2Node_DynamicCast_AsFort_Replay_Spectator_Athena                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
