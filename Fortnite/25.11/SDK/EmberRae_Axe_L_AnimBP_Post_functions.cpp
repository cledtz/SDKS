...
{
	static auto Func = Class->GetFunction("EmberRae_Axe_L_AnimBP_Post_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("EmberRae_Axe_L_AnimBP_Post_C", "BlueprintUpdateAnimation");
...
{
	static auto Func = Class->GetFunction("EmberRae_Axe_L_AnimBP_Post_C", "BlueprintInitializeAnimation");
...
{
	static auto Func = Class->GetFunction("EmberRae_Axe_L_AnimBP_Post_C", "ExecuteUbergraph_EmberRae_Axe_L_AnimBP_Post");
