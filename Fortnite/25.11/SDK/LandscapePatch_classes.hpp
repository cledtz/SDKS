...
{
public:
	TSoftObjectPtr<class ALandscape>             Landscape;                                         // 0x2A0(0x28)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class ALandscapePatchManager> PatchManager;                                      // 0x2C8(0x28)(Edit, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_8716[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8717[0x4];                                     // Fixing Size After Last Property..
	TSoftObjectPtr<class ALandscapePatchManager> PreviousPatchManager;                              // 0x2F8(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_8718[0x6];                                     // Fixing Size Of Struct..
...
{
public:
	TArray<TSoftObjectPtr<class ULandscapePatchComponent>> PatchComponents;                                   // 0x288(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_8719[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_871A[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_871B[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_871C[0x3];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_871D[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_871E[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_872B[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_872D[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_872E[0x6];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_872F[0x1];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8730[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8731[0x3];                                     // Fixing Size Of Struct..
