...
public:
	...
	uint8                                        Pad_1F05[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F06[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	class FName                                  CategoryName;                                      // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1F07[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	class AGameplayDebuggerCategoryReplicator*   Owner;                                             // 0x0(0x8)(ZeroConstructor, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1F09[0x2];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F0A[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1F0B[0x1];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_1F0D[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	class AGameplayDebuggerCategoryReplicator*   Replicator;                                        // 0x10(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
