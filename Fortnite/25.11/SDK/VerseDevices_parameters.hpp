...
struct AScriptDevice_SetEnabled_Params
{
public:
...
struct AScriptDevice_HandlePreMinigameStartedSetup_Params
{
public:
};
...
struct AScriptDevice_HandleMinigameEndGame_Params
{
public:
	...
	uint8                                        Pad_79D8[0x6];                                     // Fixing Size Of Struct..
};

// 0x1 (0x1 - 0x0)
// Function VerseDevices.ScriptDevice.BP_SetVisibility
struct AScriptDevice_BP_SetVisibility_Params
{
public:
