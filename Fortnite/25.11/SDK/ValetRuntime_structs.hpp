...
public:
	...
	uint8                                        Pad_7C95[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7C96[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        BitPad_412 : 6;                                    // Fixing Bit-Field Size..
	uint8                                        Pad_7C97[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7C99[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7C9A[0x48];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7C9B[0xB8];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7C9C[0x6];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7C9D[0x10];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7C9E[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7C9F[0x4];                                     // Fixing Size After Last Property..
...
public:
	int32                                        Frame;                                             // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7CA0[0x4];                                     // Fixing Size After Last Property..
	struct FFortDagwoodCmd                       InputCmd;                                          // 0x8(0x30)(NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_7CA1[0x8];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_7CA2[0x90];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7CA3[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7CA4[0x7];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_7CA5[0x18];                                    // Fixing Size Of Struct..
};
