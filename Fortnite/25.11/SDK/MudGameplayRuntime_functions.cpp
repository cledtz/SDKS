...
void UFortPawnComponent_Mud::HandleSurfaceTypeChanged(class AActor* SurfaceActor, enum class EPhysicalSurface CurrentSurfaceType, enum class EPhysicalSurface PrevSurfaceType)
{
