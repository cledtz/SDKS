...
{
public:
	uint8                                        Pad_4036[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4037[0x8];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_4039[0x27];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_403C[0x34];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_403D[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_403F[0x47];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4042[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4043[0x74];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4049[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_404A[0x7];                                     // Fixing Size After Last Property..
	...
	class AFortItemPreviewWorld*                 CachedVaultWorld;                                  // 0x7C0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_404B[0x10];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_404C[0x360];                                   // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_404D[0xE8];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_404E[0x20];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_404F[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4050[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4051[0x6F];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4052[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4053[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4056[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_4058[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_405A[0x38];                                    // Fixing Size Of Struct..
