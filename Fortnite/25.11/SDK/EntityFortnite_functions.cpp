...
void AEntityFortniteStormSpawner::Stop()
{
	...
	Params::AEntityFortniteStormSpawner_Stop_Params Parms;
...
void AEntityFortniteStormSpawner::Start(float StartRadius, float BoundsRadius, TArray<struct FEntityFortniteStormPhase>& Phases)
{
	static auto Func = Class->GetFunction("EntityFortniteStormSpawner", "Start");

	Params::AEntityFortniteStormSpawner_Start_Params Parms;
...
void AEntityFortniteStormSpawner::Pause()
{
	...
	Params::AEntityFortniteStormSpawner_Pause_Params Parms;
...
bool AEntityFortniteStormSpawner::Exists()
{
	static auto Func = Class->GetFunction("EntityFortniteStormSpawner", "Exists");

	Params::AEntityFortniteStormSpawner_Exists_Params Parms;
