...
public:
	...
	uint8                                        Pad_9329[0x7];                                     // Fixing Size After Last Property..
	...
	FInterfaceProperty_                          CallFunc_SpawnGenericCameraLensEffect_ReturnValue; // 0xF0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	class APlayerController*                     CallFunc_GetLocalViewingPlayerController_ReturnValue; // 0x100(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	FInterfaceProperty_                          CallFunc_GetVehicleUInterface_ReturnValue;         // 0x108(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
