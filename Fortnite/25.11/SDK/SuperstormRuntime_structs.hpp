...
{
public:
	class AFortPawn*                             SourcePawn;                                        // 0x0(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_8594[0x40];                                    // Fixing Size After Last Property..
	class AFortGameplayEffectDeliveryActor*      LightningBolt;                                     // 0x48(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class AActor*>                        TargetActors;                                      // 0x50(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class AFortPawn*>                     TargetPawns;                                       // 0x60(0x10)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                        Pad_8595[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_8596[0x50];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_8598[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_8599[0x5];                                     // Fixing Size Of Struct..
};
