...
void ABP_PlayerPawn_Tandem_C::OnRep_HealthInfo()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_OnRep_HealthInfo_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::HandlePawnUnconverted(class AFortPawn* UnconvertedPawn)
{
	...
	Params::ABP_PlayerPawn_Tandem_C_HandlePawnUnconverted_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::HandlePawnConverted(class AFortPawn* InstigatorPawn, class AFortPawn* ConvertedPawn, uint8 CallFunc_GetActorTeam_ReturnValue)
{
	static auto Func = Class->GetFunction("BP_PlayerPawn_Tandem_C", "HandlePawnConverted");

	Params::ABP_PlayerPawn_Tandem_C_HandlePawnConverted_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::UpdateConvertIndicator(bool CallFunc_HasAuthority_ReturnValue, class AFortPlayerController* CallFunc_GetFirstLocalFortPlayerController_ReturnValue, uint8 CallFunc_GetActorTeam_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static auto Func = Class->GetFunction("BP_PlayerPawn_Tandem_C", "UpdateConvertIndicator");

	Params::ABP_PlayerPawn_Tandem_C_UpdateConvertIndicator_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::StartHealthBar()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_StartHealthBar_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::StartUpdatingHealthWidget()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_StartUpdatingHealthWidget_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::StopUpdatingHealthWidget()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_StopUpdatingHealthWidget_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::PawnHealthChanged()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_PawnHealthChanged_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("BP_PlayerPawn_Tandem_C", "ReceiveEndPlay");

	Params::ABP_PlayerPawn_Tandem_C_ReceiveEndPlay_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class AFortPawn* InstigatedBy, class AActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("BP_PlayerPawn_Tandem_C", "OnDeathPlayEffects");

	Params::ABP_PlayerPawn_Tandem_C_OnDeathPlayEffects_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::NPCSetupHealthBarOnDeath()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_NPCSetupHealthBarOnDeath_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::WidgetVisibilityChanged(bool bVisible)
{
	...
	Params::ABP_PlayerPawn_Tandem_C_WidgetVisibilityChanged_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::NPCTandemDisableHealthBar()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_NPCTandemDisableHealthBar_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::NPCTandemEnableHealthBars()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_NPCTandemEnableHealthBars_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::EnableHiredTandemHealthBar()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_EnableHiredTandemHealthBar_Params Parms;
...
void ABP_PlayerPawn_Tandem_C::EnableTandemHealthBar()
{
	...
	Params::ABP_PlayerPawn_Tandem_C_EnableTandemHealthBar_Params Parms;
