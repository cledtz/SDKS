...
{
public:
	class AFortTankVehicle*                      OwningTankVehicle;                                 // 0x478(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_807E[0xE];                                     // Fixing Size Of Struct..
