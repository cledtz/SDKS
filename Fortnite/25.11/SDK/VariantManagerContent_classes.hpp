...
public:
	...
	uint8                                        Pad_428D[0x50];                                    // Fixing Size Of Struct..
...
{
public:
	struct FSoftObjectPath                       LevelVariantSets;                                  // 0x288(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class UObject>, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                 // 0x2A0(0x50)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_4291[0x18];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4292[0x60];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_4293[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4295[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_4296[0x6F];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_4297[0x18];                                    // Fixing Size After Last Property..
	class USceneComponent*                       SceneComponent;                                    // 0x2A0(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                        LastSelectedOption;                                // 0x2A8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4298[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_42A0[0x18];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_42A1[0x4];                                     // Fixing Size After Last Property..
