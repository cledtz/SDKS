...
{
public:
	uint8                                        Pad_1CEB[0x20];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1CEC[0x50];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_1CED[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_1CEE[0x4];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_1CEF[0x1];                                     // Fixing Size Of Struct..
};
