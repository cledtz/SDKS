...
struct AGCNL_Irwin_Player_Prey_Nug_Float_C_ReceiveBeginPlay_Params
{
public:
};
...
struct AGCNL_Irwin_Player_Prey_Nug_Float_C_OnRemovalGeneric_Params
{
public:
...
struct AGCNL_Irwin_Player_Prey_Nug_Float_C_OnLoopingStartGeneric_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Irwin_Player_Prey_Nug_Float_C_ExecuteUbergraph_GCNL_Irwin_Player_Prey_Nug_Float_Params
{
public:
	...
	uint8                                        Pad_7FAF[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7FB0[0x7];                                     // Fixing Size After Last Property..
