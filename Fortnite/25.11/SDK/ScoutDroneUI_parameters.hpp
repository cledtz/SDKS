...
{
public:
	class AFortScoutDrone*                       Drone;                                             // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct AScoutDroneUIDirector_BP_OnScoutDroneDismissed_Params
{
public:
};
...
struct AScoutDroneUIDirector_BP_OnScoutDroneDeployed_Params
{
public:
};
