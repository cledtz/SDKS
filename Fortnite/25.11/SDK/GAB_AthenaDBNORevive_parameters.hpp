...
public:
	...
	uint8                                        Pad_85BB[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_85BC[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_85BD[0x4];                                     // Fixing Size After Last Property..
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable_1;                            // 0x78(0x28)()
	...
	uint8                                        Pad_85BE[0x4];                                     // Fixing Size After Last Property..
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable_3;                            // 0x118(0x28)()
	...
	uint8                                        Pad_85BF[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_85C0[0x6];                                     // Fixing Size After Last Property..
	struct FGameplayAbilityActorInfo             CallFunc_GetActorInfo_ReturnValue;                 // 0x218(0x48)(ContainsInstancedReference)
	class AFortPlayerPawn*                       K2Node_DynamicCast_AsFort_Player_Pawn;             // 0x260(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x268(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_85C1[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_85C2[0x3];                                     // Fixing Size After Last Property..
	...
	struct FFortGameplayAbilityMontageInfo       K2Node_MakeStruct_FortGameplayAbilityMontageInfo;  // 0x368(0x58)()
