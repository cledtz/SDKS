...
{
public:
	TWeakObjectPtr<class AActor>                 WarpTarget;                                        // 0x0(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        BitPad_421 : 1;                                    // Fixing Bit-Field Size..
	...
	uint8                                        Pad_7E4F[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E50[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E51[0x38];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E54[0x3];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7E55[0x2];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E57[0x3];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_7E58[0x2];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_7E59[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_7E5A[0x10];                                    // Fixing Size Of Struct..
};
