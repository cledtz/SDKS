...
public:
	...
	uint8                                        Pad_8668[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	class UDynamicUIScene*                       MemorySamplingScene;                               // 0x2B8(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_8669[0x20];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_866A[0x8];                                     // Fixing Size After Last Property..
