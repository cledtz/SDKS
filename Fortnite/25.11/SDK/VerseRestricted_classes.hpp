...
public:
	...
	class UClass* _L_2fVerse_2eorg_2fRestricted_N_Rsticky__event_L_Ntype_R(class UClass* __verse_0xB2CDDD72_Argument);
...
public:
	...
	uint8                                        Pad_8A05[0x40];                                    // Fixing Size Of Struct..
