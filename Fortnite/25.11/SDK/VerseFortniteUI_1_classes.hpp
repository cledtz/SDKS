...
public:
	...
	class UObject* _L_2fFortnite_2ecom_2fUI_N_Roperator_U_2eGetHUDController_U_L_Nfort__playspace_M_Ntuple_L_R_R(const struct FTuple_Lfort__playspace_Mtuple_L_R_Mtuple_L_R_R& __verse_0xB2CDDD72_Argument);
	void _InitCDO();
};
...
{
public:
	uint8                                        Pad_8C63[0x98];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_8C64[0x27];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_8C6D[0x8];                                     // Fixing Size Of Struct..
