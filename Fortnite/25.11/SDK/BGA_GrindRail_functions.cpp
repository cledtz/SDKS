...
void ABGA_GrindRail_C::Is_Player_Exiting_This_Rail(class AFortPlayerPawn* Player, bool* bStillExiting, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, const struct FVector& CallFunc_FindUpVectorClosestToWorldLocation_ReturnValue, class UFortPawnComponent_GrindRail* CallFunc_GetComponentByClass_ReturnValue, double CallFunc_Dot_VectorVector_ReturnValue, class AActor* CallFunc_GetGrindBaseActor_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, bool CallFunc_GetWantsToGrind_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "Is Player Exiting This Rail");

	Params::ABGA_GrindRail_C_Is_Player_Exiting_This_Rail_Params Parms;
...
void ABGA_GrindRail_C::GetRailColorAndEmissive(struct FLinearColor* RailColor, double* ColorEmissiveScale, enum class EColorSelect Temp_byte_Variable, const struct FLinearColor& K2Node_Select_Default, const struct FLinearColor& CallFunc_LinearColor_Desaturated_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetRailColorAndEmissive");

	Params::ABGA_GrindRail_C_GetRailColorAndEmissive_Params Parms;
...
void ABGA_GrindRail_C::SpawnTipComponent(class UActorComponent** TipComponent, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class USceneComponent* CallFunc_AddComponentByClass_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "SpawnTipComponent");

	Params::ABGA_GrindRail_C_SpawnTipComponent_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "Generate Meshes Along Spline");

	Params::ABGA_GrindRail_C_Generate_Meshes_Along_Spline_Params Parms;
...
void ABGA_GrindRail_C::Try_Create_End_Tips(bool CallFunc_InEditor_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UObject* CallFunc_LoadAsset_Blocking_ReturnValue, class UStaticMesh* K2Node_DynamicCast_AsStatic_Mesh, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "Try Create End Tips");

	Params::ABGA_GrindRail_C_Try_Create_End_Tips_Params Parms;
...
void ABGA_GrindRail_C::DestroyAllTipMeshComponents(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class USceneComponent*>& CallFunc_K2_GetComponentsByClass_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UActorComponent* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "DestroyAllTipMeshComponents");

	Params::ABGA_GrindRail_C_DestroyAllTipMeshComponents_Params Parms;
...
void ABGA_GrindRail_C::RemoveAllMeshComponents(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class UMeshComponent*>& CallFunc_K2_GetComponentsByClass_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class UActorComponent* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "RemoveAllMeshComponents");

	Params::ABGA_GrindRail_C_RemoveAllMeshComponents_Params Parms;
...
void ABGA_GrindRail_C::GetMeshForSplineLength(double Segment_Length, class UStaticMesh** MeshToUse)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetMeshForSplineLength");

	Params::ABGA_GrindRail_C_GetMeshForSplineLength_Params Parms;
...
void ABGA_GrindRail_C::AddInteractionRailMeshComponent(class USplineMeshComponent** SplineMeshComponent, const struct FTransform& Temp_struct_Variable, class USplineMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "AddInteractionRailMeshComponent");

	Params::ABGA_GrindRail_C_AddInteractionRailMeshComponent_Params Parms;
...
void ABGA_GrindRail_C::AddSolidRailMeshComponent(double SegmentLength, class USplineMeshComponent** SplineMeshComponent, const struct FTransform& Temp_struct_Variable, class UStaticMesh* CallFunc_GetMeshForSplineLength_MeshToUse, class USplineMeshComponent* CallFunc_AddComponent_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "AddSolidRailMeshComponent");

	Params::ABGA_GrindRail_C_AddSolidRailMeshComponent_Params Parms;
...
void ABGA_GrindRail_C::GetRotationForTip(bool bEndTip, struct FRotator* Rotator, float CallFunc_GetSplineLength_ReturnValue, double CallFunc_SelectFloat_ReturnValue, const struct FTransform& CallFunc_GetTransformAtDistanceAlongSpline_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, double CallFunc_SelectFloat_A_ImplicitCast, float CallFunc_GetTransformAtDistanceAlongSpline_Distance_ImplicitCast)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetRotationForTip");

	Params::ABGA_GrindRail_C_GetRotationForTip_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "FillInBoosterInfo");

	Params::ABGA_GrindRail_C_FillInBoosterInfo_Params Parms;
...
bool ABGA_GrindRail_C::IsTipCapped(bool bStartTip, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "IsTipCapped");

	Params::ABGA_GrindRail_C_IsTipCapped_Params Parms;
...
float ABGA_GrindRail_C::GetLength(float CallFunc_GetSplineLength_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetLength");

	Params::ABGA_GrindRail_C_GetLength_Params Parms;
...
struct FVector ABGA_GrindRail_C::GetDirectionAtDistance(float Distance, const struct FVector& CallFunc_GetDirectionAtDistanceAlongSpline_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetDirectionAtDistance");

	Params::ABGA_GrindRail_C_GetDirectionAtDistance_Params Parms;
...
void ABGA_GrindRail_C::GetSnapPosition(struct FVector& CurrentPosition, struct FVector* OutPos, float* OutDistance, const struct FVector& CallFunc_FindLocationClosestToWorldLocation_ReturnValue, float CallFunc_FindInputKeyClosestToWorldLocation_ReturnValue, float CallFunc_GetDistanceAlongSplineAtSplineInputKey_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GetSnapPosition");

	Params::ABGA_GrindRail_C_GetSnapPosition_Params Parms;
...
bool ABGA_GrindRail_C::BlueprintGetInteractionTime(class AFortPawn* InteractingPawn, float* OutInteractionTime, enum class EInteractionBeingAttempted InteractionBeingAttempted)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "BlueprintGetInteractionTime");

	Params::ABGA_GrindRail_C_BlueprintGetInteractionTime_Params Parms;
...
bool ABGA_GrindRail_C::BlueprintOnLocalInteract(class AFortPlayerPawn* InteractingPawn, enum class EInteractionBeingAttempted InteractionBeingAttempted, class UBP_GrindingComponent_C* CallFunc_GetComponentByClass_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "BlueprintOnLocalInteract");

	Params::ABGA_GrindRail_C_BlueprintOnLocalInteract_Params Parms;
...
void ABGA_GrindRail_C::JumpOffMaterial(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class USplineMeshComponent* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "JumpOffMaterial");

	Params::ABGA_GrindRail_C_JumpOffMaterial_Params Parms;
...
void ABGA_GrindRail_C::StartedGrindingMaterial(int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, class USplineMeshComponent* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "StartedGrindingMaterial");

	Params::ABGA_GrindRail_C_StartedGrindingMaterial_Params Parms;
...
void ABGA_GrindRail_C::Unified_Material_and_UV(int32 FirstPoint, int32 SecondPoint, class USplineMeshComponent* Add_Spline_mesh, const struct FLinearColor& CallFunc_GetRailColorAndEmissive_RailColor, double CallFunc_GetRailColorAndEmissive_ColorEmissiveScale, const struct FLinearColor& CallFunc_Conv_DoubleToLinearColor_ReturnValue, const struct FLinearColor& CallFunc_Multiply_LinearColorLinearColor_ReturnValue, const struct FVector4& CallFunc_MakeVector4_ReturnValue, double CallFunc_Conv_BoolToDouble_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_Conv_BoolToDouble_ReturnValue_1, float CallFunc_GetDistanceAlongSplineAtSplinePoint_ReturnValue, float CallFunc_GetDistanceAlongSplineAtSplinePoint_ReturnValue_1, float CallFunc_GetSplineLength_ReturnValue, double CallFunc_Subtract_DoubleDouble_ReturnValue, float CallFunc_GetDistanceAlongSplineAtSplinePoint_ReturnValue_2, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_SafeDivide_ReturnValue, float CallFunc_GetDistanceAlongSplineAtSplinePoint_ReturnValue_3, double CallFunc_SafeDivide_ReturnValue_1, double CallFunc_MakeVector4_X_ImplicitCast, double CallFunc_MakeVector4_Y_ImplicitCast, double CallFunc_MakeVector4_Z_ImplicitCast, double CallFunc_MakeVector4_W_ImplicitCast, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast_1, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast_2, double CallFunc_Subtract_DoubleDouble_B_ImplicitCast, double CallFunc_Subtract_DoubleDouble_A_ImplicitCast, double CallFunc_SafeDivide_B_ImplicitCast, double CallFunc_SafeDivide_B_ImplicitCast_1, double CallFunc_SafeDivide_A_ImplicitCast, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast_3, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast_4, double CallFunc_SafeDivide_A_ImplicitCast_1, float CallFunc_SetDefaultCustomPrimitiveDataFloat_Value_ImplicitCast_5)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "Unified Material and UV");

	Params::ABGA_GrindRail_C_Unified_Material_and_UV_Params Parms;
...
void ABGA_GrindRail_C::BoosterLengthToSplineLength(struct FGrindRail_Booster_Directional& Booster, double Length_Along_Booster__cm_, double* Length_Along_Spline__cm_, float CallFunc_GetSplineLength_ReturnValue, double CallFunc_SelectFloat_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, double CallFunc_Subtract_DoubleDouble_ReturnValue, double CallFunc_SelectFloat_ReturnValue_1, double CallFunc_Add_DoubleDouble_ReturnValue, double CallFunc_Subtract_DoubleDouble_A_ImplicitCast)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "BoosterLengthToSplineLength");

	Params::ABGA_GrindRail_C_BoosterLengthToSplineLength_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "UserConstructionScript");

	Params::ABGA_GrindRail_C_UserConstructionScript_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "PutPlayerOnRail");

	Params::ABGA_GrindRail_C_PutPlayerOnRail_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "PutPlayerOnRail_Server");

	Params::ABGA_GrindRail_C_PutPlayerOnRail_Server_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "PutPlayerOnRail_ClientAndServer");

	Params::ABGA_GrindRail_C_PutPlayerOnRail_ClientAndServer_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "ReceiveBeginPlay");

	Params::ABGA_GrindRail_C_ReceiveBeginPlay_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GenerateRailComponents");

	Params::ABGA_GrindRail_C_GenerateRailComponents_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "DestroyStartTip");

	Params::ABGA_GrindRail_C_DestroyStartTip_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "DestroyEndTip");

	Params::ABGA_GrindRail_C_DestroyEndTip_Params Parms;
...
void ABGA_GrindRail_C::DestroyTip(class UActorComponent* Target)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "DestroyTip");

	Params::ABGA_GrindRail_C_DestroyTip_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "Tips");

	Params::ABGA_GrindRail_C_Tips_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "RedoSplineMesh");

	Params::ABGA_GrindRail_C_RedoSplineMesh_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "sprinting state");

	Params::ABGA_GrindRail_C_Sprinting_state_Params Parms;
...
void ABGA_GrindRail_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "ReceiveHit");

	Params::ABGA_GrindRail_C_ReceiveHit_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "HandlePlayerGrindStart");

	Params::ABGA_GrindRail_C_HandlePlayerGrindStart_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "StartedGrinding");

	Params::ABGA_GrindRail_C_StartedGrinding_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GrindRailChanged");

	Params::ABGA_GrindRail_C_GrindRailChanged_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "ForceClearBoosters");

	Params::ABGA_GrindRail_C_ForceClearBoosters_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "UpdateBoosterMeshes");

	Params::ABGA_GrindRail_C_UpdateBoosterMeshes_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "UpdateAllBoosterMeshesInLevel");

	Params::ABGA_GrindRail_C_UpdateAllBoosterMeshesInLevel_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "PushGrindingSoundMix");

	Params::ABGA_GrindRail_C_PushGrindingSoundMix_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "PopGrindingSoundMix");

	Params::ABGA_GrindRail_C_PopGrindingSoundMix_Params Parms;
...
{
	static auto Func = Class->GetFunction("BGA_GrindRail_C", "GenerateMeshesAlongSpline");

	Params::ABGA_GrindRail_C_GenerateMeshesAlongSpline_Params Parms;
...
// class APlayerPawn_Athena_C*        K2Node_CustomEvent_Player                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class APlayerPawn_Athena_C*        K2Node_CustomEvent_InputPin_1                                    (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UBP_GrindingComponent_C*     CallFunc_GetComponentByClass_ReturnValue                         (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_GetWantsToGrind_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Not_PreBool_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class APlayerPawn_Athena_C*        K2Node_CustomEvent_InputPin                                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class APlayerPawn_Athena_C*        K2Node_CustomEvent_AttachedPlayer                                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TArray<class ABGA_GrindRail_C*>    CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm)
// class ABGA_GrindRail_C*            CallFunc_Array_Get_Item_2                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
