...
{
public:
	class UFortProjectEditComponent_CreativeRoyale* ProjectEditComponent;                              // 0x690(0x8)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayspaceComponent_PlayStopPauseManager* PlayStopPauseManager;                              // 0x698(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayspaceComponent_CreativeLoadingStateProxy* CreativeLoadingStateProxy;                         // 0x6A0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayspaceComponent_SpatialGameplay*   SpatialGameplayComponent;                          // 0x6A8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayspaceComponent_DeviceTracking*    DeviceTrackerComponent;                            // 0x6B0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlayspaceComponent_CreativeModifyEmotes* CreativeModifyEmotesComponent;                     // 0x6B8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortPlayspaceComponent_WorldTimeOfDayOverride* WorldTimeOfDayOverrideComponent;                   // 0x6C0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCreativeRoyalePlayspaceComponent_LoadingScreen* LoadingScreenComponent;                            // 0x6C8(0x8)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortPoiSwapManager*                   FortPoiSwapManager;                                // 0x6D0(0x8)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_2308[0x8];                                     // Fixing Size After Last Property..
	TArray<class AActor*>                        FoundActors;                                       // 0x6E0(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_230A[0x50];                                    // Fixing Size After Last Property..
...
{
public:
	FMulticastInlineDelegateProperty_            OnContentStateChangedDelegate;                     // 0x690(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnPreContentUnloadDelegate;                        // 0x6A0(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class USceneComponent*                       SceneComponent;                                    // 0x6B0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UFortLevelSaveComponent*               LevelSaveComponent;                                // 0x6B8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UPlaysetLevelStreamComponent*          PlaysetLevelStreamComponent;                       // 0x6C0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class AFortPoiVolume>         PoiToReplace;                                      // 0x6C8(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UFortCreativeRealEstatePlotItem> PlotToLoad;                                        // 0x6D0(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UFortCreativeRealEstatePlotItem> LoadedPlot;                                        // 0x6D8(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FOnlineLinkId                         LinkCodeToLoad;                                    // 0x6E0(0x18)(Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class AActor*>                        SpawnedActors;                                     // 0x6F8(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                        Pad_230B[0x38];                                    // Fixing Size Of Struct..
...
{
public:
	struct FScalableFloat                        PlayerBotsEnabled;                                 // 0x12D0(0x28)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_230C[0x8];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2313[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_2314[0x18];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_2316[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_231A[0x27];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_231C[0x18];                                    // Fixing Size After Last Property..
	class AFortPlayerControllerAthena*           EditorIslandOwnerPlayerController;                 // 0x6A8(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_231D[0x8];                                     // Fixing Size After Last Property..
	bool                                         bHasPlotLoaded;                                    // 0x6B8(0x1)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_231E[0xF];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_231F[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_2320[0x8];                                     // Fixing Size After Last Property..
