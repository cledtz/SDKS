...
public:
	...
	uint8                                        Pad_38BF[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_38C1[0x7];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_38C3[0x4];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_38C4[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_38C5[0x20];                                    // Fixing Size Of Struct..
};
