...
public:
	...
	uint8                                        Pad_36A6[0x90];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_36A8[0x50];                                    // Fixing Size After Last Property..
	TArray<class UBuoyancyComponent*>            BuoyancyComponents;                                // 0x2D8(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36A9[0x68];                                    // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_36AA[0x5];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_36AB[0x7];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_36AC[0x4];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_36AD[0x18];                                    // Fixing Size Of Struct..
...
public:
	class UBodySetup*                            CachedBodySetup;                                   // 0x568(0x8)(ZeroConstructor, NoDestructor, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36AF[0x40];                                    // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_36B2[0x8];                                     // Fixing Size After Last Property..
	class UWaterSplineComponent*                 SplineComp;                                        // 0x290(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterSplineMetadata*                  WaterSplineMetadata;                               // 0x298(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterBodyComponent*                   WaterBodyComponent;                                // 0x2A0(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                        WaterBodyIndex;                                    // 0x2A8(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NonTransactional, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	enum class EWaterBodyType                    WaterBodyType;                                     // 0x2AC(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_36B3[0x3];                                     // Fixing Size After Last Property..
	class UWaterWavesBase*                       WaterWaves;                                        // 0x2B0(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterBodyInfoMeshComponent*           WaterInfoMeshComponent;                            // 0x2B8(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWaterBodyInfoMeshComponent*           DilatedWaterInfoMeshComponent;                     // 0x2C0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UWaterBodyStaticMeshComponent*> WaterBodyStaticMeshComponents;                     // 0x2C8(0x10)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_36B6[0x8];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_36B8[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_36B9[0x3];                                     // Fixing Size After Last Property..
	...
	TSoftObjectPtr<class AWaterZone>             OwningWaterZone;                                   // 0xDD0(0x28)(Edit, DisableEditOnTemplate, EditConst, AdvancedDisplay, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	bool                                         bExcludeAllOverlappingWaterBodies;                 // 0x2D0(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_36BA[0x7];                                     // Fixing Size After Last Property..
	TArray<class AWaterBody*>                    WaterBodiesToExclude;                              // 0x2D8(0x10)(Edit, ZeroConstructor, DisableEditOnTemplate, UObjectWrapper, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_36BB[0x8];                                     // Fixing Size After Last Property..
	class UWaterSplineComponent*                 SplineComp;                                        // 0x290(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_36BC[0x4];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_36BD[0x4];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_36BE[0x98];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_36BF[0xF];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_36C0[0x7];                                     // Fixing Size After Last Property..
	...
	uint8                                        Pad_36C1[0x7];                                     // Fixing Size Of Struct..
...
public:
	...
	uint8                                        Pad_36C2[0x8];                                     // Fixing Size Of Struct..
...
{
public:
	uint8                                        Pad_36C4[0x38];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_36C5[0x28];                                    // Fixing Size After Last Property..
	...
	uint8                                        Pad_36C6[0x30];                                    // Fixing Size Of Struct..
...
{
public:
	class UTextureRenderTarget2D*                WaterInfoTexture;                                  // 0x288(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, EditConst, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TWeakObjectPtr<class UWaterBodyComponent>> OwnedWaterBodies;                                  // 0x290(0x10)(Edit, ExportObject, ZeroConstructor, Transient, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FIntPoint                             RenderTargetResolution;                            // 0x2A0(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWaterMeshComponent*                   WaterMesh;                                         // 0x2A8(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FVector2D                             ZoneExtent;                                        // 0x2B0(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                        CaptureZOffset;                                    // 0x2C0(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bHalfPrecisionTexture;                             // 0x2C4(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36C7[0x3];                                     // Fixing Size After Last Property..
	int32                                        VelocityBlurRadius;                                // 0x2C8(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                        OverlapPriority;                                   // 0x2CC(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                         bEnableLocalOnlyTessellation;                      // 0x2D0(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36C8[0x7];                                     // Fixing Size After Last Property..
	struct FVector                               LocalTessellationExtent;                           // 0x2D8(0x18)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36C9[0x28];                                    // Fixing Size Of Struct..
