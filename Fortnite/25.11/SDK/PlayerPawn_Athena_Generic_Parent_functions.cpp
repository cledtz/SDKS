...
void APlayerPawn_Athena_Generic_Parent_C::OnExitedVehicleDispatcher__DelegateSignature()
{
	...
	Params::APlayerPawn_Athena_Generic_Parent_C_OnExitedVehicleDispatcher__DelegateSignature_Params Parms;
...
void APlayerPawn_Athena_Generic_Parent_C::OnEnteredVehicleDispatcher__DelegateSignature()
{
	...
	Params::APlayerPawn_Athena_Generic_Parent_C_OnEnteredVehicleDispatcher__DelegateSignature_Params Parms;
...
void APlayerPawn_Athena_Generic_Parent_C::OnPlayHit__DelegateSignature(class AActor* SelfActor, class AActor* OtherActor, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("PlayerPawn_Athena_Generic_Parent_C", "OnPlayHit__DelegateSignature");

	Params::APlayerPawn_Athena_Generic_Parent_C_OnPlayHit__DelegateSignature_Params Parms;
...
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPlayerPawnAthena*       JumpingPlayer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
