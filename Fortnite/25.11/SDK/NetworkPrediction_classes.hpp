...
{
public:
	struct FSharedPackageMap                     SharedPackageMap;                                  // 0x288(0x10)(Net, NativeAccessSpecifierPrivate)
...
{
public:
	class ANetworkPredictionReplicatedManager*   ReplicatedManager;                                 // 0x30(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_369A[0x638];                                   // Fixing Size Of Struct..
