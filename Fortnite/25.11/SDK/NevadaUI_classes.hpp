...
public:
	...
	class AFortNevadaVehicle*                    OwningNevadaVehicle;                               // 0x488(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_81DE[0x8];                                     // Fixing Size After Last Property..
