...
{
public:
	uint8                                        Pad_41DC[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_41DE[0x8];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_41DF[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	class UStruct*                               Struct;                                            // 0x8(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_41E1[0x7];                                     // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_41E2[0x50];                                    // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_41E4[0x4];                                     // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_41E5[0x4];                                     // Fixing Size After Last Property..
