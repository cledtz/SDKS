...
{
public:
	uint8                                        Pad_36FC[0x10];                                    // Fixing Size After Last Property..
...
{
public:
	uint8                                        Pad_36FD[0xB];                                     // Fixing Size After Last Property..
	uint8                                        BitPad_228 : 2;                                    // Fixing Bit-Field Size..
	uint8                                        bInvert : 1;                                       // Mask: 0x4, PropSize: 0x10xB(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        BitPad_229 : 5;                                    // Fixing Bit-Field Size..
...
{
public:
	uint8                                        Pad_36FF[0x1];                                     // Fixing Size Of Struct..
};
...
public:
	...
	TSubclassOf<class UWorldConditionSchema>     SchemaClass;                                       // 0x10(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_3700[0x10];                                    // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3701[0x3];                                     // Fixing Size Of Struct..
};
...
{
public:
	uint8                                        Pad_3702[0x28];                                    // Fixing Size After Last Property..
...
public:
	...
	uint8                                        Pad_3703[0x3];                                     // Fixing Size Of Struct..
};
...
public:
	...
	uint8                                        Pad_3704[0x3];                                     // Fixing Size Of Struct..
};
