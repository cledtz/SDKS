...
{
public:
	class AActor*                                SurfaceActor;                                      // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_37A6[0x6];                                     // Fixing Size Of Struct..
};
