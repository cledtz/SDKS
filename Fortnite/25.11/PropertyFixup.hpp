...
class FVerseDynamicProperty_
{
	unsigned __int8 Pad[0x10];
};

class FVerseFunctionProperty_
{
	unsigned __int8 Pad[0x10];
};
...
class FOptionProperty_
{
	unsigned __int8 Pad[0x8];
};

class FVerseStringProperty_
{
	unsigned __int8 Pad[0x10];
};

class FReferenceProperty_
{
	unsigned __int8 Pad[0x10];
};
