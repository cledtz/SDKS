...
public:
	...
	uint8                                        Pad_39AD[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_39AE[0x4];                                     // Fixing Size After Last Property
	struct FRuntimeFloatCurve                    BoostToPitchCurve;                                 // 0xC0(0x88)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_39AF[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_39B3[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_39C0[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_39C2[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_39C4[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_39C9[0xC];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_39CD[0xC];                                     // Fixing Size Of Struct
