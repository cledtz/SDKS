...
public:
	...
	uint8                                        Pad_2B58[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B5B[0x5];                                     // Fixing Size Of Struct
};
...
{
public:
	TArray<class UActor*>                        Actors;                                            // 0x0(0x10)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2B78[0x7];                                     // Fixing Size Of Struct
};
