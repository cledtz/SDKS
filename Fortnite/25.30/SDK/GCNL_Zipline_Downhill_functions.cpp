...
void UGCNL_Zipline_Downhill_C::OnRemovalGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Zipline_Downhill_C", "OnRemovalGeneric");

	Params::UGCNL_Zipline_Downhill_C_OnRemovalGeneric_Params Parms;
...
void UGCNL_Zipline_Downhill_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Zipline_Downhill_C", "OnLoopingStartGeneric");

	Params::UGCNL_Zipline_Downhill_C_OnLoopingStartGeneric_Params Parms;
...
void UGCNL_Zipline_Downhill_C::CameraShakeTimer()
{
	static auto Func = Class->GetFunction("GCNL_Zipline_Downhill_C", "CameraShakeTimer");

	Params::UGCNL_Zipline_Downhill_C_CameraShakeTimer_Params Parms;
