...
public:
	...
	uint8                                        Pad_851E[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_8521[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_8522[0x4];                                     // Fixing Size After Last Property
	...
	void CheckForPawnDeath(class UFortPawn* Pawn, bool* IsDead, float CallFunc_GetHealth_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, double CallFunc_LessEqual_DoubleDouble_A_ImplicitCast);
	...
	void OnHitPawn(class UActor* SelfActor, class UActor* OtherActor, const struct FVector& NormalImpulse, struct FHitResult& Hit);
	void MovementModeChangedDelegate_Event(class UCharacter* Character, enum class EMovementMode PrevMovementMode, uint8 PreviousCustomMode);
