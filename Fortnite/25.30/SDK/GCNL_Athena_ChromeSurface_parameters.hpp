...
struct UGCNL_Athena_ChromeSurface_C_OnApplicationGeneric_Params
{
public:
...
struct UGCNL_Athena_ChromeSurface_C_OnRemovalGeneric_Params
{
public:
	class UActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct UGCNL_Athena_ChromeSurface_C_ExecuteUbergraph_GCNL_Athena_ChromeSurface_Params
{
public:
	...
	uint8                                        Pad_747A[0x7];                                     // Fixing Size After Last Property
