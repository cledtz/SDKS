...
{
	static auto Func = Class->GetFunction("PlayerSurveySingleChoiceResponse_C", "SetNumberOfResponses");
...
{
	static auto Func = Class->GetFunction("PlayerSurveySingleChoiceResponse_C", "OnAddedToFocusPath");
...
{
	static auto Func = Class->GetFunction("PlayerSurveySingleChoiceResponse_C", "ExecuteUbergraph_PlayerSurveySingleChoiceResponse");
