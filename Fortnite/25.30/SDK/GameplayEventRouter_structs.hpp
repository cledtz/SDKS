...
{
public:
	uint8                                        Pad_E31[0x10];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_E36[0xC0];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_E37[0x20];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_E38[0x38];                                     // Fixing Size Of Struct
};
