...
public:
	...
	TScriptInterface<class UCampfire_Interface_C> K2Node_DynamicCast_AsCampfire_Interface;           // 0x108(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x118(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_54DF[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_54E0[0x4];                                     // Fixing Size After Last Property
