...
{
	static auto Func = Class->GetFunction("CommonInputBaseControllerData", "GetRegisteredGamepads");
...
{
	static auto Func = Class->GetFunction("CommonInputSettings", "IsEnhancedInputSupportEnabled");
...
{
	static auto Func = Class->GetFunction("CommonInputSubsystem", "GetCurrentGamepadName");
...
{
	static auto Func = Class->GetFunction("CommonInputSubsystem", "BroadcastInputMethodChanged");
