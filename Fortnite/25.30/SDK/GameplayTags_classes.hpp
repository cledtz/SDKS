...
public:
	...
	uint8                                        Pad_13AB[0x10];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_13BC[0x160];                                   // Fixing Size After Last Property
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_13BD[0xB0];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_13C6[0x2];                                     // Fixing Size After Last Property
