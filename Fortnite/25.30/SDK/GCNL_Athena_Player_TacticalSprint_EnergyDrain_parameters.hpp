...
struct UGCNL_Athena_Player_TacticalSprint_EnergyDrain_C_OnLoopingStartGeneric_Params
{
public:
...
struct UGCNL_Athena_Player_TacticalSprint_EnergyDrain_C_UpdateFX_Params
{
public:
};
...
struct UGCNL_Athena_Player_TacticalSprint_EnergyDrain_C_OnRemovalGeneric_Params
{
public:
	class UActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct UGCNL_Athena_Player_TacticalSprint_EnergyDrain_C_ExecuteUbergraph_GCNL_Athena_Player_TacticalSprint_EnergyDrain_Params
{
public:
	...
	class UPawn*                                 K2Node_DynamicCast_AsPawn;                         // 0x108(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_90CB[0x2];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetFloatParameter_self_CastInput;         // 0x260(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
