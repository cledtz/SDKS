...
void UPlayerBanner_C::UnbindDelegates(class UFortMcpContext* CallFunc_GetContext_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
...
void UPlayerBanner_C::SetBannerOwner(const struct FUniqueNetIdRepl& OwnerId, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsValid_UniqueNetIdRepl_ReturnValue)
{
