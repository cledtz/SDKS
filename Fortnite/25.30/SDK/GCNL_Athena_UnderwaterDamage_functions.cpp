...
void UGCNL_Athena_UnderwaterDamage_C::OnRemoval(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_UnderwaterDamage_C", "OnRemoval");

	Params::UGCNL_Athena_UnderwaterDamage_C_OnRemoval_Params Parms;
...
void UGCNL_Athena_UnderwaterDamage_C::OnRecurring(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_UnderwaterDamage_C", "OnRecurring");

	Params::UGCNL_Athena_UnderwaterDamage_C_OnRecurring_Params Parms;
...
void UGCNL_Athena_UnderwaterDamage_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Athena_UnderwaterDamage_C", "OnLoopingStart");

	Params::UGCNL_Athena_UnderwaterDamage_C_OnLoopingStart_Params Parms;
