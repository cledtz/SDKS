...
struct UGCN_BurtCharging_Player_Latent_C_OnExecute_Params
{
public:
	...
	uint8                                        Pad_A13D[0x7];                                     // Fixing Size After Last Property
	...
	class UFortPlayerController*                 CallFunc_GetFortPlayerControllerFromActor_ReturnValue; // 0xF0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};

// 0x0 (0x0 - 0x0)
// Function GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.ExecuteBoostLogic
struct UGCN_BurtCharging_Player_Latent_C_ExecuteBoostLogic_Params
{
public:
};
...
struct UGCN_BurtCharging_Player_Latent_C_BoostEndEvent_Params
{
public:
};
...
struct UGCN_BurtCharging_Player_Latent_C_ExecuteUbergraph_GCN_BurtCharging_Player_Latent_Params
{
public:
	...
	TScriptInterface<class UCameraLensEffectInterface> CallFunc_AddGenericCameraLensEffect_ReturnValue;   // 0x20(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
