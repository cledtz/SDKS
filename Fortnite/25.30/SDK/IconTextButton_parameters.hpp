...
public:
	...
	uint8                                        Pad_973[0x3];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_9B0[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_9B2[0x5];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_9D5[0x3];                                      // Fixing Size After Last Property
	class UCommonInputSubsystem*                 CallFunc_GetContext_ReturnValue;                   // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	enum class ECommonInputType                  CallFunc_GetCurrentInputType_ReturnValue;          // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_9D9[0xA];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_9DA[0x7];                                      // Fixing Size After Last Property
