...
void UGCNL_Vent_Enter_C::FadePPVol__FinishedFunc()
{
	static auto Func = Class->GetFunction("GCNL_Vent_Enter_C", "FadePPVol__FinishedFunc");

	Params::UGCNL_Vent_Enter_C_FadePPVol__FinishedFunc_Params Parms;
...
void UGCNL_Vent_Enter_C::FadePPVol__UpdateFunc()
{
	static auto Func = Class->GetFunction("GCNL_Vent_Enter_C", "FadePPVol__UpdateFunc");

	Params::UGCNL_Vent_Enter_C_FadePPVol__UpdateFunc_Params Parms;
...
void UGCNL_Vent_Enter_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Vent_Enter_C", "OnLoopingStart");

	Params::UGCNL_Vent_Enter_C_OnLoopingStart_Params Parms;
...
void UGCNL_Vent_Enter_C::OnRemoval(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Vent_Enter_C", "OnRemoval");

	Params::UGCNL_Vent_Enter_C_OnRemoval_Params Parms;
