...
public:
	...
	uint8                                        Pad_9CD3[0x4];                                     // Fixing Size After Last Property
	class UPlayerPawn_Athena_C*                  AthenaPawn;                                        // 0xD0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
