...
public:
	...
	uint8                                        Pad_5757[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_5761[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        BitPad_3C0 : 6;                                    // Fixing Bit-Field Size
	uint8                                        Pad_5764[0x7];                                     // Fixing Size After Last Property
	struct FScalableFloat                        WaterTraceZOffset;                                 // 0x180(0x28)(Edit, AdvancedDisplay, NativeAccessSpecifierPrivate)
	uint8                                        Pad_5765[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_576B[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_576C[0x1C];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_576D[0x18];                                    // Fixing Size Of Struct
