...
{
public:
	uint8                                        Pad_2078[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2079[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2081[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2083[0x10];                                    // Fixing Size Of Struct
};
