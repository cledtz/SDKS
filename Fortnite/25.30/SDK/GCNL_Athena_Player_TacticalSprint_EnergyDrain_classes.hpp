...
class UGCNL_Athena_Player_TacticalSprint_EnergyDrain_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	class UActor*                                Pawn;                                              // 0x990(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
