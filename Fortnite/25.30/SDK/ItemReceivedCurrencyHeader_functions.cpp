...
{
	static auto Func = Class->GetFunction("ItemReceivedCurrencyHeader_C", "ActiveFromPresentation");
...
{
	static auto Func = Class->GetFunction("ItemReceivedCurrencyHeader_C", "ExecuteUbergraph_ItemReceivedCurrencyHeader");
...
{
	static auto Func = Class->GetFunction("ItemReceivedCurrencyHeader_C", "ActivateWidgetFromPresentationScreen__DelegateSignature");
