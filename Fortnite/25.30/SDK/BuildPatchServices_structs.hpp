...
public:
	...
	uint8                                        Pad_7F5[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_7F6[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_7FB[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_7FC[0x6];                                      // Fixing Size Of Struct
};
