...
public:
	...
	uint8                                        Pad_A369[0x4];                                     // Fixing size after last (predefined) property
...
public:
	...
	static constexpr uint64                      UObjectMask = 0x1;                                 // (0x00[0x00]) NOT AUTO-GENERATED PROPERTY
};
...
public:
	...
	uint8                                        Pad_A36A[0x4];                                     // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A36B[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A36C[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A36D[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A36E[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A36F[0x30];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A370[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A371[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_A372[0x28];                                    // Fixing size after last (predefined) property
