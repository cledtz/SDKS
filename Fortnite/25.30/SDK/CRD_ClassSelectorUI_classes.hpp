...
public:
	...
	uint8                                        Pad_16F5[0x1C];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_16FB[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_16FF[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1701[0x1C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1716[0xA0];                                    // Fixing Size After Last Property
	class UTextBlock*                            PlayerCount;                                       // 0x1550(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonLazyImage*                      TeamIconImage;                                     // 0x1558(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_1718[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_171B[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_171E[0x1C];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1720[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1726[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_1743[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1757[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1759[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_175C[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1760[0x1C];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_176A[0x10];                                    // Fixing Size After Last Property
