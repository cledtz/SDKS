...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "Spark__FinishedFunc");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "Spark__UpdateFunc");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "Alpha__FinishedFunc");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "Alpha__UpdateFunc");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "UpdateZiplineFX");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "Update Begin Z");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "ResetBlue");
...
{
	static auto Func = Class->GetFunction("BP_ZipLine_Athena_Harness_Yellow_C", "ExecuteUbergraph_BP_ZipLine_Athena_Harness_Yellow");
