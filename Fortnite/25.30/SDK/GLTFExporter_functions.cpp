...
{
	static auto Func = Class->GetFunction("GLTFExportOptions", "ResetToDefault");
...
// TSet<class UActor*>                SelectedActors                                                   (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct FGLTFExportMessages         OutMessages                                                      (Parm, OutParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UGLTFExporter::ExportToGLTF(class UObject* Object, const class FString& FilePath, class UGLTFExportOptions* Options, TSet<class UActor*>& SelectedActors, struct FGLTFExportMessages* OutMessages)
{
	static auto Func = Class->GetFunction("GLTFExporter", "ExportToGLTF");
...
{
	static auto Func = Class->GetFunction("GLTFProxyOptions", "ResetToDefault");
