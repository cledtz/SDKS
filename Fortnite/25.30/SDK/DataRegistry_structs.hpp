...
{
public:
	uint8                                        Pad_9DC[0x18];                                     // Fixing Size Of Struct
};
...
{
public:
	class FName                                  Name;                                              // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
...
{
public:
	struct FDataRegistryType                     RegistryType;                                      // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  ItemName;                                          // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_9E0[0x3];                                      // Fixing Size After Last Property
...
{
public:
	struct FGameplayTag                          BaseGameplayTag;                                   // 0x0(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_9E5[0x2];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_9E8[0x30];                                     // Fixing Size Of Struct
};
