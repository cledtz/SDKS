...
public:
	...
	struct FAthenaRadioStation                   Source;                                            // 0x8(0x58)(Parm, NativeAccessSpecifierPublic)
};
...
public:
	class UStreamingRadioPlayerComponent*        Radio;                                             // 0x0(0x8)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAthenaRadioStation                   LastSource;                                        // 0x8(0x58)(Parm, NativeAccessSpecifierPublic)
};
