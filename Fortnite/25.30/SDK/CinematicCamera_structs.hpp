...
{
public:
	TSoftObjectPtr<class UActor>                 ActorToTrack;                                      // 0x0(0x28)(Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_16C3[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        BitPad_11B : 7;                                    // Fixing Bit-Field Size
	...
	uint8                                        Pad_16C6[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        BitPad_11C : 6;                                    // Fixing Bit-Field Size
	uint8                                        Pad_16CB[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_16CC[0x18];                                    // Fixing Size After Last Property
	TSoftObjectPtr<class UActor>                 ActorToTrack;                                      // 0x20(0x28)(Edit, BlueprintVisible, Interp, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_16D0[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_16D2[0x4];                                     // Fixing Size Of Struct
};
