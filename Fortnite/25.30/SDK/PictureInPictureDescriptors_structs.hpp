...
{
public:
	uint8                                        Pad_54C0[0x48];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_54C1[0x7];                                     // Fixing Size After Last Property
	...
	TSet<class FString>                          PlatformDenylist;                                  // 0xF0(0x50)(BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                          GameplayTagDenylist;                               // 0x140(0x50)(BlueprintVisible, NativeAccessSpecifierPublic)
	TSet<class FString>                          GameplayTagAllowlist;                              // 0x190(0x50)(BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                         bManual;                                           // 0x1E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_54C6[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_54C7[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_54C9[0xF];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_54CA[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_54CB[0x48];                                    // Fixing Size Of Struct
};
