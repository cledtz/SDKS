...
{
public:
	uint8                                        Pad_2A2F[0x48];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2A31[0xF8];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2A32[0x378];                                   // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2A34[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_2A35[0x230];                                   // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2A36[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2A38[0x128];                                   // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2A3B[0x4];                                     // Fixing Size After Last Property
