...
{
public:
	struct FPiPPartnerSource                     SelectedSource;                                    // 0x0(0x1E8)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FPiPPartnerSource                     ReturnValue;                                       // 0x0(0x1E8)(Parm, OutParm, ReturnParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_54E6[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_54FF[0x7];                                     // Fixing Size Of Struct
};
