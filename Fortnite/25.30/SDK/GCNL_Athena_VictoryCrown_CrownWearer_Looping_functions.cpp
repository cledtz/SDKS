...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::GetVisualVolume(bool IsFirstPerson, double* NewParam1, bool Temp_bool_Variable, float CallFunc_GetValueAtLevel_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue_1, double K2Node_Select_Default, double K2Node_Select_Option_0_ImplicitCast, double K2Node_Select_Option_1_ImplicitCast)
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "GetVisualVolume");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_GetVisualVolume_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::Intro_Ambient_FX_Timeline__FinishedFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "Intro Ambient FX Timeline__FinishedFunc");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_Intro_Ambient_FX_Timeline__FinishedFunc_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::Intro_Ambient_FX_Timeline__UpdateFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "Intro Ambient FX Timeline__UpdateFunc");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_Intro_Ambient_FX_Timeline__UpdateFunc_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::Intro_Flare_Timeline__FinishedFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "Intro Flare Timeline__FinishedFunc");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_Intro_Flare_Timeline__FinishedFunc_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::Intro_Flare_Timeline__UpdateFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "Intro Flare Timeline__UpdateFunc");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_Intro_Flare_Timeline__UpdateFunc_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::AVIndicatorLoop()
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "AVIndicatorLoop");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_AVIndicatorLoop_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::OnRemovalGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "OnRemovalGeneric");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_OnRemovalGeneric_Params Parms;
...
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "OnApplicationGeneric");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_OnApplicationGeneric_Params Parms;
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Athena_VictoryCrown_CrownWearer_Looping_C", "OnLoopingStartGeneric");

	Params::UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C_OnLoopingStartGeneric_Params Parms;
...
// double                             CallFunc_GetVisualVolume_NewParam1                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UGCNL_Athena_VictoryCrown_CrownWearer_Looping_C::ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping(int32 EntryPoint, TArray<class UFortPlayerController*>& Temp_object_Variable, TArray<enum class EFortTeamAffiliation>& K2Node_MakeArray_Array, class UActor* K2Node_Event_MyTarget_2, const struct FGameplayCueParameters& K2Node_Event_Parameters_2, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_2, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_2, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance_1, class UDecalActor* K2Node_Event_BurstDecalInstance_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_K2_IsValidTimerHandle_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue, bool CallFunc_GetValueAsBool_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue_1, float CallFunc_GetValueAtLevel_ReturnValue_2, float CallFunc_GetValueAtLevel_ReturnValue_3, float CallFunc_GetValueAtLevel_ReturnValue_4, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, class UActor* K2Node_Event_MyTarget_1, const struct FGameplayCueParameters& K2Node_Event_Parameters_1, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_1, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_1, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance, class UDecalActor* K2Node_Event_BurstDecalInstance, class UFortPlayerController* CallFunc_GetFortPlayerControllerFromActor_ReturnValue, TArray<class UFortPlayerController*>& CallFunc_GetLocalFortPlayerControllers_ReturnValue, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, bool CallFunc_Array_Contains_ReturnValue, double CallFunc_GetVisualVolume_NewParam1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_2, double CallFunc_Multiply_DoubleDouble_ReturnValue_3, uint8 CallFunc_GetActorTeam_ReturnValue, bool CallFunc_IsPlaying_ReturnValue, bool CallFunc_IsPlaying_ReturnValue_1, bool CallFunc_Array_IsValidIndex_ReturnValue, class UFXSystemComponent* CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast, double CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1, double CallFunc_Multiply_DoubleDouble_B_ImplicitCast, double CallFunc_Multiply_DoubleDouble_B_ImplicitCast_1, float CallFunc_SetFloatParameter_Param_ImplicitCast, float CallFunc_SetFloatParameter_Param_ImplicitCast_1)
{
	...
	Parms.CallFunc_GetVisualVolume_NewParam1 = CallFunc_GetVisualVolume_NewParam1;
