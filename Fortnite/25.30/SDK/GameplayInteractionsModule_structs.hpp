...
public:
	...
	uint8                                        Pad_3071[0x7];                                     // Fixing Size After Last Property
	class UActor*                                ContextActor;                                      // 0x30(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UActor*                                SmartObjectActor;                                  // 0x38(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_3074[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_307A[0x4];                                     // Fixing Size Of Struct
};
...
public:
	enum class EGameplayInteractionMatchSlotTagSource Source;                                            // 0x20(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_307E[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_307F[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3083[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	class UActor*                                ResultActor;                                       // 0x8(0x8)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_3087[0x7];                                     // Fixing Size Of Struct
};
...
public:
	struct FSmartObjectSlotHandle                TargetSlot;                                        // 0x0(0x8)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3088[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_308A[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_308B[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3090[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_3091[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3095[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3096[0x6];                                     // Fixing Size Of Struct
};
...
public:
	struct FSmartObjectSlotHandle                TargetSlot;                                        // 0x0(0x8)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3099[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_309B[0x8];                                     // Fixing Size Of Struct
};
...
public:
	struct FSmartObjectSlotHandle                TargetSlot;                                        // 0x0(0x8)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_309D[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_30A2[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_30A8[0xC];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_30AE[0x8];                                     // Fixing Size Of Struct
};
