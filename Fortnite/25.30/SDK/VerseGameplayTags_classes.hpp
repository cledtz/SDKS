...
{
public:
	uint8                                        Pad_368B[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_368C[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_368D[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_36A3[0x8];                                     // Fixing Size After Last Property
