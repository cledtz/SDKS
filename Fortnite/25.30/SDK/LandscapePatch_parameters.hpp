...
public:
	...
	uint8                                        Pad_2A7A[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2A86[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2A8B[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2A8F[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2AB5[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2ACA[0x3];                                     // Fixing Size Of Struct
};
...
public:
	class FName                                  InWeightmapLayerName;                              // 0x0(0x4)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2ACE[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2AD6[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2ADC[0x7];                                     // Fixing Size After Last Property
	class UTextureRenderTarget2D*                ReturnValue;                                       // 0x8(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_2AE8[0x2];                                     // Fixing Size Of Struct
};
