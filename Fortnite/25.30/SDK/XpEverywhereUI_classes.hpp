...
{
public:
	uint8                                        Pad_223C[0x60];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_223D[0xE];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_224D[0xD0];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2263[0x18];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2269[0x48];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_226F[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2275[0x6];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2279[0x90];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_227A[0x10];                                    // Fixing Size Of Struct
