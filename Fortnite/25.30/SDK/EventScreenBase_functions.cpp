...
{
	static auto Func = Class->GetFunction("FortEventScreenBase", "OnRewardTrackReady");
...
{
	static auto Func = Class->GetFunction("FortEventScreenBase", "HasAllRewardsCollected");
