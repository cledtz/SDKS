...
public:
	...
	uint8                                        Pad_2D18[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2D1D[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2D27[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2D2A[0x7];                                     // Fixing Size Of Struct
};
