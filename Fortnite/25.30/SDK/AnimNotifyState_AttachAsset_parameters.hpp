...
public:
	...
	uint8                                        Pad_7D2[0x7];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_7E7[0x7];                                      // Fixing Size After Last Property
	TScriptInterface<class UGameplayTagAssetInterface> CallFunc_HasAnyMatchingGameplayTags_self_CastInput; // 0x60(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7EB[0x2];                                      // Fixing Size After Last Property
