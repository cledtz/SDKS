...
{
public:
	uint8                                        Pad_255B[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_255C[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_255F[0x6];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2562[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2565[0x40];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2567[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2568[0x3B];                                    // Fixing Size Of Struct
};
