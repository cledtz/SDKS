...
struct UGCN_Athena_GenericHeldObject_HitWorld_C_OnBurst_Params
{
public:
	...
	uint8                                        Pad_A34C[0x7];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetIntParameter_self_CastInput;           // 0x1E0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
