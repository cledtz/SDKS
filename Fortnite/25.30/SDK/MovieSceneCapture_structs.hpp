...
public:
	...
	uint8                                        Pad_AC9[0x2];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_ACA[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_ACB[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_ACC[0x4];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_ACE[0x10];                                     // Fixing Size Of Struct
};
