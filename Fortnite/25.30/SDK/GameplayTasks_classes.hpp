...
{
public:
	uint8                                        Pad_1AC1[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1AC3[0x21];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_1AEC[0x14];                                    // Fixing Size After Last Property
	uint8                                        BitPad_14D : 1;                                    // Fixing Bit-Field Size
	uint8                                        bIsNetDirty : 1;                                   // Mask: 0x2, PropSize: 0x10xB4(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_14E : 6;                                    // Fixing Bit-Field Size
	uint8                                        Pad_1AEE[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1AF0[0x10];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1B60[0x30];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1B66[0x18];                                    // Fixing Size Of Struct
