...
struct UTabTouchWeaponOptions_New_C_SettingValueChanged_Params
{
public:
...
struct UTabTouchWeaponOptions_New_C_CenterOnTab_Params
{
public:
};
...
struct UTabTouchWeaponOptions_New_C_ExecuteUbergraph_TabTouchWeaponOptions_New_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2FE5[0x4];                                     // Fixing Size After Last Property
