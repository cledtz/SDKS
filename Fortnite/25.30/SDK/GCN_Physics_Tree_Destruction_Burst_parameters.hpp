...
public:
	...
	uint8                                        Pad_A14B[0x4];                                     // Fixing Size After Last Property
	class UBGA_PhysicsTreeLog_C*                 K2Node_DynamicCast_AsBGA_Physics_Tree_Log;         // 0x110(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x118(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A14C[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_A14D[0x3];                                     // Fixing Size After Last Property
