...
void UVaultWorld_C::OnSetupBackground(class UTexture2D* LoadedBackgroundTexture, struct FVaultWorldBackgroundData& BackgroundInfo)
{
	static auto Func = Class->GetFunction("VaultWorld_C", "OnSetupBackground");

	Params::UVaultWorld_C_OnSetupBackground_Params Parms;
...
void UVaultWorld_C::OnTransitionBackground(bool bPlayForward, enum class EBackgroundIntensityLevel IntensityTransition)
{
	static auto Func = Class->GetFunction("VaultWorld_C", "OnTransitionBackground");

	Params::UVaultWorld_C_OnTransitionBackground_Params Parms;
...
void UVaultWorld_C::OnUpdateDisplay(bool bShowFloor, bool bShowEffects)
{
	static auto Func = Class->GetFunction("VaultWorld_C", "OnUpdateDisplay");

	Params::UVaultWorld_C_OnUpdateDisplay_Params Parms;
...
void UVaultWorld_C::OnTransitionItemDetails(bool bShowItemDetails)
{
	static auto Func = Class->GetFunction("VaultWorld_C", "OnTransitionItemDetails");

	Params::UVaultWorld_C_OnTransitionItemDetails_Params Parms;
...
void UVaultWorld_C::ExecuteUbergraph_VaultWorld(int32 EntryPoint, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue, class UMaterialInstanceDynamic* CallFunc_CreateDynamicMaterialInstance_ReturnValue_1, class UTexture2D* K2Node_Event_LoadedBackgroundTexture, const struct FVaultWorldBackgroundData& K2Node_Event_BackgroundInfo, bool K2Node_Event_bPlayForward, enum class EBackgroundIntensityLevel K2Node_Event_IntensityTransition, class UFortStaticMeshActor* K2Node_DynamicCast_AsFort_Static_Mesh_Actor, bool K2Node_DynamicCast_bSuccess, bool K2Node_Event_bShowFloor, bool K2Node_Event_bShowEffects, bool K2Node_Event_bShowItemDetails)
{
