...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_Timeline_0__FinishedFunc_Params
{
public:
};
...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_Timeline_0__UpdateFunc_Params
{
public:
};
...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_Timeline_0__DoFlash__EventFunc_Params
{
public:
};
...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_OnLoopingStart_Params
{
public:
...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_OnRemoval_Params
{
public:
	class UActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xD0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct UGCNL_Athena_HidingProp_Teleporting_WilliePete_C_ExecuteUbergraph_GCNL_Athena_HidingProp_Teleporting_WilliePete_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_8533[0x4];                                     // Fixing Size After Last Property
	...
	class UActor*                                K2Node_DynamicCast_AsActor;                        // 0x108(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class UCameraLensEffectInterface> CallFunc_SpawnGenericCameraLensEffect_ReturnValue; // 0x128(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	uint8                                        Pad_8539[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_853A[0x7];                                     // Fixing Size After Last Property
