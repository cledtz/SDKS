...
public:
	...
	TScriptInterface<class UCameraLensEffectInterface> CallFunc_SpawnGenericCameraLensEffect_ReturnValue; // 0x348(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	uint8                                        Pad_3976[0x5];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetFloatParameter_self_CastInput;         // 0x380(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_397A[0x3];                                     // Fixing Size After Last Property
