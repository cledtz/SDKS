...
public:
	...
	uint8                                        Pad_207C[0x2];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_207D[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_207F[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2082[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2084[0x1F];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2086[0x38];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2089[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_208B[0x3];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_208F[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_209D[0x48];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_20A0[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_20A1[0x5];                                     // Fixing Size Of Struct
...
public:
	...
	TSoftObjectPtr<class UPlayerController>      PlayerControllerCache;                             // 0x98(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UPlayerState>           PlayerStateCache;                                  // 0xC0(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_20AA[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_20AB[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_20AC[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_20E9[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_20F3[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_20FF[0x10];                                    // Fixing Size Of Struct
