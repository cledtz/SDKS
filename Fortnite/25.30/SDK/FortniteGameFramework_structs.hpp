...
{
public:
	uint8                                        Pad_1DFD[0x58];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1E01[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1E02[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1E05[0x28];                                    // Fixing Size Of Struct
};
