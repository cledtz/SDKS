...
public:
	...
	uint8                                        Pad_5BBA[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5BBB[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5BBD[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5BBE[0x4];                                     // Fixing Size After Last Property
...
public:
	class FName                                  ParameterName;                                     // 0x0(0x4)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5BBF[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5BC1[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5BC2[0x4];                                     // Fixing Size After Last Property
