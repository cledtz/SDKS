...
public:
	...
	uint8                                        Pad_6576[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_6579[0x6];                                     // Fixing Size After Last Property
...
public:
	struct FSpatialMath_vector3                  __verse_0x18E3F084_Elem0;                          // 0x0(0x18)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor)
	uint8                                        Pad_657B[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_657C[0x6];                                     // Fixing Size After Last Property
...
public:
	struct FSpatialMath_vector3                  __verse_0x18E3F084_Elem0;                          // 0x0(0x18)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor)
	uint8                                        Pad_657F[0x8];                                     // Fixing Size After Last Property
	struct FVerseRotation                        __verse_0x7D844C3C_Elem1;                          // 0x20(0x20)(InstancedReference, NoDestructor)
	...
	uint8                                        Pad_6582[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_6585[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_6587[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_658C[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_658F[0x6];                                     // Fixing Size After Last Property
