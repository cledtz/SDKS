...
class UGCN_Loop_SnowFlakes_CameraAttached_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	void ExecuteUbergraph_GCN_Loop_SnowFlakes_CameraAttached(int32 EntryPoint, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents);
};
