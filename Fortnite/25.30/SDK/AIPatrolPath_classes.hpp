...
{
public:
	uint8                                        Pad_2048[0x98];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_20B3[0x28];                                    // Fixing Size After Last Property
	...
	TSoftClassPtr<class UPawn>                   DefaultAIPawn;                                     // 0xD8(0x28)(Edit, DisableEditOnInstance, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSubclassOf<class UBuildingActor>            PathRendererClass;                                 // 0x100(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UNavigationData*                       CachedNavData;                                     // 0x168(0x8)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_20BC[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_20C1[0x8];                                     // Fixing Size After Last Property
	TArray<class UActor*>                        PatrolPath;                                        // 0x1D0(0x10)(ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_20C3[0x10];                                    // Fixing Size After Last Property
	...
	class UActor*                                CurrentCloningNode;                                // 0x300(0x8)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class UFortCreativePatrolPath*               PatrolPathActor;                                   // 0x318(0x8)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UFortAthenaPatrolPoint*                PatrolPointActor;                                  // 0x320(0x8)(ZeroConstructor, Transient, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_20C8[0x40];                                    // Fixing Size After Last Property
