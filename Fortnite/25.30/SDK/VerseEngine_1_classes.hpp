...
public:
	...
	uint8                                        Pad_656F[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_65A3[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_65AF[0x40];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_65B1[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_65B3[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_65BB[0x28];                                    // Fixing Size Of Struct
