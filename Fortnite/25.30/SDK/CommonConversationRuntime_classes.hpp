...
{
public:
	uint8                                        Pad_2947[0x28];                                    // Fixing Size After Last Property
	struct FConversationParticipants             Participants;                                      // 0x50(0x10)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_2948[0x148];                                   // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_297F[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2984[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_29B2[0x60];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_29B6[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_29BA[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_29BB[0x160];                                   // Fixing Size Of Struct
