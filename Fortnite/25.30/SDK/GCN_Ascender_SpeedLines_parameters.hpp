...
struct UGCN_Ascender_SpeedLines_C_OnBurst_Params
{
public:
	...
	uint8                                        Pad_A341[0x4];                                     // Fixing Size After Last Property
	struct FHitResult                            CallFunc_K2_AddWorldOffset_SweepHitResult;         // 0x118(0xE0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_Greater_IntInt_ReturnValue;               // 0x1F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A342[0x7];                                     // Fixing Size After Last Property
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x200(0xE0)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FVector                               CallFunc_K2_GetComponentLocation_ReturnValue;      // 0x2F8(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                               CallFunc_Add_VectorVector_ReturnValue;             // 0x328(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UActor*>                        Temp_object_Variable;                              // 0x340(0x10)(ConstParm, ReferenceParm)
	...
	TArray<enum class EObjectTypeQuery>          K2Node_MakeArray_Array;                            // 0x380(0x10)(ConstParm, ReferenceParm)
	...
	uint8                                        Pad_A343[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_A345[0x4];                                     // Fixing Size After Last Property
