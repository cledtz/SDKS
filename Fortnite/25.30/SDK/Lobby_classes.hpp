...
public:
	...
	uint8                                        Pad_4E5[0x1];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_4E6[0x76];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_4E8[0x8];                                      // Fixing Size After Last Property
	TSoftClassPtr<class ULobbyBeaconState>       LobbyStateClass;                                   // 0x2C0(0x28)(Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class ULobbyBeaconState*                     LobbyState;                                        // 0x2E8(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_4ED[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_4EE[0x48];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4F6[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_4F8[0x68];                                     // Fixing Size Of Struct
