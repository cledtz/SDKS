...
{
public:
	uint8                                        Pad_23BE[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_23BF[0xA8];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_23C6[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_23C9[0xC8];                                    // Fixing Size Of Struct
