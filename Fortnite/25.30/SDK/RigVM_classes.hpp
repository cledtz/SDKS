...
{
public:
	uint8                                        Pad_19EA[0x8];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1A41[0x20];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1A45[0x38];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1A46[0xE8];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1A47[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1A4B[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1A4C[0x28];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1A56[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1A8E[0x8];                                     // Fixing Size After Last Property
	struct FRigVMRuntimeSettings                 VMRuntimeSettings;                                 // 0x30(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_1A8F[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1A90[0x18];                                    // Fixing Size After Last Property
	TArray<class FName>                          EventQueue;                                        // 0x90(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_1A91[0x90];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1A92[0x40];                                    // Fixing Size Of Struct
