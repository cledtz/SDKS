...
public:
	...
	uint8                                        Pad_5A69[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A7C[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A83[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	struct FGameplayTag                          VoteId;                                            // 0x4(0x4)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EVoteState                        VoteState;                                         // 0x8(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5A87[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A8A[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A8B[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A8C[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A8E[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	class UPlayerState*                          InPlayerState;                                     // 0x0(0x8)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_5A90[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5A92[0x4];                                     // Fixing Size Of Struct
};
