...
class UGCNL_Athena_HidingProp_Teleporting_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	uint8                                        Pad_A0C8[0x3];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UCameraLensEffectInterface> LensEffectInterface;                               // 0x988(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
