...
public:
	...
	uint8                                        Pad_6116[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_6138[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_613A[0x78];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_613F[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	struct FTuple_L_R                            __verse_0xB2CDDD72_Argument;                       // 0x158(0x1)(Parm, HasGetValueTypeHash)
	uint8                                        Pad_6148[0x7];                                     // Fixing Size After Last Property
	FVerseDynamicProperty_                       _RetVal;                                           // 0x160(0x10)(Parm, OutParm, ReturnParm, HasGetValueTypeHash)
