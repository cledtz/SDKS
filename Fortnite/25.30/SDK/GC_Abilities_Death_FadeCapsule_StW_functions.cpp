...
// Parameters:
// class UFortPlayerPawn*             FortPawn                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UGC_Abilities_Death_FadeCapsule_StW_C::CapsuleFadeTL__FinishedFunc()
{
	static auto Func = Class->GetFunction("GC_Abilities_Death_FadeCapsule_StW_C", "CapsuleFadeTL__FinishedFunc");

	Params::UGC_Abilities_Death_FadeCapsule_StW_C_CapsuleFadeTL__FinishedFunc_Params Parms;
...
void UGC_Abilities_Death_FadeCapsule_StW_C::CapsuleFadeTL__UpdateFunc()
{
	static auto Func = Class->GetFunction("GC_Abilities_Death_FadeCapsule_StW_C", "CapsuleFadeTL__UpdateFunc");

	Params::UGC_Abilities_Death_FadeCapsule_StW_C_CapsuleFadeTL__UpdateFunc_Params Parms;
...
void UGC_Abilities_Death_FadeCapsule_StW_C::K2_HandleGameplayCue(class UActor* MyTarget, enum class EGameplayCueEvent EventType, struct FGameplayCueParameters& Parameters)
{
	static auto Func = Class->GetFunction("GC_Abilities_Death_FadeCapsule_StW_C", "K2_HandleGameplayCue");

	Params::UGC_Abilities_Death_FadeCapsule_StW_C_K2_HandleGameplayCue_Params Parms;
