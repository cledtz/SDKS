...
{
public:
	uint8                                        Pad_E27[0x10];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_E2A[0xB];                                      // Fixing Size After Last Property
	uint8                                        BitPad_7B : 2;                                     // Fixing Bit-Field Size
	uint8                                        bInvert : 1;                                       // Mask: 0x4, PropSize: 0x10xB(0x1)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        BitPad_7C : 5;                                     // Fixing Bit-Field Size
	...
	uint8                                        Pad_E2F[0x2];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_E34[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	TSubclassOf<class UWorldConditionSchema>     SchemaClass;                                       // 0x10(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_E39[0x10];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_E41[0x28];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_E4D[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_E51[0x3];                                      // Fixing Size Of Struct
};
