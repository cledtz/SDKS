...
public:
	...
	class FName                                  OnlineSubsystem;                                   // 0x20(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7B1[0x4];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_7B5[0x7];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_7B7[0x18];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_7B9[0x10];                                     // Fixing Size After Last Property
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_7BB[0x90];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_7C3[0x18];                                     // Fixing Size Of Struct
};
