...
{
	static auto Func = Class->GetFunction("UserSearchResultListEntry_XS_C", "BP_OnUnhovered");

	Params::UUserSearchResultListEntry_XS_C_BP_OnUnhovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("UserSearchResultListEntry_XS_C", "BndEvt__MenuAnchor_Actions_K2Node_ComponentBoundEvent_0_OnMenuOpenChangedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UserSearchResultListEntry_XS_C", "BP_OnHovered");

	Params::UUserSearchResultListEntry_XS_C_BP_OnHovered_Params Parms;
...
{
	static auto Func = Class->GetFunction("UserSearchResultListEntry_XS_C", "SetNamePlatformAndMutuals");
...
{
	static auto Func = Class->GetFunction("UserSearchResultListEntry_XS_C", "ExecuteUbergraph_UserSearchResultListEntry_XS");
