...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "SetInteractionCollision");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "SetCableTilingBySplineLength");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "BlueprintCanInteract");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "GetAutoHorizAndVertVectors");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "Calc Auto Location At Alpha");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "SetSplinePositionAndTangent");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "CalculatePositionOfPoles");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "AutoSmoothTanget");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "AddSplineMeshSegment");
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "ReceiveBeginPlay");
...
void UBP_Athena_Environmental_ZipLine_Spline_C::PlayerAttachedToZipline(class UFortPlayerPawn* PlayerPawn)
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "PlayerAttachedToZipline");

	Params::UBP_Athena_Environmental_ZipLine_Spline_C_PlayerAttachedToZipline_Params Parms;
...
void UBP_Athena_Environmental_ZipLine_Spline_C::PlayerDetachedFromZipline(class UFortPlayerPawn* PlayerPawn)
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "PlayerDetachedFromZipline");

	Params::UBP_Athena_Environmental_ZipLine_Spline_C_PlayerDetachedFromZipline_Params Parms;
...
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "HandlePoleDied");
...
void UBP_Athena_Environmental_ZipLine_Spline_C::ExecuteUbergraph_BP_Athena_Environmental_ZipLine_Spline(int32 EntryPoint, int32 Temp_int_Loop_Counter_Variable, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class UFortPlayerPawn* K2Node_CustomEvent_PlayerPawn_1, const struct FVector& CallFunc_GetLocationAtSplinePoint_ReturnValue, int32 CallFunc_GetNumberOfSplinePoints_ReturnValue, double CallFunc_GetGameTimeInSeconds_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, const struct FVector& CallFunc_GetLocationAtSplinePoint_ReturnValue_1, class UFortPlayerPawn* K2Node_CustomEvent_PlayerPawn, class UMaterialInstanceDynamic* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class UActor* K2Node_CustomEvent_DamagedActor, float K2Node_CustomEvent_Damage, class UController* K2Node_CustomEvent_InstigatedBy, class UActor* K2Node_CustomEvent_DamageCauser, const struct FVector& K2Node_CustomEvent_HitLocation, class UPrimitiveComponent* K2Node_CustomEvent_FHitComponent, class FName K2Node_CustomEvent_BoneName, const struct FVector& K2Node_CustomEvent_Momentum, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, bool CallFunc_GetValueAsBool_ReturnValue, float CallFunc_SetScalarParameterValue_Value_ImplicitCast)
{
	static auto Func = Class->GetFunction("BP_Athena_Environmental_ZipLine_Spline_C", "ExecuteUbergraph_BP_Athena_Environmental_ZipLine_Spline");
