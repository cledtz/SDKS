...
{
public:
	uint8                                        Pad_1B14[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1B1B[0x3];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1B35[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1B3F[0x8];                                     // Fixing Size Of Struct
