...
void UGCNL_Athena_HidingProp_Teleporting_C::Timeline_0__FinishedFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_Teleporting_C", "Timeline_0__FinishedFunc");

	Params::UGCNL_Athena_HidingProp_Teleporting_C_Timeline_0__FinishedFunc_Params Parms;
...
void UGCNL_Athena_HidingProp_Teleporting_C::Timeline_0__UpdateFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_Teleporting_C", "Timeline_0__UpdateFunc");

	Params::UGCNL_Athena_HidingProp_Teleporting_C_Timeline_0__UpdateFunc_Params Parms;
...
void UGCNL_Athena_HidingProp_Teleporting_C::Timeline_0__DoFlash__EventFunc()
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_Teleporting_C", "Timeline_0__DoFlash__EventFunc");

	Params::UGCNL_Athena_HidingProp_Teleporting_C_Timeline_0__DoFlash__EventFunc_Params Parms;
...
void UGCNL_Athena_HidingProp_Teleporting_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_Teleporting_C", "OnLoopingStart");

	Params::UGCNL_Athena_HidingProp_Teleporting_C_OnLoopingStart_Params Parms;
...
void UGCNL_Athena_HidingProp_Teleporting_C::OnRemoval(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Athena_HidingProp_Teleporting_C", "OnRemoval");

	Params::UGCNL_Athena_HidingProp_Teleporting_C_OnRemoval_Params Parms;
