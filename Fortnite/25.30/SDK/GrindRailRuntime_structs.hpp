...
public:
	...
	uint8                                        BitPad_112 : 4;                                    // Fixing Bit-Field Size
...
public:
	...
	uint8                                        BitPad_113 : 7;                                    // Fixing Bit-Field Size
	...
	uint8                                        BitPad_114 : 7;                                    // Fixing Bit-Field Size
	uint8                                        Pad_1612[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        BitPad_115 : 7;                                    // Fixing Bit-Field Size
	uint8                                        Pad_1613[0x3];                                     // Fixing Size After Last Property
	struct FBoneReference                        LeftFootFKBone;                                    // 0x300(0xC)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_1614[0x34];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1618[0x2];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1619[0x4];                                     // Fixing Size Of Struct
};
