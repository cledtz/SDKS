...
class UGCNL_Athena_MultiInteract_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	class UPlayerPawn_Athena_C*                  Effect_Causer_Pawn;                                // 0x9E8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
