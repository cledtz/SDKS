...
public:
	...
	uint8                                        Pad_23CE[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	TSoftClassPtr<class UActor>                  ActorClass;                                        // 0x20(0x28)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                JsonStringObjectForPropertyData;                   // 0x48(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_23D0[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_23D1[0x50];                                    // Fixing Size Of Struct
};
