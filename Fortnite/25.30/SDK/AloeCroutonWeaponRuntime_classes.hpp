...
public:
	...
	uint8                                        Pad_E7C[0x20];                                     // Fixing Size Of Struct
...
public:
	...
	void HandleChargeCountChanged(float OldChargeCount, float NewChargeCount, TWeakObjectPtr<class UFortPlayerController> PlayerController);
};
