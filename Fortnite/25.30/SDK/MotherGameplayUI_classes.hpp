...
public:
	...
	uint8                                        Pad_37EC[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_37F1[0x60];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_37FB[0x20];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_380F[0x48];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_381F[0x24];                                    // Fixing Size Of Struct
