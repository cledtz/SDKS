...
void UGCNL_RollingEffects_Stone_C::OnRemovalGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_RollingEffects_Stone_C", "OnRemovalGeneric");

	Params::UGCNL_RollingEffects_Stone_C_OnRemovalGeneric_Params Parms;
...
void UGCNL_RollingEffects_Stone_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_RollingEffects_Stone_C", "OnLoopingStartGeneric");

	Params::UGCNL_RollingEffects_Stone_C_OnLoopingStartGeneric_Params Parms;
...
// class UProp_PhysicsBoulder_Parent_C*K2Node_DynamicCast_AsProp_Physics_Boulder_Parent                 (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
