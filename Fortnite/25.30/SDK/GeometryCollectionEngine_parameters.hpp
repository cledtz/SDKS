...
public:
	...
	uint8                                        Pad_142B[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14A0[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_14FC[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1514[0x8];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_159D[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_15A3[0x4];                                     // Fixing Size After Last Property
...
public:
	int32                                        ItemIndex;                                         // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_15A9[0x4];                                     // Fixing Size After Last Property
