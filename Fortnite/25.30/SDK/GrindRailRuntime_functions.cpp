...
{
	static auto Func = Class->GetFunction("FortGrindRail", "GetSpeedSettingsOverride");
...
{
	static auto Func = Class->GetFunction("FortGrindRail", "AllowSprinting");
...
{
	static auto Func = Class->GetFunction("FortPawnComponent_GrindRail", "AddTemporaryMoveIgnoreActor");
