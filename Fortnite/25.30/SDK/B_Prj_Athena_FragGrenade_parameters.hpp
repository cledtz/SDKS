...
struct UB_Prj_Athena_FragGrenade_C_PreExploWarning__FinishedFunc_Params
{
public:
};
...
struct UB_Prj_Athena_FragGrenade_C_PreExploWarning__UpdateFunc_Params
{
public:
};
...
struct UB_Prj_Athena_FragGrenade_C_FuseEnded_Params
{
public:
};
...
struct UB_Prj_Athena_FragGrenade_C_OnExploded_Params
{
public:
...
struct UB_Prj_Athena_FragGrenade_C_OnBounce_Params
{
public:
...
struct UB_Prj_Athena_FragGrenade_C_ReceiveBeginPlay_Params
{
public:
};
...
struct UB_Prj_Athena_FragGrenade_C_Pre_Explo_Audio_Tell_Params
{
public:
};
...
struct UB_Prj_Athena_FragGrenade_C_BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_1_WaterInteractionOnEnterWater__DelegateSignature_Params
{
public:
...
struct UB_Prj_Athena_FragGrenade_C_BndEvt__WaterInteractionComponent_K2Node_ComponentBoundEvent_3_WaterInteractionOnExitWater__DelegateSignature_Params
{
public:
	class UFortWaterBodyActor*                   WaterBody;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortWaterInteractionComponent*        WaterInteractionComponent;                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UB_Prj_Athena_FragGrenade_C_ExecuteUbergraph_B_Prj_Athena_FragGrenade_Params
{
public:
	...
	class UController*                           CallFunc_GetInstigatorController_ReturnValue;      // 0x28(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_OnSameTeam_ReturnValue;                   // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_881C[0x7];                                     // Fixing Size After Last Property
	TArray<class UActor*>                        K2Node_Event_HitActors;                            // 0x38(0x10)(ConstParm, ReferenceParm)
	...
	uint8                                        Pad_881E[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_881F[0x4];                                     // Fixing Size After Last Property
	...
	class UActor*                                CallFunc_BreakHitResult_HitActor;                  // 0x1C8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8820[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_8821[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_8822[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_8823[0x3];                                     // Fixing Size After Last Property
	...
	class UFortWaterBodyActor*                   K2Node_ComponentBoundEvent_WaterBody_1;            // 0x410(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8824[0xF];                                     // Fixing Size After Last Property
	...
	class UActor*                                CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue; // 0x4A8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FWaterSurfaceInfo                     CallFunc_GetWaterSurfaceInfoStruct_OutWaterSurfaceInfo; // 0x4B0(0x68)(NoDestructor)
	class UFN_RadialForce_C*                     CallFunc_FinishSpawningActor_ReturnValue;          // 0x518(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetFloatParameter_self_CastInput;         // 0x520(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortWaterBodyActor*                   K2Node_ComponentBoundEvent_WaterBody;              // 0x530(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_8825[0x7];                                     // Fixing Size After Last Property
