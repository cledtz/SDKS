...
{
	static auto Func = Class->GetFunction("BP_GrindingComponent_C", "ApplyDamageToDevice");
...
void UBP_GrindingComponent_C::Change_Sprint_State(bool New, float CallFunc_GetValueAtLevelWithContext_ReturnValue, bool CallFunc_IsSpatialGameplayExperience_ReturnValue, float CallFunc_GetValueAtLevel_ReturnValue, const struct FGameplayTag& CallFunc_MakeLiteralGameplayTag_ReturnValue, double CallFunc_SelectFloat_ReturnValue, const struct FGameplayTag& CallFunc_MakeLiteralGameplayTag_ReturnValue_1, bool CallFunc_StartUsingEnergy_ReturnValue, bool CallFunc_StopUsingEnergy_ReturnValue, const struct FGameplayEffectContextHandle& CallFunc_MakeSimpleFortEffectContext_ReturnValue, double CallFunc_SelectFloat_A_ImplicitCast, double CallFunc_SelectFloat_B_ImplicitCast, float CallFunc_StartUsingEnergy_EnergyToUsePerSecond_ImplicitCast)
{
