...
{
public:
	uint8                                        Pad_8B6[0x950];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_8C7[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_8CC[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_8CD[0x10];                                     // Fixing Size Of Struct
