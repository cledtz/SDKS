...
public:
	...
	uint8                                        Pad_C0[0x8];                                       // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_C2[0x120];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_CA[0x18];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_D9[0x10];                                      // Fixing Size After Last Property
