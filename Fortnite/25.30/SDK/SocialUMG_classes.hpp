...
{
public:
	uint8                                        Pad_2A63[0x68];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2A88[0x8];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2A92[0x18];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2A9A[0xE8];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_2A9C[0x20];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2A9F[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2AA2[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2AA3[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2AAB[0x80];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2AAD[0x40];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2AB1[0x30];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2AB3[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2AB4[0xC];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2AB6[0x20];                                    // Fixing Size Of Struct
...
public:
	...
	class UMenuAnchor*                           MenuAnchor_Actions;                                // 0x14E0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_2ABA[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2ABC[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2ABD[0x108];                                   // Fixing Size After Last Property
	...
	uint8                                        Pad_2ABE[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2AC0[0x48];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2AC1[0x70];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_2AC2[0x20];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2AC3[0x28];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_2AC4[0x40];                                    // Fixing Size Of Struct
