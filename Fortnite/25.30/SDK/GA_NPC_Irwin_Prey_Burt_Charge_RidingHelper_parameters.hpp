...
{
public:
	class UActor*                                PlayerTarget;                                      // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	uint8                                        Pad_6F27[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_6F28[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_6F29[0x6];                                     // Fixing Size After Last Property
	class UActor*                                CallFunc_GetAvatarActorFromActorInfo_ReturnValue;  // 0xD0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortAIPawn*                           K2Node_DynamicCast_AsFort_AIPawn;                  // 0xD8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_6F2A[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_6F2B[0x2];                                     // Fixing Size After Last Property
	...
	class UActor*                                K2Node_CustomEvent_PlayerTarget;                   // 0x118(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_6F2D[0x6];                                     // Fixing Size After Last Property
	class UActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x128(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_6F2E[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_6F2F[0x7];                                     // Fixing Size After Last Property
