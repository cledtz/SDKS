...
public:
	...
	uint8                                        Pad_2B70[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B71[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B75[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2BA3[0x7];                                     // Fixing Size Of Struct
};
...
public:
	struct FUniqueNetIdRepl                      NetId;                                             // 0x0(0x30)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bIsLocalPlayer;                                    // 0x30(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2BAA[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2BAF[0x7];                                     // Fixing Size Of Struct
};
