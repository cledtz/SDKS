...
void UGCN_Loop_SnowFlakes_CameraAttached_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCN_Loop_SnowFlakes_CameraAttached_C", "OnLoopingStart");

	Params::UGCN_Loop_SnowFlakes_CameraAttached_C_OnLoopingStart_Params Parms;
...
void UGCN_Loop_SnowFlakes_CameraAttached_C::ExecuteUbergraph_GCN_Loop_SnowFlakes_CameraAttached(int32 EntryPoint, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents)
{
	...
	Params::UGCN_Loop_SnowFlakes_CameraAttached_C_ExecuteUbergraph_GCN_Loop_SnowFlakes_CameraAttached_Params Parms;
