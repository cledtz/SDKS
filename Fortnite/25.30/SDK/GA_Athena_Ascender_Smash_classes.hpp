...
public:
	...
	class UB_Athena_Zipline_Ascender_C*          AscenderZipline;                                   // 0xC00(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          DescendingTag;                                     // 0xC08(0x4)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_A2E8[0x4];                                     // Fixing Size After Last Property
	...
	bool IsPlayerUsingHandle(bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UFortPlayerPawn* CallFunc_GetPawnUsingHandle_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue);
