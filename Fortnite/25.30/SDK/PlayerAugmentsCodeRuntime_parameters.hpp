...
public:
	...
	uint8                                        Pad_3DBD[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_3DC8[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3E9E[0x3];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_3EBA[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3EE9[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3EEC[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3F04[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_3F11[0x3];                                     // Fixing Size After Last Property
...
public:
	enum class EAugmentExecResult                OutExec;                                           // 0x0(0x1)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3F13[0x7];                                     // Fixing Size After Last Property
