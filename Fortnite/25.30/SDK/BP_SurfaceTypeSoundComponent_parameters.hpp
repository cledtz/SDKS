...
public:
	...
	uint8                                        Pad_873A[0x6];                                     // Fixing Size After Last Property
	class UBuildingSMActor*                      K2Node_DynamicCast_AsBuilding_Static_Mesh;         // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
