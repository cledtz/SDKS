...
public:
	...
	uint8                                        Pad_3DF8[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	class UFortWeapon*                           PreviousWeapon;                                    // 0x8(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class UFortPawn*                             InPawn;                                            // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        PreviousCustomMode;                                // 0x9(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3E1C[0x6];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3E33[0x7];                                     // Fixing Size After Last Property
