...
{
public:
	uint8                                        Pad_383D[0x8];                                     // Fixing Size After Last Property
	class UFortInventory*                        Inventory;                                         // 0x998(0x8)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_383F[0x18];                                    // Fixing Size After Last Property
	class USphereComponent*                      SphereComponent_InteractionRange;                  // 0x9B8(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSoftClassPtr<class UUserWidget>             MenuWidget;                                        // 0x9C0(0x28)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UWidgetComponent*                      WidgetComponent_PotContents;                       // 0x9E8(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bShowCraftingUI;                                   // 0x9F0(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bSendEventMessageOnLocalInteract;                  // 0x9F1(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_3842[0x6];                                     // Fixing Size After Last Property
	class UStaticMeshComponent*                  CraftingObjectMesh;                                // 0x9F8(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_385D[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_3865[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        BitPad_20E : 6;                                    // Fixing Bit-Field Size
	...
	uint8                                        Pad_386D[0x158];                                   // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_38C1[0x140];                                   // Fixing Size After Last Property
	...
	uint8                                        Pad_38C2[0x50];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_38C7[0x6];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_38DF[0x8];                                     // Fixing Size Of Struct
