...
public:
	...
	uint8                                        Pad_77C[0x18];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_781[0x80];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_784[0xF0];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_786[0x40];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_788[0x50];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_789[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_78A[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_78C[0x1C8];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_78D[0x50];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_78F[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_790[0x60];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_792[0xC0];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_793[0x10];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_796[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_798[0x38];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_79A[0x10];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_79D[0x57];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_79E[0x70];                                     // Fixing Size After Last Property
	TWeakObjectPtr<class UPartyBeaconClient>     ReservationBeaconClient;                           // 0x208(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_79F[0x4];                                      // Fixing Size After Last Property
	TWeakObjectPtr<class USpectatorBeaconClient> SpectatorBeaconClient;                             // 0x214(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_7A0[0x2C];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_7A1[0x10C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7A2[0x48];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_7A3[0x98];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7A4[0x60];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_7A8[0x4];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_7A9[0x1A8];                                    // Fixing Size Of Struct
