...
{
public:
	uint8                                        Pad_2A93[0xC0];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2A94[0xC];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2A96[0x9];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2A98[0xC8];                                    // Fixing Size Of Struct
};
