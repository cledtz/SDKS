...
// TWeakObjectPtr<class UFortPlayerController>PlayerController                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortCosmeticStatObject_AloeCroutonCharge::HandleChargeCountChanged(float OldChargeCount, float NewChargeCount, TWeakObjectPtr<class UFortPlayerController> PlayerController)
{
