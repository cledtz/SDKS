...
public:
	...
	uint8                                        Pad_5742[0x28];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_5744[0x28];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_574B[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        BitPad_3BF : 5;                                    // Fixing Bit-Field Size
	uint8                                        Pad_5754[0x5];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5758[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_575B[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_575C[0x7];                                     // Fixing Size Of Struct
};
