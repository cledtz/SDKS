...
{
public:
	uint8                                        Pad_2D6B[0x40];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2D74[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2DBE[0x7];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2DC8[0x10];                                    // Fixing Size After Last Property
