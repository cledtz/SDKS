...
{
	static auto Func = Class->GetFunction("Player_SkyDiveAndGlide_AnimBP_C", "AnimGraph");
...
{
	static auto Func = Class->GetFunction("Player_SkyDiveAndGlide_AnimBP_C", "ExecuteUbergraph_Player_SkyDiveAndGlide_AnimBP");
