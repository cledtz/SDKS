...
{
	static auto Func = Class->GetFunction("PartyDisplayManagerBP_C", "OnEmoteSetupFinished");
...
{
	static auto Func = Class->GetFunction("PartyDisplayManagerBP_C", "OnMeshLODStreamingFinished");
