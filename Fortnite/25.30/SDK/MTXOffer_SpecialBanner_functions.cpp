...
{
	static auto Func = Class->GetFunction("MTXOffer_SpecialBanner_C", "SetupSpecialOfferBanner");
...
{
	static auto Func = Class->GetFunction("MTXOffer_SpecialBanner_C", "ExecuteUbergraph_MTXOffer_SpecialBanner");
