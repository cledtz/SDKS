...
public:
	...
	TSubclassOf<class UFortNevadaAudioController> FortNevadaAudioControllerClass;                    // 0x1AE0(0x8)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UFortNevadaAudioController*            FortNevadaAudioController;                         // 0x1AF0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_4D30[0x4C];                                    // Fixing Size After Last Property
	TWeakObjectPtr<class ULandscapeProxy>        CachedLandscapeProxy;                              // 0x1BC0(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_4D32[0x7];                                     // Fixing Size After Last Property
	struct FTowhookParams                        TowhookParams;                                     // 0x1BD8(0xD0)(Edit, BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	TSubclassOf<class UFortAthenaVehicle>        AttachedPawnHiddenVehicle;                         // 0x1CA8(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UFortAthenaVehicle*                    SpawnedTractorBeamVictimVehicle;                   // 0x1CB8(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TArray<class UActor*>                        TractorBeamTargetedActors;                         // 0x1CC8(0x10)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, RepNotify, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class UActor*>                        PreviouslyTargetedActors;                          // 0x1CD8(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	class UActor*                                TractorBeamAttachedActor;                          // 0x1CE8(0x8)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UActor*                                TractorBeamTargetedActor;                          // 0x1CF0(0x8)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, Transient, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_4D34[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D36[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D37[0x98];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_4D3A[0x50];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_4D3B[0x27];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_4D3C[0x80];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_4D3E[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D3F[0x1];                                     // Fixing Size After Last Property
	...
	TArray<TSubclassOf<class UActor>>            TractorBeamDisallowedClasses;                      // 0x20B0(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_4D51[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D53[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D54[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D55[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D56[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D57[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D5A[0x24];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4D5C[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D60[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D61[0xA0];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_4D63[0x28];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_4D70[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_4D7C[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D7D[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D7E[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_4D89[0x4];                                     // Fixing Size After Last Property
