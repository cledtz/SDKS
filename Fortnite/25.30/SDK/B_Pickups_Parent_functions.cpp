...
void UB_Pickups_Parent_C::ReceiveTick(float DeltaSeconds)
{
	static auto Func = Class->GetFunction("B_Pickups_Parent_C", "ReceiveTick");

	Params::UB_Pickups_Parent_C_ReceiveTick_Params Parms;
...
void UB_Pickups_Parent_C::OnAboutToEnterBackpack(class UFortPawn* PickupTarget)
{
	static auto Func = Class->GetFunction("B_Pickups_Parent_C", "OnAboutToEnterBackpack");

	Params::UB_Pickups_Parent_C_OnAboutToEnterBackpack_Params Parms;
...
// class UFortPawn*                   K2Node_Event_PickupTarget_1                                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
