...
void UB_CameraLens_SwimBoost_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("B_CameraLens_SwimBoost_C", "ReceiveBeginPlay");

	Params::UB_CameraLens_SwimBoost_C_ReceiveBeginPlay_Params Parms;
...
void UB_CameraLens_SwimBoost_C::ExecuteUbergraph_B_CameraLens_SwimBoost(int32 EntryPoint)
{
	static auto Func = Class->GetFunction("B_CameraLens_SwimBoost_C", "ExecuteUbergraph_B_CameraLens_SwimBoost");

	Params::UB_CameraLens_SwimBoost_C_ExecuteUbergraph_B_CameraLens_SwimBoost_Params Parms;
