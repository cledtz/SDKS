...
public:
	...
	uint8                                        Pad_1C5E[0x2C];                                    // Fixing Size Of Struct
	...
	void HandleSurfaceTypeChanged(class UActor* SurfaceActor, enum class EPhysicalSurface CurrentSurfaceType, enum class EPhysicalSurface PrevSurfaceType);
	void HandleASCInitialized(class UFortAbilitySystemComponent* AbilitySystemComponent, class UFortPlayerPawn* AffectedPawn);
};
