...
void UGCNL_EnvCampFire_Stoke_C::OnLoopingStart(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UParticleSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_EnvCampFire_Stoke_C", "OnLoopingStart");

	Params::UGCNL_EnvCampFire_Stoke_C_OnLoopingStart_Params Parms;
...
// TScriptInterface<class UCampfire_Interface_C>K2Node_DynamicCast_AsCampfire_Interface                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UGCNL_EnvCampFire_Stoke_C::ExecuteUbergraph_GCNL_EnvCampFire_Stoke(int32 EntryPoint, int32 Temp_int_Loop_Counter_Variable, int32 Temp_int_Array_Index_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UParticleSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, TScriptInterface<class UCampfire_Interface_C> K2Node_DynamicCast_AsCampfire_Interface, bool K2Node_DynamicCast_bSuccess, class UParticleSystemComponent* CallFunc_Array_Get_Item, const struct FVector& CallFunc_GetLocationToSpawnFireVFX_WorldLocation, int32 CallFunc_Array_Length_ReturnValue, const struct FHitResult& CallFunc_K2_SetWorldLocation_SweepHitResult, bool CallFunc_Less_IntInt_ReturnValue)
{
	...
	Parms.K2Node_DynamicCast_AsCampfire_Interface = K2Node_DynamicCast_AsCampfire_Interface;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_Array_Get_Item = CallFunc_Array_Get_Item;
	Parms.CallFunc_GetLocationToSpawnFireVFX_WorldLocation = CallFunc_GetLocationToSpawnFireVFX_WorldLocation;
