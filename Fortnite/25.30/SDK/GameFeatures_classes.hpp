...
public:
	...
	uint8                                        Pad_172B[0xF];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_172C[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_172F[0x50];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1730[0x10];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1735[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	bool                                         bPreloadInEditor;                                  // 0x38(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_173A[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_174B[0xA0];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_174C[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_174F[0x20];                                    // Fixing Size Of Struct
