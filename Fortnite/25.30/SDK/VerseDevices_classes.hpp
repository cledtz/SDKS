...
public:
	...
	uint8                                        Pad_36DF[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_36E3[0x4];                                     // Fixing Size Of Struct
...
{
public:
	class UVerseCreativeDevice*                  Script;                                            // 0xBD0(0x8)(Edit, ExportObject, ZeroConstructor, InstancedReference, SaveGame, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_36EA[0x8];                                     // Fixing Size After Last Property
	class UVerseCreativeDevice*                  ScriptInstance;                                    // 0xBE0(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_36EB[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_36EC[0x78];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_36ED[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_36F0[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_36F1[0x8];                                     // Fixing Size Of Struct
