...
{
	static auto Func = Class->GetFunction("Simulation", "_L_2fVerse_2eorg_2fSimulation_N_RGetSession");
...
FOptionProperty_ USimulation::_L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R(const struct FTuple_Lint_Many_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Simulation", "_L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R");
...
FOptionProperty_ USimulation::_L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R(const struct FTuple_Lplayer__component_Many_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Simulation", "_L_2fVerse_2eorg_2fSimulation_N_RGetOrCreateComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R");
...
FOptionProperty_ USimulation::_L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R(const struct FTuple_Lplayer__component_Many_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Simulation", "_L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nplayer__component_M_NType_20where_20Type_R");
...
FOptionProperty_ USimulation::_L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R(const struct FTuple_Lint_Many_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Simulation", "_L_2fVerse_2eorg_2fSimulation_N_RGetComponentOfTypeForPlayer_L_Nint_M_NType_20where_20Type_R");
...
FOptionProperty_ USimulation_player::_L_2fVerse_2eorg_2fSimulation_2fplayer_N_RIsActive(const struct FTuple_L_R& __verse_0xB2CDDD72_Argument)
{
	static auto Func = Class->GetFunction("Simulation_player", "_L_2fVerse_2eorg_2fSimulation_2fplayer_N_RIsActive");
...
{
	static auto Func = Class->GetFunction("Simulation_session", "$InitInstance");
...
{
	static auto Func = Class->GetFunction("Simulation_session", "$Block");
...
{
	static auto Func = Class->GetFunction("Simulation_session", "$InitCDO");
