...
{
	static auto Func = Class->GetFunction("StaticMeshDescription", "SetVertexInstanceUV");
...
{
	static auto Func = Class->GetFunction("StaticMeshDescription", "SetPolygonGroupMaterialSlotName");
...
{
	static auto Func = Class->GetFunction("StaticMeshDescription", "GetVertexInstanceUV");
...
{
	static auto Func = Class->GetFunction("StaticMeshDescription", "CreateCube");
