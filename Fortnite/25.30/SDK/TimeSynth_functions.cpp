...
// Parameters:
// class UTimeSynthVolumeGroup*       InVolumeGroup                                                    (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UTimeSynthClip*              InClip                                                           (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UTimeSynthVolumeGroup*       InVolumeGroup                                                    (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	static auto Func = Class->GetFunction("TimeSynthComponent", "HasActiveClips");

	Params::UTimeSynthComponent_HasActiveClips_Params Parms;
...
int32 UTimeSynthComponent::GetMaxActiveClipLimit()
{
	static auto Func = Class->GetFunction("TimeSynthComponent", "GetMaxActiveClipLimit");

	Params::UTimeSynthComponent_GetMaxActiveClipLimit_Params Parms;
...
void UTimeSynthComponent::AddQuantizationEventDelegate(enum class ETimeSynthEventQuantization QuantizationType, FDelegateProperty_& OnQuantizationEvent)
{
