...
public:
	...
	uint8                                        Pad_384D[0x30];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_387B[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_3883[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_3887[0x20];                                    // Fixing Size After Last Property
	...
	struct FPiPPartnerSource                     CurrentSource;                                     // 0x4F0(0x1E8)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                        Pad_388B[0x8];                                     // Fixing Size After Last Property
	class USubtitleDisplay*                      Subtitles;                                         // 0x6E0(0x8)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_389D[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_389F[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_38A0[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_38A3[0x10];                                    // Fixing Size Of Struct
