...
public:
	...
	uint8                                        Pad_9C8E[0x4];                                     // Fixing Size After Last Property
	TSoftClassPtr<class UCommonUserWidget>       ParentalControlsScreenClass;                       // 0x2F0(0x28)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("WBP_ContentPurchaseBlocker_C");
		return Clss;
	}
