...
public:
	...
	uint8                                        Pad_3761[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	class UFortPlayerPawnAthena*                 FortPlayerPawnAthena;                              // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
