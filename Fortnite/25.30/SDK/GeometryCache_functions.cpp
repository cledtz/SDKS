...
class UGeometryCacheComponent* UGeometryCacheActor::GetGeometryCacheComponent()
{
	static auto Func = Class->GetFunction("GeometryCacheActor", "GetGeometryCacheComponent");

	Params::UGeometryCacheActor_GetGeometryCacheComponent_Params Parms;
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "SetWireframeOverrideColor");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "SetOverrideWireframeColor");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "SetMotionVectorScale");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "SetExtrapolateFrames");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "IsExtrapolatingFrames");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "GetWireframeOverrideColor");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "GetOverrideWireframeColor");
...
{
	static auto Func = Class->GetFunction("GeometryCacheComponent", "GetMotionVectorScale");
