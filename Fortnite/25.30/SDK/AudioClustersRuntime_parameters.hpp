...
public:
	...
	uint8                                        Pad_508B[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_508E[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_508F[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5097[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5098[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class UAudioClusterConfigMap*                Map;                                               // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_509C[0x7];                                     // Fixing Size Of Struct
};
