...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "Handle Tab Gamepad Config Action Handler States_SAVE");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "OnSettingsTabListPopulated");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "BndEvt__TabList_Categories_K2Node_ComponentBoundEvent_0_OnTabButtonCreation__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "On Override Reset Modal");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "OnShowResetToDefaultModal");
...
{
	static auto Func = Class->GetFunction("OptionsMenu_C", "OnSplitscreenUpdateSizing");
