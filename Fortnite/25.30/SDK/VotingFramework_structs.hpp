...
public:
	...
	uint8                                        Pad_5A95[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_5A96[0x3];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_5A97[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5A98[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_5A9A[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5A9B[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_5A9C[0x4];                                     // Fixing Size After Last Property
	class UWorld*                                WorldRef;                                          // 0x10(0x8)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  VoteSessionId;                                     // 0x18(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                  VoteId;                                            // 0x1C(0x4)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_5A9D[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5A9E[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_5AA0[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_5AA1[0x7];                                     // Fixing Size Of Struct
};
