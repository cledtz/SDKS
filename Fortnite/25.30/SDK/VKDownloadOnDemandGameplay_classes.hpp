...
{
public:
	uint8                                        Pad_2578[0x108];                                   // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_257A[0x78];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_257B[0x90];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_257C[0x20];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_257F[0x48];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2581[0x48];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_2582[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2584[0x30];                                    // Fixing Size After Last Property
