...
public:
	...
	uint8                                        Pad_BAD[0x8];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_C0B[0x58];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_C10[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_C1B[0x4];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_C1E[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_C5D[0x50];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_C61[0x20];                                     // Fixing Size After Last Property
	...
	class UActor*                                ActorDensityReservoir;                             // 0x158(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UActor*>                        SpawnedActors;                                     // 0x160(0x10)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_C62[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_C63[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_C64[0x7];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_CFE[0x8];                                      // Fixing Size After Last Property
	...
	TArray<TScriptInterface<class UFortAthenaLivingWorldPointProviderInterface>> PointProviders;                                    // 0x158(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_D02[0x8];                                      // Fixing Size After Last Property
	...
	TArray<TSoftClassPtr<class UActor>>          ActorClassToPreloadOnClient;                       // 0x348(0x10)(Net, ZeroConstructor, RepNotify, UObjectWrapper, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_D05[0x258];                                    // Fixing Size After Last Property
	TArray<class UActor*>                        RuntimePointProviderList;                          // 0x808(0x10)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	TSet<class UActor*>                          RuntimePointProviderOwners;                        // 0x818(0x50)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                        Pad_D06[0x210];                                    // Fixing Size After Last Property
	...
	class UFortAthenaLivingWorldEQSHelper*       EQSHelper;                                         // 0xAC8(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_D07[0x28];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_D10[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_D13[0x18];                                     // Fixing Size Of Struct
...
{
public:
	TArray<struct FFortAthenaLivingWorldPrefabActorSpawnerData> ActorSpawnerDatas;                                 // 0x7D8(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	struct FBox                                  LocalLevelBounds;                                  // 0x7E8(0x38)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FBox                                  LocalGrassRemovalBox;                              // 0x820(0x38)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_            OnAllActorSpawnedDelegate;                         // 0x858(0x10)(ZeroConstructor, Transient, InstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_D36[0x18];                                     // Fixing Size After Last Property
	TArray<TWeakObjectPtr<class UBuildingActor>> BuildingsToKill;                                   // 0x880(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<TWeakObjectPtr<class UActor>>         SpawnedActors;                                     // 0x890(0x10)(ZeroConstructor, Transient, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	FDelegateProperty_                           FinishedDestroyingBuildingCallback;                // 0x8A0(0xC)(ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bHasFinishedSpawn;                                 // 0x8AC(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bHasRemovedFoliage;                                // 0x8AD(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_D39[0x2];                                      // Fixing Size After Last Property
	struct FScalableFloat                        bIsEnabled;                                        // 0x8B0(0x28)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                        Weight;                                            // 0x8D8(0x28)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	bool                                         bShouldLevelBeVisible;                             // 0x900(0x1)(Edit, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bShouldSpawnerBeAllowedToSpawn;                    // 0x901(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                         bShouldAlwaysSnapAboveLandscape;                   // 0x902(0x1)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_D3B[0x5];                                      // Fixing Size After Last Property
	struct FWorldConditionQueryDefinition        CanSpawnCondition;                                 // 0x908(0x18)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_D3C[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	class UFortAthenaPatrolPath*                 PatrolPath;                                        // 0x3B0(0x8)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	TWeakObjectPtr<class UActor>                 SpawnedActor;                                      // 0x3C8(0x8)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_D54[0x5];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_D56[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_D59[0x7];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_D84[0x6];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_D88[0x198];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_D99[0xC];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_DA8[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        BitPad_73 : 5;                                     // Fixing Bit-Field Size
	uint8                                        Pad_DAF[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_DB1[0x8];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_DC6[0x8];                                      // Fixing Size After Last Property
	struct FGameplayTagContainer                 FiltersTags;                                       // 0x298(0x20)(Edit, NativeAccessSpecifierPrivate)
	...
	uint8                                        BitPad_75 : 6;                                     // Fixing Bit-Field Size
	uint8                                        Pad_DCD[0x2];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_DD0[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_E12[0x4];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_E25[0x40];                                     // Fixing Size After Last Property
