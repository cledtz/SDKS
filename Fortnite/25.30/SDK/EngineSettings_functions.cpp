...
{
	static auto Func = Class->GetFunction("GameMapsSettings", "SetSkipAssigningGamepadToPlayer1");
...
{
	static auto Func = Class->GetFunction("GameMapsSettings", "GetSkipAssigningGamepadToPlayer1");
...
{
	static auto Func = Class->GetFunction("GameMapsSettings", "GetGameMapsSettings");
