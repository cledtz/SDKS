...
public:
	...
	uint8                                        Pad_26A0[0x7];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_26A8[0x28];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_26AA[0x88];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_26B0[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_26B1[0x50];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_26B8[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_26BF[0x2];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_26C2[0x20];                                    // Fixing Size Of Struct
