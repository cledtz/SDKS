...
public:
	...
	uint8                                        Pad_97CD[0x7];                                     // Fixing Size After Last Property
	...
	void Hide_Tooltip();
	void Show_Tooltip();
	class UUserWidget* OnGetUserMenuContent(class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UTooltip_Basic_S_C* CallFunc_Create_ReturnValue);
	...
	void UpdateSize(int32 FontSizeMobile, bool Temp_bool_Variable, double Temp_real_Variable, double Temp_real_Variable_1, bool Temp_bool_Variable_1, const struct FVector2D& Temp_struct_Variable, const struct FVector2D& Temp_struct_Variable_1, bool CallFunc_IsMobileGame_ReturnValue, bool Temp_bool_Variable_2, bool CallFunc_IsMobileGame_ReturnValue_1, double K2Node_Select_Default, const struct FVector2D& K2Node_Select_Default_1, const struct FVector2D& K2Node_Select_Default_2, const struct FVector2D& K2Node_Select_Option_0_ImplicitCast, float CallFunc_SetHeightOverride_InHeightOverride_ImplicitCast, const struct FDeprecateSlateVector2D& K2Node_SetFieldsInStruct_ImageSize_ImplicitCast);
