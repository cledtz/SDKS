...
void UGCNL_Athena_Player_Sliding_Player_C::ToggleLoopingSoundIndicator(bool bEnableSoundIndicator, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "ToggleLoopingSoundIndicator");

	Params::UGCNL_Athena_Player_Sliding_Player_C_ToggleLoopingSoundIndicator_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::On_Target_Pawn_Actor_Hit(class UActor* SelfActor, class UActor* OtherActor, const struct FVector& NormalImpulse, struct FHitResult& Hit, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, bool CallFunc_OnCollision_OutResult, float CallFunc_OnCollision_OutMagnitude)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "On Target Pawn Actor Hit");

	Params::UGCNL_Athena_Player_Sliding_Player_C_On_Target_Pawn_Actor_Hit_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::StopSlideAudio(bool CallFunc_IsValid_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "StopSlideAudio");

	Params::UGCNL_Athena_Player_Sliding_Player_C_StopSlideAudio_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::ResetAudioData(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "ResetAudioData");

	Params::UGCNL_Athena_Player_Sliding_Player_C_ResetAudioData_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::Sliding_Failsafe_Check()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "Sliding Failsafe Check");

	Params::UGCNL_Athena_Player_Sliding_Player_C_Sliding_Failsafe_Check_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::Stop_Sliding_Audio()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "Stop Sliding Audio");

	Params::UGCNL_Athena_Player_Sliding_Player_C_Stop_Sliding_Audio_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::OnLoopingStartGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents)
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "OnLoopingStartGeneric");

	Params::UGCNL_Athena_Player_Sliding_Player_C_OnLoopingStartGeneric_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::ResumeSlidingAudio()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "ResumeSlidingAudio");

	Params::UGCNL_Athena_Player_Sliding_Player_C_ResumeSlidingAudio_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::Update_Speed_Line()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "Update Speed Line");

	Params::UGCNL_Athena_Player_Sliding_Player_C_Update_Speed_Line_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::UpdateSurfaceType()
{
	static auto Func = Class->GetFunction("GCNL_Athena_Player_Sliding_Player_C", "UpdateSurfaceType");

	Params::UGCNL_Athena_Player_Sliding_Player_C_UpdateSurfaceType_Params Parms;
...
void UGCNL_Athena_Player_Sliding_Player_C::ExecuteUbergraph_GCNL_Athena_Player_Sliding_Player(int32 EntryPoint, bool CallFunc_Not_PreBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UActor* K2Node_Event_MyTarget_1, const struct FGameplayCueParameters& K2Node_Event_Parameters_1, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents_1, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents_1, class UActor* K2Node_Event_MyTarget, const struct FGameplayCueParameters& K2Node_Event_Parameters, TArray<class UFXSystemComponent*>& K2Node_Event_ParticleComponents, TArray<class UAudioComponent*>& K2Node_Event_AudioComponents, class ULegacyCameraShake* K2Node_Event_BurstCameraShakeInstance, class UDecalActor* K2Node_Event_BurstDecalInstance, class UFXSystemComponent* CallFunc_Array_Get_Item, class UFortMovementComp_Character* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UFortPlayerPawn* K2Node_DynamicCast_AsFort_Player_Pawn, bool K2Node_DynamicCast_bSuccess, bool CallFunc_NotEqual_BoolBool_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, int32 CallFunc_CheckSurfaceType_SurfaceTypeInt)
{
	...
	Params::UGCNL_Athena_Player_Sliding_Player_C_ExecuteUbergraph_GCNL_Athena_Player_Sliding_Player_Params Parms;
