...
void UB_CameraLens_Shadow_Bomb_Loop_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("B_CameraLens_Shadow_Bomb_Loop_C", "ReceiveBeginPlay");

	Params::UB_CameraLens_Shadow_Bomb_Loop_C_ReceiveBeginPlay_Params Parms;
...
void UB_CameraLens_Shadow_Bomb_Loop_C::ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop(int32 EntryPoint)
{
	static auto Func = Class->GetFunction("B_CameraLens_Shadow_Bomb_Loop_C", "ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop");

	Params::UB_CameraLens_Shadow_Bomb_Loop_C_ExecuteUbergraph_B_CameraLens_Shadow_Bomb_Loop_Params Parms;
