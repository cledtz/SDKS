...
{
public:
	uint8                                        Pad_1FA5[0x38];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1FA8[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1FAC[0x8];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1FB1[0x58];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1FB3[0x1F];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1FB5[0x38];                                    // Fixing Size Of Struct
