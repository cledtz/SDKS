...
public:
	...
	uint8                                        Pad_38EF[0x3];                                     // Fixing Size After Last Property
...
public:
	...
	float                                        NoiseFloorDb;                                      // 0x38(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_390A[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_393D[0x18];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_393E[0x18];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_3940[0x18];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_3941[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3949[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_3978[0x18];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_3979[0x18];                                    // Fixing Size Of Struct
