...
public:
	...
	uint8                                        Pad_D18[0x7];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_D1D[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D23[0x3];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_D25[0x1];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_D26[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        BitPad_6C : 4;                                     // Fixing Bit-Field Size
	...
	uint8                                        Pad_D29[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D2B[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_D2F[0x3];                                      // Fixing Size Of Struct
};
