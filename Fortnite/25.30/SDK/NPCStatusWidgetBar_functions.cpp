...
{
	static auto Func = Class->GetFunction("NPCStatusWidgetBar_C", "SetHealthBarColorDependingHealth");
...
{
	static auto Func = Class->GetFunction("NPCStatusWidgetBar_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("NPCStatusWidgetBar_C", "SetPercent");
...
{
	static auto Func = Class->GetFunction("NPCStatusWidgetBar_C", "SetNumPips");
...
{
	static auto Func = Class->GetFunction("NPCStatusWidgetBar_C", "ExecuteUbergraph_NPCStatusWidgetBar");
