...
class UGCNL_Athena_HidingProp_Collision_C : public UFortGameplayCueNotify_Loop
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCNL_Athena_HidingProp_Collision_C");
		return Clss;
	}
