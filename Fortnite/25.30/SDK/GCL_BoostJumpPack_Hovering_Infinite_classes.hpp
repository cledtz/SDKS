...
class UGCL_BoostJumpPack_Hovering_Infinite_C : public UGameplayCueNotify_Jetpack_Hovering
{
public:
	...
	uint8                                        Pad_9E00[0x7];                                     // Fixing Size After Last Property
	...
	bool                                         bIsFirstJump;                                      // 0xAD8(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9E01[0x7];                                     // Fixing Size After Last Property
	class UFXSystemComponent*                    VFX_Reference;                                     // 0xAE0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool OnRemove(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_OnRemove_ReturnValue);
	bool OnActive(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, bool CallFunc_OnActive_ReturnValue, class USkeletalMeshComponent* CallFunc_GetSkeletalMeshForPartType_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UFXSystemComponent* CallFunc_SpawnFXSystemAttached_ReturnValue);
