...
public:
	...
	uint8                                        Pad_3766[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_377E[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_378E[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_37BB[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_38AD[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_38B7[0x7];                                     // Fixing Size Of Struct
};
...
public:
	class FName                                  NotifyName;                                        // 0x0(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_39C1[0x4];                                     // Fixing Size After Last Property
	struct FBranchingPointNotifyPayload          BranchingPointNotifyPayload;                       // 0x8(0x20)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
