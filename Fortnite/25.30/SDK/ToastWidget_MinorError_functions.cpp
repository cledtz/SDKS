...
{
	static auto Func = Class->GetFunction("ToastWidget_MinorError_C", "UpdateToast");
...
{
	static auto Func = Class->GetFunction("ToastWidget_MinorError_C", "OnPlayOpenAnimation");
...
{
	static auto Func = Class->GetFunction("ToastWidget_MinorError_C", "OnNotificationSet");
...
{
	static auto Func = Class->GetFunction("ToastWidget_MinorError_C", "OnNotificationUpdated");
