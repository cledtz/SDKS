...
public:
	...
	uint8                                        Pad_B1F[0x3];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_B24[0x60];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_B26[0x4];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_B2B[0x1];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_B2E[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_B2F[0x38];                                     // Fixing Size Of Struct
};
