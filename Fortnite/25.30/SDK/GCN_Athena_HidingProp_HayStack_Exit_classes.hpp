...
// 0x0 (0x210 - 0x210)
// BlueprintGeneratedClass GCN_Athena_HidingProp_HayStack_Exit.GCN_Athena_HidingProp_HayStack_Exit_C
...
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("GCN_Athena_HidingProp_HayStack_Exit_C");
		return Clss;
	}
