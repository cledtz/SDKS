...
// Parameters:
// class UFortPawn*                   Target_Fort_Pawn                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UGAT_ActiveAbility_C::SetPawnCollision(class UFortPawn* FortPawn, bool CollisionOn, bool CallFunc_NotEqual_NameName_ReturnValue, class FName CallFunc_GetCollisionProfileName_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
...
{
	static auto Func = Class->GetFunction("GAT_ActiveAbility_C", "K2_OnEndAbility");

	Params::UGAT_ActiveAbility_C_K2_OnEndAbility_Params Parms;
