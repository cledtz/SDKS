...
public:
	...
	uint8                                        Pad_7F42[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_7F45[0x7];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UCameraLensEffectInterface> CameraLensEffectInterface;                         // 0x9E0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
