...
void UB_EmotePreviewDisplay_C::CleanupDynamicSounds(int32 Temp_int_Variable, int32 Temp_int_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, class UAudioComponent* CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class UAudioComponent* CallFunc_Array_Get_Item_1, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue_1)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "CleanupDynamicSounds");

	Params::UB_EmotePreviewDisplay_C_CleanupDynamicSounds_Params Parms;
...
// class UFortPetAnimInstance*        K2Node_DynamicCast_AsFort_Pet_Anim_Instance                      (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UB_EmotePreviewDisplay_C::ApplyEmoteToPet(bool IsRemoval, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, class UFortPlayerPawn* CallFunc_GetHeroPlayerPawnForCurrentDisplayedItem_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UFortPetAnimInstance* K2Node_DynamicCast_AsFort_Pet_Anim_Instance, bool K2Node_DynamicCast_bSuccess)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "ApplyEmoteToPet");

	Params::UB_EmotePreviewDisplay_C_ApplyEmoteToPet_Params Parms;
...
void UB_EmotePreviewDisplay_C::OnLoaded_638F148342254A777E929B88915A8958(class UObject* Loaded)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "OnLoaded_638F148342254A777E929B88915A8958");

	Params::UB_EmotePreviewDisplay_C_OnLoaded_638F148342254A777E929B88915A8958_Params Parms;
...
void UB_EmotePreviewDisplay_C::PreviewEmote(class UFortMontageItemDefinitionBase* Emote)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "PreviewEmote");

	Params::UB_EmotePreviewDisplay_C_PreviewEmote_Params Parms;
...
void UB_EmotePreviewDisplay_C::PerformSpecialAction(class FName ActionName)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "PerformSpecialAction");

	Params::UB_EmotePreviewDisplay_C_PerformSpecialAction_Params Parms;
...
void UB_EmotePreviewDisplay_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "ReceiveEndPlay");

	Params::UB_EmotePreviewDisplay_C_ReceiveEndPlay_Params Parms;
...
void UB_EmotePreviewDisplay_C::SpecialCaseShoutHandler()
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "SpecialCaseShoutHandler");

	Params::UB_EmotePreviewDisplay_C_SpecialCaseShoutHandler_Params Parms;
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortMontageItemDefinitionBase*K2Node_Event_Emote                                               (ConstParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UObject*                     K2Node_CustomEvent_Loaded                                        (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue                                  (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// FDelegateProperty_                 K2Node_CreateDelegate_OutputDelegate                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UFortPlayerPawn*             CallFunc_GetHeroPlayerPawnForCurrentDisplayedItem_ReturnValue    (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UFortEmojiPreviewComponent*  CallFunc_GetComponentByClass_ReturnValue                         (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// struct FTransform                  Temp_struct_Variable                                             (ConstParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue_1                                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UFortEmojiPreviewComponent*  CallFunc_AddComponent_ReturnValue                                (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UAthenaShoutItemDefinition*  K2Node_DynamicCast_AsAthena_Shout_Item_Definition                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// TSoftObjectPtr<class UAnimMontage> CallFunc_GetFrontendPreviewAnimation_ReturnValue                 (UObjectWrapper, HasGetValueTypeHash)
...
// class UFortFrontEndContext*        CallFunc_GetContext_ReturnValue_3                                (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UAudioComponent*             CallFunc_SpawnSoundComponent_SpawnedComponent                    (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UFortPlayerPawn*             CallFunc_GetHeroPlayerPawnForCurrentDisplayedItem_ReturnValue_3  (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UFortEmojiPreviewComponent*  CallFunc_AddComponent_ReturnValue_1                              (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UFortEmojiPreviewComponent*  CallFunc_GetComponentByClass_ReturnValue_1                       (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UB_EmotePreviewDisplay_C::OnEmoteSetupFinished__DelegateSignature()
{
	static auto Func = Class->GetFunction("B_EmotePreviewDisplay_C", "OnEmoteSetupFinished__DelegateSignature");

	Params::UB_EmotePreviewDisplay_C_OnEmoteSetupFinished__DelegateSignature_Params Parms;
