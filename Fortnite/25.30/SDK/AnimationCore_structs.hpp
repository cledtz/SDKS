...
public:
	...
	class FName                                  ParentName;                                        // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	uint8                                        Pad_3D4[0xE0];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3DA[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_3DB[0x8];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_3DC[0x3];                                      // Fixing Size After Last Property
	class FName                                  SourceNode;                                        // 0x10(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                  TargetNode;                                        // 0x14(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                         bMaintainOffset;                                   // 0x1C(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3DD[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3E2[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3E7[0xF];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_3EA[0xB];                                      // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_3EB[0x50];                                     // Fixing Size Of Struct
};
...
public:
	struct FVector                               Location;                                          // 0x0(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3EE[0x8];                                      // Fixing Size After Last Property
