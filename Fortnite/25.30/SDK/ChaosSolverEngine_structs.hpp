...
{
public:
	uint8                                        Pad_618[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_619[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_61B[0x40];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_61C[0x8];                                      // Fixing Size After Last Property
