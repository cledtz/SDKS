...
struct UCameraRig_Rail_GetRailSplineComponent_Params
{
public:
...
struct UCineCameraActor_GetCineCameraComponent_Params
{
public:
...
{
public:
	struct FCameraFocusSettings                  NewFocusSettings;                                  // 0x0(0x60)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	float                                        NewCustomNearClippingPlane;                        // 0x0(0x4)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_16A6[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_16AF[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_16B3[0x3];                                     // Fixing Size Of Struct
};
