...
void UCinematic_C::ClearMovieWidget(class UFortMovieWidget*& MovieWidgetToClear, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, class UMediaPlayer* CallFunc_GetMediaPlayer_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
...
void UCinematic_C::Show_Movie(class UMediaPlayer* MediaPlayer, class UMediaSource* MediaSource, int32 CallFunc_GetAudioTrackIndex_AudioTrack, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UMediaPlayer* CallFunc_GetMediaPlayer_ReturnValue, class UPlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue, class ULegacy_MovieWidget_C* CallFunc_Create_ReturnValue)
{
	static auto Func = Class->GetFunction("Cinematic_C", "Show Movie");

	Params::UCinematic_C_Show_Movie_Params Parms;
