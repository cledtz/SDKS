...
void UProp_PhysicsBoulder_Granite_C::OnDeathPlayEffects(float Damage, struct FGameplayTagContainer& DamageTags, const struct FVector& Momentum, struct FHitResult& HitInfo, class UFortPawn* InstigatedBy, class UActor* DamageCauser, const struct FGameplayEffectContextHandle& EffectContext)
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Granite_C", "OnDeathPlayEffects");

	Params::UProp_PhysicsBoulder_Granite_C_OnDeathPlayEffects_Params Parms;
...
void UProp_PhysicsBoulder_Granite_C::ReceiveHit(class UPrimitiveComponent* MyComp, class UActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Granite_C", "ReceiveHit");

	Params::UProp_PhysicsBoulder_Granite_C_ReceiveHit_Params Parms;
...
void UProp_PhysicsBoulder_Granite_C::ReceiveBeginPlay()
{
	static auto Func = Class->GetFunction("Prop_PhysicsBoulder_Granite_C", "ReceiveBeginPlay");

	Params::UProp_PhysicsBoulder_Granite_C_ReceiveBeginPlay_Params Parms;
