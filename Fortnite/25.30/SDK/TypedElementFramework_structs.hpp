...
{
public:
	uint8                                        Pad_8CE[0x8];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8CF[0x1];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8D1[0x1];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8D3[0x8];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8D6[0xF];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8D9[0x7];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8DB[0x10];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8DC[0xF];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8DD[0x7];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8DF[0xF];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8E2[0x5F];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8E4[0x3];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8E5[0x3];                                      // Fixing Size Of Struct
};
