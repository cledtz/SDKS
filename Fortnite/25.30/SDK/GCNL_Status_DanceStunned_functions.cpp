...
void UGCNL_Status_DanceStunned_C::OnApplicationGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Status_DanceStunned_C", "OnApplicationGeneric");

	Params::UGCNL_Status_DanceStunned_C_OnApplicationGeneric_Params Parms;
...
void UGCNL_Status_DanceStunned_C::OnRemovalGeneric(class UActor* MyTarget, struct FGameplayCueParameters& Parameters, TArray<class UFXSystemComponent*>& ParticleComponents, TArray<class UAudioComponent*>& AudioComponents, class ULegacyCameraShake* BurstCameraShakeInstance, class UDecalActor* BurstDecalInstance)
{
	static auto Func = Class->GetFunction("GCNL_Status_DanceStunned_C", "OnRemovalGeneric");

	Params::UGCNL_Status_DanceStunned_C_OnRemovalGeneric_Params Parms;
