...
public:
	...
	uint8                                        Pad_7EE0[0x4];                                     // Fixing Size After Last Property
	struct FFortWorldMarkerData                  K2Node_Event_FortWorldMarkerData;                  // 0x18(0x180)(ConstParm)
	class UBP_PlayerPawn_Tandem_C*               K2Node_DynamicCast_AsBP_Player_Pawn_Tandem;        // 0x198(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x1A0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_7EE1[0x7];                                     // Fixing Size After Last Property
	class UNPC_Pawn_Wildlife_Parent_C*           K2Node_DynamicCast_AsNPC_Pawn_Wildlife_Parent;     // 0x1A8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7EE3[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_7EE4[0x3];                                     // Fixing Size After Last Property
	class UFortPlayerPawn*                       CallFunc_GetConverterPawn_ReturnValue;             // 0x1D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_7EE5[0x6];                                     // Fixing Size After Last Property
	class UFortPlayerState*                      CallFunc_AttemptGetPlayerStateForPawn_ReturnValue; // 0x1E8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UFortPlayerStateAthena*                K2Node_DynamicCast_AsFort_Player_State_Athena;     // 0x1F8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
