...
{
	static auto Func = Class->GetFunction("UserListEntry_C", "BP_OnUnhovered");
...
{
	static auto Func = Class->GetFunction("UserListEntry_C", "BndEvt__MenuAnchor_Actions_K2Node_ComponentBoundEvent_0_OnMenuOpenChangedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UserListEntry_C", "BP_OnHovered");
...
{
	static auto Func = Class->GetFunction("UserListEntry_C", "OnFocusLost");
...
{
	static auto Func = Class->GetFunction("UserListEntry_C", "ExecuteUbergraph_UserListEntry");
