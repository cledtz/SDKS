...
public:
	...
	uint8                                        Pad_1528[0xE];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1555[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1557[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_155C[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_155D[0x6];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1560[0x5];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1561[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1562[0xD];                                     // Fixing Size Of Struct
...
public:
	...
	struct FFilterOptionPerAxis                  AxisFilter;                                        // 0xB0(0x3)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1564[0x5];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1565[0x10];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1566[0x6];                                     // Fixing Size Of Struct
