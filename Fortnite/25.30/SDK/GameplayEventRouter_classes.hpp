...
public:
	...
	uint8                                        Pad_DC7[0x40];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_DDB[0x40];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_E10[0x228];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_E28[0xB0];                                     // Fixing Size Of Struct
