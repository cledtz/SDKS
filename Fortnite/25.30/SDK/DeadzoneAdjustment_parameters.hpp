...
struct UDeadzoneAdjustment_C_DoCustomNavigation_0_Params
{
public:
...
struct UDeadzoneAdjustment_C_Construct_Params
{
public:
};
...
struct UDeadzoneAdjustment_C_OnValueChanged_Bind_Params
{
public:
...
struct UDeadzoneAdjustment_C_ExecuteUbergraph_DeadzoneAdjustment_Params
{
public:
	...
	double                                       CallFunc_ConvertSliderValueToSettingsValue_SettingsValue; // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_ConvertSliderValueToSettingsValue_SliderValue_ImplicitCast; // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
