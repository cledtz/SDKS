...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "NotEqual_DataRegistryType");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "NotEqual_DataRegistryId");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "IsValidDataRegistryType");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "IsValidDataRegistryId");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "GetCachedItemFromLookupBP");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "GetCachedItemBP");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "FindCachedItemBP");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "EvaluateDataRegistryCurve");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "EqualEqual_DataRegistryType");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "EqualEqual_DataRegistryId");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "Conv_DataRegistryTypeToString");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "Conv_DataRegistryIdToString");
...
{
	static auto Func = Class->GetFunction("DataRegistrySubsystem", "AcquireItemBP");
