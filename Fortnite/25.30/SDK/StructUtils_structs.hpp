...
{
public:
	uint8                                        Pad_19B9[0x10];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_19BB[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_19BE[0xA];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_19BF[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_19C1[0x10];                                    // Fixing Size Of Struct
};
