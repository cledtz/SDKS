...
{
public:
	uint8                                        Pad_2D54[0xC];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2D58[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2D59[0x20];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2D62[0x3];                                     // Fixing Size After Last Property
