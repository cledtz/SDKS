...
public:
	...
	uint8                                        Pad_A1A6[0x7];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetIntParameter_self_CastInput;           // 0x1E8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
