...
{
public:
	uint8                                        Pad_7A[0x1];                                       // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_7C[0x18];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_7F[0x50];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_80[0x60];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_83[0x28];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_8A[0x8];                                       // Fixing Size After Last Property
	...
	uint8                                        Pad_8B[0xA];                                       // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_8C[0x30];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_8F[0x5];                                       // Fixing Size After Last Property
	...
	uint8                                        Pad_90[0x60];                                      // Fixing Size Of Struct
};
