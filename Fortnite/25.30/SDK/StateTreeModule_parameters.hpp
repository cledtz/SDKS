...
public:
	...
	uint8                                        Pad_1B62[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1B7A[0x3];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1B7E[0x1];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1B91[0x1];                                     // Fixing Size Of Struct
};
