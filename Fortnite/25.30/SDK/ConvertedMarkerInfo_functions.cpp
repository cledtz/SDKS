...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "SetBackgroundVisibility");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "OnLoaded_68559753464A154900ECA9BC6BB940C0");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "OnLoaded_25BCEE7642585A8BD6CE1CAFC70FEAF3");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "OverrideShowBackground");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "InitPlayerIconState");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "UpdateCommandIcon");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "InitNPCCommandIcon");
...
{
	static auto Func = Class->GetFunction("ConvertedMarkerInfo_C", "ExecuteUbergraph_ConvertedMarkerInfo");
