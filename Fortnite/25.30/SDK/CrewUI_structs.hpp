...
public:
	...
	uint8                                        Pad_4EC2[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4EC4[0x6];                                     // Fixing Size After Last Property
	TSoftObjectPtr<class UFortItemDefinition>    RewardDef;                                         // 0x40(0x28)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
...
public:
	...
	uint8                                        Pad_4EC5[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4EC6[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_4EC7[0x10];                                    // Fixing Size Of Struct
};
