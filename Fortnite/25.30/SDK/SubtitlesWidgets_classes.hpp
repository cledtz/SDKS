...
public:
	...
	uint8                                        Pad_2B3C[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2B43[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B44[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2B45[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B46[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B47[0x10];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2B4B[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2B4C[0x20];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2B4F[0x18];                                    // Fixing Size After Last Property
	struct FSubtitleFormat                       SubtitleFormat;                                    // 0x48(0x4)(NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2B50[0x4];                                     // Fixing Size Of Struct
