...
public:
	...
	uint8                                        Pad_9E5E[0x4];                                     // Fixing Size After Last Property
	...
	TScriptInterface<class UAudioParameterControllerInterface> CallFunc_SetIntParameter_self_CastInput;           // 0x358(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
