...
{
public:
	uint8                                        Pad_553[0x20];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_554[0x50];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_556[0x1];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_55C[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_55F[0x4];                                      // Fixing Size After Last Property
