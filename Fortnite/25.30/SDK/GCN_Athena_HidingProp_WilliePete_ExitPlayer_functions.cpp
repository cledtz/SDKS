...
{
	static auto Func = Class->GetFunction("GCN_Athena_HidingProp_WilliePete_ExitPlayer_C", "OnBurst");

	Params::UGCN_Athena_HidingProp_WilliePete_ExitPlayer_C_OnBurst_Params Parms;
