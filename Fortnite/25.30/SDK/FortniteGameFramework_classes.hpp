...
{
public:
	uint8                                        Pad_1DED[0x60];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DF0[0x58];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DF4[0x60];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DF5[0x58];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DF7[0x58];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1DFC[0x7];                                     // Fixing Size Of Struct
