...
public:
	...
	uint8                                        Pad_220F[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2213[0x80];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2237[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	class UMcpProfile*                           ProfileObject;                                     // 0x10(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                         bForwardUpdatesToClient;                           // 0x19(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2239[0x6];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_223B[0x20];                                    // Fixing Size After Last Property
	class UMcpProfileGroup*                      ProfileGroup;                                      // 0x20(0x8)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
