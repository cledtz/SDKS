...
class UClass* UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C");

	return Clss;
}


// UI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C UI_Menu_Solder_Weapon_Gun_Selector_EquippedGun.Default__UI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C* UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C::GetDefaultObj()
{
	static class UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C*>(UUI_Menu_Solder_Weapon_Gun_Selector_EquippedGun_C::StaticClass()->DefaultObject);
