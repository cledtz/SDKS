...
class UClass* UUI_CreateServer_Map_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_CreateServer_Map_C");

	return Clss;
}


// UI_CreateServer_Map_C UI_CreateServer_Map.Default__UI_CreateServer_Map_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_CreateServer_Map_C* UUI_CreateServer_Map_C::GetDefaultObj()
{
	static class UUI_CreateServer_Map_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_CreateServer_Map_C*>(UUI_CreateServer_Map_C::StaticClass()->DefaultObject);
