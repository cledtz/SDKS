...
class UClass* UU_Menu_Soldier_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("U_Menu_Soldier_C");

	return Clss;
}


// U_Menu_Soldier_C U_Menu_Soldier.Default__U_Menu_Soldier_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UU_Menu_Soldier_C* UU_Menu_Soldier_C::GetDefaultObj()
{
	static class UU_Menu_Soldier_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UU_Menu_Soldier_C*>(UU_Menu_Soldier_C::StaticClass()->DefaultObject);
