...
class UClass* UUI_HomeScreen_Menu_Offers_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_HomeScreen_Menu_Offers_C");

	return Clss;
}


// UI_HomeScreen_Menu_Offers_C UI_HomeScreen_Menu_Offers.Default__UI_HomeScreen_Menu_Offers_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_HomeScreen_Menu_Offers_C* UUI_HomeScreen_Menu_Offers_C::GetDefaultObj()
{
	static class UUI_HomeScreen_Menu_Offers_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_HomeScreen_Menu_Offers_C*>(UUI_HomeScreen_Menu_Offers_C::StaticClass()->DefaultObject);
