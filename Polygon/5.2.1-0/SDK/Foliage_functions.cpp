...
class UClass* UInstancedFoliageActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UInstancedFoliageActor* UInstancedFoliageActor::GetDefaultObj()
{
	static class UInstancedFoliageActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UInstancedFoliageActor*>(UInstancedFoliageActor::StaticClass()->DefaultObject);
...
class UClass* UInteractiveFoliageActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UInteractiveFoliageActor* UInteractiveFoliageActor::GetDefaultObj()
{
	static class UInteractiveFoliageActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UInteractiveFoliageActor*>(UInteractiveFoliageActor::StaticClass()->DefaultObject);
...
void UInteractiveFoliageActor::CapsuleTouched(class UPrimitiveComponent* OverlappedComp, class UActor* Other, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& OverlapInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::UInteractiveFoliageActor_CapsuleTouched_Params Parms{};
...
class UClass* UProceduralFoliageBlockingVolume::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UProceduralFoliageBlockingVolume* UProceduralFoliageBlockingVolume::GetDefaultObj()
{
	static class UProceduralFoliageBlockingVolume* Default = nullptr;

	if (!Default)
		Default = static_cast<UProceduralFoliageBlockingVolume*>(UProceduralFoliageBlockingVolume::StaticClass()->DefaultObject);
...
class UClass* UProceduralFoliageVolume::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UProceduralFoliageVolume* UProceduralFoliageVolume::GetDefaultObj()
{
	static class UProceduralFoliageVolume* Default = nullptr;

	if (!Default)
		Default = static_cast<UProceduralFoliageVolume*>(UProceduralFoliageVolume::StaticClass()->DefaultObject);
