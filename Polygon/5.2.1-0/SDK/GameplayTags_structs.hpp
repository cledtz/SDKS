...
{
public:
	uint8                                        Pad_2546[0x10];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2548[0x1];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_254A[0x4];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2550[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2552[0x50];                                    // Fixing Size Of Struct
};
