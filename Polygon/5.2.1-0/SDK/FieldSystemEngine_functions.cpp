...
class UClass* UFieldSystemActor::StaticClass()
{
...
class UFieldSystemActor* UFieldSystemActor::GetDefaultObj()
{
	static class UFieldSystemActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UFieldSystemActor*>(UFieldSystemActor::StaticClass()->DefaultObject);
