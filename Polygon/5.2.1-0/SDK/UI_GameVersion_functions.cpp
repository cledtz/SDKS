...
class UClass* UUI_GameVersion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_GameVersion_C");

	return Clss;
}


// UI_GameVersion_C UI_GameVersion.Default__UI_GameVersion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_GameVersion_C* UUI_GameVersion_C::GetDefaultObj()
{
	static class UUI_GameVersion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_GameVersion_C*>(UUI_GameVersion_C::StaticClass()->DefaultObject);
