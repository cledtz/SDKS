...
class UClass* UUI_Game_Minimap_ControlPoint_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Game_Minimap_ControlPoint_C");

	return Clss;
}


// UI_Game_Minimap_ControlPoint_C UI_Game_Minimap_ControlPoint.Default__UI_Game_Minimap_ControlPoint_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Game_Minimap_ControlPoint_C* UUI_Game_Minimap_ControlPoint_C::GetDefaultObj()
{
	static class UUI_Game_Minimap_ControlPoint_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Game_Minimap_ControlPoint_C*>(UUI_Game_Minimap_ControlPoint_C::StaticClass()->DefaultObject);
