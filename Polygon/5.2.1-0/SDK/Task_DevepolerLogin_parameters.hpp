...
public:
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0x70(0x40)(None)
	...
	uint8                                        Pad_31E6[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_31E8[0x7];                                     // Fixing Size After Last Property 
	...
	struct FClientLoginWithCustomIDRequest       K2Node_MakeStruct_ClientLoginWithCustomIDRequest;  // 0x138(0x50)(None)
	...
	uint8                                        Pad_31EA[0x6];                                     // Fixing Size After Last Property 
	TArray<enum class EModifiedData>             K2Node_MakeArray_Array;                            // 0x1A8(0x10)(ConstParm, ReferenceParm)
	struct FClientLoginResult                    K2Node_CustomEvent_result_1;                       // 0x1B8(0x68)(None)
	...
	uint8                                        Pad_31EC[0x7];                                     // Fixing Size After Last Property 
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_1;                     // 0x278(0x40)(None)
	...
	uint8                                        Pad_31EE[0x7];                                     // Fixing Size After Last Property 
	struct FClientGetPlayerCombinedInfoRequest   K2Node_MakeStruct_ClientGetPlayerCombinedInfoRequest; // 0x2C8(0x28)(None)
	struct FClientGetPlayerCombinedInfoResult    K2Node_CustomEvent_result;                         // 0x2F0(0x20)(None)
