...
class UClass* UGeometryCacheActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UGeometryCacheActor* UGeometryCacheActor::GetDefaultObj()
{
	static class UGeometryCacheActor* Default = nullptr;

	if (!Default)
		Default = static_cast<UGeometryCacheActor*>(UGeometryCacheActor::StaticClass()->DefaultObject);
