...
class UClass* UUI_CurrencyConversion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_CurrencyConversion_C");

	return Clss;
}


// UI_CurrencyConversion_C UI_CurrencyConversion.Default__UI_CurrencyConversion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_CurrencyConversion_C* UUI_CurrencyConversion_C::GetDefaultObj()
{
	static class UUI_CurrencyConversion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_CurrencyConversion_C*>(UUI_CurrencyConversion_C::StaticClass()->DefaultObject);
