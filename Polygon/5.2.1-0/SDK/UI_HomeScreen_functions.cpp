...
class UClass* UUI_HomeScreen_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_HomeScreen_C");

	return Clss;
}


// UI_HomeScreen_C UI_HomeScreen.Default__UI_HomeScreen_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_HomeScreen_C* UUI_HomeScreen_C::GetDefaultObj()
{
	static class UUI_HomeScreen_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_HomeScreen_C*>(UUI_HomeScreen_C::StaticClass()->DefaultObject);
