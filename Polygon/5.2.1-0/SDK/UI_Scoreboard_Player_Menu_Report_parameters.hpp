...
public:
	...
	uint8                                        Pad_2F13[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2F16[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2F18[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2F1A[0x3];                                     // Fixing Size After Last Property 
	...
	struct FClientReportPlayerClientRequest      K2Node_MakeStruct_ClientReportPlayerClientRequest; // 0xF0(0x30)(None)
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x120(0x38)(None)
