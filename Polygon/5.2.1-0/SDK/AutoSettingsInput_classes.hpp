...
{
public:
	uint8                                        Pad_6B[0x8];                                       // Fixing Size After Last Property 
	...
	uint8                                        Pad_6D[0x6];                                       // Fixing Size After Last Property 
...
public:
	...
	static class UClass* StaticClass();
	static class UAutoSettingsInputConfigInterface* GetDefaultObj();
...
{
public:
	uint8                                        Pad_84[0x8];                                       // Fixing Size Of Struct
...
public:
	...
	static class UClass* StaticClass();
	static class UAutoSettingsPlayer* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_AD[0x14];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_BF[0x7];                                       // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_15E[0x4];                                      // Fixing Size After Last Property 
