...
public:
	...
	uint8                                        Pad_AAA[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_AAB[0x7];                                      // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_AAC[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_AAE[0x8];                                      // Fixing Size After Last Property 
	...
	uint8                                        Pad_AAF[0x7];                                      // Fixing Size Of Struct
};
