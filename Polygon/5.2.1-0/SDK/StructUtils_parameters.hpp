...
public:
	...
	uint8                                        Pad_A6F[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A7A[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A84[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A85[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_A88[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	struct FInstancedStruct                      B;                                                 // 0x10(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                         ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_A8D[0x7];                                      // Fixing Size Of Struct
};
