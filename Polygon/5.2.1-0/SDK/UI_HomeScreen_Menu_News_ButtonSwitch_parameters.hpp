...
struct UUI_HomeScreen_Menu_News_ButtonSwitch_C_BndEvt__UI_HomeScreen_Offer_News_ButtonSwitch_Button_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature_Params
{
public:
};
...
struct UUI_HomeScreen_Menu_News_ButtonSwitch_C_SetIsActive_Params
{
public:
...
struct UUI_HomeScreen_Menu_News_ButtonSwitch_C_ExecuteUbergraph_UI_HomeScreen_Menu_News_ButtonSwitch_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2AC4[0x4];                                     // Fixing Size After Last Property 
	...
	bool                                         K2Node_CustomEvent_isActive;                       // 0x19(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2AC5[0x6];                                     // Fixing Size After Last Property 
