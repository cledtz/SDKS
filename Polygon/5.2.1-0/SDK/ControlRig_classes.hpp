...
{
public:
	uint8                                        Pad_1751[0x60];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1756[0x99];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1758[0x74];                                    // Fixing Size After Last Property 
	class URigHierarchyController*               HierarchyController;                               // 0x1A0(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_175A[0x58];                                    // Fixing Size After Last Property 
	TMap<struct FRigElementKey, struct FRigElementKey> PreviousNameMap;                                   // 0x200(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_175B[0x80];                                    // Fixing Size After Last Property 
	class URigHierarchy*                         HierarchyForCacheValidation;                       // 0x2D0(0x8)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                        Pad_175C[0x98];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_17F3[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_17F7[0x18];                                    // Fixing Size After Last Property 
	class UAnimationDataSourceRegistry*          DataSourceRegistry;                                // 0x210(0x8)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_17F8[0x90];                                    // Fixing Size After Last Property 
	struct FRigInfluenceMapPerEvent              Influences;                                        // 0x2A8(0x60)(NativeAccessSpecifierPrivate)
	class UControlRig*                           InteractionRig;                                    // 0x308(0x8)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UControlRig>               InteractionRigClass;                               // 0x310(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_17FC[0xC0];                                    // Fixing Size After Last Property 
	FMulticastSparseDelegateProperty_            OnControlSelected_BP;                              // 0x3D8(0x1)(InstancedReference, BlueprintAssignable, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_17FD[0x1F];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_199B[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_199C[0xC0];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_19C8[0x6];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_19DD[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_19DE[0x3];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_19EA[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1A0A[0x40];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1A12[0x30];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1A13[0x10];                                    // Fixing Size Of Struct
...
{
public:
	TArray<bool>                                 IsControlActive;                                   // 0x3F8(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	enum class EControlRigFKRigExecuteMode       ApplyMode;                                         // 0x408(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_1A15[0x2F];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1AD2[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AD3[0x6C];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1AE6[0x8];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1AEF[0x4];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1AF4[0x48];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AF8[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1AFC[0x68];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1B00[0x40];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1B31[0x6];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1B36[0x4];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1B3C[0x1];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1B3F[0x4];                                     // Fixing Size After Last Property 
