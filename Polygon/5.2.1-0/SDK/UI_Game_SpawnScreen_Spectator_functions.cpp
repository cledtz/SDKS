...
class UClass* UUI_Game_SpawnScreen_Spectator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Game_SpawnScreen_Spectator_C");

	return Clss;
}


// UI_Game_SpawnScreen_Spectator_C UI_Game_SpawnScreen_Spectator.Default__UI_Game_SpawnScreen_Spectator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Game_SpawnScreen_Spectator_C* UUI_Game_SpawnScreen_Spectator_C::GetDefaultObj()
{
	static class UUI_Game_SpawnScreen_Spectator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Game_SpawnScreen_Spectator_C*>(UUI_Game_SpawnScreen_Spectator_C::StaticClass()->DefaultObject);
