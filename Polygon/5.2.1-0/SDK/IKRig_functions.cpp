...
class UClass* UIKGoalCreatorInterface::StaticClass()
{
...
class UIKGoalCreatorInterface* UIKGoalCreatorInterface::GetDefaultObj()
{
	static class UIKGoalCreatorInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UIKGoalCreatorInterface*>(UIKGoalCreatorInterface::StaticClass()->DefaultObject);
