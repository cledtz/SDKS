...
public:
	...
	uint8                                        Pad_13FD[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1404[0x7];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1407[0xE];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_1428[0x6];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_142B[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_142C[0x5];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_142D[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_142F[0xD];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1431[0x8];                                     // Fixing Size After Last Property 
	...
	struct FFilterOptionPerAxis                  AxisFilter;                                        // 0xB0(0x3)(BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1432[0x5];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1433[0x10];                                    // Fixing Size After Last Property 
	...
	uint8                                        Pad_1437[0x6];                                     // Fixing Size Of Struct
