...
class UClass* UUI_Weapons_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Weapons_C");

	return Clss;
}


// UI_Weapons_C UI_Weapons.Default__UI_Weapons_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Weapons_C* UUI_Weapons_C::GetDefaultObj()
{
	static class UUI_Weapons_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Weapons_C*>(UUI_Weapons_C::StaticClass()->DefaultObject);
