...
class UClass* UUI_Game_Squad_PlayerSlot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Game_Squad_PlayerSlot_C");

	return Clss;
}


// UI_Game_Squad_PlayerSlot_C UI_Game_Squad_PlayerSlot.Default__UI_Game_Squad_PlayerSlot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Game_Squad_PlayerSlot_C* UUI_Game_Squad_PlayerSlot_C::GetDefaultObj()
{
	static class UUI_Game_Squad_PlayerSlot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Game_Squad_PlayerSlot_C*>(UUI_Game_Squad_PlayerSlot_C::StaticClass()->DefaultObject);
