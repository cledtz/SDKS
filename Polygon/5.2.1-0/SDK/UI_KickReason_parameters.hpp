...
public:
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0x18(0x40)(None)
	...
	uint8                                        Pad_2DB9[0x6];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2DBF[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2DC7[0x7];                                     // Fixing Size After Last Property 
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest; // 0x1F0(0x38)(None)
	...
	struct FClientWriteEventResponse             K2Node_CustomEvent_result;                         // 0x238(0x18)(None)
	class UObject*                               K2Node_CustomEvent_customData_1;                   // 0x250(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x258(0x38)(None)
