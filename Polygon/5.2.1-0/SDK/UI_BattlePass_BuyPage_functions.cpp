...
class UClass* UUI_BattlePass_BuyPage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_BattlePass_BuyPage_C");

	return Clss;
}


// UI_BattlePass_BuyPage_C UI_BattlePass_BuyPage.Default__UI_BattlePass_BuyPage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_BattlePass_BuyPage_C* UUI_BattlePass_BuyPage_C::GetDefaultObj()
{
	static class UUI_BattlePass_BuyPage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_BattlePass_BuyPage_C*>(UUI_BattlePass_BuyPage_C::StaticClass()->DefaultObject);
