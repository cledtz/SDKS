...
class UClass* UUI_KillCam_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_KillCam_C");

	return Clss;
}


// UI_KillCam_C UI_Killcam.Default__UI_KillCam_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_KillCam_C* UUI_KillCam_C::GetDefaultObj()
{
	static class UUI_KillCam_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_KillCam_C*>(UUI_KillCam_C::StaticClass()->DefaultObject);
