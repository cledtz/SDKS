...
{
public:
	uint8                                        Pad_A9A[0x38];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_A9D[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_AA2[0x20];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_AA6[0x7];                                      // Fixing Size After Last Property 
