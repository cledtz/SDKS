...
class UCableActor : public UActor
{
public:
	...
	static class UCableActor* GetDefaultObj();
...
public:
	...
	uint8                                        Pad_1BB2[0x6];                                     // Fixing Size After Last Property 
	struct FComponentReference                   AttachEndTo;                                       // 0x5A8(0x28)(Edit, NativeAccessSpecifierPublic)
	class FName                                  AttachEndToSocketName;                             // 0x5D0(0x8)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1BB4[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_1BB8[0x18];                                    // Fixing Size Of Struct
	...
	void SetAttachEndTo(class UActor* Actor, class FName ComponentProperty, class FName SocketName);
	void GetCableParticleLocations(TArray<struct FVector>* Locations);
	class USceneComponent* GetAttachedComponent();
	class UActor* GetAttachedActor();
};
