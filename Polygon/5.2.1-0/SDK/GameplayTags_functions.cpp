...
class UClass* UGameplayTagAssetInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class UGameplayTagAssetInterface* UGameplayTagAssetInterface::GetDefaultObj()
{
	static class UGameplayTagAssetInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayTagAssetInterface*>(UGameplayTagAssetInterface::StaticClass()->DefaultObject);
