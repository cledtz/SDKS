...
class UClass* UBP_Item_Rifle_AK74M_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Item_Rifle_AK74M_C");

	return Clss;
}


// BP_Item_Rifle_AK74M_C BP_Item_Rifle_AK74M.Default__BP_Item_Rifle_AK74M_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Item_Rifle_AK74M_C* UBP_Item_Rifle_AK74M_C::GetDefaultObj()
{
	static class UBP_Item_Rifle_AK74M_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Item_Rifle_AK74M_C*>(UBP_Item_Rifle_AK74M_C::StaticClass()->DefaultObject);
