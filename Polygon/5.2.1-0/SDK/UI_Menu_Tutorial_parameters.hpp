...
public:
	...
	uint8                                        Pad_5[0x7];                                        // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_5A[0x4];                                       // Fixing Size After Last Property 
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_1;                     // 0x28(0x40)(None)
	...
	uint8                                        Pad_5D[0x6];                                       // Fixing Size After Last Property 
	class UObject*                               Temp_object_Variable;                              // 0x78(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabBaseModel                     Temp_struct_Variable;                              // 0x80(0x40)(None)
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0xF0(0x40)(None)
	...
	uint8                                        Pad_60[0x3];                                       // Fixing Size After Last Property 
	...
	uint8                                        Pad_62[0x3];                                       // Fixing Size After Last Property 
	class UObject*                               Temp_object_Variable_1;                            // 0x150(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabBaseModel                     Temp_struct_Variable_1;                            // 0x158(0x40)(None)
	...
	uint8                                        Pad_63[0x4];                                       // Fixing Size After Last Property 
	...
	uint8                                        Pad_64[0x7];                                       // Fixing Size After Last Property 
	...
	uint8                                        Pad_68[0x7];                                       // Fixing Size After Last Property 
	...
	uint8                                        Pad_6A[0x7];                                       // Fixing Size After Last Property 
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest; // 0x278(0x38)(None)
	class UPlayFabClientAPI*                     CallFunc_WritePlayerEvent_ReturnValue;             // 0x2B0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FClientWriteEventResponse             K2Node_CustomEvent_result;                         // 0x2B8(0x18)(None)
	...
	uint8                                        Pad_70[0x7];                                       // Fixing Size After Last Property 
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x2E0(0x38)(None)
	class UObject*                               K2Node_CustomEvent_customData;                     // 0x318(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest_1; // 0x320(0x38)(None)
	...
	uint8                                        Pad_74[0x5];                                       // Fixing Size After Last Property 
