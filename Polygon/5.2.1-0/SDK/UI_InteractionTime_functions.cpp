...
class UClass* UUI_InteractionTime_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_InteractionTime_C");

	return Clss;
}


// UI_InteractionTime_C UI_InteractionTime.Default__UI_InteractionTime_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_InteractionTime_C* UUI_InteractionTime_C::GetDefaultObj()
{
	static class UUI_InteractionTime_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_InteractionTime_C*>(UUI_InteractionTime_C::StaticClass()->DefaultObject);
