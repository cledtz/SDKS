...
class UClass* ULevelVariantSetsActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class ULevelVariantSetsActor* ULevelVariantSetsActor::GetDefaultObj()
{
	static class ULevelVariantSetsActor* Default = nullptr;

	if (!Default)
		Default = static_cast<ULevelVariantSetsActor*>(ULevelVariantSetsActor::StaticClass()->DefaultObject);
...
bool ULevelVariantSetsActor::SwitchOnVariantByName(const class FString& VariantSetName, const class FString& VariantName)
{
	static class UFunction* Func = nullptr;
	...
	Params::ULevelVariantSetsActor_SwitchOnVariantByName_Params Parms{};
...
bool ULevelVariantSetsActor::SwitchOnVariantByIndex(int32 VariantSetIndex, int32 VariantIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::ULevelVariantSetsActor_SwitchOnVariantByIndex_Params Parms{};
...
void ULevelVariantSetsActor::SetLevelVariantSets(class ULevelVariantSets* InVariantSets)
{
	...
	Params::ULevelVariantSetsActor_SetLevelVariantSets_Params Parms{};
...
class ULevelVariantSets* ULevelVariantSetsActor::GetLevelVariantSets(bool bLoad)
{
	...
	Params::ULevelVariantSetsActor_GetLevelVariantSets_Params Parms{};
...
class UClass* USwitchActor::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class USwitchActor* USwitchActor::GetDefaultObj()
{
	static class USwitchActor* Default = nullptr;

	if (!Default)
		Default = static_cast<USwitchActor*>(USwitchActor::StaticClass()->DefaultObject);
...
void USwitchActor::SelectOption(int32 OptionIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::USwitchActor_SelectOption_Params Parms{};
...
int32 USwitchActor::GetSelectedOption()
{
	static class UFunction* Func = nullptr;
	...
	Params::USwitchActor_GetSelectedOption_Params Parms{};
...
TArray<class UActor*> USwitchActor::GetOptions()
{
	...
	Params::USwitchActor_GetOptions_Params Parms{};
...
class UActor* UVariant::GetActor(int32 ActorIndex)
{
	static class UFunction* Func = nullptr;
