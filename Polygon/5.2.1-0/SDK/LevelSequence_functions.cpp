...
class UClass* ULevelSequenceMetaData::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class ULevelSequenceMetaData* ULevelSequenceMetaData::GetDefaultObj()
{
	static class ULevelSequenceMetaData* Default = nullptr;

	if (!Default)
		Default = static_cast<ULevelSequenceMetaData*>(ULevelSequenceMetaData::StaticClass()->DefaultObject);
