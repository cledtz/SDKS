...
{
public:
	uint8                                        Pad_260C[0x8];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_260E[0x2];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_260F[0x25];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_2615[0x7];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2622[0x14];                                    // Fixing Size After Last Property 
	uint8                                        BitPad_11D : 1;                                    // Fixing Bit-Field Size 
	uint8                                        bIsNetDirty : 1;                                   // Mask: 0x2, PropSize: 0x10xB4(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_11E : 6;                                    // Fixing Bit-Field Size 
	...
	uint8                                        Pad_2624[0x10];                                    // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_26AC[0x30];                                    // Fixing Size After Last Property 
	TSubclassOf<class UActor>                    ClassToSpawn;                                      // 0xB8(0x8)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_26B2[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_26DC[0x10];                                    // Fixing Size Of Struct
