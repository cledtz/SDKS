...
class UClass* UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C");

	return Clss;
}


// UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item.Default__UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C* UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C::GetDefaultObj()
{
	static class UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C*>(UUI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_List_Item_C::StaticClass()->DefaultObject);
