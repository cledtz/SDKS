...
public:
	...
	uint8                                        Pad_2215[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2216[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2217[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2219[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_221A[0x8];                                     // Fixing Size After Last Property 
