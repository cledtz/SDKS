...
public:
	...
	uint8                                        Pad_29DB[0x2];                                     // Fixing Size After Last Property 
...
public:
	...
	uint8                                        Pad_29E6[0x7];                                     // Fixing Size After Last Property 
...
public:
	...
	struct FPlayFabBaseModel                     Temp_struct_Variable;                              // 0x18(0x40)(None)
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_1;                     // 0x58(0x40)(None)
	...
	struct FPlayFabBaseModel                     Temp_struct_Variable_1;                            // 0xC0(0x40)(None)
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0x130(0x40)(None)
	...
	uint8                                        Pad_2A4E[0x6];                                     // Fixing Size After Last Property 
	class UObject*                               Temp_object_Variable_1;                            // 0x180(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabBaseModel                     Temp_struct_Variable_2;                            // 0x188(0x40)(None)
	...
	struct FClientPayForPurchaseRequest          K2Node_MakeStruct_ClientPayForPurchaseRequest;     // 0x1E8(0x50)(None)
	...
	uint8                                        Pad_2A4F[0x7];                                     // Fixing Size After Last Property 
	class FText                                  CallFunc_Conv_IntToText_ReturnValue;               // 0x278(0x18)(None)
	class FText                                  CallFunc_Conv_DoubleToText_ReturnValue;            // 0x290(0x18)(None)
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_2;                     // 0x508(0x40)(None)
	...
	uint8                                        Pad_2A56[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2A58[0x4];                                     // Fixing Size After Last Property 
	...
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest; // 0x5E8(0x38)(None)
	...
	uint8                                        Pad_2A5C[0x1];                                     // Fixing Size After Last Property 
	...
	struct FClientWriteEventResponse             K2Node_CustomEvent_result;                         // 0x640(0x18)(None)
	...
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x670(0x38)(None)
	...
	uint8                                        Pad_2A5F[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2A60[0x7];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2A63[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_2A64[0x7];                                     // Fixing Size After Last Property 
	struct FClientConfirmPurchaseRequest         K2Node_MakeStruct_ClientConfirmPurchaseRequest;    // 0x728(0x20)(None)
	...
	struct FPlayFabError                         K2Node_MakeStruct_PlayFabError;                    // 0x758(0x38)(None)
	struct FPlayFabError                         K2Node_MakeStruct_PlayFabError_1;                  // 0x790(0x38)(None)
	struct FPlayFabBaseModel                     Temp_struct_Variable_3;                            // 0x7C8(0x40)(None)
	...
	uint8                                        Pad_2A66[0x6];                                     // Fixing Size After Last Property 
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_3;                     // 0x830(0x40)(None)
	...
	uint8                                        Pad_2A67[0x3];                                     // Fixing Size After Last Property 
