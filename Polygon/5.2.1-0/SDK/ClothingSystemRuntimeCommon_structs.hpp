...
public:
	...
	uint8                                        Pad_25B6[0x4];                                     // Fixing Size After Last Property 
...
{
public:
	uint8                                        Pad_25B9[0x10];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_25BC[0x3];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_25BD[0x27];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_25C0[0x4];                                     // Fixing Size After Last Property 
	...
	uint8                                        Pad_25C1[0x7];                                     // Fixing Size Of Struct
};
