...
class UClass* UMediaPlate::StaticClass()
{
...
class UMediaPlate* UMediaPlate::GetDefaultObj()
{
	static class UMediaPlate* Default = nullptr;

	if (!Default)
		Default = static_cast<UMediaPlate*>(UMediaPlate::StaticClass()->DefaultObject);
