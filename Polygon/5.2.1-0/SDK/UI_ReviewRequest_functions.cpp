...
class UClass* UUI_ReviewRequest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UI_ReviewRequest_C");

	return Clss;
}


// UI_ReviewRequest_C UI_ReviewRequest.Default__UI_ReviewRequest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUI_ReviewRequest_C* UUI_ReviewRequest_C::GetDefaultObj()
{
	static class UUI_ReviewRequest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUI_ReviewRequest_C*>(UUI_ReviewRequest_C::StaticClass()->DefaultObject);
