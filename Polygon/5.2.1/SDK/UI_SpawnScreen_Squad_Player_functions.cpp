...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "OnPlayerNameChanged_Event");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "OnChangeHealth_Event");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "BndEvt__UI_SpawnScreen_Squad_Player_Button_Select_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "Destruct");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "OnEndPlay_Event");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "OnPawnSet_Event");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Squad_Player_C", "ExecuteUbergraph_UI_SpawnScreen_Squad_Player");
