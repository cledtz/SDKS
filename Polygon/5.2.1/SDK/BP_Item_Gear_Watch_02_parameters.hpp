...
public:
	...
	uint8                                        Pad_2042[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_204C[0x5];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_204D[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_204E[0x4];                                     // Fixing Size After Last Property
	class FText                                  CallFunc_Conv_DoubleToText_ReturnValue;            // 0x118(0x18)()
	...
	uint8                                        Pad_2053[0x3];                                     // Fixing Size After Last Property
	class FText                                  CallFunc_Conv_IntToText_ReturnValue_1;             // 0x168(0x18)()
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_1;            // 0x180(0x10)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FClientExecuteCloudScriptResult       K2Node_CustomEvent_result;                         // 0x190(0x60)()
	...
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x200(0x38)()
	...
	uint8                                        Pad_2054[0x3];                                     // Fixing Size After Last Property
