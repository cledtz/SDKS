...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "SetActivePage");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "SetWeaponIsHovered");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "AddNewWeaponItem");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "IsHoveredDelegate_Event");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "BndEvt__UI_Button_Primary_K2Node_ComponentBoundEvent_2_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "BndEvt__UI_Button_Secondary_K2Node_ComponentBoundEvent_3_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "BndEvt__UI_Shop_Weapon_UI_Button_Modules_K2Node_ComponentBoundEvent_1_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_Weapon_C", "ExecuteUbergraph_UI_Shop_Weapon");
