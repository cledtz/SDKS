...
public:
	...
	uint8                                        Pad_2C6D[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2C7A[0x6];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2CC2[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CC5[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CC8[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CCB[0x6];                                     // Fixing Size After Last Property
	struct FBattlePassReward                     CallFunc_GetDataTableRowFromName_OutRow;           // 0x80(0xC0)()
	...
	uint8                                        Pad_2CCF[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CD4[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CD9[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2CDE[0x5];                                     // Fixing Size After Last Property
