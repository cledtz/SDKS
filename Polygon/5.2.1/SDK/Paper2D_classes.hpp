...
{
public:
	class UPaperFlipbookComponent*               Sprite;                                            // 0x628(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_6BE[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_6BF[0x7];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        BitPad_29 : 5;                                     // Fixing Bit-Field Size
	uint8                                        Pad_704[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_706[0x8];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_730[0x10];                                     // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_734[0x5];                                      // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_735[0x10];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_73B[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_73D[0x4];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        BitPad_2A : 4;                                     // Fixing Bit-Field Size
	uint8                                        Pad_750[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_753[0x4];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_75D[0x2];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_760[0x4];                                      // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_7B2[0x3];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_7BA[0x6];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_7BD[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_7BE[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_7BF[0x10];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_7C5[0x10];                                     // Fixing Size Of Struct
