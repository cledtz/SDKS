...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_CollimatorSight_03_C", "SetCorrectiveFovMaterial");
...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_CollimatorSight_03_C", "ExecuteUbergraph_BP_Item_Optic_CollimatorSight_03");
