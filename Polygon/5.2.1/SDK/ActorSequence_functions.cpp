...
{
	static auto Func = Class->GetFunction("ActorSequenceComponent", "StopSequence");
...
{
	static auto Func = Class->GetFunction("ActorSequenceComponent", "PlaySequence");
...
{
	static auto Func = Class->GetFunction("ActorSequenceComponent", "PauseSequence");
