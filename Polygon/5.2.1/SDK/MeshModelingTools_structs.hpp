...
enum class EProceduralRectType : uint8
{
	Rectangle                      = 0,
	RoundedRectangle               = 1,
...
enum class EProceduralDiscType : uint8
{
	Disc                           = 0,
	PuncturedDisc                  = 1,
...
enum class EProceduralSphereType : uint8
{
	LatLong                        = 0,
	Box                            = 1,
...
enum class EProceduralStairsType : uint8
{
	Linear                         = 0,
	Floating                       = 1,
	Curved                         = 2,
...
enum class EPolyEditExtrudeDistanceMode : uint8
{
	ClickInViewport                = 0,
	Fixed                          = 1,
...
enum class EPolyEditExtrudeModeOptions : uint8
{
	SingleDirection                = 3,
...
enum class EPolyEditOffsetModeOptions : uint8
{
	VertexNormals                  = 2,
	SelectedTriangleNormals        = 0,
	SelectedTriangleNormalsEven    = 1,
...
enum class EPolyEditPushPullModeOptions : uint8
{
	SelectedTriangleNormals        = 0,
	SelectedTriangleNormalsEven    = 1,
	SingleDirection                = 3,
...
enum class EUVProjectionToolInitializationMode : uint8
{
	Default                        = 0,
	UsePrevious                    = 1,
	AutoFit                        = 2,
