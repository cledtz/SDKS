...
public:
	...
	uint8                                        Pad_1848[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_186D[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_186F[0xB];                                     // Fixing Size Of Struct
};
...
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1876[0x8];                                     // Fixing Size After Last Property
...
public:
	class UPlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_187B[0x8];                                     // Fixing Size After Last Property
	struct FMinimalViewInfo                      ReturnValue;                                       // 0x10(0x7C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
