...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "GiveRewardForPromoCode");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "OnPlayFabResponse_A63AC9924A800319BAD27F87EEB79850");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "BndEvt__UI_PromoCode_Button_Cancel_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "BndEvt__UI_PromoCode_Button_Redeem_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "BndEvt__UI_PromoCode_Button_OK_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "ActivatePromoCode_Success");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "ActivatePromoCode_Failure");
...
{
	static auto Func = Class->GetFunction("UI_PromoCode_C", "ExecuteUbergraph_UI_PromoCode");
