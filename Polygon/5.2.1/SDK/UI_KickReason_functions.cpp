...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "OnPlayFabResponse_3A318FC54672A87852C380886C51DFAB");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "BndEvt__UI_KickReason_Button_OK_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "WriteEvent_Success");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "WriteEvent_Failure");
...
{
	static auto Func = Class->GetFunction("UI_KickReason_C", "ExecuteUbergraph_UI_KickReason");
