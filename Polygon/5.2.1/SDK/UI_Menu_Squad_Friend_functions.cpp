...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "BP_OnItemExpansionChanged");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "BP_OnItemSelectionChanged");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "BndEvt__UI_Squad_Friend_Button_Invite_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnListItemObjectSet");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "BP_OnEntryReleased");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnPartyMemberJoined_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnPartyMemberExited_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnPartyJoined_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnPartyExited_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnGetAvatar_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "OnPresenceUpdated_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Squad_Friend_C", "ExecuteUbergraph_UI_Menu_Squad_Friend");
