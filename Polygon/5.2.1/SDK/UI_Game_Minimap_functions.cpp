...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "CreateControlPointMarkers");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "OnGameTimer_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "OnChangeTotalScore_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "OnSetTeam_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_C", "ExecuteUbergraph_UI_Game_Minimap");
