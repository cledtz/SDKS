...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "OnMouseButtonDown_Background");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "SetFocusToScoreboard");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "BndEvt__UI_Scoreboard_Player_Menu_Button_VoteKick_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "BndEvt__UI_Scoreboard_Player_Menu_Button_Report_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Scoreboard_Player_Menu_C", "ExecuteUbergraph_UI_Scoreboard_Player_Menu");
