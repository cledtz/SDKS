...
{
public:
	uint8                                        Pad_20EC[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20EE[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20EF[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20F1[0x8];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20F5[0xF];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20F8[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20F9[0x10];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20FB[0xF];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20FE[0xB];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_20FF[0xF];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2101[0x5F];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2103[0x3];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2105[0x3];                                     // Fixing Size Of Struct
};
