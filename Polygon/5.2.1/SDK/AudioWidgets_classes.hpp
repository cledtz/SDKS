...
public:
	...
	uint8                                        Pad_1DB7[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1DB8[0x1C];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_1DDF[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1DE5[0x178];                                   // Fixing Size Of Struct
...
public:
	float                                        Value;                                             // 0x150(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1E04[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1E09[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1E0A[0x768];                                   // Fixing Size Of Struct
