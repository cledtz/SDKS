...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "GetSlotByItemClass");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "Reset");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "ParsePlayerInventory");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "BndEvt__UI_Menu_Soldier_Gear_UI_Menu_Solder_Gear_Watch_Slot_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Soldier_Gear_C", "ExecuteUbergraph_UI_Menu_Soldier_Gear");
