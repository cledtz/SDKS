...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_VSS_C", "SetSight");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_VSS_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_VSS_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_VSS_C", "ExecuteUbergraph_BP_Item_Sniper_VSS");
