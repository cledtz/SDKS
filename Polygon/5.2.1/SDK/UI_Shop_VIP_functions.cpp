...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_C", "ExecuteUbergraph_UI_Shop_VIP");
