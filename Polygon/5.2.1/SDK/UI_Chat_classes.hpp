...
public:
	...
	uint8                                        Pad_2399[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_239B[0x6];                                     // Fixing Size After Last Property
	TArray<class FString>                        BadWordsList;                                      // 0x300(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("UI_Chat_C");
		return Clss;
	}
