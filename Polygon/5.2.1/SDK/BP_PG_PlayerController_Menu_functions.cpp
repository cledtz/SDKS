...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "SetVisibleHardLoadingScreen");
...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "SetVisibleSoftLoadingScreen");
...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "SwitchCamera");
...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "ShowError");
...
{
	static auto Func = Class->GetFunction("BP_PG_PlayerController_Menu_C", "ExecuteUbergraph_BP_PG_PlayerController_Menu");
