...
public:
	...
	uint8                                        Pad_5C0[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_5C1[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_5C3[0x5];                                      // Fixing Size After Last Property
	struct FEventReply                           CallFunc_Handled_ReturnValue;                      // 0x1B0(0xB8)()
...
public:
	...
	uint8                                        Pad_5DE[0x4];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_5F4[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_5FB[0x3];                                      // Fixing Size After Last Property
