...
public:
	...
	uint8                                        Pad_1B6[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1C3[0x6];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1D2[0x7];                                      // Fixing Size Of Struct
};
...
public:
	bool                                         bIsDefault;                                        // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1D6[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1DA[0x10];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1E2[0x7];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_1E8[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_1EA[0x10];                                     // Fixing Size Of Struct
};
