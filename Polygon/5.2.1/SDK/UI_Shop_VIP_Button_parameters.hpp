...
public:
	...
	uint8                                        Pad_2E9B[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2E9C[0x3];                                     // Fixing Size After Last Property
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0x6C(0x14)()
	struct FSlateColor                           K2Node_MakeStruct_SlateColor_1;                    // 0x80(0x14)()
	uint8                                        Pad_2E9D[0xC];                                     // Fixing Size After Last Property
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0xA0(0xD0)()
...
public:
	...
	struct FClientExecuteCloudScriptResult       K2Node_CustomEvent_result;                         // 0x8(0x60)()
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0xE0(0x40)()
	...
	uint8                                        Pad_2EDC[0x7];                                     // Fixing Size After Last Property
	class FText                                  CallFunc_Conv_IntToText_ReturnValue_1;             // 0x1A0(0x18)()
	bool                                         CallFunc_Greater_IntInt_ReturnValue_1;             // 0x1B8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2EDE[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2EDF[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2EE3[0x7];                                     // Fixing Size After Last Property
	...
	struct FClientExecuteCloudScriptRequest      K2Node_MakeStruct_ClientExecuteCloudScriptRequest; // 0x388(0x30)()
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0x3F8(0x18)()
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x410(0x38)()
	class UObject*                               K2Node_CustomEvent_customData_1;                   // 0x448(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_1;          // 0x450(0x18)()
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_2;          // 0x468(0x18)()
