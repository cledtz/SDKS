...
{
	static auto Func = Class->GetFunction("WeightMapSetProperties", "GetWeightMapsFunc");
...
{
	static auto Func = Class->GetFunction("MeshTopologySelectionMechanicProperties", "SelectAll");

	Params::UMeshTopologySelectionMechanicProperties_SelectAll_Params Parms;
...
{
	static auto Func = Class->GetFunction("MeshTopologySelectionMechanicProperties", "InvertSelection");

	Params::UMeshTopologySelectionMechanicProperties_InvertSelection_Params Parms;
...
{
	static auto Func = Class->GetFunction("OctreeDynamicMeshComponent", "SetDynamicMesh");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetPointSetVisibility");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetPointSetMaterial");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetLineSetVisibility");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetLineSetMaterial");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetAllPointSetsMaterial");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "SetAllLineSetsMaterial");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "RemovePointSet");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "RemoveLineSet");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "RemoveAllPointSets");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "RemoveAllLineSets");
...
// Parameters:
// class UPreviewGeometryActor*       ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UPreviewGeometryActor* UPreviewGeometry::GetActor()
{
	static auto Func = Class->GetFunction("PreviewGeometry", "GetActor");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "FindPointSet");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "FindLineSet");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "Disconnect");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "CreateInWorld");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "AddPointSet");
...
{
	static auto Func = Class->GetFunction("PreviewGeometry", "AddLineSet");
...
{
	static auto Func = Class->GetFunction("ModelingObjectsCreationAPI", "CreateTextureObject");
...
{
	static auto Func = Class->GetFunction("ModelingObjectsCreationAPI", "CreateMeshObject");
...
{
	static auto Func = Class->GetFunction("CreateMeshObjectTypeProperties", "ShouldShowPropertySet");
...
{
	static auto Func = Class->GetFunction("CreateMeshObjectTypeProperties", "GetOutputTypeNamesFunc");
...
{
	static auto Func = Class->GetFunction("CreateMeshObjectTypeProperties", "GetCurrentCreateMeshType");
...
{
	static auto Func = Class->GetFunction("PolygroupLayersProperties", "GetGroupLayersFunc");
