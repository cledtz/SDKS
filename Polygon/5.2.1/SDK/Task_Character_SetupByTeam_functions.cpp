...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "SetMaterialsByTeam");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "ReceiveActivate");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "OnSetTeam_Event");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "OnSetPlayerStateLocal_Event");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "OnIsMemberMySquad_Event");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "ScaleCharacterByDistance");
...
{
	static auto Func = Class->GetFunction("Task_Character_SetupByTeam_C", "ExecuteUbergraph_Task_Character_SetupByTeam");
