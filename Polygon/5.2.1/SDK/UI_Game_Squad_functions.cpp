...
{
	static auto Func = Class->GetFunction("UI_Game_Squad_C", "UpdateSquadMembers");
...
{
	static auto Func = Class->GetFunction("UI_Game_Squad_C", "OnMembersUpdate_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Squad_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Squad_C", "ExecuteUbergraph_UI_Game_Squad");
