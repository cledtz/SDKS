...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "OnLoaded_1C3DEABF479ED1124FB5CC964FCC7D87");
...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "OnLoaded_CA54BF554483FB7A8A73F1A47DB82EDC");
...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "ShowUnlockItem");
...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_UpgradeLevelOfPlayer_C", "ExecuteUbergraph_UI_UpgradeLevelOfPlayer");
