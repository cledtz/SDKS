...
public:
	...
	uint8                                        Pad_3E2B[0x4];                                     // Fixing size after last (predefined) property
...
public:
	...
	bool                                         bIsUObject;                                        // (0x00[0x01]) NOT AUTO-GENERATED PROPERTY
};
...
{
public:
	uint8                                        Pad_3E2C[0x8];                                     // Fixing size after last (predefined) property
	int32                                        ElementSize;                                       // (0x3C[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x40[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_3E2D[0x4];                                     // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E2E[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E2F[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E30[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E31[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E32[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E33[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E34[0x28];                                    // Fixing size after last (predefined) property
...
{
public:
	uint8                                        Pad_3E35[0x28];                                    // Fixing size after last (predefined) property
