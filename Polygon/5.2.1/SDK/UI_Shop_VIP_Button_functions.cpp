...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "SetCanBuy");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "OnPlayFabResponse_089383D84669101F1269ABB1AD6D1DB1");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "BndEvt__UI_Shop_VIP_Button_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "OnClickedBuy");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "PurchaseVIP_Failure");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "PurchaseVIP_Success");
...
{
	static auto Func = Class->GetFunction("UI_Shop_VIP_Button_C", "ExecuteUbergraph_UI_Shop_VIP_Button");
