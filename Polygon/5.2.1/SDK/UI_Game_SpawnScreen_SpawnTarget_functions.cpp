...
{
	static auto Func = Class->GetFunction("UI_Game_SpawnScreen_SpawnTarget_C", "SetNewSpawnTarget");
...
{
	static auto Func = Class->GetFunction("UI_Game_SpawnScreen_SpawnTarget_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_Game_SpawnScreen_SpawnTarget_C", "ExecuteUbergraph_UI_Game_SpawnScreen_SpawnTarget");
