...
public:
	...
	uint8                                        Pad_25CA[0x10];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_25D9[0x138];                                   // Fixing Size After Last Property
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x160(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_25DA[0x88];                                    // Fixing Size After Last Property
