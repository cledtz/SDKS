...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "WordFilter");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "SortBadWordsList");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "OnKeyDown");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "OpenChat");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "BndEvt__EditableText_Message_K2Node_ComponentBoundEvent_0_OnEditableTextCommittedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "CloseChat");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "AddMessage");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "StartPlayAnimationHiddenChat");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "PlayAnimationEvent");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "HiddenChatEvent");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "SendMessage");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "BndEvt__Button_MessageType_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "BndEvt__EditableText_Message_K2Node_ComponentBoundEvent_2_OnEditableTextChangedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "SelectMessageType");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "BndEvt__Button_CloseChat_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "OnAddedToFocusPath");
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "Construct");
...
// struct FGameChatMessage            CallFunc_Array_Get_Item                                          ()
...
// struct FGameChatMessage            K2Node_CustomEvent_Message                                       ()
...
// struct FGameChatMessage            K2Node_MakeStruct_GameChatMessage                                ()
...
{
	static auto Func = Class->GetFunction("UI_Chat_C", "ExecuteUbergraph_UI_Chat");
