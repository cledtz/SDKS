...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "OnSetTeam_Event");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "ExecuteUbergraph_UI_TeamBaseMarker");
...
{
	static auto Func = Class->GetFunction("UI_TeamBaseMarker_C", "SelectAsSpawnPointDelegate__DelegateSignature");
