...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "ReceiveActivate");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "OnConnectionStateChange_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "OnResponseReserveSlot_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "OnPutInQueue_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "OnClickLeave_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "ReceiveFinished");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "ExecuteUbergraph_Task_Multiplayer_RequestReserveSlots");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_RequestReserveSlots_C", "OnFinished__DelegateSignature");
