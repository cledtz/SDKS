...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "OnMappingsChanged_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "OnSetCurrentGun_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "OnEnable_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkey_Entry_C", "ExecuteUbergraph_UI_Game_Hotkey_Entry");
