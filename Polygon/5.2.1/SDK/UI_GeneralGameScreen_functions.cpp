...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "ToggleMenu");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "SetActiveScreenIndex");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "OnKeyDown");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "OnSuccess_687E902B488342B2BAC8458BD7DE2584");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "OnNewLevelReceived_Event");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "OnTeamWon_Event");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "DeveloperLogin_Failure");
...
{
	static auto Func = Class->GetFunction("UI_GeneralGameScreen_C", "ExecuteUbergraph_UI_GeneralGameScreen");
