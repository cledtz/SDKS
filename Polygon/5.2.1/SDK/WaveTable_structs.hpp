...
public:
	...
	uint8                                        Pad_9BD[0x3];                                      // Fixing Size After Last Property
	...
	float                                        FinalValue;                                        // 0xA0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_9BF[0x4];                                      // Fixing Size Of Struct
};
...
{
public:
	struct FWaveTableTransform                   Transform;                                         // 0x0(0xA8)(Edit, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_9F3[0x6];                                      // Fixing Size After Last Property
