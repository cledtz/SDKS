...
public:
	...
	uint8                                        Pad_4D8[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4DA[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_4DC[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_4DD[0x2];                                      // Fixing Size After Last Property
	...
	struct FMeshNaniteSettings                   NaniteSettings;                                    // 0xD0(0x38)(Edit, NativeAccessSpecifierPublic)
	uint8                                        Pad_4E0[0x4F8];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_4E2[0x7];                                      // Fixing Size After Last Property
	class UActor*                                NewActor;                                          // 0x8(0x8)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_4E4[0x4];                                      // Fixing Size After Last Property
...
public:
	enum class ECreateModelingObjectResult       ResultCode;                                        // 0x0(0x1)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4E8[0x7];                                      // Fixing Size After Last Property
