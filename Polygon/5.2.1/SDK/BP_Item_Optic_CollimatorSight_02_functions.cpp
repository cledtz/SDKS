...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_CollimatorSight_02_C", "SetCorrectiveFovMaterial");
...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_CollimatorSight_02_C", "ExecuteUbergraph_BP_Item_Optic_CollimatorSight_02");
