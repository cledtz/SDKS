...
{
	static auto Func = Class->GetFunction("UI_HitIndicator_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_HitIndicator_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_HitIndicator_C", "ExecuteUbergraph_UI_HitIndicator");
