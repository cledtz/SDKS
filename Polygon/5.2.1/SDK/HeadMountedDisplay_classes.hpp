...
public:
	...
	class FName                                  MotionSource;                                      // 0x570(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bDisableLowLatencyUpdate : 1;                      // Mask: 0x1, PropSize: 0x10x578(0x1)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        BitPad_CE : 7;                                     // Fixing Bit-Field Size
	uint8                                        Pad_219D[0x3];                                     // Fixing Size After Last Property
	enum class ETrackingStatus                   CurrentTrackingStatus;                             // 0x57C(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_21A0[0xB];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_21A2[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_21A6[0xE8];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_2207[0x8];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2208[0x3];                                     // Fixing Size After Last Property
	class FName                                  DisplayModelSource;                                // 0x624(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2209[0x4];                                     // Fixing Size After Last Property
	class UStaticMesh*                           CustomDisplayMesh;                                 // 0x630(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMaterialInterface*>            DisplayMeshMaterialOverrides;                      // 0x638(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                        Pad_220A[0x28];                                    // Fixing Size Of Struct
