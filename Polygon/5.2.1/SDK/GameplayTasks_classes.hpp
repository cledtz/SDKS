...
{
public:
	uint8                                        Pad_275B[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_275C[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_275D[0x25];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_275F[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2760[0x7];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_2768[0x14];                                    // Fixing Size After Last Property
	uint8                                        BitPad_134 : 1;                                    // Fixing Bit-Field Size
	...
	uint8                                        Pad_276A[0x10];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2785[0x30];                                    // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_2787[0x18];                                    // Fixing Size Of Struct
...
public:
	...
	uint8                                        Pad_278F[0x10];                                    // Fixing Size Of Struct
