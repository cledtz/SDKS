...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "SetCorrectiveFovMaterialImplementation");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "SetVisibleMarkerByDistance");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "OnAiming");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "SetPlayerLooksOverride");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "UserConstructionScript");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "Timeline_NeutralizationVignetteImpact__FinishedFunc");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "Timeline_NeutralizationVignetteImpact__UpdateFunc");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "Timeline_PostProcessScopeBlurWeight__FinishedFunc");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "Timeline_PostProcessScopeBlurWeight__UpdateFunc");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "BndEvt__BP_PG_Character_WeaponComponent_K2Node_ComponentBoundEvent_0_OnAimingDelegate__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "OnIsAlive_Event");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "SetPlayerLooks");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "CameraNeutralizationEffectEvent");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "EventTakeDamage");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "Respawn");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "HitAtProtectedCharacter");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "DeathEvent");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "OnJumped");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "SetCorrectiveFovMaterial");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_PG_Game_Character_C", "ExecuteUbergraph_BP_PG_Game_Character");
