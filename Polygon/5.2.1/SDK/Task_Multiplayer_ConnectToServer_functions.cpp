...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "OnPlayFabResponse_3F9ED0AB4BF39E9BF514A8BC8A2291FA");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "ReceiveActivate");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "OnPasswordEntered_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "OnCanceled_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "ReceiveFinished");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "WritePlayerEvent_Success");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "WritePlayerEvent_Failure");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "OnReserveSlotFinished_Event");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "CustomEvent_0");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "CustomEvent_1");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "ExecuteUbergraph_Task_Multiplayer_ConnectToServer");
...
{
	static auto Func = Class->GetFunction("Task_Multiplayer_ConnectToServer_C", "OnFinished__DelegateSignature");
