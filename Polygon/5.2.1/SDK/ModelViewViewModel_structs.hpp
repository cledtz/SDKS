...
public:
	...
	uint8                                        Pad_311[0x1];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_313[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_319[0x1];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_322[0x18];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_325[0x2];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_32A[0x2];                                      // Fixing Size After Last Property
	...
	enum class EMVVMExecutionMode                ExecutionMode;                                     // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Flags;                                             // 0x19(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_32C[0x2];                                      // Fixing Size Of Struct
};
