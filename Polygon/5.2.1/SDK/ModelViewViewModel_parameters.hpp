...
public:
	...
	uint8                                        Pad_2DD[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2E1[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2E5[0x3];                                      // Fixing Size Of Struct
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x10(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2EF[0x7];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2F2[0x4];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2F9[0x7];                                      // Fixing Size Of Struct
};
