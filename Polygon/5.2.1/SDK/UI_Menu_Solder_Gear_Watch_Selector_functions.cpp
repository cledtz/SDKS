...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "OnKeyDown");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "SetToolTipInfo");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "SpawnWatch");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "AddWatch");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "Reset");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "ParsePlayerInventory");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "BndEvt__UI_Menu_Solder_Weapon_Gun_Selector_Button_Back_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "Back");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "Destruct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Gear_Watch_Selector_C", "ExecuteUbergraph_UI_Menu_Solder_Gear_Watch_Selector");
