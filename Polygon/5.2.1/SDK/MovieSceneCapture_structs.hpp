...
public:
	...
	TSubclassOf<class UGameModeBase>             GameModeOverride;                                  // 0x10(0x8)(Edit, BlueprintVisible, ZeroConstructor, Config, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2692[0x2];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2696[0x4];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2699[0x10];                                    // Fixing Size Of Struct
};
