...
public:
	...
	uint8                                        Pad_B5A[0x7];                                      // Fixing Size After Last Property
...
public:
	bool                                         bOnlyIncludeChecked;                               // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B5C[0x7];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_B62[0x6];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_B65[0x7];                                      // Fixing Size Of Struct
};
