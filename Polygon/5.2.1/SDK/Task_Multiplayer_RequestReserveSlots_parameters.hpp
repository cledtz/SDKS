...
public:
	...
	uint8                                        Pad_1B7F[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CAD[0x6];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CB7[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CBD[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CBF[0x7];                                     // Fixing Size After Last Property
	class FText                                  CallFunc_Conv_ByteToText_ReturnValue;              // 0x1D8(0x18)()
	bool                                         CallFunc_IsValid_ReturnValue_1;                    // 0x1F0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1CC2[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CC5[0x1];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1CCA[0x3];                                     // Fixing Size After Last Property
