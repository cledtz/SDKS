...
{
public:
	uint8                                        Pad_132[0x10];                                     // Fixing Size Of Struct

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestJsonObject");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_18D[0x10];                                     // Fixing Size Of Struct

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestJsonValue");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestLibrary");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_266[0x40];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_267[0x4];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_268[0xF];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_269[0x48];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_26A[0xD0];                                     // Fixing Size Of Struct

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestRequestJSON");
		return Clss;
	}
...
public:
	...
	uint8                                        Pad_2AB[0x6];                                      // Fixing Size Of Struct

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestSettings");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("VaRestSubsystem");
		return Clss;
	}
