...
{
	static auto Func = Class->GetFunction("AnimNotifyState_TimedNiagaraEffect", "GetSpawnedEffect");
...
{
	static auto Func = Class->GetFunction("AnimNotifyState_TimedNiagaraEffectAdvanced", "GetNotifyProgress");
...
{
	static auto Func = Class->GetFunction("AnimNotify_PlayNiagaraEffect", "GetSpawnedEffect");
