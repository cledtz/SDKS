...
{
	static auto Func = Class->GetFunction("Task_Menu_CameraTransition_C", "ReceiveActivate");
...
{
	static auto Func = Class->GetFunction("Task_Menu_CameraTransition_C", "SwitchCamera_Event");
...
{
	static auto Func = Class->GetFunction("Task_Menu_CameraTransition_C", "ExecuteUbergraph_Task_Menu_CameraTransition");
