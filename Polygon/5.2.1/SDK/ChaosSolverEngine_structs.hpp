...
public:
	...
	struct FVector                               Extents;                                           // 0x50(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Mass;                                              // 0x68(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        Index;                                             // 0x6C(0x4)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         bFromCrumble;                                      // 0x70(0x1)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_227F[0x7];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_2282[0x4];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_2286[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2287[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2288[0x40];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_2289[0x8];                                     // Fixing Size After Last Property
