...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "SetCrosshairPosition");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "OnApplyGunDamage_Event");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "OnSetCurrentGun_Event");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "OnPossessedPawnChanged_Event_0");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Crosshair_C", "ExecuteUbergraph_UI_Crosshair");
