...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "Reset");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "OnUpdateGunData");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "BndEvt__UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_Button_Back_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress_C", "ExecuteUbergraph_UI_Menu_Solder_Weapon_Gun_Gunsmith_Progress");
