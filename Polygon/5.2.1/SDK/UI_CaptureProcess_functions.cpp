...
{
	static auto Func = Class->GetFunction("UI_CaptureProcess_C", "GetCapturePointsByTeam");
...
{
	static auto Func = Class->GetFunction("UI_CaptureProcess_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_CaptureProcess_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_CaptureProcess_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_CaptureProcess_C", "ExecuteUbergraph_UI_CaptureProcess");
