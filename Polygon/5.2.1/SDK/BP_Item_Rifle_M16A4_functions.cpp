...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_M16A4_C", "SetSight");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_M16A4_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_M16A4_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_M16A4_C", "ExecuteUbergraph_BP_Item_Rifle_M16A4");
