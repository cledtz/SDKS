...
{
	static auto Func = Class->GetFunction("UI_ItemCharacteristic_Parameter_C", "CalculateParameters");
...
{
	static auto Func = Class->GetFunction("UI_ItemCharacteristic_Parameter_C", "SetParameters");
...
{
	static auto Func = Class->GetFunction("UI_ItemCharacteristic_Parameter_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_ItemCharacteristic_Parameter_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_ItemCharacteristic_Parameter_C", "ExecuteUbergraph_UI_ItemCharacteristic_Parameter");
