...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnChangeHealth_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnSetCurrentGun_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnChangeNumberGrenades_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnPossessedPawnChanged_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnChangeStockAmmo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "OnChangeCurrentNumberAmmo_Event");
...
{
	static auto Func = Class->GetFunction("UI_Indicators_C", "ExecuteUbergraph_UI_Indicators");
