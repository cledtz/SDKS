...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherIcon_C", "FindCoord");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherIcon_C", "FindAngle");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherIcon_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherIcon_C", "CalculatePosition");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherIcon_C", "ExecuteUbergraph_UI_Game_Minimap_OtherIcon");
