...
class UBP_Item_Sniper_VSS_C : public UItem_Gun_Sniper
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_Item_Sniper_VSS_C");
		return Clss;
	}
	...
	void ExecuteUbergraph_BP_Item_Sniper_VSS(int32 EntryPoint, bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate);
};
