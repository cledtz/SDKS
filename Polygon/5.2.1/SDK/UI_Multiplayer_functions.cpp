...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "DirectConnectToServer");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "BndEvt__UI_Button_Quickmatch_K2Node_ComponentBoundEvent_3_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "BndEvt__UI_Button_ServerList_K2Node_ComponentBoundEvent_4_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "BndEvt__UI_Button_CreateServer_K2Node_ComponentBoundEvent_5_OnClick__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "OnClick_Event");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Multiplayer_C", "ExecuteUbergraph_UI_Multiplayer");
