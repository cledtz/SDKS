...
{
	static auto Func = Class->GetFunction("UI_MainMenu_Shop_Premium_SpecialOffers_C", "RemoveOfferByClass");
...
{
	static auto Func = Class->GetFunction("UI_MainMenu_Shop_Premium_SpecialOffers_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_MainMenu_Shop_Premium_SpecialOffers_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_MainMenu_Shop_Premium_SpecialOffers_C", "ExecuteUbergraph_UI_MainMenu_Shop_Premium_SpecialOffers");
