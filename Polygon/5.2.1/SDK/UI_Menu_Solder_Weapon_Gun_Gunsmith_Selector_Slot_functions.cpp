...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "OnPaint");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "SetModuleInfo");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "Reset");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "BndEvt__UI_Menu_Solder_Weapon_Gun_Gunsmith_General_Slot_Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "BndEvt__UI_Menu_Solder_Weapon_Gun_Gunsmith_General_Slot_Button_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "BndEvt__UI_Menu_Solder_Weapon_Gun_Gunsmith_General_Slot_Button_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot_C", "ExecuteUbergraph_UI_Menu_Solder_Weapon_Gun_Gunsmith_Selector_Slot");
