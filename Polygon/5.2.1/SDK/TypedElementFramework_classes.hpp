...
{
public:
	uint8                                        Pad_20BA[0x950];                                   // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_20E6[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_20EA[0x8];                                     // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_20EB[0x10];                                    // Fixing Size Of Struct
