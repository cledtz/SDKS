...
public:
	...
	uint8                                        Pad_38B[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_38C[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_38E[0x5];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_390[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_393[0x6];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_396[0x7];                                      // Fixing Size After Last Property
	class FText                                  CallFunc_MakeLiteralText_ReturnValue_1;            // 0x170(0x18)()
	...
	uint8                                        Pad_3AF[0x6];                                      // Fixing Size After Last Property
	struct FClientWriteEventResponse             K2Node_CustomEvent_result_1;                       // 0x1F8(0x18)()
	class UObject*                               K2Node_CustomEvent_customData_3;                   // 0x210(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabError                         K2Node_CustomEvent_error_1;                        // 0x218(0x38)()
	...
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest; // 0x270(0x38)()
	...
	uint8                                        Pad_3C6[0x3];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_3C8[0x6];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_3DF[0x7];                                      // Fixing Size After Last Property
	...
	class FText                                  CallFunc_Format_ReturnValue_1;                     // 0x348(0x18)()
	...
	uint8                                        Pad_3E5[0x6];                                      // Fixing Size After Last Property
	...
	struct FClientWriteEventResponse             K2Node_CustomEvent_result;                         // 0x3B0(0x18)()
	class UObject*                               K2Node_CustomEvent_customData_1;                   // 0x3C8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabError                         K2Node_CustomEvent_error;                          // 0x3D0(0x38)()
