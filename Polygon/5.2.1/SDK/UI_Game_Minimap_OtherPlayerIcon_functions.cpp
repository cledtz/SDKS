...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "CalculateMarkerPosition");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "FindCoord");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "FindAngle");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "CalculatePosition_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "OnIsAlive_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "OnIsMemberMySquad_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Minimap_OtherPlayerIcon_C", "ExecuteUbergraph_UI_Game_Minimap_OtherPlayerIcon");
