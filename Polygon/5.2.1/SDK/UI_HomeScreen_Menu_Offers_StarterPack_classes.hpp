...
class UUI_HomeScreen_Menu_Offers_StarterPack_C : public UUserWidget
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("UI_HomeScreen_Menu_Offers_StarterPack_C");
		return Clss;
	}
