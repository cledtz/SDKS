...
{
	static auto Func = Class->GetFunction("UI_ModuleInfo_C", "SetDescription");
...
{
	static auto Func = Class->GetFunction("UI_ModuleInfo_C", "SetRare");
...
{
	static auto Func = Class->GetFunction("UI_ModuleInfo_C", "FindModuleCharacteristic");
...
{
	static auto Func = Class->GetFunction("UI_ModuleInfo_C", "ParseModuleInfo");
...
{
	static auto Func = Class->GetFunction("UI_ModuleInfo_C", "Reset");
