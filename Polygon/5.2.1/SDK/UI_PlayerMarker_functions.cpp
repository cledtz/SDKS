...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "SetupAsSquadMember");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "SetupAsEnemy");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "SetupAsFriendly");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "SetOwnerCharacter");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "OnSetPlayerState_Event");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "OnChangeHealth_Event");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "SetActiveIndex");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "OnHealthProtection_Event");
...
{
	static auto Func = Class->GetFunction("UI_PlayerMarker_C", "ExecuteUbergraph_UI_PlayerMarker");
