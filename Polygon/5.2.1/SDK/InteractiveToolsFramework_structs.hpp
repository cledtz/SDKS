...
public:
	...
	uint8                                        Pad_231[0x2];                                      // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_232[0x3];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_238[0x128];                                    // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_23A[0x7];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_23C[0x8];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_23D[0x7];                                      // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_23E[0x28];                                     // Fixing Size Of Struct
};
