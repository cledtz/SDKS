...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "OnKeyUp");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "OnKeyDown");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "ShowGameResult");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "BndEvt__Button_Exit_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_MatchResult_C", "ExecuteUbergraph_UI_MatchResult");
