...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetRareColor");
...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetDefaultModuleClassByType");
...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetActorRelativeLocation");
...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetGameInstance");
...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetGameModeBP_Game");
...
{
	static auto Func = Class->GetFunction("BPFL_General_C", "GetGameStateBP");
