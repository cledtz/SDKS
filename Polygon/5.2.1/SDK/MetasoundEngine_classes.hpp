...
public:
	...
	uint8                                        Pad_1D70[0x30];                                    // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1D8C[0x68];                                    // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_1D9C[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1D9D[0x198];                                   // Fixing Size Of Struct
...
{
public:
	uint8                                        Pad_1DA1[0x68];                                    // Fixing Size After Last Property
	...
	uint8                                        Pad_1DA6[0x6C];                                    // Fixing Size Of Struct
