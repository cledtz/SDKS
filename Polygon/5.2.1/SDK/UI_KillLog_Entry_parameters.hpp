...
struct UUI_KillLog_Entry_C_PreConstruct_Params
{
public:
...
struct UUI_KillLog_Entry_C_Construct_Params
{
public:
};
...
struct UUI_KillLog_Entry_C_ExecuteUbergraph_UI_KillLog_Entry_Params
{
public:
	...
	uint8                                        Pad_1D23[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1D29[0x5];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1D2B[0x7];                                     // Fixing Size After Last Property
	...
	class FString                                CallFunc_GetPlayerName_ReturnValue_1;              // 0x78(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_1;          // 0x88(0x18)()
	class UPG_Game_Character*                    K2Node_DynamicCast_AsPG_Game_Character;            // 0xA0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xA8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D2D[0x7];                                     // Fixing Size After Last Property
	class UBP_PG_PlayerState_Game_C*             K2Node_DynamicCast_AsBP_PG_Player_State_Game;      // 0xB0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_1D32[0x1];                                     // Fixing Size After Last Property
	struct FLinearColor                          Temp_struct_Variable_3;                            // 0xBC(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                          K2Node_Select_Default;                             // 0xCC(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0xDC(0x14)()
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue_1;        // 0xF0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0xF1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D36[0x2];                                     // Fixing Size After Last Property
	struct FLinearColor                          K2Node_Select_Default_1;                           // 0xF4(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateColor                           K2Node_MakeStruct_SlateColor_1;                    // 0x104(0x14)()
};
