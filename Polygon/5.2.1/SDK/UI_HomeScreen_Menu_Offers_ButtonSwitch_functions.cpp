...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_ButtonSwitch_C", "SetIsActive");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_ButtonSwitch_C", "BndEvt__UI_HomeScreen_Offer_News_ButtonSwitch_Button_K2Node_ComponentBoundEvent_0_OnButtonPressedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_ButtonSwitch_C", "ExecuteUbergraph_UI_HomeScreen_Menu_Offers_ButtonSwitch");
