...
{
public:
	uint8                                        Pad_1E28[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1E37[0x2];                                     // Fixing Size After Last Property
...
{
public:
	uint8                                        Pad_1E3D[0x8];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1E3E[0xC];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1E42[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1E44[0x8];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_1E49[0xC];                                     // Fixing Size Of Struct
};
