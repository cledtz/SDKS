...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "SetIsEquipped");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "BndEvt__UI_SpawnScreen_Loadout_Full_Item_Button_K2Node_ComponentBoundEvent_1_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "BndEvt__UI_SpawnScreen_Loadout_Full_Item_Button_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "BndEvt__Button_K2Node_ComponentBoundEvent_2_OnButtonPressedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "Initialize");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "ExecuteUbergraph_UI_SpawnScreen_Loadout_Full_Item_Gun");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "OnPressed__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_SpawnScreen_Loadout_Full_Item_Gun_C", "OnHovered__DelegateSignature");
