...
public:
	...
	uint8                                        Pad_2A59[0x2];                                     // Fixing Size After Last Property
...
struct UBP_Item_Rifle_Vector_C_ReceiveBeginPlay_Params
{
public:
};
...
struct UBP_Item_Rifle_Vector_C_OnSetGunModules_Event_Params
{
public:
};
...
struct UBP_Item_Rifle_Vector_C_ExecuteUbergraph_BP_Item_Rifle_Vector_Params
{
public:
	...
	uint8                                        Pad_2A5C[0x2];                                     // Fixing Size After Last Property
