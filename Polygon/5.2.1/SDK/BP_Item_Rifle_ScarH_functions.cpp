...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_ScarH_C", "SetSight");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_ScarH_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_ScarH_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_ScarH_C", "ExecuteUbergraph_BP_Item_Rifle_ScarH");
