...
public:
	...
	uint8                                        Pad_3392[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_3399[0x4];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_339A[0x7];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_33A1[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_33A2[0x4];                                     // Fixing Size After Last Property
...
{
public:
	class FText                                  CallFunc_Conv_ByteToText_ReturnValue;              // 0x0(0x18)()
};
...
public:
	...
	uint8                                        Pad_33B1[0x4];                                     // Fixing Size After Last Property
	...
	struct FSlateColor                           K2Node_MakeStruct_SlateColor;                      // 0xB4(0x14)()
	struct FLevelInfo                            CallFunc_GetCurrentLevelInfo_ReturnValue;          // 0xC8(0x48)()
	bool                                         CallFunc_Greater_IntInt_ReturnValue;               // 0x110(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_33BE[0x7];                                     // Fixing Size After Last Property
