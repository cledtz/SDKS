...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "SetSelectedMap");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "ParsePlayerCombinedInfo");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "BndEvt__Button_Play_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "BndEvt__Button_StartServer_K2Node_ComponentBoundEvent_5_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "CreateServer");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "BndEvt__UI_CreateServer_Button_CreateServer_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "BndEvt__UI_CreateServer_Button_ShowPassword_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "OnRequestServerFinished_Event");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_CreateServer_C", "ExecuteUbergraph_UI_CreateServer");
