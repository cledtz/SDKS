...
{
public:
	uint8                                        Pad_AF6[0xC0];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_AF8[0xC];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_AFC[0x9];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_AFD[0xC8];                                     // Fixing Size Of Struct
};
