...
public:
	...
	uint8                                        Pad_114C[0x3];                                     // Fixing Size After Last Property
	...
	{
		static class UClass* Clss = UObject::FindClassFast("Action");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("ActionLibrary");
		return Clss;
	}
...
{
public:
	uint8                                        Pad_1160[0x8];                                     // Fixing Size After Last Property
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("ActionsSubsystem");
		return Clss;
	}
...
public:
	...
	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("BTT_RunAction");
		return Clss;
	}
