...
public:
	...
	uint8                                        Pad_1A77[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_1A7A[0x3];                                     // Fixing Size After Last Property
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ImgMediaSettings");
		return Clss;
	}
