...
class UBP_Item_Rifle_Vector_C : public UItem_Gun_Rifle
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_Item_Rifle_Vector_C");
		return Clss;
	}
	...
	void ExecuteUbergraph_BP_Item_Rifle_Vector(int32 EntryPoint, bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate);
};
