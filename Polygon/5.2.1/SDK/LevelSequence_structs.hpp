...
{
public:
	uint8                                        Pad_161F[0x20];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1620[0x50];                                    // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_1621[0x1];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_162D[0x1];                                     // Fixing Size Of Struct
};
