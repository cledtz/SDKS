...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_AK47_C", "SetSight");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_AK47_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_AK47_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("BP_Item_Rifle_AK47_C", "ExecuteUbergraph_BP_Item_Rifle_AK47");
