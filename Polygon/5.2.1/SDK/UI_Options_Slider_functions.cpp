...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "ApplyValue");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "GetValue");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "SetValue");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "BndEvt__Slider_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "BndEvt__Slider_K2Node_ComponentBoundEvent_1_OnMouseCaptureEndEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "ExecuteUbergraph_UI_Options_Slider");
...
{
	static auto Func = Class->GetFunction("UI_Options_Slider_C", "OnValueChanged__DelegateSignature");
