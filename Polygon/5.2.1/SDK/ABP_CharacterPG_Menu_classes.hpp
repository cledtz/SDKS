...
public:
	...
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_7;                        // 0x3F0(0x128)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_3;             // 0x518(0x20)()
	struct FAnimNode_LayeredBoneBlend            AnimGraphNode_LayeredBoneBlend_1;                  // 0x538(0xE0)()
	uint8                                        Pad_583[0x8];                                      // Fixing Size After Last Property
	struct FAnimNode_TwoBoneIK                   AnimGraphNode_TwoBoneIK_1;                         // 0x620(0x280)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_3;             // 0x8A0(0x20)()
	struct FAnimNode_TwoBoneIK                   AnimGraphNode_TwoBoneIK;                           // 0x8C0(0x280)()
	struct FAnimNode_CopyBone                    AnimGraphNode_CopyBone_1;                          // 0xB40(0xF0)()
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator_1;                 // 0xC30(0x40)()
	...
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_4;                        // 0xEC0(0x128)()
	struct FAnimNode_BlendListByBool             AnimGraphNode_BlendListByBool;                     // 0xFE8(0x48)()
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator;                   // 0x1030(0x40)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_2;             // 0x1070(0x20)()
	struct FAnimNode_LayeredBoneBlend            AnimGraphNode_LayeredBoneBlend;                    // 0x1090(0xE0)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_3;                        // 0x1170(0x128)()
	struct FAnimNode_CopyBone                    AnimGraphNode_CopyBone;                            // 0x1298(0xF0)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_2;             // 0x1388(0x20)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_1;             // 0x13A8(0x20)()
	struct FAnimNode_SaveCachedPose              AnimGraphNode_SaveCachedPose;                      // 0x13C8(0x108)()
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose_1;                     // 0x14D0(0x28)()
	struct FAnimNode_UseCachedPose               AnimGraphNode_UseCachedPose;                       // 0x14F8(0x28)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_1;             // 0x1520(0x20)()
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;               // 0x1540(0x20)()
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace;               // 0x1560(0x20)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_2;                        // 0x1580(0x128)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone_1;                        // 0x16A8(0x128)()
	struct FAnimNode_ModifyBone                  AnimGraphNode_ModifyBone;                          // 0x17D0(0x128)()
	...
	uint8                                        Pad_589[0x8];                                      // Fixing Size After Last Property
	...
	uint8                                        Pad_58B[0x7];                                      // Fixing Size After Last Property
	...
	{
		static class UClass* Clss = UObject::FindClassFast("ABP_CharacterPG_Menu_C");
		return Clss;
	}
