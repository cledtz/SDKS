...
enum class EBakeNormalSpace : uint8
{
	Tangent                        = 0,
	Object                         = 1,
...
enum class EBakeCurvatureTypeMode : uint8
{
	MeanAverage                    = 0,
	Max                            = 1,
	Min                            = 2,
...
enum class EBakeCurvatureColorMode : uint8
{
	Grayscale                      = 0,
	RedBlue                        = 1,
	RedGreenBlue                   = 2,
...
enum class EBakeCurvatureClampMode : uint8
{
	None                           = 0,
	OnlyPositive                   = 1,
	OnlyNegative                   = 2,
...
enum class EBakeVertexOutput : uint8
{
	RGBA                           = 0,
	PerChannel                     = 1,
...
enum class EBakeVertexChannel : uint8
{
	R                              = 0,
	G                              = 1,
	B                              = 2,
...
enum class ECubeGridToolFaceSelectionMode : uint8
{
...
enum class EDrawPolyPathRadiusMode : uint8
{
	Fixed                          = 0,
	Interactive                    = 1,
...
enum class EDrawPolyPathExtrudeMode : uint8
{
	Flat                           = 0,
	Fixed                          = 1,
	Interactive                    = 2,
...
enum class EBrushActionMode : uint8
{
	Paint                          = 0,
	FloodFill                      = 1,
...
public:
	...
	uint8                                        Pad_1129[0x4];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_112B[0xC];                                     // Fixing Size After Last Property
...
public:
	...
	uint8                                        Pad_112D[0x8];                                     // Fixing Size After Last Property
	struct FTransform                            Transform;                                         // 0x10(0x60)(Edit, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FKShapeElem                           Element;                                           // 0x70(0x30)(Edit, EditConst, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1135[0x8];                                     // Fixing Size Of Struct
};
