...
public:
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response_1;                     // 0x8(0x40)()
	...
	uint8                                        Pad_30E3[0x3];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_30E6[0x3];                                     // Fixing Size After Last Property
	...
	struct FPlayFabBaseModel                     K2Node_CustomEvent_response;                       // 0xD8(0x40)()
	...
	uint8                                        Pad_30F3[0x3];                                     // Fixing Size After Last Property
	class UObject*                               Temp_object_Variable_1;                            // 0x138(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPlayFabBaseModel                     Temp_struct_Variable_1;                            // 0x140(0x40)()
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest; // 0x180(0x38)()
	...
	struct FClientWriteEventResponse             K2Node_CustomEvent_result;                         // 0x1C8(0x18)()
	...
	uint8                                        Pad_30F7[0x7];                                     // Fixing Size After Last Property
	...
	struct FClientWriteClientPlayerEventRequest  K2Node_MakeStruct_ClientWriteClientPlayerEventRequest_1; // 0x230(0x38)()
