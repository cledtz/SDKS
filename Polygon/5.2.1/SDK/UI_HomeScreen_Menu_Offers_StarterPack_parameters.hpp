...
struct UUI_HomeScreen_Menu_Offers_StarterPack_C_Construct_Params
{
public:
};
...
struct UUI_HomeScreen_Menu_Offers_StarterPack_C_OnHovered_Event_Params
{
public:
...
struct UUI_HomeScreen_Menu_Offers_StarterPack_C_BndEvt__UI_HomeScreen_Offer_News_NewModules_Button_Shop_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
public:
};
...
struct UUI_HomeScreen_Menu_Offers_StarterPack_C_BndEvt__UI_HomeScreen_Menu_Offers_StarterPack_Button_Buy_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature_Params
{
public:
};
...
struct UUI_HomeScreen_Menu_Offers_StarterPack_C_ExecuteUbergraph_UI_HomeScreen_Menu_Offers_StarterPack_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x4(0x10)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2AE3[0x4];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2AE5[0x7];                                     // Fixing Size After Last Property
	...
	class UUI_MainMenu_Shop_Premium_Offers_StarterPack_BuyPage_C* CallFunc_Create_ReturnValue;                       // 0x48(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
