...
class UBP_Item_Gear_Watch_09_C : public UItem_Watch_General
{
public:
	...
	{
		static class UClass* Clss = UObject::FindClassFast("BP_Item_Gear_Watch_09_C");
		return Clss;
	}
