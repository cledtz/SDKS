...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_ElcanDR_01_C", "SetCorrectiveFovMaterial");
...
{
	static auto Func = Class->GetFunction("BP_Item_Optic_ElcanDR_01_C", "ExecuteUbergraph_BP_Item_Optic_ElcanDR_01");
