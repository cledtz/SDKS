...
class UUI_MainMenu_Shop_Premium_Offers_StarterPack_C : public UUserWidget
{
public:
	...
	uint8                                        Pad_2B03[0x4];                                     // Fixing Size After Last Property
	class UUI_HomeScreen_Menu_Offers_StarterPack_C* OfferOnHomeMenu;                                   // 0x2A8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass()
	{
		static class UClass* Clss = UObject::FindClassFast("UI_MainMenu_Shop_Premium_Offers_StarterPack_C");
		return Clss;
	}
