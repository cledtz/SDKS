...
{
	static auto Func = Class->GetFunction("ImgMediaSource", "SetTokenizedSequencePath");
...
{
	static auto Func = Class->GetFunction("ImgMediaSource", "SetSequencePath");
...
{
	static auto Func = Class->GetFunction("ImgMediaSource", "SetMipLevelDistance");
...
void UImgMediaSource::RemoveTargetObject(class UActor* InActor)
{
	static auto Func = Class->GetFunction("ImgMediaSource", "RemoveTargetObject");
...
void UImgMediaSource::RemoveGlobalCamera(class UActor* InActor)
{
	static auto Func = Class->GetFunction("ImgMediaSource", "RemoveGlobalCamera");
...
{
	static auto Func = Class->GetFunction("ImgMediaSource", "GetSequencePath");
...
{
	static auto Func = Class->GetFunction("ImgMediaSource", "GetProxies");
...
void UImgMediaSource::AddTargetObject(class UActor* InActor)
{
	static auto Func = Class->GetFunction("ImgMediaSource", "AddTargetObject");
...
void UImgMediaSource::AddGlobalCamera(class UActor* InActor)
{
	static auto Func = Class->GetFunction("ImgMediaSource", "AddGlobalCamera");
