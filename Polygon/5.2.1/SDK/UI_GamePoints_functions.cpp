...
{
	static auto Func = Class->GetFunction("UI_GamePoints_C", "CreateGamePointEntryWidget");
...
{
	static auto Func = Class->GetFunction("UI_GamePoints_C", "AddNewPointMessage");
...
{
	static auto Func = Class->GetFunction("UI_GamePoints_C", "Tick");
...
{
	static auto Func = Class->GetFunction("UI_GamePoints_C", "ExecuteUbergraph_UI_GamePoints");
