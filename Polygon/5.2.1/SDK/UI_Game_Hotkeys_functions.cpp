...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkeys_C", "OnSetCurrentGun_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkeys_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkeys_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("UI_Game_Hotkeys_C", "ExecuteUbergraph_UI_Game_Hotkeys");
