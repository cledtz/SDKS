...
{
public:
	uint8                                        Pad_9ED[0x10];                                     // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_9EE[0x10];                                     // Fixing Size Of Struct
};
...
public:
	...
	uint8                                        Pad_9EF[0xE];                                      // Fixing Size Of Struct
};
...
{
public:
	uint8                                        Pad_9F2[0x10];                                     // Fixing Size Of Struct
};
