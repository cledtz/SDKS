...
{
public:
	TScriptInterface<class UGameplayTaskOwnerInterface> TaskOwner;                                         // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2764[0x7];                                     // Fixing Size After Last Property
	...
	uint8                                        Pad_2765[0x7];                                     // Fixing Size Of Struct
};
...
{
public:
	TScriptInterface<class UGameplayTaskOwnerInterface> InTaskOwner;                                       // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TScriptInterface<class UGameplayTaskOwnerInterface> TaskOwner;                                         // 0x0(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TSubclassOf<class UActor>                    Class;                                             // 0x40(0x8)(Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	class UObject*                               WorldContextObject;                                // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UActor*                                SpawnedActor;                                      // 0x8(0x8)(Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_278D[0x3];                                     // Fixing Size After Last Property
