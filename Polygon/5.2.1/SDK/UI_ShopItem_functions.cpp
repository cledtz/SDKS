...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "SetEnableLoupe");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "Set Is Purchased");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "GetCatalogVersionByItemType");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "SetItemInfo");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnPlayFabResponse_09710F9A4237AB46170B1D960A630947");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnLoaded_2C5F359C4097A5010239688BB380D317");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnMouseEnter");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnMouseLeave");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "PurchaseItemSuccess");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "PurchaseItemFailure");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "BndEvt__Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnUpdatePlayerCombinedInfo_Event");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "OnClicked_Event");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "BndEvt__UI_ShopItem_Button_Loupe_K2Node_ComponentBoundEvent_3_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "BndEvt__UI_ShopItem_Button_Loupe_K2Node_ComponentBoundEvent_4_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "AsyncLoadIcon");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "ExecuteUbergraph_UI_ShopItem");
...
{
	static auto Func = Class->GetFunction("UI_ShopItem_C", "IsHoveredDelegate__DelegateSignature");
