...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_News_NewUpdate_C", "PreConstruct");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_News_NewUpdate_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_News_NewUpdate_C", "OnHovered_Event");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_News_NewUpdate_C", "BndEvt__UI_HomeScreen_Offer_News_NewUpdate_Button_ViewChangelist_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_News_NewUpdate_C", "ExecuteUbergraph_UI_HomeScreen_Menu_News_NewUpdate");
