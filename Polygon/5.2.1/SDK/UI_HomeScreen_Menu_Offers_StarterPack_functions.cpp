...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_StarterPack_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_StarterPack_C", "OnHovered_Event");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_StarterPack_C", "BndEvt__UI_HomeScreen_Offer_News_NewModules_Button_Shop_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_StarterPack_C", "BndEvt__UI_HomeScreen_Menu_Offers_StarterPack_Button_Buy_1_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_HomeScreen_Menu_Offers_StarterPack_C", "ExecuteUbergraph_UI_HomeScreen_Menu_Offers_StarterPack");
