...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "BndEvt__UI_WarningNoPC_Button_Yes_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "Construct");
...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "BndEvt__UI_Shop_SteamOverlayIsDisabled_Button_Discord_K2Node_ComponentBoundEvent_0_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "BndEvt__UI_Shop_SteamOverlayIsDisabled_Button_Discord_K2Node_ComponentBoundEvent_2_OnButtonHoverEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "BndEvt__UI_Shop_SteamOverlayIsDisabled_Button_Discord_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto Func = Class->GetFunction("UI_Shop_SteamOverlayIsDisabled_C", "ExecuteUbergraph_UI_Shop_SteamOverlayIsDisabled");
