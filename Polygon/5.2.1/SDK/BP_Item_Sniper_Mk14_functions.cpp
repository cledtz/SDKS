...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_Mk14_C", "SetSight");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_Mk14_C", "ReceiveBeginPlay");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_Mk14_C", "OnSetGunModules_Event");
...
{
	static auto Func = Class->GetFunction("BP_Item_Sniper_Mk14_C", "ExecuteUbergraph_BP_Item_Sniper_Mk14");
